...
pub struct TakeOffRelicCsReq {
    ...
    pub avatar_id: u32,
    // @@protoc_insertion_point(field:TakeOffRelicCsReq.OHCANELOIKG)
    pub OHCANELOIKG: ::std::vec::Vec<u32>,
    // special fields
...
impl TakeOffRelicCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "OHCANELOIKG",
            |m: &TakeOffRelicCsReq| { &m.OHCANELOIKG },
            |m: &mut TakeOffRelicCsReq| { &mut m.OHCANELOIKG },
        ));
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                34 => {
                    is.read_repeated_packed_uint32_into(&mut self.OHCANELOIKG)?;
                },
                32 => {
                    self.OHCANELOIKG.push(is.read_uint32()?);
                },
                tag => {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    r_id\x18\x0f\x20\x01(\rR\x08avatarId\x12\x20\n\x0bOHCANELOIKG\x18\x04\
    \x20\x03(\rR\x0bOHCANELOIKGb\x06proto3\
";
