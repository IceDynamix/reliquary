...
impl ::protobuf::Message for MonopolyEventSelectFriendScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.OEFHMBJBLGC != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.OEFHMBJBLGC);
        }
        if self.IEEJCHFEPHA != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.IEEJCHFEPHA);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.OEFHMBJBLGC != 0 {
            os.write_uint32(6, self.OEFHMBJBLGC)?;
        }
        if self.IEEJCHFEPHA != 0 {
            os.write_uint32(3, self.IEEJCHFEPHA)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    IAACCAFGEPIR\x0bHGBIGBFGBOM\x12\x20\n\x0bOEFHMBJBLGC\x18\x06\x20\x01(\rR\
    \x0bOEFHMBJBLGC\x12\x20\n\x0bIEEJCHFEPHA\x18\x03\x20\x01(\rR\x0bIEEJCHFE\
    PHAb\x06proto3\
";
