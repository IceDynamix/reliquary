...
pub struct QuickStartFarmElementScRsp {
    ...
    pub retcode: u32,
    // @@protoc_insertion_point(field:QuickStartFarmElementScRsp.LPPMFJOCKNO)
    pub LPPMFJOCKNO: ::protobuf::MessageField<super::DDCPCKIHMEF::DDCPCKIHMEF>,
    // @@protoc_insertion_point(field:QuickStartFarmElementScRsp.CFNJJEJIGOK)
    pub CFNJJEJIGOK: u32,
    // @@protoc_insertion_point(field:QuickStartFarmElementScRsp.KIDMDEFNAAK)
    pub KIDMDEFNAAK: u32,
    // special fields
...
impl QuickStartFarmElementScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::DDCPCKIHMEF::DDCPCKIHMEF>(
            "LPPMFJOCKNO",
            |m: &QuickStartFarmElementScRsp| { &m.LPPMFJOCKNO },
            |m: &mut QuickStartFarmElementScRsp| { &mut m.LPPMFJOCKNO },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "CFNJJEJIGOK",
            |m: &QuickStartFarmElementScRsp| { &m.CFNJJEJIGOK },
            |m: &mut QuickStartFarmElementScRsp| { &mut m.CFNJJEJIGOK },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "KIDMDEFNAAK",
            |m: &QuickStartFarmElementScRsp| { &m.KIDMDEFNAAK },
            |m: &mut QuickStartFarmElementScRsp| { &mut m.KIDMDEFNAAK },
        ));
...
impl ::protobuf::Message for QuickStartFarmElementScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.KIDMDEFNAAK != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.KIDMDEFNAAK);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.KIDMDEFNAAK != 0 {
            os.write_uint32(1, self.KIDMDEFNAAK)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x20QuickStartFarmElementScRsp.proto\x1a\x11DDCPCKIHMEF.proto\"\xaa\
    \x01\n\x1aQuickStartFarmElementScRsp\x12\x18\n\x07retcode\x18\x0c\x20\
    \x01(\rR\x07retcode\x12.\n\x0bLPPMFJOCKNO\x18\x08\x20\x01(\x0b2\x0c.DDCP\
    CKIHMEFR\x0bLPPMFJOCKNO\x12\x20\n\x0bCFNJJEJIGOK\x18\x0f\x20\x01(\rR\x0b\
    CFNJJEJIGOK\x12\x20\n\x0bKIDMDEFNAAK\x18\x01\x20\x01(\rR\x0bKIDMDEFNAAKb\
    \x06proto3\
";
