...
pub struct UnlockTutorialCsReq {
    // message fields
    // @@protoc_insertion_point(field:UnlockTutorialCsReq.LEJCMFBIIEH)
    pub LEJCMFBIIEH: u32,
    // special fields
...
impl UnlockTutorialCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "LEJCMFBIIEH",
            |m: &UnlockTutorialCsReq| { &m.LEJCMFBIIEH },
            |m: &mut UnlockTutorialCsReq| { &mut m.LEJCMFBIIEH },
        ));
...
impl ::protobuf::Message for UnlockTutorialCsReq {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                16 => {
                    self.LEJCMFBIIEH = is.read_uint32()?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.LEJCMFBIIEH != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.LEJCMFBIIEH);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.LEJCMFBIIEH != 0 {
            os.write_uint32(2, self.LEJCMFBIIEH)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0bLEJCMFBIIEH\x18\x02\x20\x01(\rR\x0bLEJCMFBIIEHb\x06proto3\
";
