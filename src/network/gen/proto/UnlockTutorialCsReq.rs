...
pub struct UnlockTutorialCsReq {
    // message fields
    // @@protoc_insertion_point(field:UnlockTutorialCsReq.PLPMNFLKEBO)
    pub PLPMNFLKEBO: u32,
    // special fields
...
impl UnlockTutorialCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "PLPMNFLKEBO",
            |m: &UnlockTutorialCsReq| { &m.PLPMNFLKEBO },
            |m: &mut UnlockTutorialCsReq| { &mut m.PLPMNFLKEBO },
        ));
...
impl ::protobuf::Message for UnlockTutorialCsReq {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                104 => {
                    self.PLPMNFLKEBO = is.read_uint32()?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.PLPMNFLKEBO != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.PLPMNFLKEBO);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.PLPMNFLKEBO != 0 {
            os.write_uint32(13, self.PLPMNFLKEBO)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0bPLPMNFLKEBO\x18\r\x20\x01(\rR\x0bPLPMNFLKEBOb\x06proto3\
";
