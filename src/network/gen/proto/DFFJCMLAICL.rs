...
//! Generated file from `DFFJCMLAICL.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:DFFJCMLAICL)
...
impl<'a> ::std::default::Default for &'a DFFJCMLAICL {
    fn default() -> &'a DFFJCMLAICL {
        <DFFJCMLAICL as ::protobuf::Message>::default_instance()
    }
}

impl DFFJCMLAICL {
    pub fn new() -> DFFJCMLAICL {
...
impl ::protobuf::Message for DFFJCMLAICL {
    const NAME: &'static str = "DFFJCMLAICL";
    ...
    fn default_instance() -> &'static DFFJCMLAICL {
        static instance: ::protobuf::rt::Lazy<DFFJCMLAICL> = ::protobuf::rt::Lazy::new();
        instance.get(DFFJCMLAICL::new)
    }
}

impl ::protobuf::MessageFull for DFFJCMLAICL {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("DFFJCMLAICL").unwrap()).clone()
    }
}

impl ::std::fmt::Display for DFFJCMLAICL {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for DFFJCMLAICL {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(DFFJCMLAICL::generated_message_descriptor_data());
