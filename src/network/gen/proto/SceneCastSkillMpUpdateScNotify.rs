...
impl ::protobuf::Message for SceneCastSkillMpUpdateScNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.attacked_group_id != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.attacked_group_id);
        }
        if self.mp != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.attacked_group_id != 0 {
            os.write_uint32(11, self.attacked_group_id)?;
        }
        if self.mp != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    cNotify\x12*\n\x11attacked_group_id\x18\x0b\x20\x01(\rR\x0fattackedGroup\
    Id\x12\x0e\n\x02mp\x18\n\x20\x01(\rR\x02mpB\x15\n\x13emu.lunarcore.proto\
    b\x06proto3\
";
