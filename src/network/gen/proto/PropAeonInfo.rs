...
impl ::protobuf::Message for PropAeonInfo {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.add_exp != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.add_exp);
        }
        if self.aeon_id != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.aeon_id);
        }
        if self.dialogue_group_id != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.dialogue_group_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.add_exp != 0 {
            os.write_uint32(1, self.add_exp)?;
        }
        if self.aeon_id != 0 {
            os.write_uint32(2, self.aeon_id)?;
        }
        if self.dialogue_group_id != 0 {
            os.write_uint32(11, self.dialogue_group_id)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x01\x20\x01(\rR\x06addExp\x12\x17\n\x07aeon_id\x18\x02\x20\x01(\rR\x06a\
    eonId\x12*\n\x11dialogue_group_id\x18\x0b\x20\x01(\rR\x0fdialogueGroupId\
    b\x06proto3\
";
