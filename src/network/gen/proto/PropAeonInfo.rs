...
impl ::protobuf::Message for PropAeonInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.dialogue_group_id != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.dialogue_group_id);
        }
        if self.add_exp != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.dialogue_group_id != 0 {
            os.write_uint32(7, self.dialogue_group_id)?;
        }
        if self.add_exp != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    d\x18\x07\x20\x01(\rR\x0fdialogueGroupId\x12\x17\n\x07add_exp\x18\r\x20\
    \x01(\rR\x06addExp\x12\x17\n\x07aeon_id\x18\n\x20\x01(\rR\x06aeonIdB\x15\
