...
impl ::protobuf::Message for BuyGoodsCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.goods_num != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.goods_num);
        }
        if self.goods_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.goods_num != 0 {
            os.write_uint32(10, self.goods_num)?;
        }
        if self.goods_id != 0 {
