...
impl ::protobuf::Message for BuyGoodsCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.goods_num != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.goods_num);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.goods_num != 0 {
            os.write_uint32(3, self.goods_num)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0b\x20\x01(\rR\x06shopId\x12\x17\n\x07item_id\x18\t\x20\x01(\rR\x06ite\
    mId\x12\x19\n\x08goods_id\x18\x08\x20\x01(\rR\x07goodsId\x12\x1b\n\tgood\
    s_num\x18\x03\x20\x01(\rR\x08goodsNumB\x15\n\x13emu.lunarcore.protob\x06\
    proto3\
";
