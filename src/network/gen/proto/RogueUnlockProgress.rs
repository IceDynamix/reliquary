...
impl ::protobuf::Message for RogueUnlockProgress {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.unlock_id != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.unlock_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.finish != false {
            os.write_bool(10, self.finish)?;
        }
        if self.progress != 0 {
            os.write_uint32(6, self.progress)?;
        }
        if self.unlock_id != 0 {
            os.write_uint32(14, self.unlock_id)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x06finish\x18\n\x20\x01(\x08R\x06finish\x12\x1a\n\x08progress\x18\x06\
    \x20\x01(\rR\x08progress\x12\x1b\n\tunlock_id\x18\x0e\x20\x01(\rR\x08unl\
    ockIdb\x06proto3\
";
