...
impl ::protobuf::Message for RogueUnlockProgress {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.unlock_id != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.unlock_id);
        }
        if self.progress != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.unlock_id != 0 {
            os.write_uint32(7, self.unlock_id)?;
        }
        if self.progress != 0 {
            os.write_uint32(13, self.progress)?;
        }
        if self.finish != false {
            os.write_bool(12, self.finish)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x19RogueUnlockProgress.proto\"f\n\x13RogueUnlockProgress\x12\x1b\n\tu\
    nlock_id\x18\x07\x20\x01(\rR\x08unlockId\x12\x1a\n\x08progress\x18\r\x20\
    \x01(\rR\x08progress\x12\x16\n\x06finish\x18\x0c\x20\x01(\x08R\x06finish\
    b\x06proto3\
";
