...
impl ::protobuf::Message for RogueUnlockProgress {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.unlock_id != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.unlock_id);
        }
        if self.progress != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.unlock_id != 0 {
            os.write_uint32(5, self.unlock_id)?;
        }
        if self.progress != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    nlock_id\x18\x05\x20\x01(\rR\x08unlockId\x12\x1a\n\x08progress\x18\x06\
    \x20\x01(\rR\x08progress\x12\x16\n\x06finish\x18\x03\x20\x01(\x08R\x06fi\
    nishb\x06proto3\
";
