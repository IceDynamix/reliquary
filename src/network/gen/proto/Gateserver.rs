...
impl ::protobuf::Message for Gateserver {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.lua_url.is_empty() {
            my_size += ::protobuf::rt::string_size(15, &self.lua_url);
        }
        if !self.msg.is_empty() {
            my_size += ::protobuf::rt::string_size(266, &self.msg);
        }
        if !self.client_secret_key.is_empty() {
            my_size += ::protobuf::rt::string_size(409, &self.client_secret_key);
        }
        if !self.ifix_url.is_empty() {
            my_size += ::protobuf::rt::string_size(1766, &self.ifix_url);
        }
        if self.port != 0 {
        ...
        if !self.ifix_version.is_empty() {
            my_size += ::protobuf::rt::string_size(1833, &self.ifix_version);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.lua_url.is_empty() {
            os.write_string(15, &self.lua_url)?;
        }
        if !self.msg.is_empty() {
            os.write_string(266, &self.msg)?;
        }
        if !self.client_secret_key.is_empty() {
            os.write_string(409, &self.client_secret_key)?;
        }
        if !self.ifix_url.is_empty() {
            os.write_string(1766, &self.ifix_url)?;
        }
        if self.port != 0 {
            os.write_uint32(4, self.port)?;
        }
        if self.unk1 != false {
            os.write_bool(8, self.unk1)?;
        }
        if self.unk2 != false {
            os.write_bool(14, self.unk2)?;
        }
        if self.unk3 != false {
            os.write_bool(207, self.unk3)?;
        }
        if self.unk4 != false {
            os.write_bool(642, self.unk4)?;
        }
        if self.unk5 != false {
            os.write_bool(1257, self.unk5)?;
        }
        if self.unk6 != false {
            os.write_bool(1497, self.unk6)?;
        }
        if self.unk7 != false {
            os.write_bool(1700, self.unk7)?;
        }
        if !self.mdk_res_version.is_empty() {
            os.write_string(1456, &self.mdk_res_version)?;
        }
        if !self.ifix_version.is_empty() {
            os.write_string(1833, &self.ifix_version)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x10Gateserver.proto\"\xf6\x03\n\nGateserver\x12\x0e\n\x02ip\x18\x01\
    \x20\x01(\tR\x02ip\x12(\n\x10asset_bundle_url\x18\x03\x20\x01(\tR\x0eass\
    etBundleUrl\x12\x1f\n\x0bregion_name\x18\x05\x20\x01(\tR\nregionName\x12\
    &\n\x0fex_resource_url\x18\t\x20\x01(\tR\rexResourceUrl\x12\x17\n\x07lua\
    _url\x18\x0f\x20\x01(\tR\x06luaUrl\x12\x11\n\x03msg\x18\x8a\x02\x20\x01(\
    \tR\x03msg\x12+\n\x11client_secret_key\x18\x99\x03\x20\x01(\tR\x0fclient\
    SecretKey\x12\x1a\n\x08ifix_url\x18\xe6\r\x20\x01(\tR\x07ifixUrl\x12\x12\
    \n\x04port\x18\x04\x20\x01(\rR\x04port\x12\x12\n\x04unk1\x18\x08\x20\x01\
    (\x08R\x04unk1\x12\x12\n\x04unk2\x18\x0e\x20\x01(\x08R\x04unk2\x12\x13\n\
    \x04unk3\x18\xcf\x01\x20\x01(\x08R\x04unk3\x12\x13\n\x04unk4\x18\x82\x05\
    \x20\x01(\x08R\x04unk4\x12\x13\n\x04unk5\x18\xe9\t\x20\x01(\x08R\x04unk5\
    \x12\x13\n\x04unk6\x18\xd9\x0b\x20\x01(\x08R\x04unk6\x12\x13\n\x04unk7\
    \x18\xa4\r\x20\x01(\x08R\x04unk7\x12'\n\x0fmdk_res_version\x18\xb0\x0b\
    \x20\x01(\tR\rmdkResVersion\x12\"\n\x0cifix_version\x18\xa9\x0e\x20\x01(\
    \tR\x0bifixVersionB\x15\n\x13emu.lunarcore.protob\x06proto3\
";
