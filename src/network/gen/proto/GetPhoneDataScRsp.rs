...
impl ::protobuf::Message for GetPhoneDataScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.cur_phone_theme != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.cur_phone_theme);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.cur_phone_theme != 0 {
            os.write_uint32(10, self.cur_phone_theme)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    e\x18\x0e\x20\x01(\rR\x07retcode\x12,\n\x12owned_chat_bubbles\x18\t\x20\
    \x03(\rR\x10ownedChatBubbles\x12&\n\x0fcur_chat_bubble\x18\r\x20\x01(\rR\
    \rcurChatBubble\x12,\n\x12owned_phone_themes\x18\x0b\x20\x03(\rR\x10owne\
