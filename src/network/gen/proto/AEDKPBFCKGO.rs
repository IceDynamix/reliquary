...
impl ::protobuf::Message for AEDKPBFCKGO {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.PKDLKCBKKPF != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.PKDLKCBKKPF);
        }
        if self.IFKDGEBCDEG != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.IFKDGEBCDEG);
        }
        if self.EFINFPKKJLE != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.EFINFPKKJLE);
        }
        if self.IMOBLGOAJCB != false {
            my_size += 1 + 1;
        }
        if self.GIMDHBNJOOO != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.GIMDHBNJOOO);
        }
        ...
        if self.KMGIEMOFOGB != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.KMGIEMOFOGB);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.PKDLKCBKKPF != 0 {
            os.write_uint32(7, self.PKDLKCBKKPF)?;
        }
        if self.IFKDGEBCDEG != 0 {
            os.write_uint32(15, self.IFKDGEBCDEG)?;
        }
        if self.EFINFPKKJLE != 0 {
            os.write_uint32(4, self.EFINFPKKJLE)?;
        }
        if self.IMOBLGOAJCB != false {
            os.write_bool(14, self.IMOBLGOAJCB)?;
        }
        if self.GIMDHBNJOOO != 0 {
            os.write_uint32(8, self.GIMDHBNJOOO)?;
        }
        if self.FNIGPGBGEHN != 0 {
        ...
        if self.KMGIEMOFOGB != 0 {
            os.write_uint32(10, self.KMGIEMOFOGB)?;
        }
        if self.PDDNGKNCPEB != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    KPF\x18\x07\x20\x01(\rR\x0bPKDLKCBKKPF\x12\x20\n\x0bIFKDGEBCDEG\x18\x0f\
    \x20\x01(\rR\x0bIFKDGEBCDEG\x12\x20\n\x0bEFINFPKKJLE\x18\x04\x20\x01(\rR\
    \x0bEFINFPKKJLE\x12\x20\n\x0bIMOBLGOAJCB\x18\x0e\x20\x01(\x08R\x0bIMOBLG\
    OAJCB\x12\x20\n\x0bGIMDHBNJOOO\x18\x08\x20\x01(\rR\x0bGIMDHBNJOOO\x12\
    \x20\n\x0bFNIGPGBGEHN\x18\x0c\x20\x01(\rR\x0bFNIGPGBGEHN\x12\x20\n\x0bPI\
    LAAGOKAOF\x18\r\x20\x01(\rR\x0bPILAAGOKAOF\x12\x20\n\x0bKMGIEMOFOGB\x18\
    \n\x20\x01(\rR\x0bKMGIEMOFOGB\x12\x20\n\x0bPDDNGKNCPEB\x18\x0b\x20\x01(\
    \rR\x0bPDDNGKNCPEBb\x06proto3\
";
