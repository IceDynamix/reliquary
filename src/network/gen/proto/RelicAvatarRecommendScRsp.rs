...
pub struct RelicAvatarRecommendScRsp {
    ...
    pub retcode: u32,
    // @@protoc_insertion_point(field:RelicAvatarRecommendScRsp.DHJHIBCDNBA)
    pub DHJHIBCDNBA: u32,
    // @@protoc_insertion_point(field:RelicAvatarRecommendScRsp.FEIFDEGKEAP)
...
impl RelicAvatarRecommendScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "DHJHIBCDNBA",
            |m: &RelicAvatarRecommendScRsp| { &m.DHJHIBCDNBA },
            |m: &mut RelicAvatarRecommendScRsp| { &mut m.DHJHIBCDNBA },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "FEIFDEGKEAP",
            |m: &RelicAvatarRecommendScRsp| { &m.FEIFDEGKEAP },
            |m: &mut RelicAvatarRecommendScRsp| { &mut m.FEIFDEGKEAP },
        ));
...
impl ::protobuf::Message for RelicAvatarRecommendScRsp {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.ROGUE_TALENT_STATUS_ENABLE != false {
            os.write_bool(2, self.ROGUE_TALENT_STATUS_ENABLE)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    dScRsp\x12;\n\x1aROGUE_TALENT_STATUS_ENABLE\x18\x02\x20\x01(\x08R\x17ROG\
    UETALENTSTATUSENABLE\x12\x18\n\x07retcode\x18\x0b\x20\x01(\rR\x07retcode\
    \x12\x20\n\x0bDHJHIBCDNBA\x18\x04\x20\x01(\rR\x0bDHJHIBCDNBA\x12\x20\n\
    \x0bFEIFDEGKEAP\x18\t\x20\x03(\rR\x0bFEIFDEGKEAPb\x06proto3\
";
