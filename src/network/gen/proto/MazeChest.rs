...
impl ::protobuf::Message for MazeChest {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.map_info_chest_type != ::protobuf::EnumOrUnknown::new(super::MapInfoChestType::MapInfoChestType::MAP_INFO_CHEST_TYPE_NONE) {
            my_size += ::protobuf::rt::int32_size(5, self.map_info_chest_type.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.map_info_chest_type != ::protobuf::EnumOrUnknown::new(super::MapInfoChestType::MapInfoChestType::MAP_INFO_CHEST_TYPE_NONE) {
            os.write_enum(5, ::protobuf::EnumOrUnknown::value(&self.map_info_chest_type))?;
        }
        if self.unlocked_amount_list != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    st\x12@\n\x13map_info_chest_type\x18\x05\x20\x01(\x0e2\x11.MapInfoChestT\
    ypeR\x10mapInfoChestType\x120\n\x14unlocked_amount_list\x18\x01\x20\x01(\
    \rR\x12unlockedAmountList\x12*\n\x11total_amount_list\x18\x07\x20\x01(\r\
    R\x0ftotalAmountListB\x15\n\x13emu.lunarcore.protob\x06proto3\
";
