...
impl ::protobuf::Message for MazeChest {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.map_info_chest_type != ::protobuf::EnumOrUnknown::new(super::MapInfoChestType::MapInfoChestType::MAP_INFO_CHEST_TYPE_NONE) {
            my_size += ::protobuf::rt::int32_size(3, self.map_info_chest_type.value());
        }
        if self.total_amount_list != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.total_amount_list);
        }
        if self.unlocked_amount_list != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.unlocked_amount_list);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.map_info_chest_type != ::protobuf::EnumOrUnknown::new(super::MapInfoChestType::MapInfoChestType::MAP_INFO_CHEST_TYPE_NONE) {
            os.write_enum(3, ::protobuf::EnumOrUnknown::value(&self.map_info_chest_type))?;
        }
        if self.total_amount_list != 0 {
            os.write_uint32(2, self.total_amount_list)?;
        }
        if self.unlocked_amount_list != 0 {
            os.write_uint32(11, self.unlocked_amount_list)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    st\x12@\n\x13map_info_chest_type\x18\x03\x20\x01(\x0e2\x11.MapInfoChestT\
    ypeR\x10mapInfoChestType\x12*\n\x11total_amount_list\x18\x02\x20\x01(\rR\
    \x0ftotalAmountList\x120\n\x14unlocked_amount_list\x18\x0b\x20\x01(\rR\
