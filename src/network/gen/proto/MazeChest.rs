...
impl ::protobuf::Message for MazeChest {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.map_info_chest_type != ::protobuf::EnumOrUnknown::new(super::MapInfoChestType::MapInfoChestType::MAP_INFO_CHEST_TYPE_NONE) {
            my_size += ::protobuf::rt::int32_size(8, self.map_info_chest_type.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.map_info_chest_type != ::protobuf::EnumOrUnknown::new(super::MapInfoChestType::MapInfoChestType::MAP_INFO_CHEST_TYPE_NONE) {
            os.write_enum(8, ::protobuf::EnumOrUnknown::value(&self.map_info_chest_type))?;
        }
        if self.total_amount_list != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    st\x12@\n\x13map_info_chest_type\x18\x08\x20\x01(\x0e2\x11.MapInfoChestT\
