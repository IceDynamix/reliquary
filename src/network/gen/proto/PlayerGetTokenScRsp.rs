...
pub struct PlayerGetTokenScRsp {
    ...
    // @@protoc_insertion_point(field:PlayerGetTokenScRsp.MFJPFLGKHDI)
    pub MFJPFLGKHDI: ::protobuf::MessageField<super::BlackInfo::BlackInfo>,
    // @@protoc_insertion_point(field:PlayerGetTokenScRsp.uid)
    pub uid: u32,
    // @@protoc_insertion_point(field:PlayerGetTokenScRsp.OKLOCCDBABL)
...
impl PlayerGetTokenScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::BlackInfo::BlackInfo>(
            "MFJPFLGKHDI",
            |m: &PlayerGetTokenScRsp| { &m.MFJPFLGKHDI },
            |m: &mut PlayerGetTokenScRsp| { &mut m.MFJPFLGKHDI },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "uid",
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "OKLOCCDBABL",
            |m: &PlayerGetTokenScRsp| { &m.OKLOCCDBABL },
            |m: &mut PlayerGetTokenScRsp| { &mut m.OKLOCCDBABL },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "retcode",
...
impl ::protobuf::Message for PlayerGetTokenScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.OKLOCCDBABL.is_empty() {
            my_size += ::protobuf::rt::string_size(14, &self.OKLOCCDBABL);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.OKLOCCDBABL.is_empty() {
            os.write_string(14, &self.OKLOCCDBABL)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    eySeed\x12,\n\x0bMFJPFLGKHDI\x18\x01\x20\x01(\x0b2\n.BlackInfoR\x0bMFJPF\
    LGKHDI\x12\x10\n\x03uid\x18\x0f\x20\x01(\rR\x03uid\x12\x20\n\x0bOKLOCCDB\
    ABL\x18\x0e\x20\x01(\tR\x0bOKLOCCDBABL\x12\x18\n\x07retcode\x18\x0b\x20\
