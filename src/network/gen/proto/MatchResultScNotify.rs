...
pub struct MatchResultScNotify {
    ...
    pub retcode: u32,
    // @@protoc_insertion_point(field:MatchResultScNotify.EBMOKPBKMMD)
...
impl MatchResultScNotify {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "EBMOKPBKMMD",
            |m: &MatchResultScNotify| { &m.EBMOKPBKMMD },
            |m: &mut MatchResultScNotify| { &mut m.EBMOKPBKMMD },
        ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x19MatchResultScNotify.proto\x1a\x11CCHCPNLPBDK.proto\"_\n\x13MatchRe\
    sultScNotify\x12\x18\n\x07retcode\x18\x08\x20\x01(\rR\x07retcode\x12.\n\
    \x0bEBMOKPBKMMD\x18\r\x20\x03(\x0b2\x0c.CCHCPNLPBDKR\x0bEBMOKPBKMMDb\x06\
    proto3\
";
