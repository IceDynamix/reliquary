...
impl ::protobuf::Message for StartCocoonStageCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.NLLKJODHPCP != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.NLLKJODHPCP);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.NLLKJODHPCP != 0 {
            os.write_uint32(5, self.NLLKJODHPCP)?;
        }
        if self.LMPHJMDONMH != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12\x20\n\x0bHEAJKBNOGLG\x18\t\x20\x01(\rR\x0bHEAJKBNOGLG\x12\x20\n\x0b\
    IFJFCEJJBPE\x18\x04\x20\x01(\rR\x0bIFJFCEJJBPE\x12\x20\n\x0bNLLKJODHPCP\
    \x18\x05\x20\x01(\rR\x0bNLLKJODHPCP\x12\x20\n\x0bLMPHJMDONMH\x18\x08\x20\
    \x01(\rR\x0bLMPHJMDONMHb\x06proto3\
";
