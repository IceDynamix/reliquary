...
//! Generated file from `AINBLBBFDBJ.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:AINBLBBFDBJ)
...
impl<'a> ::std::default::Default for &'a AINBLBBFDBJ {
    fn default() -> &'a AINBLBBFDBJ {
        <AINBLBBFDBJ as ::protobuf::Message>::default_instance()
    }
}

impl AINBLBBFDBJ {
    pub fn new() -> AINBLBBFDBJ {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "PIPMGACMJNN",
            |m: &AINBLBBFDBJ| { &m.PIPMGACMJNN },
            |m: &mut AINBLBBFDBJ| { &mut m.PIPMGACMJNN },
        ));
...
impl ::protobuf::Message for AINBLBBFDBJ {
    const NAME: &'static str = "AINBLBBFDBJ";
...
impl ::protobuf::MessageFull for AINBLBBFDBJ {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("AINBLBBFDBJ").unwrap()).clone()
    }
}

impl ::std::fmt::Display for AINBLBBFDBJ {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for AINBLBBFDBJ {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(AINBLBBFDBJ::generated_message_descriptor_data());
