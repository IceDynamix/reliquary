...
pub struct GetTrainVisitorRegisterScRsp {
    ...
    pub retcode: u32,
    // @@protoc_insertion_point(field:GetTrainVisitorRegisterScRsp.BHJEIMILLPF)
    pub BHJEIMILLPF: ::std::vec::Vec<u32>,
    // @@protoc_insertion_point(field:GetTrainVisitorRegisterScRsp.JBMPEGPPCHP)
    pub JBMPEGPPCHP: ::std::vec::Vec<super::CCIKAAAPKDB::CCIKAAAPKDB>,
    // special fields
...
impl GetTrainVisitorRegisterScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "BHJEIMILLPF",
            |m: &GetTrainVisitorRegisterScRsp| { &m.BHJEIMILLPF },
            |m: &mut GetTrainVisitorRegisterScRsp| { &mut m.BHJEIMILLPF },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "JBMPEGPPCHP",
            |m: &GetTrainVisitorRegisterScRsp| { &m.JBMPEGPPCHP },
            |m: &mut GetTrainVisitorRegisterScRsp| { &mut m.JBMPEGPPCHP },
        ));
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                50 => {
                    self.JBMPEGPPCHP.push(is.read_message()?);
                },
                tag => {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\"GetTrainVisitorRegisterScRsp.proto\x1a\x11CCIKAAAPKDB.proto\"\x8a\
    \x01\n\x1cGetTrainVisitorRegisterScRsp\x12\x18\n\x07retcode\x18\x0e\x20\
    \x01(\rR\x07retcode\x12\x20\n\x0bBHJEIMILLPF\x18\x01\x20\x03(\rR\x0bBHJE\
    IMILLPF\x12.\n\x0bJBMPEGPPCHP\x18\x06\x20\x03(\x0b2\x0c.CCIKAAAPKDBR\x0b\
    JBMPEGPPCHPb\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::CCIKAAAPKDB::file_descriptor().clone());
