...
pub struct LobbyModifyPlayerInfoCsReq {
    // message fields
    // @@protoc_insertion_point(field:LobbyModifyPlayerInfoCsReq.slot)
    pub slot: ::protobuf::EnumOrUnknown<super::LobbyModifyType::LobbyModifyType>,
    // @@protoc_insertion_point(field:LobbyModifyPlayerInfoCsReq.DIFNDEGMKNA)
    pub DIFNDEGMKNA: ::protobuf::MessageField<super::PGDACNIBFMP::PGDACNIBFMP>,
    // @@protoc_insertion_point(field:LobbyModifyPlayerInfoCsReq.JAFCADJGPJH)
    pub JAFCADJGPJH: u32,
    // special fields
...
impl LobbyModifyPlayerInfoCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "slot",
            |m: &LobbyModifyPlayerInfoCsReq| { &m.slot },
            |m: &mut LobbyModifyPlayerInfoCsReq| { &mut m.slot },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::PGDACNIBFMP::PGDACNIBFMP>(
            "DIFNDEGMKNA",
            |m: &LobbyModifyPlayerInfoCsReq| { &m.DIFNDEGMKNA },
            |m: &mut LobbyModifyPlayerInfoCsReq| { &mut m.DIFNDEGMKNA },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "JAFCADJGPJH",
            |m: &LobbyModifyPlayerInfoCsReq| { &m.JAFCADJGPJH },
            |m: &mut LobbyModifyPlayerInfoCsReq| { &mut m.JAFCADJGPJH },
        ));
...
impl ::protobuf::Message for LobbyModifyPlayerInfoCsReq {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                16 => {
                    self.JAFCADJGPJH = is.read_uint32()?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.JAFCADJGPJH != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.JAFCADJGPJH);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.JAFCADJGPJH != 0 {
            os.write_uint32(2, self.JAFCADJGPJH)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x20LobbyModifyPlayerInfoCsReq.proto\x1a\x15LobbyModifyType.proto\x1a\
    \x11PGDACNIBFMP.proto\"\x94\x01\n\x1aLobbyModifyPlayerInfoCsReq\x12$\n\
    \x04slot\x18\r\x20\x01(\x0e2\x10.LobbyModifyTypeR\x04slot\x12.\n\x0bDIFN\
    DEGMKNA\x18\x08\x20\x01(\x0b2\x0c.PGDACNIBFMPR\x0bDIFNDEGMKNA\x12\x20\n\
    \x0bJAFCADJGPJH\x18\x02\x20\x01(\rR\x0bJAFCADJGPJHb\x06proto3\
";
