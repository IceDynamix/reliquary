...
impl ::protobuf::Message for ABHFABFGPOF {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.PIKAPDJHGND != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.PIKAPDJHGND);
        }
        ...
        if self.NKHKDJKEGDH != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.NKHKDJKEGDH);
        }
        if self.FCJECKCICKB != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.FCJECKCICKB);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.PIKAPDJHGND != 0 {
            os.write_uint32(10, self.PIKAPDJHGND)?;
        }
        if self.NLMDEMOHBOO != 0 {
        ...
        if self.NKHKDJKEGDH != 0 {
            os.write_uint32(14, self.NKHKDJKEGDH)?;
        }
        if self.FCJECKCICKB != 0 {
            os.write_uint32(9, self.FCJECKCICKB)?;
        }
        if self.CLOONOIFEFO != false {
            os.write_bool(13, self.CLOONOIFEFO)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    GND\x18\n\x20\x01(\rR\x0bPIKAPDJHGND\x12\x20\n\x0bNLMDEMOHBOO\x18\x0c\
    \x20\x01(\rR\x0bNLMDEMOHBOO\x12\x20\n\x0bBIINNCNDPCG\x18\x08\x20\x01(\
    \x08R\x0bBIINNCNDPCG\x12\x20\n\x0bJAFNPNMOHCM\x18\x05\x20\x01(\rR\x0bJAF\
    NPNMOHCM\x12\x20\n\x0bNKHKDJKEGDH\x18\x0e\x20\x01(\rR\x0bNKHKDJKEGDH\x12\
    \x20\n\x0bFCJECKCICKB\x18\t\x20\x01(\rR\x0bFCJECKCICKB\x12\x20\n\x0bCLOO\
    NOIFEFO\x18\r\x20\x01(\x08R\x0bCLOONOIFEFOb\x06proto3\
";
