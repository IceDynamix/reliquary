...
impl ::protobuf::Message for DoGachaCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.simulate_magic != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.simulate_magic);
        }
        if self.gacha_num != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.simulate_magic != 0 {
            os.write_uint32(6, self.simulate_magic)?;
        }
        if self.gacha_num != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    dom\x18\x05\x20\x01(\rR\x0bgachaRandom\x12\x19\n\x08gacha_id\x18\x01\x20\
    \x01(\rR\x07gachaId\x12%\n\x0esimulate_magic\x18\x06\x20\x01(\rR\rsimula\
    teMagic\x12\x1b\n\tgacha_num\x18\x08\x20\x01(\rR\x08gachaNumB\x15\n\x13e\
