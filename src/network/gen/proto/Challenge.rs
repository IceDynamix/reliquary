...
pub struct Challenge {
    ...
    // @@protoc_insertion_point(field:Challenge.attempts)
    pub attempts: u32,
    // @@protoc_insertion_point(field:Challenge.MDGLHFIFFLC)
    pub MDGLHFIFFLC: bool,
    // @@protoc_insertion_point(field:Challenge.story_info)
...
impl Challenge {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "attempts",
            |m: &Challenge| { &m.attempts },
            |m: &mut Challenge| { &mut m.attempts },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "MDGLHFIFFLC",
            |m: &Challenge| { &m.MDGLHFIFFLC },
            |m: &mut Challenge| { &mut m.MDGLHFIFFLC },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::ChallengeBossExtraInfo::ChallengeBossExtraInfo>(
            "story_info",
            |m: &Challenge| { &m.story_info },
            |m: &mut Challenge| { &mut m.story_info },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "score",
            |m: &Challenge| { &m.score },
...
impl ::protobuf::Message for Challenge {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.taken_reward != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.taken_reward);
        }
        if self.attempts != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.attempts);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.taken_reward != 0 {
            os.write_uint32(15, self.taken_reward)?;
        }
        if self.attempts != 0 {
            os.write_uint32(11, self.attempts)?;
        }
        if self.MDGLHFIFFLC != false {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x0fChallenge.proto\x1a\x1cChallengeBossExtraInfo.proto\"\x90\x02\n\tC\
    hallenge\x12!\n\x0ctaken_reward\x18\x0f\x20\x01(\rR\x0btakenReward\x12\
    \x1a\n\x08attempts\x18\x0b\x20\x01(\rR\x08attempts\x12\x20\n\x0bMDGLHFIF\
    FLC\x18\x01\x20\x01(\x08R\x0bMDGLHFIFFLC\x126\n\nstory_info\x18\x03\x20\
    \x01(\x0b2\x17.ChallengeBossExtraInfoR\tstoryInfo\x12\x14\n\x05score\x18\
    \t\x20\x01(\rR\x05score\x12!\n\x0cchallenge_id\x18\x05\x20\x01(\rR\x0bch\
    allengeId\x12\x14\n\x05stars\x18\x04\x20\x01(\rR\x05stars\x12\x1b\n\tsco\
    re_two\x18\x08\x20\x01(\rR\x08scoreTwoB\x15\n\x13emu.lunarcore.protob\
    \x06proto3\
";
