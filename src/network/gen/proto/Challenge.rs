...
pub struct Challenge {
    ...
    pub score: u32,
    // @@protoc_insertion_point(field:Challenge.GEHGEGOFDDM)
    pub GEHGEGOFDDM: u32,
    // special fields
...
impl Challenge {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "GEHGEGOFDDM",
            |m: &Challenge| { &m.GEHGEGOFDDM },
            |m: &mut Challenge| { &mut m.GEHGEGOFDDM },
        ));
...
impl ::protobuf::Message for Challenge {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                40 => {
                    self.GEHGEGOFDDM = is.read_uint32()?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.taken_reward != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.taken_reward);
        }
        ...
        if self.GEHGEGOFDDM != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.GEHGEGOFDDM);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.taken_reward != 0 {
            os.write_uint32(13, self.taken_reward)?;
        }
        if self.challenge_id != 0 {
        ...
        if self.GEHGEGOFDDM != 0 {
            os.write_uint32(5, self.GEHGEGOFDDM)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x0fChallenge.proto\"\x9f\x01\n\tChallenge\x12\x14\n\x05stars\x18\x08\
    \x20\x01(\rR\x05stars\x12!\n\x0ctaken_reward\x18\r\x20\x01(\rR\x0btakenR\
    eward\x12!\n\x0cchallenge_id\x18\x01\x20\x01(\rR\x0bchallengeId\x12\x14\
    \n\x05score\x18\x07\x20\x01(\rR\x05score\x12\x20\n\x0bGEHGEGOFDDM\x18\
    \x05\x20\x01(\rR\x0bGEHGEGOFDDMB\x15\n\x13emu.lunarcore.protob\x06proto3\
";
