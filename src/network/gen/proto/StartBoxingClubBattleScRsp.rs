...
pub struct StartBoxingClubBattleScRsp {
    // message fields
    // @@protoc_insertion_point(field:StartBoxingClubBattleScRsp.PGGMKGMBBKJ)
    pub PGGMKGMBBKJ: u32,
    // @@protoc_insertion_point(field:StartBoxingClubBattleScRsp.LPPMFJOCKNO)
...
impl StartBoxingClubBattleScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "PGGMKGMBBKJ",
            |m: &StartBoxingClubBattleScRsp| { &m.PGGMKGMBBKJ },
            |m: &mut StartBoxingClubBattleScRsp| { &mut m.PGGMKGMBBKJ },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::DDCPCKIHMEF::DDCPCKIHMEF>(
            "LPPMFJOCKNO",
            |m: &StartBoxingClubBattleScRsp| { &m.LPPMFJOCKNO },
            |m: &mut StartBoxingClubBattleScRsp| { &mut m.LPPMFJOCKNO },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "retcode",
...
impl ::protobuf::Message for StartBoxingClubBattleScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.PGGMKGMBBKJ != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.PGGMKGMBBKJ);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.PGGMKGMBBKJ != 0 {
            os.write_uint32(9, self.PGGMKGMBBKJ)?;
        }
        if let Some(v) = self.LPPMFJOCKNO.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x20StartBoxingClubBattleScRsp.proto\x1a\x11DDCPCKIHMEF.proto\"\x88\
    \x01\n\x1aStartBoxingClubBattleScRsp\x12\x20\n\x0bPGGMKGMBBKJ\x18\t\x20\
    \x01(\rR\x0bPGGMKGMBBKJ\x12.\n\x0bLPPMFJOCKNO\x18\x03\x20\x01(\x0b2\x0c.\
    DDCPCKIHMEFR\x0bLPPMFJOCKNO\x12\x18\n\x07retcode\x18\x0f\x20\x01(\rR\x07\
    retcodeb\x06proto3\
";
