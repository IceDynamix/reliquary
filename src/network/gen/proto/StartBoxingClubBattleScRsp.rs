...
pub struct StartBoxingClubBattleScRsp {
    // message fields
    // @@protoc_insertion_point(field:StartBoxingClubBattleScRsp.GPKEAKPHIPA)
    pub GPKEAKPHIPA: u32,
    // @@protoc_insertion_point(field:StartBoxingClubBattleScRsp.ADADHIHDHJC)
    pub ADADHIHDHJC: u32,
    // @@protoc_insertion_point(field:StartBoxingClubBattleScRsp.BBKGPAJCCBM)
...
impl StartBoxingClubBattleScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "GPKEAKPHIPA",
            |m: &StartBoxingClubBattleScRsp| { &m.GPKEAKPHIPA },
            |m: &mut StartBoxingClubBattleScRsp| { &mut m.GPKEAKPHIPA },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "ADADHIHDHJC",
            |m: &StartBoxingClubBattleScRsp| { &m.ADADHIHDHJC },
            |m: &mut StartBoxingClubBattleScRsp| { &mut m.ADADHIHDHJC },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::CHDPLFOHLCN::CHDPLFOHLCN>(
            "BBKGPAJCCBM",
            |m: &StartBoxingClubBattleScRsp| { &m.BBKGPAJCCBM },
            |m: &mut StartBoxingClubBattleScRsp| { &mut m.BBKGPAJCCBM },
        ));
...
impl ::protobuf::Message for StartBoxingClubBattleScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.GPKEAKPHIPA != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.GPKEAKPHIPA);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.GPKEAKPHIPA != 0 {
            os.write_uint32(9, self.GPKEAKPHIPA)?;
        }
        if self.ADADHIHDHJC != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x20StartBoxingClubBattleScRsp.proto\x1a\x11CHDPLFOHLCN.proto\"\x90\
    \x01\n\x1aStartBoxingClubBattleScRsp\x12\x20\n\x0bGPKEAKPHIPA\x18\t\x20\
    \x01(\rR\x0bGPKEAKPHIPA\x12\x20\n\x0bADADHIHDHJC\x18\x02\x20\x01(\rR\x0b\
    ADADHIHDHJC\x12.\n\x0bBBKGPAJCCBM\x18\x03\x20\x01(\x0b2\x0c.CHDPLFOHLCNR\
    \x0bBBKGPAJCCBMb\x06proto3\
";
