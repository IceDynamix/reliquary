...
pub struct PlanetFesDoGachaCsReq {
    // message fields
    // @@protoc_insertion_point(field:PlanetFesDoGachaCsReq.GIAJEKCIIGD)
    pub GIAJEKCIIGD: u32,
    // @@protoc_insertion_point(field:PlanetFesDoGachaCsReq.IFNGNHHCNGL)
    pub IFNGNHHCNGL: u32,
    // @@protoc_insertion_point(field:PlanetFesDoGachaCsReq.FPFCKNICPPJ)
    pub FPFCKNICPPJ: u32,
    // special fields
...
impl PlanetFesDoGachaCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "GIAJEKCIIGD",
            |m: &PlanetFesDoGachaCsReq| { &m.GIAJEKCIIGD },
            |m: &mut PlanetFesDoGachaCsReq| { &mut m.GIAJEKCIIGD },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "IFNGNHHCNGL",
            |m: &PlanetFesDoGachaCsReq| { &m.IFNGNHHCNGL },
            |m: &mut PlanetFesDoGachaCsReq| { &mut m.IFNGNHHCNGL },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "FPFCKNICPPJ",
            |m: &PlanetFesDoGachaCsReq| { &m.FPFCKNICPPJ },
            |m: &mut PlanetFesDoGachaCsReq| { &mut m.FPFCKNICPPJ },
        ));
...
impl ::protobuf::Message for PlanetFesDoGachaCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.GIAJEKCIIGD != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.GIAJEKCIIGD);
        }
        if self.IFNGNHHCNGL != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.IFNGNHHCNGL);
        }
        if self.FPFCKNICPPJ != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.FPFCKNICPPJ);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.GIAJEKCIIGD != 0 {
            os.write_uint32(5, self.GIAJEKCIIGD)?;
        }
        if self.IFNGNHHCNGL != 0 {
            os.write_uint32(6, self.IFNGNHHCNGL)?;
        }
        if self.FPFCKNICPPJ != 0 {
            os.write_uint32(3, self.FPFCKNICPPJ)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1bPlanetFesDoGachaCsReq.proto\"}\n\x15PlanetFesDoGachaCsReq\x12\x20\
    \n\x0bGIAJEKCIIGD\x18\x05\x20\x01(\rR\x0bGIAJEKCIIGD\x12\x20\n\x0bIFNGNH\
    HCNGL\x18\x06\x20\x01(\rR\x0bIFNGNHHCNGL\x12\x20\n\x0bFPFCKNICPPJ\x18\
    \x03\x20\x01(\rR\x0bFPFCKNICPPJb\x06proto3\
";
