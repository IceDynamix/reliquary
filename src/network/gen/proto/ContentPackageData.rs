...
impl ::protobuf::Message for ContentPackageData {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.cur_content_id != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.cur_content_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.cur_content_id != 0 {
            os.write_uint32(10, self.cur_content_id)?;
        }
