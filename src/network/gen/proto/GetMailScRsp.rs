...
impl ::protobuf::Message for GetMailScRsp {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.total_num != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.total_num);
        }
        if self.start != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.total_num != 0 {
            os.write_uint32(7, self.total_num)?;
        }
        if self.start != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    cRsp\x12\x1b\n\ttotal_num\x18\x07\x20\x01(\rR\x08totalNum\x12\x14\n\x05s\
    tart\x18\x0b\x20\x01(\rR\x05start\x12\x18\n\x07retcode\x18\x02\x20\x01(\
    \rR\x07retcode\x12(\n\tmail_list\x18\x0c\x20\x03(\x0b2\x0b.ClientMailR\
    \x08mailList\x12\x15\n\x06is_end\x18\r\x20\x01(\x08R\x05isEnd\x125\n\x10\
    notice_mail_list\x18\t\x20\x03(\x0b2\x0b.ClientMailR\x0enoticeMailListB\
