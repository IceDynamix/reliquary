...
impl ::protobuf::Message for GetMailScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.total_num != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.total_num);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.total_num != 0 {
            os.write_uint32(9, self.total_num)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    cRsp\x12\x15\n\x06is_end\x18\x0e\x20\x01(\x08R\x05isEnd\x12\x14\n\x05sta\
    rt\x18\x01\x20\x01(\rR\x05start\x125\n\x10notice_mail_list\x18\n\x20\x03\
    (\x0b2\x0b.ClientMailR\x0enoticeMailList\x12(\n\tmail_list\x18\x02\x20\
    \x03(\x0b2\x0b.ClientMailR\x08mailList\x12\x18\n\x07retcode\x18\x05\x20\
    \x01(\rR\x07retcode\x12\x1b\n\ttotal_num\x18\t\x20\x01(\rR\x08totalNumb\
    \x06proto3\
";
