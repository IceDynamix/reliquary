...
pub enum CmdBenefitActivityType {
    ...
    CmdJoinBenefitActivityCsReq = 4865,
}
...
impl ::protobuf::Enum for CmdBenefitActivityType {
    ...
    fn from_i32(value: i32) -> ::std::option::Option<CmdBenefitActivityType> {
        match value {
            ...
            4899 => ::std::option::Option::Some(CmdBenefitActivityType::CmdJoinBenefitActivityScRsp),
            4900 => ::std::option::Option::Some(CmdBenefitActivityType::CmdGetBenefitActivityInfoScRsp),
            4862 => ::std::option::Option::Some(CmdBenefitActivityType::CmdGetBenefitActivityInfoCsReq),
            4873 => ::std::option::Option::Some(CmdBenefitActivityType::CmdTakeBenefitActivityRewardScRsp),
            4865 => ::std::option::Option::Some(CmdBenefitActivityType::CmdJoinBenefitActivityCsReq),
...
impl ::protobuf::EnumFull for CmdBenefitActivityType {
    ...
    fn descriptor(&self) -> ::protobuf::reflect::EnumValueDescriptor {
        let index = match self {
            ...
            CmdBenefitActivityType::CmdGetBenefitActivityInfoScRsp => 3,
            CmdBenefitActivityType::CmdGetBenefitActivityInfoCsReq => 4,
            CmdBenefitActivityType::CmdTakeBenefitActivityRewardScRsp => 5,
            CmdBenefitActivityType::CmdJoinBenefitActivityCsReq => 6,
        };
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    vityRewardCsReq\x10\x90&\x12\x20\n\x1bCmdJoinBenefitActivityScRsp\x10\
    \xa3&\x12#\n\x1eCmdGetBenefitActivityInfoScRsp\x10\xa4&\x12#\n\x1eCmdGet\
    BenefitActivityInfoCsReq\x10\xfe%\x12&\n!CmdTakeBenefitActivityRewardScR\
    sp\x10\x89&\x12\x20\n\x1bCmdJoinBenefitActivityCsReq\x10\x81&b\x06proto3\
";
