...
pub struct AcceptMissionEventScRsp {
    ...
    pub retcode: u32,
    // @@protoc_insertion_point(field:AcceptMissionEventScRsp.AHFDNEDBGMC)
    pub AHFDNEDBGMC: ::protobuf::MessageField<super::FBDLAHIKIBJ::FBDLAHIKIBJ>,
    // special fields
...
impl AcceptMissionEventScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::FBDLAHIKIBJ::FBDLAHIKIBJ>(
            "AHFDNEDBGMC",
            |m: &AcceptMissionEventScRsp| { &m.AHFDNEDBGMC },
            |m: &mut AcceptMissionEventScRsp| { &mut m.AHFDNEDBGMC },
        ));
...
impl ::protobuf::Message for AcceptMissionEventScRsp {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                10 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.AHFDNEDBGMC)?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let Some(v) = self.AHFDNEDBGMC.as_ref() {
    ...
    fn default_instance() -> &'static AcceptMissionEventScRsp {
        static instance: AcceptMissionEventScRsp = AcceptMissionEventScRsp {
            retcode: 0,
            AHFDNEDBGMC: ::protobuf::MessageField::none(),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1dAcceptMissionEventScRsp.proto\x1a\x11FBDLAHIKIBJ.proto\"c\n\x17Acc\
    eptMissionEventScRsp\x12\x18\n\x07retcode\x18\x08\x20\x01(\rR\x07retcode\
    \x12.\n\x0bAHFDNEDBGMC\x18\x01\x20\x01(\x0b2\x0c.FBDLAHIKIBJR\x0bAHFDNED\
    BGMCb\x06proto3\
";
