...
pub struct Material {
    // message fields
    // @@protoc_insertion_point(field:Material.ONDFNMPEOEN)
    pub ONDFNMPEOEN: u64,
    // @@protoc_insertion_point(field:Material.tid)
    pub tid: u32,
    // @@protoc_insertion_point(field:Material.LJDBKCBFPPC)
    pub LJDBKCBFPPC: u32,
    // special fields
...
impl Material {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "ONDFNMPEOEN",
            |m: &Material| { &m.ONDFNMPEOEN },
            |m: &mut Material| { &mut m.ONDFNMPEOEN },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "tid",
            |m: &Material| { &m.tid },
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "LJDBKCBFPPC",
            |m: &Material| { &m.LJDBKCBFPPC },
            |m: &mut Material| { &mut m.LJDBKCBFPPC },
        ));
...
impl ::protobuf::Message for Material {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.ONDFNMPEOEN != 0 {
            my_size += ::protobuf::rt::uint64_size(7, self.ONDFNMPEOEN);
        }
        if self.tid != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.tid);
        }
        if self.LJDBKCBFPPC != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.LJDBKCBFPPC);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.ONDFNMPEOEN != 0 {
            os.write_uint64(7, self.ONDFNMPEOEN)?;
        }
        if self.tid != 0 {
            os.write_uint32(14, self.tid)?;
        }
        if self.LJDBKCBFPPC != 0 {
            os.write_uint32(6, self.LJDBKCBFPPC)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x0eMaterial.proto\"`\n\x08Material\x12\x20\n\x0bONDFNMPEOEN\x18\x07\
    \x20\x01(\x04R\x0bONDFNMPEOEN\x12\x10\n\x03tid\x18\x0e\x20\x01(\rR\x03ti\
    d\x12\x20\n\x0bLJDBKCBFPPC\x18\x06\x20\x01(\rR\x0bLJDBKCBFPPCb\x06proto3\
";
