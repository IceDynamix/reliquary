...
pub struct AlleyEventChangeNotify {
    // message fields
    // @@protoc_insertion_point(field:AlleyEventChangeNotify.FPKNCHKBHPK)
    pub FPKNCHKBHPK: u32,
    // @@protoc_insertion_point(field:AlleyEventChangeNotify.OMPJNNIJNPL)
    pub OMPJNNIJNPL: ::protobuf::MessageField<super::DCMCLLPDDJO::DCMCLLPDDJO>,
    // special fields
...
impl AlleyEventChangeNotify {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "FPKNCHKBHPK",
            |m: &AlleyEventChangeNotify| { &m.FPKNCHKBHPK },
            |m: &mut AlleyEventChangeNotify| { &mut m.FPKNCHKBHPK },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::DCMCLLPDDJO::DCMCLLPDDJO>(
            "OMPJNNIJNPL",
            |m: &AlleyEventChangeNotify| { &m.OMPJNNIJNPL },
            |m: &mut AlleyEventChangeNotify| { &mut m.OMPJNNIJNPL },
        ));
...
impl ::protobuf::Message for AlleyEventChangeNotify {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                96 => {
                    self.FPKNCHKBHPK = is.read_uint32()?;
                },
                66 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.OMPJNNIJNPL)?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.FPKNCHKBHPK != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.FPKNCHKBHPK);
        }
        if let Some(v) = self.OMPJNNIJNPL.as_ref() {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.FPKNCHKBHPK != 0 {
            os.write_uint32(12, self.FPKNCHKBHPK)?;
        }
        if let Some(v) = self.OMPJNNIJNPL.as_ref() {
    ...
    fn default_instance() -> &'static AlleyEventChangeNotify {
        static instance: AlleyEventChangeNotify = AlleyEventChangeNotify {
            FPKNCHKBHPK: 0,
            OMPJNNIJNPL: ::protobuf::MessageField::none(),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1cAlleyEventChangeNotify.proto\x1a\x11DCMCLLPDDJO.proto\"j\n\x16Alle\
    yEventChangeNotify\x12\x20\n\x0bFPKNCHKBHPK\x18\x0c\x20\x01(\rR\x0bFPKNC\
    HKBHPK\x12.\n\x0bOMPJNNIJNPL\x18\x08\x20\x01(\x0b2\x0c.DCMCLLPDDJOR\x0bO\
    MPJNNIJNPLb\x06proto3\
";
