...
pub struct AlleyEventChangeNotify {
    // message fields
    // @@protoc_insertion_point(field:AlleyEventChangeNotify.OPHMNNHHNEI)
    pub OPHMNNHHNEI: u32,
    // @@protoc_insertion_point(field:AlleyEventChangeNotify.HOKNNHDKMHP)
    pub HOKNNHDKMHP: ::protobuf::MessageField<super::FBMJMHIIODF::FBMJMHIIODF>,
    // special fields
...
impl AlleyEventChangeNotify {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "OPHMNNHHNEI",
            |m: &AlleyEventChangeNotify| { &m.OPHMNNHHNEI },
            |m: &mut AlleyEventChangeNotify| { &mut m.OPHMNNHHNEI },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::FBMJMHIIODF::FBMJMHIIODF>(
            "HOKNNHDKMHP",
            |m: &AlleyEventChangeNotify| { &m.HOKNNHDKMHP },
            |m: &mut AlleyEventChangeNotify| { &mut m.HOKNNHDKMHP },
        ));
...
impl ::protobuf::Message for AlleyEventChangeNotify {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                96 => {
                    self.OPHMNNHHNEI = is.read_uint32()?;
                },
                10 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.HOKNNHDKMHP)?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.OPHMNNHHNEI != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.OPHMNNHHNEI);
        }
        if let Some(v) = self.HOKNNHDKMHP.as_ref() {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.OPHMNNHHNEI != 0 {
            os.write_uint32(12, self.OPHMNNHHNEI)?;
        }
        if let Some(v) = self.HOKNNHDKMHP.as_ref() {
    ...
    fn default_instance() -> &'static AlleyEventChangeNotify {
        static instance: AlleyEventChangeNotify = AlleyEventChangeNotify {
            OPHMNNHHNEI: 0,
            HOKNNHDKMHP: ::protobuf::MessageField::none(),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1cAlleyEventChangeNotify.proto\x1a\x11FBMJMHIIODF.proto\"j\n\x16Alle\
    yEventChangeNotify\x12\x20\n\x0bOPHMNNHHNEI\x18\x0c\x20\x01(\rR\x0bOPHMN\
    NHHNEI\x12.\n\x0bHOKNNHDKMHP\x18\x01\x20\x01(\x0b2\x0c.FBMJMHIIODFR\x0bH\
    OKNNHDKMHPb\x06proto3\
";
