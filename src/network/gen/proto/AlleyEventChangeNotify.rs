...
pub struct AlleyEventChangeNotify {
    // message fields
    // @@protoc_insertion_point(field:AlleyEventChangeNotify.HOAHHDCGEEO)
    pub HOAHHDCGEEO: ::protobuf::MessageField<super::CKFJJBFEAPC::CKFJJBFEAPC>,
    // @@protoc_insertion_point(field:AlleyEventChangeNotify.AMFBGHLDGIH)
    pub AMFBGHLDGIH: u32,
    // special fields
...
impl AlleyEventChangeNotify {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::CKFJJBFEAPC::CKFJJBFEAPC>(
            "HOAHHDCGEEO",
            |m: &AlleyEventChangeNotify| { &m.HOAHHDCGEEO },
            |m: &mut AlleyEventChangeNotify| { &mut m.HOAHHDCGEEO },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "AMFBGHLDGIH",
            |m: &AlleyEventChangeNotify| { &m.AMFBGHLDGIH },
            |m: &mut AlleyEventChangeNotify| { &mut m.AMFBGHLDGIH },
        ));
...
impl ::protobuf::Message for AlleyEventChangeNotify {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                82 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.HOAHHDCGEEO)?;
                },
                56 => {
                    self.AMFBGHLDGIH = is.read_uint32()?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if let Some(v) = self.HOAHHDCGEEO.as_ref() {
            let len = v.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
        }
        if self.AMFBGHLDGIH != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.AMFBGHLDGIH);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.AMFBGHLDGIH != 0 {
            os.write_uint32(7, self.AMFBGHLDGIH)?;
        }
    ...
    fn default_instance() -> &'static AlleyEventChangeNotify {
        static instance: AlleyEventChangeNotify = AlleyEventChangeNotify {
            HOAHHDCGEEO: ::protobuf::MessageField::none(),
            AMFBGHLDGIH: 0,
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1cAlleyEventChangeNotify.proto\x1a\x11CKFJJBFEAPC.proto\"j\n\x16Alle\
    yEventChangeNotify\x12.\n\x0bHOAHHDCGEEO\x18\n\x20\x01(\x0b2\x0c.CKFJJBF\
    EAPCR\x0bHOAHHDCGEEO\x12\x20\n\x0bAMFBGHLDGIH\x18\x07\x20\x01(\rR\x0bAMF\
    BGHLDGIHb\x06proto3\
";
