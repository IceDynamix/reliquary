...
pub struct GetStarFightDataScRsp {
    ...
    pub retcode: u32,
    // @@protoc_insertion_point(field:GetStarFightDataScRsp.JAFADPCHBPP)
    pub JAFADPCHBPP: ::std::vec::Vec<super::HEFAKEFDMBL::HEFAKEFDMBL>,
    // special fields
...
impl GetStarFightDataScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "JAFADPCHBPP",
            |m: &GetStarFightDataScRsp| { &m.JAFADPCHBPP },
            |m: &mut GetStarFightDataScRsp| { &mut m.JAFADPCHBPP },
        ));
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                34 => {
                    self.JAFADPCHBPP.push(is.read_message()?);
                },
                tag => {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1bGetStarFightDataScRsp.proto\x1a\x11HEFAKEFDMBL.proto\"a\n\x15GetSt\
    arFightDataScRsp\x12\x18\n\x07retcode\x18\x03\x20\x01(\rR\x07retcode\x12\
    .\n\x0bJAFADPCHBPP\x18\x04\x20\x03(\x0b2\x0c.HEFAKEFDMBLR\x0bJAFADPCHBPP\
    b\x06proto3\
";
