...
impl ::protobuf::Message for UseItemCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.use_avatar_type != ::protobuf::EnumOrUnknown::new(super::AvatarType::AvatarType::AVATAR_TYPE_NONE) {
            my_size += ::protobuf::rt::int32_size(14, self.use_avatar_type.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.use_avatar_type != ::protobuf::EnumOrUnknown::new(super::AvatarType::AvatarType::AVATAR_TYPE_NONE) {
            os.write_enum(14, ::protobuf::EnumOrUnknown::value(&self.use_avatar_type))?;
        }
        if self.use_item_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    sReq\x123\n\x0fuse_avatar_type\x18\x0e\x20\x01(\x0e2\x0b.AvatarTypeR\rus\
    eAvatarType\x12\x1e\n\x0buse_item_id\x18\x02\x20\x01(\rR\tuseItemId\x12,\
    \n\x12optional_reward_id\x18\x0f\x20\x01(\rR\x10optionalRewardId\x12$\n\
    \x0euse_item_count\x18\x07\x20\x01(\rR\x0cuseItemCount\x12$\n\x0ebase_av\
    atar_id\x18\x0c\x20\x01(\rR\x0cbaseAvatarIdB\x15\n\x13emu.lunarcore.prot\
    ob\x06proto3\
";
