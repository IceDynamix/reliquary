...
pub struct TextJoinSaveScRsp {
    // message fields
    // @@protoc_insertion_point(field:TextJoinSaveScRsp.BDONIIOMCDH)
    pub BDONIIOMCDH: u32,
    // @@protoc_insertion_point(field:TextJoinSaveScRsp.GMEIABHHGJH)
    pub GMEIABHHGJH: ::std::string::String,
    // @@protoc_insertion_point(field:TextJoinSaveScRsp.retcode)
    pub retcode: u32,
    // @@protoc_insertion_point(field:TextJoinSaveScRsp.LDHIMDPKBJJ)
    pub LDHIMDPKBJJ: u32,
    // special fields
...
impl TextJoinSaveScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "BDONIIOMCDH",
            |m: &TextJoinSaveScRsp| { &m.BDONIIOMCDH },
            |m: &mut TextJoinSaveScRsp| { &mut m.BDONIIOMCDH },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "GMEIABHHGJH",
            |m: &TextJoinSaveScRsp| { &m.GMEIABHHGJH },
            |m: &mut TextJoinSaveScRsp| { &mut m.GMEIABHHGJH },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "retcode",
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "LDHIMDPKBJJ",
            |m: &TextJoinSaveScRsp| { &m.LDHIMDPKBJJ },
            |m: &mut TextJoinSaveScRsp| { &mut m.LDHIMDPKBJJ },
        ));
...
impl ::protobuf::Message for TextJoinSaveScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.BDONIIOMCDH != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.BDONIIOMCDH);
        }
        if !self.GMEIABHHGJH.is_empty() {
            my_size += ::protobuf::rt::string_size(6, &self.GMEIABHHGJH);
        }
        if self.retcode != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.retcode);
        }
        if self.LDHIMDPKBJJ != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.LDHIMDPKBJJ);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.BDONIIOMCDH != 0 {
            os.write_uint32(7, self.BDONIIOMCDH)?;
        }
        if !self.GMEIABHHGJH.is_empty() {
            os.write_string(6, &self.GMEIABHHGJH)?;
        }
        if self.retcode != 0 {
            os.write_uint32(3, self.retcode)?;
        }
        if self.LDHIMDPKBJJ != 0 {
            os.write_uint32(5, self.LDHIMDPKBJJ)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0bBDONIIOMCDH\x18\x07\x20\x01(\rR\x0bBDONIIOMCDH\x12\x20\n\x0bGMEIABHH\
    GJH\x18\x06\x20\x01(\tR\x0bGMEIABHHGJH\x12\x18\n\x07retcode\x18\x03\x20\
    \x01(\rR\x07retcode\x12\x20\n\x0bLDHIMDPKBJJ\x18\x05\x20\x01(\rR\x0bLDHI\
    MDPKBJJb\x06proto3\
";
