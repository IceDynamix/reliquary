...
pub struct DeleteRelicFilterPlanScRsp {
    // message fields
    // @@protoc_insertion_point(field:DeleteRelicFilterPlanScRsp.OKKJFIBNGCE)
    pub OKKJFIBNGCE: bool,
    // @@protoc_insertion_point(field:DeleteRelicFilterPlanScRsp.retcode)
    pub retcode: u32,
    // @@protoc_insertion_point(field:DeleteRelicFilterPlanScRsp.KDODMGGOLKL)
    pub KDODMGGOLKL: ::std::vec::Vec<u32>,
    // special fields
...
impl DeleteRelicFilterPlanScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "OKKJFIBNGCE",
            |m: &DeleteRelicFilterPlanScRsp| { &m.OKKJFIBNGCE },
            |m: &mut DeleteRelicFilterPlanScRsp| { &mut m.OKKJFIBNGCE },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "retcode",
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "KDODMGGOLKL",
            |m: &DeleteRelicFilterPlanScRsp| { &m.KDODMGGOLKL },
            |m: &mut DeleteRelicFilterPlanScRsp| { &mut m.KDODMGGOLKL },
        ));
...
impl ::protobuf::Message for DeleteRelicFilterPlanScRsp {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                114 => {
                    is.read_repeated_packed_uint32_into(&mut self.KDODMGGOLKL)?;
                },
                112 => {
                    self.KDODMGGOLKL.push(is.read_uint32()?);
                },
                tag => {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.OKKJFIBNGCE != false {
            os.write_bool(3, self.OKKJFIBNGCE)?;
        }
        if self.retcode != 0 {
            os.write_uint32(9, self.retcode)?;
        }
        for v in &self.KDODMGGOLKL {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    p\x12\x20\n\x0bOKKJFIBNGCE\x18\x03\x20\x01(\x08R\x0bOKKJFIBNGCE\x12\x18\
    \n\x07retcode\x18\t\x20\x01(\rR\x07retcode\x12\x20\n\x0bKDODMGGOLKL\x18\
    \x0e\x20\x03(\rR\x0bKDODMGGOLKLb\x06proto3\
";
