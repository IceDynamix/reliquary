...
impl ::protobuf::Message for Chat {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.sent_time != 0 {
            my_size += ::protobuf::rt::uint64_size(9, self.sent_time);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.sent_time != 0 {
            os.write_uint64(9, self.sent_time)?;
        }
        if self.sender_uid != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x05\x20\x01(\tR\x04text\x12#\n\x08msg_type\x18\x02\x20\x01(\x0e2\
    \x08.MsgTypeR\x07msgType\x12\x14\n\x05emote\x18\x06\x20\x01(\rR\x05emote\
    \x12\x1b\n\tsent_time\x18\t\x20\x01(\x04R\x08sentTime\x12\x1d\n\nsender_\
    uid\x18\x04\x20\x01(\rR\tsenderUidB\x15\n\x13emu.lunarcore.protob\x06pro\
    to3\
";
