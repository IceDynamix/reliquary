...
impl ::protobuf::Message for Chat {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.sender_uid != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.sender_uid);
        }
        if self.sent_time != 0 {
            my_size += ::protobuf::rt::uint64_size(5, self.sent_time);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.sender_uid != 0 {
            os.write_uint32(8, self.sender_uid)?;
        }
        if self.sent_time != 0 {
            os.write_uint64(5, self.sent_time)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x0e\x20\x01(\rR\x05emote\x12#\n\x08msg_type\x18\n\x20\x01(\x0e2\x08\
    .MsgTypeR\x07msgType\x12\x12\n\x04text\x18\x01\x20\x01(\tR\x04text\x12\
    \x1d\n\nsender_uid\x18\x08\x20\x01(\rR\tsenderUid\x12\x1b\n\tsent_time\
    \x18\x05\x20\x01(\x04R\x08sentTimeB\x15\n\x13emu.lunarcore.protob\x06pro\
    to3\
";
