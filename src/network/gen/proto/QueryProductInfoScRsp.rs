...
impl ::protobuf::Message for QueryProductInfoScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.EPCFJNOHJCL != 0 {
            my_size += ::protobuf::rt::uint64_size(11, self.EPCFJNOHJCL);
        }
        if self.CMGHDMPEAKO != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.CMGHDMPEAKO);
        }
        if self.ODNFIAAHKCI != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.ODNFIAAHKCI);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.EPCFJNOHJCL != 0 {
            os.write_uint64(11, self.EPCFJNOHJCL)?;
        }
        if self.CMGHDMPEAKO != 0 {
            os.write_uint32(14, self.CMGHDMPEAKO)?;
        }
        if self.ODNFIAAHKCI != 0 {
            os.write_uint32(10, self.ODNFIAAHKCI)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ode\x12.\n\x0bPIDHEGPBCJI\x18\x0f\x20\x03(\x0b2\x0c.AAPNHPAMDCKR\x0bPIDH\
    EGPBCJI\x12\x20\n\x0bEPCFJNOHJCL\x18\x0b\x20\x01(\x04R\x0bEPCFJNOHJCL\
    \x12\x20\n\x0bCMGHDMPEAKO\x18\x0e\x20\x01(\rR\x0bCMGHDMPEAKO\x12\x20\n\
    \x0bODNFIAAHKCI\x18\n\x20\x01(\rR\x0bODNFIAAHKCIb\x06proto3\
";
