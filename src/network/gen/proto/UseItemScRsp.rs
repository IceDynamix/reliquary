...
impl ::protobuf::Message for UseItemScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.use_item_count != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.use_item_count);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.use_item_count != 0 {
            os.write_uint32(6, self.use_item_count)?;
        }
        if let Some(v) = self.return_data.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    sp\x12$\n\x0euse_item_count\x18\x06\x20\x01(\rR\x0cuseItemCount\x12*\n\
    \x0breturn_data\x18\x01\x20\x01(\x0b2\t.ItemListR\nreturnData\x12\x1e\n\
    \x0buse_item_id\x18\x03\x20\x01(\rR\tuseItemId\x12\x18\n\x07retcode\x18\
    \x07\x20\x01(\rR\x07retcodeB\x15\n\x13emu.lunarcore.protob\x06proto3\
";
