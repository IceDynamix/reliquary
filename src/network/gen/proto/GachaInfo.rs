...
impl ::protobuf::Message for GachaInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.history_url.is_empty() {
            my_size += ::protobuf::rt::string_size(4, &self.history_url);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.history_url.is_empty() {
            os.write_string(4, &self.history_url)?;
        }
        if let Some(v) = self.gacha_ceiling.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12\x19\n\x08end_time\x18\x07\x20\x01(\x03R\x07endTime\x12\x17\n\x07up_\
    info\x18\x0b\x20\x03(\rR\x06upInfo\x12\x1f\n\x0bhistory_url\x18\x04\x20\
    \x01(\tR\nhistoryUrl\x122\n\rgacha_ceiling\x18\x05\x20\x01(\x0b2\r.Gacha\
    CeilingR\x0cgachaCeiling\x12\x1d\n\nbegin_time\x18\x01\x20\x01(\x03R\tbe\
    ginTime\x12\x19\n\x08gacha_id\x18\n\x20\x01(\rR\x07gachaId\x12\x1d\n\nde\
    tail_url\x18\x06\x20\x01(\tR\tdetailUrl\x12\x1a\n\x08featured\x18\r\x20\
    \x03(\rR\x08featuredB\x15\n\x13emu.lunarcore.protob\x06proto3\
";
