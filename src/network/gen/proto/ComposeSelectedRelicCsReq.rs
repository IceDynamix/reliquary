...
pub struct ComposeSelectedRelicCsReq {
    // message fields
    // @@protoc_insertion_point(field:ComposeSelectedRelicCsReq.NFBGFHBEAAK)
    pub NFBGFHBEAAK: u32,
    // @@protoc_insertion_point(field:ComposeSelectedRelicCsReq.BGMIEFLMAGF)
    pub BGMIEFLMAGF: u32,
    // @@protoc_insertion_point(field:ComposeSelectedRelicCsReq.JMCAKALBKHP)
    pub JMCAKALBKHP: ::protobuf::MessageField<super::CGMLGCGMBDH::CGMLGCGMBDH>,
    // @@protoc_insertion_point(field:ComposeSelectedRelicCsReq.GPGBNLJGHCD)
    pub GPGBNLJGHCD: u32,
...
impl ComposeSelectedRelicCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "NFBGFHBEAAK",
            |m: &ComposeSelectedRelicCsReq| { &m.NFBGFHBEAAK },
            |m: &mut ComposeSelectedRelicCsReq| { &mut m.NFBGFHBEAAK },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "BGMIEFLMAGF",
            |m: &ComposeSelectedRelicCsReq| { &m.BGMIEFLMAGF },
            |m: &mut ComposeSelectedRelicCsReq| { &mut m.BGMIEFLMAGF },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::CGMLGCGMBDH::CGMLGCGMBDH>(
            "JMCAKALBKHP",
            |m: &ComposeSelectedRelicCsReq| { &m.JMCAKALBKHP },
            |m: &mut ComposeSelectedRelicCsReq| { &mut m.JMCAKALBKHP },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "GPGBNLJGHCD",
            |m: &ComposeSelectedRelicCsReq| { &m.GPGBNLJGHCD },
            |m: &mut ComposeSelectedRelicCsReq| { &mut m.GPGBNLJGHCD },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "main_affix_id",
...
impl ::protobuf::Message for ComposeSelectedRelicCsReq {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                32 => {
                    self.BGMIEFLMAGF = is.read_uint32()?;
                },
                106 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.JMCAKALBKHP)?;
                },
                56 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.NFBGFHBEAAK != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.NFBGFHBEAAK);
        }
        if self.BGMIEFLMAGF != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.BGMIEFLMAGF);
        }
        if let Some(v) = self.JMCAKALBKHP.as_ref() {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.NFBGFHBEAAK != 0 {
            os.write_uint32(9, self.NFBGFHBEAAK)?;
        }
        if self.BGMIEFLMAGF != 0 {
            os.write_uint32(4, self.BGMIEFLMAGF)?;
        }
        if let Some(v) = self.JMCAKALBKHP.as_ref() {
    ...
    fn default_instance() -> &'static ComposeSelectedRelicCsReq {
        static instance: ComposeSelectedRelicCsReq = ComposeSelectedRelicCsReq {
            NFBGFHBEAAK: 0,
            BGMIEFLMAGF: 0,
            JMCAKALBKHP: ::protobuf::MessageField::none(),
            GPGBNLJGHCD: 0,
            main_affix_id: 0,
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1fComposeSelectedRelicCsReq.proto\x1a\x11CGMLGCGMBDH.proto\"\xd5\x01\
    \n\x19ComposeSelectedRelicCsReq\x12\x20\n\x0bNFBGFHBEAAK\x18\t\x20\x01(\
    \rR\x0bNFBGFHBEAAK\x12\x20\n\x0bBGMIEFLMAGF\x18\x04\x20\x01(\rR\x0bBGMIE\
    FLMAGF\x12.\n\x0bJMCAKALBKHP\x18\r\x20\x01(\x0b2\x0c.CGMLGCGMBDHR\x0bJMC\
    AKALBKHP\x12\x20\n\x0bGPGBNLJGHCD\x18\x07\x20\x01(\rR\x0bGPGBNLJGHCD\x12\
    \"\n\rmain_affix_id\x18\x05\x20\x01(\rR\x0bmainAffixIdb\x06proto3\
";
