...
impl ::protobuf::Message for ComposeSelectedRelicCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.LOMDAGHOLKC != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.LOMDAGHOLKC);
        }
        ...
        if self.JDOEKFEMOJA != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.JDOEKFEMOJA);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(1, &self.GGNPAIFHPBB);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.LOMDAGHOLKC != 0 {
            os.write_uint32(8, self.LOMDAGHOLKC)?;
        }
        if let Some(v) = self.GJFMNMOKAIC.as_ref() {
        ...
        if self.JDOEKFEMOJA != 0 {
            os.write_uint32(6, self.JDOEKFEMOJA)?;
        }
        os.write_repeated_packed_uint32(1, &self.GGNPAIFHPBB)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x19ComposeSelectedRelicCsReq\x12\x20\n\x0bLOMDAGHOLKC\x18\x08\x20\x01\
    (\rR\x0bLOMDAGHOLKC\x12.\n\x0bGJFMNMOKAIC\x18\t\x20\x01(\x0b2\x0c.KNAPAI\
    OFJIER\x0bGJFMNMOKAIC\x12.\n\x0bFBGODFJICLL\x18\x05\x20\x01(\x0b2\x0c.KN\
    APAIOFJIER\x0bFBGODFJICLL\x12\x20\n\x0bLEBFMHHIDNC\x18\r\x20\x01(\rR\x0b\
    LEBFMHHIDNC\x12\"\n\rmain_affix_id\x18\x0b\x20\x01(\rR\x0bmainAffixId\
    \x12\x20\n\x0bJDOEKFEMOJA\x18\x06\x20\x01(\rR\x0bJDOEKFEMOJA\x12\x20\n\
    \x0bGGNPAIFHPBB\x18\x01\x20\x03(\rR\x0bGGNPAIFHPBBb\x06proto3\
";
