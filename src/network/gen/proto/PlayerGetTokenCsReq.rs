...
impl ::protobuf::Message for PlayerGetTokenCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.account_uid.is_empty() {
            my_size += ::protobuf::rt::string_size(14, &self.account_uid);
        }
        if self.platform_type != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.platform_type);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if !self.account_uid.is_empty() {
            os.write_string(14, &self.account_uid)?;
        }
        if self.platform_type != 0 {
            os.write_uint32(7, self.platform_type)?;
        }
        if !self.token.is_empty() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0baccount_uid\x18\x0e\x20\x01(\tR\naccountUid\x12#\n\rplatform_type\
    \x18\x07\x20\x01(\rR\x0cplatformType\x12\x14\n\x05token\x18\x0b\x20\x01(\
