...
pub struct SetGenderScRsp {
    ...
    pub retcode: u32,
    // @@protoc_insertion_point(field:SetGenderScRsp.OADEDDNNDDJ)
    pub OADEDDNNDDJ: ::std::vec::Vec<super::MultiPathAvatarTypeInfo::MultiPathAvatarTypeInfo>,
    // @@protoc_insertion_point(field:SetGenderScRsp.EFADNKKLHKM)
...
impl SetGenderScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "OADEDDNNDDJ",
            |m: &SetGenderScRsp| { &m.OADEDDNNDDJ },
            |m: &mut SetGenderScRsp| { &mut m.OADEDDNNDDJ },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "EFADNKKLHKM",
            |m: &SetGenderScRsp| { &m.EFADNKKLHKM },
            |m: &mut SetGenderScRsp| { &mut m.EFADNKKLHKM },
        ));
...
impl ::protobuf::Message for SetGenderScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.EFADNKKLHKM != ::protobuf::EnumOrUnknown::new(super::MultiPathAvatarType::MultiPathAvatarType::MultiPathAvatarTypeNone) {
            my_size += ::protobuf::rt::int32_size(10, self.EFADNKKLHKM.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.EFADNKKLHKM != ::protobuf::EnumOrUnknown::new(super::MultiPathAvatarType::MultiPathAvatarType::MultiPathAvatarTypeNone) {
            os.write_enum(10, ::protobuf::EnumOrUnknown::value(&self.EFADNKKLHKM))?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    PathAvatarTypeInfo.proto\"\x9e\x01\n\x0eSetGenderScRsp\x12\x18\n\x07retc\
    ode\x18\x04\x20\x01(\rR\x07retcode\x12:\n\x0bOADEDDNNDDJ\x18\x0e\x20\x03\
    (\x0b2\x18.MultiPathAvatarTypeInfoR\x0bOADEDDNNDDJ\x126\n\x0bEFADNKKLHKM\
    \x18\n\x20\x01(\x0e2\x14.MultiPathAvatarTypeR\x0bEFADNKKLHKMb\x06proto3\
";
