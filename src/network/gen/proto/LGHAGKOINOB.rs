...
//! Generated file from `LGHAGKOINOB.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:LGHAGKOINOB)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct LGHAGKOINOB {
    // message fields
    ...
    // special fields
    // @@protoc_insertion_point(special_field:LGHAGKOINOB.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a LGHAGKOINOB {
    fn default() -> &'a LGHAGKOINOB {
        <LGHAGKOINOB as ::protobuf::Message>::default_instance()
    }
}

impl LGHAGKOINOB {
    pub fn new() -> LGHAGKOINOB {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "NFOPIKDKPGG",
            |m: &LGHAGKOINOB| { &m.NFOPIKDKPGG },
            |m: &mut LGHAGKOINOB| { &mut m.NFOPIKDKPGG },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<LGHAGKOINOB>(
            "LGHAGKOINOB",
            fields,
            oneofs,
        )
...
impl ::protobuf::Message for LGHAGKOINOB {
    const NAME: &'static str = "LGHAGKOINOB";
...
impl ::protobuf::MessageFull for LGHAGKOINOB {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("LGHAGKOINOB").unwrap()).clone()
    }
}

impl ::std::fmt::Display for LGHAGKOINOB {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for LGHAGKOINOB {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(LGHAGKOINOB::generated_message_descriptor_data());
