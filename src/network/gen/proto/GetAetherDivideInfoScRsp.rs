...
impl ::protobuf::Message for GetAetherDivideInfoScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.PHLKDNGHOOA != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.PHLKDNGHOOA);
        }
        ...
        if self.PFLJGGDAOFM != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.PFLJGGDAOFM);
        }
        if self.EGEMNDNEDIP != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.EGEMNDNEDIP);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.PHLKDNGHOOA != 0 {
            os.write_uint32(9, self.PHLKDNGHOOA)?;
        }
        for v in &self.BMKPHJICOKC {
            ::protobuf::rt::write_message_field_with_cached_size(12, v, os)?;
        };
        if self.PFLJGGDAOFM != 0 {
            os.write_uint32(11, self.PFLJGGDAOFM)?;
        }
        if self.EGEMNDNEDIP != 0 {
            os.write_uint32(4, self.EGEMNDNEDIP)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    foScRsp\x12\x20\n\x0bIBCIPIIDCOL\x18\x01\x20\x01(\rR\x0bIBCIPIIDCOL\x12\
    \x20\n\x0bPHLKDNGHOOA\x18\t\x20\x01(\rR\x0bPHLKDNGHOOA\x12.\n\x0bBMKPHJI\
    COKC\x18\x0c\x20\x03(\x0b2\x0c.JHJLEPEFADFR\x0bBMKPHJICOKC\x12\x20\n\x0b\
    PFLJGGDAOFM\x18\x0b\x20\x01(\rR\x0bPFLJGGDAOFM\x12\x20\n\x0bEGEMNDNEDIP\
    \x18\x04\x20\x01(\rR\x0bEGEMNDNEDIP\x12\x18\n\x07retcode\x18\n\x20\x01(\
    \rR\x07retcode\x12\x20\n\x0bJDHLMHJBOJM\x18\x0f\x20\x01(\rR\x0bJDHLMHJBO\
    JM\x12.\n\x0bBCHKCFCOPEI\x18\x08\x20\x03(\x0b2\x0c.IBMCNAFOBNBR\x0bBCHKC\
    FCOPEI\x12.\n\x0bNLFIHKICDDO\x18\x05\x20\x03(\x0b2\x0c.GJILPEBEOOLR\x0bN\
    LFIHKICDDOb\x06proto3\
";
