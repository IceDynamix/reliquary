...
pub struct TextJoinQueryCsReq {
    // message fields
    // @@protoc_insertion_point(field:TextJoinQueryCsReq.CPKDNDFFHEM)
    pub CPKDNDFFHEM: ::std::vec::Vec<u32>,
    // special fields
...
impl TextJoinQueryCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "CPKDNDFFHEM",
            |m: &TextJoinQueryCsReq| { &m.CPKDNDFFHEM },
            |m: &mut TextJoinQueryCsReq| { &mut m.CPKDNDFFHEM },
        ));
...
impl ::protobuf::Message for TextJoinQueryCsReq {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                90 => {
                    is.read_repeated_packed_uint32_into(&mut self.CPKDNDFFHEM)?;
                },
                88 => {
                    self.CPKDNDFFHEM.push(is.read_uint32()?);
                },
                tag => {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    PKDNDFFHEM\x18\x0b\x20\x03(\rR\x0bCPKDNDFFHEMb\x06proto3\
";
