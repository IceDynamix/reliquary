...
pub struct ChessRogueGiveUpRollScRsp {
    // message fields
    // @@protoc_insertion_point(field:ChessRogueGiveUpRollScRsp.AAPJLBGNFLG)
    pub AAPJLBGNFLG: ::protobuf::MessageField<super::ItemList::ItemList>,
    // @@protoc_insertion_point(field:ChessRogueGiveUpRollScRsp.LHINNDFFHHC)
...
impl ChessRogueGiveUpRollScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::ItemList::ItemList>(
            "AAPJLBGNFLG",
            |m: &ChessRogueGiveUpRollScRsp| { &m.AAPJLBGNFLG },
            |m: &mut ChessRogueGiveUpRollScRsp| { &mut m.AAPJLBGNFLG },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::LNFJDOCNPOM::LNFJDOCNPOM>(
            "LHINNDFFHHC",
            |m: &ChessRogueGiveUpRollScRsp| { &m.LHINNDFFHHC },
            |m: &mut ChessRogueGiveUpRollScRsp| { &mut m.LHINNDFFHHC },
        ));
...
impl ::protobuf::Message for ChessRogueGiveUpRollScRsp {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                90 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.AAPJLBGNFLG)?;
                },
                18 => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if let Some(v) = self.AAPJLBGNFLG.as_ref() {
    ...
    fn default_instance() -> &'static ChessRogueGiveUpRollScRsp {
        static instance: ChessRogueGiveUpRollScRsp = ChessRogueGiveUpRollScRsp {
            AAPJLBGNFLG: ::protobuf::MessageField::none(),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1fChessRogueGiveUpRollScRsp.proto\x1a\x0eItemList.proto\x1a\x11LNFJD\
    OCNPOM.proto\"\x92\x01\n\x19ChessRogueGiveUpRollScRsp\x12+\n\x0bAAPJLBGN\
    FLG\x18\x0b\x20\x01(\x0b2\t.ItemListR\x0bAAPJLBGNFLG\x12.\n\x0bLHINNDFFH\
    HC\x18\x02\x20\x01(\x0b2\x0c.LNFJDOCNPOMR\x0bLHINNDFFHHC\x12\x18\n\x07re\
