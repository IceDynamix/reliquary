...
pub struct PlayerHeartBeatScRsp {
    // message fields
    // @@protoc_insertion_point(field:PlayerHeartBeatScRsp.OFHLAAHPJMM)
    pub OFHLAAHPJMM: u64,
    // @@protoc_insertion_point(field:PlayerHeartBeatScRsp.OLHAHCPNGCE)
    pub OLHAHCPNGCE: u64,
    // @@protoc_insertion_point(field:PlayerHeartBeatScRsp.retcode)
    pub retcode: u32,
    // @@protoc_insertion_point(field:PlayerHeartBeatScRsp.ADFIOHIHPMJ)
...
impl PlayerHeartBeatScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "OFHLAAHPJMM",
            |m: &PlayerHeartBeatScRsp| { &m.OFHLAAHPJMM },
            |m: &mut PlayerHeartBeatScRsp| { &mut m.OFHLAAHPJMM },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "OLHAHCPNGCE",
            |m: &PlayerHeartBeatScRsp| { &m.OLHAHCPNGCE },
            |m: &mut PlayerHeartBeatScRsp| { &mut m.OLHAHCPNGCE },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "retcode",
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::GECGIJIIHDI::GECGIJIIHDI>(
            "ADFIOHIHPMJ",
            |m: &PlayerHeartBeatScRsp| { &m.ADFIOHIHPMJ },
            |m: &mut PlayerHeartBeatScRsp| { &mut m.ADFIOHIHPMJ },
        ));
...
impl ::protobuf::Message for PlayerHeartBeatScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.OFHLAAHPJMM != 0 {
            my_size += ::protobuf::rt::uint64_size(1, self.OFHLAAHPJMM);
        }
        if self.OLHAHCPNGCE != 0 {
            my_size += ::protobuf::rt::uint64_size(8, self.OLHAHCPNGCE);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.OFHLAAHPJMM != 0 {
            os.write_uint64(1, self.OFHLAAHPJMM)?;
        }
        if self.OLHAHCPNGCE != 0 {
            os.write_uint64(8, self.OLHAHCPNGCE)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1aPlayerHeartBeatScRsp.proto\x1a\x11GECGIJIIHDI.proto\"\xa4\x01\n\
    \x14PlayerHeartBeatScRsp\x12\x20\n\x0bOFHLAAHPJMM\x18\x01\x20\x01(\x04R\
    \x0bOFHLAAHPJMM\x12\x20\n\x0bOLHAHCPNGCE\x18\x08\x20\x01(\x04R\x0bOLHAHC\
    PNGCE\x12\x18\n\x07retcode\x18\x0f\x20\x01(\rR\x07retcode\x12.\n\x0bADFI\
    OHIHPMJ\x18\x0c\x20\x01(\x0b2\x0c.GECGIJIIHDIR\x0bADFIOHIHPMJb\x06proto3\
";
