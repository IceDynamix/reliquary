...
pub struct FinishChessRogueSubStoryScRsp {
    // message fields
    // @@protoc_insertion_point(field:FinishChessRogueSubStoryScRsp.GKEJFEAKPAH)
    pub GKEJFEAKPAH: u32,
    // @@protoc_insertion_point(field:FinishChessRogueSubStoryScRsp.MKCLAPDPKDD)
    pub MKCLAPDPKDD: u32,
    // @@protoc_insertion_point(field:FinishChessRogueSubStoryScRsp.retcode)
    pub retcode: u32,
    // @@protoc_insertion_point(field:FinishChessRogueSubStoryScRsp.LONLLBIHMID)
    pub LONLLBIHMID: u32,
    // @@protoc_insertion_point(field:FinishChessRogueSubStoryScRsp.OPINDDBIODB)
    pub OPINDDBIODB: u32,
    // special fields
...
impl FinishChessRogueSubStoryScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "GKEJFEAKPAH",
            |m: &FinishChessRogueSubStoryScRsp| { &m.GKEJFEAKPAH },
            |m: &mut FinishChessRogueSubStoryScRsp| { &mut m.GKEJFEAKPAH },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "MKCLAPDPKDD",
            |m: &FinishChessRogueSubStoryScRsp| { &m.MKCLAPDPKDD },
            |m: &mut FinishChessRogueSubStoryScRsp| { &mut m.MKCLAPDPKDD },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "retcode",
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "LONLLBIHMID",
            |m: &FinishChessRogueSubStoryScRsp| { &m.LONLLBIHMID },
            |m: &mut FinishChessRogueSubStoryScRsp| { &mut m.LONLLBIHMID },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "OPINDDBIODB",
            |m: &FinishChessRogueSubStoryScRsp| { &m.OPINDDBIODB },
            |m: &mut FinishChessRogueSubStoryScRsp| { &mut m.OPINDDBIODB },
        ));
...
impl ::protobuf::Message for FinishChessRogueSubStoryScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.GKEJFEAKPAH != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.GKEJFEAKPAH);
        }
        ...
        if self.LONLLBIHMID != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.LONLLBIHMID);
        }
        if self.OPINDDBIODB != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.OPINDDBIODB);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.GKEJFEAKPAH != 0 {
            os.write_uint32(1, self.GKEJFEAKPAH)?;
        }
        if self.MKCLAPDPKDD != 0 {
        ...
        if self.LONLLBIHMID != 0 {
            os.write_uint32(7, self.LONLLBIHMID)?;
        }
        if self.OPINDDBIODB != 0 {
            os.write_uint32(13, self.OPINDDBIODB)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    bStoryScRsp\x12\x20\n\x0bGKEJFEAKPAH\x18\x01\x20\x01(\rR\x0bGKEJFEAKPAH\
    \x12\x20\n\x0bMKCLAPDPKDD\x18\x0e\x20\x01(\rR\x0bMKCLAPDPKDD\x12\x18\n\
    \x07retcode\x18\x06\x20\x01(\rR\x07retcode\x12\x20\n\x0bLONLLBIHMID\x18\
    \x07\x20\x01(\rR\x0bLONLLBIHMID\x12\x20\n\x0bOPINDDBIODB\x18\r\x20\x01(\
    \rR\x0bOPINDDBIODBb\x06proto3\
";
