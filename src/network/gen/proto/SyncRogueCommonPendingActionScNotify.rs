...
impl ::protobuf::Message for SyncRogueCommonPendingActionScNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.rogue_version_id != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.rogue_version_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.rogue_version_id != 0 {
            os.write_uint32(3, self.rogue_version_id)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ogue_common_pending_action\x18\x0e\x20\x01(\x0b2\x19.RogueCommonPendingA\
    ctionR\x18rogueCommonPendingAction\x12(\n\x10rogue_version_id\x18\x03\
