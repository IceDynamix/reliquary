...
//! Generated file from `LPILGJEPAGJ.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:LPILGJEPAGJ)
...
impl<'a> ::std::default::Default for &'a LPILGJEPAGJ {
    fn default() -> &'a LPILGJEPAGJ {
        <LPILGJEPAGJ as ::protobuf::Message>::default_instance()
    }
}

impl LPILGJEPAGJ {
    pub fn new() -> LPILGJEPAGJ {
...
impl ::protobuf::Message for LPILGJEPAGJ {
    const NAME: &'static str = "LPILGJEPAGJ";
    ...
    fn default_instance() -> &'static LPILGJEPAGJ {
        static instance: ::protobuf::rt::Lazy<LPILGJEPAGJ> = ::protobuf::rt::Lazy::new();
        instance.get(LPILGJEPAGJ::new)
    }
}

impl ::protobuf::MessageFull for LPILGJEPAGJ {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("LPILGJEPAGJ").unwrap()).clone()
    }
}

impl ::std::fmt::Display for LPILGJEPAGJ {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for LPILGJEPAGJ {
