...
pub struct TrainPartyTakeBuildLevelAwardScRsp {
    // message fields
    // @@protoc_insertion_point(field:TrainPartyTakeBuildLevelAwardScRsp.ECCLPIFMMPP)
    pub ECCLPIFMMPP: u32,
    // @@protoc_insertion_point(field:TrainPartyTakeBuildLevelAwardScRsp.retcode)
    pub retcode: u32,
    // @@protoc_insertion_point(field:TrainPartyTakeBuildLevelAwardScRsp.DCPBFLJFHBB)
...
impl TrainPartyTakeBuildLevelAwardScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "ECCLPIFMMPP",
            |m: &TrainPartyTakeBuildLevelAwardScRsp| { &m.ECCLPIFMMPP },
            |m: &mut TrainPartyTakeBuildLevelAwardScRsp| { &mut m.ECCLPIFMMPP },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "retcode",
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::ItemList::ItemList>(
            "DCPBFLJFHBB",
            |m: &TrainPartyTakeBuildLevelAwardScRsp| { &m.DCPBFLJFHBB },
            |m: &mut TrainPartyTakeBuildLevelAwardScRsp| { &mut m.DCPBFLJFHBB },
        ));
...
impl ::protobuf::Message for TrainPartyTakeBuildLevelAwardScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.ECCLPIFMMPP != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.ECCLPIFMMPP);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.ECCLPIFMMPP != 0 {
            os.write_uint32(8, self.ECCLPIFMMPP)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x08\x20\x01(\rR\x0bECCLPIFMMPP\x12\x18\n\x07retcode\x18\x07\x20\x01(\rR\
    \x07retcode\x12+\n\x0bDCPBFLJFHBB\x18\x0f\x20\x01(\x0b2\t.ItemListR\x0bD\
    CPBFLJFHBBb\x06proto3\
";
