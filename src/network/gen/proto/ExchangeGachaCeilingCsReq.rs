...
pub struct ExchangeGachaCeilingCsReq {
    ...
    pub avatar_id: u32,
    // @@protoc_insertion_point(field:ExchangeGachaCeilingCsReq.IDDDLEKCICN)
    pub IDDDLEKCICN: u32,
    // special fields
...
impl ExchangeGachaCeilingCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "IDDDLEKCICN",
            |m: &ExchangeGachaCeilingCsReq| { &m.IDDDLEKCICN },
            |m: &mut ExchangeGachaCeilingCsReq| { &mut m.IDDDLEKCICN },
        ));
...
impl ::protobuf::Message for ExchangeGachaCeilingCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.IDDDLEKCICN != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.IDDDLEKCICN);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.IDDDLEKCICN != 0 {
            os.write_uint32(12, self.IDDDLEKCICN)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    EKCICN\x18\x0c\x20\x01(\rR\x0bIDDDLEKCICNb\x06proto3\
";
