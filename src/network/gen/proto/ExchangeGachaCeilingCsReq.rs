...
pub struct ExchangeGachaCeilingCsReq {
    ...
    pub avatar_id: u32,
    // @@protoc_insertion_point(field:ExchangeGachaCeilingCsReq.PGNLLENJFEJ)
    pub PGNLLENJFEJ: u32,
    // special fields
...
impl ExchangeGachaCeilingCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "PGNLLENJFEJ",
            |m: &ExchangeGachaCeilingCsReq| { &m.PGNLLENJFEJ },
            |m: &mut ExchangeGachaCeilingCsReq| { &mut m.PGNLLENJFEJ },
        ));
...
impl ::protobuf::Message for ExchangeGachaCeilingCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.PGNLLENJFEJ != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.PGNLLENJFEJ);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.PGNLLENJFEJ != 0 {
            os.write_uint32(13, self.PGNLLENJFEJ)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ENJFEJ\x18\r\x20\x01(\rR\x0bPGNLLENJFEJb\x06proto3\
";
