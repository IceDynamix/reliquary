...
impl ::protobuf::Message for ClientMail {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.template_id != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.template_id);
        }
        ...
        if self.mail_type != ::protobuf::EnumOrUnknown::new(super::MailType::MailType::MAIL_TYPE_NORMAL) {
            my_size += ::protobuf::rt::int32_size(12, self.mail_type.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.template_id != 0 {
            os.write_uint32(13, self.template_id)?;
        }
        if !self.title.is_empty() {
        ...
        if self.is_read != false {
            os.write_bool(15, self.is_read)?;
        }
        if !self.sender.is_empty() {
            os.write_string(11, &self.sender)?;
        }
        if self.mail_type != ::protobuf::EnumOrUnknown::new(super::MailType::MailType::MAIL_TYPE_NORMAL) {
            os.write_enum(12, ::protobuf::EnumOrUnknown::value(&self.mail_type))?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0btemplate_id\x18\r\x20\x01(\rR\ntemplateId\x12\x14\n\x05title\x18\x08\
    \x20\x01(\tR\x05title\x12)\n\nattachment\x18\t\x20\x01(\x0b2\t.ItemListR\
    \nattachment\x12\x17\n\x07is_read\x18\x0f\x20\x01(\x08R\x06isRead\x12\
    \x16\n\x06sender\x18\x0b\x20\x01(\tR\x06sender\x12&\n\tmail_type\x18\x0c\
    \x20\x01(\x0e2\t.MailTypeR\x08mailType\x12\x1b\n\tpara_list\x18\x07\x20\
    \x03(\tR\x08paraList\x12\x12\n\x04time\x18\n\x20\x01(\x03R\x04time\x12\
