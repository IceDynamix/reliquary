...
//! Generated file from `AMDKBOHCFIA.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:AMDKBOHCFIA)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct AMDKBOHCFIA {
    // message fields
    // @@protoc_insertion_point(field:AMDKBOHCFIA.ABLICGMCINN)
    pub ABLICGMCINN: u32,
...
impl<'a> ::std::default::Default for &'a AMDKBOHCFIA {
    fn default() -> &'a AMDKBOHCFIA {
        <AMDKBOHCFIA as ::protobuf::Message>::default_instance()
    }
}

impl AMDKBOHCFIA {
    pub fn new() -> AMDKBOHCFIA {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "ABLICGMCINN",
            |m: &AMDKBOHCFIA| { &m.ABLICGMCINN },
            |m: &mut AMDKBOHCFIA| { &mut m.ABLICGMCINN },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "CENIFNKNFNP",
...
impl ::protobuf::Message for AMDKBOHCFIA {
    const NAME: &'static str = "AMDKBOHCFIA";
...
impl ::protobuf::MessageFull for AMDKBOHCFIA {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("AMDKBOHCFIA").unwrap()).clone()
    }
}

impl ::std::fmt::Display for AMDKBOHCFIA {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for AMDKBOHCFIA {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(AMDKBOHCFIA::generated_message_descriptor_data());
