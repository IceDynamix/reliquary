...
pub struct GetTrialActivityDataScRsp {
    // message fields
    // @@protoc_insertion_point(field:GetTrialActivityDataScRsp.ADADHIHDHJC)
    pub ADADHIHDHJC: u32,
    // @@protoc_insertion_point(field:GetTrialActivityDataScRsp.OEBBDFEELBJ)
    pub OEBBDFEELBJ: ::std::vec::Vec<super::KHDEAGCENMD::KHDEAGCENMD>,
    // @@protoc_insertion_point(field:GetTrialActivityDataScRsp.AHKELHDHOCP)
    pub AHKELHDHOCP: u32,
    // special fields
...
impl GetTrialActivityDataScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "ADADHIHDHJC",
            |m: &GetTrialActivityDataScRsp| { &m.ADADHIHDHJC },
            |m: &mut GetTrialActivityDataScRsp| { &mut m.ADADHIHDHJC },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "OEBBDFEELBJ",
            |m: &GetTrialActivityDataScRsp| { &m.OEBBDFEELBJ },
            |m: &mut GetTrialActivityDataScRsp| { &mut m.OEBBDFEELBJ },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "AHKELHDHOCP",
            |m: &GetTrialActivityDataScRsp| { &m.AHKELHDHOCP },
            |m: &mut GetTrialActivityDataScRsp| { &mut m.AHKELHDHOCP },
        ));
...
impl ::protobuf::Message for GetTrialActivityDataScRsp {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                34 => {
                    self.OEBBDFEELBJ.push(is.read_message()?);
                },
                112 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        for value in &self.OEBBDFEELBJ {
            let len = value.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
        };
        if self.AHKELHDHOCP != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.AHKELHDHOCP);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        for v in &self.OEBBDFEELBJ {
            ::protobuf::rt::write_message_field_with_cached_size(4, v, os)?;
        };
        if self.AHKELHDHOCP != 0 {
            os.write_uint32(14, self.AHKELHDHOCP)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1fGetTrialActivityDataScRsp.proto\x1a\x11KHDEAGCENMD.proto\"\x8f\x01\
    \n\x19GetTrialActivityDataScRsp\x12\x20\n\x0bADADHIHDHJC\x18\t\x20\x01(\
    \rR\x0bADADHIHDHJC\x12.\n\x0bOEBBDFEELBJ\x18\x04\x20\x03(\x0b2\x0c.KHDEA\
    GCENMDR\x0bOEBBDFEELBJ\x12\x20\n\x0bAHKELHDHOCP\x18\x0e\x20\x01(\rR\x0bA\
    HKELHDHOCPb\x06proto3\
";
