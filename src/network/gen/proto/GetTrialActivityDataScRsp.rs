...
pub struct GetTrialActivityDataScRsp {
    // message fields
    // @@protoc_insertion_point(field:GetTrialActivityDataScRsp.NKDAJJECKGH)
    pub NKDAJJECKGH: ::std::vec::Vec<super::GLCJILNGIIC::GLCJILNGIIC>,
    // @@protoc_insertion_point(field:GetTrialActivityDataScRsp.retcode)
    pub retcode: u32,
    // @@protoc_insertion_point(field:GetTrialActivityDataScRsp.DHFBKNEIMBP)
    pub DHFBKNEIMBP: u32,
    // special fields
...
impl GetTrialActivityDataScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "NKDAJJECKGH",
            |m: &GetTrialActivityDataScRsp| { &m.NKDAJJECKGH },
            |m: &mut GetTrialActivityDataScRsp| { &mut m.NKDAJJECKGH },
        ));
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "DHFBKNEIMBP",
            |m: &GetTrialActivityDataScRsp| { &m.DHFBKNEIMBP },
            |m: &mut GetTrialActivityDataScRsp| { &mut m.DHFBKNEIMBP },
        ));
...
impl ::protobuf::Message for GetTrialActivityDataScRsp {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                98 => {
                    self.NKDAJJECKGH.push(is.read_message()?);
                },
                40 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.DHFBKNEIMBP != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.DHFBKNEIMBP);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.DHFBKNEIMBP != 0 {
            os.write_uint32(10, self.DHFBKNEIMBP)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1fGetTrialActivityDataScRsp.proto\x1a\x11GLCJILNGIIC.proto\"\x87\x01\
    \n\x19GetTrialActivityDataScRsp\x12.\n\x0bNKDAJJECKGH\x18\x0c\x20\x03(\
    \x0b2\x0c.GLCJILNGIICR\x0bNKDAJJECKGH\x12\x18\n\x07retcode\x18\x05\x20\
    \x01(\rR\x07retcode\x12\x20\n\x0bDHFBKNEIMBP\x18\n\x20\x01(\rR\x0bDHFBKN\
    EIMBPb\x06proto3\
";
