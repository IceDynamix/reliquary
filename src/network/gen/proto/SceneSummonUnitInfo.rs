...
impl ::protobuf::Message for SceneSummonUnitInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.life_time_ms != 0 {
            my_size += ::protobuf::rt::sint32_size(3, self.life_time_ms);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.life_time_ms != 0 {
            os.write_sint32(3, self.life_time_ms)?;
        }
        if self.create_time_ms != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x11trigger_name_list\x18\x02\x20\x03(\tR\x0ftriggerNameList\x12(\n\
    \x10caster_entity_id\x18\x06\x20\x01(\rR\x0ecasterEntityId\x12(\n\x10att\
    ach_entity_id\x18\r\x20\x01(\rR\x0eattachEntityId\x12$\n\x0esummon_unit_\
    id\x18\x05\x20\x01(\rR\x0csummonUnitId\x12\x20\n\x0clife_time_ms\x18\x03\
    \x20\x01(\x11R\nlifeTimeMs\x12$\n\x0ecreate_time_ms\x18\x0c\x20\x01(\x04\
