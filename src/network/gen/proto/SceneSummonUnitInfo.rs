...
impl ::protobuf::Message for SceneSummonUnitInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.life_time_ms != 0 {
            my_size += ::protobuf::rt::sint32_size(6, self.life_time_ms);
        }
        if self.caster_entity_id != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.caster_entity_id);
        }
        for value in &self.trigger_name_list {
            my_size += ::protobuf::rt::string_size(12, &value);
        };
        if self.create_time_ms != 0 {
            my_size += ::protobuf::rt::uint64_size(7, self.create_time_ms);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.life_time_ms != 0 {
            os.write_sint32(6, self.life_time_ms)?;
        }
        if self.caster_entity_id != 0 {
            os.write_uint32(14, self.caster_entity_id)?;
        }
        for v in &self.trigger_name_list {
            os.write_string(12, &v)?;
        };
        if self.create_time_ms != 0 {
            os.write_uint64(7, self.create_time_ms)?;
        }
        if self.summon_unit_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x10attach_entity_id\x18\x04\x20\x01(\rR\x0eattachEntityId\x12\x20\n\
    \x0clife_time_ms\x18\x06\x20\x01(\x11R\nlifeTimeMs\x12(\n\x10caster_enti\
    ty_id\x18\x0e\x20\x01(\rR\x0ecasterEntityId\x12*\n\x11trigger_name_list\
    \x18\x0c\x20\x03(\tR\x0ftriggerNameList\x12$\n\x0ecreate_time_ms\x18\x07\
    \x20\x01(\x04R\x0ccreateTimeMs\x12$\n\x0esummon_unit_id\x18\x03\x20\x01(\
    \rR\x0csummonUnitIdB\x15\n\x13emu.lunarcore.protob\x06proto3\
";
