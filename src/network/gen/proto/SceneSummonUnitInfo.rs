...
impl ::protobuf::Message for SceneSummonUnitInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.caster_entity_id != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.caster_entity_id);
        }
        ...
        if self.create_time_ms != 0 {
            my_size += ::protobuf::rt::uint64_size(15, self.create_time_ms);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.caster_entity_id != 0 {
            os.write_uint32(13, self.caster_entity_id)?;
        }
        ...
        if self.create_time_ms != 0 {
            os.write_uint64(15, self.create_time_ms)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x20\n\x0clife_time_ms\x18\x07\x20\x01(\x05R\nlifeTimeMs\x12(\n\x10caste\
    r_entity_id\x18\r\x20\x01(\rR\x0ecasterEntityId\x12*\n\x11trigger_name_l\
    ist\x18\x0c\x20\x03(\tR\x0ftriggerNameList\x12$\n\x0esummon_unit_id\x18\
    \x03\x20\x01(\rR\x0csummonUnitId\x12(\n\x10attach_entity_id\x18\x04\x20\
    \x01(\rR\x0eattachEntityId\x12$\n\x0ecreate_time_ms\x18\x0f\x20\x01(\x04\
    R\x0ccreateTimeMsB\x15\n\x13emu.lunarcore.protob\x06proto3\
";
