...
//! Generated file from `CIGJABKNKEO.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:CIGJABKNKEO)
...
pub struct CIGJABKNKEO {
    ...
    pub tid: u32,
    // special fields
    // @@protoc_insertion_point(special_field:CIGJABKNKEO.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a CIGJABKNKEO {
    fn default() -> &'a CIGJABKNKEO {
        <CIGJABKNKEO as ::protobuf::Message>::default_instance()
    }
}

impl CIGJABKNKEO {
    pub fn new() -> CIGJABKNKEO {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "tid",
            |m: &CIGJABKNKEO| { &m.tid },
            |m: &mut CIGJABKNKEO| { &mut m.tid },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<CIGJABKNKEO>(
            "CIGJABKNKEO",
            fields,
            oneofs,
        )
...
impl ::protobuf::Message for CIGJABKNKEO {
    const NAME: &'static str = "CIGJABKNKEO";
...
impl ::protobuf::MessageFull for CIGJABKNKEO {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("CIGJABKNKEO").unwrap()).clone()
    }
}

impl ::std::fmt::Display for CIGJABKNKEO {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for CIGJABKNKEO {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(CIGJABKNKEO::generated_message_descriptor_data());
