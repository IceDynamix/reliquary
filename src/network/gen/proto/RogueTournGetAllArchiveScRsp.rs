...
pub struct RogueTournGetAllArchiveScRsp {
    // message fields
    // @@protoc_insertion_point(field:RogueTournGetAllArchiveScRsp.AMFDAPBMDAM)
    pub AMFDAPBMDAM: ::std::vec::Vec<super::CNKEFABFHGG::CNKEFABFHGG>,
...
impl RogueTournGetAllArchiveScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "AMFDAPBMDAM",
            |m: &RogueTournGetAllArchiveScRsp| { &m.AMFDAPBMDAM },
            |m: &mut RogueTournGetAllArchiveScRsp| { &mut m.AMFDAPBMDAM },
        ));
...
impl ::protobuf::Message for RogueTournGetAllArchiveScRsp {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                10 => {
                    self.AMFDAPBMDAM.push(is.read_message()?);
                },
                104 => {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\"RogueTournGetAllArchiveScRsp.proto\x1a\x11CNKEFABFHGG.proto\"h\n\x1c\
    RogueTournGetAllArchiveScRsp\x12.\n\x0bAMFDAPBMDAM\x18\x01\x20\x03(\x0b2\
    \x0c.CNKEFABFHGGR\x0bAMFDAPBMDAM\x12\x18\n\x07retcode\x18\r\x20\x01(\rR\
