...
impl ::protobuf::Message for MatchThreeSetBirdPosScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.EKGDAHEOBOG != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.EKGDAHEOBOG);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.EKGDAHEOBOG != 0 {
            os.write_uint32(11, self.EKGDAHEOBOG)?;
        }
        if self.BKMPFEOCFIB != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    EOBOG\x18\x0b\x20\x01(\rR\x0bEKGDAHEOBOG\x12\x20\n\x0bBKMPFEOCFIB\x18\
    \x01\x20\x01(\rR\x0bBKMPFEOCFIBb\x06proto3\
";
