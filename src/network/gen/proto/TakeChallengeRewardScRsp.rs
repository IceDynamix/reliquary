...
pub struct TakeChallengeRewardScRsp {
    ...
    pub retcode: u32,
    // @@protoc_insertion_point(field:TakeChallengeRewardScRsp.GCFIIGOLPMF)
    pub GCFIIGOLPMF: u32,
    // @@protoc_insertion_point(field:TakeChallengeRewardScRsp.CIKDIBGLPND)
    pub CIKDIBGLPND: ::std::vec::Vec<super::IMANOPMEGID::IMANOPMEGID>,
    // special fields
...
impl TakeChallengeRewardScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "GCFIIGOLPMF",
            |m: &TakeChallengeRewardScRsp| { &m.GCFIIGOLPMF },
            |m: &mut TakeChallengeRewardScRsp| { &mut m.GCFIIGOLPMF },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "CIKDIBGLPND",
            |m: &TakeChallengeRewardScRsp| { &m.CIKDIBGLPND },
            |m: &mut TakeChallengeRewardScRsp| { &mut m.CIKDIBGLPND },
        ));
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                106 => {
                    self.CIKDIBGLPND.push(is.read_message()?);
                },
                tag => {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1eTakeChallengeRewardScRsp.proto\x1a\x11IMANOPMEGID.proto\"\x86\x01\
    \n\x18TakeChallengeRewardScRsp\x12\x18\n\x07retcode\x18\x04\x20\x01(\rR\
    \x07retcode\x12\x20\n\x0bGCFIIGOLPMF\x18\x0e\x20\x01(\rR\x0bGCFIIGOLPMF\
    \x12.\n\x0bCIKDIBGLPND\x18\r\x20\x03(\x0b2\x0c.IMANOPMEGIDR\x0bCIKDIBGLP\
    NDb\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::IMANOPMEGID::file_descriptor().clone());
