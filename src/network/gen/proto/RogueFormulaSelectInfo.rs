...
pub struct RogueFormulaSelectInfo {
    ...
    pub roll_formula_cost_data: ::protobuf::MessageField<super::LFKJBBFJDKN::LFKJBBFJDKN>,
...
impl ::protobuf::Message for RogueFormulaSelectInfo {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.hint_id != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.hint_id);
        }
        ...
        if self.roll_formula_count != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.roll_formula_count);
        }
        ...
        for value in &self.select_formula_id_list {
            my_size += ::protobuf::rt::uint32_size(9, *value);
        };
        for value in &self.handbook_unlock_formula_id_list {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.hint_id != 0 {
            os.write_uint32(5, self.hint_id)?;
        }
        if self.roll_formula_max_count != 0 {
            os.write_uint32(2, self.roll_formula_max_count)?;
        }
        if self.can_roll != false {
            os.write_bool(8, self.can_roll)?;
        }
        if self.roll_formula_count != 0 {
            os.write_uint32(1, self.roll_formula_count)?;
        }
        if self.roll_formula_free_count != 0 {
        ...
        for v in &self.select_formula_id_list {
            os.write_uint32(9, *v)?;
        };
        for v in &self.handbook_unlock_formula_id_list {
            os.write_uint32(6, *v)?;
        };
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1cRogueFormulaSelectInfo.proto\x1a\x11LFKJBBFJDKN.proto\"\xa4\x03\n\
    \x16RogueFormulaSelectInfo\x12\x17\n\x07hint_id\x18\x05\x20\x01(\rR\x06h\
    intId\x123\n\x16roll_formula_max_count\x18\x02\x20\x01(\rR\x13rollFormul\
    aMaxCount\x12\x19\n\x08can_roll\x18\x08\x20\x01(\x08R\x07canRoll\x12,\n\
    \x12roll_formula_count\x18\x01\x20\x01(\rR\x10rollFormulaCount\x125\n\
    \x17roll_formula_free_count\x18\x0b\x20\x01(\rR\x14rollFormulaFreeCount\
    \x12A\n\x16roll_formula_cost_data\x18\r\x20\x01(\x0b2\x0c.LFKJBBFJDKNR\
    \x13rollFormulaCostData\x123\n\x16select_formula_id_list\x18\t\x20\x03(\
    \rR\x13selectFormulaIdList\x12D\n\x1fhandbook_unlock_formula_id_list\x18\
    \x06\x20\x03(\rR\x1bhandbookUnlockFormulaIdListb\x06proto3\
";
