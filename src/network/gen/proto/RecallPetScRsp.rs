...
pub struct RecallPetScRsp {
    ...
    pub retcode: u32,
    // @@protoc_insertion_point(field:RecallPetScRsp.EAFGOCECBDJ)
    pub EAFGOCECBDJ: u32,
    // @@protoc_insertion_point(field:RecallPetScRsp.AJGKIKFGMPI)
    pub AJGKIKFGMPI: u32,
    // special fields
...
impl RecallPetScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "EAFGOCECBDJ",
            |m: &RecallPetScRsp| { &m.EAFGOCECBDJ },
            |m: &mut RecallPetScRsp| { &mut m.EAFGOCECBDJ },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "AJGKIKFGMPI",
            |m: &RecallPetScRsp| { &m.AJGKIKFGMPI },
            |m: &mut RecallPetScRsp| { &mut m.AJGKIKFGMPI },
        ));
...
impl ::protobuf::Message for RecallPetScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.EAFGOCECBDJ != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.EAFGOCECBDJ);
        }
        if self.AJGKIKFGMPI != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.AJGKIKFGMPI);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.EAFGOCECBDJ != 0 {
            os.write_uint32(5, self.EAFGOCECBDJ)?;
        }
        if self.AJGKIKFGMPI != 0 {
            os.write_uint32(13, self.AJGKIKFGMPI)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x07\x20\x01(\rR\x07retcode\x12\x20\n\x0bEAFGOCECBDJ\x18\x05\x20\x01\
    (\rR\x0bEAFGOCECBDJ\x12\x20\n\x0bAJGKIKFGMPI\x18\r\x20\x01(\rR\x0bAJGKIK\
    FGMPIb\x06proto3\
";
