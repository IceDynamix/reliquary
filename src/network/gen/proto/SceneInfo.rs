...
impl ::protobuf::Message for SceneInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.world_id != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.world_id);
        }
        if self.plane_id != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.plane_id);
        }
        if self.leader_entity_id != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.leader_entity_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.world_id != 0 {
            os.write_uint32(5, self.world_id)?;
        }
        if self.plane_id != 0 {
            os.write_uint32(13, self.plane_id)?;
        }
        if self.leader_entity_id != 0 {
            os.write_uint32(2, self.leader_entity_id)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    e.proto\x1a\x1aSceneEntityGroupInfo.proto\"\xff\x03\n\tSceneInfo\x12\x19\
    \n\x08floor_id\x18\x03\x20\x01(\rR\x07floorId\x12$\n\x0egame_mode_type\
    \x18\x0f\x20\x01(\rR\x0cgameModeType\x12;\n\x10group_state_list\x18\xdb\
    \x02\x20\x03(\x0b2\x10.SceneGroupStateR\x0egroupStateList\x12\"\n\rgroup\
    _id_list\x18\x04\x20\x03(\rR\x0bgroupIdList\x12\x19\n\x08entry_id\x18\
    \x0b\x20\x01(\rR\x07entryId\x120\n\x14lighten_section_list\x18\t\x20\x03\
    (\rR\x12lightenSectionList\x121\n\x0bentity_list\x18\x01\x20\x03(\x0b2\
    \x10.SceneEntityInfoR\nentityList\x12,\n\x12client_pos_version\x18\x07\
    \x20\x01(\rR\x10clientPosVersion\x12B\n\x11entity_group_list\x18\x82\x0c\
    \x20\x03(\x0b2\x15.SceneEntityGroupInfoR\x0fentityGroupList\x12\x19\n\
    \x08world_id\x18\x05\x20\x01(\rR\x07worldId\x12\x19\n\x08plane_id\x18\r\
    \x20\x01(\rR\x07planeId\x12(\n\x10leader_entity_id\x18\x02\x20\x01(\rR\
    \x0eleaderEntityIdB\x15\n\x13emu.lunarcore.protob\x06proto3\
";
