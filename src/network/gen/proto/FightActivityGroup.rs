...
impl ::protobuf::Message for FightActivityGroup {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.passed_max_difficulty_level != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.passed_max_difficulty_level);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.passed_max_difficulty_level != 0 {
            os.write_uint32(13, self.passed_max_difficulty_level)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x1bpassed_max_difficulty_level\x18\r\x20\x01(\rR\x18passedMaxDifficulty\
    Level\x12J\n\"taken_difficulty_level_reward_list\x18\x0c\x20\x03(\rR\x1e\
    takenDifficultyLevelRewardList\x12\x19\n\x08group_id\x18\x06\x20\x01(\rR\
    \x07groupId\x12(\n\x10endless_max_wave\x18\x04\x20\x01(\rR\x0eendlessMax\
    Waveb\x06proto3\
";
