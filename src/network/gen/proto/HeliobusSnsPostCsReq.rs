...
impl ::protobuf::Message for HeliobusSnsPostCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.FCLNOOGEHMC != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.FCLNOOGEHMC);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.FCLNOOGEHMC != 0 {
            os.write_uint32(8, self.FCLNOOGEHMC)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    CNP\x18\x01\x20\x01(\rR\x0bJFMOFIIDCNP\x12\x20\n\x0bFCLNOOGEHMC\x18\x08\
