...
impl ::protobuf::Message for RevcMsgScNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.emote != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.emote);
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x05toUid\x12\x14\n\x05emote\x18\x0e\x20\x01(\rR\x05emote\x12\x12\n\x04t\
    ext\x18\x08\x20\x01(\tR\x04text\x12#\n\x08msg_type\x18\x0f\x20\x01(\x0e2\
    \x08.MsgTypeR\x07msgType\x12&\n\tchat_type\x18\r\x20\x01(\x0e2\t.ChatTyp\
    eR\x08chatType\x12\x19\n\x08from_uid\x18\x04\x20\x01(\rR\x07fromUidB\x15\
