...
impl ::protobuf::Message for RevcMsgScNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.from_uid != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.from_uid);
        }
        if self.to_uid != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.from_uid != 0 {
            os.write_uint32(12, self.from_uid)?;
        }
        if self.to_uid != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x08.MsgTypeR\x07msgType\x12\x12\n\x04text\x18\x04\x20\x01(\tR\x04text\
    \x12\x14\n\x05emote\x18\x02\x20\x01(\rR\x05emote\x12\x19\n\x08from_uid\
    \x18\x0c\x20\x01(\rR\x07fromUid\x12\x15\n\x06to_uid\x18\t\x20\x01(\rR\
    \x05toUid\x12&\n\tchat_type\x18\x05\x20\x01(\x0e2\t.ChatTypeR\x08chatTyp\
