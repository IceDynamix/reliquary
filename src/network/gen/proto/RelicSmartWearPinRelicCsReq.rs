...
impl ::protobuf::Message for RelicSmartWearPinRelicCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.GEEKCAGBGMN != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.GEEKCAGBGMN);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.GEEKCAGBGMN != 0 {
            os.write_uint32(6, self.GEEKCAGBGMN)?;
        }
        if self.BAOONJDCFKD != false {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12\x20\n\x0bGEEKCAGBGMN\x18\x06\x20\x01(\rR\x0bGEEKCAGBGMN\x12\x20\n\
    \x0bBAOONJDCFKD\x18\x02\x20\x01(\x08R\x0bBAOONJDCFKD\x12\x1b\n\tavatar_i\
    d\x18\x05\x20\x01(\rR\x08avatarIdb\x06proto3\
";
