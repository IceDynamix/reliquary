...
pub struct TrainPartyGetDataScRsp {
    // message fields
    // @@protoc_insertion_point(field:TrainPartyGetDataScRsp.HHPEOIKDLMD)
    pub HHPEOIKDLMD: ::protobuf::MessageField<super::PLIPPAGGMJE::PLIPPAGGMJE>,
    // @@protoc_insertion_point(field:TrainPartyGetDataScRsp.ADADHIHDHJC)
    pub ADADHIHDHJC: u32,
    // special fields
...
impl TrainPartyGetDataScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::PLIPPAGGMJE::PLIPPAGGMJE>(
            "HHPEOIKDLMD",
            |m: &TrainPartyGetDataScRsp| { &m.HHPEOIKDLMD },
            |m: &mut TrainPartyGetDataScRsp| { &mut m.HHPEOIKDLMD },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "ADADHIHDHJC",
            |m: &TrainPartyGetDataScRsp| { &m.ADADHIHDHJC },
            |m: &mut TrainPartyGetDataScRsp| { &mut m.ADADHIHDHJC },
        ));
...
impl ::protobuf::Message for TrainPartyGetDataScRsp {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                66 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.HHPEOIKDLMD)?;
                },
                16 => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if let Some(v) = self.HHPEOIKDLMD.as_ref() {
    ...
    fn default_instance() -> &'static TrainPartyGetDataScRsp {
        static instance: TrainPartyGetDataScRsp = TrainPartyGetDataScRsp {
            HHPEOIKDLMD: ::protobuf::MessageField::none(),
            ADADHIHDHJC: 0,
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1cTrainPartyGetDataScRsp.proto\x1a\x11PLIPPAGGMJE.proto\"j\n\x16Trai\
    nPartyGetDataScRsp\x12.\n\x0bHHPEOIKDLMD\x18\x08\x20\x01(\x0b2\x0c.PLIPP\
    AGGMJER\x0bHHPEOIKDLMD\x12\x20\n\x0bADADHIHDHJC\x18\x02\x20\x01(\rR\x0bA\
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::PLIPPAGGMJE::file_descriptor().clone());
