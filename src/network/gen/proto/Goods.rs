...
impl ::protobuf::Message for Goods {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.buy_times != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.buy_times);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.buy_times != 0 {
            os.write_uint32(1, self.buy_times)?;
        }
        if self.begin_time != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x0bGoods.proto\"\x92\x01\n\x05Goods\x12\x1b\n\tbuy_times\x18\x01\x20\
    \x01(\rR\x08buyTimes\x12\x1d\n\nbegin_time\x18\x0b\x20\x01(\x03R\tbeginT\
    ime\x12\x17\n\x07item_id\x18\x08\x20\x01(\rR\x06itemId\x12\x19\n\x08good\
    s_id\x18\x07\x20\x01(\rR\x07goodsId\x12\x19\n\x08end_time\x18\x03\x20\
