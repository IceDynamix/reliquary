...
//! Generated file from `ENJHDLHKINO.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:ENJHDLHKINO)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct ENJHDLHKINO {
    // message fields
    // @@protoc_insertion_point(field:ENJHDLHKINO.KNDMEILHKEJ)
    pub KNDMEILHKEJ: ::protobuf::MessageField<super::GCFEHMENONM::GCFEHMENONM>,
    // special fields
    // @@protoc_insertion_point(special_field:ENJHDLHKINO.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a ENJHDLHKINO {
    fn default() -> &'a ENJHDLHKINO {
        <ENJHDLHKINO as ::protobuf::Message>::default_instance()
    }
}

impl ENJHDLHKINO {
    pub fn new() -> ENJHDLHKINO {
...
impl ::protobuf::Message for ENJHDLHKINO {
    const NAME: &'static str = "ENJHDLHKINO";
...
impl ::protobuf::MessageFull for ENJHDLHKINO {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("ENJHDLHKINO").unwrap()).clone()
    }
}

impl ::std::fmt::Display for ENJHDLHKINO {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for ENJHDLHKINO {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x11ENJHDLHKINO.proto\x1a\x11GCFEHMENONM.proto\"=\n\x0bENJHDLHKINO\x12\
    .\n\x0bKNDMEILHKEJ\x18\x01\x20\x01(\x0b2\x0c.GCFEHMENONMR\x0bKNDMEILHKEJ\
    b\x06proto3\
";
