...
impl ::protobuf::Message for RefreshTriggerByClientScNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.AAKOLAHMAPG != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.AAKOLAHMAPG);
        }
        if !self.KKCEGAIBADO.is_empty() {
            my_size += ::protobuf::rt::string_size(14, &self.KKCEGAIBADO);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(4, &self.OLPGLIGLHGC);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.AAKOLAHMAPG != 0 {
            os.write_uint32(8, self.AAKOLAHMAPG)?;
        }
        if !self.KKCEGAIBADO.is_empty() {
            os.write_string(14, &self.KKCEGAIBADO)?;
        }
        os.write_repeated_packed_uint32(4, &self.OLPGLIGLHGC)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    lientScNotify\x12\x20\n\x0bAAKOLAHMAPG\x18\x08\x20\x01(\rR\x0bAAKOLAHMAP\
    G\x12\x20\n\x0bKKCEGAIBADO\x18\x0e\x20\x01(\tR\x0bKKCEGAIBADO\x12\x20\n\
    \x0bOLPGLIGLHGC\x18\x04\x20\x03(\rR\x0bOLPGLIGLHGCb\x06proto3\
";
