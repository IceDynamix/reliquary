...
impl ::protobuf::Message for RefreshTriggerByClientScNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.trigger_entity_id != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.trigger_entity_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.trigger_entity_id != 0 {
            os.write_uint32(7, self.trigger_entity_id)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    lientScNotify\x12!\n\x0ctrigger_name\x18\x01\x20\x01(\tR\x0btriggerName\
    \x123\n\x16trigger_target_id_list\x18\x05\x20\x03(\rR\x13triggerTargetId\
    List\x12*\n\x11trigger_entity_id\x18\x07\x20\x01(\rR\x0ftriggerEntityIdB\
