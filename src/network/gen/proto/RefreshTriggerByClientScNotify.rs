...
pub struct RefreshTriggerByClientScNotify {
    // message fields
    // @@protoc_insertion_point(field:RefreshTriggerByClientScNotify.KKCEGAIBADO)
    pub KKCEGAIBADO: ::std::string::String,
    // @@protoc_insertion_point(field:RefreshTriggerByClientScNotify.OLPGLIGLHGC)
    pub OLPGLIGLHGC: ::std::vec::Vec<u32>,
    // @@protoc_insertion_point(field:RefreshTriggerByClientScNotify.AAKOLAHMAPG)
    pub AAKOLAHMAPG: u32,
    // special fields
...
impl RefreshTriggerByClientScNotify {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "KKCEGAIBADO",
            |m: &RefreshTriggerByClientScNotify| { &m.KKCEGAIBADO },
            |m: &mut RefreshTriggerByClientScNotify| { &mut m.KKCEGAIBADO },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "OLPGLIGLHGC",
            |m: &RefreshTriggerByClientScNotify| { &m.OLPGLIGLHGC },
            |m: &mut RefreshTriggerByClientScNotify| { &mut m.OLPGLIGLHGC },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "AAKOLAHMAPG",
            |m: &RefreshTriggerByClientScNotify| { &m.AAKOLAHMAPG },
            |m: &mut RefreshTriggerByClientScNotify| { &mut m.AAKOLAHMAPG },
        ));
...
impl ::protobuf::Message for RefreshTriggerByClientScNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.KKCEGAIBADO.is_empty() {
            my_size += ::protobuf::rt::string_size(13, &self.KKCEGAIBADO);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(15, &self.OLPGLIGLHGC);
        if self.AAKOLAHMAPG != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.AAKOLAHMAPG);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if !self.KKCEGAIBADO.is_empty() {
            os.write_string(13, &self.KKCEGAIBADO)?;
        }
        os.write_repeated_packed_uint32(15, &self.OLPGLIGLHGC)?;
        if self.AAKOLAHMAPG != 0 {
            os.write_uint32(6, self.AAKOLAHMAPG)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    lientScNotify\x12\x20\n\x0bKKCEGAIBADO\x18\r\x20\x01(\tR\x0bKKCEGAIBADO\
    \x12\x20\n\x0bOLPGLIGLHGC\x18\x0f\x20\x03(\rR\x0bOLPGLIGLHGC\x12\x20\n\
    \x0bAAKOLAHMAPG\x18\x06\x20\x01(\rR\x0bAAKOLAHMAPGb\x06proto3\
";
