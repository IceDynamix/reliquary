...
pub struct SwordTrainingSelectEndingCsReq {
    // message fields
    // @@protoc_insertion_point(field:SwordTrainingSelectEndingCsReq.AMDMIAEJNEM)
    pub AMDMIAEJNEM: u32,
    // special fields
...
impl SwordTrainingSelectEndingCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "AMDMIAEJNEM",
            |m: &SwordTrainingSelectEndingCsReq| { &m.AMDMIAEJNEM },
            |m: &mut SwordTrainingSelectEndingCsReq| { &mut m.AMDMIAEJNEM },
        ));
...
impl ::protobuf::Message for SwordTrainingSelectEndingCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.AMDMIAEJNEM != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.AMDMIAEJNEM);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.AMDMIAEJNEM != 0 {
            os.write_uint32(1, self.AMDMIAEJNEM)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    gCsReq\x12\x20\n\x0bAMDMIAEJNEM\x18\x01\x20\x01(\rR\x0bAMDMIAEJNEMb\x06p\
    roto3\
";
