...
impl ::protobuf::Message for JNIPIAADOIP {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.BLMNEKFPAGH != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.BLMNEKFPAGH);
        }
        if self.MLGFJGCHONH != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.MLGFJGCHONH);
        }
        if self.DKHIGCIPEKF != false {
            my_size += 1 + 1;
        }
        if self.HJNOIENGEDL != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.HJNOIENGEDL);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.BIINNCNDPCG != false {
            os.write_bool(4, self.BIINNCNDPCG)?;
        }
        if self.BLMNEKFPAGH != 0 {
            os.write_uint32(15, self.BLMNEKFPAGH)?;
        }
        if self.MLGFJGCHONH != 0 {
            os.write_uint32(6, self.MLGFJGCHONH)?;
        }
        if self.DKHIGCIPEKF != false {
            os.write_bool(10, self.DKHIGCIPEKF)?;
        }
        if self.HJNOIENGEDL != 0 {
            os.write_uint32(3, self.HJNOIENGEDL)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    NJK\x18\t\x20\x01(\x03R\x0bBCFBFMMENJK\x12\x20\n\x0bBIINNCNDPCG\x18\x04\
    \x20\x01(\x08R\x0bBIINNCNDPCG\x12\x20\n\x0bBLMNEKFPAGH\x18\x0f\x20\x01(\
    \rR\x0bBLMNEKFPAGH\x12\x20\n\x0bMLGFJGCHONH\x18\x06\x20\x01(\rR\x0bMLGFJ\
    GCHONH\x12\x20\n\x0bDKHIGCIPEKF\x18\n\x20\x01(\x08R\x0bDKHIGCIPEKF\x12\
    \x20\n\x0bHJNOIENGEDL\x18\x03\x20\x01(\rR\x0bHJNOIENGEDLb\x06proto3\
";
