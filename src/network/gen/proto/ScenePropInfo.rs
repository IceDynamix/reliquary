...
impl ::protobuf::Message for ScenePropInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.prop_id != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.prop_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.prop_id != 0 {
            os.write_uint32(12, self.prop_id)?;
        }
        if self.prop_state != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ropInfo\x12\x20\n\x0clife_time_ms\x18\x0b\x20\x01(\rR\nlifeTimeMs\x12-\n\
    \nextra_info\x18\t\x20\x01(\x0b2\x0e.PropExtraInfoR\textraInfo\x12\x17\n\
    \x07prop_id\x18\x0c\x20\x01(\rR\x06propId\x12\x1d\n\nprop_state\x18\x01\
    \x20\x01(\rR\tpropState\x12$\n\x0ecreate_time_ms\x18\x07\x20\x01(\x04R\
