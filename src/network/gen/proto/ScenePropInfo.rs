...
impl ::protobuf::Message for ScenePropInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.prop_state != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.prop_state);
        }
        if self.prop_id != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.prop_id);
        }
        if self.life_time_ms != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.life_time_ms);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.prop_state != 0 {
            os.write_uint32(15, self.prop_state)?;
        }
        if self.prop_id != 0 {
            os.write_uint32(1, self.prop_id)?;
        }
        if self.life_time_ms != 0 {
            os.write_uint32(9, self.life_time_ms)?;
        }
        if self.create_time_ms != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ropInfo\x12\x1d\n\nprop_state\x18\x0f\x20\x01(\rR\tpropState\x12\x17\n\
    \x07prop_id\x18\x01\x20\x01(\rR\x06propId\x12\x20\n\x0clife_time_ms\x18\
    \t\x20\x01(\rR\nlifeTimeMs\x12$\n\x0ecreate_time_ms\x18\r\x20\x01(\x04R\
    \x0ccreateTimeMs\x12*\n\x11trigger_name_list\x18\x0c\x20\x03(\tR\x0ftrig\
    gerNameList\x12-\n\nextra_info\x18\x03\x20\x01(\x0b2\x0e.PropExtraInfoR\
