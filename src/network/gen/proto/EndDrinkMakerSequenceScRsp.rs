...
impl ::protobuf::Message for EndDrinkMakerSequenceScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.tips != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.tips);
        }
        if self.next_sequence_id != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.next_sequence_id);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.tips != 0 {
            os.write_uint32(10, self.tips)?;
        }
        if self.next_sequence_id != 0 {
            os.write_uint32(7, self.next_sequence_id)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    SequenceScRsp\x12\x14\n\x05level\x18\r\x20\x01(\rR\x05level\x12\x10\n\
    \x03exp\x18\x06\x20\x01(\rR\x03exp\x12/\n\x0crequest_list\x18\x01\x20\
    \x03(\x0b2\x0c.MFLPAMAFJNCR\x0brequestList\x12!\n\x06reward\x18\x03\x20\
    \x01(\x0b2\t.ItemListR\x06reward\x12&\n\x05guest\x18\x0c\x20\x01(\x0b2\
    \x10.DrinkMakerGuestR\x05guest\x12\x12\n\x04tips\x18\n\x20\x01(\rR\x04ti\
    ps\x12(\n\x10next_sequence_id\x18\x07\x20\x01(\rR\x0enextSequenceId\x12\
