...
pub struct EndDrinkMakerSequenceScRsp {
    ...
    pub request_list: ::std::vec::Vec<super::BKFLLOHDLEM::BKFLLOHDLEM>,
    // special fields
...
impl ::protobuf::Message for EndDrinkMakerSequenceScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.tips != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.tips);
        }
        if self.exp != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.exp);
        }
        if self.next_sequence_id != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.next_sequence_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.tips != 0 {
            os.write_uint32(9, self.tips)?;
        }
        if self.exp != 0 {
            os.write_uint32(4, self.exp)?;
        }
        if self.next_sequence_id != 0 {
            os.write_uint32(11, self.next_sequence_id)?;
        }
        if let Some(v) = self.guest.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x20EndDrinkMakerSequenceScRsp.proto\x1a\x11BKFLLOHDLEM.proto\x1a\x15D\
    rinkMakerGuest.proto\x1a\x0eItemList.proto\"\x98\x02\n\x1aEndDrinkMakerS\
    equenceScRsp\x12!\n\x06reward\x18\x0c\x20\x01(\x0b2\t.ItemListR\x06rewar\
    d\x12\x12\n\x04tips\x18\t\x20\x01(\rR\x04tips\x12\x10\n\x03exp\x18\x04\
    \x20\x01(\rR\x03exp\x12(\n\x10next_sequence_id\x18\x0b\x20\x01(\rR\x0ene\
    xtSequenceId\x12&\n\x05guest\x18\x03\x20\x01(\x0b2\x10.DrinkMakerGuestR\
    \x05guest\x12\x14\n\x05level\x18\n\x20\x01(\rR\x05level\x12\x18\n\x07ret\
    code\x18\x0f\x20\x01(\rR\x07retcode\x12/\n\x0crequest_list\x18\x01\x20\
    \x03(\x0b2\x0c.BKFLLOHDLEMR\x0brequestListb\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::BKFLLOHDLEM::file_descriptor().clone());
