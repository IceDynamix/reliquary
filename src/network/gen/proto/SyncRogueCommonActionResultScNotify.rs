...
impl ::protobuf::Message for SyncRogueCommonActionResultScNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.FGMGPLJCKPC != ::protobuf::EnumOrUnknown::new(super::NEMKLKDBEAP::NEMKLKDBEAP::ROGUE_COMMON_ACTION_RESULT_DISPLAY_TYPE_NONE) {
            my_size += ::protobuf::rt::int32_size(11, self.FGMGPLJCKPC.value());
        }
        ...
        if self.BNGFAIGNPHE != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.BNGFAIGNPHE);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.FGMGPLJCKPC != ::protobuf::EnumOrUnknown::new(super::NEMKLKDBEAP::NEMKLKDBEAP::ROGUE_COMMON_ACTION_RESULT_DISPLAY_TYPE_NONE) {
            os.write_enum(11, ::protobuf::EnumOrUnknown::value(&self.FGMGPLJCKPC))?;
        }
        for v in &self.FLBMHLPHFND {
            ::protobuf::rt::write_message_field_with_cached_size(3, v, os)?;
        };
        if self.BNGFAIGNPHE != 0 {
            os.write_uint32(6, self.BNGFAIGNPHE)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    y\x12.\n\x0bFGMGPLJCKPC\x18\x0b\x20\x01(\x0e2\x0c.NEMKLKDBEAPR\x0bFGMGPL\
    JCKPC\x12.\n\x0bFLBMHLPHFND\x18\x03\x20\x03(\x0b2\x0c.DGNDDJGNJLBR\x0bFL\
    BMHLPHFND\x12\x20\n\x0bBNGFAIGNPHE\x18\x06\x20\x01(\rR\x0bBNGFAIGNPHEb\
    \x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::DGNDDJGNJLB::file_descriptor().clone());
            deps.push(super::NEMKLKDBEAP::file_descriptor().clone());
