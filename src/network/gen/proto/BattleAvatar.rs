...
pub struct BattleAvatar {
    ...
    // @@protoc_insertion_point(field:BattleAvatar.GEOFDFBGECI)
    pub GEOFDFBGECI: u32,
    // special fields
...
impl BattleAvatar {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "GEOFDFBGECI",
            |m: &BattleAvatar| { &m.GEOFDFBGECI },
            |m: &mut BattleAvatar| { &mut m.GEOFDFBGECI },
        ));
...
impl ::protobuf::Message for BattleAvatar {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                136 => {
                    self.GEOFDFBGECI = is.read_uint32()?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.GEOFDFBGECI != 0 {
            my_size += ::protobuf::rt::uint32_size(17, self.GEOFDFBGECI);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.GEOFDFBGECI != 0 {
            os.write_uint32(17, self.GEOFDFBGECI)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    Bar\x12\x20\n\x0bGEOFDFBGECI\x18\x11\x20\x01(\rR\x0bGEOFDFBGECIB\x15\n\
