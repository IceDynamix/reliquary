...
pub struct FinishTutorialCsReq {
    // message fields
    // @@protoc_insertion_point(field:FinishTutorialCsReq.DPGFMFHGGPO)
    pub DPGFMFHGGPO: u32,
    // special fields
...
impl FinishTutorialCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "DPGFMFHGGPO",
            |m: &FinishTutorialCsReq| { &m.DPGFMFHGGPO },
            |m: &mut FinishTutorialCsReq| { &mut m.DPGFMFHGGPO },
        ));
...
impl ::protobuf::Message for FinishTutorialCsReq {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                48 => {
                    self.DPGFMFHGGPO = is.read_uint32()?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.DPGFMFHGGPO != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.DPGFMFHGGPO);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.DPGFMFHGGPO != 0 {
            os.write_uint32(6, self.DPGFMFHGGPO)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x19FinishTutorialCsReq.proto\"7\n\x13FinishTutorialCsReq\x12\x20\n\
    \x0bDPGFMFHGGPO\x18\x06\x20\x01(\rR\x0bDPGFMFHGGPOb\x06proto3\
";
