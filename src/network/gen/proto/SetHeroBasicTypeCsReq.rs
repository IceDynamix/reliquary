...
impl ::protobuf::Message for SetHeroBasicTypeCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.basic_type != ::protobuf::EnumOrUnknown::new(super::HeroBasicType::HeroBasicType::None) {
            my_size += ::protobuf::rt::int32_size(15, self.basic_type.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.basic_type != ::protobuf::EnumOrUnknown::new(super::HeroBasicType::HeroBasicType::None) {
            os.write_enum(15, ::protobuf::EnumOrUnknown::value(&self.basic_type))?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    HeroBasicTypeCsReq\x12-\n\nbasic_type\x18\x0f\x20\x01(\x0e2\x0e.HeroBasi\
