...
impl ::protobuf::Message for AddAvatarScNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.IGCIIKMMDAI != ::protobuf::EnumOrUnknown::new(super::LDKKGKFBNDG::LDKKGKFBNDG::ADD_AVATAR_SRC_NONE) {
            my_size += ::protobuf::rt::int32_size(3, self.IGCIIKMMDAI.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.IGCIIKMMDAI != ::protobuf::EnumOrUnknown::new(super::LDKKGKFBNDG::LDKKGKFBNDG::ADD_AVATAR_SRC_NONE) {
            os.write_enum(3, ::protobuf::EnumOrUnknown::value(&self.IGCIIKMMDAI))?;
        }
        if self.AEDKJJIBAHK != false {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    roto\"\xb8\x01\n\x11AddAvatarScNotify\x12.\n\x0bIGCIIKMMDAI\x18\x03\x20\
    \x01(\x0e2\x0c.LDKKGKFBNDGR\x0bIGCIIKMMDAI\x12\x20\n\x0bAEDKJJIBAHK\x18\
    \x0e\x20\x01(\x08R\x0bAEDKJJIBAHK\x12+\n\x0bBHELBOHKBBM\x18\x0c\x20\x01(\
