...
pub struct SwordTrainingDailyPhaseConfirmCsReq {
    // message fields
    // @@protoc_insertion_point(field:SwordTrainingDailyPhaseConfirmCsReq.OMMPPEPNCNH)
    pub OMMPPEPNCNH: ::protobuf::EnumOrUnknown<super::SwordTrainingDailyPhaseType::SwordTrainingDailyPhaseType>,
    // special fields
...
impl SwordTrainingDailyPhaseConfirmCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "OMMPPEPNCNH",
            |m: &SwordTrainingDailyPhaseConfirmCsReq| { &m.OMMPPEPNCNH },
            |m: &mut SwordTrainingDailyPhaseConfirmCsReq| { &mut m.OMMPPEPNCNH },
        ));
...
impl ::protobuf::Message for SwordTrainingDailyPhaseConfirmCsReq {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                120 => {
                    self.OMMPPEPNCNH = is.read_enum_or_unknown()?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.OMMPPEPNCNH != ::protobuf::EnumOrUnknown::new(super::SwordTrainingDailyPhaseType::SwordTrainingDailyPhaseType::SWORD_TRAINING_DAILY_PHASE_TYPE_NONE) {
            my_size += ::protobuf::rt::int32_size(15, self.OMMPPEPNCNH.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.OMMPPEPNCNH != ::protobuf::EnumOrUnknown::new(super::SwordTrainingDailyPhaseType::SwordTrainingDailyPhaseType::SWORD_TRAINING_DAILY_PHASE_TYPE_NONE) {
            os.write_enum(15, ::protobuf::EnumOrUnknown::value(&self.OMMPPEPNCNH))?;
        }
    ...
    fn clear(&mut self) {
        self.OMMPPEPNCNH = ::protobuf::EnumOrUnknown::new(super::SwordTrainingDailyPhaseType::SwordTrainingDailyPhaseType::SWORD_TRAINING_DAILY_PHASE_TYPE_NONE);
    ...
    fn default_instance() -> &'static SwordTrainingDailyPhaseConfirmCsReq {
        static instance: SwordTrainingDailyPhaseConfirmCsReq = SwordTrainingDailyPhaseConfirmCsReq {
            OMMPPEPNCNH: ::protobuf::EnumOrUnknown::from_i32(0),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    H\x18\x0f\x20\x01(\x0e2\x1c.SwordTrainingDailyPhaseTypeR\x0bOMMPPEPNCNHb\
    \x06proto3\
";
