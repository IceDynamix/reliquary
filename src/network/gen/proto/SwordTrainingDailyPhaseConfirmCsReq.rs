...
pub struct SwordTrainingDailyPhaseConfirmCsReq {
    // message fields
    // @@protoc_insertion_point(field:SwordTrainingDailyPhaseConfirmCsReq.FGMBFKBCGFH)
    pub FGMBFKBCGFH: ::protobuf::EnumOrUnknown<super::ActivitySwordTraining::SwordTrainingDailyPhaseType>,
    // special fields
...
impl SwordTrainingDailyPhaseConfirmCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "FGMBFKBCGFH",
            |m: &SwordTrainingDailyPhaseConfirmCsReq| { &m.FGMBFKBCGFH },
            |m: &mut SwordTrainingDailyPhaseConfirmCsReq| { &mut m.FGMBFKBCGFH },
        ));
...
impl ::protobuf::Message for SwordTrainingDailyPhaseConfirmCsReq {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                16 => {
                    self.FGMBFKBCGFH = is.read_enum_or_unknown()?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.FGMBFKBCGFH != ::protobuf::EnumOrUnknown::new(super::ActivitySwordTraining::SwordTrainingDailyPhaseType::SWORD_TRAINING_DAILY_PHASE_TYPE_NONE) {
            my_size += ::protobuf::rt::int32_size(2, self.FGMBFKBCGFH.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.FGMBFKBCGFH != ::protobuf::EnumOrUnknown::new(super::ActivitySwordTraining::SwordTrainingDailyPhaseType::SWORD_TRAINING_DAILY_PHASE_TYPE_NONE) {
            os.write_enum(2, ::protobuf::EnumOrUnknown::value(&self.FGMBFKBCGFH))?;
        }
    ...
    fn clear(&mut self) {
        self.FGMBFKBCGFH = ::protobuf::EnumOrUnknown::new(super::ActivitySwordTraining::SwordTrainingDailyPhaseType::SWORD_TRAINING_DAILY_PHASE_TYPE_NONE);
    ...
    fn default_instance() -> &'static SwordTrainingDailyPhaseConfirmCsReq {
        static instance: SwordTrainingDailyPhaseConfirmCsReq = SwordTrainingDailyPhaseConfirmCsReq {
            FGMBFKBCGFH: ::protobuf::EnumOrUnknown::from_i32(0),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    H\x18\x02\x20\x01(\x0e2\x1c.SwordTrainingDailyPhaseTypeR\x0bFGMBFKBCGFHb\
    \x06proto3\
";
