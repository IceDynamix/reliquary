...
impl ::protobuf::Message for Shop {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.city_level != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.city_level);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.city_level != 0 {
            os.write_uint32(15, self.city_level)?;
        }
        if self.begin_time != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    id\x18\x07\x20\x01(\rR\x06shopId\x12\x1d\n\ncity_level\x18\x0f\x20\x01(\
    \rR\tcityLevel\x12\x1d\n\nbegin_time\x18\x04\x20\x01(\x03R\tbeginTime\
    \x12\x19\n\x08city_exp\x18\x06\x20\x01(\rR\x07cityExp\x12\x19\n\x08end_t\
    ime\x18\n\x20\x01(\x03R\x07endTime\x12%\n\ngoods_list\x18\r\x20\x03(\x0b\
    2\x06.GoodsR\tgoodsList\x125\n\x17city_taken_level_reward\x18\x05\x20\
    \x01(\x04R\x14cityTakenLevelRewardb\x06proto3\
";
