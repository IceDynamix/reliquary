...
impl ::protobuf::Message for LogisticsScore {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.last_max_score != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.last_max_score);
        }
        ...
        if self.cur_score != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.cur_score);
        }
        if self.last_level != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.last_level);
        }
        if self.unlock_level != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.unlock_level);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.last_max_score != 0 {
            os.write_uint32(14, self.last_max_score)?;
        }
        if let Some(v) = self.reward.as_ref() {
            ::protobuf::rt::write_message_field_with_cached_size(9, v, os)?;
        }
        if self.cur_score != 0 {
            os.write_uint32(2, self.cur_score)?;
        }
        if self.last_level != 0 {
            os.write_uint32(11, self.last_level)?;
        }
        if self.unlock_level != 0 {
            os.write_uint32(10, self.unlock_level)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    sScore\x12\x1b\n\tmax_score\x18\x01\x20\x01(\rR\x08maxScore\x12\x15\n\
    \x06map_id\x18\x04\x20\x01(\rR\x05mapId\x12$\n\x0elast_max_score\x18\x0e\
    \x20\x01(\rR\x0clastMaxScore\x12!\n\x06reward\x18\t\x20\x01(\x0b2\t.Item\
    ListR\x06reward\x12\x1b\n\tcur_score\x18\x02\x20\x01(\rR\x08curScore\x12\
    \x1d\n\nlast_level\x18\x0b\x20\x01(\rR\tlastLevel\x12!\n\x0cunlock_level\
    \x18\n\x20\x01(\rR\x0bunlockLevelb\x06proto3\
";
