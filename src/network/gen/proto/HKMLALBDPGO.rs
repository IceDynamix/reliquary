...
impl ::protobuf::Message for HKMLALBDPGO {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.LHCBBGIMMDG != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.LHCBBGIMMDG);
        }
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(11, &self.BOONPDEOBLA);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.LHCBBGIMMDG != 0 {
            os.write_uint32(6, self.LHCBBGIMMDG)?;
        }
        if self.FAHIHDJFOHM != 0 {
        ...
        os.write_repeated_packed_uint32(11, &self.BOONPDEOBLA)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    MDG\x18\x06\x20\x01(\rR\x0bLHCBBGIMMDG\x12\x20\n\x0bFAHIHDJFOHM\x18\x05\
    \x20\x01(\rR\x0bFAHIHDJFOHM\x12\x20\n\x0bFJKGKAEKBKJ\x18\x02\x20\x01(\
    \x08R\x0bFJKGKAEKBKJ\x12\x20\n\x0bBOONPDEOBLA\x18\x0b\x20\x03(\rR\x0bBOO\
    NPDEOBLAb\x06proto3\
";
