...
impl AKOKICDPFMP {
    ...
    // .ICAOOPPMJDJ JIPPGKHKKBG = 173;

    pub fn JIPPGKHKKBG(&self) -> &super::ICAOOPPMJDJ::ICAOOPPMJDJ {
        match self.HBFOFPDAFPD {
            ::std::option::Option::Some(akokicdpfmp::HBFOFPDAFPD::JIPPGKHKKBG(ref v)) => v,
            _ => <super::ICAOOPPMJDJ::ICAOOPPMJDJ as ::protobuf::Message>::default_instance(),
        }
    }

    pub fn clear_JIPPGKHKKBG(&mut self) {
        self.HBFOFPDAFPD = ::std::option::Option::None;
    }

    pub fn has_JIPPGKHKKBG(&self) -> bool {
        match self.HBFOFPDAFPD {
            ::std::option::Option::Some(akokicdpfmp::HBFOFPDAFPD::JIPPGKHKKBG(..)) => true,
            _ => false,
        }
    }

    // Param is passed by value, moved
    pub fn set_JIPPGKHKKBG(&mut self, v: super::ICAOOPPMJDJ::ICAOOPPMJDJ) {
        self.HBFOFPDAFPD = ::std::option::Option::Some(akokicdpfmp::HBFOFPDAFPD::JIPPGKHKKBG(v))
    }

    // Mutable pointer to the field.
    pub fn mut_JIPPGKHKKBG(&mut self) -> &mut super::ICAOOPPMJDJ::ICAOOPPMJDJ {
        if let ::std::option::Option::Some(akokicdpfmp::HBFOFPDAFPD::JIPPGKHKKBG(_)) = self.HBFOFPDAFPD {
        } else {
            self.HBFOFPDAFPD = ::std::option::Option::Some(akokicdpfmp::HBFOFPDAFPD::JIPPGKHKKBG(super::ICAOOPPMJDJ::ICAOOPPMJDJ::new()));
        }
        match self.HBFOFPDAFPD {
            ::std::option::Option::Some(akokicdpfmp::HBFOFPDAFPD::JIPPGKHKKBG(ref mut v)) => v,
            _ => panic!(),
        }
    }

    // Take field
    pub fn take_JIPPGKHKKBG(&mut self) -> super::ICAOOPPMJDJ::ICAOOPPMJDJ {
        if self.has_JIPPGKHKKBG() {
            match self.HBFOFPDAFPD.take() {
                ::std::option::Option::Some(akokicdpfmp::HBFOFPDAFPD::JIPPGKHKKBG(v)) => v,
                _ => panic!(),
            }
        } else {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_oneof_message_has_get_mut_set_accessor::<_, super::ICAOOPPMJDJ::ICAOOPPMJDJ>(
            "JIPPGKHKKBG",
            AKOKICDPFMP::has_JIPPGKHKKBG,
            AKOKICDPFMP::JIPPGKHKKBG,
            AKOKICDPFMP::mut_JIPPGKHKKBG,
            AKOKICDPFMP::set_JIPPGKHKKBG,
        ));
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                1386 => {
                    self.HBFOFPDAFPD = ::std::option::Option::Some(akokicdpfmp::HBFOFPDAFPD::JIPPGKHKKBG(is.read_message()?));
                },
                6962 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let ::std::option::Option::Some(ref v) = self.HBFOFPDAFPD {
            match v {
                ...
                &akokicdpfmp::HBFOFPDAFPD::JIPPGKHKKBG(ref v) => {
                    let len = v.compute_size();
                    my_size += 2 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
                },
...
pub mod akokicdpfmp {
    ...
    pub enum HBFOFPDAFPD {
        ...
        // @@protoc_insertion_point(oneof_field:AKOKICDPFMP.JIPPGKHKKBG)
        JIPPGKHKKBG(super::super::ICAOOPPMJDJ::ICAOOPPMJDJ),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0b2\x0c.GLDNBPFCNHDH\0R\x0bPHMCJEJIDJA\x121\n\x0bJIPPGKHKKBG\x18\xad\
    \x01\x20\x01(\x0b2\x0c.ICAOOPPMJDJH\0R\x0bJIPPGKHKKBG\x121\n\x0bMEJDMJIK\
    IMO\x18\xe6\x06\x20\x01(\x0b2\x0c.MAOGFDKDCKMH\0R\x0bMEJDMJIKIMO\x121\n\
    \x0bJHFGDIJPFCG\x18\xe2\x08\x20\x01(\x0b2\x0c.GOCKGIGBDCGH\0R\x0bJHFGDIJ\
