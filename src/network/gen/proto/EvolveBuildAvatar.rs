...
//! Generated file from `EvolveBuildAvatar.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_4_0;

// @@protoc_insertion_point(message:EvolveBuildAvatar)
...
impl<'a> ::std::default::Default for &'a EvolveBuildAvatar {
    fn default() -> &'a EvolveBuildAvatar {
        <EvolveBuildAvatar as ::protobuf::Message>::default_instance()
    }
}

impl EvolveBuildAvatar {
    pub fn new() -> EvolveBuildAvatar {
...
impl ::protobuf::Message for EvolveBuildAvatar {
    const NAME: &'static str = "EvolveBuildAvatar";
    ...
    fn new() -> EvolveBuildAvatar {
        EvolveBuildAvatar::new()
    }
...
impl ::protobuf::MessageFull for EvolveBuildAvatar {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("EvolveBuildAvatar").unwrap()).clone()
    }
}

impl ::std::fmt::Display for EvolveBuildAvatar {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for EvolveBuildAvatar {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x17EvolveBuildAvatar.proto\x1a\x10AvatarType.proto\"v\n\x11EvolveBuil\
    dAvatar\x12\x16\n\x06damage\x18\x0b\x20\x01(\x01R\x06damage\x12,\n\x0bav\
    atar_type\x18\x0e\x20\x01(\x0e2\x0b.AvatarTypeR\navatarType\x12\x1b\n\ta\
    vatar_id\x18\x08\x20\x01(\rR\x08avatarIdb\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(EvolveBuildAvatar::generated_message_descriptor_data());
