...
impl ::protobuf::Message for TreasureDungeonRecordData {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.source_grid_id != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.source_grid_id);
        }
        if self.param1 != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.source_grid_id != 0 {
            os.write_uint32(13, self.source_grid_id)?;
        }
        if self.param1 != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x08\x20\x01(\rR\x0ctargetGridId\x12$\n\x0esource_grid_id\x18\r\x20\
    \x01(\rR\x0csourceGridId\x12\x16\n\x06param1\x18\x0e\x20\x01(\rR\x06para\
    m1\x12\x16\n\x06param2\x18\x0f\x20\x01(\rR\x06param2\x12.\n\x04type\x18\
    \x06\x20\x01(\x0e2\x1a.TreasureDungeonRecordTypeR\x04typeb\x06proto3\
";
