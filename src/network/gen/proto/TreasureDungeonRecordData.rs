...
impl ::protobuf::Message for TreasureDungeonRecordData {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.param1 != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.param1);
        }
        if self.source_grid_id != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.source_grid_id);
        }
        if self.target_grid_id != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.target_grid_id);
        }
        if self.param2 != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.param2);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.param1 != 0 {
            os.write_uint32(10, self.param1)?;
        }
        if self.source_grid_id != 0 {
            os.write_uint32(8, self.source_grid_id)?;
        }
        if self.target_grid_id != 0 {
            os.write_uint32(11, self.target_grid_id)?;
        }
        if self.param2 != 0 {
            os.write_uint32(5, self.param2)?;
        }
        if self.type_ != ::protobuf::EnumOrUnknown::new(super::TreasureDungeonRecordType::TreasureDungeonRecordType::TREASURE_DUNGEON_RECORD_NONE) {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    roto\"\xc7\x01\n\x19TreasureDungeonRecordData\x12\x16\n\x06param1\x18\n\
    \x20\x01(\rR\x06param1\x12$\n\x0esource_grid_id\x18\x08\x20\x01(\rR\x0cs\
    ourceGridId\x12$\n\x0etarget_grid_id\x18\x0b\x20\x01(\rR\x0ctargetGridId\
    \x12\x16\n\x06param2\x18\x05\x20\x01(\rR\x06param2\x12.\n\x04type\x18\r\
    \x20\x01(\x0e2\x1a.TreasureDungeonRecordTypeR\x04typeb\x06proto3\
";
