...
pub struct ShareScRsp {
    // message fields
    // @@protoc_insertion_point(field:ShareScRsp.DFGNKCCPACJ)
    pub DFGNKCCPACJ: ::protobuf::MessageField<super::HHJJIPAJCPC::HHJJIPAJCPC>,
    // @@protoc_insertion_point(field:ShareScRsp.retcode)
    pub retcode: u32,
    // @@protoc_insertion_point(field:ShareScRsp.LPDNAMLHGNJ)
...
impl ShareScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::HHJJIPAJCPC::HHJJIPAJCPC>(
            "DFGNKCCPACJ",
            |m: &ShareScRsp| { &m.DFGNKCCPACJ },
            |m: &mut ShareScRsp| { &mut m.DFGNKCCPACJ },
        ));
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::ItemList::ItemList>(
            "LPDNAMLHGNJ",
            |m: &ShareScRsp| { &m.LPDNAMLHGNJ },
            |m: &mut ShareScRsp| { &mut m.LPDNAMLHGNJ },
        ));
...
impl ::protobuf::Message for ShareScRsp {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                98 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.DFGNKCCPACJ)?;
                },
                72 => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if let Some(v) = self.DFGNKCCPACJ.as_ref() {
    ...
    fn default_instance() -> &'static ShareScRsp {
        static instance: ShareScRsp = ShareScRsp {
            DFGNKCCPACJ: ::protobuf::MessageField::none(),
            retcode: 0,
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x10ShareScRsp.proto\x1a\x11HHJJIPAJCPC.proto\x1a\x0eItemList.proto\"\
    \x83\x01\n\nShareScRsp\x12.\n\x0bDFGNKCCPACJ\x18\x0c\x20\x01(\x0b2\x0c.H\
    HJJIPAJCPCR\x0bDFGNKCCPACJ\x12\x18\n\x07retcode\x18\t\x20\x01(\rR\x07ret\
    code\x12+\n\x0bLPDNAMLHGNJ\x18\x06\x20\x01(\x0b2\t.ItemListR\x0bLPDNAMLH\
    GNJb\x06proto3\
";
