...
impl ::protobuf::Message for EntityBuffChangeInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.remove_buff_id != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.remove_buff_id);
        }
        if self.entity_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.remove_buff_id != 0 {
            os.write_uint32(12, self.remove_buff_id)?;
        }
        if self.entity_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    oR\x0baddBuffInfo\x12$\n\x0eremove_buff_id\x18\x0c\x20\x01(\rR\x0cremove\
    BuffId\x12\x1b\n\tentity_id\x18\x07\x20\x01(\rR\x08entityIdB\x15\n\x13em\
