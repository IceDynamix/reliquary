...
pub struct SceneMonsterWave {
    ...
    // @@protoc_insertion_point(field:SceneMonsterWave.EMAMOBCGBDD)
...
impl SceneMonsterWave {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "EMAMOBCGBDD",
            |m: &SceneMonsterWave| { &m.EMAMOBCGBDD },
            |m: &mut SceneMonsterWave| { &mut m.EMAMOBCGBDD },
        ));
...
impl ::protobuf::Message for SceneMonsterWave {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.wave_id != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.wave_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.wave_id != 0 {
            os.write_uint32(12, self.wave_id)?;
        }
        if let Some(v) = self.wave_param.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    erWaveParam.proto\x1a\x0eItemList.proto\"\xdc\x01\n\x10SceneMonsterWave\
    \x120\n\x0cmonster_list\x18\x06\x20\x03(\x0b2\r.SceneMonsterR\x0bmonster\
    List\x12+\n\x0bEMAMOBCGBDD\x18\x02\x20\x03(\x0b2\t.ItemListR\x0bEMAMOBCG\
    BDD\x12\x17\n\x07wave_id\x18\x0c\x20\x01(\rR\x06waveId\x125\n\nwave_para\
    m\x18\x01\x20\x01(\x0b2\x16.SceneMonsterWaveParamR\twaveParam\x12\x19\n\
    \x08stage_id\x18\x0e\x20\x01(\rR\x07stageIdB\x15\n\x13emu.lunarcore.prot\
    ob\x06proto3\
";
