...
impl ::protobuf::Message for GetPamSkinDataScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        for value in &self.unlocked_pam_skins {
            my_size += ::protobuf::rt::uint32_size(4, *value);
        };
        if self.current_pam_skin_id != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.current_pam_skin_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        for v in &self.unlocked_pam_skins {
            os.write_uint32(4, *v)?;
        };
        if self.current_pam_skin_id != 0 {
            os.write_uint32(5, self.current_pam_skin_id)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    skins\x18\x04\x20\x03(\rR\x10unlockedPamSkins\x12-\n\x13current_pam_skin\
    _id\x18\x05\x20\x01(\rR\x10currentPamSkinIdB\x15\n\x13emu.lunarcore.prot\
    ob\x06proto3\
";
