...
impl ::protobuf::Message for SceneCastSkillCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.caster_id != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.caster_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.caster_id != 0 {
            os.write_uint32(1, self.caster_id)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ceneCastSkillCsReq\x12\x1f\n\x0bskill_index\x18\x06\x20\x01(\rR\nskillIn\
    dex\x128\n\x19hit_target_entity_id_list\x18\r\x20\x03(\rR\x15hitTargetEn\
    tityIdList\x12@\n\x1dassist_monster_entity_id_list\x18\x0e\x20\x03(\rR\
    \x19assistMonsterEntityIdList\x12*\n\x11attacked_group_id\x18\x08\x20\
    \x01(\rR\x0fattackedGroupId\x120\n\rtarget_motion\x18\x0f\x20\x01(\x0b2\
    \x0b.MotionInfoR\x0ctargetMotion\x12\x1b\n\tcaster_id\x18\x01\x20\x01(\r\
