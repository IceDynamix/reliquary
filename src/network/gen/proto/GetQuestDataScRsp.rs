...
impl ::protobuf::Message for GetQuestDataScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.total_achievement_exp != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.total_achievement_exp);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.total_achievement_exp != 0 {
            os.write_uint32(11, self.total_achievement_exp)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    DataScRsp\x12\x18\n\x07retcode\x18\x02\x20\x01(\rR\x07retcode\x122\n\x15\
    total_achievement_exp\x18\x0b\x20\x01(\rR\x13totalAchievementExp\x12%\n\
    \nquest_list\x18\x03\x20\x03(\x0b2\x06.QuestR\tquestListB\x15\n\x13emu.l\
