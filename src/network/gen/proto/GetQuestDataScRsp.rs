...
pub struct GetQuestDataScRsp {
    // message fields
    // @@protoc_insertion_point(field:GetQuestDataScRsp.HKIKCAABHPB)
    pub HKIKCAABHPB: u32,
    // @@protoc_insertion_point(field:GetQuestDataScRsp.retcode)
    pub retcode: u32,
    // @@protoc_insertion_point(field:GetQuestDataScRsp.PPAKDPOOANI)
...
impl GetQuestDataScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "HKIKCAABHPB",
            |m: &GetQuestDataScRsp| { &m.HKIKCAABHPB },
            |m: &mut GetQuestDataScRsp| { &mut m.HKIKCAABHPB },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "retcode",
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "PPAKDPOOANI",
            |m: &GetQuestDataScRsp| { &m.PPAKDPOOANI },
            |m: &mut GetQuestDataScRsp| { &mut m.PPAKDPOOANI },
        ));
...
impl ::protobuf::Message for GetQuestDataScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.HKIKCAABHPB != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.HKIKCAABHPB);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.HKIKCAABHPB != 0 {
            os.write_uint32(12, self.HKIKCAABHPB)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x17GetQuestDataScRsp.proto\x1a\x11FPPAMPPIHMN.proto\"\x7f\n\x11GetQue\
    stDataScRsp\x12\x20\n\x0bHKIKCAABHPB\x18\x0c\x20\x01(\rR\x0bHKIKCAABHPB\
    \x12\x18\n\x07retcode\x18\x03\x20\x01(\rR\x07retcode\x12.\n\x0bPPAKDPOOA\
    NI\x18\x0b\x20\x03(\x0b2\x0c.FPPAMPPIHMNR\x0bPPAKDPOOANIb\x06proto3\
";
