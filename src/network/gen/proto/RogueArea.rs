...
pub struct RogueArea {
    ...
    // @@protoc_insertion_point(field:RogueArea.LBHJLPCJDPA)
    pub LBHJLPCJDPA: u32,
...
impl RogueArea {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "LBHJLPCJDPA",
            |m: &RogueArea| { &m.LBHJLPCJDPA },
            |m: &mut RogueArea| { &mut m.LBHJLPCJDPA },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "map_id",
...
impl ::protobuf::Message for RogueArea {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.rogue_status != ::protobuf::EnumOrUnknown::new(super::RogueStatus::RogueStatus::ROGUE_STATUS_NONE) {
            my_size += ::protobuf::rt::int32_size(10, self.rogue_status.value());
        }
        if self.area_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.rogue_status != ::protobuf::EnumOrUnknown::new(super::RogueStatus::RogueStatus::ROGUE_STATUS_NONE) {
            os.write_enum(10, ::protobuf::EnumOrUnknown::value(&self.rogue_status))?;
        }
        if self.area_id != 0 {
            os.write_uint32(13, self.area_id)?;
        }
        if self.has_taken_reward != false {
            os.write_bool(9, self.has_taken_reward)?;
        }
        if self.LBHJLPCJDPA != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    oto\"\xeb\x01\n\tRogueArea\x121\n\x0barea_status\x18\x06\x20\x01(\x0e2\
    \x10.RogueAreaStatusR\nareaStatus\x12/\n\x0crogue_status\x18\n\x20\x01(\
    \x0e2\x0c.RogueStatusR\x0brogueStatus\x12\x17\n\x07area_id\x18\r\x20\x01\
    (\rR\x06areaId\x12(\n\x10has_taken_reward\x18\t\x20\x01(\x08R\x0ehasTake\
    nReward\x12\x20\n\x0bLBHJLPCJDPA\x18\x0f\x20\x01(\rR\x0bLBHJLPCJDPA\x12\
    \x15\n\x06map_id\x18\x0c\x20\x01(\rR\x05mapIdB\x15\n\x13emu.lunarcore.pr\
    otob\x06proto3\
";
