...
impl ::protobuf::Message for RogueArea {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.rogue_area_status != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.rogue_area_status);
        }
        if self.rogue_status != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.rogue_status);
        }
        ...
        if self.cur_reach_room_num != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.cur_reach_room_num);
        }
        if self.area_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.rogue_area_status != 0 {
            os.write_uint32(1, self.rogue_area_status)?;
        }
        if self.rogue_status != 0 {
            os.write_uint32(8, self.rogue_status)?;
        }
        if self.has_taken_rewards != false {
            os.write_bool(14, self.has_taken_rewards)?;
        }
        if self.map_id != 0 {
            os.write_uint32(5, self.map_id)?;
        }
        if self.cur_reach_room_num != 0 {
            os.write_uint32(6, self.cur_reach_room_num)?;
        }
        if self.area_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x01\x20\x01(\rR\x0frogueAreaStatus\x12!\n\x0crogue_status\x18\x08\
    \x20\x01(\rR\x0brogueStatus\x12*\n\x11has_taken_rewards\x18\x0e\x20\x01(\
    \x08R\x0fhasTakenRewards\x12\x15\n\x06map_id\x18\x05\x20\x01(\rR\x05mapI\
    d\x12+\n\x12cur_reach_room_num\x18\x06\x20\x01(\rR\x0fcurReachRoomNum\
    \x12\x17\n\x07area_id\x18\t\x20\x01(\rR\x06areaIdB\x15\n\x13emu.lunarcor\
    e.protob\x06proto3\
";
