...
pub struct RogueArea {
    ...
    // @@protoc_insertion_point(field:RogueArea.CMJFDLMBIOK)
    pub CMJFDLMBIOK: bool,
...
impl RogueArea {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "CMJFDLMBIOK",
            |m: &RogueArea| { &m.CMJFDLMBIOK },
            |m: &mut RogueArea| { &mut m.CMJFDLMBIOK },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "map_id",
...
impl ::protobuf::Message for RogueArea {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.rogue_area_status != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.rogue_area_status);
        }
        if self.cur_reach_room_num != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.cur_reach_room_num);
        }
        if self.CMJFDLMBIOK != false {
            my_size += 1 + 1;
        }
        if self.map_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.rogue_area_status != 0 {
            os.write_uint32(8, self.rogue_area_status)?;
        }
        if self.cur_reach_room_num != 0 {
            os.write_uint32(2, self.cur_reach_room_num)?;
        }
        if self.CMJFDLMBIOK != false {
            os.write_bool(14, self.CMJFDLMBIOK)?;
        }
        if self.map_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x0fRogueArea.proto\"\xb6\x01\n\tRogueArea\x12*\n\x11rogue_area_status\
    \x18\x08\x20\x01(\rR\x0frogueAreaStatus\x12+\n\x12cur_reach_room_num\x18\
    \x02\x20\x01(\rR\x0fcurReachRoomNum\x12\x20\n\x0bCMJFDLMBIOK\x18\x0e\x20\
    \x01(\x08R\x0bCMJFDLMBIOK\x12\x15\n\x06map_id\x18\x05\x20\x01(\rR\x05map\
    Id\x12\x17\n\x07area_id\x18\x07\x20\x01(\rR\x06areaIdB\x15\n\x13emu.luna\
