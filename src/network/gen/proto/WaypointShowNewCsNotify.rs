...
impl ::protobuf::Message for WaypointShowNewCsNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.NKCMNAFAIOI != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.NKCMNAFAIOI);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.NKCMNAFAIOI != 0 {
            os.write_uint32(9, self.NKCMNAFAIOI)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x20\n\x0bKIEKJEFFPHK\x18\x0e\x20\x01(\rR\x0bKIEKJEFFPHK\x12\x20\n\x0bNK\
    CMNAFAIOI\x18\t\x20\x01(\rR\x0bNKCMNAFAIOIb\x06proto3\
";
