...
impl ::protobuf::Message for EnterRogueMapRoomScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.cur_site_id != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.cur_site_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.cur_site_id != 0 {
            os.write_uint32(15, self.cur_site_id)?;
        }
        if let Some(v) = self.lineup.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    nfo.proto\"\x99\x01\n\x16EnterRogueMapRoomScRsp\x12\x18\n\x07retcode\x18\
    \n\x20\x01(\rR\x07retcode\x12\x20\n\x05scene\x18\x05\x20\x01(\x0b2\n.Sce\
    neInfoR\x05scene\x12\x1e\n\x0bcur_site_id\x18\x0f\x20\x01(\rR\tcurSiteId\
    \x12#\n\x06lineup\x18\x06\x20\x01(\x0b2\x0b.LineupInfoR\x06lineupB\x15\n\
