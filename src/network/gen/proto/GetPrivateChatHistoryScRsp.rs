...
impl ::protobuf::Message for GetPrivateChatHistoryScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.sender_uid != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.sender_uid);
        }
        if self.to_uid != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.sender_uid != 0 {
            os.write_uint32(11, self.sender_uid)?;
        }
        if self.to_uid != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    tPrivateChatHistoryScRsp\x12\x1d\n\nsender_uid\x18\x0b\x20\x01(\rR\tsend\
    erUid\x12\x15\n\x06to_uid\x18\x02\x20\x01(\rR\x05toUid\x12\x18\n\x07retc\
    ode\x18\x05\x20\x01(\rR\x07retcode\x12\"\n\tchat_list\x18\x08\x20\x03(\
    \x0b2\x05.ChatR\x08chatListB\x15\n\x13emu.lunarcore.protob\x06proto3\
";
