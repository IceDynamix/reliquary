...
pub struct SceneEntityTeleportScRsp {
    // message fields
    // @@protoc_insertion_point(field:SceneEntityTeleportScRsp.ECKDFNEOBDC)
    pub ECKDFNEOBDC: u32,
    // @@protoc_insertion_point(field:SceneEntityTeleportScRsp.ECGMLPBECDM)
    pub ECGMLPBECDM: ::protobuf::MessageField<super::NDDCJGJPEME::NDDCJGJPEME>,
...
impl SceneEntityTeleportScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "ECKDFNEOBDC",
            |m: &SceneEntityTeleportScRsp| { &m.ECKDFNEOBDC },
            |m: &mut SceneEntityTeleportScRsp| { &mut m.ECKDFNEOBDC },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::NDDCJGJPEME::NDDCJGJPEME>(
            "ECGMLPBECDM",
            |m: &SceneEntityTeleportScRsp| { &m.ECGMLPBECDM },
            |m: &mut SceneEntityTeleportScRsp| { &mut m.ECGMLPBECDM },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "retcode",
...
impl ::protobuf::Message for SceneEntityTeleportScRsp {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                106 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.ECGMLPBECDM)?;
                },
                64 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.ECKDFNEOBDC != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.ECKDFNEOBDC);
        }
        if let Some(v) = self.ECGMLPBECDM.as_ref() {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.ECKDFNEOBDC != 0 {
            os.write_uint32(6, self.ECKDFNEOBDC)?;
        }
        if let Some(v) = self.ECGMLPBECDM.as_ref() {
    ...
    fn default_instance() -> &'static SceneEntityTeleportScRsp {
        static instance: SceneEntityTeleportScRsp = SceneEntityTeleportScRsp {
            ECKDFNEOBDC: 0,
            ECGMLPBECDM: ::protobuf::MessageField::none(),
            retcode: 0,
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1eSceneEntityTeleportScRsp.proto\x1a\x11NDDCJGJPEME.proto\"\x86\x01\
    \n\x18SceneEntityTeleportScRsp\x12\x20\n\x0bECKDFNEOBDC\x18\x06\x20\x01(\
    \rR\x0bECKDFNEOBDC\x12.\n\x0bECGMLPBECDM\x18\r\x20\x01(\x0b2\x0c.NDDCJGJ\
    PEMER\x0bECGMLPBECDM\x12\x18\n\x07retcode\x18\x08\x20\x01(\rR\x07retcode\
    b\x06proto3\
";
