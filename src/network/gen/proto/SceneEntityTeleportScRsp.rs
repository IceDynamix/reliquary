...
pub struct SceneEntityTeleportScRsp {
    ...
    pub retcode: u32,
    // @@protoc_insertion_point(field:SceneEntityTeleportScRsp.CGMALNHGHME)
    pub CGMALNHGHME: ::protobuf::MessageField<super::HJMLDBKEGCN::HJMLDBKEGCN>,
    // @@protoc_insertion_point(field:SceneEntityTeleportScRsp.LLLHPFLFKPP)
    pub LLLHPFLFKPP: u32,
    // special fields
...
impl SceneEntityTeleportScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::HJMLDBKEGCN::HJMLDBKEGCN>(
            "CGMALNHGHME",
            |m: &SceneEntityTeleportScRsp| { &m.CGMALNHGHME },
            |m: &mut SceneEntityTeleportScRsp| { &mut m.CGMALNHGHME },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "LLLHPFLFKPP",
            |m: &SceneEntityTeleportScRsp| { &m.LLLHPFLFKPP },
            |m: &mut SceneEntityTeleportScRsp| { &mut m.LLLHPFLFKPP },
        ));
...
impl ::protobuf::Message for SceneEntityTeleportScRsp {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                34 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.CGMALNHGHME)?;
                },
                8 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let Some(v) = self.CGMALNHGHME.as_ref() {
    ...
    fn default_instance() -> &'static SceneEntityTeleportScRsp {
        static instance: SceneEntityTeleportScRsp = SceneEntityTeleportScRsp {
            retcode: 0,
            CGMALNHGHME: ::protobuf::MessageField::none(),
            LLLHPFLFKPP: 0,
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1eSceneEntityTeleportScRsp.proto\x1a\x11HJMLDBKEGCN.proto\"\x86\x01\
    \n\x18SceneEntityTeleportScRsp\x12\x18\n\x07retcode\x18\x02\x20\x01(\rR\
    \x07retcode\x12.\n\x0bCGMALNHGHME\x18\x04\x20\x01(\x0b2\x0c.HJMLDBKEGCNR\
    \x0bCGMALNHGHME\x12\x20\n\x0bLLLHPFLFKPP\x18\x01\x20\x01(\rR\x0bLLLHPFLF\
    KPPb\x06proto3\
";
