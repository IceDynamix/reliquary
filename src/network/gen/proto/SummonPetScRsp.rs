...
pub struct SummonPetScRsp {
    // message fields
    // @@protoc_insertion_point(field:SummonPetScRsp.EAFGOCECBDJ)
    pub EAFGOCECBDJ: u32,
    // @@protoc_insertion_point(field:SummonPetScRsp.AJGKIKFGMPI)
    pub AJGKIKFGMPI: u32,
...
impl SummonPetScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "EAFGOCECBDJ",
            |m: &SummonPetScRsp| { &m.EAFGOCECBDJ },
            |m: &mut SummonPetScRsp| { &mut m.EAFGOCECBDJ },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "AJGKIKFGMPI",
            |m: &SummonPetScRsp| { &m.AJGKIKFGMPI },
            |m: &mut SummonPetScRsp| { &mut m.AJGKIKFGMPI },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "retcode",
...
impl ::protobuf::Message for SummonPetScRsp {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                120 => {
                    self.EAFGOCECBDJ = is.read_uint32()?;
                },
                56 => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.EAFGOCECBDJ != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.EAFGOCECBDJ);
        }
        if self.AJGKIKFGMPI != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.AJGKIKFGMPI);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.EAFGOCECBDJ != 0 {
            os.write_uint32(15, self.EAFGOCECBDJ)?;
        }
        if self.AJGKIKFGMPI != 0 {
            os.write_uint32(7, self.AJGKIKFGMPI)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    DJ\x18\x0f\x20\x01(\rR\x0bEAFGOCECBDJ\x12\x20\n\x0bAJGKIKFGMPI\x18\x07\
    \x20\x01(\rR\x0bAJGKIKFGMPI\x12\x18\n\x07retcode\x18\x03\x20\x01(\rR\x07\
    retcodeb\x06proto3\
";
