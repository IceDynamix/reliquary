...
impl ::protobuf::Message for GroupStateInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.player_uid != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.player_uid);
        }
        if self.entry_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.player_uid != 0 {
            os.write_uint32(14, self.player_uid)?;
        }
        if self.entry_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x14GroupStateInfo.proto\"\x86\x01\n\x0eGroupStateInfo\x12\x1d\n\nplay\
    er_uid\x18\x0e\x20\x01(\rR\tplayerUid\x12\x19\n\x08entry_id\x18\x07\x20\
    \x01(\rR\x07entryId\x12\x1f\n\x0bgroup_state\x18\x02\x20\x01(\rR\ngroupS\
