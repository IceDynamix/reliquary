...
impl ::protobuf::Message for PVEBattleResultCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.turn_snapshot_hash.is_empty() {
            my_size += ::protobuf::rt::bytes_size(14, &self.turn_snapshot_hash);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if !self.turn_snapshot_hash.is_empty() {
            os.write_bytes(14, &self.turn_snapshot_hash)?;
        }
        if self.client_res_version != 0 {
        ...
        if self.is_ai_consider_ultra_skill != false {
            os.write_bool(11, self.is_ai_consider_ultra_skill)?;
        }
        if self.cost_time != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    CsReq\x12,\n\x12turn_snapshot_hash\x18\x0e\x20\x01(\x0cR\x10turnSnapshot\
    Hash\x12,\n\x12client_res_version\x18\n\x20\x01(\rR\x10clientResVersion\
    \x12#\n\x03stt\x18\r\x20\x01(\x0b2\x11.BattleStatisticsR\x03stt\x12\x19\
    \n\x08stage_id\x18\x02\x20\x01(\rR\x07stageId\x12\x1b\n\tbattle_id\x18\
    \x08\x20\x01(\rR\x08battleId\x12/\n\nend_status\x18\x07\x20\x01(\x0e2\
    \x10.BattleEndStatusR\tendStatus\x12:\n\x1ais_ai_consider_ultra_skill\
    \x18\x0b\x20\x01(\x08R\x16isAiConsiderUltraSkill\x12\x1b\n\tcost_time\
    \x18\x05\x20\x01(\rR\x08costTime\x12\"\n\x07op_list\x18\x06\x20\x03(\x0b\
