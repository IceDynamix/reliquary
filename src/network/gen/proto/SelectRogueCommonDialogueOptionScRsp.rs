...
pub struct SelectRogueCommonDialogueOptionScRsp {
    ...
    pub retcode: u32,
    // @@protoc_insertion_point(field:SelectRogueCommonDialogueOptionScRsp.EFDPHFELDEG)
    pub EFDPHFELDEG: u32,
    // @@protoc_insertion_point(field:SelectRogueCommonDialogueOptionScRsp.FABICFOEMFG)
    pub FABICFOEMFG: ::std::vec::Vec<u32>,
    // @@protoc_insertion_point(field:SelectRogueCommonDialogueOptionScRsp.BIJDBCMDPPF)
    pub BIJDBCMDPPF: u32,
    // @@protoc_insertion_point(field:SelectRogueCommonDialogueOptionScRsp.NDIMEJLMLHO)
    pub NDIMEJLMLHO: bool,
    // @@protoc_insertion_point(field:SelectRogueCommonDialogueOptionScRsp.FFLCKMJGPPL)
...
impl SelectRogueCommonDialogueOptionScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "EFDPHFELDEG",
            |m: &SelectRogueCommonDialogueOptionScRsp| { &m.EFDPHFELDEG },
            |m: &mut SelectRogueCommonDialogueOptionScRsp| { &mut m.EFDPHFELDEG },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "FABICFOEMFG",
            |m: &SelectRogueCommonDialogueOptionScRsp| { &m.FABICFOEMFG },
            |m: &mut SelectRogueCommonDialogueOptionScRsp| { &mut m.FABICFOEMFG },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "BIJDBCMDPPF",
            |m: &SelectRogueCommonDialogueOptionScRsp| { &m.BIJDBCMDPPF },
            |m: &mut SelectRogueCommonDialogueOptionScRsp| { &mut m.BIJDBCMDPPF },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "NDIMEJLMLHO",
            |m: &SelectRogueCommonDialogueOptionScRsp| { &m.NDIMEJLMLHO },
            |m: &mut SelectRogueCommonDialogueOptionScRsp| { &mut m.NDIMEJLMLHO },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::BJDMNJJECDA::BJDMNJJECDA>(
            "FFLCKMJGPPL",
            |m: &SelectRogueCommonDialogueOptionScRsp| { &m.FFLCKMJGPPL },
            |m: &mut SelectRogueCommonDialogueOptionScRsp| { &mut m.FFLCKMJGPPL },
        ));
...
impl ::protobuf::Message for SelectRogueCommonDialogueOptionScRsp {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                90 => {
                    is.read_repeated_packed_uint32_into(&mut self.FABICFOEMFG)?;
                },
                88 => {
                    self.FABICFOEMFG.push(is.read_uint32()?);
                },
                24 => {
                    self.BIJDBCMDPPF = is.read_uint32()?;
                },
                56 => {
                    self.NDIMEJLMLHO = is.read_bool()?;
                },
                82 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.EFDPHFELDEG != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.EFDPHFELDEG);
        }
        for value in &self.FABICFOEMFG {
            my_size += ::protobuf::rt::uint32_size(11, *value);
        };
        if self.BIJDBCMDPPF != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.BIJDBCMDPPF);
        }
        if self.NDIMEJLMLHO != false {
            my_size += 1 + 1;
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.EFDPHFELDEG != 0 {
            os.write_uint32(14, self.EFDPHFELDEG)?;
        }
        for v in &self.FABICFOEMFG {
            os.write_uint32(11, *v)?;
        };
        if self.BIJDBCMDPPF != 0 {
            os.write_uint32(3, self.BIJDBCMDPPF)?;
        }
        if self.NDIMEJLMLHO != false {
            os.write_bool(7, self.NDIMEJLMLHO)?;
        }
        if let Some(v) = self.FFLCKMJGPPL.as_ref() {
    ...
    fn clear(&mut self) {
        self.retcode = 0;
        self.EFDPHFELDEG = 0;
        self.FABICFOEMFG.clear();
        self.BIJDBCMDPPF = 0;
        self.NDIMEJLMLHO = false;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n*SelectRogueCommonDialogueOptionScRsp.proto\x1a\x11BJDMNJJECDA.proto\"\
    \xf8\x01\n$SelectRogueCommonDialogueOptionScRsp\x12\x18\n\x07retcode\x18\
    \x01\x20\x01(\rR\x07retcode\x12\x20\n\x0bEFDPHFELDEG\x18\x0e\x20\x01(\rR\
    \x0bEFDPHFELDEG\x12\x20\n\x0bFABICFOEMFG\x18\x0b\x20\x03(\rR\x0bFABICFOE\
    MFG\x12\x20\n\x0bBIJDBCMDPPF\x18\x03\x20\x01(\rR\x0bBIJDBCMDPPF\x12\x20\
    \n\x0bNDIMEJLMLHO\x18\x07\x20\x01(\x08R\x0bNDIMEJLMLHO\x12.\n\x0bFFLCKMJ\
    GPPL\x18\n\x20\x01(\x0b2\x0c.BJDMNJJECDAR\x0bFFLCKMJGPPLb\x06proto3\
";
