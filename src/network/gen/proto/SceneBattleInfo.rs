...
impl ::protobuf::Message for SceneBattleInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.logic_random_seed != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.logic_random_seed);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        for (k, v) in &self.battle_target_info {
            ...
            entry_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
            os.write_raw_varint32(4666)?; // Tag.
        ...
        if self.logic_random_seed != 0 {
            os.write_uint32(3, self.logic_random_seed)?;
        }
        for v in &self.battle_avatar_list {
            ::protobuf::rt::write_message_field_with_cached_size(4, v, os)?;
        };
        for v in &self.event_battle_info_list {
            ::protobuf::rt::write_message_field_with_cached_size(413, v, os)?;
        };
        if self.stage_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    monster_wave_list\x18\x07\x20\x03(\x0b2\x11.SceneMonsterWaveR\x0fmonster\
    WaveList\x12U\n\x12battle_target_info\x18\xc7\x04\x20\x03(\x0b2&.SceneBa\
    ttleInfo.BattleTargetInfoEntryR\x10battleTargetInfo\x12\x1b\n\tbattle_id\
    \x18\x0f\x20\x01(\rR\x08battleId\x12\x1f\n\x0bworld_level\x18\x01\x20\
    \x01(\rR\nworldLevel\x12(\n\tbuff_list\x18\x06\x20\x03(\x0b2\x0b.BattleB\
    uffR\x08buffList\x12!\n\x0crounds_limit\x18\x08\x20\x01(\rR\x0broundsLim\
    it\x12*\n\x11logic_random_seed\x18\x03\x20\x01(\rR\x0flogicRandomSeed\
    \x12;\n\x12battle_avatar_list\x18\x04\x20\x03(\x0b2\r.BattleAvatarR\x10b\
    attleAvatarList\x12L\n\x16event_battle_info_list\x18\x9d\x03\x20\x03(\
    \x0b2\x16.BattleEventBattleInfoR\x13eventBattleInfoList\x12\x19\n\x08sta\
    ge_id\x18\x0b\x20\x01(\rR\x07stageId\x1aV\n\x15BattleTargetInfoEntry\x12\
