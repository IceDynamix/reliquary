...
impl ::protobuf::Message for SceneBattleInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.logic_random_seed != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.logic_random_seed);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        for (k, v) in &self.battle_target_info {
            ...
            entry_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
            os.write_raw_varint32(11466)?; // Tag.
        ...
        if self.logic_random_seed != 0 {
            os.write_uint32(9, self.logic_random_seed)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    battle_target_info\x18\x99\x0b\x20\x03(\x0b2&.SceneBattleInfo.BattleTarg\
    etInfoEntryR\x10battleTargetInfo\x12\x1b\n\tbattle_id\x18\x03\x20\x01(\r\
    R\x08battleId\x12L\n\x16event_battle_info_list\x18\x9b\t\x20\x03(\x0b2\
    \x16.BattleEventBattleInfoR\x13eventBattleInfoList\x12;\n\x12battle_avat\
    ar_list\x18\x0e\x20\x03(\x0b2\r.BattleAvatarR\x10battleAvatarList\x12=\n\
    \x11monster_wave_list\x18\n\x20\x03(\x0b2\x11.SceneMonsterWaveR\x0fmonst\
    erWaveList\x12\x1f\n\x0bworld_level\x18\x02\x20\x01(\rR\nworldLevel\x12!\
    \n\x0crounds_limit\x18\x05\x20\x01(\rR\x0broundsLimit\x12*\n\x11logic_ra\
    ndom_seed\x18\t\x20\x01(\rR\x0flogicRandomSeed\x12(\n\tbuff_list\x18\x0c\
    \x20\x03(\x0b2\x0b.BattleBuffR\x08buffList\x12\x19\n\x08stage_id\x18\x01\
    \x20\x01(\rR\x07stageId\x1aV\n\x15BattleTargetInfoEntry\x12\x10\n\x03key\
    \x18\x01\x20\x01(\rR\x03key\x12'\n\x05value\x18\x02\x20\x01(\x0b2\x11.Ba\
    ttleTargetListR\x05value:\x028\x01B\x15\n\x13emu.lunarcore.protob\x06pro\
    to3\
";
