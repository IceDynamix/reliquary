...
pub struct SceneBattleInfo {
    ...
    // @@protoc_insertion_point(field:SceneBattleInfo.KAHOEKAEFHD)
    ...
    // @@protoc_insertion_point(field:SceneBattleInfo.wave_count)
    pub wave_count: u32,
    ...
    pub world_level: u32,
    // @@protoc_insertion_point(field:SceneBattleInfo.NLBJKFNNONH)
...
impl SceneBattleInfo {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::EvolveBuild::EvolveBuildBattleInfo>(
            "KAHOEKAEFHD",
            |m: &SceneBattleInfo| { &m.KAHOEKAEFHD },
            |m: &mut SceneBattleInfo| { &mut m.KAHOEKAEFHD },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "monster_wave_list",
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "wave_count",
            |m: &SceneBattleInfo| { &m.wave_count },
            |m: &mut SceneBattleInfo| { &mut m.wave_count },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "logic_random_seed",
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "NLBJKFNNONH",
            |m: &SceneBattleInfo| { &m.NLBJKFNNONH },
            |m: &mut SceneBattleInfo| { &mut m.NLBJKFNNONH },
        ));
...
impl ::protobuf::Message for SceneBattleInfo {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                72 => {
                    self.wave_count = is.read_uint32()?;
                },
                80 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.wave_count != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.wave_count);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.wave_count != 0 {
            os.write_uint32(9, self.wave_count)?;
        }
        if self.logic_random_seed != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x1a\x16BattleTargetList.proto\x1a\x11EvolveBuild.proto\x1a\x1aRogueMagi\
    cBattleInfo.proto\"\xd8\x05\n\x0fSceneBattleInfo\x12(\n\tbuff_list\x18\
    \x0e\x20\x03(\x0b2\x0b.BattleBuffR\x08buffList\x12\x1b\n\tbattle_id\x18\
    \x03\x20\x01(\rR\x08battleId\x12\x19\n\x08stage_id\x18\x0b\x20\x01(\rR\
    \x07stageId\x12U\n\x12battle_target_info\x18\x98\x0c\x20\x03(\x0b2&.Scen\
    eBattleInfo.BattleTargetInfoEntryR\x10battleTargetInfo\x12!\n\x0crounds_\
    limit\x18\r\x20\x01(\rR\x0broundsLimit\x12L\n\x16event_battle_info_list\
    \x18\xe4\x05\x20\x03(\x0b2\x16.BattleEventBattleInfoR\x13eventBattleInfo\
    List\x129\n\x0bKAHOEKAEFHD\x18\xcb\x05\x20\x01(\x0b2\x16.EvolveBuildBatt\
    leInfoR\x0bKAHOEKAEFHD\x12=\n\x11monster_wave_list\x18\x05\x20\x03(\x0b2\
    \x11.SceneMonsterWaveR\x0fmonsterWaveList\x12\x1d\n\nwave_count\x18\t\
    \x20\x01(\rR\twaveCount\x12*\n\x11logic_random_seed\x18\n\x20\x01(\rR\
    \x0flogicRandomSeed\x12;\n\x12battle_avatar_list\x18\x02\x20\x03(\x0b2\r\
    .BattleAvatarR\x10battleAvatarList\x12\x1f\n\x0bworld_level\x18\x08\x20\
    \x01(\rR\nworldLevel\x12\x20\n\x0bNLBJKFNNONH\x18\x01\x20\x01(\x08R\x0bN\
    LBJKFNNONH\x1aV\n\x15BattleTargetInfoEntry\x12\x10\n\x03key\x18\x01\x20\
    \x01(\rR\x03key\x12'\n\x05value\x18\x02\x20\x01(\x0b2\x11.BattleTargetLi\
    stR\x05value:\x028\x01B\x15\n\x13emu.lunarcore.protob\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::EvolveBuild::file_descriptor().clone());
