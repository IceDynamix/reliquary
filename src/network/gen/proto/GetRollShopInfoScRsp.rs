...
impl ::protobuf::Message for GetRollShopInfoScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.BBJIJINJAFK != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.BBJIJINJAFK);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.BBJIJINJAFK != 0 {
            os.write_uint32(9, self.BBJIJINJAFK)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ode\x18\r\x20\x01(\rR\x07retcode\x12\x20\n\x0bDLPBJMPECFC\x18\x05\x20\
    \x03(\rR\x0bDLPBJMPECFC\x12\x20\n\x0bBBJIJINJAFK\x18\t\x20\x01(\rR\x0bBB\
