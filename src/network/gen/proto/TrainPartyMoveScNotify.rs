...
pub struct TrainPartyMoveScNotify {
    ...
    pub GHEEOEOHMFI: u32,
    // @@protoc_insertion_point(field:TrainPartyMoveScNotify.PEADIOCNIMF)
    pub PEADIOCNIMF: ::std::vec::Vec<super::KKNLMCJIGAF::KKNLMCJIGAF>,
    // special fields
...
impl TrainPartyMoveScNotify {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "PEADIOCNIMF",
            |m: &TrainPartyMoveScNotify| { &m.PEADIOCNIMF },
            |m: &mut TrainPartyMoveScNotify| { &mut m.PEADIOCNIMF },
        ));
...
impl ::protobuf::Message for TrainPartyMoveScNotify {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                58 => {
                    self.PEADIOCNIMF.push(is.read_message()?);
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.GHEEOEOHMFI != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.GHEEOEOHMFI);
        }
        for value in &self.PEADIOCNIMF {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.GHEEOEOHMFI != 0 {
            os.write_uint32(5, self.GHEEOEOHMFI)?;
        }
        for v in &self.PEADIOCNIMF {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    nPartyMoveScNotify\x12\x20\n\x0bGHEEOEOHMFI\x18\x05\x20\x01(\rR\x0bGHEEO\
    EOHMFI\x12.\n\x0bPEADIOCNIMF\x18\x07\x20\x03(\x0b2\x0c.KKNLMCJIGAFR\x0bP\
    EADIOCNIMFb\x06proto3\
";
