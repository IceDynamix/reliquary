...
pub struct GetBenefitActivityInfoScRsp {
    // message fields
    // @@protoc_insertion_point(field:GetBenefitActivityInfoScRsp.ABBLHNKDPPI)
    pub ABBLHNKDPPI: bool,
    // @@protoc_insertion_point(field:GetBenefitActivityInfoScRsp.MNJDBGMJECF)
    pub MNJDBGMJECF: ::std::vec::Vec<super::FOHMKMDOHGP::FOHMKMDOHGP>,
...
impl GetBenefitActivityInfoScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "ABBLHNKDPPI",
            |m: &GetBenefitActivityInfoScRsp| { &m.ABBLHNKDPPI },
            |m: &mut GetBenefitActivityInfoScRsp| { &mut m.ABBLHNKDPPI },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "MNJDBGMJECF",
            |m: &GetBenefitActivityInfoScRsp| { &m.MNJDBGMJECF },
            |m: &mut GetBenefitActivityInfoScRsp| { &mut m.MNJDBGMJECF },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "retcode",
...
impl ::protobuf::Message for GetBenefitActivityInfoScRsp {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                32 => {
                    self.ABBLHNKDPPI = is.read_bool()?;
                },
                50 => {
                    self.MNJDBGMJECF.push(is.read_message()?);
                },
                64 => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.ABBLHNKDPPI != false {
            my_size += 1 + 1;
        }
        for value in &self.MNJDBGMJECF {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.ABBLHNKDPPI != false {
            os.write_bool(4, self.ABBLHNKDPPI)?;
        }
        for v in &self.MNJDBGMJECF {
    ...
    fn clear(&mut self) {
        self.ABBLHNKDPPI = false;
        self.MNJDBGMJECF.clear();
        self.retcode = 0;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n!GetBenefitActivityInfoScRsp.proto\x1a\x11FOHMKMDOHGP.proto\"\x89\x01\
    \n\x1bGetBenefitActivityInfoScRsp\x12\x20\n\x0bABBLHNKDPPI\x18\x04\x20\
    \x01(\x08R\x0bABBLHNKDPPI\x12.\n\x0bMNJDBGMJECF\x18\x06\x20\x03(\x0b2\
    \x0c.FOHMKMDOHGPR\x0bMNJDBGMJECF\x12\x18\n\x07retcode\x18\x08\x20\x01(\r\
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::FOHMKMDOHGP::file_descriptor().clone());
