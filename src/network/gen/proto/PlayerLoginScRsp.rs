...
impl ::protobuf::Message for PlayerLoginScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.JOAMEJFEOAM != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.JOAMEJFEOAM);
        }
        if self.retcode != 0 {
        ...
        if self.LOGOEFCPCHK != 0 {
            my_size += ::protobuf::rt::uint64_size(11, self.LOGOEFCPCHK);
        }
        ...
        if self.FLOEMBLNODK != 0 {
            my_size += ::protobuf::rt::int32_size(3, self.FLOEMBLNODK);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.JOAMEJFEOAM != 0 {
            os.write_uint32(5, self.JOAMEJFEOAM)?;
        }
        if self.retcode != 0 {
        ...
        if self.LOGOEFCPCHK != 0 {
            os.write_uint64(11, self.LOGOEFCPCHK)?;
        }
        if self.IGKBEAMLNBJ != false {
        ...
        if self.FLOEMBLNODK != 0 {
            os.write_int32(3, self.FLOEMBLNODK)?;
        }
        if self.NMOOODOHHCI != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    yerLoginScRsp\x12.\n\x0bGPKGJLNHPJK\x18\r\x20\x01(\x0b2\x0c.DJOLEKKPBGBR\
    \x0bGPKGJLNHPJK\x12\x20\n\x0bJOAMEJFEOAM\x18\x05\x20\x01(\rR\x0bJOAMEJFE\
    OAM\x12\x18\n\x07retcode\x18\x0f\x20\x01(\rR\x07retcode\x12\x20\n\x0bNHM\
    HABJKHOG\x18\t\x20\x01(\tR\x0bNHMHABJKHOG\x12\x20\n\x0bLOGOEFCPCHK\x18\
    \x0b\x20\x01(\x04R\x0bLOGOEFCPCHK\x12\x20\n\x0bIGKBEAMLNBJ\x18\x06\x20\
    \x01(\x08R\x0bIGKBEAMLNBJ\x12\x20\n\x0bPDIKPEIFANN\x18\x07\x20\x01(\tR\
    \x0bPDIKPEIFANN\x12\x20\n\x0bFLOEMBLNODK\x18\x03\x20\x01(\x05R\x0bFLOEMB\
    LNODK\x12\x20\n\x0bNMOOODOHHCI\x18\x04\x20\x01(\x04R\x0bNMOOODOHHCI\x12\
