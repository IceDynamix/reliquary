...
//! Generated file from `IBCGAGLOLNA.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:IBCGAGLOLNA)
...
impl<'a> ::std::default::Default for &'a IBCGAGLOLNA {
    fn default() -> &'a IBCGAGLOLNA {
        <IBCGAGLOLNA as ::protobuf::Message>::default_instance()
    }
}

impl IBCGAGLOLNA {
    pub fn new() -> IBCGAGLOLNA {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            ...
            |m: &mut IBCGAGLOLNA| { &mut m.JJCIPIMCBBJ },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "HOBJMINNBOP",
...
impl ::protobuf::Message for IBCGAGLOLNA {
    const NAME: &'static str = "IBCGAGLOLNA";
...
impl ::protobuf::MessageFull for IBCGAGLOLNA {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("IBCGAGLOLNA").unwrap()).clone()
    }
}

impl ::std::fmt::Display for IBCGAGLOLNA {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for IBCGAGLOLNA {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(IBCGAGLOLNA::generated_message_descriptor_data());
