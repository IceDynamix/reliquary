...
pub struct Relic {
    ...
    pub unique_id: u32,
    // @@protoc_insertion_point(field:Relic.FNNGLGIFBBE)
    pub FNNGLGIFBBE: ::std::vec::Vec<super::RelicAffix::RelicAffix>,
...
impl Relic {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "FNNGLGIFBBE",
            |m: &Relic| { &m.FNNGLGIFBBE },
            |m: &mut Relic| { &mut m.FNNGLGIFBBE },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "level",
            |m: &Relic| { &m.level },
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                122 => {
                    self.FNNGLGIFBBE.push(is.read_message()?);
                },
                32 => {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0cis_protected\x18\n\x20\x01(\x08R\x0bisProtected\x121\n\x0esub_affix_\
    list\x18\t\x20\x03(\x0b2\x0b.RelicAffixR\x0csubAffixList\x12\x1b\n\tuniq\
    ue_id\x18\x07\x20\x01(\rR\x08uniqueId\x12-\n\x0bFNNGLGIFBBE\x18\x0f\x20\
    \x03(\x0b2\x0b.RelicAffixR\x0bFNNGLGIFBBE\x12\x14\n\x05level\x18\x04\x20\
    \x01(\rR\x05level\x12!\n\x0cis_discarded\x18\x06\x20\x01(\x08R\x0bisDisc\
    arded\x12\x10\n\x03exp\x18\x0b\x20\x01(\rR\x03exp\x12\x10\n\x03tid\x18\r\
    \x20\x01(\rR\x03tid\x12\"\n\rmain_affix_id\x18\x0c\x20\x01(\rR\x0bmainAf\
    fixId\x12&\n\x0fequip_avatar_id\x18\x01\x20\x01(\rR\requipAvatarIdb\x06p\
    roto3\
";
