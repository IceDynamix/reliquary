...
//! Generated file from `LAILNIGFPOO.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:LAILNIGFPOO)
...
impl<'a> ::std::default::Default for &'a LAILNIGFPOO {
    fn default() -> &'a LAILNIGFPOO {
        <LAILNIGFPOO as ::protobuf::Message>::default_instance()
    }
}

impl LAILNIGFPOO {
    pub fn new() -> LAILNIGFPOO {
...
impl ::protobuf::Message for LAILNIGFPOO {
    const NAME: &'static str = "LAILNIGFPOO";
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.KHGPFHBOELE != 0 {
            my_size += ::protobuf::rt::uint64_size(13, self.KHGPFHBOELE);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.AELPFEBGNOK != false {
            os.write_bool(14, self.AELPFEBGNOK)?;
        }
        if self.KHGPFHBOELE != 0 {
            os.write_uint64(13, self.KHGPFHBOELE)?;
        }
...
impl ::protobuf::MessageFull for LAILNIGFPOO {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("LAILNIGFPOO").unwrap()).clone()
    }
}

impl ::std::fmt::Display for LAILNIGFPOO {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for LAILNIGFPOO {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x11LAILNIGFPOO.proto\"s\n\x0bLAILNIGFPOO\x12\x20\n\x0bKGJHJMDCAOC\x18\
    \n\x20\x01(\x08R\x0bKGJHJMDCAOC\x12\x20\n\x0bAELPFEBGNOK\x18\x0e\x20\x01\
    (\x08R\x0bAELPFEBGNOK\x12\x20\n\x0bKHGPFHBOELE\x18\r\x20\x01(\x04R\x0bKH\
    GPFHBOELEb\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(LAILNIGFPOO::generated_message_descriptor_data());
