...
impl ::protobuf::Message for FPCHMKKCGFA {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.AFFJHMJDIBN != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.AFFJHMJDIBN);
        }
        if self.BNCKFBFMGMI != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.BNCKFBFMGMI);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.AFFJHMJDIBN != 0 {
            os.write_uint32(1, self.AFFJHMJDIBN)?;
        }
        if self.BNCKFBFMGMI != 0 {
            os.write_uint32(11, self.BNCKFBFMGMI)?;
        }
        if self.LGHOKGABGCK != ::protobuf::EnumOrUnknown::new(super::NJCHLJFIODM::NJCHLJFIODM::ROGUE_MODIFIER_CONTENT_DEFINITE) {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    GFA\x12\x20\n\x0bAFFJHMJDIBN\x18\x01\x20\x01(\rR\x0bAFFJHMJDIBN\x12\x20\
    \n\x0bBNCKFBFMGMI\x18\x0b\x20\x01(\rR\x0bBNCKFBFMGMI\x12.\n\x0bLGHOKGABG\
