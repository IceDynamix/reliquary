...
pub struct GetMonopolyFriendRankingListScRsp {
    // message fields
    // @@protoc_insertion_point(field:GetMonopolyFriendRankingListScRsp.OPOLOPOHLOK)
    pub OPOLOPOHLOK: ::protobuf::MessageField<super::CKBCAHOBKBH::CKBCAHOBKBH>,
    // @@protoc_insertion_point(field:GetMonopolyFriendRankingListScRsp.retcode)
    pub retcode: u32,
    // @@protoc_insertion_point(field:GetMonopolyFriendRankingListScRsp.KKAPLKKJECE)
    pub KKAPLKKJECE: ::std::vec::Vec<super::CKBCAHOBKBH::CKBCAHOBKBH>,
    // special fields
...
impl GetMonopolyFriendRankingListScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::CKBCAHOBKBH::CKBCAHOBKBH>(
            "OPOLOPOHLOK",
            |m: &GetMonopolyFriendRankingListScRsp| { &m.OPOLOPOHLOK },
            |m: &mut GetMonopolyFriendRankingListScRsp| { &mut m.OPOLOPOHLOK },
        ));
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "KKAPLKKJECE",
            |m: &GetMonopolyFriendRankingListScRsp| { &m.KKAPLKKJECE },
            |m: &mut GetMonopolyFriendRankingListScRsp| { &mut m.KKAPLKKJECE },
        ));
...
impl ::protobuf::Message for GetMonopolyFriendRankingListScRsp {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                26 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.OPOLOPOHLOK)?;
                },
                104 => {
                    self.retcode = is.read_uint32()?;
                },
                10 => {
                    self.KKAPLKKJECE.push(is.read_message()?);
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if let Some(v) = self.OPOLOPOHLOK.as_ref() {
    ...
    fn clear(&mut self) {
        self.OPOLOPOHLOK.clear();
        self.retcode = 0;
        self.KKAPLKKJECE.clear();
    ...
    fn default_instance() -> &'static GetMonopolyFriendRankingListScRsp {
        static instance: GetMonopolyFriendRankingListScRsp = GetMonopolyFriendRankingListScRsp {
            OPOLOPOHLOK: ::protobuf::MessageField::none(),
            retcode: 0,
            KKAPLKKJECE: ::std::vec::Vec::new(),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n'GetMonopolyFriendRankingListScRsp.proto\x1a\x11CKBCAHOBKBH.proto\"\
    \x9d\x01\n!GetMonopolyFriendRankingListScRsp\x12.\n\x0bOPOLOPOHLOK\x18\
    \x03\x20\x01(\x0b2\x0c.CKBCAHOBKBHR\x0bOPOLOPOHLOK\x12\x18\n\x07retcode\
    \x18\r\x20\x01(\rR\x07retcode\x12.\n\x0bKKAPLKKJECE\x18\x01\x20\x03(\x0b\
    2\x0c.CKBCAHOBKBHR\x0bKKAPLKKJECEb\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::CKBCAHOBKBH::file_descriptor().clone());
