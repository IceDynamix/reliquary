...
pub struct MatchThreeLevelEndScRsp {
    // message fields
    // @@protoc_insertion_point(field:MatchThreeLevelEndScRsp.DGEJMCKIFJB)
    pub DGEJMCKIFJB: u32,
    // @@protoc_insertion_point(field:MatchThreeLevelEndScRsp.retcode)
    pub retcode: u32,
    // @@protoc_insertion_point(field:MatchThreeLevelEndScRsp.KIFPFCDEAAE)
    pub KIFPFCDEAAE: u32,
    // special fields
...
impl MatchThreeLevelEndScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "DGEJMCKIFJB",
            |m: &MatchThreeLevelEndScRsp| { &m.DGEJMCKIFJB },
            |m: &mut MatchThreeLevelEndScRsp| { &mut m.DGEJMCKIFJB },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "retcode",
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "KIFPFCDEAAE",
            |m: &MatchThreeLevelEndScRsp| { &m.KIFPFCDEAAE },
            |m: &mut MatchThreeLevelEndScRsp| { &mut m.KIFPFCDEAAE },
        ));
...
impl ::protobuf::Message for MatchThreeLevelEndScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.DGEJMCKIFJB != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.DGEJMCKIFJB);
        }
        if self.retcode != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.retcode);
        }
        if self.KIFPFCDEAAE != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.KIFPFCDEAAE);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.DGEJMCKIFJB != 0 {
            os.write_uint32(7, self.DGEJMCKIFJB)?;
        }
        if self.retcode != 0 {
            os.write_uint32(12, self.retcode)?;
        }
        if self.KIFPFCDEAAE != 0 {
            os.write_uint32(10, self.KIFPFCDEAAE)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x20\n\x0bDGEJMCKIFJB\x18\x07\x20\x01(\rR\x0bDGEJMCKIFJB\x12\x18\n\x07re\
    tcode\x18\x0c\x20\x01(\rR\x07retcode\x12\x20\n\x0bKIFPFCDEAAE\x18\n\x20\
    \x01(\rR\x0bKIFPFCDEAAEb\x06proto3\
";
