...
pub struct GetFriendChallengeLineupScRsp {
    // message fields
    // @@protoc_insertion_point(field:GetFriendChallengeLineupScRsp.EMIDNFPPMBH)
    pub EMIDNFPPMBH: bool,
    // @@protoc_insertion_point(field:GetFriendChallengeLineupScRsp.retcode)
    pub retcode: u32,
    // @@protoc_insertion_point(field:GetFriendChallengeLineupScRsp.PPAGGONDPCF)
    pub PPAGGONDPCF: ::std::vec::Vec<super::KLMFIBACKFD::KLMFIBACKFD>,
    // special fields
...
impl GetFriendChallengeLineupScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "EMIDNFPPMBH",
            |m: &GetFriendChallengeLineupScRsp| { &m.EMIDNFPPMBH },
            |m: &mut GetFriendChallengeLineupScRsp| { &mut m.EMIDNFPPMBH },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "retcode",
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "PPAGGONDPCF",
            |m: &GetFriendChallengeLineupScRsp| { &m.PPAGGONDPCF },
            |m: &mut GetFriendChallengeLineupScRsp| { &mut m.PPAGGONDPCF },
        ));
...
impl ::protobuf::Message for GetFriendChallengeLineupScRsp {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.EMIDNFPPMBH != false {
            os.write_bool(5, self.EMIDNFPPMBH)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n#GetFriendChallengeLineupScRsp.proto\x1a\x11KLMFIBACKFD.proto\"\x8b\
    \x01\n\x1dGetFriendChallengeLineupScRsp\x12\x20\n\x0bEMIDNFPPMBH\x18\x05\
    \x20\x01(\x08R\x0bEMIDNFPPMBH\x12\x18\n\x07retcode\x18\x02\x20\x01(\rR\
    \x07retcode\x12.\n\x0bPPAGGONDPCF\x18\x04\x20\x03(\x0b2\x0c.KLMFIBACKFDR\
    \x0bPPAGGONDPCFb\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::KLMFIBACKFD::file_descriptor().clone());
