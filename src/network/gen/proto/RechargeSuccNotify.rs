...
impl ::protobuf::Message for RechargeSuccNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.channel_order_no.is_empty() {
            my_size += ::protobuf::rt::string_size(6, &self.channel_order_no);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.channel_order_no.is_empty() {
            os.write_string(6, &self.channel_order_no)?;
        }
        if self.month_card_outdate_time != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    argeSuccNotify\x12\x1d\n\nproduct_id\x18\x0e\x20\x01(\tR\tproductId\x12&\
    \n\titem_list\x18\x05\x20\x01(\x0b2\t.ItemListR\x08itemList\x12(\n\x10ch\
    annel_order_no\x18\x06\x20\x01(\tR\x0echannelOrderNo\x125\n\x17month_car\
    d_outdate_time\x18\x0b\x20\x01(\x04R\x14monthCardOutdateTimeb\x06proto3\
";
