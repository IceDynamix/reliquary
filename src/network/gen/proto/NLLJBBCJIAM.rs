...
pub struct NLLJBBCJIAM {
    ...
    // @@protoc_insertion_point(field:NLLJBBCJIAM.CLKEOEHPLNG)
    pub CLKEOEHPLNG: u32,
    // special fields
...
impl NLLJBBCJIAM {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "CLKEOEHPLNG",
            |m: &NLLJBBCJIAM| { &m.CLKEOEHPLNG },
            |m: &mut NLLJBBCJIAM| { &mut m.CLKEOEHPLNG },
        ));
...
impl ::protobuf::Message for NLLJBBCJIAM {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(1, &self.ODOGFHENJEP);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(1, &self.ODOGFHENJEP)?;
        if self.CLKEOEHPLNG != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x11NLLJBBCJIAM.proto\"Q\n\x0bNLLJBBCJIAM\x12\x20\n\x0bODOGFHENJEP\x18\
    \x01\x20\x03(\rR\x0bODOGFHENJEP\x12\x20\n\x0bCLKEOEHPLNG\x18\x07\x20\x01\
    (\rR\x0bCLKEOEHPLNGb\x06proto3\
";
