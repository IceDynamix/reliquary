...
pub struct AvatarPathChangedNotify {
    ...
    // @@protoc_insertion_point(field:AvatarPathChangedNotify.PEMIKIDKNJG)
    pub PEMIKIDKNJG: ::protobuf::EnumOrUnknown<super::MultiPathAvatarType::MultiPathAvatarType>,
    // special fields
...
impl AvatarPathChangedNotify {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "PEMIKIDKNJG",
            |m: &AvatarPathChangedNotify| { &m.PEMIKIDKNJG },
            |m: &mut AvatarPathChangedNotify| { &mut m.PEMIKIDKNJG },
        ));
...
impl ::protobuf::Message for AvatarPathChangedNotify {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                32 => {
                    self.PEMIKIDKNJG = is.read_enum_or_unknown()?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.PEMIKIDKNJG != ::protobuf::EnumOrUnknown::new(super::MultiPathAvatarType::MultiPathAvatarType::MultiPathAvatarTypeNone) {
            my_size += ::protobuf::rt::int32_size(4, self.PEMIKIDKNJG.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.PEMIKIDKNJG != ::protobuf::EnumOrUnknown::new(super::MultiPathAvatarType::MultiPathAvatarType::MultiPathAvatarTypeNone) {
            os.write_enum(4, ::protobuf::EnumOrUnknown::value(&self.PEMIKIDKNJG))?;
        }
    ...
    fn clear(&mut self) {
        ...
        self.PEMIKIDKNJG = ::protobuf::EnumOrUnknown::new(super::MultiPathAvatarType::MultiPathAvatarType::MultiPathAvatarTypeNone);
    ...
    fn default_instance() -> &'static AvatarPathChangedNotify {
        static instance: AvatarPathChangedNotify = AvatarPathChangedNotify {
            base_avatar_id: 0,
            PEMIKIDKNJG: ::protobuf::EnumOrUnknown::from_i32(0),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x17AvatarPathChangedNotify\x12$\n\x0ebase_avatar_id\x18\r\x20\x01(\rR\
    \x0cbaseAvatarId\x126\n\x0bPEMIKIDKNJG\x18\x04\x20\x01(\x0e2\x14.MultiPa\
    thAvatarTypeR\x0bPEMIKIDKNJGb\x06proto3\
";
