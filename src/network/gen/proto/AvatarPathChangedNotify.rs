...
pub struct AvatarPathChangedNotify {
    // message fields
    // @@protoc_insertion_point(field:AvatarPathChangedNotify.POALPJAKFAP)
    pub POALPJAKFAP: ::protobuf::EnumOrUnknown<super::MultiPathAvatarType::MultiPathAvatarType>,
...
impl AvatarPathChangedNotify {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "POALPJAKFAP",
            |m: &AvatarPathChangedNotify| { &m.POALPJAKFAP },
            |m: &mut AvatarPathChangedNotify| { &mut m.POALPJAKFAP },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "base_avatar_id",
...
impl ::protobuf::Message for AvatarPathChangedNotify {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                112 => {
                    self.POALPJAKFAP = is.read_enum_or_unknown()?;
                },
                56 => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.POALPJAKFAP != ::protobuf::EnumOrUnknown::new(super::MultiPathAvatarType::MultiPathAvatarType::MultiPathAvatarTypeNone) {
            my_size += ::protobuf::rt::int32_size(14, self.POALPJAKFAP.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.POALPJAKFAP != ::protobuf::EnumOrUnknown::new(super::MultiPathAvatarType::MultiPathAvatarType::MultiPathAvatarTypeNone) {
            os.write_enum(14, ::protobuf::EnumOrUnknown::value(&self.POALPJAKFAP))?;
        }
        if self.base_avatar_id != 0 {
    ...
    fn clear(&mut self) {
        self.POALPJAKFAP = ::protobuf::EnumOrUnknown::new(super::MultiPathAvatarType::MultiPathAvatarType::MultiPathAvatarTypeNone);
    ...
    fn default_instance() -> &'static AvatarPathChangedNotify {
        static instance: AvatarPathChangedNotify = AvatarPathChangedNotify {
            POALPJAKFAP: ::protobuf::EnumOrUnknown::from_i32(0),
            base_avatar_id: 0,
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1dAvatarPathChangedNotify.proto\x1a\x19MultiPathAvatarType.proto\"w\
    \n\x17AvatarPathChangedNotify\x126\n\x0bPOALPJAKFAP\x18\x0e\x20\x01(\x0e\
    2\x14.MultiPathAvatarTypeR\x0bPOALPJAKFAP\x12$\n\x0ebase_avatar_id\x18\
    \x07\x20\x01(\rR\x0cbaseAvatarIdb\x06proto3\
";
