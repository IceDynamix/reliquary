...
pub struct AvatarPathChangedNotify {
    ...
    // @@protoc_insertion_point(field:AvatarPathChangedNotify.HFBECOGKINM)
    pub HFBECOGKINM: ::protobuf::EnumOrUnknown<super::MultiPathAvatarType::MultiPathAvatarType>,
    // special fields
...
impl AvatarPathChangedNotify {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "HFBECOGKINM",
            |m: &AvatarPathChangedNotify| { &m.HFBECOGKINM },
            |m: &mut AvatarPathChangedNotify| { &mut m.HFBECOGKINM },
        ));
...
impl ::protobuf::Message for AvatarPathChangedNotify {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                120 => {
                    self.HFBECOGKINM = is.read_enum_or_unknown()?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.HFBECOGKINM != ::protobuf::EnumOrUnknown::new(super::MultiPathAvatarType::MultiPathAvatarType::MultiPathAvatarTypeNone) {
            my_size += ::protobuf::rt::int32_size(15, self.HFBECOGKINM.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.HFBECOGKINM != ::protobuf::EnumOrUnknown::new(super::MultiPathAvatarType::MultiPathAvatarType::MultiPathAvatarTypeNone) {
            os.write_enum(15, ::protobuf::EnumOrUnknown::value(&self.HFBECOGKINM))?;
        }
    ...
    fn clear(&mut self) {
        ...
        self.HFBECOGKINM = ::protobuf::EnumOrUnknown::new(super::MultiPathAvatarType::MultiPathAvatarType::MultiPathAvatarTypeNone);
    ...
    fn default_instance() -> &'static AvatarPathChangedNotify {
        static instance: AvatarPathChangedNotify = AvatarPathChangedNotify {
            base_avatar_id: 0,
            HFBECOGKINM: ::protobuf::EnumOrUnknown::from_i32(0),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x17AvatarPathChangedNotify\x12$\n\x0ebase_avatar_id\x18\x0c\x20\x01(\
    \rR\x0cbaseAvatarId\x126\n\x0bHFBECOGKINM\x18\x0f\x20\x01(\x0e2\x14.Mult\
    iPathAvatarTypeR\x0bHFBECOGKINMb\x06proto3\
";
