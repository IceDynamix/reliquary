...
impl ::protobuf::Message for StartPunkLordRaidScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.AGEGDMGNPDK != 0 {
            my_size += ::protobuf::rt::int64_size(9, self.AGEGDMGNPDK);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.CLOMMFKJPMM != false {
            os.write_bool(6, self.CLOMMFKJPMM)?;
        }
        if self.AGEGDMGNPDK != 0 {
            os.write_int64(9, self.AGEGDMGNPDK)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x0b\x20\x01(\rR\x07retcode\x12.\n\x0bIDOMKBKKKKL\x18\x03\x20\x01(\
    \x0b2\x0c.FNLGPLNCPCLR\x0bIDOMKBKKKKL\x12\x20\n\x0bDMILCFHLIHP\x18\x07\
    \x20\x03(\rR\x0bDMILCFHLIHP\x12.\n\x0bDPMKAMMIOLB\x18\x0c\x20\x01(\x0b2\
    \x0c.KAOAHKAOHFIR\x0bDPMKAMMIOLB\x12\x20\n\x0bCLOMMFKJPMM\x18\x06\x20\
    \x01(\x08R\x0bCLOMMFKJPMM\x12\x20\n\x0bAGEGDMGNPDK\x18\t\x20\x01(\x03R\
    \x0bAGEGDMGNPDKb\x06proto3\
";
