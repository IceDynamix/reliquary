...
impl ::protobuf::Message for ExchangeGachaCeilingScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.IDDDLEKCICN != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.IDDDLEKCICN);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.IDDDLEKCICN != 0 {
            os.write_uint32(6, self.IDDDLEKCICN)?;
        }
        if let Some(v) = self.MENLIBPOAJA.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    emList.proto\"\xd1\x01\n\x19ExchangeGachaCeilingScRsp\x12+\n\x0bPMJIDGLB\
    DMC\x18\x02\x20\x01(\x0b2\t.ItemListR\x0bPMJIDGLBDMC\x12\x1b\n\tavatar_i\
    d\x18\t\x20\x01(\rR\x08avatarId\x12\x20\n\x0bIDDDLEKCICN\x18\x06\x20\x01\
    (\rR\x0bIDDDLEKCICN\x12.\n\x0bMENLIBPOAJA\x18\x0e\x20\x01(\x0b2\x0c.INJN\
    DJJFAKJR\x0bMENLIBPOAJA\x12\x18\n\x07retcode\x18\x08\x20\x01(\rR\x07retc\
    odeb\x06proto3\
";
