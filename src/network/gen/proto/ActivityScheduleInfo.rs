...
impl ::protobuf::Message for ActivityScheduleInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.module_id != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.module_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.module_id != 0 {
            os.write_uint32(14, self.module_id)?;
        }
        if self.activity_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    e\x18\x03\x20\x01(\x03R\x07endTime\x12\x1b\n\tmodule_id\x18\x0e\x20\x01(\
    \rR\x08moduleId\x12\x1f\n\x0bactivity_id\x18\r\x20\x01(\rR\nactivityIdB\
