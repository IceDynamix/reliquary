...
pub struct LobbyCreateCsReq {
    // message fields
    // @@protoc_insertion_point(field:LobbyCreateCsReq.LAJONMOIOFH)
    pub LAJONMOIOFH: ::protobuf::MessageField<super::EMPBNBJLDNI::EMPBNBJLDNI>,
    // @@protoc_insertion_point(field:LobbyCreateCsReq.MGGMPKIGHBM)
...
impl LobbyCreateCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::EMPBNBJLDNI::EMPBNBJLDNI>(
            "LAJONMOIOFH",
            |m: &LobbyCreateCsReq| { &m.LAJONMOIOFH },
            |m: &mut LobbyCreateCsReq| { &mut m.LAJONMOIOFH },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "MGGMPKIGHBM",
            |m: &LobbyCreateCsReq| { &m.MGGMPKIGHBM },
            |m: &mut LobbyCreateCsReq| { &mut m.MGGMPKIGHBM },
        ));
...
impl ::protobuf::Message for LobbyCreateCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.MGGMPKIGHBM != ::protobuf::EnumOrUnknown::new(super::FightGameMode::FightGameMode::FIGHT_GAME_MODE_NONE) {
            my_size += ::protobuf::rt::int32_size(3, self.MGGMPKIGHBM.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.MGGMPKIGHBM != ::protobuf::EnumOrUnknown::new(super::FightGameMode::FightGameMode::FIGHT_GAME_MODE_NONE) {
            os.write_enum(3, ::protobuf::EnumOrUnknown::value(&self.MGGMPKIGHBM))?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x16LobbyCreateCsReq.proto\x1a\x11EMPBNBJLDNI.proto\x1a\x13FightGameMo\
    de.proto\"t\n\x10LobbyCreateCsReq\x12.\n\x0bLAJONMOIOFH\x18\x07\x20\x01(\
    \x0b2\x0c.EMPBNBJLDNIR\x0bLAJONMOIOFH\x120\n\x0bMGGMPKIGHBM\x18\x03\x20\
    \x01(\x0e2\x0e.FightGameModeR\x0bMGGMPKIGHBMb\x06proto3\
";
