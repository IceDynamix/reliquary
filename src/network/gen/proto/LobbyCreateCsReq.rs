...
pub struct LobbyCreateCsReq {
    // message fields
    // @@protoc_insertion_point(field:LobbyCreateCsReq.MGAIAJAKPEI)
    pub MGAIAJAKPEI: ::protobuf::EnumOrUnknown<super::FightGameMode::FightGameMode>,
    // @@protoc_insertion_point(field:LobbyCreateCsReq.DIFNDEGMKNA)
...
impl LobbyCreateCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "MGAIAJAKPEI",
            |m: &LobbyCreateCsReq| { &m.MGAIAJAKPEI },
            |m: &mut LobbyCreateCsReq| { &mut m.MGAIAJAKPEI },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::PGDACNIBFMP::PGDACNIBFMP>(
            "DIFNDEGMKNA",
            |m: &LobbyCreateCsReq| { &m.DIFNDEGMKNA },
            |m: &mut LobbyCreateCsReq| { &mut m.DIFNDEGMKNA },
        ));
...
impl ::protobuf::Message for LobbyCreateCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.MGAIAJAKPEI != ::protobuf::EnumOrUnknown::new(super::FightGameMode::FightGameMode::FIGHT_GAME_MODE_NONE) {
            my_size += ::protobuf::rt::int32_size(13, self.MGAIAJAKPEI.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.MGAIAJAKPEI != ::protobuf::EnumOrUnknown::new(super::FightGameMode::FightGameMode::FIGHT_GAME_MODE_NONE) {
            os.write_enum(13, ::protobuf::EnumOrUnknown::value(&self.MGAIAJAKPEI))?;
        }
        if let Some(v) = self.DIFNDEGMKNA.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x16LobbyCreateCsReq.proto\x1a\x13FightGameMode.proto\x1a\x11PGDACNIBF\
    MP.proto\"t\n\x10LobbyCreateCsReq\x120\n\x0bMGAIAJAKPEI\x18\r\x20\x01(\
    \x0e2\x0e.FightGameModeR\x0bMGAIAJAKPEI\x12.\n\x0bDIFNDEGMKNA\x18\x01\
    \x20\x01(\x0b2\x0c.PGDACNIBFMPR\x0bDIFNDEGMKNAb\x06proto3\
";
