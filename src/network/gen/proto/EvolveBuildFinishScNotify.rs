...
pub struct EvolveBuildFinishScNotify {
    ...
    pub battle_result_type: ::protobuf::EnumOrUnknown<super::NKAEANAJHFL::NKAEANAJHFL>,
...
impl ::protobuf::Message for EvolveBuildFinishScNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.battle_result_type != ::protobuf::EnumOrUnknown::new(super::NKAEANAJHFL::NKAEANAJHFL::EVOLVE_BATTLE_RESULT_NONE) {
            my_size += ::protobuf::rt::int32_size(7, self.battle_result_type.value());
        }
        ...
        if self.cur_period_type != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.cur_period_type);
        }
        if self.wave != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.battle_result_type != ::protobuf::EnumOrUnknown::new(super::NKAEANAJHFL::NKAEANAJHFL::EVOLVE_BATTLE_RESULT_NONE) {
            os.write_enum(7, ::protobuf::EnumOrUnknown::value(&self.battle_result_type))?;
        }
        if let Some(v) = self.level_info.as_ref() {
            ::protobuf::rt::write_message_field_with_cached_size(4, v, os)?;
        }
        if self.cur_period_type != 0 {
            os.write_uint32(3, self.cur_period_type)?;
        }
        if self.wave != 0 {
            os.write_uint32(1, self.wave)?;
        }
        if self.is_lose != false {
            os.write_bool(11, self.is_lose)?;
        }
        if self.exp != 0 {
    ...
    fn clear(&mut self) {
        self.coin = 0;
        self.score = 0;
        self.battle_result_type = ::protobuf::EnumOrUnknown::new(super::NKAEANAJHFL::NKAEANAJHFL::EVOLVE_BATTLE_RESULT_NONE);
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x1a\x11NKAEANAJHFL.proto\"\xb9\x02\n\x19EvolveBuildFinishScNotify\x12\
    \x12\n\x04coin\x18\x06\x20\x01(\rR\x04coin\x12\x14\n\x05score\x18\x0f\
    \x20\x01(\rR\x05score\x12:\n\x12battle_result_type\x18\x07\x20\x01(\x0e2\
    \x0c.NKAEANAJHFLR\x10battleResultType\x124\n\nlevel_info\x18\x04\x20\x01\
    (\x0b2\x15.EvolveBuildLevelInfoR\tlevelInfo\x12&\n\x0fcur_period_type\
    \x18\x03\x20\x01(\rR\rcurPeriodType\x12\x12\n\x04wave\x18\x01\x20\x01(\r\
    R\x04wave\x12\x17\n\x07is_lose\x18\x0b\x20\x01(\x08R\x06isLose\x12\x10\n\
    \x03exp\x18\n\x20\x01(\rR\x03exp\x12\x19\n\x08level_id\x18\x0e\x20\x01(\
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::NKAEANAJHFL::file_descriptor().clone());
