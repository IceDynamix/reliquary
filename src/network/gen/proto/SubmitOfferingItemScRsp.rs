...
pub struct SubmitOfferingItemScRsp {
    // message fields
    // @@protoc_insertion_point(field:SubmitOfferingItemScRsp.JLEFMLADEHI)
...
impl SubmitOfferingItemScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::POPDHFEBLPG::POPDHFEBLPG>(
            "JLEFMLADEHI",
            |m: &SubmitOfferingItemScRsp| { &m.JLEFMLADEHI },
            |m: &mut SubmitOfferingItemScRsp| { &mut m.JLEFMLADEHI },
        ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1dSubmitOfferingItemScRsp.proto\x1a\x11POPDHFEBLPG.proto\"c\n\x17Sub\
    mitOfferingItemScRsp\x12.\n\x0bJLEFMLADEHI\x18\x02\x20\x01(\x0b2\x0c.POP\
    DHFEBLPGR\x0bJLEFMLADEHI\x12\x18\n\x07retcode\x18\x0c\x20\x01(\rR\x07ret\
    codeb\x06proto3\
";
