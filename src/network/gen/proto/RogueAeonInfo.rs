...
impl ::protobuf::Message for RogueAeonInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.unlocked_aeon_num != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.unlocked_aeon_num);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.unlocked_aeon_num != 0 {
            os.write_uint32(13, self.unlocked_aeon_num)?;
        }
        if self.unlocked_aeon_enhance_num != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    aeon_num\x18\r\x20\x01(\rR\x0funlockedAeonNum\x129\n\x19unlocked_aeon_en\
    hance_num\x18\x02\x20\x01(\rR\x16unlockedAeonEnhanceNum\x12\x20\n\x0caeo\
