...
impl ::protobuf::Message for GetBasicInfoScRsp {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.cur_day != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.cur_day);
        }
        ...
        if self.week_cocoon_finished_count != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.week_cocoon_finished_count);
        }
        ...
        if self.gameplay_birthday != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.gameplay_birthday);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.cur_day != 0 {
            os.write_uint32(15, self.cur_day)?;
        }
        if self.last_set_nickname_time != 0 {
        ...
        if self.week_cocoon_finished_count != 0 {
            os.write_uint32(1, self.week_cocoon_finished_count)?;
        }
        if let Some(v) = self.player_setting_info.as_ref() {
            ::protobuf::rt::write_message_field_with_cached_size(11, v, os)?;
        }
        if self.gameplay_birthday != 0 {
            os.write_uint32(13, self.gameplay_birthday)?;
        }
        if self.next_recover_time != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x11GetBasicInfoScRsp\x12\x17\n\x07cur_day\x18\x0f\x20\x01(\rR\x06curDay\
    \x123\n\x16last_set_nickname_time\x18\x0e\x20\x01(\x03R\x13lastSetNickna\
    meTime\x12%\n\x0eexchange_times\x18\x02\x20\x01(\rR\rexchangeTimes\x12;\
    \n\x1aweek_cocoon_finished_count\x18\x01\x20\x01(\rR\x17weekCocoonFinish\
    edCount\x12B\n\x13player_setting_info\x18\x0b\x20\x01(\x0b2\x12.PlayerSe\
    ttingInfoR\x11playerSettingInfo\x12+\n\x11gameplay_birthday\x18\r\x20\
    \x01(\rR\x10gameplayBirthday\x12*\n\x11next_recover_time\x18\x04\x20\x01\
