...
pub struct GetBasicInfoScRsp {
    ...
    pub player_setting_info: ::protobuf::MessageField<super::JCPBMBJDOIM::JCPBMBJDOIM>,
...
impl GetBasicInfoScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::JCPBMBJDOIM::JCPBMBJDOIM>(
            "player_setting_info",
...
impl ::protobuf::Message for GetBasicInfoScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.week_cocoon_finished_count != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.week_cocoon_finished_count);
        }
        if self.gender != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.gender);
        }
        if self.last_set_nickname_time != 0 {
            my_size += ::protobuf::rt::int64_size(6, self.last_set_nickname_time);
        }
        if self.cur_day != 0 {
        ...
        if self.next_recover_time != 0 {
            my_size += ::protobuf::rt::int64_size(3, self.next_recover_time);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.week_cocoon_finished_count != 0 {
            os.write_uint32(10, self.week_cocoon_finished_count)?;
        }
        if self.gender != 0 {
            os.write_uint32(14, self.gender)?;
        }
        if self.last_set_nickname_time != 0 {
            os.write_int64(6, self.last_set_nickname_time)?;
        }
        if self.cur_day != 0 {
        ...
        if self.next_recover_time != 0 {
            os.write_int64(3, self.next_recover_time)?;
        }
        if self.is_gender_set != false {
            os.write_bool(8, self.is_gender_set)?;
        }
        if self.gameplay_birthday != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x17GetBasicInfoScRsp.proto\x1a\x11JCPBMBJDOIM.proto\"\xb2\x03\n\x11Ge\
    tBasicInfoScRsp\x12;\n\x1aweek_cocoon_finished_count\x18\n\x20\x01(\rR\
    \x17weekCocoonFinishedCount\x12\x16\n\x06gender\x18\x0e\x20\x01(\rR\x06g\
    ender\x123\n\x16last_set_nickname_time\x18\x06\x20\x01(\x03R\x13lastSetN\
    icknameTime\x12\x17\n\x07cur_day\x18\x04\x20\x01(\rR\x06curDay\x12<\n\
    \x13player_setting_info\x18\x0f\x20\x01(\x0b2\x0c.JCPBMBJDOIMR\x11player\
    SettingInfo\x12*\n\x11next_recover_time\x18\x03\x20\x01(\x03R\x0fnextRec\
    overTime\x12\"\n\ris_gender_set\x18\x08\x20\x01(\x08R\x0bisGenderSet\x12\
    +\n\x11gameplay_birthday\x18\x05\x20\x01(\rR\x10gameplayBirthday\x12\x18\
    \n\x07retcode\x18\x02\x20\x01(\rR\x07retcode\x12%\n\x0eexchange_times\
    \x18\x01\x20\x01(\rR\rexchangeTimesb\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::JCPBMBJDOIM::file_descriptor().clone());
