...
impl ::protobuf::Message for SwapLineupCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.src_slot != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.src_slot);
        }
        if self.index != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.index);
        }
        if self.dst_slot != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.dst_slot);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.src_slot != 0 {
            os.write_uint32(5, self.src_slot)?;
        }
        if self.index != 0 {
            os.write_uint32(2, self.index)?;
        }
        if self.dst_slot != 0 {
            os.write_uint32(15, self.dst_slot)?;
        }
        if self.is_virtual != false {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x19\n\x08src_slot\x18\x05\x20\x01(\rR\x07srcSlot\x12\x14\n\x05index\x18\
    \x02\x20\x01(\rR\x05index\x12\x19\n\x08dst_slot\x18\x0f\x20\x01(\rR\x07d\
    stSlot\x12\x1d\n\nis_virtual\x18\x01\x20\x01(\x08R\tisVirtual\x12<\n\x11\
    extra_lineup_type\x18\x07\x20\x01(\x0e2\x10.ExtraLineupTypeR\x0fextraLin\
