...
impl ::protobuf::Message for SwapLineupCsReq {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.src_slot != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.src_slot);
        }
        if self.plane_id != 0 {
        ...
        if self.dst_slot != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.dst_slot);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.src_slot != 0 {
            os.write_uint32(1, self.src_slot)?;
        }
        if self.plane_id != 0 {
        ...
        if self.dst_slot != 0 {
            os.write_uint32(3, self.dst_slot)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    SwapLineupCsReq\x12\x19\n\x08src_slot\x18\x01\x20\x01(\rR\x07srcSlot\x12\
    \x19\n\x08plane_id\x18\x08\x20\x01(\rR\x07planeId\x12\x14\n\x05index\x18\
    \x07\x20\x01(\rR\x05index\x12<\n\x11extra_lineup_type\x18\x0b\x20\x01(\
    \x0e2\x10.ExtraLineupTypeR\x0fextraLineupType\x12\x1d\n\nis_virtual\x18\
    \x06\x20\x01(\x08R\tisVirtual\x12\x19\n\x08dst_slot\x18\x03\x20\x01(\rR\
