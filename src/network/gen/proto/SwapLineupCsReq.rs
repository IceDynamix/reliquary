...
impl ::protobuf::Message for SwapLineupCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.src_slot != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.src_slot);
        }
        ...
        if self.dst_slot != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.dst_slot);
        }
        if self.plane_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\nis_virtual\x18\x0e\x20\x01(\x08R\tisVirtual\x12\x19\n\x08src_slot\
    \x18\x0c\x20\x01(\rR\x07srcSlot\x12<\n\x11extra_lineup_type\x18\x01\x20\
    \x01(\x0e2\x10.ExtraLineupTypeR\x0fextraLineupType\x12\x19\n\x08dst_slot\
    \x18\x02\x20\x01(\rR\x07dstSlot\x12\x19\n\x08plane_id\x18\x04\x20\x01(\r\
