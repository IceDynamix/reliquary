...
impl ::protobuf::Message for RogueMapInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.cur_site_id != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.cur_site_id);
        }
        ...
        if self.cur_room_id != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.cur_room_id);
        }
        if self.map_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.cur_site_id != 0 {
            os.write_uint32(5, self.cur_site_id)?;
        }
        for v in &self.room_list {
            ::protobuf::rt::write_message_field_with_cached_size(3, v, os)?;
        };
        if self.cur_room_id != 0 {
            os.write_uint32(1, self.cur_room_id)?;
        }
        if self.map_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    nfo\x12\x17\n\x07area_id\x18\x0b\x20\x01(\rR\x06areaId\x12\x1e\n\x0bcur_\
    site_id\x18\x05\x20\x01(\rR\tcurSiteId\x12'\n\troom_list\x18\x03\x20\x03\
    (\x0b2\n.RogueRoomR\x08roomList\x12\x1e\n\x0bcur_room_id\x18\x01\x20\x01\
    (\rR\tcurRoomId\x12\x15\n\x06map_id\x18\x0e\x20\x01(\rR\x05mapIdB\x15\n\
