...
impl ModifyRelicFilterPlanScRsp {
    ...
    // .RelicFilterPlanSettings settings = 7;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    anScRsp\x12\x1d\n\nslot_index\x18\t\x20\x01(\rR\tslotIndex\x12\x18\n\x07\
    retcode\x18\x03\x20\x01(\rR\x07retcode\x12)\n\x10update_timestamp\x18\r\
    \x20\x01(\x03R\x0fupdateTimestamp\x12\x14\n\x04name\x18\x08\x20\x01(\tH\
    \0R\x04name\x12*\n\x04icon\x18\x0e\x20\x01(\x0b2\x14.RelicFilterPlanIcon\
    H\0R\x04icon\x126\n\x08settings\x18\x07\x20\x01(\x0b2\x18.RelicFilterPla\
