...
impl ::protobuf::Message for ModifyRelicFilterPlanScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.update_timestamp != 0 {
            my_size += ::protobuf::rt::int64_size(1, self.update_timestamp);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.update_timestamp != 0 {
            os.write_int64(1, self.update_timestamp)?;
        }
        if let ::std::option::Option::Some(ref v) = self.info_case {
            match v {
                &modify_relic_filter_plan_sc_rsp::Info_case::Name(ref v) => {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x01\x20\x01(\x03R\x0fupdateTimestamp\x12\x14\n\x04name\x18\x0c\x20\x01(\
    \tH\0R\x04name\x12*\n\x04icon\x18\t\x20\x01(\x0b2\x14.RelicFilterPlanIco\
    nH\0R\x04icon\x126\n\x08settings\x18\x06\x20\x01(\x0b2\x18.RelicFilterPl\
    anSettingsH\0R\x08settingsB\x0b\n\tinfo_caseb\x06proto3\
";
