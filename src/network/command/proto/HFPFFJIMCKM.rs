...
impl ::protobuf::Message for HFPFFJIMCKM {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.LKJMLIDAODM != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.LKJMLIDAODM);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.BDNFLICNFHN != false {
            os.write_bool(3, self.BDNFLICNFHN)?;
        }
        for v in &self.OPCLDNLLNFH {
            ::protobuf::rt::write_message_field_with_cached_size(2, v, os)?;
        };
        if self.LKJMLIDAODM != 0 {
            os.write_uint32(7, self.LKJMLIDAODM)?;
        }
        if let Some(v) = self.motion.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \xa1\x01\n\x0bHFPFFJIMCKM\x12\x20\n\x0bBDNFLICNFHN\x18\x03\x20\x01(\x08R\
    \x0bBDNFLICNFHN\x12)\n\x0bOPCLDNLLNFH\x18\x02\x20\x03(\x0b2\x07.VectorR\
    \x0bOPCLDNLLNFH\x12\x20\n\x0bLKJMLIDAODM\x18\x07\x20\x01(\rR\x0bLKJMLIDA\
    ODM\x12#\n\x06motion\x18\x0e\x20\x01(\x0b2\x0b.MotionInfoR\x06motionb\
    \x06proto3\
";
