...
pub struct AbilityUseStt {
    // message fields
    // @@protoc_insertion_point(field:AbilityUseStt.NPKHCIODJAF)
    pub NPKHCIODJAF: ::std::string::String,
...
impl AbilityUseStt {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "NPKHCIODJAF",
            |m: &AbilityUseStt| { &m.NPKHCIODJAF },
            |m: &mut AbilityUseStt| { &mut m.NPKHCIODJAF },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "count",
...
impl ::protobuf::Message for AbilityUseStt {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                10 => {
                    self.NPKHCIODJAF = is.read_string()?;
                },
                16 => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if !self.NPKHCIODJAF.is_empty() {
            my_size += ::protobuf::rt::string_size(1, &self.NPKHCIODJAF);
        }
        if self.count != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if !self.NPKHCIODJAF.is_empty() {
            os.write_string(1, &self.NPKHCIODJAF)?;
        }
        if self.count != 0 {
    ...
    fn default_instance() -> &'static AbilityUseStt {
        static instance: AbilityUseStt = AbilityUseStt {
            NPKHCIODJAF: ::std::string::String::new(),
            count: 0,
            total_damage: 0.,
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x01\x20\x01(\tR\x0bNPKHCIODJAF\x12\x14\n\x05count\x18\x02\x20\x01(\
