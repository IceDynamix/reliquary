...
impl ::protobuf::Message for TextJoinSaveScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.FANOKEMBMPB != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.FANOKEMBMPB);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.FANOKEMBMPB != 0 {
            os.write_uint32(3, self.FANOKEMBMPB)?;
        }
        if self.ADINNBPINAK != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x08\x20\x01(\tR\x0bHBJKEEBDJML\x12\x20\n\x0bFANOKEMBMPB\x18\x03\x20\x01\
    (\rR\x0bFANOKEMBMPB\x12\x20\n\x0bADINNBPINAK\x18\n\x20\x01(\rR\x0bADINNB\
    PINAKb\x06proto3\
";
