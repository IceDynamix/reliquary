...
impl ::protobuf::Message for TextJoinSaveScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.FANOKEMBMPB != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.FANOKEMBMPB);
        }
        if self.retcode != 0 {
        ...
        if self.ADINNBPINAK != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.ADINNBPINAK);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.FANOKEMBMPB != 0 {
            os.write_uint32(4, self.FANOKEMBMPB)?;
        }
        if self.retcode != 0 {
        ...
        if self.ADINNBPINAK != 0 {
            os.write_uint32(11, self.ADINNBPINAK)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0bFANOKEMBMPB\x18\x04\x20\x01(\rR\x0bFANOKEMBMPB\x12\x18\n\x07retcode\
    \x18\r\x20\x01(\rR\x07retcode\x12\x20\n\x0bHBJKEEBDJML\x18\x08\x20\x01(\
    \tR\x0bHBJKEEBDJML\x12\x20\n\x0bADINNBPINAK\x18\x0b\x20\x01(\rR\x0bADINN\
    BPINAKb\x06proto3\
";
