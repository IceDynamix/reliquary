...
//! Generated file from `FDECDCEDPNM.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:FDECDCEDPNM)
...
impl<'a> ::std::default::Default for &'a FDECDCEDPNM {
    fn default() -> &'a FDECDCEDPNM {
        <FDECDCEDPNM as ::protobuf::Message>::default_instance()
    }
}

impl FDECDCEDPNM {
    pub fn new() -> FDECDCEDPNM {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "ICCCHCCDKND",
            |m: &FDECDCEDPNM| { &m.ICCCHCCDKND },
            |m: &mut FDECDCEDPNM| { &mut m.ICCCHCCDKND },
        ));
...
impl ::protobuf::Message for FDECDCEDPNM {
    const NAME: &'static str = "FDECDCEDPNM";
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(13, &self.ICCCHCCDKND);
        if self.id != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.id);
        }
        if self.BGMFEHBEABC != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.BGMFEHBEABC);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(13, &self.ICCCHCCDKND)?;
        if self.id != 0 {
            os.write_uint32(4, self.id)?;
        }
        if self.BGMFEHBEABC != 0 {
            os.write_uint32(14, self.BGMFEHBEABC)?;
        }
        if self.is_new != false {
...
impl ::protobuf::MessageFull for FDECDCEDPNM {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("FDECDCEDPNM").unwrap()).clone()
    }
}

impl ::std::fmt::Display for FDECDCEDPNM {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for FDECDCEDPNM {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x11FDECDCEDPNM.proto\"x\n\x0bFDECDCEDPNM\x12\x20\n\x0bICCCHCCDKND\x18\
    \r\x20\x03(\rR\x0bICCCHCCDKND\x12\x0e\n\x02id\x18\x04\x20\x01(\rR\x02id\
    \x12\x20\n\x0bBGMFEHBEABC\x18\x0e\x20\x01(\rR\x0bBGMFEHBEABC\x12\x15\n\
    \x06is_new\x18\x07\x20\x01(\x08R\x05isNewb\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(FDECDCEDPNM::generated_message_descriptor_data());
