...
impl ::protobuf::Message for DoGachaCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.simulate_magic != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.simulate_magic);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.simulate_magic != 0 {
            os.write_uint32(5, self.simulate_magic)?;
        }
        if self.gacha_random != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    id\x18\x04\x20\x01(\rR\x07gachaId\x12%\n\x0esimulate_magic\x18\x05\x20\
    \x01(\rR\rsimulateMagic\x12!\n\x0cgacha_random\x18\x0e\x20\x01(\rR\x0bga\
    chaRandom\x12\x1b\n\tgacha_num\x18\x0f\x20\x01(\rR\x08gachaNumb\x06proto\
    3\
";
