...
impl ::protobuf::Message for DoGachaCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.simulate_magic != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.simulate_magic);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.simulate_magic != 0 {
            os.write_uint32(8, self.simulate_magic)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    m\x18\x06\x20\x01(\rR\x08gachaNum\x12!\n\x0cgacha_random\x18\x0f\x20\x01\
    (\rR\x0bgachaRandom\x12\x19\n\x08gacha_id\x18\x0b\x20\x01(\rR\x07gachaId\
    \x12%\n\x0esimulate_magic\x18\x08\x20\x01(\rR\rsimulateMagicb\x06proto3\
";
