...
impl ::protobuf::Message for DoGachaCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.gacha_num != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.gacha_num);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.gacha_num != 0 {
            os.write_uint32(3, self.gacha_num)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    dom\x18\x0f\x20\x01(\rR\x0bgachaRandom\x12\x19\n\x08gacha_id\x18\x01\x20\
    \x01(\rR\x07gachaId\x12%\n\x0esimulate_magic\x18\x0b\x20\x01(\rR\rsimula\
    teMagic\x12\x1b\n\tgacha_num\x18\x03\x20\x01(\rR\x08gachaNumb\x06proto3\
";
