...
//! Generated file from `HBLNHGANBAB.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:HBLNHGANBAB)
...
impl<'a> ::std::default::Default for &'a HBLNHGANBAB {
    fn default() -> &'a HBLNHGANBAB {
        <HBLNHGANBAB as ::protobuf::Message>::default_instance()
    }
}

impl HBLNHGANBAB {
    pub fn new() -> HBLNHGANBAB {
...
impl ::protobuf::Message for HBLNHGANBAB {
    const NAME: &'static str = "HBLNHGANBAB";
...
impl ::protobuf::MessageFull for HBLNHGANBAB {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("HBLNHGANBAB").unwrap()).clone()
    }
}

impl ::std::fmt::Display for HBLNHGANBAB {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for HBLNHGANBAB {
