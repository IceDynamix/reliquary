...
impl ::protobuf::Message for ServerLogScNotify {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if !self.LCPLLGNJNAJ.is_empty() {
            os.write_string(7, &self.LCPLLGNJNAJ)?;
        }
        if self.level != ::protobuf::EnumOrUnknown::new(super::ServerLogLevel::ServerLogLevel::SERVER_LOG_LEVEL_NONE) {
            os.write_enum(11, ::protobuf::EnumOrUnknown::value(&self.level))?;
        }
        if !self.HKLIGCHHIEG.is_empty() {
            os.write_string(3, &self.HKLIGCHHIEG)?;
        }
        if self.tag != ::protobuf::EnumOrUnknown::new(super::ServerLogTag::ServerLogTag::SERVER_LOG_TAG_DEFAULT) {
            os.write_enum(8, ::protobuf::EnumOrUnknown::value(&self.tag))?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ogTag.proto\"\x9f\x01\n\x11ServerLogScNotify\x12\x20\n\x0bLCPLLGNJNAJ\
    \x18\x07\x20\x01(\tR\x0bLCPLLGNJNAJ\x12%\n\x05level\x18\x0b\x20\x01(\x0e\
    2\x0f.ServerLogLevelR\x05level\x12\x20\n\x0bHKLIGCHHIEG\x18\x03\x20\x01(\
    \tR\x0bHKLIGCHHIEG\x12\x1f\n\x03tag\x18\x08\x20\x01(\x0e2\r.ServerLogTag\
    R\x03tagb\x06proto3\
";
