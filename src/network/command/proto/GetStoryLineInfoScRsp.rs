...
impl ::protobuf::Message for GetStoryLineInfoScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.cur_story_line_id != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.cur_story_line_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.cur_story_line_id != 0 {
            os.write_uint32(3, self.cur_story_line_id)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12/\n\x14trial_avatar_id_list\x18\x02\x20\x03(\rR\x11trialAvatarIdList\
    \x12)\n\x11cur_story_line_id\x18\x03\x20\x01(\rR\x0ecurStoryLineId\x12@\
    \n\x1dunfinished_story_line_id_list\x18\n\x20\x03(\rR\x19unfinishedStory\
