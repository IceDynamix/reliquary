...
pub struct GetStarFightDataScRsp {
    ...
    pub retcode: u32,
    // @@protoc_insertion_point(field:GetStarFightDataScRsp.CNCIBBCHEAO)
    pub CNCIBBCHEAO: ::std::vec::Vec<super::StarFightGroupInfo::StarFightGroupInfo>,
    // special fields
...
impl GetStarFightDataScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "CNCIBBCHEAO",
            |m: &GetStarFightDataScRsp| { &m.CNCIBBCHEAO },
            |m: &mut GetStarFightDataScRsp| { &mut m.CNCIBBCHEAO },
        ));
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                114 => {
                    self.CNCIBBCHEAO.push(is.read_message()?);
                },
                tag => {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1bGetStarFightDataScRsp.proto\x1a\x18StarFightGroupInfo.proto\"h\n\
    \x15GetStarFightDataScRsp\x12\x18\n\x07retcode\x18\x04\x20\x01(\rR\x07re\
    tcode\x125\n\x0bCNCIBBCHEAO\x18\x0e\x20\x03(\x0b2\x13.StarFightGroupInfo\
    R\x0bCNCIBBCHEAOb\x06proto3\
";
