...
pub struct GetStarFightDataScRsp {
    // message fields
    // @@protoc_insertion_point(field:GetStarFightDataScRsp.PGJPADLGHAN)
    pub PGJPADLGHAN: ::std::vec::Vec<super::CBFMBNLLANM::CBFMBNLLANM>,
...
impl GetStarFightDataScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "PGJPADLGHAN",
            |m: &GetStarFightDataScRsp| { &m.PGJPADLGHAN },
            |m: &mut GetStarFightDataScRsp| { &mut m.PGJPADLGHAN },
        ));
...
impl ::protobuf::Message for GetStarFightDataScRsp {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                114 => {
                    self.PGJPADLGHAN.push(is.read_message()?);
                },
                96 => {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1bGetStarFightDataScRsp.proto\x1a\x11CBFMBNLLANM.proto\"a\n\x15GetSt\
    arFightDataScRsp\x12.\n\x0bPGJPADLGHAN\x18\x0e\x20\x03(\x0b2\x0c.CBFMBNL\
    LANMR\x0bPGJPADLGHAN\x12\x18\n\x07retcode\x18\x0c\x20\x01(\rR\x07retcode\
    b\x06proto3\
";
