...
impl ::protobuf::Message for KACKJJDJONI {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.HCFOCPKFOBG != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.HCFOCPKFOBG);
        }
        if self.PAPKGJOJPII != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.PAPKGJOJPII);
        }
        if self.JODNMDOAMKC != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.JODNMDOAMKC);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(10, &self.KDDPPGOCOMB);
        if self.NCDCGFKOLOE != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.NCDCGFKOLOE);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.HCFOCPKFOBG != 0 {
            os.write_uint32(5, self.HCFOCPKFOBG)?;
        }
        if self.PAPKGJOJPII != 0 {
            os.write_uint32(9, self.PAPKGJOJPII)?;
        }
        if self.JODNMDOAMKC != 0 {
            os.write_uint32(11, self.JODNMDOAMKC)?;
        }
        os.write_repeated_packed_uint32(10, &self.KDDPPGOCOMB)?;
        if self.NCDCGFKOLOE != 0 {
            os.write_uint32(15, self.NCDCGFKOLOE)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    FAI\x18\x01\x20\x01(\rR\x0bBLHPICIOFAI\x12\x20\n\x0bHCFOCPKFOBG\x18\x05\
    \x20\x01(\rR\x0bHCFOCPKFOBG\x12\x20\n\x0bPAPKGJOJPII\x18\t\x20\x01(\rR\
    \x0bPAPKGJOJPII\x12\x20\n\x0bJODNMDOAMKC\x18\x0b\x20\x01(\rR\x0bJODNMDOA\
    MKC\x12\x20\n\x0bKDDPPGOCOMB\x18\n\x20\x03(\rR\x0bKDDPPGOCOMB\x12\x20\n\
    \x0bNCDCGFKOLOE\x18\x0f\x20\x01(\rR\x0bNCDCGFKOLOEb\x06proto3\
";
