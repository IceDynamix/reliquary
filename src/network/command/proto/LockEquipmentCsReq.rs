...
pub struct LockEquipmentCsReq {
    ...
    pub is_locked: bool,
    // @@protoc_insertion_point(field:LockEquipmentCsReq.DHDBPGCBNMK)
    pub DHDBPGCBNMK: ::std::vec::Vec<u32>,
    // special fields
...
impl LockEquipmentCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "DHDBPGCBNMK",
            |m: &LockEquipmentCsReq| { &m.DHDBPGCBNMK },
            |m: &mut LockEquipmentCsReq| { &mut m.DHDBPGCBNMK },
        ));
...
impl ::protobuf::Message for LockEquipmentCsReq {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                18 => {
                    is.read_repeated_packed_uint32_into(&mut self.DHDBPGCBNMK)?;
                },
                16 => {
                    self.DHDBPGCBNMK.push(is.read_uint32()?);
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(2, &self.DHDBPGCBNMK);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_uint32(2, &self.DHDBPGCBNMK)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    locked\x18\x0e\x20\x01(\x08R\x08isLocked\x12\x20\n\x0bDHDBPGCBNMK\x18\
    \x02\x20\x03(\rR\x0bDHDBPGCBNMKb\x06proto3\
";
