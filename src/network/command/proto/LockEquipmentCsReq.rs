...
pub struct LockEquipmentCsReq {
    // message fields
    // @@protoc_insertion_point(field:LockEquipmentCsReq.is_lock)
    pub is_lock: bool,
    // @@protoc_insertion_point(field:LockEquipmentCsReq.COOFKOEEACB)
    pub COOFKOEEACB: ::std::vec::Vec<u32>,
    // special fields
...
impl LockEquipmentCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "is_lock",
            |m: &LockEquipmentCsReq| { &m.is_lock },
            |m: &mut LockEquipmentCsReq| { &mut m.is_lock },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "COOFKOEEACB",
            |m: &LockEquipmentCsReq| { &m.COOFKOEEACB },
            |m: &mut LockEquipmentCsReq| { &mut m.COOFKOEEACB },
        ));
...
impl ::protobuf::Message for LockEquipmentCsReq {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                98 => {
                    is.read_repeated_packed_uint32_into(&mut self.COOFKOEEACB)?;
                },
                96 => {
                    self.COOFKOEEACB.push(is.read_uint32()?);
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(12, &self.COOFKOEEACB);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.is_lock != false {
            os.write_bool(11, self.is_lock)?;
        }
        os.write_repeated_packed_uint32(12, &self.COOFKOEEACB)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x18LockEquipmentCsReq.proto\"O\n\x12LockEquipmentCsReq\x12\x17\n\x07i\
    s_lock\x18\x0b\x20\x01(\x08R\x06isLock\x12\x20\n\x0bCOOFKOEEACB\x18\x0c\
    \x20\x03(\rR\x0bCOOFKOEEACBb\x06proto3\
";
