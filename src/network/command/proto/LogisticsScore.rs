...
impl ::protobuf::Message for LogisticsScore {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.unlock_level != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.unlock_level);
        }
        if self.max_score != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.max_score);
        }
        if self.last_level != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.last_level);
        }
        if self.last_max_score != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.last_max_score);
        }
        if self.cur_score != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.cur_score);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.unlock_level != 0 {
            os.write_uint32(7, self.unlock_level)?;
        }
        if self.max_score != 0 {
            os.write_uint32(11, self.max_score)?;
        }
        if self.last_level != 0 {
            os.write_uint32(12, self.last_level)?;
        }
        if self.last_max_score != 0 {
            os.write_uint32(4, self.last_max_score)?;
        }
        if self.cur_score != 0 {
            os.write_uint32(5, self.cur_score)?;
        }
        if let Some(v) = self.reward.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    sScore\x12!\n\x0cunlock_level\x18\x07\x20\x01(\rR\x0bunlockLevel\x12\x1b\
    \n\tmax_score\x18\x0b\x20\x01(\rR\x08maxScore\x12\x1d\n\nlast_level\x18\
    \x0c\x20\x01(\rR\tlastLevel\x12$\n\x0elast_max_score\x18\x04\x20\x01(\rR\
    \x0clastMaxScore\x12\x1b\n\tcur_score\x18\x05\x20\x01(\rR\x08curScore\
    \x12!\n\x06reward\x18\x01\x20\x01(\x0b2\t.ItemListR\x06reward\x12\x15\n\
