...
impl ::protobuf::Message for LogisticsScore {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.last_level != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.last_level);
        }
        if self.cur_score != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.cur_score);
        }
        ...
        if self.last_max_score != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.last_max_score);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.last_level != 0 {
            os.write_uint32(6, self.last_level)?;
        }
        if self.cur_score != 0 {
            os.write_uint32(9, self.cur_score)?;
        }
        if self.unlock_level != 0 {
        ...
        if self.last_max_score != 0 {
            os.write_uint32(10, self.last_max_score)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x1d\n\nlast_level\x18\x06\x20\x01(\rR\tlastLevel\x12\x1b\n\tcur_score\
    \x18\t\x20\x01(\rR\x08curScore\x12!\n\x0cunlock_level\x18\x0f\x20\x01(\r\
    R\x0bunlockLevel\x12\x15\n\x06map_id\x18\x04\x20\x01(\rR\x05mapId\x12\
    \x1b\n\tmax_score\x18\x0e\x20\x01(\rR\x08maxScore\x12$\n\x0elast_max_sco\
    re\x18\n\x20\x01(\rR\x0clastMaxScoreb\x06proto3\
";
