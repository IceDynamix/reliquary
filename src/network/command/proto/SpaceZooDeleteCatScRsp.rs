...
pub struct SpaceZooDeleteCatScRsp {
    // message fields
    // @@protoc_insertion_point(field:SpaceZooDeleteCatScRsp.AIGNPJKIGOL)
    pub AIGNPJKIGOL: ::std::vec::Vec<u32>,
...
impl SpaceZooDeleteCatScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "AIGNPJKIGOL",
            |m: &SpaceZooDeleteCatScRsp| { &m.AIGNPJKIGOL },
            |m: &mut SpaceZooDeleteCatScRsp| { &mut m.AIGNPJKIGOL },
        ));
...
impl ::protobuf::Message for SpaceZooDeleteCatScRsp {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                66 => {
                    is.read_repeated_packed_uint32_into(&mut self.AIGNPJKIGOL)?;
                },
                64 => {
                    self.AIGNPJKIGOL.push(is.read_uint32()?);
                },
                16 => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(8, &self.AIGNPJKIGOL);
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(8, &self.AIGNPJKIGOL)?;
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x20\n\x0bAIGNPJKIGOL\x18\x08\x20\x03(\rR\x0bAIGNPJKIGOL\x12\x18\n\x07re\
