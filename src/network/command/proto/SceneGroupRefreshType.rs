...
pub enum SceneGroupRefreshType {
    ...
    // @@protoc_insertion_point(enum_value:SceneGroupRefreshType.SceneGroupRefreshType_AFIBFMAFNCC)
    SceneGroupRefreshType_AFIBFMAFNCC = 3,
}
...
impl ::protobuf::Enum for SceneGroupRefreshType {
    ...
    fn from_i32(value: i32) -> ::std::option::Option<SceneGroupRefreshType> {
        match value {
            ...
            3 => ::std::option::Option::Some(SceneGroupRefreshType::SceneGroupRefreshType_AFIBFMAFNCC),
    ...
    fn from_str(str: &str) -> ::std::option::Option<SceneGroupRefreshType> {
        match str {
            ...
            "SceneGroupRefreshType_AFIBFMAFNCC" => ::std::option::Option::Some(SceneGroupRefreshType::SceneGroupRefreshType_AFIBFMAFNCC),
            _ => ::std::option::Option::None
        }
    }
    ...
    const VALUES: &'static [SceneGroupRefreshType] = &[
        ...
        SceneGroupRefreshType::SceneGroupRefreshType_AFIBFMAFNCC,
    ];
}
