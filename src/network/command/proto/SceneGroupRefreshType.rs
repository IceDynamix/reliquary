...
pub enum SceneGroupRefreshType {
    ...
    // @@protoc_insertion_point(enum_value:SceneGroupRefreshType.SCENE_GROUP_REFRESH_TYPE_AFIBFMAFNCC)
...
impl ::protobuf::Enum for SceneGroupRefreshType {
    ...
    fn from_i32(value: i32) -> ::std::option::Option<SceneGroupRefreshType> {
        match value {
            ...
            3 => ::std::option::Option::Some(SceneGroupRefreshType::SCENE_GROUP_REFRESH_TYPE_AFIBFMAFNCC),
    ...
    fn from_str(str: &str) -> ::std::option::Option<SceneGroupRefreshType> {
        match str {
            ...
            "SCENE_GROUP_REFRESH_TYPE_AFIBFMAFNCC" => ::std::option::Option::Some(SceneGroupRefreshType::SCENE_GROUP_REFRESH_TYPE_AFIBFMAFNCC),
            _ => ::std::option::Option::None
        }
    }
    ...
    const VALUES: &'static [SceneGroupRefreshType] = &[
        ...
        SceneGroupRefreshType::SCENE_GROUP_REFRESH_TYPE_AFIBFMAFNCC,
    ];
}
