...
impl ::protobuf::Message for SwapLineupCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.ELLIDANJNOB != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.ELLIDANJNOB);
        }
        if self.NEDIKHNGMBH != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.NEDIKHNGMBH);
        }
        if self.plane_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.ELLIDANJNOB != 0 {
            os.write_uint32(2, self.ELLIDANJNOB)?;
        }
        if self.NEDIKHNGMBH != 0 {
            os.write_uint32(7, self.NEDIKHNGMBH)?;
        }
        if self.plane_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    SwapLineupCsReq\x12<\n\x11extra_lineup_type\x18\x0f\x20\x01(\x0e2\x10.Ex\
    traLineupTypeR\x0fextraLineupType\x12\x1d\n\nis_virtual\x18\n\x20\x01(\
    \x08R\tisVirtual\x12\x14\n\x05index\x18\x06\x20\x01(\rR\x05index\x12\x20\
    \n\x0bELLIDANJNOB\x18\x02\x20\x01(\rR\x0bELLIDANJNOB\x12\x20\n\x0bNEDIKH\
    NGMBH\x18\x07\x20\x01(\rR\x0bNEDIKHNGMBH\x12\x19\n\x08plane_id\x18\x01\
