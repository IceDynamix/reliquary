...
impl ::protobuf::Message for SwapLineupCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.ELLIDANJNOB != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.ELLIDANJNOB);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.ELLIDANJNOB != 0 {
            os.write_uint32(7, self.ELLIDANJNOB)?;
        }
        if self.extra_lineup_type != ::protobuf::EnumOrUnknown::new(super::ExtraLineupType::ExtraLineupType::LINEUP_NONE) {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    SwapLineupCsReq\x12\x14\n\x05index\x18\x03\x20\x01(\rR\x05index\x12\x19\
    \n\x08plane_id\x18\x08\x20\x01(\rR\x07planeId\x12\x20\n\x0bELLIDANJNOB\
    \x18\x07\x20\x01(\rR\x0bELLIDANJNOB\x12<\n\x11extra_lineup_type\x18\x06\
    \x20\x01(\x0e2\x10.ExtraLineupTypeR\x0fextraLineupType\x12\x20\n\x0bNEDI\
    KHNGMBH\x18\x01\x20\x01(\rR\x0bNEDIKHNGMBH\x12\x1d\n\nis_virtual\x18\t\
