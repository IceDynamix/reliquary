...
//! Generated file from `AFBAMPLGHEH.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:AFBAMPLGHEH)
...
impl<'a> ::std::default::Default for &'a AFBAMPLGHEH {
    fn default() -> &'a AFBAMPLGHEH {
        <AFBAMPLGHEH as ::protobuf::Message>::default_instance()
    }
}

impl AFBAMPLGHEH {
    pub fn new() -> AFBAMPLGHEH {
...
impl ::protobuf::Message for AFBAMPLGHEH {
    const NAME: &'static str = "AFBAMPLGHEH";
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(2, &self.IHBJIIHBIBP);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(2, &self.IHBJIIHBIBP)?;
...
impl ::protobuf::MessageFull for AFBAMPLGHEH {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("AFBAMPLGHEH").unwrap()).clone()
    }
}

impl ::std::fmt::Display for AFBAMPLGHEH {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for AFBAMPLGHEH {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x11AFBAMPLGHEH.proto\x1a\x11DHNFBGENLIG.proto\"_\n\x0bAFBAMPLGHEH\x12\
    \x20\n\x0bIHBJIIHBIBP\x18\x02\x20\x03(\rR\x0bIHBJIIHBIBP\x12.\n\x0bNCKCM\
    GCBEHK\x18\x08\x20\x03(\x0b2\x0c.DHNFBGENLIGR\x0bNCKCMGCBEHKb\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::DHNFBGENLIG::file_descriptor().clone());
            let mut messages = ::std::vec::Vec::with_capacity(1);
            messages.push(AFBAMPLGHEH::generated_message_descriptor_data());
