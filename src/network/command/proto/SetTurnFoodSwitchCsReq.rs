...
pub struct SetTurnFoodSwitchCsReq {
    // message fields
    // @@protoc_insertion_point(field:SetTurnFoodSwitchCsReq.FHLOGNHNJBG)
    pub FHLOGNHNJBG: bool,
    // @@protoc_insertion_point(field:SetTurnFoodSwitchCsReq.HKAEHBFBLEM)
...
impl SetTurnFoodSwitchCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "FHLOGNHNJBG",
            |m: &SetTurnFoodSwitchCsReq| { &m.FHLOGNHNJBG },
            |m: &mut SetTurnFoodSwitchCsReq| { &mut m.FHLOGNHNJBG },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "HKAEHBFBLEM",
            |m: &SetTurnFoodSwitchCsReq| { &m.HKAEHBFBLEM },
            |m: &mut SetTurnFoodSwitchCsReq| { &mut m.HKAEHBFBLEM },
        ));
...
impl ::protobuf::Message for SetTurnFoodSwitchCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.HKAEHBFBLEM != ::protobuf::EnumOrUnknown::new(super::TurnFoodSwitch::TurnFoodSwitch::TURN_FOOD_SWITCH_NONE) {
            my_size += ::protobuf::rt::int32_size(10, self.HKAEHBFBLEM.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.FHLOGNHNJBG != false {
            os.write_bool(11, self.FHLOGNHNJBG)?;
        }
        if self.HKAEHBFBLEM != ::protobuf::EnumOrUnknown::new(super::TurnFoodSwitch::TurnFoodSwitch::TURN_FOOD_SWITCH_NONE) {
            os.write_enum(10, ::protobuf::EnumOrUnknown::value(&self.HKAEHBFBLEM))?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    etTurnFoodSwitchCsReq\x12\x20\n\x0bFHLOGNHNJBG\x18\x0b\x20\x01(\x08R\x0b\
    FHLOGNHNJBG\x121\n\x0bHKAEHBFBLEM\x18\n\x20\x01(\x0e2\x0f.TurnFoodSwitch\
    R\x0bHKAEHBFBLEMb\x06proto3\
";
