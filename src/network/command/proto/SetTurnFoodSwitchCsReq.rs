...
pub struct SetTurnFoodSwitchCsReq {
    // message fields
    // @@protoc_insertion_point(field:SetTurnFoodSwitchCsReq.BNEBCGHFCDC)
    pub BNEBCGHFCDC: bool,
    // @@protoc_insertion_point(field:SetTurnFoodSwitchCsReq.NLGOPBNENFP)
...
impl SetTurnFoodSwitchCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "BNEBCGHFCDC",
            |m: &SetTurnFoodSwitchCsReq| { &m.BNEBCGHFCDC },
            |m: &mut SetTurnFoodSwitchCsReq| { &mut m.BNEBCGHFCDC },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "NLGOPBNENFP",
            |m: &SetTurnFoodSwitchCsReq| { &m.NLGOPBNENFP },
            |m: &mut SetTurnFoodSwitchCsReq| { &mut m.NLGOPBNENFP },
        ));
...
impl ::protobuf::Message for SetTurnFoodSwitchCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.NLGOPBNENFP != ::protobuf::EnumOrUnknown::new(super::TurnFoodSwitch::TurnFoodSwitch::TURN_FOOD_SWITCH_NONE) {
            my_size += ::protobuf::rt::int32_size(5, self.NLGOPBNENFP.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.BNEBCGHFCDC != false {
            os.write_bool(4, self.BNEBCGHFCDC)?;
        }
        if self.NLGOPBNENFP != ::protobuf::EnumOrUnknown::new(super::TurnFoodSwitch::TurnFoodSwitch::TURN_FOOD_SWITCH_NONE) {
            os.write_enum(5, ::protobuf::EnumOrUnknown::value(&self.NLGOPBNENFP))?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    etTurnFoodSwitchCsReq\x12\x20\n\x0bBNEBCGHFCDC\x18\x04\x20\x01(\x08R\x0b\
    BNEBCGHFCDC\x121\n\x0bNLGOPBNENFP\x18\x05\x20\x01(\x0e2\x0f.TurnFoodSwit\
    chR\x0bNLGOPBNENFPb\x06proto3\
";
