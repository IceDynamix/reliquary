...
impl ::protobuf::Message for TreasureDungeonRecordData {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.target_grid_id != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.target_grid_id);
        }
        ...
        if self.source_grid_id != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.source_grid_id);
        }
        if self.param2 != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.param2);
        }
        if self.param1 != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.param1);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.target_grid_id != 0 {
            os.write_uint32(5, self.target_grid_id)?;
        }
        if self.type_ != ::protobuf::EnumOrUnknown::new(super::TreasureDungeonRecordType::TreasureDungeonRecordType::TREASURE_DUNGEON_RECORD_NONE) {
            os.write_enum(6, ::protobuf::EnumOrUnknown::value(&self.type_))?;
        }
        if self.source_grid_id != 0 {
            os.write_uint32(2, self.source_grid_id)?;
        }
        if self.param2 != 0 {
            os.write_uint32(8, self.param2)?;
        }
        if self.param1 != 0 {
            os.write_uint32(9, self.param1)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x05\x20\x01(\rR\x0ctargetGridId\x12.\n\x04type\x18\x06\x20\x01(\x0e\
    2\x1a.TreasureDungeonRecordTypeR\x04type\x12$\n\x0esource_grid_id\x18\
    \x02\x20\x01(\rR\x0csourceGridId\x12\x16\n\x06param2\x18\x08\x20\x01(\rR\
    \x06param2\x12\x16\n\x06param1\x18\t\x20\x01(\rR\x06param1b\x06proto3\
";
