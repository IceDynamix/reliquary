...
impl ::protobuf::Message for LBAOGIBPJOP {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.CEIFKJIEAJE != ::protobuf::EnumOrUnknown::new(super::JOMKPEGEFMP::JOMKPEGEFMP::MARBLE_TEAM_TYPE_NONE) {
            my_size += ::protobuf::rt::int32_size(7, self.CEIFKJIEAJE.value());
        }
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(14, &self.PCMGAGAHBLK);
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(12, &self.JJEFBPKPKBK);
        if self.NLIBKABFGCC != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.NLIBKABFGCC);
        }
        if self.BBDOPLEKIAC != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.BBDOPLEKIAC);
        }
        ...
        if self.PBFAIOJJGNL != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.PBFAIOJJGNL);
        }
        if self.JIJHAAIHNCN != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.JIJHAAIHNCN);
        }
        if self.EIGABCKEDNP != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.EIGABCKEDNP);
        }
        if self.DKPNENBHELH != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.DKPNENBHELH);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.CEIFKJIEAJE != ::protobuf::EnumOrUnknown::new(super::JOMKPEGEFMP::JOMKPEGEFMP::MARBLE_TEAM_TYPE_NONE) {
            os.write_enum(7, ::protobuf::EnumOrUnknown::value(&self.CEIFKJIEAJE))?;
        }
        if self.LIKHCLPMHJK != false {
            os.write_bool(9, self.LIKHCLPMHJK)?;
        }
        if self.HJEFOLKGAEI != ::protobuf::EnumOrUnknown::new(super::JOMKPEGEFMP::JOMKPEGEFMP::MARBLE_TEAM_TYPE_NONE) {
            os.write_enum(6, ::protobuf::EnumOrUnknown::value(&self.HJEFOLKGAEI))?;
        }
        os.write_repeated_packed_uint32(14, &self.PCMGAGAHBLK)?;
        if self.MODDKLNDAMK != 0 {
        ...
        os.write_repeated_packed_uint32(12, &self.JJEFBPKPKBK)?;
        if self.NLIBKABFGCC != 0 {
            os.write_uint32(10, self.NLIBKABFGCC)?;
        }
        if self.BBDOPLEKIAC != 0 {
            os.write_uint32(11, self.BBDOPLEKIAC)?;
        }
        if self.ACJCPHIFMLN != 0 {
            os.write_uint32(13, self.ACJCPHIFMLN)?;
        }
        if self.JIKEIGBCABB != false {
            os.write_bool(5, self.JIKEIGBCABB)?;
        }
        if self.PBFAIOJJGNL != 0 {
            os.write_uint32(1, self.PBFAIOJJGNL)?;
        }
        if self.JIJHAAIHNCN != 0 {
            os.write_uint32(4, self.JIJHAAIHNCN)?;
        }
        if self.EIGABCKEDNP != 0 {
            os.write_uint32(3, self.EIGABCKEDNP)?;
        }
        if self.DKPNENBHELH != 0 {
            os.write_uint32(2, self.DKPNENBHELH)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    o\"\xd8\x04\n\x0bLBAOGIBPJOP\x12.\n\x0bCEIFKJIEAJE\x18\x07\x20\x01(\x0e2\
    \x0c.JOMKPEGEFMPR\x0bCEIFKJIEAJE\x12\x20\n\x0bLIKHCLPMHJK\x18\t\x20\x01(\
    \x08R\x0bLIKHCLPMHJK\x12.\n\x0bHJEFOLKGAEI\x18\x06\x20\x01(\x0e2\x0c.JOM\
    KPEGEFMPR\x0bHJEFOLKGAEI\x12\x20\n\x0bPCMGAGAHBLK\x18\x0e\x20\x03(\rR\
    \x0bPCMGAGAHBLK\x12\x20\n\x0bMODDKLNDAMK\x18\x08\x20\x01(\rR\x0bMODDKLND\
    AMK\x12/\n\x0bLIPJDJPMOKB\x18\xc6\x04\x20\x03(\x0b2\x0c.CBBDIOMIFHDR\x0b\
    LIPJDJPMOKB\x12\x20\n\x0bKHCMOFPFOAK\x18\x0f\x20\x01(\rR\x0bKHCMOFPFOAK\
    \x12\x20\n\x0bJJEFBPKPKBK\x18\x0c\x20\x03(\rR\x0bJJEFBPKPKBK\x12\x20\n\
    \x0bNLIBKABFGCC\x18\n\x20\x01(\rR\x0bNLIBKABFGCC\x12\x20\n\x0bBBDOPLEKIA\
    C\x18\x0b\x20\x01(\rR\x0bBBDOPLEKIAC\x12\x20\n\x0bACJCPHIFMLN\x18\r\x20\
    \x01(\rR\x0bACJCPHIFMLN\x12\x20\n\x0bJIKEIGBCABB\x18\x05\x20\x01(\x08R\
    \x0bJIKEIGBCABB\x12\x20\n\x0bPBFAIOJJGNL\x18\x01\x20\x01(\rR\x0bPBFAIOJJ\
    GNL\x12\x20\n\x0bJIJHAAIHNCN\x18\x04\x20\x01(\rR\x0bJIJHAAIHNCN\x12\x20\
    \n\x0bEIGABCKEDNP\x18\x03\x20\x01(\rR\x0bEIGABCKEDNP\x12\x20\n\x0bDKPNEN\
    BHELH\x18\x02\x20\x01(\rR\x0bDKPNENBHELHb\x06proto3\
";
