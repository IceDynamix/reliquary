...
impl ::protobuf::Message for GetQuestDataScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.total_achievement_exp != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.total_achievement_exp);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.total_achievement_exp != 0 {
            os.write_uint32(3, self.total_achievement_exp)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    total_achievement_exp\x18\x03\x20\x01(\rR\x13totalAchievementExp\x12%\n\
    \nquest_list\x18\t\x20\x03(\x0b2\x06.QuestR\tquestListb\x06proto3\
";
