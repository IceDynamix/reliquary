...
impl ::protobuf::Message for GetQuestDataScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.total_achievement_exp != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.total_achievement_exp);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.total_achievement_exp != 0 {
            os.write_uint32(12, self.total_achievement_exp)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    DataScRsp\x122\n\x15total_achievement_exp\x18\x0c\x20\x01(\rR\x13totalAc\
    hievementExp\x12\x18\n\x07retcode\x18\x03\x20\x01(\rR\x07retcode\x12%\n\
    \nquest_list\x18\x0b\x20\x03(\x0b2\x06.QuestR\tquestListb\x06proto3\
";
