...
//! Generated file from `NEKAENFGGAC.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:NEKAENFGGAC)
...
impl<'a> ::std::default::Default for &'a NEKAENFGGAC {
    fn default() -> &'a NEKAENFGGAC {
        <NEKAENFGGAC as ::protobuf::Message>::default_instance()
    }
}

impl NEKAENFGGAC {
    pub fn new() -> NEKAENFGGAC {
...
impl ::protobuf::Message for NEKAENFGGAC {
    const NAME: &'static str = "NEKAENFGGAC";
...
impl ::protobuf::MessageFull for NEKAENFGGAC {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("NEKAENFGGAC").unwrap()).clone()
    }
}

impl ::std::fmt::Display for NEKAENFGGAC {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for NEKAENFGGAC {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::MOGBGNCDOIA::file_descriptor().clone());
            let mut messages = ::std::vec::Vec::with_capacity(1);
            messages.push(NEKAENFGGAC::generated_message_descriptor_data());
