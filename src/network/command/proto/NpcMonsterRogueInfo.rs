...
impl ::protobuf::Message for NpcMonsterRogueInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.rogue_monster_id != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.rogue_monster_id);
        }
        ...
        if self.DNEAMPLLFME != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.DNEAMPLLFME);
        }
        if self.level != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.rogue_monster_id != 0 {
            os.write_uint32(13, self.rogue_monster_id)?;
        }
        if self.elite_group != 0 {
        ...
        if self.DNEAMPLLFME != 0 {
            os.write_uint32(3, self.DNEAMPLLFME)?;
        }
        if self.level != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x10rogue_monster_id\x18\r\x20\x01(\rR\x0erogueMonsterId\x12\x1f\n\x0b\
    elite_group\x18\x01\x20\x01(\rR\neliteGroup\x12(\n\x10hard_level_group\
    \x18\t\x20\x01(\rR\x0ehardLevelGroup\x12\x20\n\x0bDNEAMPLLFME\x18\x03\
    \x20\x01(\rR\x0bDNEAMPLLFME\x12\x14\n\x05level\x18\x0c\x20\x01(\rR\x05le\
    velb\x06proto3\
";
