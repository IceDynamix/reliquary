...
pub struct NpcMonsterRogueInfo {
    ...
    pub level: u32,
    // @@protoc_insertion_point(field:NpcMonsterRogueInfo.POHHHACHHGH)
    pub POHHHACHHGH: u32,
    // special fields
...
impl NpcMonsterRogueInfo {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "POHHHACHHGH",
            |m: &NpcMonsterRogueInfo| { &m.POHHHACHHGH },
            |m: &mut NpcMonsterRogueInfo| { &mut m.POHHHACHHGH },
        ));
...
impl ::protobuf::Message for NpcMonsterRogueInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.hard_level_group != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.hard_level_group);
        }
        if self.level != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.level);
        }
        if self.POHHHACHHGH != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.POHHHACHHGH);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.hard_level_group != 0 {
            os.write_uint32(6, self.hard_level_group)?;
        }
        if self.level != 0 {
            os.write_uint32(7, self.level)?;
        }
        if self.POHHHACHHGH != 0 {
            os.write_uint32(9, self.POHHHACHHGH)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x10rogue_monster_id\x18\x0c\x20\x01(\rR\x0erogueMonsterId\x12\x1f\n\
    \x0belite_group\x18\r\x20\x01(\rR\neliteGroup\x12(\n\x10hard_level_group\
    \x18\x06\x20\x01(\rR\x0ehardLevelGroup\x12\x14\n\x05level\x18\x07\x20\
    \x01(\rR\x05level\x12\x20\n\x0bPOHHHACHHGH\x18\t\x20\x01(\rR\x0bPOHHHACH\
    HGHb\x06proto3\
";
