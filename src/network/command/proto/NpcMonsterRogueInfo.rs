...
impl ::protobuf::Message for NpcMonsterRogueInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.elite_group != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.elite_group);
        }
        if self.level != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.elite_group != 0 {
            os.write_uint32(6, self.elite_group)?;
        }
        if self.level != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x1f\n\x0belite_group\x18\x06\x20\x01(\rR\neliteGroup\x12\x14\n\x05level\
    \x18\n\x20\x01(\rR\x05level\x12(\n\x10rogue_monster_id\x18\x0c\x20\x01(\
    \rR\x0erogueMonsterId\x12(\n\x10hard_level_group\x18\x08\x20\x01(\rR\x0e\
    hardLevelGroup\x12\x20\n\x0bDNEAMPLLFME\x18\x0b\x20\x01(\rR\x0bDNEAMPLLF\
    MEb\x06proto3\
";
