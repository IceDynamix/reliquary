...
impl RogueMagicLayerInfo {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            ...
            |m: &mut RogueMagicLayerInfo| { &mut m.tourn_room_list },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "layer_id",
...
impl ::protobuf::Message for RogueMagicLayerInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.level_index != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.level_index);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.level_index != 0 {
            os.write_uint32(8, self.level_index)?;
        }
        if self.status != ::protobuf::EnumOrUnknown::new(super::RogueMagicLayerStatus::RogueMagicLayerStatus::ROGUE_MAGIC_LAYER_STATUS_NONE) {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0ecur_room_index\x18\x06\x20\x01(\rR\x0ccurRoomIndex\x12\x1f\n\x0bleve\
    l_index\x18\x08\x20\x01(\rR\nlevelIndex\x12.\n\x06status\x18\t\x20\x01(\
    \x0e2\x16.RogueMagicLayerStatusR\x06status\x12;\n\x0ftourn_room_list\x18\
    \x0b\x20\x03(\x0b2\x13.RogueMagicRoomInfoR\rtournRoomList\x12\x19\n\x08l\
    ayer_id\x18\x0f\x20\x01(\rR\x07layerIdb\x06proto3\
";
