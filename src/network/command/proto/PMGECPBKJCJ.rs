...
impl ::protobuf::Message for PMGECPBKJCJ {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.KDLPEIGHJAK != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.KDLPEIGHJAK);
        }
        if self.IEFMADJGADB != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.IEFMADJGADB);
        }
        if self.group_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.KDLPEIGHJAK != 0 {
            os.write_uint32(15, self.KDLPEIGHJAK)?;
        }
        if self.IEFMADJGADB != 0 {
            os.write_uint32(7, self.IEFMADJGADB)?;
        }
        if self.group_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    KJCJ\x12\x20\n\x0bKDLPEIGHJAK\x18\x0f\x20\x01(\rR\x0bKDLPEIGHJAK\x12\x20\
    \n\x0bIEFMADJGADB\x18\x07\x20\x01(\rR\x0bIEFMADJGADB\x12\x19\n\x08group_\
    id\x18\x05\x20\x01(\rR\x07groupId\x12&\n\x07op_type\x18\x03\x20\x01(\x0e\
    2\r.HandPropTypeR\x06opTypeb\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::HandPropType::file_descriptor().clone());
