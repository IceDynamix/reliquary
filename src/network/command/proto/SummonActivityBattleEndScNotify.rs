...
impl ::protobuf::Message for SummonActivityBattleEndScNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.HMFFHGBKOGL != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.HMFFHGBKOGL);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.HMFFHGBKOGL != 0 {
            os.write_uint32(2, self.HMFFHGBKOGL)?;
        }
        if self.NEDFIBONLKB != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x02\x20\x01(\rR\x0bHMFFHGBKOGL\x12\x20\n\x0bNEDFIBONLKB\x18\t\x20\x01(\
    \rR\x0bNEDFIBONLKBb\x06proto3\
";
