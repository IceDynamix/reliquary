...
impl ::protobuf::Message for RefreshTriggerByClientScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.trigger_entity_id != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.trigger_entity_id);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.trigger_entity_id != 0 {
            os.write_uint32(10, self.trigger_entity_id)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ntScRsp\x12!\n\x0ctrigger_name\x18\x01\x20\x01(\tR\x0btriggerName\x12*\n\
    \x11trigger_entity_id\x18\n\x20\x01(\rR\x0ftriggerEntityId\x12\x18\n\x07\
    retcode\x18\x0e\x20\x01(\rR\x07retcode\x12'\n\x0frefresh_trigger\x18\x0f\
    \x20\x01(\x08R\x0erefreshTriggerb\x06proto3\
";
