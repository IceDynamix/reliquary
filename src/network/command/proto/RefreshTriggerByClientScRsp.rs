...
impl ::protobuf::Message for RefreshTriggerByClientScRsp {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.refresh_trigger != false {
            os.write_bool(1, self.refresh_trigger)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ntScRsp\x12!\n\x0ctrigger_name\x18\x0c\x20\x01(\tR\x0btriggerName\x12'\n\
    \x0frefresh_trigger\x18\x01\x20\x01(\x08R\x0erefreshTrigger\x12\x18\n\
    \x07retcode\x18\x08\x20\x01(\rR\x07retcode\x12*\n\x11trigger_entity_id\
    \x18\t\x20\x01(\rR\x0ftriggerEntityIdb\x06proto3\
";
