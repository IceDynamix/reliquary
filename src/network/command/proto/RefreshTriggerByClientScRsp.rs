...
impl ::protobuf::Message for RefreshTriggerByClientScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.trigger_entity_id != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.trigger_entity_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.refresh_trigger != false {
            os.write_bool(6, self.refresh_trigger)?;
        }
        if self.retcode != 0 {
        ...
        if self.trigger_entity_id != 0 {
            os.write_uint32(2, self.trigger_entity_id)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ntScRsp\x12'\n\x0frefresh_trigger\x18\x06\x20\x01(\x08R\x0erefreshTrigge\
    r\x12\x18\n\x07retcode\x18\x0f\x20\x01(\rR\x07retcode\x12!\n\x0ctrigger_\
    name\x18\t\x20\x01(\tR\x0btriggerName\x12*\n\x11trigger_entity_id\x18\
    \x02\x20\x01(\rR\x0ftriggerEntityIdb\x06proto3\
";
