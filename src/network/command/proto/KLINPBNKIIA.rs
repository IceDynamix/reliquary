...
impl ::protobuf::Message for KLINPBNKIIA {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.CCLJMNCKECP != ::protobuf::EnumOrUnknown::new(super::SwordTrainingDailyPhaseType::SwordTrainingDailyPhaseType::SWORD_TRAINING_DAILY_PHASE_TYPE_NONE) {
            my_size += ::protobuf::rt::int32_size(5, self.CCLJMNCKECP.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.CCLJMNCKECP != ::protobuf::EnumOrUnknown::new(super::SwordTrainingDailyPhaseType::SwordTrainingDailyPhaseType::SWORD_TRAINING_DAILY_PHASE_TYPE_NONE) {
            os.write_enum(5, ::protobuf::EnumOrUnknown::value(&self.CCLJMNCKECP))?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    haseType.proto\"\x9f\x01\n\x0bKLINPBNKIIA\x12>\n\x0bCCLJMNCKECP\x18\x05\
    \x20\x01(\x0e2\x1c.SwordTrainingDailyPhaseTypeR\x0bCCLJMNCKECP\x12\x20\n\
    \x0bEIJDEOPOFNB\x18\r\x20\x03(\rR\x0bEIJDEOPOFNB\x12.\n\x0bDNCBPCENKIF\
    \x18\x06\x20\x03(\x0b2\x0c.PIIBOJCEJJNR\x0bDNCBPCENKIFb\x06proto3\
";
