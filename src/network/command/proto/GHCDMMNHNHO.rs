...
//! Generated file from `GHCDMMNHNHO.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:GHCDMMNHNHO)
...
pub struct GHCDMMNHNHO {
    ...
    pub enhanced_id: u32,
    // special fields
    // @@protoc_insertion_point(special_field:GHCDMMNHNHO.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a GHCDMMNHNHO {
    fn default() -> &'a GHCDMMNHNHO {
        <GHCDMMNHNHO as ::protobuf::Message>::default_instance()
    }
}

impl GHCDMMNHNHO {
    pub fn new() -> GHCDMMNHNHO {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "enhanced_id",
            |m: &GHCDMMNHNHO| { &m.enhanced_id },
            |m: &mut GHCDMMNHNHO| { &mut m.enhanced_id },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<GHCDMMNHNHO>(
            "GHCDMMNHNHO",
            fields,
            oneofs,
        )
...
impl ::protobuf::Message for GHCDMMNHNHO {
    const NAME: &'static str = "GHCDMMNHNHO";
...
impl ::protobuf::MessageFull for GHCDMMNHNHO {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("GHCDMMNHNHO").unwrap()).clone()
    }
}

impl ::std::fmt::Display for GHCDMMNHNHO {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for GHCDMMNHNHO {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(GHCDMMNHNHO::generated_message_descriptor_data());
