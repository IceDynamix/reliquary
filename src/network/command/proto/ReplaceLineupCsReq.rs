...
pub struct ReplaceLineupCsReq {
    ...
    pub leader_slot: u32,
    // @@protoc_insertion_point(field:ReplaceLineupCsReq.selected_lineup)
    pub selected_lineup: ::std::vec::Vec<super::LineupDetails::LineupDetails>,
...
impl ReplaceLineupCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "selected_lineup",
            |m: &ReplaceLineupCsReq| { &m.selected_lineup },
            |m: &mut ReplaceLineupCsReq| { &mut m.selected_lineup },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "index",
...
impl ::protobuf::Message for ReplaceLineupCsReq {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                74 => {
                    self.selected_lineup.push(is.read_message()?);
                },
                80 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        for value in &self.selected_lineup {
    ...
    fn default_instance() -> &'static ReplaceLineupCsReq {
        static instance: ReplaceLineupCsReq = ReplaceLineupCsReq {
            ...
            leader_slot: 0,
            selected_lineup: ::std::vec::Vec::new(),
            index: 0,
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x18ReplaceLineupCsReq.proto\x1a\x15ExtraLineupType.proto\x1a\x13Lineu\
    pDetails.proto\"\xa9\x02\n\x12ReplaceLineupCsReq\x12\x19\n\x08plane_id\
    \x18\x01\x20\x01(\rR\x07planeId\x12\x1d\n\nis_virtual\x18\x02\x20\x01(\
    \x08R\tisVirtual\x12+\n\x12game_story_line_id\x18\x03\x20\x01(\rR\x0fgam\
    eStoryLineId\x12\x1f\n\x0bleader_slot\x18\x05\x20\x01(\rR\nleaderSlot\
    \x127\n\x0fselected_lineup\x18\t\x20\x03(\x0b2\x0e.LineupDetailsR\x0esel\
    ectedLineup\x12\x14\n\x05index\x18\n\x20\x01(\rR\x05index\x12<\n\x11extr\
    a_lineup_type\x18\x0b\x20\x01(\x0e2\x10.ExtraLineupTypeR\x0fextraLineupT\
    ypeb\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::LineupDetails::file_descriptor().clone());
