...
impl ::protobuf::Message for ReplaceLineupCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.leader_slot != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.leader_slot);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.leader_slot != 0 {
            os.write_uint32(1, self.leader_slot)?;
        }
        if self.game_story_line_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x0e\x20\x01(\x08R\tisVirtual\x12<\n\x11extra_lineup_type\x18\x05\
    \x20\x01(\x0e2\x10.ExtraLineupTypeR\x0fextraLineupType\x129\n\x10lineup_\
    slot_list\x18\n\x20\x03(\x0b2\x0f.LineupSlotDataR\x0elineupSlotList\x12\
    \x19\n\x08plane_id\x18\x08\x20\x01(\rR\x07planeId\x12\x1f\n\x0bleader_sl\
    ot\x18\x01\x20\x01(\rR\nleaderSlot\x12+\n\x12game_story_line_id\x18\x04\
    \x20\x01(\rR\x0fgameStoryLineId\x12\x14\n\x05index\x18\x0b\x20\x01(\rR\
    \x05indexb\x06proto3\
";
