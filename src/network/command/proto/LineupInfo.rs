...
impl ::protobuf::Message for LineupInfo {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(10, &self.story_line_avatar_id_list);
        if !self.name.is_empty() {
            my_size += ::protobuf::rt::string_size(14, &self.name);
        }
        if self.mp != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.mp);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(1, &self.MANKKFPBFCB);
        my_size += ::protobuf::rt::vec_packed_uint32_size(15, &self.KOMPCJPAPKM);
        ...
        if self.max_mp != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.max_mp);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(10, &self.story_line_avatar_id_list)?;
        if !self.name.is_empty() {
            os.write_string(14, &self.name)?;
        }
        if self.mp != 0 {
            os.write_uint32(7, self.mp)?;
        }
        os.write_repeated_packed_uint32(1, &self.MANKKFPBFCB)?;
        os.write_repeated_packed_uint32(15, &self.KOMPCJPAPKM)?;
        if self.is_virtual != false {
        ...
        if self.max_mp != 0 {
            os.write_uint32(2, self.max_mp)?;
        }
        if self.BFNBKLMAMKB != false {
            os.write_bool(4, self.BFNBKLMAMKB)?;
        }
        if self.game_story_line_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x20\x03(\rR\x15storyLineAvatarIdList\x12\x12\n\x04name\x18\x0e\x20\x01(\
    \tR\x04name\x12\x0e\n\x02mp\x18\x07\x20\x01(\rR\x02mp\x12\x20\n\x0bMANKK\
    FPBFCB\x18\x01\x20\x03(\rR\x0bMANKKFPBFCB\x12\x20\n\x0bKOMPCJPAPKM\x18\
    \x0f\x20\x03(\rR\x0bKOMPCJPAPKM\x12\x1d\n\nis_virtual\x18\x0c\x20\x01(\
    \x08R\tisVirtual\x12.\n\x0bavatar_list\x18\x05\x20\x03(\x0b2\r.LineupAva\
    tarR\navatarList\x12\x19\n\x08plane_id\x18\x0b\x20\x01(\rR\x07planeId\
    \x12<\n\x11extra_lineup_type\x18\r\x20\x01(\x0e2\x10.ExtraLineupTypeR\
    \x0fextraLineupType\x12\x1f\n\x0bleader_slot\x18\x06\x20\x01(\rR\nleader\
    Slot\x12\x15\n\x06max_mp\x18\x02\x20\x01(\rR\x05maxMp\x12\x20\n\x0bBFNBK\
    LMAMKB\x18\x04\x20\x01(\x08R\x0bBFNBKLMAMKB\x12+\n\x12game_story_line_id\
    \x18\x08\x20\x01(\rR\x0fgameStoryLineId\x12\x14\n\x05index\x18\t\x20\x01\
    (\rR\x05indexb\x06proto3\
";
