...
pub struct LineupInfo {
    ...
    // @@protoc_insertion_point(field:LineupInfo.ELELIEEEPFH)
    pub ELELIEEEPFH: ::std::vec::Vec<u32>,
    ...
    // @@protoc_insertion_point(field:LineupInfo.AFEOIOONKJE)
    pub AFEOIOONKJE: ::std::vec::Vec<u32>,
    // @@protoc_insertion_point(field:LineupInfo.mp)
    pub mp: u32,
    // @@protoc_insertion_point(field:LineupInfo.DKKBKBOMDMP)
    pub DKKBKBOMDMP: ::std::vec::Vec<u32>,
    // @@protoc_insertion_point(field:LineupInfo.plane_id)
    pub plane_id: u32,
    // @@protoc_insertion_point(field:LineupInfo.EKPOLJPMMFI)
    pub EKPOLJPMMFI: bool,
...
impl LineupInfo {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "ELELIEEEPFH",
            |m: &LineupInfo| { &m.ELELIEEEPFH },
            |m: &mut LineupInfo| { &mut m.ELELIEEEPFH },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "index",
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "AFEOIOONKJE",
            |m: &LineupInfo| { &m.AFEOIOONKJE },
            |m: &mut LineupInfo| { &mut m.AFEOIOONKJE },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "mp",
            |m: &LineupInfo| { &m.mp },
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "DKKBKBOMDMP",
            |m: &LineupInfo| { &m.DKKBKBOMDMP },
            |m: &mut LineupInfo| { &mut m.DKKBKBOMDMP },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "plane_id",
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "EKPOLJPMMFI",
            |m: &LineupInfo| { &m.EKPOLJPMMFI },
            |m: &mut LineupInfo| { &mut m.EKPOLJPMMFI },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "name",
            |m: &LineupInfo| { &m.name },
...
impl ::protobuf::Message for LineupInfo {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                42 => {
                    is.read_repeated_packed_uint32_into(&mut self.ELELIEEEPFH)?;
                },
                40 => {
                    self.ELELIEEEPFH.push(is.read_uint32()?);
                },
                48 => {
                ...
                66 => {
                    is.read_repeated_packed_uint32_into(&mut self.AFEOIOONKJE)?;
                },
                64 => {
                    self.AFEOIOONKJE.push(is.read_uint32()?);
                },
                72 => {
                    self.mp = is.read_uint32()?;
                },
                82 => {
                    is.read_repeated_packed_uint32_into(&mut self.DKKBKBOMDMP)?;
                },
                80 => {
                    self.DKKBKBOMDMP.push(is.read_uint32()?);
                },
                88 => {
                    self.plane_id = is.read_uint32()?;
                },
                96 => {
                    self.EKPOLJPMMFI = is.read_bool()?;
                },
                106 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(5, &self.ELELIEEEPFH);
        if self.index != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.index);
        }
        if self.game_story_line_id != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.game_story_line_id);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(8, &self.AFEOIOONKJE);
        if self.mp != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.mp);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(10, &self.DKKBKBOMDMP);
        if self.plane_id != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.plane_id);
        }
        if self.EKPOLJPMMFI != false {
            my_size += 1 + 1;
        }
        ...
        if self.leader_slot != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.leader_slot);
        }
        if self.max_mp != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.max_mp);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_uint32(5, &self.ELELIEEEPFH)?;
        if self.index != 0 {
            os.write_uint32(6, self.index)?;
        }
        if self.game_story_line_id != 0 {
            os.write_uint32(7, self.game_story_line_id)?;
        }
        os.write_repeated_packed_uint32(8, &self.AFEOIOONKJE)?;
        if self.mp != 0 {
            os.write_uint32(9, self.mp)?;
        }
        os.write_repeated_packed_uint32(10, &self.DKKBKBOMDMP)?;
        if self.plane_id != 0 {
            os.write_uint32(11, self.plane_id)?;
        }
        if self.EKPOLJPMMFI != false {
            os.write_bool(12, self.EKPOLJPMMFI)?;
        }
        if !self.name.is_empty() {
            os.write_string(13, &self.name)?;
        }
        if self.leader_slot != 0 {
            os.write_uint32(14, self.leader_slot)?;
        }
        if self.max_mp != 0 {
            os.write_uint32(15, self.max_mp)?;
        }
    ...
    fn clear(&mut self) {
        ...
        self.ELELIEEEPFH.clear();
        self.index = 0;
        self.game_story_line_id = 0;
        self.AFEOIOONKJE.clear();
        self.mp = 0;
        self.DKKBKBOMDMP.clear();
        self.plane_id = 0;
        self.EKPOLJPMMFI = false;
        self.name.clear();
        self.leader_slot = 0;
        self.max_mp = 0;
    ...
    fn default_instance() -> &'static LineupInfo {
        static instance: LineupInfo = LineupInfo {
            ...
            ELELIEEEPFH: ::std::vec::Vec::new(),
            index: 0,
            game_story_line_id: 0,
            AFEOIOONKJE: ::std::vec::Vec::new(),
            mp: 0,
            DKKBKBOMDMP: ::std::vec::Vec::new(),
            plane_id: 0,
            EKPOLJPMMFI: false,
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    proto\"\xdb\x03\n\nLineupInfo\x12\x1d\n\nis_virtual\x18\x01\x20\x01(\x08\
    R\tisVirtual\x12.\n\x0bavatar_list\x18\x03\x20\x03(\x0b2\r.LineupAvatarR\
    \navatarList\x12<\n\x11extra_lineup_type\x18\x04\x20\x01(\x0e2\x10.Extra\
    LineupTypeR\x0fextraLineupType\x12\x20\n\x0bELELIEEEPFH\x18\x05\x20\x03(\
    \rR\x0bELELIEEEPFH\x12\x14\n\x05index\x18\x06\x20\x01(\rR\x05index\x12+\
    \n\x12game_story_line_id\x18\x07\x20\x01(\rR\x0fgameStoryLineId\x12\x20\
    \n\x0bAFEOIOONKJE\x18\x08\x20\x03(\rR\x0bAFEOIOONKJE\x12\x0e\n\x02mp\x18\
    \t\x20\x01(\rR\x02mp\x12\x20\n\x0bDKKBKBOMDMP\x18\n\x20\x03(\rR\x0bDKKBK\
    BOMDMP\x12\x19\n\x08plane_id\x18\x0b\x20\x01(\rR\x07planeId\x12\x20\n\
    \x0bEKPOLJPMMFI\x18\x0c\x20\x01(\x08R\x0bEKPOLJPMMFI\x12\x12\n\x04name\
    \x18\r\x20\x01(\tR\x04name\x12\x1f\n\x0bleader_slot\x18\x0e\x20\x01(\rR\
    \nleaderSlot\x12\x15\n\x06max_mp\x18\x0f\x20\x01(\rR\x05maxMpb\x06proto3\
";
