...
impl ::protobuf::Message for LineupInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(12, &self.MANKKFPBFCB);
        ...
        if self.max_mp != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.max_mp);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.is_virtual != false {
            os.write_bool(6, self.is_virtual)?;
        }
        if self.index != 0 {
        ...
        os.write_repeated_packed_uint32(12, &self.MANKKFPBFCB)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    proto\"\xf3\x03\n\nLineupInfo\x12<\n\x11extra_lineup_type\x18\x0e\x20\
    \x01(\x0e2\x10.ExtraLineupTypeR\x0fextraLineupType\x12\x1d\n\nis_virtual\
    \x18\x06\x20\x01(\x08R\tisVirtual\x12\x14\n\x05index\x18\x01\x20\x01(\rR\
    \x05index\x12\x1f\n\x0bleader_slot\x18\x05\x20\x01(\rR\nleaderSlot\x128\
    \n\x19story_line_avatar_id_list\x18\x0b\x20\x03(\rR\x15storyLineAvatarId\
    List\x12\x20\n\x0bMANKKFPBFCB\x18\x0c\x20\x03(\rR\x0bMANKKFPBFCB\x12.\n\
    \x0bavatar_list\x18\r\x20\x03(\x0b2\r.LineupAvatarR\navatarList\x12\x19\
    \n\x08plane_id\x18\x0f\x20\x01(\rR\x07planeId\x12+\n\x12game_story_line_\
    id\x18\x07\x20\x01(\rR\x0fgameStoryLineId\x12\x15\n\x06max_mp\x18\x04\
    \x20\x01(\rR\x05maxMp\x12\x20\n\x0bBFNBKLMAMKB\x18\x02\x20\x01(\x08R\x0b\
    BFNBKLMAMKB\x12\x20\n\x0bKOMPCJPAPKM\x18\n\x20\x03(\rR\x0bKOMPCJPAPKM\
    \x12\x0e\n\x02mp\x18\t\x20\x01(\rR\x02mp\x12\x12\n\x04name\x18\x03\x20\
