...
pub struct LineupInfo {
    ...
    pub max_mp: u32,
    // @@protoc_insertion_point(field:LineupInfo.PDEDOJHKOMD)
    pub PDEDOJHKOMD: ::std::vec::Vec<u32>,
    ...
    // @@protoc_insertion_point(field:LineupInfo.JFAGOOABLFD)
    pub JFAGOOABLFD: ::std::vec::Vec<u32>,
    // @@protoc_insertion_point(field:LineupInfo.mp)
    pub mp: u32,
    // @@protoc_insertion_point(field:LineupInfo.ACBPKODJMBJ)
    pub ACBPKODJMBJ: bool,
    // special fields
...
impl LineupInfo {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "PDEDOJHKOMD",
            |m: &LineupInfo| { &m.PDEDOJHKOMD },
            |m: &mut LineupInfo| { &mut m.PDEDOJHKOMD },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "plane_id",
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "JFAGOOABLFD",
            |m: &LineupInfo| { &m.JFAGOOABLFD },
            |m: &mut LineupInfo| { &mut m.JFAGOOABLFD },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "mp",
            |m: &LineupInfo| { &m.mp },
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "ACBPKODJMBJ",
            |m: &LineupInfo| { &m.ACBPKODJMBJ },
            |m: &mut LineupInfo| { &mut m.ACBPKODJMBJ },
        ));
...
impl ::protobuf::Message for LineupInfo {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                106 => {
                    is.read_repeated_packed_uint32_into(&mut self.PDEDOJHKOMD)?;
                },
                104 => {
                    self.PDEDOJHKOMD.push(is.read_uint32()?);
                },
                72 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.max_mp != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.max_mp);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(13, &self.PDEDOJHKOMD);
        if self.plane_id != 0 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(7, &self.story_line_avatar_id_list);
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(11, &self.JFAGOOABLFD);
        if self.mp != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.mp);
        }
        if self.ACBPKODJMBJ != false {
            my_size += 1 + 1;
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.max_mp != 0 {
            os.write_uint32(10, self.max_mp)?;
        }
        os.write_repeated_packed_uint32(13, &self.PDEDOJHKOMD)?;
        if self.plane_id != 0 {
        ...
        os.write_repeated_packed_uint32(7, &self.story_line_avatar_id_list)?;
        ...
        os.write_repeated_packed_uint32(11, &self.JFAGOOABLFD)?;
        if self.mp != 0 {
            os.write_uint32(1, self.mp)?;
        }
        if self.ACBPKODJMBJ != false {
            os.write_bool(8, self.ACBPKODJMBJ)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    proto\"\xf3\x03\n\nLineupInfo\x12\x12\n\x04name\x18\x0f\x20\x01(\tR\x04n\
    ame\x12\x1f\n\x0bleader_slot\x18\x05\x20\x01(\rR\nleaderSlot\x12\x15\n\
    \x06max_mp\x18\n\x20\x01(\rR\x05maxMp\x12\x20\n\x0bPDEDOJHKOMD\x18\r\x20\
    \x03(\rR\x0bPDEDOJHKOMD\x12\x19\n\x08plane_id\x18\t\x20\x01(\rR\x07plane\
    Id\x12\x14\n\x05index\x18\x06\x20\x01(\rR\x05index\x12<\n\x11extra_lineu\
    p_type\x18\x03\x20\x01(\x0e2\x10.ExtraLineupTypeR\x0fextraLineupType\x12\
    8\n\x19story_line_avatar_id_list\x18\x07\x20\x03(\rR\x15storyLineAvatarI\
    dList\x12.\n\x0bavatar_list\x18\x0c\x20\x03(\x0b2\r.LineupAvatarR\navata\
    rList\x12\x1d\n\nis_virtual\x18\x02\x20\x01(\x08R\tisVirtual\x12+\n\x12g\
    ame_story_line_id\x18\x04\x20\x01(\rR\x0fgameStoryLineId\x12\x20\n\x0bJF\
    AGOOABLFD\x18\x0b\x20\x03(\rR\x0bJFAGOOABLFD\x12\x0e\n\x02mp\x18\x01\x20\
    \x01(\rR\x02mp\x12\x20\n\x0bACBPKODJMBJ\x18\x08\x20\x01(\x08R\x0bACBPKOD\
    JMBJb\x06proto3\
";
