...
impl ::protobuf::Message for SceneSummonUnitInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.caster_entity_id != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.caster_entity_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.caster_entity_id != 0 {
            os.write_uint32(9, self.caster_entity_id)?;
        }
        if self.create_time_ms != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0clife_time_ms\x18\x0c\x20\x01(\x05R\nlifeTimeMs\x12(\n\x10caster_enti\
    ty_id\x18\t\x20\x01(\rR\x0ecasterEntityId\x12$\n\x0ecreate_time_ms\x18\
    \x05\x20\x01(\x04R\x0ccreateTimeMs\x12$\n\x0esummon_unit_id\x18\x0f\x20\
    \x01(\rR\x0csummonUnitId\x12(\n\x10attach_entity_id\x18\r\x20\x01(\rR\
    \x0eattachEntityIdb\x06proto3\
";
