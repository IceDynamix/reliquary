...
pub struct SceneSummonUnitInfo {
    // message fields
    // @@protoc_insertion_point(field:SceneSummonUnitInfo.NIEPLCJGPOG)
    pub NIEPLCJGPOG: u32,
    // @@protoc_insertion_point(field:SceneSummonUnitInfo.FCHOPANMGKM)
    pub FCHOPANMGKM: u32,
    ...
    // @@protoc_insertion_point(field:SceneSummonUnitInfo.OLKPFFEOFJB)
    pub OLKPFFEOFJB: u32,
    // special fields
...
impl SceneSummonUnitInfo {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "NIEPLCJGPOG",
            |m: &SceneSummonUnitInfo| { &m.NIEPLCJGPOG },
            |m: &mut SceneSummonUnitInfo| { &mut m.NIEPLCJGPOG },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "FCHOPANMGKM",
            |m: &SceneSummonUnitInfo| { &m.FCHOPANMGKM },
            |m: &mut SceneSummonUnitInfo| { &mut m.FCHOPANMGKM },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "life_time_ms",
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "OLKPFFEOFJB",
            |m: &SceneSummonUnitInfo| { &m.OLKPFFEOFJB },
            |m: &mut SceneSummonUnitInfo| { &mut m.OLKPFFEOFJB },
        ));
...
impl ::protobuf::Message for SceneSummonUnitInfo {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                8 => {
                    self.NIEPLCJGPOG = is.read_uint32()?;
                },
                48 => {
                    self.FCHOPANMGKM = is.read_uint32()?;
                },
                72 => {
                ...
                120 => {
                    self.OLKPFFEOFJB = is.read_uint32()?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.NIEPLCJGPOG != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.NIEPLCJGPOG);
        }
        if self.FCHOPANMGKM != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.FCHOPANMGKM);
        }
        if self.life_time_ms != 0 {
            my_size += ::protobuf::rt::int32_size(9, self.life_time_ms);
        }
        ...
        if self.OLKPFFEOFJB != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.OLKPFFEOFJB);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.NIEPLCJGPOG != 0 {
            os.write_uint32(1, self.NIEPLCJGPOG)?;
        }
        if self.FCHOPANMGKM != 0 {
            os.write_uint32(6, self.FCHOPANMGKM)?;
        }
        if self.life_time_ms != 0 {
            os.write_int32(9, self.life_time_ms)?;
        }
        ...
        if self.OLKPFFEOFJB != 0 {
            os.write_uint32(15, self.OLKPFFEOFJB)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x19SceneSummonUnitInfo.proto\"\xef\x01\n\x13SceneSummonUnitInfo\x12\
    \x20\n\x0bNIEPLCJGPOG\x18\x01\x20\x01(\rR\x0bNIEPLCJGPOG\x12\x20\n\x0bFC\
    HOPANMGKM\x18\x06\x20\x01(\rR\x0bFCHOPANMGKM\x12\x20\n\x0clife_time_ms\
    \x18\t\x20\x01(\x05R\nlifeTimeMs\x12*\n\x11trigger_name_list\x18\n\x20\
    \x03(\tR\x0ftriggerNameList\x12$\n\x0ecreate_time_ms\x18\r\x20\x01(\x04R\
    \x0ccreateTimeMs\x12\x20\n\x0bOLKPFFEOFJB\x18\x0f\x20\x01(\rR\x0bOLKPFFE\
    OFJBb\x06proto3\
";
