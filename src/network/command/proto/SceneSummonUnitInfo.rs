...
impl ::protobuf::Message for SceneSummonUnitInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.caster_entity_id != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.caster_entity_id);
        }
        for value in &self.trigger_name_list {
            my_size += ::protobuf::rt::string_size(4, &value);
        };
        if self.attach_entity_id != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.attach_entity_id);
        }
        ...
        if self.summon_unit_id != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.summon_unit_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.caster_entity_id != 0 {
            os.write_uint32(1, self.caster_entity_id)?;
        }
        for v in &self.trigger_name_list {
            os.write_string(4, &v)?;
        };
        if self.attach_entity_id != 0 {
            os.write_uint32(6, self.attach_entity_id)?;
        }
        if self.life_time_ms != 0 {
        ...
        if self.summon_unit_id != 0 {
            os.write_uint32(13, self.summon_unit_id)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x10caster_entity_id\x18\x01\x20\x01(\rR\x0ecasterEntityId\x12*\n\x11t\
    rigger_name_list\x18\x04\x20\x03(\tR\x0ftriggerNameList\x12(\n\x10attach\
    _entity_id\x18\x06\x20\x01(\rR\x0eattachEntityId\x12\x20\n\x0clife_time_\
    ms\x18\x07\x20\x01(\x05R\nlifeTimeMs\x12$\n\x0ecreate_time_ms\x18\x0b\
    \x20\x01(\x04R\x0ccreateTimeMs\x12$\n\x0esummon_unit_id\x18\r\x20\x01(\r\
    R\x0csummonUnitIdb\x06proto3\
";
