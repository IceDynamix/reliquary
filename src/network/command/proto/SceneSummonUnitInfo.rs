...
impl ::protobuf::Message for SceneSummonUnitInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.attach_entity_id != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.attach_entity_id);
        }
        if self.life_time_ms != 0 {
            my_size += ::protobuf::rt::int32_size(7, self.life_time_ms);
        }
        if self.caster_entity_id != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.caster_entity_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.attach_entity_id != 0 {
            os.write_uint32(2, self.attach_entity_id)?;
        }
        if self.life_time_ms != 0 {
            os.write_int32(7, self.life_time_ms)?;
        }
        if self.caster_entity_id != 0 {
            os.write_uint32(5, self.caster_entity_id)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    n_unit_id\x18\x0f\x20\x01(\rR\x0csummonUnitId\x12(\n\x10attach_entity_id\
    \x18\x02\x20\x01(\rR\x0eattachEntityId\x12\x20\n\x0clife_time_ms\x18\x07\
    \x20\x01(\x05R\nlifeTimeMs\x12(\n\x10caster_entity_id\x18\x05\x20\x01(\r\
    R\x0ecasterEntityId\x12*\n\x11trigger_name_list\x18\x04\x20\x03(\tR\x0ft\
    riggerNameListb\x06proto3\
";
