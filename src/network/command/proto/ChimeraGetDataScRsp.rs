...
impl ::protobuf::Message for ChimeraGetDataScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.KILPNHJBPDB != 0 {
            my_size += ::protobuf::rt::uint32_size(1597, self.KILPNHJBPDB);
        }
        ...
        if self.CPBDBAIDAEH != 0 {
            my_size += ::protobuf::rt::uint32_size(134, self.CPBDBAIDAEH);
        }
        if self.GBEMDNCKKBA != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.GBEMDNCKKBA);
        }
        if self.BBBGKCHNOCK != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.BBBGKCHNOCK);
        }
        if self.EAIOJCNLMNG != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.EAIOJCNLMNG);
        }
        if self.JFPNMOONLNJ != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.JFPNMOONLNJ);
        }
        if self.OLLDKAJOAJD != 0 {
            my_size += ::protobuf::rt::uint32_size(54, self.OLLDKAJOAJD);
        }
        if self.IJEIOMMFPKA != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.IJEIOMMFPKA);
        }
        if self.BBMGIIMECEL != ::protobuf::EnumOrUnknown::new(super::OAPDMKKKEOL::OAPDMKKKEOL::CHIMERA_LAST_PHASE_FINISH_NONE) {
            my_size += ::protobuf::rt::int32_size(7, self.BBMGIIMECEL.value());
        }
        if self.CAGAPLNHABB != 0 {
            my_size += ::protobuf::rt::uint32_size(518, self.CAGAPLNHABB);
        }
        ...
        if self.LFKFOCJFNCJ != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.LFKFOCJFNCJ);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.KILPNHJBPDB != 0 {
            os.write_uint32(1597, self.KILPNHJBPDB)?;
        }
        if self.CJEKJHPIBJL != 0 {
        ...
        if self.CPBDBAIDAEH != 0 {
            os.write_uint32(134, self.CPBDBAIDAEH)?;
        }
        if self.GBEMDNCKKBA != 0 {
            os.write_uint32(12, self.GBEMDNCKKBA)?;
        }
        if self.BBBGKCHNOCK != 0 {
            os.write_uint32(10, self.BBBGKCHNOCK)?;
        }
        if self.EAIOJCNLMNG != 0 {
            os.write_uint32(3, self.EAIOJCNLMNG)?;
        }
        if self.JFPNMOONLNJ != 0 {
            os.write_uint32(14, self.JFPNMOONLNJ)?;
        }
        if self.OLLDKAJOAJD != 0 {
            os.write_uint32(54, self.OLLDKAJOAJD)?;
        }
        if self.IJEIOMMFPKA != 0 {
            os.write_uint32(4, self.IJEIOMMFPKA)?;
        }
        if self.BBMGIIMECEL != ::protobuf::EnumOrUnknown::new(super::OAPDMKKKEOL::OAPDMKKKEOL::CHIMERA_LAST_PHASE_FINISH_NONE) {
            os.write_enum(7, ::protobuf::EnumOrUnknown::value(&self.BBMGIIMECEL))?;
        }
        if self.CAGAPLNHABB != 0 {
            os.write_uint32(518, self.CAGAPLNHABB)?;
        }
        ...
        if self.LFKFOCJFNCJ != 0 {
            os.write_uint32(6, self.LFKFOCJFNCJ)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x13ChimeraGetDataScRsp\x12!\n\x0bKILPNHJBPDB\x18\xbd\x0c\x20\x01(\rR\
    \x0bKILPNHJBPDB\x12\x20\n\x0bCJEKJHPIBJL\x18\x01\x20\x01(\rR\x0bCJEKJHPI\
    BJL\x12\x18\n\x07retcode\x18\r\x20\x01(\rR\x07retcode\x12.\n\x0bKIIMKAEA\
    JAL\x18\x05\x20\x03(\x0b2\x0c.JCNJDFFCLDGR\x0bKIIMKAEAJAL\x12.\n\x0bNCDA\
    OBLMHHP\x18\x0b\x20\x03(\x0b2\x0c.DIFPDPLCIGDR\x0bNCDAOBLMHHP\x12$\n\x06\
    lineup\x18\x02\x20\x01(\x0b2\x0c.MPJDIBCCOHFR\x06lineup\x12!\n\x0bCPBDBA\
    IDAEH\x18\x86\x01\x20\x01(\rR\x0bCPBDBAIDAEH\x12\x20\n\x0bGBEMDNCKKBA\
    \x18\x0c\x20\x01(\rR\x0bGBEMDNCKKBA\x12\x20\n\x0bBBBGKCHNOCK\x18\n\x20\
    \x01(\rR\x0bBBBGKCHNOCK\x12\x20\n\x0bEAIOJCNLMNG\x18\x03\x20\x01(\rR\x0b\
    EAIOJCNLMNG\x12\x20\n\x0bJFPNMOONLNJ\x18\x0e\x20\x01(\rR\x0bJFPNMOONLNJ\
    \x12\x20\n\x0bOLLDKAJOAJD\x186\x20\x01(\rR\x0bOLLDKAJOAJD\x12\x20\n\x0bI\
    JEIOMMFPKA\x18\x04\x20\x01(\rR\x0bIJEIOMMFPKA\x12.\n\x0bBBMGIIMECEL\x18\
    \x07\x20\x01(\x0e2\x0c.OAPDMKKKEOLR\x0bBBMGIIMECEL\x12!\n\x0bCAGAPLNHABB\
    \x18\x86\x04\x20\x01(\rR\x0bCAGAPLNHABB\x12\x20\n\x0bMFAFNNCJJNG\x18\x08\
    \x20\x03(\rR\x0bMFAFNNCJJNG\x12\x20\n\x0bCJKCNHCLMGD\x18\t\x20\x01(\rR\
    \x0bCJKCNHCLMGD\x12\x20\n\x0bLFKFOCJFNCJ\x18\x06\x20\x01(\rR\x0bLFKFOCJF\
    NCJb\x06proto3\
";
