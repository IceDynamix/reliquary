...
//! Generated file from `LGGGHFDBCFN.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:LGGGHFDBCFN)
...
impl<'a> ::std::default::Default for &'a LGGGHFDBCFN {
    fn default() -> &'a LGGGHFDBCFN {
        <LGGGHFDBCFN as ::protobuf::Message>::default_instance()
    }
}

impl LGGGHFDBCFN {
    pub fn new() -> LGGGHFDBCFN {
...
impl ::protobuf::Message for LGGGHFDBCFN {
    const NAME: &'static str = "LGGGHFDBCFN";
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.FDGJLMMEAOF != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.FDGJLMMEAOF);
        }
        if self.KBDOBOODPAK != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.KBDOBOODPAK);
        }
        if self.progress != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.FDGJLMMEAOF != 0 {
            os.write_uint32(4, self.FDGJLMMEAOF)?;
        }
        if self.KBDOBOODPAK != 0 {
            os.write_uint32(13, self.KBDOBOODPAK)?;
        }
        if self.progress != 0 {
...
impl ::protobuf::MessageFull for LGGGHFDBCFN {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("LGGGHFDBCFN").unwrap()).clone()
    }
}

impl ::std::fmt::Display for LGGGHFDBCFN {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for LGGGHFDBCFN {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x11LGGGHFDBCFN.proto\"\x8c\x01\n\x0bLGGGHFDBCFN\x12\x20\n\x0bFDGJLMME\
    AOF\x18\x04\x20\x01(\rR\x0bFDGJLMMEAOF\x12\x20\n\x0bKBDOBOODPAK\x18\r\
    \x20\x01(\rR\x0bKBDOBOODPAK\x12\x1a\n\x08progress\x18\x06\x20\x01(\rR\
    \x08progress\x12\x1d\n\nhas_passed\x18\x01\x20\x01(\x08R\thasPassedb\x06\
    proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(LGGGHFDBCFN::generated_message_descriptor_data());
