...
impl ::protobuf::Message for UpdateTrackMainMissionIdScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.prev_track_mission_id != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.prev_track_mission_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.prev_track_mission_id != 0 {
            os.write_uint32(12, self.prev_track_mission_id)?;
        }
        if self.track_mission_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x15prev_track_mission_id\x18\x0c\x20\x01(\rR\x12prevTrackMissionId\x12(\
    \n\x10track_mission_id\x18\x0e\x20\x01(\rR\x0etrackMissionIdb\x06proto3\
";
