...
pub struct UpdateTrackMainMissionIdScRsp {
    ...
    pub retcode: u32,
    // @@protoc_insertion_point(field:UpdateTrackMainMissionIdScRsp.CNHFOIPPPPK)
    pub CNHFOIPPPPK: u32,
    // @@protoc_insertion_point(field:UpdateTrackMainMissionIdScRsp.JMJKOKLEJDN)
    pub JMJKOKLEJDN: u32,
    // special fields
...
impl UpdateTrackMainMissionIdScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "CNHFOIPPPPK",
            |m: &UpdateTrackMainMissionIdScRsp| { &m.CNHFOIPPPPK },
            |m: &mut UpdateTrackMainMissionIdScRsp| { &mut m.CNHFOIPPPPK },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "JMJKOKLEJDN",
            |m: &UpdateTrackMainMissionIdScRsp| { &m.JMJKOKLEJDN },
            |m: &mut UpdateTrackMainMissionIdScRsp| { &mut m.JMJKOKLEJDN },
        ));
...
impl ::protobuf::Message for UpdateTrackMainMissionIdScRsp {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                120 => {
                    self.JMJKOKLEJDN = is.read_uint32()?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.JMJKOKLEJDN != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.JMJKOKLEJDN);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.JMJKOKLEJDN != 0 {
            os.write_uint32(15, self.JMJKOKLEJDN)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    HFOIPPPPK\x18\x0c\x20\x01(\rR\x0bCNHFOIPPPPK\x12\x20\n\x0bJMJKOKLEJDN\
    \x18\x0f\x20\x01(\rR\x0bJMJKOKLEJDNb\x06proto3\
";
