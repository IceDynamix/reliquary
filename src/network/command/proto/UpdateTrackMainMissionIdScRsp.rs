...
impl ::protobuf::Message for UpdateTrackMainMissionIdScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.DKMBBNLMNNE != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.DKMBBNLMNNE);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.DKMBBNLMNNE != 0 {
            os.write_uint32(14, self.DKMBBNLMNNE)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    cRsp\x12\x20\n\x0bLFLBIOPJFGE\x18\x04\x20\x01(\rR\x0bLFLBIOPJFGE\x12\x20\
    \n\x0bDKMBBNLMNNE\x18\x0e\x20\x01(\rR\x0bDKMBBNLMNNE\x12\x18\n\x07retcod\
