...
impl ::protobuf::Message for ClientMail {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.sender.is_empty() {
            my_size += ::protobuf::rt::string_size(10, &self.sender);
        }
        ...
        if self.mail_type != ::protobuf::EnumOrUnknown::new(super::MailType::MailType::MAIL_TYPE_NORMAL) {
            my_size += ::protobuf::rt::int32_size(4, self.mail_type.value());
        }
        if self.id != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.id);
        }
        if self.expire_time != 0 {
            my_size += ::protobuf::rt::int64_size(6, self.expire_time);
        }
        if self.template_id != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.template_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.sender.is_empty() {
            os.write_string(10, &self.sender)?;
        }
        ...
        if self.mail_type != ::protobuf::EnumOrUnknown::new(super::MailType::MailType::MAIL_TYPE_NORMAL) {
            os.write_enum(4, ::protobuf::EnumOrUnknown::value(&self.mail_type))?;
        }
        if self.id != 0 {
            os.write_uint32(13, self.id)?;
        }
        if self.expire_time != 0 {
            os.write_int64(6, self.expire_time)?;
        }
        if self.template_id != 0 {
            os.write_uint32(12, self.template_id)?;
        }
        if self.is_read != false {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x16\n\x06sender\x18\n\x20\x01(\tR\x06sender\x12\x1b\n\tpara_list\x18\
    \x03\x20\x03(\tR\x08paraList\x12\x18\n\x07content\x18\x0f\x20\x01(\tR\
    \x07content\x12)\n\nattachment\x18\x08\x20\x01(\x0b2\t.ItemListR\nattach\
    ment\x12\x12\n\x04time\x18\x05\x20\x01(\x03R\x04time\x12&\n\tmail_type\
    \x18\x04\x20\x01(\x0e2\t.MailTypeR\x08mailType\x12\x0e\n\x02id\x18\r\x20\
    \x01(\rR\x02id\x12\x1f\n\x0bexpire_time\x18\x06\x20\x01(\x03R\nexpireTim\
    e\x12\x1f\n\x0btemplate_id\x18\x0c\x20\x01(\rR\ntemplateId\x12\x17\n\x07\
    is_read\x18\x02\x20\x01(\x08R\x06isReadb\x06proto3\
";
