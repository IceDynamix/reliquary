...
impl ::protobuf::Message for ClientMail {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.mail_type != ::protobuf::EnumOrUnknown::new(super::MailType::MailType::MAIL_TYPE_NORMAL) {
            my_size += ::protobuf::rt::int32_size(6, self.mail_type.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.mail_type != ::protobuf::EnumOrUnknown::new(super::MailType::MailType::MAIL_TYPE_NORMAL) {
            os.write_enum(6, ::protobuf::EnumOrUnknown::value(&self.mail_type))?;
        }
        if let Some(v) = self.attachment.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x03\x20\x01(\x08R\x06isRead\x12\x18\n\x07content\x18\x04\x20\x01(\t\
    R\x07content\x12\x14\n\x05title\x18\x05\x20\x01(\tR\x05title\x12&\n\tmai\
    l_type\x18\x06\x20\x01(\x0e2\t.MailTypeR\x08mailType\x12)\n\nattachment\
    \x18\x08\x20\x01(\x0b2\t.ItemListR\nattachment\x12\x12\n\x04time\x18\t\
    \x20\x01(\x03R\x04time\x12\x16\n\x06sender\x18\x0b\x20\x01(\tR\x06sender\
    \x12\x1f\n\x0btemplate_id\x18\x0c\x20\x01(\rR\ntemplateId\x12\x1b\n\tpar\
    a_list\x18\x0f\x20\x03(\tR\x08paraListb\x06proto3\
";
