...
impl ::protobuf::Message for ClientMail {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.content.is_empty() {
            my_size += ::protobuf::rt::string_size(14, &self.content);
        }
        if self.template_id != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.template_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.content.is_empty() {
            os.write_string(14, &self.content)?;
        }
        if self.template_id != 0 {
            os.write_uint32(3, self.template_id)?;
        }
        if !self.title.is_empty() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0b2\t.ItemListR\nattachment\x12\x18\n\x07content\x18\x0e\x20\x01(\tR\
    \x07content\x12\x1f\n\x0btemplate_id\x18\x03\x20\x01(\rR\ntemplateId\x12\
    \x14\n\x05title\x18\x08\x20\x01(\tR\x05title\x12&\n\tmail_type\x18\x0c\
    \x20\x01(\x0e2\t.MailTypeR\x08mailType\x12\x1b\n\tpara_list\x18\r\x20\
    \x03(\tR\x08paraList\x12\x17\n\x07is_read\x18\x01\x20\x01(\x08R\x06isRea\
    d\x12\x1f\n\x0bexpire_time\x18\x05\x20\x01(\x03R\nexpireTime\x12\x12\n\
