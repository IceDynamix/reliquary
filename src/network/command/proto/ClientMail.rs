...
impl ::protobuf::Message for ClientMail {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.mail_type != ::protobuf::EnumOrUnknown::new(super::MailType::MailType::MAIL_TYPE_NORMAL) {
            my_size += ::protobuf::rt::int32_size(13, self.mail_type.value());
        }
        if self.id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.mail_type != ::protobuf::EnumOrUnknown::new(super::MailType::MailType::MAIL_TYPE_NORMAL) {
            os.write_enum(13, ::protobuf::EnumOrUnknown::value(&self.mail_type))?;
        }
        if self.id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    &\n\tmail_type\x18\r\x20\x01(\x0e2\t.MailTypeR\x08mailType\x12\x0e\n\x02\
    id\x18\x01\x20\x01(\rR\x02id\x12\x1f\n\x0bexpire_time\x18\n\x20\x01(\x03\
    R\nexpireTime\x12\x1b\n\tpara_list\x18\x07\x20\x03(\tR\x08paraList\x12\
    \x14\n\x05title\x18\t\x20\x01(\tR\x05title\x12\x17\n\x07is_read\x18\x04\
    \x20\x01(\x08R\x06isRead\x12\x18\n\x07content\x18\x05\x20\x01(\tR\x07con\
    tent\x12\x12\n\x04time\x18\x0c\x20\x01(\x03R\x04time\x12\x1f\n\x0btempla\
    te_id\x18\x0b\x20\x01(\rR\ntemplateId\x12)\n\nattachment\x18\x0f\x20\x01\
