...
impl ::protobuf::Message for NNIJCDKHPKL {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.JEDJBEDKCJI != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.JEDJBEDKCJI);
        }
        if self.AIPLFLIBPKJ != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.AIPLFLIBPKJ);
        }
        if self.CDINHFHBMOG != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.CDINHFHBMOG);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.JEDJBEDKCJI != 0 {
            os.write_uint32(6, self.JEDJBEDKCJI)?;
        }
        if self.AIPLFLIBPKJ != 0 {
            os.write_uint32(7, self.AIPLFLIBPKJ)?;
        }
        if self.CDINHFHBMOG != 0 {
            os.write_uint32(12, self.CDINHFHBMOG)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    BGM\x18\x0f\x20\x01(\x08R\x0bFBJHGPDKBGM\x12\x20\n\x0bJEDJBEDKCJI\x18\
    \x06\x20\x01(\rR\x0bJEDJBEDKCJI\x12\x20\n\x0bAIPLFLIBPKJ\x18\x07\x20\x01\
    (\rR\x0bAIPLFLIBPKJ\x12\x20\n\x0bCDINHFHBMOG\x18\x0c\x20\x01(\rR\x0bCDIN\
    HFHBMOGb\x06proto3\
";
