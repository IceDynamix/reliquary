...
impl ::protobuf::Message for GetRogueShopMiracleInfoScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.AEFHKANBFNC != 0 {
            my_size += ::protobuf::rt::int32_size(15, self.AEFHKANBFNC);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.AEFHKANBFNC != 0 {
            os.write_int32(15, self.AEFHKANBFNC)?;
        }
        if let Some(v) = self.game_miracle_info.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0f\x20\x01(\x05R\x0bAEFHKANBFNC\x128\n\x11game_miracle_info\x18\x0b\
    \x20\x01(\x0b2\x0c.NNJOLKJLPJGR\x0fgameMiracleInfo\x12/\n\x0bIHJHCCFMIFD\
    \x18\x0c\x20\x01(\x0b2\r.ItemCostDataR\x0bIHJHCCFMIFD\x12\x20\n\x0bEFOJO\
