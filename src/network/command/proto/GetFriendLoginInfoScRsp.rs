...
impl ::protobuf::Message for GetFriendLoginInfoScRsp {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.LIFCEHLFDNM != false {
            os.write_bool(9, self.LIFCEHLFDNM)?;
        }
        if self.retcode != 0 {
        ...
        if self.BOHNBJMMKBO != false {
            os.write_bool(2, self.BOHNBJMMKBO)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    sp\x12\x20\n\x0bIIHDBINOPMG\x18\x07\x20\x03(\rR\x0bIIHDBINOPMG\x12\x20\n\
    \x0bLIFCEHLFDNM\x18\t\x20\x01(\x08R\x0bLIFCEHLFDNM\x12\x18\n\x07retcode\
    \x18\x03\x20\x01(\rR\x07retcode\x12\x20\n\x0bDBNDOMDMMGF\x18\x06\x20\x03\
    (\rR\x0bDBNDOMDMMGF\x12\x20\n\x0bBOHNBJMMKBO\x18\x02\x20\x01(\x08R\x0bBO\
    HNBJMMKBOb\x06proto3\
";
