...
impl ::protobuf::Message for GetFriendLoginInfoScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(6, &self.IIHDBINOPMG);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.BOHNBJMMKBO != false {
            os.write_bool(10, self.BOHNBJMMKBO)?;
        }
        os.write_repeated_packed_uint32(6, &self.IIHDBINOPMG)?;
        if self.LIFCEHLFDNM != false {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0bBOHNBJMMKBO\x18\n\x20\x01(\x08R\x0bBOHNBJMMKBO\x12\x20\n\x0bIIHDBINO\
    PMG\x18\x06\x20\x03(\rR\x0bIIHDBINOPMG\x12\x20\n\x0bLIFCEHLFDNM\x18\x0e\
