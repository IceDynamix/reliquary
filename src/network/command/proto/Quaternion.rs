...
//! Generated file from `Quaternion.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:Quaternion)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct Quaternion {
    // message fields
    // @@protoc_insertion_point(field:Quaternion.y)
    pub y: f32,
    // @@protoc_insertion_point(field:Quaternion.MHLDKBMIJOE)
    pub MHLDKBMIJOE: f32,
    // @@protoc_insertion_point(field:Quaternion.z)
    pub z: f32,
    // @@protoc_insertion_point(field:Quaternion.x)
    pub x: f32,
    // special fields
    // @@protoc_insertion_point(special_field:Quaternion.special_fields)
...
impl Quaternion {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "MHLDKBMIJOE",
            |m: &Quaternion| { &m.MHLDKBMIJOE },
            |m: &mut Quaternion| { &mut m.MHLDKBMIJOE },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "z",
            |m: &Quaternion| { &m.z },
...
impl ::protobuf::Message for Quaternion {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                53 => {
                    self.MHLDKBMIJOE = is.read_float()?;
                },
                61 => {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.MHLDKBMIJOE != 0. {
            os.write_float(6, self.MHLDKBMIJOE)?;
        }
        if self.z != 0. {
            os.write_float(7, self.z)?;
        }
        if self.x != 0. {
            os.write_float(11, self.x)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x10Quaternion.proto\"X\n\nQuaternion\x12\x0c\n\x01y\x18\x03\x20\x01(\
    \x02R\x01y\x12\x20\n\x0bMHLDKBMIJOE\x18\x06\x20\x01(\x02R\x0bMHLDKBMIJOE\
    \x12\x0c\n\x01z\x18\x07\x20\x01(\x02R\x01z\x12\x0c\n\x01x\x18\x0b\x20\
    \x01(\x02R\x01xb\x06proto3\
";
