...
impl ::protobuf::Message for ResetEraFlipperDataScRsp {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.CJEILDIOIOE != false {
            os.write_bool(15, self.CJEILDIOIOE)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    de\x12\x20\n\x04data\x18\x07\x20\x01(\x0b2\x0c.KKFMGCNDHGHR\x04data\x12\
    \x20\n\x0bCJEILDIOIOE\x18\x0f\x20\x01(\x08R\x0bCJEILDIOIOEb\x06proto3\
";
