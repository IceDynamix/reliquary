...
pub struct ResetEraFlipperDataScRsp {
    ...
    pub retcode: u32,
    // @@protoc_insertion_point(field:ResetEraFlipperDataScRsp.HKPPOBOKOBN)
...
impl ResetEraFlipperDataScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "HKPPOBOKOBN",
            |m: &ResetEraFlipperDataScRsp| { &m.HKPPOBOKOBN },
            |m: &mut ResetEraFlipperDataScRsp| { &mut m.HKPPOBOKOBN },
        ));
...
impl ::protobuf::Message for ResetEraFlipperDataScRsp {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.HKPPOBOKOBN != false {
            os.write_bool(3, self.HKPPOBOKOBN)?;
        }
        if let Some(v) = self.data.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1eResetEraFlipperDataScRsp.proto\x1a\x11GAMJPEJHMMA.proto\"x\n\x18Re\
    setEraFlipperDataScRsp\x12\x18\n\x07retcode\x18\x0f\x20\x01(\rR\x07retco\
    de\x12\x20\n\x0bHKPPOBOKOBN\x18\x03\x20\x01(\x08R\x0bHKPPOBOKOBN\x12\x20\
    \n\x04data\x18\x01\x20\x01(\x0b2\x0c.GAMJPEJHMMAR\x04datab\x06proto3\
";
