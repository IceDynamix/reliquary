...
pub struct ResetEraFlipperDataScRsp {
    // message fields
    // @@protoc_insertion_point(field:ResetEraFlipperDataScRsp.CEICIHHHJDC)
...
impl ResetEraFlipperDataScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "CEICIHHHJDC",
            |m: &ResetEraFlipperDataScRsp| { &m.CEICIHHHJDC },
            |m: &mut ResetEraFlipperDataScRsp| { &mut m.CEICIHHHJDC },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "retcode",
...
impl ::protobuf::Message for ResetEraFlipperDataScRsp {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.CEICIHHHJDC != false {
            os.write_bool(11, self.CEICIHHHJDC)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1eResetEraFlipperDataScRsp.proto\x1a\x11KAODJLBGPML.proto\"x\n\x18Re\
    setEraFlipperDataScRsp\x12\x20\n\x0bCEICIHHHJDC\x18\x0b\x20\x01(\x08R\
    \x0bCEICIHHHJDC\x12\x18\n\x07retcode\x18\x0f\x20\x01(\rR\x07retcode\x12\
    \x20\n\x04data\x18\x03\x20\x01(\x0b2\x0c.KAODJLBGPMLR\x04datab\x06proto3\
";
