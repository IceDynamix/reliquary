...
impl ::protobuf::Message for SceneNpcMonsterInfo {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.NMPEOMMHMPP != false {
            os.write_bool(10, self.NMPEOMMHMPP)?;
        }
        if self.NHKJKNJAGMF != false {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x01\x20\x01(\x0b2\x14.NpcMonsterExtraInfoR\textraInfo\x12.\n\x0bBMI\
    JGBFJMCF\x18\t\x20\x01(\x0b2\x0c.GILBMELHGCBR\x0bBMIJGBFJMCF\x12\x20\n\
    \x0bNMPEOMMHMPP\x18\n\x20\x01(\x08R\x0bNMPEOMMHMPP\x12\x20\n\x0bNHKJKNJA\
    GMF\x18\x06\x20\x01(\x08R\x0bNHKJKNJAGMF\x12\x1d\n\nmonster_id\x18\x0e\
    \x20\x01(\rR\tmonsterId\x12\x19\n\x08event_id\x18\x05\x20\x01(\rR\x07eve\
