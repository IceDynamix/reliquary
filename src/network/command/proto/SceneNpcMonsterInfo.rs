...
impl ::protobuf::Message for SceneNpcMonsterInfo {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.MPFEDFBKKDF != false {
            os.write_bool(12, self.MPFEDFBKKDF)?;
        }
        if self.event_id != 0 {
            os.write_uint32(7, self.event_id)?;
        }
        if self.IDPJIDNLEHH != false {
            os.write_bool(4, self.IDPJIDNLEHH)?;
        }
        if self.world_level != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    id\x18\x03\x20\x01(\rR\tmonsterId\x12\x20\n\x0bMPFEDFBKKDF\x18\x0c\x20\
    \x01(\x08R\x0bMPFEDFBKKDF\x12\x19\n\x08event_id\x18\x07\x20\x01(\rR\x07e\
    ventId\x12\x20\n\x0bIDPJIDNLEHH\x18\x04\x20\x01(\x08R\x0bIDPJIDNLEHH\x12\
    \x1f\n\x0bworld_level\x18\x01\x20\x01(\rR\nworldLevel\x12.\n\x0bGEIFPDHB\
    KBF\x18\x0e\x20\x01(\x0b2\x0c.OEPANDOKEJDR\x0bGEIFPDHBKBF\x123\n\nextra_\
    info\x18\x02\x20\x01(\x0b2\x14.NpcMonsterExtraInfoR\textraInfob\x06proto\
    3\
";
