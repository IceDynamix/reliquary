...
impl ::protobuf::Message for SyncHandleFriendScNotify {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.handle_result != false {
            os.write_bool(10, self.handle_result)?;
        }
        if self.uid != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x01\n\x18SyncHandleFriendScNotify\x12=\n\x12handle_friend_info\x18\x07\
    \x20\x01(\x0b2\x0f.FriendListInfoR\x10handleFriendInfo\x12#\n\rhandle_re\
    sult\x18\n\x20\x01(\x08R\x0chandleResult\x12\x10\n\x03uid\x18\x08\x20\
