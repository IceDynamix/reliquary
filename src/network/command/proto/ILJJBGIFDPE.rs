...
impl ::protobuf::Message for ILJJBGIFDPE {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.HDKAFNKHALA != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.HDKAFNKHALA);
        }
        if self.MEMBICNIFLI != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.MEMBICNIFLI);
        }
        ...
        if self.NIJMJBMCFJF != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.NIJMJBMCFJF);
        }
        ...
        if self.CCIGDJCGAMD != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.CCIGDJCGAMD);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.HDKAFNKHALA != 0 {
            os.write_uint32(7, self.HDKAFNKHALA)?;
        }
        if self.MEMBICNIFLI != 0 {
            os.write_uint32(4, self.MEMBICNIFLI)?;
        }
        for v in &self.OEBAFBIGMBC {
            ::protobuf::rt::write_message_field_with_cached_size(9, v, os)?;
        };
        if self.NIJMJBMCFJF != 0 {
            os.write_uint32(14, self.NIJMJBMCFJF)?;
        }
        if let Some(v) = self.PEHINGJKGCB.as_ref() {
        ...
        if self.CCIGDJCGAMD != 0 {
            os.write_uint32(2, self.CCIGDJCGAMD)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    o\"\xf8\x03\n\x0bILJJBGIFDPE\x12.\n\x0bFOFHIEIICPB\x18\x0b\x20\x01(\x0b2\
    \x0c.IIKNGNHDMFIR\x0bFOFHIEIICPB\x12\x20\n\x0bNLAOMPDENKK\x18\x03\x20\
    \x01(\rR\x0bNLAOMPDENKK\x12.\n\x0bEAJPDPCDJPK\x18\x06\x20\x01(\x0b2\x0c.\
    IIKNGNHDMFIR\x0bEAJPDPCDJPK\x12\x20\n\x0bHDKAFNKHALA\x18\x07\x20\x01(\rR\
    \x0bHDKAFNKHALA\x12\x20\n\x0bMEMBICNIFLI\x18\x04\x20\x01(\rR\x0bMEMBICNI\
    FLI\x12.\n\x0bOEBAFBIGMBC\x18\t\x20\x03(\x0b2\x0c.NPAIINEKEFBR\x0bOEBAFB\
    IGMBC\x12\x20\n\x0bNIJMJBMCFJF\x18\x0e\x20\x01(\rR\x0bNIJMJBMCFJF\x12.\n\
    \x0bPEHINGJKGCB\x18\x0c\x20\x01(\x0b2\x0c.IIKNGNHDMFIR\x0bPEHINGJKGCB\
    \x12?\n\x0bBJELCLBGALF\x18\x01\x20\x03(\x0b2\x1d.ILJJBGIFDPE.BJELCLBGALF\
    EntryR\x0bBJELCLBGALF\x12\x20\n\x0bCCIGDJCGAMD\x18\x02\x20\x01(\rR\x0bCC\
