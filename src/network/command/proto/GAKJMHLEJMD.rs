...
//! Generated file from `GAKJMHLEJMD.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:GAKJMHLEJMD)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct GAKJMHLEJMD {
    // message fields
...
impl<'a> ::std::default::Default for &'a GAKJMHLEJMD {
    fn default() -> &'a GAKJMHLEJMD {
        <GAKJMHLEJMD as ::protobuf::Message>::default_instance()
    }
}

impl GAKJMHLEJMD {
    pub fn new() -> GAKJMHLEJMD {
...
impl ::protobuf::Message for GAKJMHLEJMD {
    const NAME: &'static str = "GAKJMHLEJMD";
...
impl ::protobuf::MessageFull for GAKJMHLEJMD {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("GAKJMHLEJMD").unwrap()).clone()
    }
}

impl ::std::fmt::Display for GAKJMHLEJMD {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for GAKJMHLEJMD {
