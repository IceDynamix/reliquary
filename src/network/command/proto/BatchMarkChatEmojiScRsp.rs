...
impl ::protobuf::Message for BatchMarkChatEmojiScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(1, &self.marked_emoji_id_list);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_uint32(1, &self.marked_emoji_id_list)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    id_list\x18\x01\x20\x03(\rR\x11markedEmojiIdListb\x06proto3\
";
