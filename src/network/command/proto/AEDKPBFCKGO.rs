...
impl ::protobuf::Message for AEDKPBFCKGO {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.FNIGPGBGEHN != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.FNIGPGBGEHN);
        }
        if self.IFKDGEBCDEG != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.IFKDGEBCDEG);
        }
        if self.GIMDHBNJOOO != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.GIMDHBNJOOO);
        }
        if self.EFINFPKKJLE != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.EFINFPKKJLE);
        }
        if self.PILAAGOKAOF != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.PILAAGOKAOF);
        }
        if self.IMOBLGOAJCB != false {
            my_size += 1 + 1;
        }
        if self.PKDLKCBKKPF != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.PKDLKCBKKPF);
        }
        if self.PDDNGKNCPEB != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.PDDNGKNCPEB);
        }
        if self.KMGIEMOFOGB != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.KMGIEMOFOGB);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.FNIGPGBGEHN != 0 {
            os.write_uint32(13, self.FNIGPGBGEHN)?;
        }
        if self.IFKDGEBCDEG != 0 {
            os.write_uint32(2, self.IFKDGEBCDEG)?;
        }
        if self.GIMDHBNJOOO != 0 {
            os.write_uint32(3, self.GIMDHBNJOOO)?;
        }
        if self.EFINFPKKJLE != 0 {
            os.write_uint32(8, self.EFINFPKKJLE)?;
        }
        if self.PILAAGOKAOF != 0 {
            os.write_uint32(6, self.PILAAGOKAOF)?;
        }
        if self.IMOBLGOAJCB != false {
            os.write_bool(10, self.IMOBLGOAJCB)?;
        }
        if self.PKDLKCBKKPF != 0 {
            os.write_uint32(5, self.PKDLKCBKKPF)?;
        }
        if self.PDDNGKNCPEB != 0 {
            os.write_uint32(11, self.PDDNGKNCPEB)?;
        }
        if self.KMGIEMOFOGB != 0 {
            os.write_uint32(7, self.KMGIEMOFOGB)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    EHN\x18\r\x20\x01(\rR\x0bFNIGPGBGEHN\x12\x20\n\x0bIFKDGEBCDEG\x18\x02\
    \x20\x01(\rR\x0bIFKDGEBCDEG\x12\x20\n\x0bGIMDHBNJOOO\x18\x03\x20\x01(\rR\
    \x0bGIMDHBNJOOO\x12\x20\n\x0bEFINFPKKJLE\x18\x08\x20\x01(\rR\x0bEFINFPKK\
    JLE\x12\x20\n\x0bPILAAGOKAOF\x18\x06\x20\x01(\rR\x0bPILAAGOKAOF\x12\x20\
    \n\x0bIMOBLGOAJCB\x18\n\x20\x01(\x08R\x0bIMOBLGOAJCB\x12\x20\n\x0bPKDLKC\
    BKKPF\x18\x05\x20\x01(\rR\x0bPKDLKCBKKPF\x12\x20\n\x0bPDDNGKNCPEB\x18\
    \x0b\x20\x01(\rR\x0bPDDNGKNCPEB\x12\x20\n\x0bKMGIEMOFOGB\x18\x07\x20\x01\
    (\rR\x0bKMGIEMOFOGBb\x06proto3\
";
