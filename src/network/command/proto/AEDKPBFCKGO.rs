...
impl ::protobuf::Message for AEDKPBFCKGO {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.FNIGPGBGEHN != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.FNIGPGBGEHN);
        }
        if self.PKDLKCBKKPF != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.PKDLKCBKKPF);
        }
        if self.PDDNGKNCPEB != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.PDDNGKNCPEB);
        }
        if self.KMGIEMOFOGB != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.KMGIEMOFOGB);
        }
        ...
        if self.GIMDHBNJOOO != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.GIMDHBNJOOO);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.FNIGPGBGEHN != 0 {
            os.write_uint32(15, self.FNIGPGBGEHN)?;
        }
        if self.PKDLKCBKKPF != 0 {
            os.write_uint32(13, self.PKDLKCBKKPF)?;
        }
        if self.PDDNGKNCPEB != 0 {
            os.write_uint32(14, self.PDDNGKNCPEB)?;
        }
        if self.KMGIEMOFOGB != 0 {
            os.write_uint32(12, self.KMGIEMOFOGB)?;
        }
        if self.IFKDGEBCDEG != 0 {
            os.write_uint32(5, self.IFKDGEBCDEG)?;
        }
        if self.IMOBLGOAJCB != false {
            os.write_bool(9, self.IMOBLGOAJCB)?;
        }
        if self.EFINFPKKJLE != 0 {
        ...
        if self.GIMDHBNJOOO != 0 {
            os.write_uint32(2, self.GIMDHBNJOOO)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    EHN\x18\x0f\x20\x01(\rR\x0bFNIGPGBGEHN\x12\x20\n\x0bPKDLKCBKKPF\x18\r\
    \x20\x01(\rR\x0bPKDLKCBKKPF\x12\x20\n\x0bPDDNGKNCPEB\x18\x0e\x20\x01(\rR\
    \x0bPDDNGKNCPEB\x12\x20\n\x0bKMGIEMOFOGB\x18\x0c\x20\x01(\rR\x0bKMGIEMOF\
    OGB\x12\x20\n\x0bIFKDGEBCDEG\x18\x05\x20\x01(\rR\x0bIFKDGEBCDEG\x12\x20\
    \n\x0bIMOBLGOAJCB\x18\t\x20\x01(\x08R\x0bIMOBLGOAJCB\x12\x20\n\x0bEFINFP\
    KKJLE\x18\x08\x20\x01(\rR\x0bEFINFPKKJLE\x12\x20\n\x0bPILAAGOKAOF\x18\
    \x07\x20\x01(\rR\x0bPILAAGOKAOF\x12\x20\n\x0bGIMDHBNJOOO\x18\x02\x20\x01\
    (\rR\x0bGIMDHBNJOOOb\x06proto3\
";
