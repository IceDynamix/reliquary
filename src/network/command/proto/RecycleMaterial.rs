...
impl ::protobuf::Message for RecycleMaterial {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.expire_time != 0 {
            my_size += ::protobuf::rt::uint64_size(7, self.expire_time);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.expire_time != 0 {
            os.write_uint64(7, self.expire_time)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0e\x20\x01(\rR\x03tid\x12\x10\n\x03num\x18\t\x20\x01(\rR\x03num\x12\
    \x1f\n\x0bexpire_time\x18\x07\x20\x01(\x04R\nexpireTimeb\x06proto3\
";
