...
impl ::protobuf::Message for GetCrossInfoScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.NOGFEEMNHPC != 0 {
            my_size += ::protobuf::rt::uint64_size(7, self.NOGFEEMNHPC);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.NOGFEEMNHPC != 0 {
            os.write_uint64(7, self.NOGFEEMNHPC)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x17\n\x07room_id\x18\x0e\x20\x01(\x04R\x06roomId\x120\n\x0bNBDLPGBIDLC\
    \x18\x02\x20\x01(\x0e2\x0e.FightGameModeR\x0bNBDLPGBIDLC\x12\x20\n\x0bNO\
    GFEEMNHPC\x18\x07\x20\x01(\x04R\x0bNOGFEEMNHPCb\x06proto3\
";
