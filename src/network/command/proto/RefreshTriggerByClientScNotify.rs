...
impl ::protobuf::Message for RefreshTriggerByClientScNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(2, &self.trigger_target_id_list);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_uint32(2, &self.trigger_target_id_list)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    lientScNotify\x12*\n\x11trigger_entity_id\x18\x0e\x20\x01(\rR\x0ftrigger\
    EntityId\x12!\n\x0ctrigger_name\x18\x07\x20\x01(\tR\x0btriggerName\x123\
    \n\x16trigger_target_id_list\x18\x02\x20\x03(\rR\x13triggerTargetIdListb\
    \x06proto3\
";
