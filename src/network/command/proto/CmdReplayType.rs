...
impl ::protobuf::Enum for CmdReplayType {
    ...
    fn from_i32(value: i32) -> ::std::option::Option<CmdReplayType> {
        match value {
            ...
            3511 => ::std::option::Option::Some(CmdReplayType::CmdGetReplayTokenCsReq),
            3513 => ::std::option::Option::Some(CmdReplayType::CmdGetReplayTokenScRsp),
            3547 => ::std::option::Option::Some(CmdReplayType::CmdGetPlayerReplayInfoCsReq),
            3509 => ::std::option::Option::Some(CmdReplayType::CmdGetPlayerReplayInfoScRsp),
...
impl ::protobuf::EnumFull for CmdReplayType {
    ...
    fn descriptor(&self) -> ::protobuf::reflect::EnumValueDescriptor {
        let index = match self {
            ...
            CmdReplayType::CmdGetReplayTokenScRsp => 2,
            CmdReplayType::CmdGetPlayerReplayInfoCsReq => 3,
            CmdReplayType::CmdGetPlayerReplayInfoScRsp => 4,
        };
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ayTypeNone\x10\0\x12\x1b\n\x16CmdGetReplayTokenCsReq\x10\xb7\x1b\x12\x1b\
    \n\x16CmdGetReplayTokenScRsp\x10\xb9\x1b\x12\x20\n\x1bCmdGetPlayerReplay\
    InfoCsReq\x10\xdb\x1b\x12\x20\n\x1bCmdGetPlayerReplayInfoScRsp\x10\xb5\
    \x1bb\x06proto3\
";
