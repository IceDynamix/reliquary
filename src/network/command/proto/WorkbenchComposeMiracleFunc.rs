...
impl ::protobuf::Message for WorkbenchComposeMiracleFunc {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.int_reforge_num_value != 0 {
            my_size += ::protobuf::rt::int32_size(7, self.int_reforge_num_value);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.int_reforge_num_value != 0 {
            os.write_int32(7, self.int_reforge_num_value)?;
        }
        if let Some(v) = self.cost_data.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x1bWorkbenchComposeMiracleFunc\x12(\n\x10free_reforge_num\x18\x06\x20\
    \x01(\rR\x0efreeReforgeNum\x121\n\x15int_reforge_num_value\x18\x07\x20\
    \x01(\x05R\x12intReforgeNumValue\x12*\n\tcost_data\x18\x08\x20\x01(\x0b2\
    \r.ItemCostDataR\x08costData\x12O\n\x0bNFNICIPMJII\x18\x0c\x20\x03(\x0b2\
    -.WorkbenchComposeMiracleFunc.NFNICIPMJIIEntryR\x0bNFNICIPMJII\x1a>\n\
