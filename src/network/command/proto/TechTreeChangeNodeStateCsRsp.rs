...
//! Generated file from `TechTreeChangeNodeStateCsRsp.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:TechTreeChangeNodeStateCsRsp)
...
impl<'a> ::std::default::Default for &'a TechTreeChangeNodeStateCsRsp {
    fn default() -> &'a TechTreeChangeNodeStateCsRsp {
        <TechTreeChangeNodeStateCsRsp as ::protobuf::Message>::default_instance()
    }
}

impl TechTreeChangeNodeStateCsRsp {
    pub fn new() -> TechTreeChangeNodeStateCsRsp {
...
impl ::protobuf::Message for TechTreeChangeNodeStateCsRsp {
    const NAME: &'static str = "TechTreeChangeNodeStateCsRsp";
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.CDMFHNGEFCN != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.CDMFHNGEFCN);
        }
        if self.op_type != ::protobuf::EnumOrUnknown::new(super::OEDABANAJEK::OEDABANAJEK::OEDABANAJEK_NLCDGIPGFDJ) {
            my_size += ::protobuf::rt::int32_size(14, self.op_type.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.CDMFHNGEFCN != 0 {
            os.write_uint32(5, self.CDMFHNGEFCN)?;
        }
        if self.op_type != ::protobuf::EnumOrUnknown::new(super::OEDABANAJEK::OEDABANAJEK::OEDABANAJEK_NLCDGIPGFDJ) {
            os.write_enum(14, ::protobuf::EnumOrUnknown::value(&self.op_type))?;
        }
    ...
    fn new() -> TechTreeChangeNodeStateCsRsp {
        TechTreeChangeNodeStateCsRsp::new()
    }
...
impl ::protobuf::MessageFull for TechTreeChangeNodeStateCsRsp {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("TechTreeChangeNodeStateCsRsp").unwrap()).clone()
    }
}

impl ::std::fmt::Display for TechTreeChangeNodeStateCsRsp {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for TechTreeChangeNodeStateCsRsp {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x01(\rR\x07retcode\x12\x20\n\x0bCDMFHNGEFCN\x18\x05\x20\x01(\rR\x0bCDMF\
    HNGEFCN\x12%\n\x07op_type\x18\x0e\x20\x01(\x0e2\x0c.OEDABANAJEKR\x06opTy\
    peb\x06proto3\
";
