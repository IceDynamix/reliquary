...
pub struct UpdateMechanismBarScNotify {
    // message fields
    // @@protoc_insertion_point(field:UpdateMechanismBarScNotify.DPHMOAJPDIC)
    pub DPHMOAJPDIC: ::protobuf::MessageField<super::MechanismBarInfo::MechanismBarInfo>,
...
impl UpdateMechanismBarScNotify {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::MechanismBarInfo::MechanismBarInfo>(
            "DPHMOAJPDIC",
            |m: &UpdateMechanismBarScNotify| { &m.DPHMOAJPDIC },
            |m: &mut UpdateMechanismBarScNotify| { &mut m.DPHMOAJPDIC },
        ));
...
impl ::protobuf::Message for UpdateMechanismBarScNotify {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                106 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.DPHMOAJPDIC)?;
                },
                48 => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if let Some(v) = self.DPHMOAJPDIC.as_ref() {
    ...
    fn default_instance() -> &'static UpdateMechanismBarScNotify {
        static instance: UpdateMechanismBarScNotify = UpdateMechanismBarScNotify {
            DPHMOAJPDIC: ::protobuf::MessageField::none(),
            floor_id: 0,
            plane_id: 0,
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x87\x01\n\x1aUpdateMechanismBarScNotify\x123\n\x0bDPHMOAJPDIC\x18\r\x20\
    \x01(\x0b2\x11.MechanismBarInfoR\x0bDPHMOAJPDIC\x12\x19\n\x08floor_id\
    \x18\x06\x20\x01(\rR\x07floorId\x12\x19\n\x08plane_id\x18\x08\x20\x01(\r\
