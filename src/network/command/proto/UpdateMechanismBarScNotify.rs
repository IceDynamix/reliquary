...
pub struct UpdateMechanismBarScNotify {
    ...
    pub floor_id: u32,
    // @@protoc_insertion_point(field:UpdateMechanismBarScNotify.ADBPPOFGGBC)
    pub ADBPPOFGGBC: ::protobuf::MessageField<super::MechanismBarInfo::MechanismBarInfo>,
    // special fields
...
impl UpdateMechanismBarScNotify {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::MechanismBarInfo::MechanismBarInfo>(
            "ADBPPOFGGBC",
            |m: &UpdateMechanismBarScNotify| { &m.ADBPPOFGGBC },
            |m: &mut UpdateMechanismBarScNotify| { &mut m.ADBPPOFGGBC },
        ));
...
impl ::protobuf::Message for UpdateMechanismBarScNotify {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                50 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.ADBPPOFGGBC)?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let Some(v) = self.ADBPPOFGGBC.as_ref() {
    ...
    fn default_instance() -> &'static UpdateMechanismBarScNotify {
        static instance: UpdateMechanismBarScNotify = UpdateMechanismBarScNotify {
            plane_id: 0,
            floor_id: 0,
            ADBPPOFGGBC: ::protobuf::MessageField::none(),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x20\x01(\rR\x07planeId\x12\x19\n\x08floor_id\x18\x0f\x20\x01(\rR\x07flo\
    orId\x123\n\x0bADBPPOFGGBC\x18\x06\x20\x01(\x0b2\x11.MechanismBarInfoR\
    \x0bADBPPOFGGBCb\x06proto3\
";
