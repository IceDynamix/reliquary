...
pub struct UpdateMechanismBarScNotify {
    // message fields
    // @@protoc_insertion_point(field:UpdateMechanismBarScNotify.MFANGEOJHBI)
    pub MFANGEOJHBI: ::protobuf::MessageField<super::MechanismBarInfo::MechanismBarInfo>,
...
impl UpdateMechanismBarScNotify {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::MechanismBarInfo::MechanismBarInfo>(
            "MFANGEOJHBI",
            |m: &UpdateMechanismBarScNotify| { &m.MFANGEOJHBI },
            |m: &mut UpdateMechanismBarScNotify| { &mut m.MFANGEOJHBI },
        ));
...
impl ::protobuf::Message for UpdateMechanismBarScNotify {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                90 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.MFANGEOJHBI)?;
                },
                24 => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if let Some(v) = self.MFANGEOJHBI.as_ref() {
    ...
    fn default_instance() -> &'static UpdateMechanismBarScNotify {
        static instance: UpdateMechanismBarScNotify = UpdateMechanismBarScNotify {
            MFANGEOJHBI: ::protobuf::MessageField::none(),
            plane_id: 0,
            floor_id: 0,
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x87\x01\n\x1aUpdateMechanismBarScNotify\x123\n\x0bMFANGEOJHBI\x18\x0b\
    \x20\x01(\x0b2\x11.MechanismBarInfoR\x0bMFANGEOJHBI\x12\x19\n\x08plane_i\
    d\x18\x03\x20\x01(\rR\x07planeId\x12\x19\n\x08floor_id\x18\x0c\x20\x01(\
    \rR\x07floorIdb\x06proto3\
";
