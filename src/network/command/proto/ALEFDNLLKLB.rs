...
impl ::protobuf::Message for ALEFDNLLKLB {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(4, &self.FDEIGEPCCBP);
        if self.EENJBPMNDOL != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.EENJBPMNDOL);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_uint32(4, &self.FDEIGEPCCBP)?;
        if self.EENJBPMNDOL != 0 {
            os.write_uint32(7, self.EENJBPMNDOL)?;
        }
        if let Some(v) = self.GBEABIMOBIC.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ng_action\x18\x0b\x20\x01(\x0b2\x0c.JKMFMMPMNAMR\rpendingAction\x12.\n\
    \x0bNNCJOECKCKA\x18\r\x20\x01(\x0b2\x0c.BPPMEIGAHGIR\x0bNNCJOECKCKA\x12+\
    \n\nskill_info\x18\x05\x20\x01(\x0b2\x0c.GJBNIIINKFBR\tskillInfo\x12\x20\
    \n\x0bFDEIGEPCCBP\x18\x04\x20\x03(\rR\x0bFDEIGEPCCBP\x12\x20\n\x0bEENJBP\
    MNDOL\x18\x07\x20\x01(\rR\x0bEENJBPMNDOL\x12.\n\x0bGBEABIMOBIC\x18\t\x20\
    \x01(\x0b2\x0c.PGGGCFBKDPKR\x0bGBEABIMOBIC\x12.\n\x0bAFPDJDKNENI\x18\x0e\
    \x20\x01(\x0b2\x0c.OCBOLHFOIGIR\x0bAFPDJDKNENI\x12.\n\x0bLJGCPNOGIFO\x18\
    \x02\x20\x01(\x0b2\x0c.DMJLKIFEMMNR\x0bLJGCPNOGIFOb\x06proto3\
";
