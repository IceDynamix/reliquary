...
impl ::protobuf::Message for KKNLMCJIGAF {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.GHFAIHLCELN != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.GHFAIHLCELN);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.GHFAIHLCELN != 0 {
            os.write_uint32(14, self.GHFAIHLCELN)?;
        }
        if self.HFNHLCFNHKD != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ELN\x18\x0e\x20\x01(\rR\x0bGHFAIHLCELN\x12\x20\n\x0bHFNHLCFNHKD\x18\x04\
    \x20\x01(\rR\x0bHFNHLCFNHKD\x12\x1b\n\tunique_id\x18\x0f\x20\x01(\rR\x08\
    uniqueId\x12#\n\rdisplay_value\x18\x06\x20\x01(\rR\x0cdisplayValueb\x06p\
    roto3\
";
