...
impl ::protobuf::Message for DisplayAvatarDetailInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.enhanced_id != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.enhanced_id);
        }
        if self.pos != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.enhanced_id != 0 {
            os.write_uint32(12, self.enhanced_id)?;
        }
        if self.pos != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    DisplayAvatarDetailInfo\x123\n\tequipment\x18\x02\x20\x01(\x0b2\x15.Disp\
    layEquipmentInfoR\tequipment\x12\x1b\n\tavatar_id\x18\x0e\x20\x01(\rR\
    \x08avatarId\x12&\n\x0fdressed_skin_id\x18\x0b\x20\x01(\rR\rdressedSkinI\
    d\x12\x10\n\x03exp\x18\x08\x20\x01(\rR\x03exp\x12\x12\n\x04rank\x18\x03\
    \x20\x01(\rR\x04rank\x12\x1c\n\tpromotion\x18\x05\x20\x01(\rR\tpromotion\
    \x12D\n\x15avatar_skilltree_list\x18\n\x20\x03(\x0b2\x10.AvatarSkillTree\
    R\x13avatarSkilltreeList\x12\x1f\n\x0benhanced_id\x18\x0c\x20\x01(\rR\ne\
    nhancedId\x12\x10\n\x03pos\x18\x07\x20\x01(\rR\x03pos\x120\n\nrelic_list\
    \x18\x01\x20\x03(\x0b2\x11.DisplayRelicInfoR\trelicList\x12\x14\n\x05lev\
    el\x18\x0f\x20\x01(\rR\x05levelb\x06proto3\
";
