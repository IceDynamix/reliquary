...
impl ::protobuf::Message for DisplayAvatarDetailInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.enhanced_id != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.enhanced_id);
        }
        if self.avatar_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.enhanced_id != 0 {
            os.write_uint32(15, self.enhanced_id)?;
        }
        if self.avatar_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    DisplayAvatarDetailInfo\x12\x1f\n\x0benhanced_id\x18\x0f\x20\x01(\rR\nen\
    hancedId\x12\x1b\n\tavatar_id\x18\n\x20\x01(\rR\x08avatarId\x12\x10\n\
    \x03exp\x18\x0b\x20\x01(\rR\x03exp\x12\x14\n\x05level\x18\x03\x20\x01(\r\
    R\x05level\x12\x12\n\x04rank\x18\x04\x20\x01(\rR\x04rank\x12D\n\x15avata\
    r_skilltree_list\x18\t\x20\x03(\x0b2\x10.AvatarSkillTreeR\x13avatarSkill\
    treeList\x12\x10\n\x03pos\x18\x0e\x20\x01(\rR\x03pos\x12&\n\x0fdressed_s\
    kin_id\x18\x08\x20\x01(\rR\rdressedSkinId\x12\x1c\n\tpromotion\x18\r\x20\
    \x01(\rR\tpromotion\x123\n\tequipment\x18\x05\x20\x01(\x0b2\x15.DisplayE\
    quipmentInfoR\tequipment\x120\n\nrelic_list\x18\x06\x20\x03(\x0b2\x11.Di\
    splayRelicInfoR\trelicListb\x06proto3\
";
