...
impl ::protobuf::Message for StartPartialChallengeCsReq {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.is_first_half != false {
            os.write_bool(6, self.is_first_half)?;
        }
        if self.buff_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    q\x12!\n\x0cchallenge_id\x18\x0f\x20\x01(\rR\x0bchallengeId\x12\"\n\ris_\
    first_half\x18\x06\x20\x01(\x08R\x0bisFirstHalf\x12\x17\n\x07buff_id\x18\
    \x0b\x20\x01(\rR\x06buffIdb\x06proto3\
";
