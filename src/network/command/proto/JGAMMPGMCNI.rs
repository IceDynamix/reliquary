...
//! Generated file from `JGAMMPGMCNI.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:JGAMMPGMCNI)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct JGAMMPGMCNI {
    // message fields
...
impl<'a> ::std::default::Default for &'a JGAMMPGMCNI {
    fn default() -> &'a JGAMMPGMCNI {
        <JGAMMPGMCNI as ::protobuf::Message>::default_instance()
    }
}

impl JGAMMPGMCNI {
    pub fn new() -> JGAMMPGMCNI {
...
impl ::protobuf::Message for JGAMMPGMCNI {
    const NAME: &'static str = "JGAMMPGMCNI";
...
impl ::protobuf::MessageFull for JGAMMPGMCNI {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("JGAMMPGMCNI").unwrap()).clone()
    }
}

impl ::std::fmt::Display for JGAMMPGMCNI {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for JGAMMPGMCNI {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(JGAMMPGMCNI::generated_message_descriptor_data());
