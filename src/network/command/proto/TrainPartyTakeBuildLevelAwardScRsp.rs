...
impl ::protobuf::Message for TrainPartyTakeBuildLevelAwardScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.FPHFHCGNNGM != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.FPHFHCGNNGM);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.FPHFHCGNNGM != 0 {
            os.write_uint32(8, self.FPHFHCGNNGM)?;
        }
        if let Some(v) = self.item_list.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x20\x01(\rR\x07retcode\x12\x20\n\x0bFPHFHCGNNGM\x18\x08\x20\x01(\rR\x0b\
    FPHFHCGNNGM\x12&\n\titem_list\x18\x0c\x20\x01(\x0b2\t.ItemListR\x08itemL\
    istb\x06proto3\
";
