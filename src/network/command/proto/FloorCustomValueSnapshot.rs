...
//! Generated file from `FloorCustomValueSnapshot.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:FloorCustomValueSnapshot)
...
pub struct FloorCustomValueSnapshot {
    ...
    pub type_: ::protobuf::EnumOrUnknown<super::AKODJPCIODF::AKODJPCIODF>,
...
impl<'a> ::std::default::Default for &'a FloorCustomValueSnapshot {
    fn default() -> &'a FloorCustomValueSnapshot {
        <FloorCustomValueSnapshot as ::protobuf::Message>::default_instance()
    }
}

impl FloorCustomValueSnapshot {
    pub fn new() -> FloorCustomValueSnapshot {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "type",
            |m: &FloorCustomValueSnapshot| { &m.type_ },
            |m: &mut FloorCustomValueSnapshot| { &mut m.type_ },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "bool_val",
...
impl ::protobuf::Message for FloorCustomValueSnapshot {
    const NAME: &'static str = "FloorCustomValueSnapshot";
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.type_ != ::protobuf::EnumOrUnknown::new(super::AKODJPCIODF::AKODJPCIODF::AKODJPCIODF_BENEHIKHBJM) {
    ...
    fn new() -> FloorCustomValueSnapshot {
        FloorCustomValueSnapshot::new()
    }

    fn clear(&mut self) {
        self.name.clear();
        self.type_ = ::protobuf::EnumOrUnknown::new(super::AKODJPCIODF::AKODJPCIODF::AKODJPCIODF_BENEHIKHBJM);
        self.bool_val = false;
        self.float_val = 0.;
        self.str_val.clear();
...
impl ::protobuf::MessageFull for FloorCustomValueSnapshot {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("FloorCustomValueSnapshot").unwrap()).clone()
    }
}

impl ::std::fmt::Display for FloorCustomValueSnapshot {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for FloorCustomValueSnapshot {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1eFloorCustomValueSnapshot.proto\x1a\x11AKODJPCIODF.proto\"\xa1\x01\
    \n\x18FloorCustomValueSnapshot\x12\x12\n\x04name\x18\x01\x20\x01(\tR\x04\
    name\x12\x20\n\x04type\x18\x02\x20\x01(\x0e2\x0c.AKODJPCIODFR\x04type\
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::AKODJPCIODF::file_descriptor().clone());
