...
pub struct FloorCustomValueSnapshot {
    ...
    pub type_: ::protobuf::EnumOrUnknown<super::EIGNGIGPLKL::EIGNGIGPLKL>,
...
impl ::protobuf::Message for FloorCustomValueSnapshot {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.type_ != ::protobuf::EnumOrUnknown::new(super::EIGNGIGPLKL::EIGNGIGPLKL::Boolean) {
    ...
    fn clear(&mut self) {
        self.name.clear();
        self.type_ = ::protobuf::EnumOrUnknown::new(super::EIGNGIGPLKL::EIGNGIGPLKL::Boolean);
        self.bool_val = false;
        self.float_val = 0.;
        self.str_val.clear();
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1eFloorCustomValueSnapshot.proto\x1a\x11EIGNGIGPLKL.proto\"\xa1\x01\
    \n\x18FloorCustomValueSnapshot\x12\x12\n\x04name\x18\x01\x20\x01(\tR\x04\
    name\x12\x20\n\x04type\x18\x02\x20\x01(\x0e2\x0c.EIGNGIGPLKLR\x04type\
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::EIGNGIGPLKL::file_descriptor().clone());
