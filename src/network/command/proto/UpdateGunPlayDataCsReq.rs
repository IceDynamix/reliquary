...
pub struct UpdateGunPlayDataCsReq {
    // message fields
    // @@protoc_insertion_point(field:UpdateGunPlayDataCsReq.AOPPLPDBEHK)
    pub AOPPLPDBEHK: ::protobuf::MessageField<super::BPAGBAALHMP::BPAGBAALHMP>,
    // @@protoc_insertion_point(field:UpdateGunPlayDataCsReq.GIJOPFIAMIA)
    pub GIJOPFIAMIA: u32,
...
impl UpdateGunPlayDataCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::BPAGBAALHMP::BPAGBAALHMP>(
            "AOPPLPDBEHK",
            |m: &UpdateGunPlayDataCsReq| { &m.AOPPLPDBEHK },
            |m: &mut UpdateGunPlayDataCsReq| { &mut m.AOPPLPDBEHK },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "GIJOPFIAMIA",
            |m: &UpdateGunPlayDataCsReq| { &m.GIJOPFIAMIA },
            |m: &mut UpdateGunPlayDataCsReq| { &mut m.GIJOPFIAMIA },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "group_id",
...
impl ::protobuf::Message for UpdateGunPlayDataCsReq {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                104 => {
                    self.GIJOPFIAMIA = is.read_uint32()?;
                },
                112 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.GIJOPFIAMIA != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.GIJOPFIAMIA);
        }
        if self.group_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.GIJOPFIAMIA != 0 {
            os.write_uint32(13, self.GIJOPFIAMIA)?;
        }
        if self.group_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1cUpdateGunPlayDataCsReq.proto\x1a\x11BPAGBAALHMP.proto\"\x99\x01\n\
    \x16UpdateGunPlayDataCsReq\x12.\n\x0bAOPPLPDBEHK\x18\x01\x20\x01(\x0b2\
    \x0c.BPAGBAALHMPR\x0bAOPPLPDBEHK\x12\x20\n\x0bGIJOPFIAMIA\x18\r\x20\x01(\
    \rR\x0bGIJOPFIAMIA\x12\x19\n\x08group_id\x18\x0e\x20\x01(\rR\x07groupId\
    \x12\x12\n\x04uuid\x18\x0c\x20\x01(\x04R\x04uuidb\x06proto3\
";
