...
pub struct MultiPathAvatarInfo {
    ...
    // @@protoc_insertion_point(field:MultiPathAvatarInfo.DEADHPICKBO)
    pub DEADHPICKBO: u64,
...
impl MultiPathAvatarInfo {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "DEADHPICKBO",
            |m: &MultiPathAvatarInfo| { &m.DEADHPICKBO },
            |m: &mut MultiPathAvatarInfo| { &mut m.DEADHPICKBO },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "dressed_skin_id",
...
impl ::protobuf::Message for MultiPathAvatarInfo {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                64 => {
                    self.DEADHPICKBO = is.read_uint64()?;
                },
                24 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.avatar_id != ::protobuf::EnumOrUnknown::new(super::MultiPathAvatarType::MultiPathAvatarType::MultiPathAvatarTypeNone) {
            my_size += ::protobuf::rt::int32_size(4, self.avatar_id.value());
        }
        if self.rank != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.rank);
        }
        if self.path_equipment_id != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.path_equipment_id);
        }
        ...
        if self.DEADHPICKBO != 0 {
            my_size += ::protobuf::rt::uint64_size(8, self.DEADHPICKBO);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.avatar_id != ::protobuf::EnumOrUnknown::new(super::MultiPathAvatarType::MultiPathAvatarType::MultiPathAvatarTypeNone) {
            os.write_enum(4, ::protobuf::EnumOrUnknown::value(&self.avatar_id))?;
        }
        if self.rank != 0 {
            os.write_uint32(1, self.rank)?;
        }
        if self.path_equipment_id != 0 {
            os.write_uint32(15, self.path_equipment_id)?;
        }
        ...
        if self.DEADHPICKBO != 0 {
            os.write_uint64(8, self.DEADHPICKBO)?;
        }
        if self.dressed_skin_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    atarInfo\x125\n\x10equip_relic_list\x18\r\x20\x03(\x0b2\x0b.EquipRelicR\
    \x0eequipRelicList\x121\n\tavatar_id\x18\x04\x20\x01(\x0e2\x14.MultiPath\
    AvatarTypeR\x08avatarId\x12\x12\n\x04rank\x18\x01\x20\x01(\rR\x04rank\
    \x12*\n\x11path_equipment_id\x18\x0f\x20\x01(\rR\x0fpathEquipmentId\x12J\
    \n\x18multipath_skilltree_list\x18\x0e\x20\x03(\x0b2\x10.AvatarSkillTree\
    R\x16multipathSkilltreeList\x12+\n\x11skilltree_version\x18\n\x20\x01(\r\
    R\x10skilltreeVersion\x12\x20\n\x0bDEADHPICKBO\x18\x08\x20\x01(\x04R\x0b\
    DEADHPICKBO\x12&\n\x0fdressed_skin_id\x18\x03\x20\x01(\rR\rdressedSkinId\
    b\x06proto3\
";
