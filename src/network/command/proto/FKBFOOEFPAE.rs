...
impl ::protobuf::Message for FKBFOOEFPAE {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.INFBHPGDLND != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.INFBHPGDLND);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.INFBHPGDLND != 0 {
            os.write_uint32(13, self.INFBHPGDLND)?;
        }
        if self.status != ::protobuf::EnumOrUnknown::new(super::RogueCollectionStatus::RogueCollectionStatus::ROGUE_COLLECTION_NONE) {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    OEFPAE\x12\x20\n\x0bINFBHPGDLND\x18\r\x20\x01(\rR\x0bINFBHPGDLND\x12.\n\
    \x06status\x18\x06\x20\x01(\x0e2\x16.RogueCollectionStatusR\x06statusb\
    \x06proto3\
";
