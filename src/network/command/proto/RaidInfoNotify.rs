...
impl ::protobuf::Message for RaidInfoNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.raid_finish_time != 0 {
            my_size += ::protobuf::rt::uint64_size(1, self.raid_finish_time);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.raid_finish_time != 0 {
            os.write_uint64(1, self.raid_finish_time)?;
        }
        if self.world_level != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    d_finish_time\x18\x01\x20\x01(\x04R\x0eraidFinishTime\x12\x1f\n\x0bworld\
    _level\x18\x07\x20\x01(\rR\nworldLevel\x129\n\x10raid_target_info\x18\
    \x08\x20\x03(\x0b2\x0f.RaidTargetInfoR\x0eraidTargetInfo\x12#\n\x06statu\
    s\x18\x0b\x20\x01(\x0e2\x0b.RaidStatusR\x06status\x12\x17\n\x07raid_id\
    \x18\r\x20\x01(\rR\x06raidId\x12&\n\titem_list\x18\x0f\x20\x01(\x0b2\t.I\
    temListR\x08itemListb\x06proto3\
";
