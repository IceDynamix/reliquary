...
impl ::protobuf::Message for RaidInfoNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.raid_finish_time != 0 {
            my_size += ::protobuf::rt::uint64_size(9, self.raid_finish_time);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.raid_finish_time != 0 {
            os.write_uint64(9, self.raid_finish_time)?;
        }
        if self.world_level != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    list\x18\x01\x20\x01(\x0b2\t.ItemListR\x08itemList\x129\n\x10raid_target\
    _info\x18\x0b\x20\x03(\x0b2\x0f.RaidTargetInfoR\x0eraidTargetInfo\x12(\n\
    \x10raid_finish_time\x18\t\x20\x01(\x04R\x0eraidFinishTime\x12\x1f\n\x0b\
    world_level\x18\x02\x20\x01(\rR\nworldLevel\x12\x17\n\x07raid_id\x18\x05\
    \x20\x01(\rR\x06raidId\x12#\n\x06status\x18\x0c\x20\x01(\x0e2\x0b.RaidSt\
    atusR\x06statusb\x06proto3\
";
