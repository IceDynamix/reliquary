...
//! Generated file from `ALBLEFHHJIC.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:ALBLEFHHJIC)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct ALBLEFHHJIC {
    // message fields
    ...
    pub id: u32,
    // special fields
    // @@protoc_insertion_point(special_field:ALBLEFHHJIC.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a ALBLEFHHJIC {
    fn default() -> &'a ALBLEFHHJIC {
        <ALBLEFHHJIC as ::protobuf::Message>::default_instance()
    }
}

impl ALBLEFHHJIC {
    pub fn new() -> ALBLEFHHJIC {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "id",
            |m: &ALBLEFHHJIC| { &m.id },
            |m: &mut ALBLEFHHJIC| { &mut m.id },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<ALBLEFHHJIC>(
            "ALBLEFHHJIC",
            fields,
            oneofs,
        )
...
impl ::protobuf::Message for ALBLEFHHJIC {
    const NAME: &'static str = "ALBLEFHHJIC";
...
impl ::protobuf::MessageFull for ALBLEFHHJIC {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("ALBLEFHHJIC").unwrap()).clone()
    }
}

impl ::std::fmt::Display for ALBLEFHHJIC {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for ALBLEFHHJIC {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(ALBLEFHHJIC::generated_message_descriptor_data());
