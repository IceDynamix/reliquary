...
//! Generated file from `POBLGKIGINE.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:POBLGKIGINE)
...
pub struct POBLGKIGINE {
    ...
    // special fields
    // @@protoc_insertion_point(special_field:POBLGKIGINE.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a POBLGKIGINE {
    fn default() -> &'a POBLGKIGINE {
        <POBLGKIGINE as ::protobuf::Message>::default_instance()
    }
}

impl POBLGKIGINE {
    pub fn new() -> POBLGKIGINE {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::PBMDEBCGNMD::PBMDEBCGNMD>(
            "LNMGOFCOMED",
            |m: &POBLGKIGINE| { &m.LNMGOFCOMED },
            |m: &mut POBLGKIGINE| { &mut m.LNMGOFCOMED },
        ));
...
impl ::protobuf::Message for POBLGKIGINE {
    const NAME: &'static str = "POBLGKIGINE";
...
impl ::protobuf::MessageFull for POBLGKIGINE {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("POBLGKIGINE").unwrap()).clone()
    }
}

impl ::std::fmt::Display for POBLGKIGINE {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for POBLGKIGINE {
