...
impl ::protobuf::Message for BKBILPDKOIL {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.LHJPKMDMNMP != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.LHJPKMDMNMP);
        }
        if self.CABEHKOFLPG != false {
            my_size += 1 + 1;
        }
        if self.HPJJDCJHHOA != 0 {
            my_size += ::protobuf::rt::uint64_size(15, self.HPJJDCJHHOA);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.LHJPKMDMNMP != 0 {
            os.write_uint32(12, self.LHJPKMDMNMP)?;
        }
        if self.CABEHKOFLPG != false {
            os.write_bool(5, self.CABEHKOFLPG)?;
        }
        if self.HPJJDCJHHOA != 0 {
            os.write_uint64(15, self.HPJJDCJHHOA)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x06\x20\x01(\x03R\x04time\x12\x20\n\x0bJPACOBGBDBG\x18\x03\x20\x03(\rR\
    \x0bJPACOBGBDBG\x12\x20\n\x0bLHJPKMDMNMP\x18\x0c\x20\x01(\rR\x0bLHJPKMDM\
    NMP\x12\x20\n\x0bCABEHKOFLPG\x18\x05\x20\x01(\x08R\x0bCABEHKOFLPG\x12\
    \x20\n\x0bHPJJDCJHHOA\x18\x0f\x20\x01(\x04R\x0bHPJJDCJHHOAb\x06proto3\
";
