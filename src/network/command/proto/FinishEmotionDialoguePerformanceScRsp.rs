...
impl ::protobuf::Message for FinishEmotionDialoguePerformanceScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.dialogue_id != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.dialogue_id);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.dialogue_id != 0 {
            os.write_uint32(15, self.dialogue_id)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x0e\x20\x01(\x0b2\t.ItemListR\nrewardList\x12\x1b\n\tscript_id\x18\
    \x07\x20\x01(\rR\x08scriptId\x12\x1f\n\x0bdialogue_id\x18\x0f\x20\x01(\r\
