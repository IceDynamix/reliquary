...
impl ::protobuf::Message for SetPlayerInfoCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.gender != ::protobuf::EnumOrUnknown::new(super::Gender::Gender::GenderNone) {
            my_size += ::protobuf::rt::int32_size(2, self.gender.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.gender != ::protobuf::EnumOrUnknown::new(super::Gender::Gender::GenderNone) {
            os.write_enum(2, ::protobuf::EnumOrUnknown::value(&self.gender))?;
        }
        if !self.nickname.is_empty() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    CsReq\x12\x1b\n\tis_modify\x18\x07\x20\x01(\x08R\x08isModify\x12\x1f\n\
    \x06gender\x18\x02\x20\x01(\x0e2\x07.GenderR\x06gender\x12\x1a\n\x08nick\
    name\x18\x05\x20\x01(\tR\x08nicknameb\x06proto3\
";
