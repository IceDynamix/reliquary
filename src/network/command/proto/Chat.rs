...
pub struct Chat {
    ...
    pub emote: u32,
    // @@protoc_insertion_point(field:Chat.HNBEPABNBNG)
...
impl Chat {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::PEDLPHDBNAF::PEDLPHDBNAF>(
            "HNBEPABNBNG",
            |m: &Chat| { &m.HNBEPABNBNG },
            |m: &mut Chat| { &mut m.HNBEPABNBNG },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "sent_time",
            |m: &Chat| { &m.sent_time },
...
impl ::protobuf::Message for Chat {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.sent_time != 0 {
            my_size += ::protobuf::rt::uint64_size(14, self.sent_time);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.sent_time != 0 {
            os.write_uint64(14, self.sent_time)?;
        }
        if self.msg_type != ::protobuf::EnumOrUnknown::new(super::MsgType::MsgType::MSG_TYPE_NONE) {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\nChat.proto\x1a\rMsgType.proto\x1a\x11PEDLPHDBNAF.proto\"\xc1\x01\n\
    \x04Chat\x12\x1d\n\nsender_uid\x18\x05\x20\x01(\rR\tsenderUid\x12\x12\n\
    \x04text\x18\x0f\x20\x01(\tR\x04text\x12\x14\n\x05emote\x18\x08\x20\x01(\
    \rR\x05emote\x12.\n\x0bHNBEPABNBNG\x18\x0c\x20\x01(\x0b2\x0c.PEDLPHDBNAF\
    R\x0bHNBEPABNBNG\x12\x1b\n\tsent_time\x18\x0e\x20\x01(\x04R\x08sentTime\
    \x12#\n\x08msg_type\x18\n\x20\x01(\x0e2\x08.MsgTypeR\x07msgTypeb\x06prot\
    o3\
";
