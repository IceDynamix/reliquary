...
impl ::protobuf::Message for Avatar {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.first_met_timestamp != 0 {
            my_size += ::protobuf::rt::uint64_size(15, self.first_met_timestamp);
        }
        if self.exp != 0 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(12, &self.taken_rewards);
        if self.promotion != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.first_met_timestamp != 0 {
            os.write_uint64(15, self.first_met_timestamp)?;
        }
        if self.exp != 0 {
        ...
        os.write_repeated_packed_uint32(12, &self.taken_rewards)?;
        if self.promotion != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \"\xcf\x03\n\x06Avatar\x12\x1b\n\tis_marked\x18\x03\x20\x01(\x08R\x08isM\
    arked\x12$\n\x0ebase_avatar_id\x18\x08\x20\x01(\rR\x0cbaseAvatarId\x12\
    \x14\n\x05level\x18\n\x20\x01(\rR\x05level\x12D\n\x15avatar_skilltree_li\
    st\x18\x02\x20\x03(\x0b2\x10.AvatarSkillTreeR\x13avatarSkilltreeList\x12\
    &\n\x0fdressed_skin_id\x18\x0b\x20\x01(\rR\rdressedSkinId\x125\n\x10equi\
    p_relic_list\x18\x06\x20\x03(\x0b2\x0b.EquipRelicR\x0eequipRelicList\x12\
    .\n\x13equipment_unique_id\x18\r\x20\x01(\rR\x11equipmentUniqueId\x12.\n\
    \x13first_met_timestamp\x18\x0f\x20\x01(\x04R\x11firstMetTimestamp\x12\
    \x10\n\x03exp\x18\x05\x20\x01(\rR\x03exp\x12\x12\n\x04rank\x18\x07\x20\
    \x01(\rR\x04rank\x12#\n\rtaken_rewards\x18\x0c\x20\x03(\rR\x0ctakenRewar\
    ds\x12\x1c\n\tpromotion\x18\x01\x20\x01(\rR\tpromotionb\x06proto3\
";
