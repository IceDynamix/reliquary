...
//! Generated file from `GIJLACBOPEE.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:GIJLACBOPEE)
...
impl<'a> ::std::default::Default for &'a GIJLACBOPEE {
    fn default() -> &'a GIJLACBOPEE {
        <GIJLACBOPEE as ::protobuf::Message>::default_instance()
    }
}

impl GIJLACBOPEE {
    pub fn new() -> GIJLACBOPEE {
...
impl ::protobuf::Message for GIJLACBOPEE {
    const NAME: &'static str = "GIJLACBOPEE";
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.HJMEJNMAILK != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.HJMEJNMAILK);
        }
        if self.level != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.HJMEJNMAILK != 0 {
            os.write_uint32(1, self.HJMEJNMAILK)?;
        }
        if self.level != 0 {
...
impl ::protobuf::MessageFull for GIJLACBOPEE {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("GIJLACBOPEE").unwrap()).clone()
    }
}

impl ::std::fmt::Display for GIJLACBOPEE {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for GIJLACBOPEE {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x11GIJLACBOPEE.proto\"l\n\x0bGIJLACBOPEE\x12%\n\x0equeue_position\x18\
    \x04\x20\x01(\rR\rqueuePosition\x12\x20\n\x0bHJMEJNMAILK\x18\x01\x20\x01\
    (\rR\x0bHJMEJNMAILK\x12\x14\n\x05level\x18\x0c\x20\x01(\rR\x05levelb\x06\
    proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(GIJLACBOPEE::generated_message_descriptor_data());
