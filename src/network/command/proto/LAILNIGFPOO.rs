...
impl ::protobuf::Message for LAILNIGFPOO {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.KHGPFHBOELE != 0 {
            my_size += ::protobuf::rt::uint64_size(9, self.KHGPFHBOELE);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.KHGPFHBOELE != 0 {
            os.write_uint64(9, self.KHGPFHBOELE)?;
        }
        if self.is_taken_reward != false {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \t\x20\x01(\x04R\x0bKHGPFHBOELE\x12&\n\x0fis_taken_reward\x18\x01\x20\
    \x01(\x08R\risTakenReward\x12\x20\n\x0bAELPFEBGNOK\x18\x05\x20\x01(\x08R\
    \x0bAELPFEBGNOKb\x06proto3\
";
