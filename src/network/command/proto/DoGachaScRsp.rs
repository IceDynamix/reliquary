...
impl ::protobuf::Message for DoGachaScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.NOPBEBKHIKA != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.NOPBEBKHIKA);
        }
        if self.retcode != 0 {
        ...
        if self.GDIFAAHIFBH != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.GDIFAAHIFBH);
        }
        if self.ceiling_num != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.ceiling_num);
        }
        if self.gacha_id != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.gacha_id);
        }
        if self.KMNJNMJFGBG != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.KMNJNMJFGBG);
        }
        if self.PENILHGLHHM != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.PENILHGLHHM);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.NOPBEBKHIKA != 0 {
            os.write_uint32(10, self.NOPBEBKHIKA)?;
        }
        if self.retcode != 0 {
        ...
        if self.GDIFAAHIFBH != 0 {
            os.write_uint32(13, self.GDIFAAHIFBH)?;
        }
        if self.ceiling_num != 0 {
            os.write_uint32(14, self.ceiling_num)?;
        }
        if self.gacha_id != 0 {
            os.write_uint32(5, self.gacha_id)?;
        }
        if self.KMNJNMJFGBG != 0 {
            os.write_uint32(6, self.KMNJNMJFGBG)?;
        }
        if self.PENILHGLHHM != 0 {
            os.write_uint32(1, self.PENILHGLHHM)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    Rsp\x12\x20\n\x0bNOPBEBKHIKA\x18\n\x20\x01(\rR\x0bNOPBEBKHIKA\x12\x18\n\
    \x07retcode\x18\x0c\x20\x01(\rR\x07retcode\x12\x1b\n\tgacha_num\x18\x0b\
    \x20\x01(\rR\x08gachaNum\x12\x20\n\x0bGDIFAAHIFBH\x18\r\x20\x01(\rR\x0bG\
    DIFAAHIFBH\x12\x1f\n\x0bceiling_num\x18\x0e\x20\x01(\rR\nceilingNum\x12\
    \x19\n\x08gacha_id\x18\x05\x20\x01(\rR\x07gachaId\x12\x20\n\x0bKMNJNMJFG\
    BG\x18\x06\x20\x01(\rR\x0bKMNJNMJFGBG\x12\x20\n\x0bPENILHGLHHM\x18\x01\
    \x20\x01(\rR\x0bPENILHGLHHM\x122\n\x0fgacha_item_list\x18\x08\x20\x03(\
