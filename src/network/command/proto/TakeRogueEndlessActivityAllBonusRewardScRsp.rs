...
impl ::protobuf::Message for TakeRogueEndlessActivityAllBonusRewardScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.CHIAFOOAIBK != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.CHIAFOOAIBK);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.CHIAFOOAIBK != 0 {
            os.write_uint32(10, self.CHIAFOOAIBK)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    IEPPNGMCKJH\x18\x06\x20\x03(\rR\x0bIEPPNGMCKJH\x12!\n\x06reward\x18\x01\
    \x20\x01(\x0b2\t.ItemListR\x06reward\x12\x20\n\x0bCHIAFOOAIBK\x18\n\x20\
    \x01(\rR\x0bCHIAFOOAIBK\x12\x18\n\x07retcode\x18\x03\x20\x01(\rR\x07retc\
    odeb\x06proto3\
";
