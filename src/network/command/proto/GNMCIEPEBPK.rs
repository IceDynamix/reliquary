...
//! Generated file from `GNMCIEPEBPK.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:GNMCIEPEBPK)
...
impl<'a> ::std::default::Default for &'a GNMCIEPEBPK {
    fn default() -> &'a GNMCIEPEBPK {
        <GNMCIEPEBPK as ::protobuf::Message>::default_instance()
    }
}

impl GNMCIEPEBPK {
    pub fn new() -> GNMCIEPEBPK {
...
impl ::protobuf::Message for GNMCIEPEBPK {
    const NAME: &'static str = "GNMCIEPEBPK";
    ...
    fn default_instance() -> &'static GNMCIEPEBPK {
        static instance: ::protobuf::rt::Lazy<GNMCIEPEBPK> = ::protobuf::rt::Lazy::new();
        instance.get(GNMCIEPEBPK::new)
    }
}

impl ::protobuf::MessageFull for GNMCIEPEBPK {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("GNMCIEPEBPK").unwrap()).clone()
    }
}

impl ::std::fmt::Display for GNMCIEPEBPK {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for GNMCIEPEBPK {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(GNMCIEPEBPK::generated_message_descriptor_data());
