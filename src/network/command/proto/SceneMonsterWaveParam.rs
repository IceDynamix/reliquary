...
impl ::protobuf::Message for SceneMonsterWaveParam {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.DNEAMPLLFME != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.DNEAMPLLFME);
        }
        if self.level != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.DNEAMPLLFME != 0 {
            os.write_uint32(7, self.DNEAMPLLFME)?;
        }
        if self.level != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12\x20\n\x0bDNEAMPLLFME\x18\x07\x20\x01(\rR\x0bDNEAMPLLFME\x12\x14\n\
    \x05level\x18\x0f\x20\x01(\rR\x05level\x12(\n\x10hard_level_group\x18\t\
    \x20\x01(\rR\x0ehardLevelGroup\x12\x1f\n\x0belite_group\x18\x0e\x20\x01(\
