...
pub struct EnterSummonActivityStageCsReq {
    ...
    pub avatar_list: ::std::vec::Vec<super::KALABBKKFNM::KALABBKKFNM>,
    // @@protoc_insertion_point(field:EnterSummonActivityStageCsReq.HGKIGGEHNLF)
    pub HGKIGGEHNLF: ::protobuf::MessageField<super::KALABBKKFNM::KALABBKKFNM>,
    // @@protoc_insertion_point(field:EnterSummonActivityStageCsReq.group_id)
    pub group_id: u32,
    // @@protoc_insertion_point(field:EnterSummonActivityStageCsReq.AKFJLNPHODD)
    pub AKFJLNPHODD: u32,
    // special fields
...
impl EnterSummonActivityStageCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::KALABBKKFNM::KALABBKKFNM>(
            "HGKIGGEHNLF",
            |m: &EnterSummonActivityStageCsReq| { &m.HGKIGGEHNLF },
            |m: &mut EnterSummonActivityStageCsReq| { &mut m.HGKIGGEHNLF },
        ));
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "AKFJLNPHODD",
            |m: &EnterSummonActivityStageCsReq| { &m.AKFJLNPHODD },
            |m: &mut EnterSummonActivityStageCsReq| { &mut m.AKFJLNPHODD },
        ));
...
impl ::protobuf::Message for EnterSummonActivityStageCsReq {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                90 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.HGKIGGEHNLF)?;
                },
                112 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let Some(v) = self.HGKIGGEHNLF.as_ref() {
        ...
        if self.AKFJLNPHODD != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.AKFJLNPHODD);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.AKFJLNPHODD != 0 {
            os.write_uint32(12, self.AKFJLNPHODD)?;
        }
    ...
    fn default_instance() -> &'static EnterSummonActivityStageCsReq {
        static instance: EnterSummonActivityStageCsReq = EnterSummonActivityStageCsReq {
            ...
            HGKIGGEHNLF: ::protobuf::MessageField::none(),
            group_id: 0,
            AKFJLNPHODD: 0,
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n#EnterSummonActivityStageCsReq.proto\x1a\x11KALABBKKFNM.proto\"\xbb\
    \x01\n\x1dEnterSummonActivityStageCsReq\x12-\n\x0bavatar_list\x18\x02\
    \x20\x03(\x0b2\x0c.KALABBKKFNMR\navatarList\x12.\n\x0bHGKIGGEHNLF\x18\
    \x0b\x20\x01(\x0b2\x0c.KALABBKKFNMR\x0bHGKIGGEHNLF\x12\x19\n\x08group_id\
    \x18\x0e\x20\x01(\rR\x07groupId\x12\x20\n\x0bAKFJLNPHODD\x18\x0c\x20\x01\
    (\rR\x0bAKFJLNPHODDb\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::KALABBKKFNM::file_descriptor().clone());
