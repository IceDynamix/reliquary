...
pub struct EnterSummonActivityStageCsReq {
    // message fields
    // @@protoc_insertion_point(field:EnterSummonActivityStageCsReq.difficulty_level)
    pub difficulty_level: u32,
    // @@protoc_insertion_point(field:EnterSummonActivityStageCsReq.avatar_list)
    pub avatar_list: ::std::vec::Vec<super::SummonActivityAvatar::SummonActivityAvatar>,
    // @@protoc_insertion_point(field:EnterSummonActivityStageCsReq.CAEJNNLBEAH)
    pub CAEJNNLBEAH: ::protobuf::MessageField<super::SummonActivityAvatar::SummonActivityAvatar>,
...
impl EnterSummonActivityStageCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "difficulty_level",
            |m: &EnterSummonActivityStageCsReq| { &m.difficulty_level },
            |m: &mut EnterSummonActivityStageCsReq| { &mut m.difficulty_level },
        ));
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::SummonActivityAvatar::SummonActivityAvatar>(
            "CAEJNNLBEAH",
            |m: &EnterSummonActivityStageCsReq| { &m.CAEJNNLBEAH },
            |m: &mut EnterSummonActivityStageCsReq| { &mut m.CAEJNNLBEAH },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "group_id",
...
impl ::protobuf::Message for EnterSummonActivityStageCsReq {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                106 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.CAEJNNLBEAH)?;
                },
                112 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let Some(v) = self.CAEJNNLBEAH.as_ref() {
    ...
    fn default_instance() -> &'static EnterSummonActivityStageCsReq {
        static instance: EnterSummonActivityStageCsReq = EnterSummonActivityStageCsReq {
            ...
            CAEJNNLBEAH: ::protobuf::MessageField::none(),
            group_id: 0,
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n#EnterSummonActivityStageCsReq.proto\x1a\x1aSummonActivityAvatar.proto\
    \"\xd6\x01\n\x1dEnterSummonActivityStageCsReq\x12)\n\x10difficulty_level\
    \x18\x07\x20\x01(\rR\x0fdifficultyLevel\x126\n\x0bavatar_list\x18\n\x20\
    \x03(\x0b2\x15.SummonActivityAvatarR\navatarList\x127\n\x0bCAEJNNLBEAH\
    \x18\r\x20\x01(\x0b2\x15.SummonActivityAvatarR\x0bCAEJNNLBEAH\x12\x19\n\
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::SummonActivityAvatar::file_descriptor().clone());
