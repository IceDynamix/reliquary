...
pub struct BattleOp {
    ...
    // @@protoc_insertion_point(field:BattleOp.NFNPNHKIBAB)
    pub NFNPNHKIBAB: ::std::string::String,
    // special fields
...
impl BattleOp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "NFNPNHKIBAB",
            |m: &BattleOp| { &m.NFNPNHKIBAB },
            |m: &mut BattleOp| { &mut m.NFNPNHKIBAB },
        ));
...
impl ::protobuf::Message for BattleOp {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                66 => {
                    self.NFNPNHKIBAB = is.read_string()?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.NFNPNHKIBAB.is_empty() {
            my_size += ::protobuf::rt::string_size(8, &self.NFNPNHKIBAB);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.NFNPNHKIBAB.is_empty() {
            os.write_string(8, &self.NFNPNHKIBAB)?;
        }
    ...
    fn default_instance() -> &'static BattleOp {
        static instance: BattleOp = BattleOp {
            ...
            skill_index: 0,
            operation_counter: 0,
            NFNPNHKIBAB: ::std::string::String::new(),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x01(\rR\x10operationCounter\x12\x20\n\x0bNFNPNHKIBAB\x18\x08\x20\x01(\t\
    R\x0bNFNPNHKIBABb\x06proto3\
";
