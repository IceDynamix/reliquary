...
pub struct PlayerSimpleInfo {
    // message fields
    // @@protoc_insertion_point(field:PlayerSimpleInfo.assist_simple_info)
...
impl PlayerSimpleInfo {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "assist_simple_info",
            |m: &PlayerSimpleInfo| { &m.assist_simple_info },
            |m: &mut PlayerSimpleInfo| { &mut m.assist_simple_info },
        ));
...
impl ::protobuf::Message for PlayerSimpleInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.chat_bubble_id != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.chat_bubble_id);
        }
        ...
        if !self.AKCEJFCFBAN.is_empty() {
            my_size += ::protobuf::rt::string_size(14, &self.AKCEJFCFBAN);
        }
        if self.ANPLLAOBFJI != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.ANPLLAOBFJI);
        }
        if self.head_icon != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.chat_bubble_id != 0 {
            os.write_uint32(3, self.chat_bubble_id)?;
        }
        if !self.nickname.is_empty() {
        ...
        if !self.AKCEJFCFBAN.is_empty() {
            os.write_string(14, &self.AKCEJFCFBAN)?;
        }
        if self.ANPLLAOBFJI != 0 {
            os.write_uint32(1, self.ANPLLAOBFJI)?;
        }
        if self.head_icon != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    OnlineStatus.proto\x1a\x12PlatformType.proto\"\x8a\x04\n\x10PlayerSimple\
    Info\x12?\n\x12assist_simple_info\x18\x0f\x20\x03(\x0b2\x11.AssistSimple\
    InfoR\x10assistSimpleInfo\x12)\n\x08platform\x18\x0b\x20\x01(\x0e2\r.Pla\
    tformTypeR\x08platform\x12(\n\x10last_active_time\x18\x0c\x20\x01(\x03R\
    \x0elastActiveTime\x12\x14\n\x05level\x18\x07\x20\x01(\rR\x05level\x12\
    \x10\n\x03uid\x18\t\x20\x01(\rR\x03uid\x12\x1c\n\tsignature\x18\x08\x20\
    \x01(\tR\tsignature\x128\n\ronline_status\x18\x06\x20\x01(\x0e2\x13.Frie\
    ndOnlineStatusR\x0conlineStatus\x12$\n\x0echat_bubble_id\x18\x03\x20\x01\
    (\rR\x0cchatBubbleId\x12\x1a\n\x08nickname\x18\x02\x20\x01(\tR\x08nickna\
    me\x12\x1b\n\tis_banned\x18\x05\x20\x01(\x08R\x08isBanned\x12\x20\n\x0bG\
    MALCPNOHBF\x18\x04\x20\x01(\tR\x0bGMALCPNOHBF\x12\x20\n\x0bAKCEJFCFBAN\
    \x18\x0e\x20\x01(\tR\x0bAKCEJFCFBAN\x12\x20\n\x0bANPLLAOBFJI\x18\x01\x20\
    \x01(\rR\x0bANPLLAOBFJI\x12\x1b\n\thead_icon\x18\r\x20\x01(\rR\x08headIc\
    onb\x06proto3\
";
