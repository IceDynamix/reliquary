...
pub struct PlayerSimpleInfo {
    ...
    // @@protoc_insertion_point(field:PlayerSimpleInfo.platform_type)
...
impl PlayerSimpleInfo {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "platform_type",
            |m: &PlayerSimpleInfo| { &m.platform_type },
            |m: &mut PlayerSimpleInfo| { &mut m.platform_type },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "ANPLLAOBFJI",
...
impl ::protobuf::Message for PlayerSimpleInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.GMALCPNOHBF.is_empty() {
            my_size += ::protobuf::rt::string_size(2, &self.GMALCPNOHBF);
        }
        if self.chat_bubble_id != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.chat_bubble_id);
        }
        if self.head_icon != 0 {
        ...
        if self.ANPLLAOBFJI != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.ANPLLAOBFJI);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if !self.GMALCPNOHBF.is_empty() {
            os.write_string(2, &self.GMALCPNOHBF)?;
        }
        if self.chat_bubble_id != 0 {
            os.write_uint32(11, self.chat_bubble_id)?;
        }
        if self.head_icon != 0 {
        ...
        if self.ANPLLAOBFJI != 0 {
            os.write_uint32(10, self.ANPLLAOBFJI)?;
        }
        if self.last_active_time != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    Info\x12\x20\n\x0bGMALCPNOHBF\x18\x02\x20\x01(\tR\x0bGMALCPNOHBF\x12$\n\
    \x0echat_bubble_id\x18\x0b\x20\x01(\rR\x0cchatBubbleId\x12\x1b\n\thead_i\
    con\x18\x0f\x20\x01(\rR\x08headIcon\x12\x1a\n\x08nickname\x18\x04\x20\
    \x01(\tR\x08nickname\x12?\n\x12assist_simple_info\x18\x05\x20\x03(\x0b2\
    \x11.AssistSimpleInfoR\x10assistSimpleInfo\x122\n\rplatform_type\x18\t\
    \x20\x01(\x0e2\r.PlatformTypeR\x0cplatformType\x12\x20\n\x0bANPLLAOBFJI\
    \x18\n\x20\x01(\rR\x0bANPLLAOBFJI\x12(\n\x10last_active_time\x18\x08\x20\
    \x01(\x03R\x0elastActiveTime\x12\x20\n\x0bAKCEJFCFBAN\x18\x06\x20\x01(\t\
    R\x0bAKCEJFCFBAN\x128\n\ronline_status\x18\x03\x20\x01(\x0e2\x13.FriendO\
    nlineStatusR\x0conlineStatus\x12\x1b\n\tis_banned\x18\r\x20\x01(\x08R\
    \x08isBanned\x12\x1c\n\tsignature\x18\x0c\x20\x01(\tR\tsignature\x12\x14\
