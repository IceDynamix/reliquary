...
pub struct QuitLineupScRsp {
    ...
    // @@protoc_insertion_point(field:QuitLineupScRsp.BBIPFIBLDFL)
    pub BBIPFIBLDFL: bool,
    // special fields
...
impl QuitLineupScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "BBIPFIBLDFL",
            |m: &QuitLineupScRsp| { &m.BBIPFIBLDFL },
            |m: &mut QuitLineupScRsp| { &mut m.BBIPFIBLDFL },
        ));
...
impl ::protobuf::Message for QuitLineupScRsp {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.BBIPFIBLDFL != false {
            os.write_bool(8, self.BBIPFIBLDFL)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x15QuitLineupScRsp.proto\"\xad\x01\n\x0fQuitLineupScRsp\x12\x19\n\x08\
    plane_id\x18\x03\x20\x01(\rR\x07planeId\x12\x1d\n\nis_virtual\x18\x02\
    \x20\x01(\x08R\tisVirtual\x12\x18\n\x07retcode\x18\x06\x20\x01(\rR\x07re\
    tcode\x12$\n\x0ebase_avatar_id\x18\r\x20\x01(\rR\x0cbaseAvatarId\x12\x20\
    \n\x0bBBIPFIBLDFL\x18\x08\x20\x01(\x08R\x0bBBIPFIBLDFLb\x06proto3\
";
