...
impl ::protobuf::Message for StrongChallengeActivityBattleEndScNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.GGBECCHPHCD != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.GGBECCHPHCD);
        }
        if self.max_score != 0 {
        ...
        if self.JAMLOKNCAKC != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.JAMLOKNCAKC);
        }
        if self.total_damage != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.total_damage);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.GGBECCHPHCD != 0 {
            os.write_uint32(4, self.GGBECCHPHCD)?;
        }
        if self.max_score != 0 {
        ...
        if self.JAMLOKNCAKC != 0 {
            os.write_uint32(11, self.JAMLOKNCAKC)?;
        }
        if self.total_damage != 0 {
            os.write_uint32(8, self.total_damage)?;
        }
        if self.end_status != ::protobuf::EnumOrUnknown::new(super::BattleEndStatus::BattleEndStatus::BATTLE_END_NONE) {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0bGGBECCHPHCD\x18\x04\x20\x01(\rR\x0bGGBECCHPHCD\x12\x1b\n\tmax_score\
    \x18\x02\x20\x01(\rR\x08maxScore\x12\x19\n\x08score_id\x18\t\x20\x01(\rR\
    \x07scoreId\x12\x20\n\x0bAHJFPNGDBDO\x18\x0e\x20\x01(\rR\x0bAHJFPNGDBDO\
    \x12\x20\n\x0bJAMLOKNCAKC\x18\x0b\x20\x01(\rR\x0bJAMLOKNCAKC\x12!\n\x0ct\
    otal_damage\x18\x08\x20\x01(\rR\x0btotalDamage\x12/\n\nend_status\x18\
    \x03\x20\x01(\x0e2\x10.BattleEndStatusR\tendStatus\x12\x19\n\x08stage_id\
    \x18\r\x20\x01(\rR\x07stageIdb\x06proto3\
";
