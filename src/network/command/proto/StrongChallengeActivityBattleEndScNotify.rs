...
impl ::protobuf::Message for StrongChallengeActivityBattleEndScNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.AHJFPNGDBDO != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.AHJFPNGDBDO);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.AHJFPNGDBDO != 0 {
            os.write_uint32(12, self.AHJFPNGDBDO)?;
        }
        if self.end_status != ::protobuf::EnumOrUnknown::new(super::BattleEndStatus::BattleEndStatus::BATTLE_END_NONE) {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0c\x20\x01(\rR\x0bAHJFPNGDBDO\x12/\n\nend_status\x18\t\x20\x01(\x0e2\
    \x10.BattleEndStatusR\tendStatus\x12\x20\n\x0bJAMLOKNCAKC\x18\x01\x20\
    \x01(\rR\x0bJAMLOKNCAKC\x12\x1b\n\tmax_score\x18\x07\x20\x01(\rR\x08maxS\
    core\x12\x19\n\x08score_id\x18\x06\x20\x01(\rR\x07scoreId\x12!\n\x0ctota\
    l_damage\x18\x04\x20\x01(\rR\x0btotalDamage\x12\x20\n\x0bGGBECCHPHCD\x18\
    \x0f\x20\x01(\rR\x0bGGBECCHPHCDb\x06proto3\
";
