...
//! Generated file from `CGBPOHBACGE.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:CGBPOHBACGE)
...
impl<'a> ::std::default::Default for &'a CGBPOHBACGE {
    fn default() -> &'a CGBPOHBACGE {
        <CGBPOHBACGE as ::protobuf::Message>::default_instance()
    }
}

impl CGBPOHBACGE {
    pub fn new() -> CGBPOHBACGE {
...
impl ::protobuf::Message for CGBPOHBACGE {
    const NAME: &'static str = "CGBPOHBACGE";
...
impl ::protobuf::MessageFull for CGBPOHBACGE {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("CGBPOHBACGE").unwrap()).clone()
    }
}

impl ::std::fmt::Display for CGBPOHBACGE {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for CGBPOHBACGE {
