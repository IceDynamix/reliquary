...
impl ::protobuf::Message for ChallengeBossPhaseSettleNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.challenge_score != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.challenge_score);
        }
        if self.star != 0 {
        ...
        if self.page_type != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.page_type);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.is_second_half != false {
            os.write_bool(1, self.is_second_half)?;
        }
        for v in &self.battle_target_list {
            ::protobuf::rt::write_message_field_with_cached_size(2, v, os)?;
        };
        if self.challenge_score != 0 {
            os.write_uint32(11, self.challenge_score)?;
        }
        if self.star != 0 {
        ...
        if self.is_reward != false {
            os.write_bool(3, self.is_reward)?;
        }
        if self.challenge_id != 0 {
            os.write_uint32(14, self.challenge_id)?;
        }
        if self.page_type != 0 {
            os.write_uint32(4, self.page_type)?;
        }
        if self.is_win != false {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x02\n\x1eChallengeBossPhaseSettleNotify\x12$\n\x0eis_second_half\x18\
    \x01\x20\x01(\x08R\x0cisSecondHalf\x12;\n\x12battle_target_list\x18\x02\
    \x20\x03(\x0b2\r.BattleTargetR\x10battleTargetList\x12'\n\x0fchallenge_s\
    core\x18\x0b\x20\x01(\rR\x0echallengeScore\x12\x12\n\x04star\x18\x06\x20\
    \x01(\rR\x04star\x12\x14\n\x05phase\x18\r\x20\x01(\rR\x05phase\x12\x1b\n\
    \tscore_two\x18\x0f\x20\x01(\rR\x08scoreTwo\x12\x1b\n\tis_reward\x18\x03\
    \x20\x01(\x08R\x08isReward\x12!\n\x0cchallenge_id\x18\x0e\x20\x01(\rR\
    \x0bchallengeId\x12\x1b\n\tpage_type\x18\x04\x20\x01(\rR\x08pageType\x12\
