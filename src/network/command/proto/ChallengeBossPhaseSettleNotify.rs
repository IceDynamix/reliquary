...
impl ::protobuf::Message for ChallengeBossPhaseSettleNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.page_type != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.page_type);
        }
        if self.phase != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.is_second_half != false {
            os.write_bool(12, self.is_second_half)?;
        }
        if self.is_win != false {
            os.write_bool(2, self.is_win)?;
        }
        if self.is_reward != false {
            os.write_bool(4, self.is_reward)?;
        }
        ...
        if self.page_type != 0 {
            os.write_uint32(14, self.page_type)?;
        }
        if self.phase != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x08\x20\x01(\rR\x0echallengeScore\x12\x1b\n\tscore_two\x18\x07\x20\x01(\
    \rR\x08scoreTwo\x12$\n\x0eis_second_half\x18\x0c\x20\x01(\x08R\x0cisSeco\
    ndHalf\x12\x15\n\x06is_win\x18\x02\x20\x01(\x08R\x05isWin\x12\x1b\n\tis_\
    reward\x18\x04\x20\x01(\x08R\x08isReward\x12;\n\x12battle_target_list\
    \x18\r\x20\x03(\x0b2\r.BattleTargetR\x10battleTargetList\x12\x12\n\x04st\
    ar\x18\x03\x20\x01(\rR\x04star\x12\x1b\n\tpage_type\x18\x0e\x20\x01(\rR\
    \x08pageType\x12\x14\n\x05phase\x18\x0b\x20\x01(\rR\x05phase\x12!\n\x0cc\
