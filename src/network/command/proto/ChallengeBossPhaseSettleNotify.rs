...
pub struct ChallengeBossPhaseSettleNotify {
    ...
    // @@protoc_insertion_point(field:ChallengeBossPhaseSettleNotify.AGAEPDNHPJC)
    pub AGAEPDNHPJC: bool,
...
impl ChallengeBossPhaseSettleNotify {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "AGAEPDNHPJC",
            |m: &ChallengeBossPhaseSettleNotify| { &m.AGAEPDNHPJC },
            |m: &mut ChallengeBossPhaseSettleNotify| { &mut m.AGAEPDNHPJC },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "is_win",
...
impl ::protobuf::Message for ChallengeBossPhaseSettleNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.page_type != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.page_type);
        }
        if self.phase != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.phase);
        }
        if self.challenge_score != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.challenge_score);
        }
        if self.score_two != 0 {
        ...
        if self.star != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.star);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.AGAEPDNHPJC != false {
            os.write_bool(10, self.AGAEPDNHPJC)?;
        }
        if self.is_win != false {
            os.write_bool(6, self.is_win)?;
        }
        if self.is_second_half != false {
            os.write_bool(2, self.is_second_half)?;
        }
        if self.is_reward != false {
            os.write_bool(7, self.is_reward)?;
        }
        if self.page_type != 0 {
            os.write_uint32(12, self.page_type)?;
        }
        if self.phase != 0 {
            os.write_uint32(4, self.phase)?;
        }
        if self.challenge_score != 0 {
            os.write_uint32(5, self.challenge_score)?;
        }
        if self.score_two != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n$ChallengeBossPhaseSettleNotify.proto\x1a\x12BattleTarget.proto\"\x89\
    \x03\n\x1eChallengeBossPhaseSettleNotify\x12;\n\x12battle_target_list\
    \x18\x01\x20\x03(\x0b2\r.BattleTargetR\x10battleTargetList\x12\x20\n\x0b\
    AGAEPDNHPJC\x18\n\x20\x01(\x08R\x0bAGAEPDNHPJC\x12\x15\n\x06is_win\x18\
    \x06\x20\x01(\x08R\x05isWin\x12$\n\x0eis_second_half\x18\x02\x20\x01(\
    \x08R\x0cisSecondHalf\x12\x1b\n\tis_reward\x18\x07\x20\x01(\x08R\x08isRe\
    ward\x12\x1b\n\tpage_type\x18\x0c\x20\x01(\rR\x08pageType\x12\x14\n\x05p\
    hase\x18\x04\x20\x01(\rR\x05phase\x12'\n\x0fchallenge_score\x18\x05\x20\
    \x01(\rR\x0echallengeScore\x12\x1b\n\tscore_two\x18\x0b\x20\x01(\rR\x08s\
    coreTwo\x12!\n\x0cchallenge_id\x18\x03\x20\x01(\rR\x0bchallengeId\x12\
    \x12\n\x04star\x18\x0e\x20\x01(\rR\x04starb\x06proto3\
";
