...
pub struct UpdateMainMissionCustomValueCsReq {
    // message fields
    // @@protoc_insertion_point(field:UpdateMainMissionCustomValueCsReq.HAMBCJHIOFK)
...
impl UpdateMainMissionCustomValueCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "HAMBCJHIOFK",
            |m: &UpdateMainMissionCustomValueCsReq| { &m.HAMBCJHIOFK },
            |m: &mut UpdateMainMissionCustomValueCsReq| { &mut m.HAMBCJHIOFK },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "value",
...
impl ::protobuf::Message for UpdateMainMissionCustomValueCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.HAMBCJHIOFK.is_empty() {
            my_size += ::protobuf::rt::string_size(7, &self.HAMBCJHIOFK);
        }
        if self.value != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if !self.HAMBCJHIOFK.is_empty() {
            os.write_string(7, &self.HAMBCJHIOFK)?;
        }
        if self.value != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    CustomValueCsReq\x12\x20\n\x0bHAMBCJHIOFK\x18\x07\x20\x01(\tR\x0bHAMBCJH\
    IOFK\x12\x14\n\x05value\x18\x0e\x20\x01(\rR\x05value\x12&\n\x0fmain_miss\
    ion_id\x18\r\x20\x01(\rR\rmainMissionIdb\x06proto3\
";
