...
impl ::protobuf::Message for UpdateMainMissionCustomValueCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.BGDFHBAANLB.is_empty() {
            my_size += ::protobuf::rt::string_size(1, &self.BGDFHBAANLB);
        }
        if self.value != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if !self.BGDFHBAANLB.is_empty() {
            os.write_string(1, &self.BGDFHBAANLB)?;
        }
        if self.value != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    CustomValueCsReq\x12\x20\n\x0bBGDFHBAANLB\x18\x01\x20\x01(\tR\x0bBGDFHBA\
    ANLB\x12\x14\n\x05value\x18\x03\x20\x01(\rR\x05value\x12&\n\x0fmain_miss\
    ion_id\x18\x06\x20\x01(\rR\rmainMissionIdb\x06proto3\
";
