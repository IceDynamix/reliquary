...
impl ::protobuf::Message for JAJGKKDPALC {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.PGALBDIIEFG != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.PGALBDIIEFG);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.PGALBDIIEFG != 0 {
            os.write_uint32(15, self.PGALBDIIEFG)?;
        }
        if let Some(v) = self.HGBIGBFGBOM.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ALC\x12\x20\n\x0bPGALBDIIEFG\x18\x0f\x20\x01(\rR\x0bPGALBDIIEFG\x12.\n\
    \x0bHGBIGBFGBOM\x18\x08\x20\x01(\x0b2\x0c.IAACCAFGEPIR\x0bHGBIGBFGBOM\
    \x12.\n\x0bIMOPIEJBHOD\x18\x01\x20\x03(\x0b2\x0c.IAACCAFGEPIR\x0bIMOPIEJ\
    BHOD\x12\x20\n\x0bLBBONKACGEJ\x18\r\x20\x01(\rR\x0bLBBONKACGEJ\x12.\n\
    \x0bNBMPBGPJONH\x18\x0c\x20\x03(\x0b2\x0c.IAACCAFGEPIR\x0bNBMPBGPJONHb\
    \x06proto3\
";
