...
impl ::protobuf::Message for CurChallenge {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.round_count != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.round_count);
        }
        if self.score_two != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.score_two);
        }
        if self.dead_avatar_num != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.dead_avatar_num);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.round_count != 0 {
            os.write_uint32(7, self.round_count)?;
        }
        if self.score_two != 0 {
            os.write_uint32(3, self.score_two)?;
        }
        if self.dead_avatar_num != 0 {
            os.write_uint32(15, self.dead_avatar_num)?;
        }
        if let Some(v) = self.stage_info.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0bchallengeId\x12<\n\x11extra_lineup_type\x18\t\x20\x01(\x0e2\x10.Extr\
    aLineupTypeR\x0fextraLineupType\x12(\n\x06status\x18\x02\x20\x01(\x0e2\
    \x10.ChallengeStatusR\x06status\x12\x19\n\x08score_id\x18\x04\x20\x01(\r\
    R\x07scoreId\x128\n\x11kill_monster_list\x18\x0b\x20\x03(\x0b2\x0c.KillM\
    onsterR\x0fkillMonsterList\x12\x1f\n\x0bround_count\x18\x07\x20\x01(\rR\
    \nroundCount\x12\x1b\n\tscore_two\x18\x03\x20\x01(\rR\x08scoreTwo\x12&\n\
    \x0fdead_avatar_num\x18\x0f\x20\x01(\rR\rdeadAvatarNum\x124\n\nstage_inf\
    o\x18\x0e\x20\x01(\x0b2\x15.ChallengeCurBuffInfoR\tstageInfob\x06proto3\
";
