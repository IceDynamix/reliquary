...
impl ::protobuf::Message for CurChallenge {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.round_count != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.round_count);
        }
        if self.score_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.round_count != 0 {
            os.write_uint32(12, self.round_count)?;
        }
        if self.score_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0e2\x10.ExtraLineupTypeR\x0fextraLineupType\x12!\n\x0cchallenge_id\x18\
    \x02\x20\x01(\rR\x0bchallengeId\x12\x1b\n\tscore_two\x18\x05\x20\x01(\rR\
    \x08scoreTwo\x12(\n\x06status\x18\x06\x20\x01(\x0e2\x10.ChallengeStatusR\
    \x06status\x12&\n\x0fdead_avatar_num\x18\x07\x20\x01(\rR\rdeadAvatarNum\
    \x128\n\x11kill_monster_list\x18\t\x20\x03(\x0b2\x0c.KillMonsterR\x0fkil\
    lMonsterList\x124\n\nstage_info\x18\n\x20\x01(\x0b2\x15.ChallengeCurBuff\
    InfoR\tstageInfo\x12\x1f\n\x0bround_count\x18\x0c\x20\x01(\rR\nroundCoun\
