...
impl ::protobuf::Message for CurChallenge {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.dead_avatar_num != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.dead_avatar_num);
        }
        if self.score_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.dead_avatar_num != 0 {
            os.write_uint32(6, self.dead_avatar_num)?;
        }
        if self.score_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x8a\x03\n\x0cCurChallenge\x128\n\x11kill_monster_list\x18\x01\x20\x03(\
    \x0b2\x0c.KillMonsterR\x0fkillMonsterList\x124\n\nstage_info\x18\x0b\x20\
    \x01(\x0b2\x15.ChallengeCurBuffInfoR\tstageInfo\x12\x1f\n\x0bround_count\
    \x18\t\x20\x01(\rR\nroundCount\x12<\n\x11extra_lineup_type\x18\x05\x20\
    \x01(\x0e2\x10.ExtraLineupTypeR\x0fextraLineupType\x12&\n\x0fdead_avatar\
    _num\x18\x06\x20\x01(\rR\rdeadAvatarNum\x12\x19\n\x08score_id\x18\x0e\
    \x20\x01(\rR\x07scoreId\x12!\n\x0cchallenge_id\x18\x07\x20\x01(\rR\x0bch\
    allengeId\x12\x1b\n\tscore_two\x18\x08\x20\x01(\rR\x08scoreTwo\x12(\n\
    \x06status\x18\x0c\x20\x01(\x0e2\x10.ChallengeStatusR\x06statusb\x06prot\
    o3\
";
