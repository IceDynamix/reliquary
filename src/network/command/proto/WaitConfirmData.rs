...
impl ::protobuf::Message for WaitConfirmData {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.is_wait_confirm != false {
            os.write_bool(3, self.is_wait_confirm)?;
        }
        if self.cycles_used != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x15WaitConfirmData.proto\"\xa5\x01\n\x0fWaitConfirmData\x12&\n\x0fis_\
    wait_confirm\x18\x03\x20\x01(\x08R\risWaitConfirm\x12\x1f\n\x0bcycles_us\
    ed\x18\x07\x20\x01(\rR\ncyclesUsed\x120\n\x14finished_target_list\x18\t\
    \x20\x03(\rR\x12finishedTargetList\x12\x17\n\x07peak_id\x18\x0e\x20\x01(\
