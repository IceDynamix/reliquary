...
impl ::protobuf::Message for WaitConfirmData {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.is_wait_confirm != false {
            os.write_bool(11, self.is_wait_confirm)?;
        }
        if self.peak_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ished_target_list\x18\x0c\x20\x03(\rR\x12finishedTargetList\x12&\n\x0fis\
    _wait_confirm\x18\x0b\x20\x01(\x08R\risWaitConfirm\x12\x17\n\x07peak_id\
    \x18\x01\x20\x01(\rR\x06peakId\x12\x1f\n\x0bcycles_used\x18\x05\x20\x01(\
