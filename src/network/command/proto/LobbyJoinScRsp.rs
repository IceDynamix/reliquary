...
impl ::protobuf::Message for LobbyJoinScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.NBDLPGBIDLC != ::protobuf::EnumOrUnknown::new(super::FightGameMode::FightGameMode::FIGHT_GAME_MODE_NONE) {
            my_size += ::protobuf::rt::int32_size(13, self.NBDLPGBIDLC.value());
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.NBDLPGBIDLC != ::protobuf::EnumOrUnknown::new(super::FightGameMode::FightGameMode::FIGHT_GAME_MODE_NONE) {
            os.write_enum(13, ::protobuf::EnumOrUnknown::value(&self.NBDLPGBIDLC))?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    .proto\"\xc7\x01\n\x0eLobbyJoinScRsp\x12\x20\n\x0bNEPODDOJJFE\x18\t\x20\
    \x01(\rR\x0bNEPODDOJJFE\x12.\n\x0bLIPJDJPMOKB\x18\x06\x20\x03(\x0b2\x0c.\
    CBBDIOMIFHDR\x0bLIPJDJPMOKB\x12\x17\n\x07room_id\x18\x07\x20\x01(\x04R\
    \x06roomId\x120\n\x0bNBDLPGBIDLC\x18\r\x20\x01(\x0e2\x0e.FightGameModeR\
    \x0bNBDLPGBIDLC\x12\x18\n\x07retcode\x18\x08\x20\x01(\rR\x07retcodeb\x06\
    proto3\
";
