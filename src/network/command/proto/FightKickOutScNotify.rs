...
pub struct FightKickOutScNotify {
    ...
    pub kick_type: ::protobuf::EnumOrUnknown<super::AHNOFNBCABG::AHNOFNBCABG>,
    // special fields
...
impl ::protobuf::Message for FightKickOutScNotify {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.kick_type != ::protobuf::EnumOrUnknown::new(super::AHNOFNBCABG::AHNOFNBCABG::AHNOFNBCABG_ODLOCDBMMNC) {
    ...
    fn clear(&mut self) {
        self.kick_type = ::protobuf::EnumOrUnknown::new(super::AHNOFNBCABG::AHNOFNBCABG::AHNOFNBCABG_ODLOCDBMMNC);
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1aFightKickOutScNotify.proto\x1a\x11AHNOFNBCABG.proto\"A\n\x14FightK\
    ickOutScNotify\x12)\n\tkick_type\x18\t\x20\x01(\x0e2\x0c.AHNOFNBCABGR\
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::AHNOFNBCABG::file_descriptor().clone());
