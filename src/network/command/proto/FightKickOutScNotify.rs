...
pub struct FightKickOutScNotify {
    ...
    pub kick_type: ::protobuf::EnumOrUnknown<super::FightKickout::FightKickout>,
    // special fields
...
impl ::protobuf::Message for FightKickOutScNotify {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.kick_type != ::protobuf::EnumOrUnknown::new(super::FightKickout::FightKickout::FIGHT_KICKOUT_UNKNOWN) {
            my_size += ::protobuf::rt::int32_size(5, self.kick_type.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.kick_type != ::protobuf::EnumOrUnknown::new(super::FightKickout::FightKickout::FIGHT_KICKOUT_UNKNOWN) {
            os.write_enum(5, ::protobuf::EnumOrUnknown::value(&self.kick_type))?;
        }
    ...
    fn clear(&mut self) {
        self.kick_type = ::protobuf::EnumOrUnknown::new(super::FightKickout::FightKickout::FIGHT_KICKOUT_UNKNOWN);
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1aFightKickOutScNotify.proto\x1a\x12FightKickout.proto\"B\n\x14Fight\
    KickOutScNotify\x12*\n\tkick_type\x18\x05\x20\x01(\x0e2\r.FightKickoutR\
    \x08kickTypeb\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::FightKickout::file_descriptor().clone());
