...
impl ::protobuf::Message for SwordTrainingDailyPhaseConfirmCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.IFENLNHLBAB != ::protobuf::EnumOrUnknown::new(super::SwordTrainingDailyPhaseType::SwordTrainingDailyPhaseType::SWORD_TRAINING_DAILY_PHASE_TYPE_NONE) {
            my_size += ::protobuf::rt::int32_size(1, self.IFENLNHLBAB.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.IFENLNHLBAB != ::protobuf::EnumOrUnknown::new(super::SwordTrainingDailyPhaseType::SwordTrainingDailyPhaseType::SWORD_TRAINING_DAILY_PHASE_TYPE_NONE) {
            os.write_enum(1, ::protobuf::EnumOrUnknown::value(&self.IFENLNHLBAB))?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    B\x18\x01\x20\x01(\x0e2\x1c.SwordTrainingDailyPhaseTypeR\x0bIFENLNHLBABb\
    \x06proto3\
";
