...
impl ::protobuf::Message for DEJAKPOEPKN {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(7, &self.LFPMAOBGNEN);
        if self.CGFGFMGDPNJ != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.CGFGFMGDPNJ);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(7, &self.LFPMAOBGNEN)?;
        if self.CGFGFMGDPNJ != 0 {
            os.write_uint32(13, self.CGFGFMGDPNJ)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x07\x20\x03(\rR\x0bLFPMAOBGNEN\x12\x20\n\x0bCGFGFMGDPNJ\x18\r\x20\x01(\
    \rR\x0bCGFGFMGDPNJb\x06proto3\
";
