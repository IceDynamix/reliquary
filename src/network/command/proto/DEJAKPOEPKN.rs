...
pub struct DEJAKPOEPKN {
    // message fields
    // @@protoc_insertion_point(field:DEJAKPOEPKN.FMJKDMEBOMJ)
    pub FMJKDMEBOMJ: u32,
    // @@protoc_insertion_point(field:DEJAKPOEPKN.MALGBMDEBPL)
    pub MALGBMDEBPL: ::std::vec::Vec<u32>,
    // special fields
...
impl DEJAKPOEPKN {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "FMJKDMEBOMJ",
            |m: &DEJAKPOEPKN| { &m.FMJKDMEBOMJ },
            |m: &mut DEJAKPOEPKN| { &mut m.FMJKDMEBOMJ },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "MALGBMDEBPL",
            |m: &DEJAKPOEPKN| { &m.MALGBMDEBPL },
            |m: &mut DEJAKPOEPKN| { &mut m.MALGBMDEBPL },
        ));
...
impl ::protobuf::Message for DEJAKPOEPKN {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                56 => {
                    self.FMJKDMEBOMJ = is.read_uint32()?;
                },
                98 => {
                    is.read_repeated_packed_uint32_into(&mut self.MALGBMDEBPL)?;
                },
                96 => {
                    self.MALGBMDEBPL.push(is.read_uint32()?);
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.FMJKDMEBOMJ != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.FMJKDMEBOMJ);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(12, &self.MALGBMDEBPL);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.FMJKDMEBOMJ != 0 {
            os.write_uint32(7, self.FMJKDMEBOMJ)?;
        }
        os.write_repeated_packed_uint32(12, &self.MALGBMDEBPL)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x07\x20\x01(\rR\x0bFMJKDMEBOMJ\x12\x20\n\x0bMALGBMDEBPL\x18\x0c\x20\x03\
    (\rR\x0bMALGBMDEBPLb\x06proto3\
";
