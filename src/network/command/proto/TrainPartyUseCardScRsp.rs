...
pub struct TrainPartyUseCardScRsp {
    // message fields
    // @@protoc_insertion_point(field:TrainPartyUseCardScRsp.CPLFONLPEMM)
    pub CPLFONLPEMM: u32,
...
impl TrainPartyUseCardScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "CPLFONLPEMM",
            |m: &TrainPartyUseCardScRsp| { &m.CPLFONLPEMM },
            |m: &mut TrainPartyUseCardScRsp| { &mut m.CPLFONLPEMM },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "retcode",
...
impl ::protobuf::Message for TrainPartyUseCardScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.CPLFONLPEMM != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.CPLFONLPEMM);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.CPLFONLPEMM != 0 {
            os.write_uint32(11, self.CPLFONLPEMM)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x20\n\x0bCPLFONLPEMM\x18\x0b\x20\x01(\rR\x0bCPLFONLPEMM\x12\x18\n\x07re\
