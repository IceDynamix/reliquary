...
impl ::protobuf::Message for TrainPartyUseCardScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.use_card_id != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.use_card_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.use_card_id != 0 {
            os.write_uint32(14, self.use_card_id)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\n\x07retcode\x18\x0b\x20\x01(\rR\x07retcode\x12\x1e\n\x0buse_card_i\
    d\x18\x0e\x20\x01(\rR\tuseCardIdb\x06proto3\
";
