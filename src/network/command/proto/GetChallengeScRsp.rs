...
impl ::protobuf::Message for GetChallengeScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.LPLJMKPBLIF != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.LPLJMKPBLIF);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.LPLJMKPBLIF != 0 {
            os.write_uint32(4, self.LPLJMKPBLIF)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    geGroupR\x12challengeGroupList\x12\x20\n\x0bLPLJMKPBLIF\x18\x04\x20\x01(\
    \rR\x0bLPLJMKPBLIF\x121\n\x0echallenge_list\x18\n\x20\x03(\x0b2\n.Challe\
    ngeR\rchallengeList\x12?\n\x0emax_level_list\x18\x05\x20\x03(\x0b2\x19.C\
    hallengeHistoryMaxLevelR\x0cmaxLevelList\x12\x18\n\x07retcode\x18\x01\
