...
pub struct GetChallengeScRsp {
    ...
    // @@protoc_insertion_point(field:GetChallengeScRsp.GHAMCPFGMMP)
    pub GHAMCPFGMMP: u32,
...
impl GetChallengeScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "GHAMCPFGMMP",
            |m: &GetChallengeScRsp| { &m.GHAMCPFGMMP },
            |m: &mut GetChallengeScRsp| { &mut m.GHAMCPFGMMP },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "retcode",
...
impl ::protobuf::Message for GetChallengeScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.GHAMCPFGMMP != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.GHAMCPFGMMP);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.GHAMCPFGMMP != 0 {
            os.write_uint32(12, self.GHAMCPFGMMP)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    geScRsp\x12A\n\x14challenge_group_list\x18\x01\x20\x03(\x0b2\x0f.Challen\
    geGroupR\x12challengeGroupList\x121\n\x0echallenge_list\x18\t\x20\x03(\
    \x0b2\n.ChallengeR\rchallengeList\x12?\n\x0emax_level_list\x18\x0f\x20\
    \x03(\x0b2\x19.ChallengeHistoryMaxLevelR\x0cmaxLevelList\x12\x20\n\x0bGH\
    AMCPFGMMP\x18\x0c\x20\x01(\rR\x0bGHAMCPFGMMP\x12\x18\n\x07retcode\x18\
