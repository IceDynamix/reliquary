...
impl ::protobuf::Message for SetGenderScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.cur_avatar_path != ::protobuf::EnumOrUnknown::new(super::MultiPathAvatarType::MultiPathAvatarType::MultiPathAvatarTypeNone) {
            my_size += ::protobuf::rt::int32_size(13, self.cur_avatar_path.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.cur_avatar_path != ::protobuf::EnumOrUnknown::new(super::MultiPathAvatarType::MultiPathAvatarType::MultiPathAvatarTypeNone) {
            os.write_enum(13, ::protobuf::EnumOrUnknown::value(&self.cur_avatar_path))?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    path\x18\r\x20\x01(\x0e2\x14.MultiPathAvatarTypeR\rcurAvatarPath\x12N\n\
    \x19cur_avatar_path_info_list\x18\x02\x20\x03(\x0b2\x14.MultiPathAvatarI\
    nfoR\x15curAvatarPathInfoList\x12\x18\n\x07retcode\x18\n\x20\x01(\rR\x07\
    retcodeb\x06proto3\
";
