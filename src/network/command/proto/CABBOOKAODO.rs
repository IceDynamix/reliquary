...
//! Generated file from `CABBOOKAODO.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:CABBOOKAODO)
...
pub struct CABBOOKAODO {
    ...
    pub avatar_id: u32,
    // special fields
    // @@protoc_insertion_point(special_field:CABBOOKAODO.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a CABBOOKAODO {
    fn default() -> &'a CABBOOKAODO {
        <CABBOOKAODO as ::protobuf::Message>::default_instance()
    }
}

impl CABBOOKAODO {
    pub fn new() -> CABBOOKAODO {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "avatar_id",
            |m: &CABBOOKAODO| { &m.avatar_id },
            |m: &mut CABBOOKAODO| { &mut m.avatar_id },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<CABBOOKAODO>(
            "CABBOOKAODO",
            fields,
            oneofs,
        )
...
impl ::protobuf::Message for CABBOOKAODO {
    const NAME: &'static str = "CABBOOKAODO";
...
impl ::protobuf::MessageFull for CABBOOKAODO {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("CABBOOKAODO").unwrap()).clone()
    }
}

impl ::std::fmt::Display for CABBOOKAODO {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for CABBOOKAODO {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(CABBOOKAODO::generated_message_descriptor_data());
