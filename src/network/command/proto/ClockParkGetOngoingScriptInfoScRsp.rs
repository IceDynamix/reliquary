...
impl ::protobuf::Message for ClockParkGetOngoingScriptInfoScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.OBPFBLNBFKI != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.OBPFBLNBFKI);
        }
        if self.retcode != 0 {
        ...
        if self.KIEKJEFFPHK != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.KIEKJEFFPHK);
        }
        if self.script_id != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.script_id);
        }
        if self.AIGEHHNHKPM != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.AIGEHHNHKPM);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.OBPFBLNBFKI != 0 {
            os.write_uint32(3, self.OBPFBLNBFKI)?;
        }
        if self.retcode != 0 {
        ...
        if self.KIEKJEFFPHK != 0 {
            os.write_uint32(7, self.KIEKJEFFPHK)?;
        }
        if self.script_id != 0 {
            os.write_uint32(2, self.script_id)?;
        }
        if self.AIGEHHNHKPM != 0 {
            os.write_uint32(13, self.AIGEHHNHKPM)?;
        }
        if self.CHOBAOGMLFN != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    OngoingScriptInfoScRsp\x12.\n\x0bMJDOGPBOJIP\x18\x05\x20\x01(\x0b2\x0c.B\
    MLOFPCNGKNR\x0bMJDOGPBOJIP\x12\x20\n\x0bOBPFBLNBFKI\x18\x03\x20\x01(\rR\
    \x0bOBPFBLNBFKI\x12\x18\n\x07retcode\x18\x04\x20\x01(\rR\x07retcode\x124\
    \n\x0frogue_buff_info\x18\x06\x20\x01(\x0b2\x0c.ECMILHCKOMOR\rrogueBuffI\
    nfo\x12\x20\n\x0bKIEKJEFFPHK\x18\x07\x20\x01(\rR\x0bKIEKJEFFPHK\x12\x1b\
    \n\tscript_id\x18\x02\x20\x01(\rR\x08scriptId\x12\x20\n\x0bAIGEHHNHKPM\
    \x18\r\x20\x01(\rR\x0bAIGEHHNHKPM\x12\x20\n\x0bCHOBAOGMLFN\x18\x0f\x20\
    \x01(\rR\x0bCHOBAOGMLFN\x12\x20\n\x0bBLHGBEDNFIB\x18\x0c\x20\x01(\rR\x0b\
    BLHGBEDNFIB\x12.\n\x0bIENPHEFANGL\x18\x01\x20\x01(\x0b2\x0c.LKBBKOJDDPDR\
    \x0bIENPHEFANGL\x12\x20\n\x0bEIDLLEOLFGM\x18\x08\x20\x03(\rR\x0bEIDLLEOL\
    FGM\x12\x20\n\x0bCMGKEOLCBIP\x18\n\x20\x01(\tR\x0bCMGKEOLCBIPb\x06proto3\
";
