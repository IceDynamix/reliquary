...
impl ::protobuf::Message for ClockParkGetOngoingScriptInfoScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.OBPFBLNBFKI != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.OBPFBLNBFKI);
        }
        if self.retcode != 0 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(11, &self.EIDLLEOLFGM);
        if let Some(v) = self.IENPHEFANGL.as_ref() {
            let len = v.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
        }
        if self.CHOBAOGMLFN != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.CHOBAOGMLFN);
        }
        if !self.CMGKEOLCBIP.is_empty() {
            my_size += ::protobuf::rt::string_size(5, &self.CMGKEOLCBIP);
        }
        if self.KIEKJEFFPHK != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.KIEKJEFFPHK);
        }
        if self.AIGEHHNHKPM != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.AIGEHHNHKPM);
        }
        if self.script_id != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.script_id);
        }
        if self.BLHGBEDNFIB != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.BLHGBEDNFIB);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.OBPFBLNBFKI != 0 {
            os.write_uint32(6, self.OBPFBLNBFKI)?;
        }
        if self.retcode != 0 {
        ...
        os.write_repeated_packed_uint32(11, &self.EIDLLEOLFGM)?;
        if let Some(v) = self.IENPHEFANGL.as_ref() {
            ::protobuf::rt::write_message_field_with_cached_size(1, v, os)?;
        }
        if self.CHOBAOGMLFN != 0 {
            os.write_uint32(15, self.CHOBAOGMLFN)?;
        }
        if !self.CMGKEOLCBIP.is_empty() {
            os.write_string(5, &self.CMGKEOLCBIP)?;
        }
        if self.KIEKJEFFPHK != 0 {
            os.write_uint32(14, self.KIEKJEFFPHK)?;
        }
        if self.AIGEHHNHKPM != 0 {
            os.write_uint32(8, self.AIGEHHNHKPM)?;
        }
        if self.script_id != 0 {
            os.write_uint32(10, self.script_id)?;
        }
        if self.BLHGBEDNFIB != 0 {
            os.write_uint32(12, self.BLHGBEDNFIB)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    OngoingScriptInfoScRsp\x12\x20\n\x0bOBPFBLNBFKI\x18\x06\x20\x01(\rR\x0bO\
    BPFBLNBFKI\x12\x18\n\x07retcode\x18\x03\x20\x01(\rR\x07retcode\x12.\n\
    \x0bMJDOGPBOJIP\x18\t\x20\x01(\x0b2\x0c.BMLOFPCNGKNR\x0bMJDOGPBOJIP\x124\
    \n\x0frogue_buff_info\x18\x07\x20\x01(\x0b2\x0c.ECMILHCKOMOR\rrogueBuffI\
    nfo\x12\x20\n\x0bEIDLLEOLFGM\x18\x0b\x20\x03(\rR\x0bEIDLLEOLFGM\x12.\n\
    \x0bIENPHEFANGL\x18\x01\x20\x01(\x0b2\x0c.LKBBKOJDDPDR\x0bIENPHEFANGL\
    \x12\x20\n\x0bCHOBAOGMLFN\x18\x0f\x20\x01(\rR\x0bCHOBAOGMLFN\x12\x20\n\
    \x0bCMGKEOLCBIP\x18\x05\x20\x01(\tR\x0bCMGKEOLCBIP\x12\x20\n\x0bKIEKJEFF\
    PHK\x18\x0e\x20\x01(\rR\x0bKIEKJEFFPHK\x12\x20\n\x0bAIGEHHNHKPM\x18\x08\
    \x20\x01(\rR\x0bAIGEHHNHKPM\x12\x1b\n\tscript_id\x18\n\x20\x01(\rR\x08sc\
    riptId\x12\x20\n\x0bBLHGBEDNFIB\x18\x0c\x20\x01(\rR\x0bBLHGBEDNFIBb\x06p\
    roto3\
";
