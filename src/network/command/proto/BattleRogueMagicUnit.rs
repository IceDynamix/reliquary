...
pub struct BattleRogueMagicUnit {
    // message fields
    // @@protoc_insertion_point(field:BattleRogueMagicUnit.magic_unit_id)
    pub magic_unit_id: u32,
    // @@protoc_insertion_point(field:BattleRogueMagicUnit.level)
    pub level: u32,
    // @@protoc_insertion_point(field:BattleRogueMagicUnit.EBOAFIAODFM)
    pub EBOAFIAODFM: bool,
    // @@protoc_insertion_point(field:BattleRogueMagicUnit.dice_slot_id)
    pub dice_slot_id: u32,
    // @@protoc_insertion_point(field:BattleRogueMagicUnit.HOBMCIDGMAL)
    pub HOBMCIDGMAL: ::std::collections::HashMap<u32, u32>,
    // special fields
...
impl BattleRogueMagicUnit {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "magic_unit_id",
            |m: &BattleRogueMagicUnit| { &m.magic_unit_id },
            |m: &mut BattleRogueMagicUnit| { &mut m.magic_unit_id },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "level",
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "EBOAFIAODFM",
            |m: &BattleRogueMagicUnit| { &m.EBOAFIAODFM },
            |m: &mut BattleRogueMagicUnit| { &mut m.EBOAFIAODFM },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "dice_slot_id",
            |m: &BattleRogueMagicUnit| { &m.dice_slot_id },
            |m: &mut BattleRogueMagicUnit| { &mut m.dice_slot_id },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_map_simpler_accessor_new::<_, _>(
            "HOBMCIDGMAL",
            |m: &BattleRogueMagicUnit| { &m.HOBMCIDGMAL },
            |m: &mut BattleRogueMagicUnit| { &mut m.HOBMCIDGMAL },
        ));
...
impl ::protobuf::Message for BattleRogueMagicUnit {
        ...
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                42 => {
                    ...
                    self.HOBMCIDGMAL.insert(key, value);
                },
                tag => {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.EBOAFIAODFM != false {
            os.write_bool(3, self.EBOAFIAODFM)?;
        }
        if self.dice_slot_id != 0 {
