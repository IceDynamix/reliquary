...
impl ::protobuf::Message for ACKNCAAAMJM {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.PPCLBDBJLMO != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.PPCLBDBJLMO);
        }
        ...
        if self.GIACFCDDJNM != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.GIACFCDDJNM);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.PPCLBDBJLMO != 0 {
            os.write_uint32(12, self.PPCLBDBJLMO)?;
        }
        if let Some(v) = self.item_list.as_ref() {
            ::protobuf::rt::write_message_field_with_cached_size(4, v, os)?;
        }
        if self.GIACFCDDJNM != 0 {
            os.write_uint32(3, self.GIACFCDDJNM)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x20\n\x0bPPCLBDBJLMO\x18\x0c\x20\x01(\rR\x0bPPCLBDBJLMO\x12&\n\titem_li\
    st\x18\x04\x20\x01(\x0b2\t.ItemListR\x08itemList\x12\x20\n\x0bGIACFCDDJN\
    M\x18\x03\x20\x01(\rR\x0bGIACFCDDJNMb\x06proto3\
";
