...
impl ::protobuf::Message for FightTreasureDungeonMonsterCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.NLMDEMOHBOO != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.NLMDEMOHBOO);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.NLMDEMOHBOO != 0 {
            os.write_uint32(9, self.NLMDEMOHBOO)?;
        }
        if self.HFNHLCFNHKD != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x20\x03(\x0b2\x0c.JACKEJLKJNAR\navatarList\x12\x20\n\x0bNLMDEMOHBOO\x18\
    \t\x20\x01(\rR\x0bNLMDEMOHBOO\x12\x20\n\x0bHFNHLCFNHKD\x18\x06\x20\x01(\
    \rR\x0bHFNHLCFNHKDb\x06proto3\
";
