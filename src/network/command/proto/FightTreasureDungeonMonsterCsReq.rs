...
impl ::protobuf::Message for FightTreasureDungeonMonsterCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.HFNHLCFNHKD != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.HFNHLCFNHKD);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.HFNHLCFNHKD != 0 {
            os.write_uint32(1, self.HFNHLCFNHKD)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0e\x20\x01(\rR\x0bNLMDEMOHBOO\x12-\n\x0bavatar_list\x18\x06\x20\x03(\
    \x0b2\x0c.JACKEJLKJNAR\navatarList\x12\x20\n\x0bHFNHLCFNHKD\x18\x01\x20\
    \x01(\rR\x0bHFNHLCFNHKDb\x06proto3\
";
