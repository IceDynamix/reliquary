...
//! Generated file from `EPNAONKOHBO.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:EPNAONKOHBO)
...
pub struct EPNAONKOHBO {
    ...
    // special fields
    // @@protoc_insertion_point(special_field:EPNAONKOHBO.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a EPNAONKOHBO {
    fn default() -> &'a EPNAONKOHBO {
        <EPNAONKOHBO as ::protobuf::Message>::default_instance()
    }
}

impl EPNAONKOHBO {
    pub fn new() -> EPNAONKOHBO {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "count",
            |m: &EPNAONKOHBO| { &m.count },
            |m: &mut EPNAONKOHBO| { &mut m.count },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "total_damage",
            |m: &EPNAONKOHBO| { &m.total_damage },
            |m: &mut EPNAONKOHBO| { &mut m.total_damage },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<EPNAONKOHBO>(
            "EPNAONKOHBO",
            fields,
            oneofs,
        )
...
impl ::protobuf::Message for EPNAONKOHBO {
    const NAME: &'static str = "EPNAONKOHBO";
...
impl ::protobuf::MessageFull for EPNAONKOHBO {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("EPNAONKOHBO").unwrap()).clone()
    }
}

impl ::std::fmt::Display for EPNAONKOHBO {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for EPNAONKOHBO {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(EPNAONKOHBO::generated_message_descriptor_data());
