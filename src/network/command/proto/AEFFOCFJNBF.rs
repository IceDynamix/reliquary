...
//! Generated file from `AEFFOCFJNBF.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:AEFFOCFJNBF)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct AEFFOCFJNBF {
    // message fields
    ...
    pub buff_id: u32,
    // special fields
    // @@protoc_insertion_point(special_field:AEFFOCFJNBF.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a AEFFOCFJNBF {
    fn default() -> &'a AEFFOCFJNBF {
        <AEFFOCFJNBF as ::protobuf::Message>::default_instance()
    }
}

impl AEFFOCFJNBF {
    pub fn new() -> AEFFOCFJNBF {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "buff_id",
            |m: &AEFFOCFJNBF| { &m.buff_id },
            |m: &mut AEFFOCFJNBF| { &mut m.buff_id },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<AEFFOCFJNBF>(
            "AEFFOCFJNBF",
            fields,
            oneofs,
        )
...
impl ::protobuf::Message for AEFFOCFJNBF {
    const NAME: &'static str = "AEFFOCFJNBF";
...
impl ::protobuf::MessageFull for AEFFOCFJNBF {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("AEFFOCFJNBF").unwrap()).clone()
    }
}

impl ::std::fmt::Display for AEFFOCFJNBF {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for AEFFOCFJNBF {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(AEFFOCFJNBF::generated_message_descriptor_data());
