...
impl ::protobuf::Message for RogueDebugReplaySaveScNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.JHJGFDMKIHG.is_empty() {
            my_size += ::protobuf::rt::string_size(14, &self.JHJGFDMKIHG);
        }
        if !self.JDEDCKKACGO.is_empty() {
            my_size += ::protobuf::rt::string_size(15, &self.JDEDCKKACGO);
        }
        if !self.NEPGEEJCLAH.is_empty() {
            my_size += ::protobuf::rt::string_size(5, &self.NEPGEEJCLAH);
        }
        if !self.KFAMACKFHPM.is_empty() {
            my_size += ::protobuf::rt::string_size(12, &self.KFAMACKFHPM);
        }
        if !self.IJPPKNKNLNL.is_empty() {
            my_size += ::protobuf::rt::string_size(2, &self.IJPPKNKNLNL);
        }
        if self.uid != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.uid);
        }
        if !self.DFPFALBJHJH.is_empty() {
            my_size += ::protobuf::rt::string_size(9, &self.DFPFALBJHJH);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if !self.JHJGFDMKIHG.is_empty() {
            os.write_string(14, &self.JHJGFDMKIHG)?;
        }
        if !self.JDEDCKKACGO.is_empty() {
            os.write_string(15, &self.JDEDCKKACGO)?;
        }
        if !self.NEPGEEJCLAH.is_empty() {
            os.write_string(5, &self.NEPGEEJCLAH)?;
        }
        if !self.KFAMACKFHPM.is_empty() {
            os.write_string(12, &self.KFAMACKFHPM)?;
        }
        if !self.IJPPKNKNLNL.is_empty() {
            os.write_string(2, &self.IJPPKNKNLNL)?;
        }
        if self.uid != 0 {
            os.write_uint32(1, self.uid)?;
        }
        if !self.DFPFALBJHJH.is_empty() {
            os.write_string(9, &self.DFPFALBJHJH)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    veScNotify\x12\x20\n\x0bJHJGFDMKIHG\x18\x0e\x20\x01(\tR\x0bJHJGFDMKIHG\
    \x12\x20\n\x0bJDEDCKKACGO\x18\x0f\x20\x01(\tR\x0bJDEDCKKACGO\x12\x20\n\
    \x0bNEPGEEJCLAH\x18\x05\x20\x01(\tR\x0bNEPGEEJCLAH\x12\x20\n\x0bKFAMACKF\
    HPM\x18\x0c\x20\x01(\tR\x0bKFAMACKFHPM\x12\x20\n\x0bIJPPKNKNLNL\x18\x02\
    \x20\x01(\tR\x0bIJPPKNKNLNL\x12\x10\n\x03uid\x18\x01\x20\x01(\rR\x03uid\
    \x12\x20\n\x0bDFPFALBJHJH\x18\t\x20\x01(\tR\x0bDFPFALBJHJHb\x06proto3\
";
