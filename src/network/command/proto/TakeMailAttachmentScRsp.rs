...
impl ::protobuf::Message for TakeMailAttachmentScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(2, &self.succ_mail_id_list);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_uint32(2, &self.succ_mail_id_list)?;
        if let Some(v) = self.attachment.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x07retcode\x18\x0c\x20\x01(\rR\x07retcode\x12)\n\x11succ_mail_id_list\
    \x18\x02\x20\x03(\rR\x0esuccMailIdList\x12)\n\nattachment\x18\t\x20\x01(\
    \x0b2\t.ItemListR\nattachment\x12?\n\x0efail_mail_list\x18\x0b\x20\x03(\
    \x0b2\x19.ClientMailAttachmentItemR\x0cfailMailListb\x06proto3\
";
