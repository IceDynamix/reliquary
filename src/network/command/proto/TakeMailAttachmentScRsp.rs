...
impl ::protobuf::Message for TakeMailAttachmentScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(6, &self.succ_mail_id_list);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_uint32(6, &self.succ_mail_id_list)?;
        if let Some(v) = self.attachment.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0efail_mail_list\x18\x04\x20\x03(\x0b2\x19.ClientMailAttachmentItemR\
    \x0cfailMailList\x12\x18\n\x07retcode\x18\x0c\x20\x01(\rR\x07retcode\x12\
    )\n\x11succ_mail_id_list\x18\x06\x20\x03(\rR\x0esuccMailIdList\x12)\n\na\
    ttachment\x18\x08\x20\x01(\x0b2\t.ItemListR\nattachmentb\x06proto3\
";
