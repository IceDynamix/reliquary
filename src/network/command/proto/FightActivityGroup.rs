...
impl ::protobuf::Message for FightActivityGroup {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.passed_max_difficulty_level != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.passed_max_difficulty_level);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(15, &self.taken_difficulty_level_reward_list);
        if self.endless_max_wave != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.endless_max_wave);
        }
        if self.group_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.passed_max_difficulty_level != 0 {
            os.write_uint32(4, self.passed_max_difficulty_level)?;
        }
        os.write_repeated_packed_uint32(15, &self.taken_difficulty_level_reward_list)?;
        if self.endless_max_wave != 0 {
            os.write_uint32(7, self.endless_max_wave)?;
        }
        if self.group_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x1bpassed_max_difficulty_level\x18\x04\x20\x01(\rR\x18passedMaxDifficul\
    tyLevel\x12J\n\"taken_difficulty_level_reward_list\x18\x0f\x20\x03(\rR\
    \x1etakenDifficultyLevelRewardList\x12(\n\x10endless_max_wave\x18\x07\
    \x20\x01(\rR\x0eendlessMaxWave\x12\x19\n\x08group_id\x18\n\x20\x01(\rR\
