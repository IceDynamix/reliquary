...
impl ::protobuf::Message for PropRogueInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.CCDEPAPJNKO != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.CCDEPAPJNKO);
        }
        if self.room_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.CCDEPAPJNKO != 0 {
            os.write_uint32(7, self.CCDEPAPJNKO)?;
        }
        if self.room_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    PJNKO\x18\x07\x20\x01(\rR\x0bCCDEPAPJNKO\x12\x17\n\x07room_id\x18\x0e\
    \x20\x01(\rR\x06roomId\x12\x17\n\x07site_id\x18\x0c\x20\x01(\rR\x06siteI\
    d\x12\x20\n\x0bBBNFIIFMGAK\x18\r\x20\x01(\rR\x0bBBNFIIFMGAKb\x06proto3\
";
