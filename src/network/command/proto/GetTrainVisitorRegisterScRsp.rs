...
impl ::protobuf::Message for GetTrainVisitorRegisterScRsp {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(7, &self.FAMHPMFOIJH);
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(7, &self.FAMHPMFOIJH)?;
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x01\n\x1cGetTrainVisitorRegisterScRsp\x12\x20\n\x0bFAMHPMFOIJH\x18\x07\
    \x20\x03(\rR\x0bFAMHPMFOIJH\x12\x18\n\x07retcode\x18\n\x20\x01(\rR\x07re\
    tcode\x12.\n\x0bFDMFKALJBAJ\x18\x03\x20\x03(\x0b2\x0c.HGLKMJFEHMBR\x0bFD\
    MFKALJBAJb\x06proto3\
";
