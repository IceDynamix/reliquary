...
impl EnterFantasticStoryActivityStageScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "OFHBPNGDEGO",
            |m: &EnterFantasticStoryActivityStageScRsp| { &m.OFHBPNGDEGO },
            |m: &mut EnterFantasticStoryActivityStageScRsp| { &mut m.OFHBPNGDEGO },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "retcode",
...
impl ::protobuf::Message for EnterFantasticStoryActivityStageScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.OFHBPNGDEGO != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.OFHBPNGDEGO);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.OFHBPNGDEGO != 0 {
            os.write_uint32(11, self.OFHBPNGDEGO)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    nfo\x18\x02\x20\x01(\x0b2\x10.SceneBattleInfoR\nbattleInfo\x12\x1b\n\tba\
    ttle_id\x18\n\x20\x01(\rR\x08battleId\x12\x20\n\x0bOFHBPNGDEGO\x18\x0b\
    \x20\x01(\rR\x0bOFHBPNGDEGO\x12\x18\n\x07retcode\x18\r\x20\x01(\rR\x07re\
    tcodeb\x06proto3\
";
