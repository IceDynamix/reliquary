...
pub struct EnterFantasticStoryActivityStageScRsp {
    ...
    pub retcode: u32,
    // @@protoc_insertion_point(field:EnterFantasticStoryActivityStageScRsp.fantastic_story_id)
...
impl EnterFantasticStoryActivityStageScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "fantastic_story_id",
            |m: &EnterFantasticStoryActivityStageScRsp| { &m.fantastic_story_id },
            |m: &mut EnterFantasticStoryActivityStageScRsp| { &mut m.fantastic_story_id },
        ));
...
impl ::protobuf::Message for EnterFantasticStoryActivityStageScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.fantastic_story_id != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.fantastic_story_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.fantastic_story_id != 0 {
            os.write_uint32(5, self.fantastic_story_id)?;
        }
        if let Some(v) = self.battle_info.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    de\x18\x04\x20\x01(\rR\x07retcode\x12,\n\x12fantastic_story_id\x18\x05\
    \x20\x01(\rR\x10fantasticStoryId\x121\n\x0bbattle_info\x18\x07\x20\x01(\
    \x0b2\x10.SceneBattleInfoR\nbattleInfo\x12\x1b\n\tbattle_id\x18\x0b\x20\
    \x01(\rR\x08battleIdb\x06proto3\
";
