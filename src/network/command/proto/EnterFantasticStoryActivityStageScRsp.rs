...
pub struct EnterFantasticStoryActivityStageScRsp {
    ...
    pub BEJCALDILNC: u32,
    // @@protoc_insertion_point(field:EnterFantasticStoryActivityStageScRsp.BOKLGJNLFFP)
    pub BOKLGJNLFFP: u32,
    // @@protoc_insertion_point(field:EnterFantasticStoryActivityStageScRsp.BANFFJDIPIE)
...
impl EnterFantasticStoryActivityStageScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "BOKLGJNLFFP",
            |m: &EnterFantasticStoryActivityStageScRsp| { &m.BOKLGJNLFFP },
            |m: &mut EnterFantasticStoryActivityStageScRsp| { &mut m.BOKLGJNLFFP },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::CMBHDGKGPGP::CMBHDGKGPGP>(
            "BANFFJDIPIE",
            |m: &EnterFantasticStoryActivityStageScRsp| { &m.BANFFJDIPIE },
            |m: &mut EnterFantasticStoryActivityStageScRsp| { &mut m.BANFFJDIPIE },
        ));
...
impl ::protobuf::Message for EnterFantasticStoryActivityStageScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.BOKLGJNLFFP != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.BOKLGJNLFFP);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.BOKLGJNLFFP != 0 {
            os.write_uint32(9, self.BOKLGJNLFFP)?;
        }
        if let Some(v) = self.BANFFJDIPIE.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n+EnterFantasticStoryActivityStageScRsp.proto\x1a\x11CMBHDGKGPGP.proto\
    \"\xb5\x01\n%EnterFantasticStoryActivityStageScRsp\x12\x18\n\x07retcode\
    \x18\x04\x20\x01(\rR\x07retcode\x12\x20\n\x0bBEJCALDILNC\x18\x0c\x20\x01\
    (\rR\x0bBEJCALDILNC\x12\x20\n\x0bBOKLGJNLFFP\x18\t\x20\x01(\rR\x0bBOKLGJ\
    NLFFP\x12.\n\x0bBANFFJDIPIE\x18\x0f\x20\x01(\x0b2\x0c.CMBHDGKGPGPR\x0bBA\
    NFFJDIPIEb\x06proto3\
";
