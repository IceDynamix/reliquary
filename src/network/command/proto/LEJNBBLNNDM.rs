...
//! Generated file from `LEJNBBLNNDM.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:LEJNBBLNNDM)
...
impl<'a> ::std::default::Default for &'a LEJNBBLNNDM {
    fn default() -> &'a LEJNBBLNNDM {
        <LEJNBBLNNDM as ::protobuf::Message>::default_instance()
    }
}

impl LEJNBBLNNDM {
    pub fn new() -> LEJNBBLNNDM {
...
impl ::protobuf::Message for LEJNBBLNNDM {
    const NAME: &'static str = "LEJNBBLNNDM";
...
impl ::protobuf::MessageFull for LEJNBBLNNDM {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("LEJNBBLNNDM").unwrap()).clone()
    }
}

impl ::std::fmt::Display for LEJNBBLNNDM {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for LEJNBBLNNDM {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::EPKGFJDJMHM::file_descriptor().clone());
            deps.push(super::OBEBKODGODB::file_descriptor().clone());
            let mut messages = ::std::vec::Vec::with_capacity(1);
            messages.push(LEJNBBLNNDM::generated_message_descriptor_data());
