...
pub struct CGJHGMIMBFB {
    // message fields
    // @@protoc_insertion_point(field:CGJHGMIMBFB.config_id)
    pub config_id: u32,
    // @@protoc_insertion_point(field:CGJHGMIMBFB.state)
    pub state: u32,
    // @@protoc_insertion_point(field:CGJHGMIMBFB.group_id)
    pub group_id: u32,
    // special fields
...
impl CGJHGMIMBFB {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "config_id",
            |m: &CGJHGMIMBFB| { &m.config_id },
            |m: &mut CGJHGMIMBFB| { &mut m.config_id },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "state",
            |m: &CGJHGMIMBFB| { &m.state },
            |m: &mut CGJHGMIMBFB| { &mut m.state },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "group_id",
            |m: &CGJHGMIMBFB| { &m.group_id },
            |m: &mut CGJHGMIMBFB| { &mut m.group_id },
        ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x11CGJHGMIMBFB.proto\"[\n\x0bCGJHGMIMBFB\x12\x1b\n\tconfig_id\x18\x05\
    \x20\x01(\rR\x08configId\x12\x14\n\x05state\x18\x0f\x20\x01(\rR\x05state\
