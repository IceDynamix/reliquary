...
impl ::protobuf::Message for Equipment {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.equip_avatar_id != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.equip_avatar_id);
        }
        if self.rank != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.equip_avatar_id != 0 {
            os.write_uint32(12, self.equip_avatar_id)?;
        }
        if self.rank != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x06\x20\x01(\x08R\x0bisProtected\x12&\n\x0fequip_avatar_id\x18\x0c\
    \x20\x01(\rR\requipAvatarId\x12\x12\n\x04rank\x18\t\x20\x01(\rR\x04rank\
    \x12\x1b\n\tunique_id\x18\x02\x20\x01(\rR\x08uniqueId\x12\x10\n\x03tid\
    \x18\x05\x20\x01(\rR\x03tidb\x06proto3\
";
