...
impl ::protobuf::Message for DailyFirstEnterMonopolyActivityScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.IIHKIKLIOJI != 0 {
            my_size += ::protobuf::rt::int64_size(5, self.IIHKIKLIOJI);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.IIHKIKLIOJI != 0 {
            os.write_int64(5, self.IIHKIKLIOJI)?;
        }
        if let Some(v) = self.LJAOGAPDFHA.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \xd6\x01\n$DailyFirstEnterMonopolyActivityScRsp\x12\x18\n\x07retcode\x18\
    \x04\x20\x01(\rR\x07retcode\x12\x20\n\x0bIIHKIKLIOJI\x18\x05\x20\x01(\
    \x03R\x0bIIHKIKLIOJI\x12.\n\x0bLJAOGAPDFHA\x18\r\x20\x01(\x0b2\x0c.AEDKP\
    BFCKGOR\x0bLJAOGAPDFHA\x12\x20\n\x0bOICAGHGMMFP\x18\x03\x20\x01(\x08R\
    \x0bOICAGHGMMFP\x12\x20\n\x0bKEKJCDMIDDL\x18\x01\x20\x01(\rR\x0bKEKJCDMI\
    DDLb\x06proto3\
";
