...
impl ::protobuf::Message for DailyFirstEnterMonopolyActivityScRsp {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.OICAGHGMMFP != false {
            os.write_bool(4, self.OICAGHGMMFP)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x0c\x20\x01(\x03R\x0bIIHKIKLIOJI\x12.\n\x0bLJAOGAPDFHA\x18\r\x20\
    \x01(\x0b2\x0c.AEDKPBFCKGOR\x0bLJAOGAPDFHA\x12\x20\n\x0bKEKJCDMIDDL\x18\
    \x01\x20\x01(\rR\x0bKEKJCDMIDDL\x12\x20\n\x0bOICAGHGMMFP\x18\x04\x20\x01\
