...
pub struct DailyFirstEnterMonopolyActivityScRsp {
    // message fields
    // @@protoc_insertion_point(field:DailyFirstEnterMonopolyActivityScRsp.EODILEHJIFE)
    pub EODILEHJIFE: ::protobuf::MessageField<super::AEDKPBFCKGO::AEDKPBFCKGO>,
    // @@protoc_insertion_point(field:DailyFirstEnterMonopolyActivityScRsp.POFGBOLONNN)
    pub POFGBOLONNN: u32,
    // @@protoc_insertion_point(field:DailyFirstEnterMonopolyActivityScRsp.OLADEOGLAGI)
    pub OLADEOGLAGI: i64,
    // @@protoc_insertion_point(field:DailyFirstEnterMonopolyActivityScRsp.retcode)
    pub retcode: u32,
    // @@protoc_insertion_point(field:DailyFirstEnterMonopolyActivityScRsp.KHPPLKIBFEP)
    pub KHPPLKIBFEP: bool,
    // special fields
...
impl DailyFirstEnterMonopolyActivityScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::AEDKPBFCKGO::AEDKPBFCKGO>(
            "EODILEHJIFE",
            |m: &DailyFirstEnterMonopolyActivityScRsp| { &m.EODILEHJIFE },
            |m: &mut DailyFirstEnterMonopolyActivityScRsp| { &mut m.EODILEHJIFE },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "POFGBOLONNN",
            |m: &DailyFirstEnterMonopolyActivityScRsp| { &m.POFGBOLONNN },
            |m: &mut DailyFirstEnterMonopolyActivityScRsp| { &mut m.POFGBOLONNN },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "OLADEOGLAGI",
            |m: &DailyFirstEnterMonopolyActivityScRsp| { &m.OLADEOGLAGI },
            |m: &mut DailyFirstEnterMonopolyActivityScRsp| { &mut m.OLADEOGLAGI },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "retcode",
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "KHPPLKIBFEP",
            |m: &DailyFirstEnterMonopolyActivityScRsp| { &m.KHPPLKIBFEP },
            |m: &mut DailyFirstEnterMonopolyActivityScRsp| { &mut m.KHPPLKIBFEP },
        ));
...
impl ::protobuf::Message for DailyFirstEnterMonopolyActivityScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.OLADEOGLAGI != 0 {
            my_size += ::protobuf::rt::int64_size(6, self.OLADEOGLAGI);
        }
        if self.retcode != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.retcode);
        }
        if self.KHPPLKIBFEP != false {
            my_size += 1 + 1;
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.OLADEOGLAGI != 0 {
            os.write_int64(6, self.OLADEOGLAGI)?;
        }
        if self.retcode != 0 {
            os.write_uint32(7, self.retcode)?;
        }
        if self.KHPPLKIBFEP != false {
            os.write_bool(15, self.KHPPLKIBFEP)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x01\x20\x01(\x0b2\x0c.AEDKPBFCKGOR\x0bEODILEHJIFE\x12\x20\n\x0bPOFG\
    BOLONNN\x18\x02\x20\x01(\rR\x0bPOFGBOLONNN\x12\x20\n\x0bOLADEOGLAGI\x18\
    \x06\x20\x01(\x03R\x0bOLADEOGLAGI\x12\x18\n\x07retcode\x18\x07\x20\x01(\
    \rR\x07retcode\x12\x20\n\x0bKHPPLKIBFEP\x18\x0f\x20\x01(\x08R\x0bKHPPLKI\
    BFEPb\x06proto3\
";
