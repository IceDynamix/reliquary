...
impl ::protobuf::Message for DailyFirstEnterMonopolyActivityScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.IIHKIKLIOJI != 0 {
            my_size += ::protobuf::rt::int64_size(6, self.IIHKIKLIOJI);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.IIHKIKLIOJI != 0 {
            os.write_int64(6, self.IIHKIKLIOJI)?;
        }
        if let Some(v) = self.LJAOGAPDFHA.as_ref() {
            ::protobuf::rt::write_message_field_with_cached_size(12, v, os)?;
        }
        if self.OICAGHGMMFP != false {
            os.write_bool(10, self.OICAGHGMMFP)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x0b\x20\x01(\rR\x0bKEKJCDMIDDL\x12\x20\n\x0bIIHKIKLIOJI\x18\x06\x20\
    \x01(\x03R\x0bIIHKIKLIOJI\x12.\n\x0bLJAOGAPDFHA\x18\x0c\x20\x01(\x0b2\
    \x0c.AEDKPBFCKGOR\x0bLJAOGAPDFHA\x12\x20\n\x0bOICAGHGMMFP\x18\n\x20\x01(\
    \x08R\x0bOICAGHGMMFP\x12\x18\n\x07retcode\x18\x03\x20\x01(\rR\x07retcode\
    b\x06proto3\
";
