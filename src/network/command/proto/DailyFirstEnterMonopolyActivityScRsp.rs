...
impl ::protobuf::Message for DailyFirstEnterMonopolyActivityScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.KEKJCDMIDDL != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.KEKJCDMIDDL);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.OICAGHGMMFP != false {
            os.write_bool(2, self.OICAGHGMMFP)?;
        }
        if self.KEKJCDMIDDL != 0 {
            os.write_uint32(14, self.KEKJCDMIDDL)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x02\x20\x01(\x08R\x0bOICAGHGMMFP\x12\x20\n\x0bKEKJCDMIDDL\x18\x0e\
    \x20\x01(\rR\x0bKEKJCDMIDDL\x12\x18\n\x07retcode\x18\x0f\x20\x01(\rR\x07\
    retcode\x12.\n\x0bLJAOGAPDFHA\x18\x07\x20\x01(\x0b2\x0c.AEDKPBFCKGOR\x0b\
    LJAOGAPDFHA\x12\x20\n\x0bIIHKIKLIOJI\x18\n\x20\x01(\x03R\x0bIIHKIKLIOJIb\
    \x06proto3\
";
