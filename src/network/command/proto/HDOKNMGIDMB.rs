...
//! Generated file from `HDOKNMGIDMB.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:HDOKNMGIDMB)
...
pub struct HDOKNMGIDMB {
    ...
    // special fields
    // @@protoc_insertion_point(special_field:HDOKNMGIDMB.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a HDOKNMGIDMB {
    fn default() -> &'a HDOKNMGIDMB {
        <HDOKNMGIDMB as ::protobuf::Message>::default_instance()
    }
}

impl HDOKNMGIDMB {
    pub fn new() -> HDOKNMGIDMB {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "KPCPABKPAKL",
            |m: &HDOKNMGIDMB| { &m.KPCPABKPAKL },
            |m: &mut HDOKNMGIDMB| { &mut m.KPCPABKPAKL },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<HDOKNMGIDMB>(
            "HDOKNMGIDMB",
            fields,
            oneofs,
        )
...
impl ::protobuf::Message for HDOKNMGIDMB {
    const NAME: &'static str = "HDOKNMGIDMB";
...
impl ::protobuf::MessageFull for HDOKNMGIDMB {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("HDOKNMGIDMB").unwrap()).clone()
    }
}

impl ::std::fmt::Display for HDOKNMGIDMB {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for HDOKNMGIDMB {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::HBJLNKAFNAD::file_descriptor().clone());
            let mut messages = ::std::vec::Vec::with_capacity(1);
            messages.push(HDOKNMGIDMB::generated_message_descriptor_data());
