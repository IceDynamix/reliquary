...
//! Generated file from `FeatureSwitchParam.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:FeatureSwitchParam)
...
impl<'a> ::std::default::Default for &'a FeatureSwitchParam {
    fn default() -> &'a FeatureSwitchParam {
        <FeatureSwitchParam as ::protobuf::Message>::default_instance()
    }
}

impl FeatureSwitchParam {
    pub fn new() -> FeatureSwitchParam {
...
impl ::protobuf::Message for FeatureSwitchParam {
    const NAME: &'static str = "FeatureSwitchParam";
    ...
    fn new() -> FeatureSwitchParam {
        FeatureSwitchParam::new()
    }
...
impl ::protobuf::MessageFull for FeatureSwitchParam {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("FeatureSwitchParam").unwrap()).clone()
    }
}

impl ::std::fmt::Display for FeatureSwitchParam {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for FeatureSwitchParam {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(FeatureSwitchParam::generated_message_descriptor_data());
