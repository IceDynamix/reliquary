...
impl ::protobuf::Message for FightFestUpdateChallengeRecordNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.DJFGDMIDEHJ != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.DJFGDMIDEHJ);
        }
        if self.turn_left != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.DJFGDMIDEHJ != 0 {
            os.write_uint32(13, self.DJFGDMIDEHJ)?;
        }
        if self.turn_left != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x01\x20\x01(\x0e2\x0c.BGLIMCBGLAJR\x0bHMBBBNKAILD\x12!\n\x0cchallen\
    ge_id\x18\x04\x20\x01(\rR\x0bchallengeId\x12\x20\n\x04rank\x18\n\x20\x01\
    (\x0e2\x0c.BGLIMCBGLAJR\x04rank\x12\x20\n\x0bDJFGDMIDEHJ\x18\r\x20\x01(\
    \rR\x0bDJFGDMIDEHJ\x12\x1b\n\tturn_left\x18\x0f\x20\x01(\rR\x08turnLeftb\
    \x06proto3\
";
