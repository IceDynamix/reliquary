...
pub struct FightFestUpdateChallengeRecordNotify {
    ...
    pub rank: ::protobuf::EnumOrUnknown<super::OBCMKEJOEJO::OBCMKEJOEJO>,
    // @@protoc_insertion_point(field:FightFestUpdateChallengeRecordNotify.FECHALOFCND)
    pub FECHALOFCND: ::protobuf::EnumOrUnknown<super::OBCMKEJOEJO::OBCMKEJOEJO>,
    // @@protoc_insertion_point(field:FightFestUpdateChallengeRecordNotify.KELPPDFFLHC)
    pub KELPPDFFLHC: u32,
    // special fields
...
impl FightFestUpdateChallengeRecordNotify {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "FECHALOFCND",
            |m: &FightFestUpdateChallengeRecordNotify| { &m.FECHALOFCND },
            |m: &mut FightFestUpdateChallengeRecordNotify| { &mut m.FECHALOFCND },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "KELPPDFFLHC",
            |m: &FightFestUpdateChallengeRecordNotify| { &m.KELPPDFFLHC },
            |m: &mut FightFestUpdateChallengeRecordNotify| { &mut m.KELPPDFFLHC },
        ));
...
impl ::protobuf::Message for FightFestUpdateChallengeRecordNotify {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                56 => {
                    self.FECHALOFCND = is.read_enum_or_unknown()?;
                },
                88 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.rank != ::protobuf::EnumOrUnknown::new(super::OBCMKEJOEJO::OBCMKEJOEJO::OBCMKEJOEJO_HDDNCGLDBFM) {
            my_size += ::protobuf::rt::int32_size(1, self.rank.value());
        }
        if self.FECHALOFCND != ::protobuf::EnumOrUnknown::new(super::OBCMKEJOEJO::OBCMKEJOEJO::OBCMKEJOEJO_HDDNCGLDBFM) {
            my_size += ::protobuf::rt::int32_size(7, self.FECHALOFCND.value());
        }
        if self.KELPPDFFLHC != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.KELPPDFFLHC);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.rank != ::protobuf::EnumOrUnknown::new(super::OBCMKEJOEJO::OBCMKEJOEJO::OBCMKEJOEJO_HDDNCGLDBFM) {
            os.write_enum(1, ::protobuf::EnumOrUnknown::value(&self.rank))?;
        }
        if self.FECHALOFCND != ::protobuf::EnumOrUnknown::new(super::OBCMKEJOEJO::OBCMKEJOEJO::OBCMKEJOEJO_HDDNCGLDBFM) {
            os.write_enum(7, ::protobuf::EnumOrUnknown::value(&self.FECHALOFCND))?;
        }
        if self.KELPPDFFLHC != 0 {
            os.write_uint32(11, self.KELPPDFFLHC)?;
        }
    ...
    fn clear(&mut self) {
        self.challenge_id = 0;
        self.turn_left = 0;
        self.rank = ::protobuf::EnumOrUnknown::new(super::OBCMKEJOEJO::OBCMKEJOEJO::OBCMKEJOEJO_HDDNCGLDBFM);
        self.FECHALOFCND = ::protobuf::EnumOrUnknown::new(super::OBCMKEJOEJO::OBCMKEJOEJO::OBCMKEJOEJO_HDDNCGLDBFM);
        self.KELPPDFFLHC = 0;
    ...
    fn default_instance() -> &'static FightFestUpdateChallengeRecordNotify {
        static instance: FightFestUpdateChallengeRecordNotify = FightFestUpdateChallengeRecordNotify {
            ...
            FECHALOFCND: ::protobuf::EnumOrUnknown::from_i32(0),
            KELPPDFFLHC: 0,
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n*FightFestUpdateChallengeRecordNotify.proto\x1a\x11OBCMKEJOEJO.proto\"\
    \xda\x01\n$FightFestUpdateChallengeRecordNotify\x12!\n\x0cchallenge_id\
    \x18\x08\x20\x01(\rR\x0bchallengeId\x12\x1b\n\tturn_left\x18\x0e\x20\x01\
    (\rR\x08turnLeft\x12\x20\n\x04rank\x18\x01\x20\x01(\x0e2\x0c.OBCMKEJOEJO\
    R\x04rank\x12.\n\x0bFECHALOFCND\x18\x07\x20\x01(\x0e2\x0c.OBCMKEJOEJOR\
    \x0bFECHALOFCND\x12\x20\n\x0bKELPPDFFLHC\x18\x0b\x20\x01(\rR\x0bKELPPDFF\
    LHCb\x06proto3\
";
