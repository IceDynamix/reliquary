...
//! Generated file from `KGPIEEKIEME.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:KGPIEEKIEME)
...
impl<'a> ::std::default::Default for &'a KGPIEEKIEME {
    fn default() -> &'a KGPIEEKIEME {
        <KGPIEEKIEME as ::protobuf::Message>::default_instance()
    }
}

impl KGPIEEKIEME {
    pub fn new() -> KGPIEEKIEME {
...
impl ::protobuf::Message for KGPIEEKIEME {
    const NAME: &'static str = "KGPIEEKIEME";
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.OFNIDAECPCJ != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.OFNIDAECPCJ);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.OFNIDAECPCJ != 0 {
            os.write_uint32(9, self.OFNIDAECPCJ)?;
        }
...
impl ::protobuf::MessageFull for KGPIEEKIEME {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("KGPIEEKIEME").unwrap()).clone()
    }
}

impl ::std::fmt::Display for KGPIEEKIEME {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for KGPIEEKIEME {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x11KGPIEEKIEME.proto\x1a\x11FDBDLBAPDBE.proto\"_\n\x0bKGPIEEKIEME\x12\
    .\n\x0bJCOBJAMPOAL\x18\x0c\x20\x01(\x0b2\x0c.FDBDLBAPDBER\x0bJCOBJAMPOAL\
    \x12\x20\n\x0bOFNIDAECPCJ\x18\t\x20\x01(\rR\x0bOFNIDAECPCJb\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(KGPIEEKIEME::generated_message_descriptor_data());
