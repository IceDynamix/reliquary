...
pub struct GetRogueExhibitionScRsp {
    // message fields
    // @@protoc_insertion_point(field:GetRogueExhibitionScRsp.GMMPICLBEDO)
    pub GMMPICLBEDO: ::std::vec::Vec<super::DMODINLGCCB::DMODINLGCCB>,
    // @@protoc_insertion_point(field:GetRogueExhibitionScRsp.JOACHBOBMPH)
    pub JOACHBOBMPH: ::std::vec::Vec<super::GBPFLAGFAIJ::GBPFLAGFAIJ>,
...
impl GetRogueExhibitionScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "GMMPICLBEDO",
            |m: &GetRogueExhibitionScRsp| { &m.GMMPICLBEDO },
            |m: &mut GetRogueExhibitionScRsp| { &mut m.GMMPICLBEDO },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "JOACHBOBMPH",
            |m: &GetRogueExhibitionScRsp| { &m.JOACHBOBMPH },
            |m: &mut GetRogueExhibitionScRsp| { &mut m.JOACHBOBMPH },
        ));
...
impl ::protobuf::Message for GetRogueExhibitionScRsp {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                18 => {
                    self.GMMPICLBEDO.push(is.read_message()?);
                },
                26 => {
                    self.JOACHBOBMPH.push(is.read_message()?);
                },
                48 => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        for value in &self.GMMPICLBEDO {
            let len = value.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
        };
        for value in &self.JOACHBOBMPH {
            let len = value.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
        };
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        for v in &self.GMMPICLBEDO {
            ::protobuf::rt::write_message_field_with_cached_size(2, v, os)?;
        };
        for v in &self.JOACHBOBMPH {
    ...
    fn clear(&mut self) {
        self.GMMPICLBEDO.clear();
        self.JOACHBOBMPH.clear();
        self.retcode = 0;
    ...
    fn default_instance() -> &'static GetRogueExhibitionScRsp {
        static instance: GetRogueExhibitionScRsp = GetRogueExhibitionScRsp {
            GMMPICLBEDO: ::std::vec::Vec::new(),
            JOACHBOBMPH: ::std::vec::Vec::new(),
            retcode: 0,
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    DO\x18\x02\x20\x03(\x0b2\x0c.DMODINLGCCBR\x0bGMMPICLBEDO\x12.\n\x0bJOACH\
    BOBMPH\x18\x03\x20\x03(\x0b2\x0c.GBPFLAGFAIJR\x0bJOACHBOBMPH\x12\x18\n\
