...
impl ::protobuf::Message for TakeChallengePeakRewardScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.peak_group_id != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.peak_group_id);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.peak_group_id != 0 {
            os.write_uint32(10, self.peak_group_id)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    roto\"\xac\x01\n\x1cTakeChallengePeakRewardScRsp\x12N\n\x16peak_reward_g\
    roup_list\x18\x04\x20\x03(\x0b2\x19.ChallengePeakRewardGroupR\x13peakRew\
    ardGroupList\x12\"\n\rpeak_group_id\x18\n\x20\x01(\rR\x0bpeakGroupId\x12\
