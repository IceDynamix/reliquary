...
//! Generated file from `GANDCEDCLDL.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:GANDCEDCLDL)
...
pub struct GANDCEDCLDL {
    ...
    pub entity_id: u32,
    // special fields
    // @@protoc_insertion_point(special_field:GANDCEDCLDL.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a GANDCEDCLDL {
    fn default() -> &'a GANDCEDCLDL {
        <GANDCEDCLDL as ::protobuf::Message>::default_instance()
    }
}

impl GANDCEDCLDL {
    pub fn new() -> GANDCEDCLDL {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "entity_id",
            |m: &GANDCEDCLDL| { &m.entity_id },
            |m: &mut GANDCEDCLDL| { &mut m.entity_id },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<GANDCEDCLDL>(
            "GANDCEDCLDL",
            fields,
            oneofs,
        )
...
impl ::protobuf::Message for GANDCEDCLDL {
    const NAME: &'static str = "GANDCEDCLDL";
...
impl ::protobuf::MessageFull for GANDCEDCLDL {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("GANDCEDCLDL").unwrap()).clone()
    }
}

impl ::std::fmt::Display for GANDCEDCLDL {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for GANDCEDCLDL {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(GANDCEDCLDL::generated_message_descriptor_data());
