...
//! Generated file from `AHOMAAHPCIG.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:AHOMAAHPCIG)
...
impl<'a> ::std::default::Default for &'a AHOMAAHPCIG {
    fn default() -> &'a AHOMAAHPCIG {
        <AHOMAAHPCIG as ::protobuf::Message>::default_instance()
    }
}

impl AHOMAAHPCIG {
    pub fn new() -> AHOMAAHPCIG {
...
impl ::protobuf::Message for AHOMAAHPCIG {
    const NAME: &'static str = "AHOMAAHPCIG";
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(3, &self.DAPJMJMGCFC);
        my_size += ::protobuf::rt::vec_packed_uint32_size(13, &self.EKJDLEFFGHD);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(3, &self.DAPJMJMGCFC)?;
        os.write_repeated_packed_uint32(13, &self.EKJDLEFFGHD)?;
...
impl ::protobuf::MessageFull for AHOMAAHPCIG {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("AHOMAAHPCIG").unwrap()).clone()
    }
}

impl ::std::fmt::Display for AHOMAAHPCIG {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for AHOMAAHPCIG {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x11AHOMAAHPCIG.proto\"Q\n\x0bAHOMAAHPCIG\x12\x20\n\x0bDAPJMJMGCFC\x18\
    \x03\x20\x03(\rR\x0bDAPJMJMGCFC\x12\x20\n\x0bEKJDLEFFGHD\x18\r\x20\x03(\
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(AHOMAAHPCIG::generated_message_descriptor_data());
