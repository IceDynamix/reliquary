...
impl ::protobuf::Message for RogueUnlockProgress {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.unlock_id != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.unlock_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.unlock_id != 0 {
            os.write_uint32(6, self.unlock_id)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x08progress\x18\x03\x20\x01(\rR\x08progress\x12\x16\n\x06finish\x18\x08\
    \x20\x01(\x08R\x06finish\x12\x1b\n\tunlock_id\x18\x06\x20\x01(\rR\x08unl\
    ockIdb\x06proto3\
";
