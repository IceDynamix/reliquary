...
//! Generated file from `KCOEJJKGNIG.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:KCOEJJKGNIG)
...
impl<'a> ::std::default::Default for &'a KCOEJJKGNIG {
    fn default() -> &'a KCOEJJKGNIG {
        <KCOEJJKGNIG as ::protobuf::Message>::default_instance()
    }
}

impl KCOEJJKGNIG {
    pub fn new() -> KCOEJJKGNIG {
...
impl ::protobuf::Message for KCOEJJKGNIG {
    const NAME: &'static str = "KCOEJJKGNIG";
...
impl ::protobuf::MessageFull for KCOEJJKGNIG {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("KCOEJJKGNIG").unwrap()).clone()
    }
}

impl ::std::fmt::Display for KCOEJJKGNIG {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for KCOEJJKGNIG {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::ALBLEFHHJIC::file_descriptor().clone());
            let mut messages = ::std::vec::Vec::with_capacity(1);
            messages.push(KCOEJJKGNIG::generated_message_descriptor_data());
