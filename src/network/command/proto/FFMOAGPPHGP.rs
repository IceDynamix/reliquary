...
//! Generated file from `FFMOAGPPHGP.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:FFMOAGPPHGP)
...
pub struct FFMOAGPPHGP {
    ...
    pub KHJKDLNAMIP: u32,
    // special fields
    // @@protoc_insertion_point(special_field:FFMOAGPPHGP.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a FFMOAGPPHGP {
    fn default() -> &'a FFMOAGPPHGP {
        <FFMOAGPPHGP as ::protobuf::Message>::default_instance()
    }
}

impl FFMOAGPPHGP {
    pub fn new() -> FFMOAGPPHGP {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "KHJKDLNAMIP",
            |m: &FFMOAGPPHGP| { &m.KHJKDLNAMIP },
            |m: &mut FFMOAGPPHGP| { &mut m.KHJKDLNAMIP },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<FFMOAGPPHGP>(
            "FFMOAGPPHGP",
            fields,
            oneofs,
        )
...
impl ::protobuf::Message for FFMOAGPPHGP {
    const NAME: &'static str = "FFMOAGPPHGP";
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.KHJKDLNAMIP != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.KHJKDLNAMIP);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.KHJKDLNAMIP != 0 {
            os.write_uint32(5, self.KHJKDLNAMIP)?;
        }
...
impl ::protobuf::MessageFull for FFMOAGPPHGP {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("FFMOAGPPHGP").unwrap()).clone()
    }
}

impl ::std::fmt::Display for FFMOAGPPHGP {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for FFMOAGPPHGP {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0bavatar_type\x18\t\x20\x01(\rR\navatarType\x12\x0e\n\x02hp\x18\x04\
    \x20\x01(\rR\x02hp\x12\x1b\n\tavatar_id\x18\x02\x20\x01(\rR\x08avatarId\
    \x12\x20\n\x0bKHJKDLNAMIP\x18\x05\x20\x01(\rR\x0bKHJKDLNAMIPb\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(FFMOAGPPHGP::generated_message_descriptor_data());
