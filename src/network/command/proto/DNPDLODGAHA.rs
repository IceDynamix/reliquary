...
//! Generated file from `DNPDLODGAHA.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:DNPDLODGAHA)
...
impl<'a> ::std::default::Default for &'a DNPDLODGAHA {
    fn default() -> &'a DNPDLODGAHA {
        <DNPDLODGAHA as ::protobuf::Message>::default_instance()
    }
}

impl DNPDLODGAHA {
    pub fn new() -> DNPDLODGAHA {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::HJNPOBAMKKF::HJNPOBAMKKF>(
            ...
            |m: &mut DNPDLODGAHA| { &mut m.FLFNBPLNNBL },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::HJNPOBAMKKF::HJNPOBAMKKF>(
            "LLMDKAHFIIJ",
...
impl ::protobuf::Message for DNPDLODGAHA {
    const NAME: &'static str = "DNPDLODGAHA";
...
impl ::protobuf::MessageFull for DNPDLODGAHA {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("DNPDLODGAHA").unwrap()).clone()
    }
}

impl ::std::fmt::Display for DNPDLODGAHA {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for DNPDLODGAHA {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::HJNPOBAMKKF::file_descriptor().clone());
            let mut messages = ::std::vec::Vec::with_capacity(1);
            messages.push(DNPDLODGAHA::generated_message_descriptor_data());
