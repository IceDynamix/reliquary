...
impl ::protobuf::Message for UpdateMarkChestCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.trigger_param_id != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.trigger_param_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.trigger_param_id != 0 {
            os.write_uint32(3, self.trigger_param_id)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x14UpdateMarkChestCsReq\x12?\n\x14mark_chest_info_list\x18\x08\x20\x03(\
    \x0b2\x0e.MarkChestInfoR\x11markChestInfoList\x12\x17\n\x07func_id\x18\n\
    \x20\x01(\rR\x06funcId\x12(\n\x10trigger_param_id\x18\x03\x20\x01(\rR\
    \x0etriggerParamIdb\x06proto3\
";
