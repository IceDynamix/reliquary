...
impl ::protobuf::Message for UpdateMarkChestCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.trigger_param_id != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.trigger_param_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.trigger_param_id != 0 {
            os.write_uint32(7, self.trigger_param_id)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0e\x20\x01(\rR\x06funcId\x12(\n\x10trigger_param_id\x18\x07\x20\x01(\r\
    R\x0etriggerParamIdb\x06proto3\
";
