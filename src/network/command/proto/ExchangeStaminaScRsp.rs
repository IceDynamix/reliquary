...
impl ::protobuf::Message for ExchangeStaminaScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.last_recover_time != 0 {
            my_size += ::protobuf::rt::int64_size(8, self.last_recover_time);
        }
        if self.exchange_times != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.exchange_times);
        }
        if self.stamina_add != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.stamina_add);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.last_recover_time != 0 {
            os.write_int64(8, self.last_recover_time)?;
        }
        if self.exchange_times != 0 {
            os.write_uint32(11, self.exchange_times)?;
        }
        if self.stamina_add != 0 {
            os.write_uint32(12, self.stamina_add)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12*\n\x11last_recover_time\x18\x08\x20\x01(\x03R\x0flastRecoverTime\
    \x12%\n\x0eexchange_times\x18\x0b\x20\x01(\rR\rexchangeTimes\x12\x1f\n\
    \x0bstamina_add\x18\x0c\x20\x01(\rR\nstaminaAdd\x12/\n\x0eitem_cost_list\
    \x18\t\x20\x03(\x0b2\t.ItemCostR\x0citemCostListb\x06proto3\
";
