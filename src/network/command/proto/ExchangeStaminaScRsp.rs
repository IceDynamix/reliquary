...
impl ::protobuf::Message for ExchangeStaminaScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.last_recover_time != 0 {
            my_size += ::protobuf::rt::int64_size(6, self.last_recover_time);
        }
        if self.stamina_add != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.stamina_add);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.last_recover_time != 0 {
            os.write_int64(6, self.last_recover_time)?;
        }
        if self.stamina_add != 0 {
            os.write_uint32(10, self.stamina_add)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    changeStaminaScRsp\x12%\n\x0eexchange_times\x18\x02\x20\x01(\rR\rexchang\
    eTimes\x12\x18\n\x07retcode\x18\x03\x20\x01(\rR\x07retcode\x12*\n\x11las\
    t_recover_time\x18\x06\x20\x01(\x03R\x0flastRecoverTime\x12\x1f\n\x0bsta\
    mina_add\x18\n\x20\x01(\rR\nstaminaAdd\x12/\n\x0eitem_cost_list\x18\r\
    \x20\x03(\x0b2\t.ItemCostR\x0citemCostListb\x06proto3\
";
