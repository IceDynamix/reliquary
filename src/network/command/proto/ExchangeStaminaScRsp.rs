...
impl ::protobuf::Message for ExchangeStaminaScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.stamina_add != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.stamina_add);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.stamina_add != 0 {
            os.write_uint32(2, self.stamina_add)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    changeStaminaScRsp\x12/\n\x0eitem_cost_list\x18\x07\x20\x03(\x0b2\t.Item\
    CostR\x0citemCostList\x12%\n\x0eexchange_times\x18\x01\x20\x01(\rR\rexch\
    angeTimes\x12*\n\x11last_recover_time\x18\x04\x20\x01(\x03R\x0flastRecov\
    erTime\x12\x1f\n\x0bstamina_add\x18\x02\x20\x01(\rR\nstaminaAdd\x12\x18\
