...
impl ::protobuf::Message for SummonPetScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.cur_pet_id != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.cur_pet_id);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.cur_pet_id != 0 {
            os.write_uint32(1, self.cur_pet_id)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x01\x20\x01(\rR\x08curPetId\x12\x18\n\x07retcode\x18\x03\x20\x01(\r\
    R\x07retcode\x12\"\n\rselect_pet_id\x18\x08\x20\x01(\rR\x0bselectPetIdb\
    \x06proto3\
";
