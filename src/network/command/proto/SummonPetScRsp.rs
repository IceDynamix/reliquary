...
impl ::protobuf::Message for SummonPetScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.select_pet_id != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.select_pet_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.select_pet_id != 0 {
            os.write_uint32(5, self.select_pet_id)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x0b\x20\x01(\rR\x08curPetId\x12\x18\n\x07retcode\x18\x02\x20\x01(\r\
    R\x07retcode\x12\"\n\rselect_pet_id\x18\x05\x20\x01(\rR\x0bselectPetIdb\
    \x06proto3\
";
