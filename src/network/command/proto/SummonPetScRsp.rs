...
impl ::protobuf::Message for SummonPetScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.select_pet_id != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.select_pet_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.select_pet_id != 0 {
            os.write_uint32(10, self.select_pet_id)?;
        }
        if self.cur_pet_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\n\x20\x01(\rR\x0bselectPetId\x12\x1c\n\ncur_pet_id\x18\x03\x20\x01(\
    \rR\x08curPetId\x12\x18\n\x07retcode\x18\x08\x20\x01(\rR\x07retcodeb\x06\
    proto3\
";
