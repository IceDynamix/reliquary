...
impl ::protobuf::Message for SummonPetScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.select_pet_id != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.select_pet_id);
        }
        if self.cur_pet_id != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.cur_pet_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.select_pet_id != 0 {
            os.write_uint32(8, self.select_pet_id)?;
        }
        if self.cur_pet_id != 0 {
            os.write_uint32(7, self.cur_pet_id)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x06\x20\x01(\rR\x07retcode\x12\"\n\rselect_pet_id\x18\x08\x20\x01(\
    \rR\x0bselectPetId\x12\x1c\n\ncur_pet_id\x18\x07\x20\x01(\rR\x08curPetId\
    b\x06proto3\
";
