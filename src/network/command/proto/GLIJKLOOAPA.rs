...
impl ::protobuf::Message for GLIJKLOOAPA {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.ECFAGNKDAEF != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.ECFAGNKDAEF);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.ECFAGNKDAEF != 0 {
            os.write_uint32(14, self.ECFAGNKDAEF)?;
        }
        if let Some(v) = self.ANCPCPCLJED.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    APA\x12\x20\n\x0bECFAGNKDAEF\x18\x0e\x20\x01(\rR\x0bECFAGNKDAEF\x12.\n\
    \x0bANCPCPCLJED\x18\x0f\x20\x01(\x0b2\x0c.HDCKCHPDMMIR\x0bANCPCPCLJED\
    \x12!\n\x0cgacha_random\x18\t\x20\x01(\rR\x0bgachaRandomb\x06proto3\
";
