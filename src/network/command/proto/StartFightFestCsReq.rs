...
impl ::protobuf::Message for StartFightFestCsReq {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(15, &self.MFGONHJGIPP);
        if self.id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(15, &self.MFGONHJGIPP)?;
        if self.id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x0f\x20\x03(\rR\x0bMFGONHJGIPP\x12\x0e\n\x02id\x18\x08\x20\x01(\rR\
    \x02id\x12\x19\n\x08event_id\x18\x06\x20\x01(\rR\x07eventId\x12-\n\x0bav\
    atar_list\x18\t\x20\x03(\x0b2\x0c.AFODMEJODLGR\navatarList\x12\"\n\x04ty\
    pe\x18\x01\x20\x01(\x0e2\x0e.FightFestTypeR\x04typeb\x06proto3\
";
