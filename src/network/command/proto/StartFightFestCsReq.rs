...
impl ::protobuf::Message for StartFightFestCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(4, &self.GILJLEOAOMA);
        if self.id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_uint32(4, &self.GILJLEOAOMA)?;
        if self.id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x01\x20\x03(\x0b2\x0c.EPCNGNEEMBIR\navatarList\x12\"\n\x04type\x18\x03\
    \x20\x01(\x0e2\x0e.FightFestTypeR\x04type\x12\x20\n\x0bGILJLEOAOMA\x18\
    \x04\x20\x03(\rR\x0bGILJLEOAOMA\x12\x0e\n\x02id\x18\x07\x20\x01(\rR\x02i\
