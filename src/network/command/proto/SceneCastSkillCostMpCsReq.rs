...
impl ::protobuf::Message for SceneCastSkillCostMpCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.cast_entity_id != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.cast_entity_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.cast_entity_id != 0 {
            os.write_uint32(13, self.cast_entity_id)?;
        }
        if self.attacked_by_entity_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0ecast_entity_id\x18\r\x20\x01(\rR\x0ccastEntityId\x121\n\x15attacked_\
    by_entity_id\x18\t\x20\x01(\rR\x12attackedByEntityIdb\x06proto3\
";
