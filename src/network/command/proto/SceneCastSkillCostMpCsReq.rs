...
impl ::protobuf::Message for SceneCastSkillCostMpCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.caster_id != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.caster_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.caster_id != 0 {
            os.write_uint32(9, self.caster_id)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    pCsReq\x12*\n\x11attacked_group_id\x18\x08\x20\x01(\rR\x0fattackedGroupI\
    d\x12\x1f\n\x0bskill_index\x18\x04\x20\x01(\rR\nskillIndex\x12\x1b\n\tca\
    ster_id\x18\t\x20\x01(\rR\x08casterIdb\x06proto3\
";
