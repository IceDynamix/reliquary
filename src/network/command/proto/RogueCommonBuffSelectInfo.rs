...
pub struct RogueCommonBuffSelectInfo {
    ...
    pub roll_buff_cost_data: ::protobuf::MessageField<super::ItemCostList::ItemCostList>,
...
impl ::protobuf::Message for RogueCommonBuffSelectInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.source_cur_count != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.source_cur_count);
        }
        if self.certain_select_buff_id != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.certain_select_buff_id);
        }
        if self.roll_buff_max_count != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.roll_buff_max_count);
        }
        if self.source_total_count != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.source_total_count);
        }
        if self.can_roll != false {
            my_size += 1 + 1;
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(6, &self.handbook_unlock_buff_id_list);
        my_size += ::protobuf::rt::vec_packed_uint32_size(1, &self.first_buff_type_list);
        ...
        if self.source_hint_id != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.source_hint_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.source_cur_count != 0 {
            os.write_uint32(14, self.source_cur_count)?;
        }
        if self.certain_select_buff_id != 0 {
            os.write_uint32(5, self.certain_select_buff_id)?;
        }
        if self.roll_buff_max_count != 0 {
            os.write_uint32(2, self.roll_buff_max_count)?;
        }
        if self.source_total_count != 0 {
            os.write_uint32(12, self.source_total_count)?;
        }
        if self.can_roll != false {
            os.write_bool(10, self.can_roll)?;
        }
        os.write_repeated_packed_uint32(6, &self.handbook_unlock_buff_id_list)?;
        os.write_repeated_packed_uint32(1, &self.first_buff_type_list)?;
        if self.roll_buff_free_count != 0 {
        ...
        if self.source_hint_id != 0 {
            os.write_uint32(3, self.source_hint_id)?;
        }
        if self.roll_buff_count != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    emCostList.proto\x1a%RogueCommonBuffSelectSourceType.proto\"\x9b\x05\n\
    \x19RogueCommonBuffSelectInfo\x12(\n\x10source_cur_count\x18\x0e\x20\x01\
    (\rR\x0esourceCurCount\x123\n\x16certain_select_buff_id\x18\x05\x20\x01(\
    \rR\x13certainSelectBuffId\x12-\n\x13roll_buff_max_count\x18\x02\x20\x01\
    (\rR\x10rollBuffMaxCount\x12,\n\x12source_total_count\x18\x0c\x20\x01(\r\
    R\x10sourceTotalCount\x12\x19\n\x08can_roll\x18\n\x20\x01(\x08R\x07canRo\
    ll\x12>\n\x1chandbook_unlock_buff_id_list\x18\x06\x20\x03(\rR\x18handboo\
    kUnlockBuffIdList\x12/\n\x14first_buff_type_list\x18\x01\x20\x03(\rR\x11\
    firstBuffTypeList\x12/\n\x14roll_buff_free_count\x18\x07\x20\x01(\rR\x11\
    rollBuffFreeCount\x12A\n\x0bsource_type\x18\r\x20\x01(\x0e2\x20.RogueCom\
    monBuffSelectSourceTypeR\nsourceType\x126\n\x10select_buff_list\x18\x0b\
    \x20\x03(\x0b2\x0c.FFAMNKOAIHFR\x0eselectBuffList\x12<\n\x13roll_buff_co\
    st_data\x18\x08\x20\x01(\x0b2\r.ItemCostListR\x10rollBuffCostData\x12$\n\
    \x0esource_hint_id\x18\x03\x20\x01(\rR\x0csourceHintId\x12&\n\x0froll_bu\
    ff_count\x18\x04\x20\x01(\rR\rrollBuffCountb\x06proto3\
";
