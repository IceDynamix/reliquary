...
impl ::protobuf::Message for HNPBFPOOJCO {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.NOPDKLDEKKF != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.NOPDKLDEKKF);
        }
        if self.group_id != 0 {
        ...
        if self.HONEMGCFBGI != ::protobuf::EnumOrUnknown::new(super::OJLJHFNFDKP::OJLJHFNFDKP::UPDATE_REDDOT_NONE) {
            my_size += ::protobuf::rt::int32_size(7, self.HONEMGCFBGI.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.NOPDKLDEKKF != 0 {
            os.write_uint32(10, self.NOPDKLDEKKF)?;
        }
        if self.group_id != 0 {
            os.write_uint32(12, self.group_id)?;
        }
        if self.HONEMGCFBGI != ::protobuf::EnumOrUnknown::new(super::OJLJHFNFDKP::OJLJHFNFDKP::UPDATE_REDDOT_NONE) {
            os.write_enum(7, ::protobuf::EnumOrUnknown::value(&self.HONEMGCFBGI))?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    JCO\x12\x20\n\x0bNOPDKLDEKKF\x18\n\x20\x01(\rR\x0bNOPDKLDEKKF\x12\x19\n\
    \x08group_id\x18\x0c\x20\x01(\rR\x07groupId\x12.\n\x0bHONEMGCFBGI\x18\
    \x07\x20\x01(\x0e2\x0c.OJLJHFNFDKPR\x0bHONEMGCFBGI\x12\x1f\n\x0bswitch_l\
    ist\x18\x03\x20\x03(\rR\nswitchList\x12\x19\n\x08panel_id\x18\x08\x20\
    \x01(\rR\x07panelIdb\x06proto3\
";
