...
//! Generated file from `WorkbenchReforgeBuffFuncInfo.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:WorkbenchReforgeBuffFuncInfo)
...
pub struct WorkbenchReforgeBuffFuncInfo {
    ...
    // @@protoc_insertion_point(field:WorkbenchReforgeBuffFuncInfo.JGEHHOAGFEP)
    pub JGEHHOAGFEP: u32,
...
impl<'a> ::std::default::Default for &'a WorkbenchReforgeBuffFuncInfo {
    fn default() -> &'a WorkbenchReforgeBuffFuncInfo {
        <WorkbenchReforgeBuffFuncInfo as ::protobuf::Message>::default_instance()
    }
}

impl WorkbenchReforgeBuffFuncInfo {
    pub fn new() -> WorkbenchReforgeBuffFuncInfo {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "JGEHHOAGFEP",
            |m: &WorkbenchReforgeBuffFuncInfo| { &m.JGEHHOAGFEP },
            |m: &mut WorkbenchReforgeBuffFuncInfo| { &mut m.JGEHHOAGFEP },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "free_reforge_num",
...
impl ::protobuf::Message for WorkbenchReforgeBuffFuncInfo {
    const NAME: &'static str = "WorkbenchReforgeBuffFuncInfo";
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.JGEHHOAGFEP != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.JGEHHOAGFEP);
        }
        ...
        if self.int_reforge_num_value != 0 {
            my_size += ::protobuf::rt::int32_size(4, self.int_reforge_num_value);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.JGEHHOAGFEP != 0 {
            os.write_uint32(7, self.JGEHHOAGFEP)?;
        }
        if self.free_reforge_num != 0 {
            os.write_uint32(15, self.free_reforge_num)?;
        }
        if self.can_free_reforge != false {
            os.write_bool(3, self.can_free_reforge)?;
        }
        if self.int_reforge_num_value != 0 {
            os.write_int32(4, self.int_reforge_num_value)?;
        }
    ...
    fn new() -> WorkbenchReforgeBuffFuncInfo {
        WorkbenchReforgeBuffFuncInfo::new()
    }
...
impl ::protobuf::MessageFull for WorkbenchReforgeBuffFuncInfo {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("WorkbenchReforgeBuffFuncInfo").unwrap()).clone()
    }
}

impl ::std::fmt::Display for WorkbenchReforgeBuffFuncInfo {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for WorkbenchReforgeBuffFuncInfo {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

static file_descriptor_proto_data: &'static [u8] = b"\
    \n\"WorkbenchReforgeBuffFuncInfo.proto\x1a\x12ItemCostData.proto\"\xf3\
    \x01\n\x1cWorkbenchReforgeBuffFuncInfo\x12*\n\tcost_data\x18\t\x20\x01(\
    \x0b2\r.ItemCostDataR\x08costData\x12\x20\n\x0bJGEHHOAGFEP\x18\x07\x20\
    \x01(\rR\x0bJGEHHOAGFEP\x12(\n\x10free_reforge_num\x18\x0f\x20\x01(\rR\
    \x0efreeReforgeNum\x12(\n\x10can_free_reforge\x18\x03\x20\x01(\x08R\x0ec\
    anFreeReforge\x121\n\x15int_reforge_num_value\x18\x04\x20\x01(\x05R\x12i\
    ntReforgeNumValueb\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(WorkbenchReforgeBuffFuncInfo::generated_message_descriptor_data());
