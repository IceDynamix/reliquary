...
//! Generated file from `AJAOJOEAGML.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:AJAOJOEAGML)
...
pub struct AJAOJOEAGML {
    ...
    pub retcode: u32,
    // special fields
    // @@protoc_insertion_point(special_field:AJAOJOEAGML.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a AJAOJOEAGML {
    fn default() -> &'a AJAOJOEAGML {
        <AJAOJOEAGML as ::protobuf::Message>::default_instance()
    }
}

impl AJAOJOEAGML {
    pub fn new() -> AJAOJOEAGML {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "retcode",
            |m: &AJAOJOEAGML| { &m.retcode },
            |m: &mut AJAOJOEAGML| { &mut m.retcode },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<AJAOJOEAGML>(
            "AJAOJOEAGML",
            fields,
            oneofs,
        )
...
impl ::protobuf::Message for AJAOJOEAGML {
    const NAME: &'static str = "AJAOJOEAGML";
...
impl ::protobuf::MessageFull for AJAOJOEAGML {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("AJAOJOEAGML").unwrap()).clone()
    }
}

impl ::std::fmt::Display for AJAOJOEAGML {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for AJAOJOEAGML {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(AJAOJOEAGML::generated_message_descriptor_data());
