...
//! Generated file from `GNFDPONFLJD.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:GNFDPONFLJD)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct GNFDPONFLJD {
    // message fields
...
impl<'a> ::std::default::Default for &'a GNFDPONFLJD {
    fn default() -> &'a GNFDPONFLJD {
        <GNFDPONFLJD as ::protobuf::Message>::default_instance()
    }
}

impl GNFDPONFLJD {
    pub fn new() -> GNFDPONFLJD {
...
impl ::protobuf::Message for GNFDPONFLJD {
    const NAME: &'static str = "GNFDPONFLJD";
...
impl ::protobuf::MessageFull for GNFDPONFLJD {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("GNFDPONFLJD").unwrap()).clone()
    }
}

impl ::std::fmt::Display for GNFDPONFLJD {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for GNFDPONFLJD {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(GNFDPONFLJD::generated_message_descriptor_data());
