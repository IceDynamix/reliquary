...
impl ::protobuf::Message for ClockParkHandleWaitOperationScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.FICFGDNHNGE != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.FICFGDNHNGE);
        }
        ...
        if self.AHIDJBJGGPP != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.AHIDJBJGGPP);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.FICFGDNHNGE != 0 {
            os.write_uint32(14, self.FICFGDNHNGE)?;
        }
        if let Some(v) = self.battle_info.as_ref() {
            ::protobuf::rt::write_message_field_with_cached_size(11, v, os)?;
        }
        if self.AHIDJBJGGPP != 0 {
            os.write_uint32(8, self.AHIDJBJGGPP)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    usR\x0bJFKDBMDOMNK\x12\x20\n\x0bKOIJFOFFJNJ\x18\r\x20\x01(\rR\x0bKOIJFOF\
    FJNJ\x12\x20\n\x0bFICFGDNHNGE\x18\x0e\x20\x01(\rR\x0bFICFGDNHNGE\x121\n\
    \x0bbattle_info\x18\x0b\x20\x01(\x0b2\x10.SceneBattleInfoR\nbattleInfo\
    \x12\x20\n\x0bAHIDJBJGGPP\x18\x08\x20\x01(\rR\x0bAHIDJBJGGPP\x12\x18\n\
