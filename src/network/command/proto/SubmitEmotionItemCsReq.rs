...
pub struct SubmitEmotionItemCsReq {
    // message fields
    // @@protoc_insertion_point(field:SubmitEmotionItemCsReq.script_id)
    pub script_id: u32,
    // @@protoc_insertion_point(field:SubmitEmotionItemCsReq.AHGGBPGLLME)
    pub AHGGBPGLLME: u32,
    // @@protoc_insertion_point(field:SubmitEmotionItemCsReq.item_list)
...
impl SubmitEmotionItemCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "script_id",
            |m: &SubmitEmotionItemCsReq| { &m.script_id },
            |m: &mut SubmitEmotionItemCsReq| { &mut m.script_id },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "AHGGBPGLLME",
            |m: &SubmitEmotionItemCsReq| { &m.AHGGBPGLLME },
            |m: &mut SubmitEmotionItemCsReq| { &mut m.AHGGBPGLLME },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::ItemList::ItemList>(
            "item_list",
            |m: &SubmitEmotionItemCsReq| { &m.item_list },
            |m: &mut SubmitEmotionItemCsReq| { &mut m.item_list },
        ));
...
impl ::protobuf::Message for SubmitEmotionItemCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.AHGGBPGLLME != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.AHGGBPGLLME);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.AHGGBPGLLME != 0 {
            os.write_uint32(4, self.AHGGBPGLLME)?;
        }
        if let Some(v) = self.item_list.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1cSubmitEmotionItemCsReq.proto\x1a\x0eItemList.proto\"\x7f\n\x16Subm\
    itEmotionItemCsReq\x12\x1b\n\tscript_id\x18\t\x20\x01(\rR\x08scriptId\
    \x12\x20\n\x0bAHGGBPGLLME\x18\x04\x20\x01(\rR\x0bAHGGBPGLLME\x12&\n\tite\
    m_list\x18\x07\x20\x01(\x0b2\t.ItemListR\x08itemListb\x06proto3\
";
