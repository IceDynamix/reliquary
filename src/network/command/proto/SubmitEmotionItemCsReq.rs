...
pub struct SubmitEmotionItemCsReq {
    // message fields
    // @@protoc_insertion_point(field:SubmitEmotionItemCsReq.ELOJPKNFLHM)
    pub ELOJPKNFLHM: u32,
...
impl SubmitEmotionItemCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "ELOJPKNFLHM",
            |m: &SubmitEmotionItemCsReq| { &m.ELOJPKNFLHM },
            |m: &mut SubmitEmotionItemCsReq| { &mut m.ELOJPKNFLHM },
        ));
...
impl ::protobuf::Message for SubmitEmotionItemCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.ELOJPKNFLHM != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.ELOJPKNFLHM);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.ELOJPKNFLHM != 0 {
            os.write_uint32(1, self.ELOJPKNFLHM)?;
        }
        if let Some(v) = self.item_list.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    itEmotionItemCsReq\x12\x20\n\x0bELOJPKNFLHM\x18\x01\x20\x01(\rR\x0bELOJP\
    KNFLHM\x12&\n\titem_list\x18\t\x20\x01(\x0b2\t.ItemListR\x08itemList\x12\
