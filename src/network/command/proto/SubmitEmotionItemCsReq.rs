...
impl ::protobuf::Message for SubmitEmotionItemCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.FIHNCOABELA != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.FIHNCOABELA);
        }
        if self.script_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.FIHNCOABELA != 0 {
            os.write_uint32(13, self.FIHNCOABELA)?;
        }
        if self.script_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    itEmotionItemCsReq\x12&\n\titem_list\x18\x06\x20\x01(\x0b2\t.ItemListR\
    \x08itemList\x12\x20\n\x0bFIHNCOABELA\x18\r\x20\x01(\rR\x0bFIHNCOABELA\
