...
impl ::protobuf::Message for SubmitEmotionItemCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.FIHNCOABELA != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.FIHNCOABELA);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.FIHNCOABELA != 0 {
            os.write_uint32(4, self.FIHNCOABELA)?;
        }
        if let Some(v) = self.item_list.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    itEmotionItemCsReq\x12\x20\n\x0bFIHNCOABELA\x18\x04\x20\x01(\rR\x0bFIHNC\
    OABELA\x12&\n\titem_list\x18\x0b\x20\x01(\x0b2\t.ItemListR\x08itemList\
