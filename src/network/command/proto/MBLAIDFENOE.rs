...
//! Generated file from `MBLAIDFENOE.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:MBLAIDFENOE)
...
impl<'a> ::std::default::Default for &'a MBLAIDFENOE {
    fn default() -> &'a MBLAIDFENOE {
        <MBLAIDFENOE as ::protobuf::Message>::default_instance()
    }
}

impl MBLAIDFENOE {
    pub fn new() -> MBLAIDFENOE {
...
impl ::protobuf::Message for MBLAIDFENOE {
    const NAME: &'static str = "MBLAIDFENOE";
...
impl ::protobuf::MessageFull for MBLAIDFENOE {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("MBLAIDFENOE").unwrap()).clone()
    }
}

impl ::std::fmt::Display for MBLAIDFENOE {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for MBLAIDFENOE {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::GJCOFAFLAEI::file_descriptor().clone());
            let mut messages = ::std::vec::Vec::with_capacity(1);
            messages.push(MBLAIDFENOE::generated_message_descriptor_data());
