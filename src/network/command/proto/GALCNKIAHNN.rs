...
//! Generated file from `GALCNKIAHNN.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:GALCNKIAHNN)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct GALCNKIAHNN {
    // message fields
...
impl<'a> ::std::default::Default for &'a GALCNKIAHNN {
    fn default() -> &'a GALCNKIAHNN {
        <GALCNKIAHNN as ::protobuf::Message>::default_instance()
    }
}

impl GALCNKIAHNN {
    pub fn new() -> GALCNKIAHNN {
...
impl ::protobuf::Message for GALCNKIAHNN {
    const NAME: &'static str = "GALCNKIAHNN";
...
impl ::protobuf::MessageFull for GALCNKIAHNN {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("GALCNKIAHNN").unwrap()).clone()
    }
}

impl ::std::fmt::Display for GALCNKIAHNN {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for GALCNKIAHNN {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(GALCNKIAHNN::generated_message_descriptor_data());
