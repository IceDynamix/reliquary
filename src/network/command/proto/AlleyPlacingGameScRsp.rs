...
impl ::protobuf::Message for AlleyPlacingGameScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.KOFICKLLJNI != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.KOFICKLLJNI);
        }
        if self.event_id != 0 {
        ...
        if self.KHIBBGPHDMB != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.KHIBBGPHDMB);
        }
        if self.ELBBANDDJCI != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.ELBBANDDJCI);
        }
        if self.ILEGFKGCMOM != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.ILEGFKGCMOM);
        }
        if self.KFBOKLHDJDA != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.KFBOKLHDJDA);
        }
        if self.PGLGBLKKIDA != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.PGLGBLKKIDA);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.KOFICKLLJNI != 0 {
            os.write_uint32(14, self.KOFICKLLJNI)?;
        }
        if self.event_id != 0 {
        ...
        if self.KHIBBGPHDMB != 0 {
            os.write_uint32(15, self.KHIBBGPHDMB)?;
        }
        if self.ELBBANDDJCI != 0 {
            os.write_uint32(7, self.ELBBANDDJCI)?;
        }
        if self.ILEGFKGCMOM != 0 {
            os.write_uint32(1, self.ILEGFKGCMOM)?;
        }
        if self.KFBOKLHDJDA != 0 {
            os.write_uint32(13, self.KFBOKLHDJDA)?;
        }
        if self.PGLGBLKKIDA != 0 {
            os.write_uint32(9, self.PGLGBLKKIDA)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12\x20\n\x0bKOFICKLLJNI\x18\x0e\x20\x01(\rR\x0bKOFICKLLJNI\x12\x19\n\
    \x08event_id\x18\x02\x20\x01(\rR\x07eventId\x12\x18\n\x07retcode\x18\x04\
    \x20\x01(\rR\x07retcode\x12\x20\n\x0bKHIBBGPHDMB\x18\x0f\x20\x01(\rR\x0b\
    KHIBBGPHDMB\x12\x20\n\x0bELBBANDDJCI\x18\x07\x20\x01(\rR\x0bELBBANDDJCI\
    \x12\x20\n\x0bILEGFKGCMOM\x18\x01\x20\x01(\rR\x0bILEGFKGCMOM\x12\x20\n\
    \x0bKFBOKLHDJDA\x18\r\x20\x01(\rR\x0bKFBOKLHDJDA\x12\x20\n\x0bPGLGBLKKID\
    A\x18\t\x20\x01(\rR\x0bPGLGBLKKIDAb\x06proto3\
";
