...
//! Generated file from `JDPGJOADLLE.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:JDPGJOADLLE)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct JDPGJOADLLE {
    // message fields
...
impl<'a> ::std::default::Default for &'a JDPGJOADLLE {
    fn default() -> &'a JDPGJOADLLE {
        <JDPGJOADLLE as ::protobuf::Message>::default_instance()
    }
}

impl JDPGJOADLLE {
    pub fn new() -> JDPGJOADLLE {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "NIHAJMHKOBC",
            |m: &JDPGJOADLLE| { &m.NIHAJMHKOBC },
            |m: &mut JDPGJOADLLE| { &mut m.NIHAJMHKOBC },
        ));
...
impl ::protobuf::Message for JDPGJOADLLE {
    const NAME: &'static str = "JDPGJOADLLE";
...
impl ::protobuf::MessageFull for JDPGJOADLLE {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("JDPGJOADLLE").unwrap()).clone()
    }
}

impl ::std::fmt::Display for JDPGJOADLLE {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for JDPGJOADLLE {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

/// Nested message and enums of message `JDPGJOADLLE`
pub mod jdpgjoadlle {
