...
impl ::protobuf::Message for DOLGFNLHEAE {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.DCEHOGAGKOM != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.DCEHOGAGKOM);
        }
        ...
        if self.FNPPHMBLKOA != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.FNPPHMBLKOA);
        }
        if self.FILEDDCMDOC != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.FILEDDCMDOC);
        }
        if self.GGFDDEJHLIF != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.GGFDDEJHLIF);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.DCEHOGAGKOM != 0 {
            os.write_uint32(4, self.DCEHOGAGKOM)?;
        }
        for v in &self.FMBFBGNABOC {
            ::protobuf::rt::write_message_field_with_cached_size(11, v, os)?;
        };
        if self.FNPPHMBLKOA != 0 {
            os.write_uint32(3, self.FNPPHMBLKOA)?;
        }
        if self.FILEDDCMDOC != 0 {
            os.write_uint32(7, self.FILEDDCMDOC)?;
        }
        if self.GGFDDEJHLIF != 0 {
            os.write_uint32(5, self.GGFDDEJHLIF)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    EAE\x12\x20\n\x0bPNGDDNAJCGG\x18\x0c\x20\x01(\rR\x0bPNGDDNAJCGG\x12\x20\
    \n\x0bDCEHOGAGKOM\x18\x04\x20\x01(\rR\x0bDCEHOGAGKOM\x12.\n\x0bFMBFBGNAB\
    OC\x18\x0b\x20\x03(\x0b2\x0c.PANAIJBJMENR\x0bFMBFBGNABOC\x12\x20\n\x0bFN\
    PPHMBLKOA\x18\x03\x20\x01(\rR\x0bFNPPHMBLKOA\x12\x20\n\x0bFILEDDCMDOC\
    \x18\x07\x20\x01(\rR\x0bFILEDDCMDOC\x12\x20\n\x0bGGFDDEJHLIF\x18\x05\x20\
    \x01(\rR\x0bGGFDDEJHLIFb\x06proto3\
";
