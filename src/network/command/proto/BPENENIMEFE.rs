...
//! Generated file from `BPENENIMEFE.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:BPENENIMEFE)
...
impl<'a> ::std::default::Default for &'a BPENENIMEFE {
    fn default() -> &'a BPENENIMEFE {
        <BPENENIMEFE as ::protobuf::Message>::default_instance()
    }
}

impl BPENENIMEFE {
    pub fn new() -> BPENENIMEFE {
...
impl ::protobuf::Message for BPENENIMEFE {
    const NAME: &'static str = "BPENENIMEFE";
...
impl ::protobuf::MessageFull for BPENENIMEFE {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("BPENENIMEFE").unwrap()).clone()
    }
}

impl ::std::fmt::Display for BPENENIMEFE {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for BPENENIMEFE {
