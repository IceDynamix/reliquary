...
impl ::protobuf::Message for KJBMLBGIBJF {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(10, &self.OCCMNIDEBBJ);
        my_size += ::protobuf::rt::vec_packed_uint32_size(7, &self.JIHCHILFJPI);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(10, &self.OCCMNIDEBBJ)?;
        os.write_repeated_packed_uint32(7, &self.JIHCHILFJPI)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x20\x03(\rR\x0bOCCMNIDEBBJ\x12\x20\n\x0bJIHCHILFJPI\x18\x07\x20\x03(\
