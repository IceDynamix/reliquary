...
pub struct TrainPartyBuildStartStepCsReq {
    // message fields
    // @@protoc_insertion_point(field:TrainPartyBuildStartStepCsReq.DECGMJJHGIG)
    pub DECGMJJHGIG: u32,
    // @@protoc_insertion_point(field:TrainPartyBuildStartStepCsReq.area_id)
    pub area_id: u32,
    // @@protoc_insertion_point(field:TrainPartyBuildStartStepCsReq.HGPLLKMHEIG)
    pub HGPLLKMHEIG: u32,
    // @@protoc_insertion_point(field:TrainPartyBuildStartStepCsReq.MJBDKGLMKIP)
    pub MJBDKGLMKIP: ::protobuf::MessageField<super::AreaDynamicInfo::AreaDynamicInfo>,
    // special fields
...
impl TrainPartyBuildStartStepCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "DECGMJJHGIG",
            |m: &TrainPartyBuildStartStepCsReq| { &m.DECGMJJHGIG },
            |m: &mut TrainPartyBuildStartStepCsReq| { &mut m.DECGMJJHGIG },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "area_id",
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "HGPLLKMHEIG",
            |m: &TrainPartyBuildStartStepCsReq| { &m.HGPLLKMHEIG },
            |m: &mut TrainPartyBuildStartStepCsReq| { &mut m.HGPLLKMHEIG },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::AreaDynamicInfo::AreaDynamicInfo>(
            "MJBDKGLMKIP",
            |m: &TrainPartyBuildStartStepCsReq| { &m.MJBDKGLMKIP },
            |m: &mut TrainPartyBuildStartStepCsReq| { &mut m.MJBDKGLMKIP },
        ));
...
impl ::protobuf::Message for TrainPartyBuildStartStepCsReq {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                34 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.MJBDKGLMKIP)?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.DECGMJJHGIG != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.DECGMJJHGIG);
        }
        if self.area_id != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.area_id);
        }
        if self.HGPLLKMHEIG != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.HGPLLKMHEIG);
        }
        if let Some(v) = self.MJBDKGLMKIP.as_ref() {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.DECGMJJHGIG != 0 {
            os.write_uint32(7, self.DECGMJJHGIG)?;
        }
        if self.area_id != 0 {
            os.write_uint32(12, self.area_id)?;
        }
        if self.HGPLLKMHEIG != 0 {
            os.write_uint32(2, self.HGPLLKMHEIG)?;
        }
        if let Some(v) = self.MJBDKGLMKIP.as_ref() {
    ...
    fn default_instance() -> &'static TrainPartyBuildStartStepCsReq {
        static instance: TrainPartyBuildStartStepCsReq = TrainPartyBuildStartStepCsReq {
            ...
            area_id: 0,
            HGPLLKMHEIG: 0,
            MJBDKGLMKIP: ::protobuf::MessageField::none(),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x07\x20\x01(\rR\x0bDECGMJJHGIG\x12\x17\n\x07area_id\x18\x0c\x20\x01(\rR\
    \x06areaId\x12\x20\n\x0bHGPLLKMHEIG\x18\x02\x20\x01(\rR\x0bHGPLLKMHEIG\
    \x122\n\x0bMJBDKGLMKIP\x18\x04\x20\x01(\x0b2\x10.AreaDynamicInfoR\x0bMJB\
    DKGLMKIPb\x06proto3\
";
