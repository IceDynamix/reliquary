...
impl ::protobuf::Message for TrainPartyBuildStartStepCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.DNLIGEOFPEL != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.DNLIGEOFPEL);
        }
        if self.area_id != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.area_id);
        }
        if self.GKENFCLLLJC != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.GKENFCLLLJC);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.DNLIGEOFPEL != 0 {
            os.write_uint32(1, self.DNLIGEOFPEL)?;
        }
        if self.area_id != 0 {
            os.write_uint32(2, self.area_id)?;
        }
        if self.GKENFCLLLJC != 0 {
            os.write_uint32(3, self.GKENFCLLLJC)?;
        }
        if let Some(v) = self.PFICNBHIHBA.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x01\x20\x01(\rR\x0bDNLIGEOFPEL\x12\x17\n\x07area_id\x18\x02\x20\x01(\rR\
    \x06areaId\x12\x20\n\x0bGKENFCLLLJC\x18\x03\x20\x01(\rR\x0bGKENFCLLLJC\
    \x122\n\x0bPFICNBHIHBA\x18\x0f\x20\x01(\x0b2\x10.AreaDynamicInfoR\x0bPFI\
    CNBHIHBAb\x06proto3\
";
