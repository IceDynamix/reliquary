...
pub struct TrainPartyBuildStartStepCsReq {
    // message fields
    // @@protoc_insertion_point(field:TrainPartyBuildStartStepCsReq.KLLGHHPEBLI)
    pub KLLGHHPEBLI: u32,
    // @@protoc_insertion_point(field:TrainPartyBuildStartStepCsReq.CKPIAIDJOHA)
    pub CKPIAIDJOHA: u32,
    // @@protoc_insertion_point(field:TrainPartyBuildStartStepCsReq.area_id)
    pub area_id: u32,
    // @@protoc_insertion_point(field:TrainPartyBuildStartStepCsReq.IHMMFNCLPNL)
    pub IHMMFNCLPNL: ::protobuf::MessageField<super::AreaDynamicInfo::AreaDynamicInfo>,
    // special fields
...
impl TrainPartyBuildStartStepCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "KLLGHHPEBLI",
            |m: &TrainPartyBuildStartStepCsReq| { &m.KLLGHHPEBLI },
            |m: &mut TrainPartyBuildStartStepCsReq| { &mut m.KLLGHHPEBLI },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "CKPIAIDJOHA",
            |m: &TrainPartyBuildStartStepCsReq| { &m.CKPIAIDJOHA },
            |m: &mut TrainPartyBuildStartStepCsReq| { &mut m.CKPIAIDJOHA },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "area_id",
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::AreaDynamicInfo::AreaDynamicInfo>(
            "IHMMFNCLPNL",
            |m: &TrainPartyBuildStartStepCsReq| { &m.IHMMFNCLPNL },
            |m: &mut TrainPartyBuildStartStepCsReq| { &mut m.IHMMFNCLPNL },
        ));
...
impl ::protobuf::Message for TrainPartyBuildStartStepCsReq {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                122 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.IHMMFNCLPNL)?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.KLLGHHPEBLI != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.KLLGHHPEBLI);
        }
        if self.CKPIAIDJOHA != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.CKPIAIDJOHA);
        }
        if self.area_id != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.area_id);
        }
        if let Some(v) = self.IHMMFNCLPNL.as_ref() {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.KLLGHHPEBLI != 0 {
            os.write_uint32(3, self.KLLGHHPEBLI)?;
        }
        if self.CKPIAIDJOHA != 0 {
            os.write_uint32(2, self.CKPIAIDJOHA)?;
        }
        if self.area_id != 0 {
    ...
    fn default_instance() -> &'static TrainPartyBuildStartStepCsReq {
        static instance: TrainPartyBuildStartStepCsReq = TrainPartyBuildStartStepCsReq {
            ...
            CKPIAIDJOHA: 0,
            area_id: 0,
            IHMMFNCLPNL: ::protobuf::MessageField::none(),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x03\x20\x01(\rR\x0bKLLGHHPEBLI\x12\x20\n\x0bCKPIAIDJOHA\x18\x02\x20\x01\
    (\rR\x0bCKPIAIDJOHA\x12\x17\n\x07area_id\x18\x07\x20\x01(\rR\x06areaId\
    \x122\n\x0bIHMMFNCLPNL\x18\x0f\x20\x01(\x0b2\x10.AreaDynamicInfoR\x0bIHM\
    MFNCLPNLb\x06proto3\
";
