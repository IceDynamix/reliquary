...
impl ::protobuf::Message for BattlePassInfoNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.HKEOAACCBPL != 0 {
            my_size += ::protobuf::rt::uint64_size(13, self.HKEOAACCBPL);
        }
        if self.LJOEKEFKPKO != 0 {
            my_size += ::protobuf::rt::uint64_size(2, self.LJOEKEFKPKO);
        }
        if self.EKGOPLDJOII != 0 {
            my_size += ::protobuf::rt::uint64_size(14, self.EKGOPLDJOII);
        }
        ...
        if self.JLLHALOHJII != ::protobuf::EnumOrUnknown::new(super::BpTierType::BpTierType::BP_TIER_TYPE_NONE) {
            my_size += ::protobuf::rt::int32_size(6, self.JLLHALOHJII.value());
        }
        if self.exp != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.exp);
        }
        if self.CPHIIOCKHPI != 0 {
            my_size += ::protobuf::rt::uint64_size(1, self.CPHIIOCKHPI);
        }
        if self.LJFLFLIMKAD != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.LJFLFLIMKAD);
        }
        if self.EDBMNMDJBKO != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.EDBMNMDJBKO);
        }
        if self.level != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.HKEOAACCBPL != 0 {
            os.write_uint64(13, self.HKEOAACCBPL)?;
        }
        if self.LJOEKEFKPKO != 0 {
            os.write_uint64(2, self.LJOEKEFKPKO)?;
        }
        if self.EKGOPLDJOII != 0 {
            os.write_uint64(14, self.EKGOPLDJOII)?;
        }
        if self.NKAOKNMHOLH != 0 {
            os.write_uint64(7, self.NKAOKNMHOLH)?;
        }
        if self.JLLHALOHJII != ::protobuf::EnumOrUnknown::new(super::BpTierType::BpTierType::BP_TIER_TYPE_NONE) {
            os.write_enum(6, ::protobuf::EnumOrUnknown::value(&self.JLLHALOHJII))?;
        }
        if self.exp != 0 {
            os.write_uint32(4, self.exp)?;
        }
        if self.CPHIIOCKHPI != 0 {
            os.write_uint64(1, self.CPHIIOCKHPI)?;
        }
        if self.LJFLFLIMKAD != 0 {
            os.write_uint32(3, self.LJFLFLIMKAD)?;
        }
        if self.EDBMNMDJBKO != 0 {
            os.write_uint32(9, self.EDBMNMDJBKO)?;
        }
        if self.level != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    KLLEOHDC\x12\x20\n\x0bFDKKIKGANCK\x18\x08\x20\x01(\x04R\x0bFDKKIKGANCK\
    \x12\x20\n\x0bINBOCKJGLBO\x18\x0c\x20\x01(\x04R\x0bINBOCKJGLBO\x12\x20\n\
    \x0bHKEOAACCBPL\x18\r\x20\x01(\x04R\x0bHKEOAACCBPL\x12\x20\n\x0bLJOEKEFK\
    PKO\x18\x02\x20\x01(\x04R\x0bLJOEKEFKPKO\x12\x20\n\x0bEKGOPLDJOII\x18\
    \x0e\x20\x01(\x04R\x0bEKGOPLDJOII\x12\x20\n\x0bNKAOKNMHOLH\x18\x07\x20\
    \x01(\x04R\x0bNKAOKNMHOLH\x12-\n\x0bJLLHALOHJII\x18\x06\x20\x01(\x0e2\
    \x0b.BpTierTypeR\x0bJLLHALOHJII\x12\x10\n\x03exp\x18\x04\x20\x01(\rR\x03\
    exp\x12\x20\n\x0bCPHIIOCKHPI\x18\x01\x20\x01(\x04R\x0bCPHIIOCKHPI\x12\
    \x20\n\x0bLJFLFLIMKAD\x18\x03\x20\x01(\rR\x0bLJFLFLIMKAD\x12\x20\n\x0bED\
    BMNMDJBKO\x18\t\x20\x01(\rR\x0bEDBMNMDJBKO\x12\x14\n\x05level\x18\x0b\
