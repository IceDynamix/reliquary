...
impl ::protobuf::Message for GetHeartDialInfoScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.unlock_status != ::protobuf::EnumOrUnknown::new(super::HeartDialUnlockStatus::HeartDialUnlockStatus::HEART_DIAL_UNLOCK_STATUS_LOCK) {
            my_size += ::protobuf::rt::int32_size(8, self.unlock_status.value());
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.unlock_status != ::protobuf::EnumOrUnknown::new(super::HeartDialUnlockStatus::HeartDialUnlockStatus::HEART_DIAL_UNLOCK_STATUS_LOCK) {
            os.write_enum(8, ::protobuf::EnumOrUnknown::value(&self.unlock_status))?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    info_list\x18\x03\x20\x03(\x0b2\x14.HeartDialScriptInfoR\x0escriptInfoLi\
    st\x12.\n\x0bOCMOEJIDLAM\x18\x06\x20\x03(\x0b2\x0c.MMEINFMDJFGR\x0bOCMOE\
    JIDLAM\x12;\n\runlock_status\x18\x08\x20\x01(\x0e2\x16.HeartDialUnlockSt\
    atusR\x0cunlockStatus\x12\x18\n\x07retcode\x18\r\x20\x01(\rR\x07retcode\
    \x12D\n\x12dialogue_info_list\x18\x04\x20\x03(\x0b2\x16.HeartDialDialogu\
    eInfoR\x10dialogueInfoListb\x06proto3\
";
