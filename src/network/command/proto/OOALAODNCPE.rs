...
impl ::protobuf::Message for OOALAODNCPE {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.FODEKCOBFFA != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.FODEKCOBFFA);
        }
        if self.NEEFGJBMCLL != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.NEEFGJBMCLL);
        }
        if self.OGGEGAOLPGN != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.OGGEGAOLPGN);
        }
        if self.OIGKBOOHNII != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.OIGKBOOHNII);
        }
        if self.GFDIPLDIFHG != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.GFDIPLDIFHG);
        }
        if self.DHDLNDFIBKC != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.DHDLNDFIBKC);
        }
        if self.NBNEKBDILLK != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.NBNEKBDILLK);
        }
        if self.NFPHCJIPIJH != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.NFPHCJIPIJH);
        }
        if self.JEHJLJDKBGE != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.JEHJLJDKBGE);
        }
        ...
        if self.MMABIMIEJNJ != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.MMABIMIEJNJ);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.FODEKCOBFFA != 0 {
            os.write_uint32(2, self.FODEKCOBFFA)?;
        }
        if self.NEEFGJBMCLL != 0 {
            os.write_uint32(10, self.NEEFGJBMCLL)?;
        }
        if self.OGGEGAOLPGN != 0 {
            os.write_uint32(5, self.OGGEGAOLPGN)?;
        }
        if self.OIGKBOOHNII != 0 {
            os.write_uint32(3, self.OIGKBOOHNII)?;
        }
        if self.GFDIPLDIFHG != 0 {
            os.write_uint32(12, self.GFDIPLDIFHG)?;
        }
        if self.DHDLNDFIBKC != 0 {
            os.write_uint32(13, self.DHDLNDFIBKC)?;
        }
        if self.NBNEKBDILLK != 0 {
            os.write_uint32(7, self.NBNEKBDILLK)?;
        }
        if self.NFPHCJIPIJH != 0 {
            os.write_uint32(9, self.NFPHCJIPIJH)?;
        }
        if self.JEHJLJDKBGE != 0 {
            os.write_uint32(8, self.JEHJLJDKBGE)?;
        }
        for v in &self.APNNBDBENLC {
            ::protobuf::rt::write_message_field_with_cached_size(15, v, os)?;
        };
        if self.MMABIMIEJNJ != 0 {
            os.write_uint32(4, self.MMABIMIEJNJ)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    CPE\x12\x20\n\x0bFODEKCOBFFA\x18\x02\x20\x01(\rR\x0bFODEKCOBFFA\x12\x20\
    \n\x0bNEEFGJBMCLL\x18\n\x20\x01(\rR\x0bNEEFGJBMCLL\x12\x20\n\x0bOGGEGAOL\
    PGN\x18\x05\x20\x01(\rR\x0bOGGEGAOLPGN\x12\x20\n\x0bOIGKBOOHNII\x18\x03\
    \x20\x01(\rR\x0bOIGKBOOHNII\x12\x20\n\x0bGFDIPLDIFHG\x18\x0c\x20\x01(\rR\
    \x0bGFDIPLDIFHG\x12\x20\n\x0bDHDLNDFIBKC\x18\r\x20\x01(\rR\x0bDHDLNDFIBK\
    C\x12\x20\n\x0bNBNEKBDILLK\x18\x07\x20\x01(\rR\x0bNBNEKBDILLK\x12\x20\n\
    \x0bNFPHCJIPIJH\x18\t\x20\x01(\rR\x0bNFPHCJIPIJH\x12\x20\n\x0bJEHJLJDKBG\
    E\x18\x08\x20\x01(\rR\x0bJEHJLJDKBGE\x12.\n\x0bAPNNBDBENLC\x18\x0f\x20\
    \x03(\x0b2\x0c.DCKPBICNMKKR\x0bAPNNBDBENLC\x12\x20\n\x0bMMABIMIEJNJ\x18\
    \x04\x20\x01(\rR\x0bMMABIMIEJNJb\x06proto3\
";
