...
impl ::protobuf::Message for OOALAODNCPE {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.DHDLNDFIBKC != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.DHDLNDFIBKC);
        }
        if self.NBNEKBDILLK != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.NBNEKBDILLK);
        }
        if self.MMABIMIEJNJ != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.MMABIMIEJNJ);
        }
        ...
        if self.OGGEGAOLPGN != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.OGGEGAOLPGN);
        }
        if self.GFDIPLDIFHG != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.GFDIPLDIFHG);
        }
        if self.JEHJLJDKBGE != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.JEHJLJDKBGE);
        }
        if self.NFPHCJIPIJH != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.NFPHCJIPIJH);
        }
        if self.OIGKBOOHNII != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.OIGKBOOHNII);
        }
        if self.FODEKCOBFFA != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.FODEKCOBFFA);
        }
        if self.NEEFGJBMCLL != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.NEEFGJBMCLL);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.DHDLNDFIBKC != 0 {
            os.write_uint32(11, self.DHDLNDFIBKC)?;
        }
        if self.NBNEKBDILLK != 0 {
            os.write_uint32(14, self.NBNEKBDILLK)?;
        }
        if self.MMABIMIEJNJ != 0 {
            os.write_uint32(15, self.MMABIMIEJNJ)?;
        }
        for v in &self.APNNBDBENLC {
            ::protobuf::rt::write_message_field_with_cached_size(1, v, os)?;
        };
        if self.OGGEGAOLPGN != 0 {
            os.write_uint32(3, self.OGGEGAOLPGN)?;
        }
        if self.GFDIPLDIFHG != 0 {
            os.write_uint32(9, self.GFDIPLDIFHG)?;
        }
        if self.JEHJLJDKBGE != 0 {
            os.write_uint32(7, self.JEHJLJDKBGE)?;
        }
        if self.NFPHCJIPIJH != 0 {
            os.write_uint32(10, self.NFPHCJIPIJH)?;
        }
        if self.OIGKBOOHNII != 0 {
            os.write_uint32(5, self.OIGKBOOHNII)?;
        }
        if self.FODEKCOBFFA != 0 {
            os.write_uint32(6, self.FODEKCOBFFA)?;
        }
        if self.NEEFGJBMCLL != 0 {
            os.write_uint32(4, self.NEEFGJBMCLL)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    CPE\x12\x20\n\x0bDHDLNDFIBKC\x18\x0b\x20\x01(\rR\x0bDHDLNDFIBKC\x12\x20\
    \n\x0bNBNEKBDILLK\x18\x0e\x20\x01(\rR\x0bNBNEKBDILLK\x12\x20\n\x0bMMABIM\
    IEJNJ\x18\x0f\x20\x01(\rR\x0bMMABIMIEJNJ\x12.\n\x0bAPNNBDBENLC\x18\x01\
    \x20\x03(\x0b2\x0c.DCKPBICNMKKR\x0bAPNNBDBENLC\x12\x20\n\x0bOGGEGAOLPGN\
    \x18\x03\x20\x01(\rR\x0bOGGEGAOLPGN\x12\x20\n\x0bGFDIPLDIFHG\x18\t\x20\
    \x01(\rR\x0bGFDIPLDIFHG\x12\x20\n\x0bJEHJLJDKBGE\x18\x07\x20\x01(\rR\x0b\
    JEHJLJDKBGE\x12\x20\n\x0bNFPHCJIPIJH\x18\n\x20\x01(\rR\x0bNFPHCJIPIJH\
    \x12\x20\n\x0bOIGKBOOHNII\x18\x05\x20\x01(\rR\x0bOIGKBOOHNII\x12\x20\n\
    \x0bFODEKCOBFFA\x18\x06\x20\x01(\rR\x0bFODEKCOBFFA\x12\x20\n\x0bNEEFGJBM\
    CLL\x18\x04\x20\x01(\rR\x0bNEEFGJBMCLLb\x06proto3\
";
