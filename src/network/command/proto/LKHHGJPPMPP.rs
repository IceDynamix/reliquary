...
pub struct LKHHGJPPMPP {
    ...
    pub avatar_id: u32,
    // @@protoc_insertion_point(field:LKHHGJPPMPP.avatar_type)
    pub avatar_type: u32,
    // special fields
...
impl LKHHGJPPMPP {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "avatar_type",
            |m: &LKHHGJPPMPP| { &m.avatar_type },
            |m: &mut LKHHGJPPMPP| { &mut m.avatar_type },
        ));
...
impl ::protobuf::Message for LKHHGJPPMPP {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.avatar_type != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.avatar_type);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.avatar_type != 0 {
            os.write_uint32(14, self.avatar_type)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x11LKHHGJPPMPP.proto\"K\n\x0bLKHHGJPPMPP\x12\x1b\n\tavatar_id\x18\t\
    \x20\x01(\rR\x08avatarId\x12\x1f\n\x0bavatar_type\x18\x0e\x20\x01(\rR\na\
