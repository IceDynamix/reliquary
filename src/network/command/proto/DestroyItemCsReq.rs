...
impl ::protobuf::Message for DestroyItemCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.cur_item_count != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.cur_item_count);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.cur_item_count != 0 {
            os.write_uint32(14, self.cur_item_count)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    unt\x18\x03\x20\x01(\rR\titemCount\x12\x17\n\x07item_id\x18\t\x20\x01(\r\
    R\x06itemId\x12$\n\x0ecur_item_count\x18\x0e\x20\x01(\rR\x0ccurItemCount\
    b\x06proto3\
";
