...
impl ::protobuf::Message for DestroyItemCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.ADOIMNBAGKC != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.ADOIMNBAGKC);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.ADOIMNBAGKC != 0 {
            os.write_uint32(1, self.ADOIMNBAGKC)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    id\x18\x0b\x20\x01(\rR\x06itemId\x12\x1d\n\nitem_count\x18\x08\x20\x01(\
    \rR\titemCount\x12\x20\n\x0bADOIMNBAGKC\x18\x01\x20\x01(\rR\x0bADOIMNBAG\
    KCb\x06proto3\
";
