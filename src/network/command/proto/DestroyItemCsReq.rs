...
pub struct DestroyItemCsReq {
    // message fields
    // @@protoc_insertion_point(field:DestroyItemCsReq.destroy_count)
    pub destroy_count: u32,
    // @@protoc_insertion_point(field:DestroyItemCsReq.item_id)
    pub item_id: u32,
    // @@protoc_insertion_point(field:DestroyItemCsReq.cur_count)
    pub cur_count: u32,
    // special fields
...
impl DestroyItemCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "destroy_count",
            |m: &DestroyItemCsReq| { &m.destroy_count },
            |m: &mut DestroyItemCsReq| { &mut m.destroy_count },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "item_id",
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "cur_count",
            |m: &DestroyItemCsReq| { &m.cur_count },
            |m: &mut DestroyItemCsReq| { &mut m.cur_count },
        ));
...
impl ::protobuf::Message for DestroyItemCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.destroy_count != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.destroy_count);
        }
        if self.item_id != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.item_id);
        }
        if self.cur_count != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.cur_count);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.destroy_count != 0 {
            os.write_uint32(4, self.destroy_count)?;
        }
        if self.item_id != 0 {
            os.write_uint32(11, self.item_id)?;
        }
        if self.cur_count != 0 {
            os.write_uint32(14, self.cur_count)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x16DestroyItemCsReq.proto\"m\n\x10DestroyItemCsReq\x12#\n\rdestroy_co\
    unt\x18\x04\x20\x01(\rR\x0cdestroyCount\x12\x17\n\x07item_id\x18\x0b\x20\
    \x01(\rR\x06itemId\x12\x1b\n\tcur_count\x18\x0e\x20\x01(\rR\x08curCountb\
    \x06proto3\
";
