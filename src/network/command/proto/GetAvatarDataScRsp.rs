...
impl ::protobuf::Message for GetAvatarDataScRsp {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_enum_or_unknown_size(7, &self.PNKCFEALAMI);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_enum_or_unknown(7, &self.PNKCFEALAMI)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x07\x20\x03(\x0e2\x19.GrowthTargetFunctionTypeR\x0bPNKCFEALAMI\x12(\
    \n\x0bavatar_list\x18\x05\x20\x03(\x0b2\x07.AvatarR\navatarList\x12\x18\
    \n\x07retcode\x18\x03\x20\x01(\rR\x07retcode\x12\x20\n\x0bANKHENIIACH\
    \x18\t\x20\x03(\rR\x0bANKHENIIACH\x12\x20\n\x0bJPNLPOPMKEJ\x18\x08\x20\
    \x01(\rR\x0bJPNLPOPMKEJ\x12\x1c\n\nis_get_all\x18\x04\x20\x01(\x08R\x08i\
    sGetAllb\x06proto3\
";
