...
impl ::protobuf::Message for PAKPCCILOLN {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.OJAMOBMGFBD != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.OJAMOBMGFBD);
        }
        if self.BLPBIGKJPCH != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.BLPBIGKJPCH);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.OJAMOBMGFBD != 0 {
            os.write_uint32(3, self.OJAMOBMGFBD)?;
        }
        if self.BLPBIGKJPCH != 0 {
            os.write_uint32(8, self.BLPBIGKJPCH)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    CDK\x18\x02\x20\x03(\rR\x0bDNKJDJJBCDK\x12\x20\n\x0bNBBOABGLCJC\x18\x05\
    \x20\x03(\rR\x0bNBBOABGLCJC\x12\x20\n\x0bOJAMOBMGFBD\x18\x03\x20\x01(\rR\
    \x0bOJAMOBMGFBD\x12\x20\n\x0bBLPBIGKJPCH\x18\x08\x20\x01(\rR\x0bBLPBIGKJ\
    PCHb\x06proto3\
";
