...
pub struct AddAvatarScNotify {
    ...
    pub src: ::protobuf::EnumOrUnknown<super::LDKKGKFBNDG::LDKKGKFBNDG>,
...
impl ::protobuf::Message for AddAvatarScNotify {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.src != ::protobuf::EnumOrUnknown::new(super::LDKKGKFBNDG::LDKKGKFBNDG::ADD_AVATAR_SRC_NONE) {
    ...
    fn clear(&mut self) {
        self.src = ::protobuf::EnumOrUnknown::new(super::LDKKGKFBNDG::LDKKGKFBNDG::ADD_AVATAR_SRC_NONE);
        self.is_new = false;
        self.reward.clear();
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    roto\"\x93\x01\n\x11AddAvatarScNotify\x12\x1e\n\x03src\x18\x03\x20\x01(\
    \x0e2\x0c.LDKKGKFBNDGR\x03src\x12\x15\n\x06is_new\x18\x0e\x20\x01(\x08R\
    \x05isNew\x12!\n\x06reward\x18\x0c\x20\x01(\x0b2\t.ItemListR\x06reward\
    \x12$\n\x0ebase_avatar_id\x18\x06\x20\x01(\rR\x0cbaseAvatarIdb\x06proto3\
";
