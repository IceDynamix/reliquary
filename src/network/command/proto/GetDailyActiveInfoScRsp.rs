...
impl ::protobuf::Message for GetDailyActiveInfoScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.daily_active_point != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.daily_active_point);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.daily_active_point != 0 {
            os.write_uint32(12, self.daily_active_point)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x01\n\x17GetDailyActiveInfoScRsp\x12,\n\x12daily_active_point\x18\x0c\
    \x20\x01(\rR\x10dailyActivePoint\x12\x18\n\x07retcode\x18\r\x20\x01(\rR\
    \x07retcode\x12:\n\x1adaily_active_quest_id_list\x18\x03\x20\x03(\rR\x16\
    dailyActiveQuestIdList\x12I\n\x17daily_active_level_list\x18\x02\x20\x03\
    (\x0b2\x12.DailyActivityInfoR\x14dailyActiveLevelListb\x06proto3\
";
