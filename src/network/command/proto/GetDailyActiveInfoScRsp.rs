...
impl ::protobuf::Message for GetDailyActiveInfoScRsp {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(7, &self.daily_active_quest_id_list);
        for value in &self.daily_active_level_list {
            let len = value.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
        };
        if self.daily_active_point != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.daily_active_point);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(7, &self.daily_active_quest_id_list)?;
        for v in &self.daily_active_level_list {
            ::protobuf::rt::write_message_field_with_cached_size(8, v, os)?;
        };
        if self.daily_active_point != 0 {
            os.write_uint32(11, self.daily_active_point)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x01\n\x17GetDailyActiveInfoScRsp\x12:\n\x1adaily_active_quest_id_list\
    \x18\x07\x20\x03(\rR\x16dailyActiveQuestIdList\x12I\n\x17daily_active_le\
    vel_list\x18\x08\x20\x03(\x0b2\x12.DailyActivityInfoR\x14dailyActiveLeve\
    lList\x12,\n\x12daily_active_point\x18\x0b\x20\x01(\rR\x10dailyActivePoi\
