...
impl ::protobuf::Message for PLPDNKNJBAA {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(9, &self.KCENCAAPMLK);
        for value in &self.HBGPLDACACI {
            let len = value.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
        };
        if self.CINEILEIEJK != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.CINEILEIEJK);
        }
        if self.NEDCJCBPEJM != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.NEDCJCBPEJM);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_uint32(9, &self.KCENCAAPMLK)?;
        for v in &self.HBGPLDACACI {
            ::protobuf::rt::write_message_field_with_cached_size(7, v, os)?;
        };
        if self.CINEILEIEJK != 0 {
            os.write_uint32(1, self.CINEILEIEJK)?;
        }
        if self.NEDCJCBPEJM != 0 {
            os.write_uint32(13, self.NEDCJCBPEJM)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    MDH\x18\x05\x20\x01(\x0b2\x0c.MOFKNBAKKDIR\x0bHOCBDMPEMDH\x12.\n\x0bENDP\
    GFBABBB\x18\x0e\x20\x03(\x0b2\x0c.BMGHLHHJEGER\x0bENDPGFBABBB\x12\x20\n\
    \x0bKCENCAAPMLK\x18\t\x20\x03(\rR\x0bKCENCAAPMLK\x12.\n\x0bHBGPLDACACI\
    \x18\x07\x20\x03(\x0b2\x0c.OHABCOEGDEHR\x0bHBGPLDACACI\x12\x20\n\x0bCINE\
    ILEIEJK\x18\x01\x20\x01(\rR\x0bCINEILEIEJK\x12\x20\n\x0bNEDCJCBPEJM\x18\
    \r\x20\x01(\rR\x0bNEDCJCBPEJMb\x06proto3\
";
