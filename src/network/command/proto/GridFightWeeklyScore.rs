...
//! Generated file from `GridFightWeeklyScore.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:GridFightWeeklyScore)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct GridFightWeeklyScore {
    // message fields
...
impl<'a> ::std::default::Default for &'a GridFightWeeklyScore {
    fn default() -> &'a GridFightWeeklyScore {
        <GridFightWeeklyScore as ::protobuf::Message>::default_instance()
    }
}

impl GridFightWeeklyScore {
    pub fn new() -> GridFightWeeklyScore {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "begin_time",
            |m: &GridFightWeeklyScore| { &m.begin_time },
            |m: &mut GridFightWeeklyScore| { &mut m.begin_time },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "end_time",
...
impl ::protobuf::Message for GridFightWeeklyScore {
    const NAME: &'static str = "GridFightWeeklyScore";
    ...
    fn new() -> GridFightWeeklyScore {
        GridFightWeeklyScore::new()
    }
...
impl ::protobuf::MessageFull for GridFightWeeklyScore {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("GridFightWeeklyScore").unwrap()).clone()
    }
}

impl ::std::fmt::Display for GridFightWeeklyScore {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for GridFightWeeklyScore {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(GridFightWeeklyScore::generated_message_descriptor_data());
