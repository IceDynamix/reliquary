...
impl ::protobuf::Message for DailyActiveInfoNotify {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(9, &self.daily_active_quest_id_list);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(9, &self.daily_active_quest_id_list)?;
        if self.daily_active_point != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \t\x20\x03(\rR\x16dailyActiveQuestIdList\x12,\n\x12daily_active_point\
    \x18\x07\x20\x01(\rR\x10dailyActivePoint\x12I\n\x17daily_active_level_li\
    st\x18\x0b\x20\x03(\x0b2\x12.DailyActivityInfoR\x14dailyActiveLevelListb\
    \x06proto3\
";
