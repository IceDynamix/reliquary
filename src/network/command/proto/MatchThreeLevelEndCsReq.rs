...
impl ::protobuf::Message for MatchThreeLevelEndCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.KKHPKMAHDMK != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.KKHPKMAHDMK);
        }
        if self.HBONKLEOEEI != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.HBONKLEOEEI);
        }
        if self.LALGADHLMCB != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.LALGADHLMCB);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.KKHPKMAHDMK != 0 {
            os.write_uint32(3, self.KKHPKMAHDMK)?;
        }
        if self.HBONKLEOEEI != 0 {
            os.write_uint32(4, self.HBONKLEOEEI)?;
        }
        if self.LALGADHLMCB != 0 {
            os.write_uint32(5, self.LALGADHLMCB)?;
        }
        if !self.uuid.is_empty() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1dMatchThreeLevelEndCsReq.proto\"\xbb\x02\n\x17MatchThreeLevelEndCsR\
    eq\x12K\n\x0bGMONIMLFKFC\x18\x02\x20\x03(\x0b2).MatchThreeLevelEndCsReq.\
    GMONIMLFKFCEntryR\x0bGMONIMLFKFC\x12\x20\n\x0bKKHPKMAHDMK\x18\x03\x20\
    \x01(\rR\x0bKKHPKMAHDMK\x12\x20\n\x0bHBONKLEOEEI\x18\x04\x20\x01(\rR\x0b\
    HBONKLEOEEI\x12\x20\n\x0bLALGADHLMCB\x18\x05\x20\x01(\rR\x0bLALGADHLMCB\
    \x12\x12\n\x04uuid\x18\x07\x20\x01(\tR\x04uuid\x12\x19\n\x08level_id\x18\
    \x0b\x20\x01(\rR\x07levelId\x1a>\n\x10GMONIMLFKFCEntry\x12\x10\n\x03key\
