...
impl ::protobuf::Message for SwordTrainingTurnActionCsReq {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(7, &self.PHAJEHIBKFI);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(7, &self.PHAJEHIBKFI)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    Req\x12\x20\n\x0bPHAJEHIBKFI\x18\x07\x20\x03(\rR\x0bPHAJEHIBKFI\x12\x20\
    \n\x0bBHNFGPEHOMO\x18\x02\x20\x03(\rR\x0bBHNFGPEHOMOb\x06proto3\
";
