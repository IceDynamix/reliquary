...
pub enum TrainVisitorStatus {
    // @@protoc_insertion_point(enum_value:TrainVisitorStatus.TRAIN_VISITOR_STATUS_NONE)
    TRAIN_VISITOR_STATUS_NONE = 0,
    // @@protoc_insertion_point(enum_value:TrainVisitorStatus.TRAIN_VISITOR_STATUS_INIT)
    TRAIN_VISITOR_STATUS_INIT = 1,
    // @@protoc_insertion_point(enum_value:TrainVisitorStatus.TRAIN_VISITOR_STATUS_GET_ON)
...
impl ::protobuf::Enum for TrainVisitorStatus {
    ...
    fn from_i32(value: i32) -> ::std::option::Option<TrainVisitorStatus> {
        match value {
            0 => ::std::option::Option::Some(TrainVisitorStatus::TRAIN_VISITOR_STATUS_NONE),
    ...
    fn from_str(str: &str) -> ::std::option::Option<TrainVisitorStatus> {
        match str {
            "TRAIN_VISITOR_STATUS_NONE" => ::std::option::Option::Some(TrainVisitorStatus::TRAIN_VISITOR_STATUS_NONE),
    ...
    const VALUES: &'static [TrainVisitorStatus] = &[
        TrainVisitorStatus::TRAIN_VISITOR_STATUS_NONE,
