...
pub struct OpenTreasureDungeonGridCsReq {
    // message fields
    // @@protoc_insertion_point(field:OpenTreasureDungeonGridCsReq.GDNEHLEOMOM)
    pub GDNEHLEOMOM: u32,
    // @@protoc_insertion_point(field:OpenTreasureDungeonGridCsReq.EICEKDBENKM)
    pub EICEKDBENKM: u32,
    // special fields
...
impl OpenTreasureDungeonGridCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "GDNEHLEOMOM",
            |m: &OpenTreasureDungeonGridCsReq| { &m.GDNEHLEOMOM },
            |m: &mut OpenTreasureDungeonGridCsReq| { &mut m.GDNEHLEOMOM },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "EICEKDBENKM",
            |m: &OpenTreasureDungeonGridCsReq| { &m.EICEKDBENKM },
            |m: &mut OpenTreasureDungeonGridCsReq| { &mut m.EICEKDBENKM },
        ));
...
impl ::protobuf::Message for OpenTreasureDungeonGridCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.GDNEHLEOMOM != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.GDNEHLEOMOM);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.GDNEHLEOMOM != 0 {
            os.write_uint32(3, self.GDNEHLEOMOM)?;
        }
        if self.EICEKDBENKM != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    Req\x12\x20\n\x0bGDNEHLEOMOM\x18\x03\x20\x01(\rR\x0bGDNEHLEOMOM\x12\x20\
