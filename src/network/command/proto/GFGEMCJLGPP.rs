...
//! Generated file from `GFGEMCJLGPP.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:GFGEMCJLGPP)
...
pub struct GFGEMCJLGPP {
    ...
    pub content_id: u32,
    // special fields
    // @@protoc_insertion_point(special_field:GFGEMCJLGPP.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a GFGEMCJLGPP {
    fn default() -> &'a GFGEMCJLGPP {
        <GFGEMCJLGPP as ::protobuf::Message>::default_instance()
    }
}

impl GFGEMCJLGPP {
    pub fn new() -> GFGEMCJLGPP {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "content_id",
            |m: &GFGEMCJLGPP| { &m.content_id },
            |m: &mut GFGEMCJLGPP| { &mut m.content_id },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<GFGEMCJLGPP>(
            "GFGEMCJLGPP",
            fields,
            oneofs,
        )
...
impl ::protobuf::Message for GFGEMCJLGPP {
    const NAME: &'static str = "GFGEMCJLGPP";
...
impl ::protobuf::MessageFull for GFGEMCJLGPP {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("GFGEMCJLGPP").unwrap()).clone()
    }
}

impl ::std::fmt::Display for GFGEMCJLGPP {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for GFGEMCJLGPP {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(GFGEMCJLGPP::generated_message_descriptor_data());
