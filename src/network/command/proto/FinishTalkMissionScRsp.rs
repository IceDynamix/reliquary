...
impl ::protobuf::Message for FinishTalkMissionScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.talk_str.is_empty() {
            my_size += ::protobuf::rt::string_size(3, &self.talk_str);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.talk_str.is_empty() {
            os.write_string(3, &self.talk_str)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    R\x07retcode\x12\x19\n\x08talk_str\x18\x03\x20\x01(\tR\x07talkStr\x12?\n\
    \x11custom_value_list\x18\x04\x20\x03(\x0b2\x13.MissionCustomValueR\x0fc\
    ustomValueList\x12$\n\x0esub_mission_id\x18\x0e\x20\x01(\rR\x0csubMissio\
    nIdb\x06proto3\
";
