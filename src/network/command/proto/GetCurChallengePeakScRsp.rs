...
impl ::protobuf::Message for GetCurChallengePeakScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.cycles_used != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.cycles_used);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.cycles_used != 0 {
            os.write_uint32(7, self.cycles_used)?;
        }
        if self.boss_buff_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    cRsp\x12&\n\x0fis_wait_confirm\x18\x04\x20\x01(\x08R\risWaitConfirm\x12\
    \x1d\n\nhas_passed\x18\x0f\x20\x01(\x08R\thasPassed\x120\n\x14finished_t\
    arget_list\x18\x08\x20\x03(\rR\x12finishedTargetList\x12\x1f\n\x0bcycles\
    _used\x18\x07\x20\x01(\rR\ncyclesUsed\x12\x20\n\x0cboss_buff_id\x18\x02\
    \x20\x01(\rR\nbossBuffId\x12\x18\n\x07retcode\x18\x06\x20\x01(\rR\x07ret\
    code\x12\x17\n\x07peak_id\x18\x03\x20\x01(\rR\x06peakIdb\x06proto3\
";
