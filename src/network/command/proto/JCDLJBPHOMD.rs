...
impl ::protobuf::Message for JCDLJBPHOMD {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.BLCILJENELO != false {
            os.write_bool(9, self.BLCILJENELO)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    .\n\x0bGHELBOBFPAM\x18\x03\x20\x01(\x0b2\x0c.INPINNPIHOBR\x0bGHELBOBFPAM\
    \x12\x20\n\x0bBLCILJENELO\x18\t\x20\x01(\x08R\x0bBLCILJENELOb\x06proto3\
";
