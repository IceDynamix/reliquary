...
impl ::protobuf::Message for PVEBattleResultCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.turn_snapshot_hash.is_empty() {
            my_size += ::protobuf::rt::bytes_size(10, &self.turn_snapshot_hash);
        }
        if self.client_version != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.client_version);
        }
        if !self.debug_extra_info.is_empty() {
            my_size += ::protobuf::rt::string_size(8, &self.debug_extra_info);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.turn_snapshot_hash.is_empty() {
            os.write_bytes(10, &self.turn_snapshot_hash)?;
        }
        if self.client_version != 0 {
            os.write_uint32(15, self.client_version)?;
        }
        if !self.debug_extra_info.is_empty() {
            os.write_string(8, &self.debug_extra_info)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    CsReq\x12\x1b\n\tbattle_id\x18\x07\x20\x01(\rR\x08battleId\x12\x1b\n\tco\
    st_time\x18\x0c\x20\x01(\rR\x08costTime\x12\x20\n\x0bGJGKAGFPAGM\x18\x0e\
    \x20\x01(\x08R\x0bGJGKAGFPAGM\x12H\n\x0bHPEKEKIPJLF\x18\x03\x20\x03(\x0b\
    2&.PVEBattleResultCsReq.HPEKEKIPJLFEntryR\x0bHPEKEKIPJLF\x12/\n\nend_sta\
    tus\x18\x0b\x20\x01(\x0e2\x10.BattleEndStatusR\tendStatus\x12,\n\x12clie\
    nt_res_version\x18\t\x20\x01(\rR\x10clientResVersion\x12\x20\n\x0bJCJFGO\
    JFEGE\x18\x04\x20\x01(\rR\x0bJCJFGOJFEGE\x12:\n\x1ais_ai_consider_ultra_\
    skill\x18\x02\x20\x01(\x08R\x16isAiConsiderUltraSkill\x12\"\n\ris_auto_f\
    ight\x18\x06\x20\x01(\x08R\x0bisAutoFight\x12,\n\x12turn_snapshot_hash\
    \x18\n\x20\x01(\x0cR\x10turnSnapshotHash\x12%\n\x0eclient_version\x18\
    \x0f\x20\x01(\rR\rclientVersion\x12(\n\x10debug_extra_info\x18\x08\x20\
    \x01(\tR\x0edebugExtraInfo\x12\"\n\x07op_list\x18\r\x20\x03(\x0b2\t.Batt\
    leOpR\x06opList\x12#\n\x03stt\x18\x01\x20\x01(\x0b2\x11.BattleStatistics\
    R\x03stt\x12\x19\n\x08stage_id\x18\x05\x20\x01(\rR\x07stageId\x1a>\n\x10\
    HPEKEKIPJLFEntry\x12\x10\n\x03key\x18\x01\x20\x01(\tR\x03key\x12\x14\n\
