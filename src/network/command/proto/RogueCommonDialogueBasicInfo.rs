...
pub struct RogueCommonDialogueBasicInfo {
    // message fields
    // @@protoc_insertion_point(field:RogueCommonDialogueBasicInfo.talk_dialogue_id)
    pub talk_dialogue_id: u32,
    // @@protoc_insertion_point(field:RogueCommonDialogueBasicInfo.aeon_talk_id)
...
impl RogueCommonDialogueBasicInfo {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "talk_dialogue_id",
            |m: &RogueCommonDialogueBasicInfo| { &m.talk_dialogue_id },
            |m: &mut RogueCommonDialogueBasicInfo| { &mut m.talk_dialogue_id },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "aeon_talk_id",
            |m: &RogueCommonDialogueBasicInfo| { &m.aeon_talk_id },
            |m: &mut RogueCommonDialogueBasicInfo| { &mut m.aeon_talk_id },
        ));
...
impl ::protobuf::Message for RogueCommonDialogueBasicInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.talk_dialogue_id != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.talk_dialogue_id);
        }
        if self.aeon_talk_id != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.aeon_talk_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.talk_dialogue_id != 0 {
            os.write_uint32(5, self.talk_dialogue_id)?;
        }
        if self.aeon_talk_id != 0 {
            os.write_uint32(12, self.aeon_talk_id)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\"RogueCommonDialogueBasicInfo.proto\"j\n\x1cRogueCommonDialogueBasicI\
    nfo\x12(\n\x10talk_dialogue_id\x18\x05\x20\x01(\rR\x0etalkDialogueId\x12\
    \x20\n\x0caeon_talk_id\x18\x0c\x20\x01(\rR\naeonTalkIdb\x06proto3\
";
