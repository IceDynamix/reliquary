...
impl ::protobuf::Message for ArchiveData {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(7, &self.archive_missing_equipment_id_list);
        for value in &self.relic_list {
            let len = value.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
        };
        my_size += ::protobuf::rt::vec_packed_uint32_size(12, &self.archive_avatar_id_list);
        my_size += ::protobuf::rt::vec_packed_uint32_size(14, &self.archive_equipment_id_list);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(7, &self.archive_missing_equipment_id_list)?;
        for v in &self.relic_list {
            ::protobuf::rt::write_message_field_with_cached_size(11, v, os)?;
        };
        os.write_repeated_packed_uint32(12, &self.archive_avatar_id_list)?;
        os.write_repeated_packed_uint32(14, &self.archive_equipment_id_list)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x07\x20\x03(\rR\x1darchiveMissingEquipmentIdList\x12)\n\nrelic_list\x18\
    \x0b\x20\x03(\x0b2\n.RelicListR\trelicList\x123\n\x16archive_avatar_id_l\
    ist\x18\x0c\x20\x03(\rR\x13archiveAvatarIdList\x129\n\x19archive_equipme\
    nt_id_list\x18\x0e\x20\x03(\rR\x16archiveEquipmentIdList\x128\n\x11kill_\
    monster_list\x18\x0f\x20\x03(\x0b2\x0c.MonsterListR\x0fkillMonsterListb\
    \x06proto3\
";
