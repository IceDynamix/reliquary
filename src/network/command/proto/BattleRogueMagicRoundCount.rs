...
pub struct BattleRogueMagicRoundCount {
    // message fields
    // @@protoc_insertion_point(field:BattleRogueMagicRoundCount.battle_standard_round_limit)
    pub battle_standard_round_limit: u32,
    // @@protoc_insertion_point(field:BattleRogueMagicRoundCount.battle_extra_round_limit)
...
impl BattleRogueMagicRoundCount {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "battle_standard_round_limit",
            |m: &BattleRogueMagicRoundCount| { &m.battle_standard_round_limit },
            |m: &mut BattleRogueMagicRoundCount| { &mut m.battle_standard_round_limit },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "battle_extra_round_limit",
            |m: &BattleRogueMagicRoundCount| { &m.battle_extra_round_limit },
            |m: &mut BattleRogueMagicRoundCount| { &mut m.battle_extra_round_limit },
        ));
...
impl ::protobuf::Message for BattleRogueMagicRoundCount {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                8 => {
                    self.battle_standard_round_limit = is.read_uint32()?;
                },
                16 => {
                    self.battle_extra_round_limit = is.read_uint32()?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.battle_standard_round_limit != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.battle_standard_round_limit);
        }
        if self.battle_extra_round_limit != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.battle_extra_round_limit);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.battle_standard_round_limit != 0 {
            os.write_uint32(1, self.battle_standard_round_limit)?;
        }
        if self.battle_extra_round_limit != 0 {
            os.write_uint32(2, self.battle_extra_round_limit)?;
        }
    ...
    fn clear(&mut self) {
        self.battle_standard_round_limit = 0;
        self.battle_extra_round_limit = 0;
    ...
    fn default_instance() -> &'static BattleRogueMagicRoundCount {
        static instance: BattleRogueMagicRoundCount = BattleRogueMagicRoundCount {
            battle_standard_round_limit: 0,
            battle_extra_round_limit: 0,
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x20BattleRogueMagicRoundCount.proto\"\x94\x01\n\x1aBattleRogueMagicRo\
    undCount\x12=\n\x1bbattle_standard_round_limit\x18\x01\x20\x01(\rR\x18ba\
    ttleStandardRoundLimit\x127\n\x18battle_extra_round_limit\x18\x02\x20\
    \x01(\rR\x15battleExtraRoundLimitb\x06proto3\
";
