...
//! Generated file from `AIIGHJEIGHE.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:AIIGHJEIGHE)
...
pub struct AIIGHJEIGHE {
    ...
    pub buff_id: u32,
    // special fields
    // @@protoc_insertion_point(special_field:AIIGHJEIGHE.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a AIIGHJEIGHE {
    fn default() -> &'a AIIGHJEIGHE {
        <AIIGHJEIGHE as ::protobuf::Message>::default_instance()
    }
}

impl AIIGHJEIGHE {
    pub fn new() -> AIIGHJEIGHE {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "buff_id",
            |m: &AIIGHJEIGHE| { &m.buff_id },
            |m: &mut AIIGHJEIGHE| { &mut m.buff_id },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<AIIGHJEIGHE>(
            "AIIGHJEIGHE",
            fields,
            oneofs,
        )
...
impl ::protobuf::Message for AIIGHJEIGHE {
    const NAME: &'static str = "AIIGHJEIGHE";
...
impl ::protobuf::MessageFull for AIIGHJEIGHE {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("AIIGHJEIGHE").unwrap()).clone()
    }
}

impl ::std::fmt::Display for AIIGHJEIGHE {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for AIIGHJEIGHE {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(AIIGHJEIGHE::generated_message_descriptor_data());
