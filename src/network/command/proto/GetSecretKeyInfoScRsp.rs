...
impl ::protobuf::Message for GetSecretKeyInfoScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.secret_rsp.is_empty() {
            my_size += ::protobuf::rt::string_size(4, &self.secret_rsp);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if !self.secret_rsp.is_empty() {
            os.write_string(4, &self.secret_rsp)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x15GetSecretKeyInfoScRsp\x12\x1d\n\nsecret_rsp\x18\x04\x20\x01(\tR\tsec\
    retRsp\x12/\n\x0bsecret_info\x18\x05\x20\x03(\x0b2\x0e.SecretKeyInfoR\ns\
