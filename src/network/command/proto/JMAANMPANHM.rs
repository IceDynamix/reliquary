...
impl ::protobuf::Message for JMAANMPANHM {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.CLPMIBDFPJC != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.CLPMIBDFPJC);
        }
        if self.NHJALPDBOGN != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.NHJALPDBOGN);
        }
        if self.FPAIBLDAKLI != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.FPAIBLDAKLI);
        }
        if self.index != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.index);
        }
        if self.NOEIMMHCKPM != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.NOEIMMHCKPM);
        }
        if self.TURN_FOOD_SWITCH_ATTACK != 0 {
            my_size += ::protobuf::rt::int32_size(13, self.TURN_FOOD_SWITCH_ATTACK);
        }
        if self.hp != 0 {
            my_size += ::protobuf::rt::int32_size(12, self.hp);
        }
        if self.NKOFFBMHAPI != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.NKOFFBMHAPI);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.CLPMIBDFPJC != 0 {
            os.write_uint32(6, self.CLPMIBDFPJC)?;
        }
        if self.NHJALPDBOGN != 0 {
            os.write_uint32(4, self.NHJALPDBOGN)?;
        }
        if self.FPAIBLDAKLI != 0 {
            os.write_uint32(3, self.FPAIBLDAKLI)?;
        }
        if self.index != 0 {
            os.write_uint32(11, self.index)?;
        }
        if self.NOEIMMHCKPM != 0 {
            os.write_uint32(9, self.NOEIMMHCKPM)?;
        }
        if self.TURN_FOOD_SWITCH_ATTACK != 0 {
            os.write_int32(13, self.TURN_FOOD_SWITCH_ATTACK)?;
        }
        if self.hp != 0 {
            os.write_int32(12, self.hp)?;
        }
        if self.NKOFFBMHAPI != 0 {
            os.write_uint32(10, self.NKOFFBMHAPI)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    PJC\x18\x06\x20\x01(\rR\x0bCLPMIBDFPJC\x12\x20\n\x0bNHJALPDBOGN\x18\x04\
    \x20\x01(\rR\x0bNHJALPDBOGN\x12\x20\n\x0bFPAIBLDAKLI\x18\x03\x20\x01(\rR\
    \x0bFPAIBLDAKLI\x12\x14\n\x05index\x18\x0b\x20\x01(\rR\x05index\x12\x20\
    \n\x0bNOEIMMHCKPM\x18\t\x20\x01(\rR\x0bNOEIMMHCKPM\x125\n\x17TURN_FOOD_S\
    WITCH_ATTACK\x18\r\x20\x01(\x05R\x14TURNFOODSWITCHATTACK\x12\x0e\n\x02hp\
    \x18\x0c\x20\x01(\x05R\x02hp\x12\x20\n\x0bNKOFFBMHAPI\x18\n\x20\x01(\rR\
    \x0bNKOFFBMHAPIb\x06proto3\
";
