...
impl ::protobuf::Message for OfferingInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.offering_state != ::protobuf::EnumOrUnknown::new(super::OfferingState::OfferingState::OFFERING_STATE_NONE) {
            my_size += ::protobuf::rt::int32_size(15, self.offering_state.value());
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(12, &self.has_taken_reward_id_list);
        if self.level_exp != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.level_exp);
        }
        if self.offering_id != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.offering_id);
        }
        if self.total_exp != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.offering_state != ::protobuf::EnumOrUnknown::new(super::OfferingState::OfferingState::OFFERING_STATE_NONE) {
            os.write_enum(15, ::protobuf::EnumOrUnknown::value(&self.offering_state))?;
        }
        os.write_repeated_packed_uint32(12, &self.has_taken_reward_id_list)?;
        if self.level_exp != 0 {
            os.write_uint32(3, self.level_exp)?;
        }
        if self.offering_id != 0 {
            os.write_uint32(14, self.offering_id)?;
        }
        if self.total_exp != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ingInfo\x125\n\x0eoffering_state\x18\x0f\x20\x01(\x0e2\x0e.OfferingState\
    R\rofferingState\x126\n\x18has_taken_reward_id_list\x18\x0c\x20\x03(\rR\
    \x14hasTakenRewardIdList\x12\x1b\n\tlevel_exp\x18\x03\x20\x01(\rR\x08lev\
    elExp\x12\x1f\n\x0boffering_id\x18\x0e\x20\x01(\rR\nofferingId\x12\x1b\n\
    \ttotal_exp\x18\x05\x20\x01(\rR\x08totalExp\x12%\n\x0eoffering_level\x18\
    \t\x20\x01(\rR\rofferingLevelb\x06proto3\
";
