...
impl ::protobuf::Message for OfferingInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.offering_state != ::protobuf::EnumOrUnknown::new(super::OfferingState::OfferingState::OFFERING_STATE_NONE) {
            my_size += ::protobuf::rt::int32_size(3, self.offering_state.value());
        }
        if self.offering_level != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.offering_level);
        }
        if self.total_exp != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.total_exp);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(2, &self.has_taken_reward_id_list);
        if self.offering_id != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.offering_id);
        }
        if self.level_exp != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.level_exp);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.offering_state != ::protobuf::EnumOrUnknown::new(super::OfferingState::OfferingState::OFFERING_STATE_NONE) {
            os.write_enum(3, ::protobuf::EnumOrUnknown::value(&self.offering_state))?;
        }
        if self.offering_level != 0 {
            os.write_uint32(15, self.offering_level)?;
        }
        if self.total_exp != 0 {
            os.write_uint32(8, self.total_exp)?;
        }
        os.write_repeated_packed_uint32(2, &self.has_taken_reward_id_list)?;
        if self.offering_id != 0 {
            os.write_uint32(1, self.offering_id)?;
        }
        if self.level_exp != 0 {
            os.write_uint32(7, self.level_exp)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ingInfo\x125\n\x0eoffering_state\x18\x03\x20\x01(\x0e2\x0e.OfferingState\
    R\rofferingState\x12%\n\x0eoffering_level\x18\x0f\x20\x01(\rR\rofferingL\
    evel\x12\x1b\n\ttotal_exp\x18\x08\x20\x01(\rR\x08totalExp\x126\n\x18has_\
    taken_reward_id_list\x18\x02\x20\x03(\rR\x14hasTakenRewardIdList\x12\x1f\
    \n\x0boffering_id\x18\x01\x20\x01(\rR\nofferingId\x12\x1b\n\tlevel_exp\
    \x18\x07\x20\x01(\rR\x08levelExpb\x06proto3\
";
