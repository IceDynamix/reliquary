...
impl ::protobuf::Message for HeliobusStartRaidCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.ENLKNPIBLIO != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.ENLKNPIBLIO);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.ENLKNPIBLIO != 0 {
            os.write_uint32(9, self.ENLKNPIBLIO)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12\x17\n\x07is_save\x18\x01\x20\x01(\x08R\x06isSave\x12\x1f\n\x0bavata\
    r_list\x18\x0f\x20\x03(\rR\navatarList\x12\x19\n\x08skill_id\x18\x04\x20\
    \x01(\rR\x07skillId\x12\x17\n\x07raid_id\x18\x0b\x20\x01(\rR\x06raidId\
    \x12$\n\x0eprop_entity_id\x18\x0e\x20\x01(\rR\x0cpropEntityId\x12\x20\n\
    \x0bENLKNPIBLIO\x18\t\x20\x01(\rR\x0bENLKNPIBLIOb\x06proto3\
";
