...
impl ::protobuf::Message for GetPrivateChatHistoryScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.contact_side != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.contact_side);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.contact_side != 0 {
            os.write_uint32(10, self.contact_side)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \xb8\x01\n\x1aGetPrivateChatHistoryScRsp\x12<\n\x11chat_message_list\x18\
    \x03\x20\x03(\x0b2\x10.ChatMessageDataR\x0fchatMessageList\x12\x1f\n\x0b\
    target_side\x18\x05\x20\x01(\rR\ntargetSide\x12!\n\x0ccontact_side\x18\n\
    \x20\x01(\rR\x0bcontactSide\x12\x18\n\x07retcode\x18\x0e\x20\x01(\rR\x07\
    retcodeb\x06proto3\
";
