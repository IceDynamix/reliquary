...
impl ::protobuf::Message for GetDrinkMakerDataScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.AMEFGBICGDI != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.AMEFGBICGDI);
        }
        if self.DHAKOFAGDOF != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.DHAKOFAGDOF);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.AMEFGBICGDI != 0 {
            os.write_uint32(3, self.AMEFGBICGDI)?;
        }
        if self.DHAKOFAGDOF != 0 {
            os.write_uint32(12, self.DHAKOFAGDOF)?;
        }
        if self.EAOLMHOAAML != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    EKFECDIHJE.proto\"\xe8\x02\n\x16GetDrinkMakerDataScRsp\x12.\n\x0bBOINOMB\
    HPCL\x18\x0b\x20\x01(\x0b2\x0c.EEKFECDIHJER\x0bBOINOMBHPCL\x12\x18\n\x07\
    retcode\x18\n\x20\x01(\rR\x07retcode\x12\x20\n\x0bHEPALNIOJNP\x18\x04\
    \x20\x01(\rR\x0bHEPALNIOJNP\x122\n\x0bPJKIBODPCKI\x18\x0f\x20\x03(\x0b2\
    \x10.DrinkMakerGuestR\x0bPJKIBODPCKI\x12\x20\n\x0bPCNNPEJEGEF\x18\x0e\
    \x20\x03(\rR\x0bPCNNPEJEGEF\x12\x14\n\x05level\x18\x07\x20\x01(\rR\x05le\
    vel\x12\x20\n\x0bAMEFGBICGDI\x18\x03\x20\x01(\rR\x0bAMEFGBICGDI\x12\x20\
    \n\x0bDHAKOFAGDOF\x18\x0c\x20\x01(\rR\x0bDHAKOFAGDOF\x12\x20\n\x0bEAOLMH\
    OAAML\x18\x06\x20\x01(\rR\x0bEAOLMHOAAML\x12\x10\n\x03exp\x18\x02\x20\
