...
pub struct GetDrinkMakerDataScRsp {
    ...
    pub PJKIBODPCKI: ::std::vec::Vec<super::HIAMKFICMNM::HIAMKFICMNM>,
...
impl ::protobuf::Message for GetDrinkMakerDataScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.EAOLMHOAAML != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.EAOLMHOAAML);
        }
        if self.HEPALNIOJNP != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.HEPALNIOJNP);
        }
        ...
        if self.AMEFGBICGDI != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.AMEFGBICGDI);
        }
        if self.level != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.EAOLMHOAAML != 0 {
            os.write_uint32(7, self.EAOLMHOAAML)?;
        }
        if self.HEPALNIOJNP != 0 {
            os.write_uint32(4, self.HEPALNIOJNP)?;
        }
        if self.DHAKOFAGDOF != 0 {
        ...
        if self.AMEFGBICGDI != 0 {
            os.write_uint32(6, self.AMEFGBICGDI)?;
        }
        if self.level != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1cGetDrinkMakerDataScRsp.proto\x1a\x11EEKFECDIHJE.proto\x1a\x11HIAMK\
    FICMNM.proto\"\xe4\x02\n\x16GetDrinkMakerDataScRsp\x12\x10\n\x03exp\x18\
    \x02\x20\x01(\rR\x03exp\x12.\n\x0bBOINOMBHPCL\x18\x0b\x20\x01(\x0b2\x0c.\
    EEKFECDIHJER\x0bBOINOMBHPCL\x12\x20\n\x0bEAOLMHOAAML\x18\x07\x20\x01(\rR\
    \x0bEAOLMHOAAML\x12\x20\n\x0bHEPALNIOJNP\x18\x04\x20\x01(\rR\x0bHEPALNIO\
    JNP\x12\x20\n\x0bDHAKOFAGDOF\x18\n\x20\x01(\rR\x0bDHAKOFAGDOF\x12\x20\n\
    \x0bPCNNPEJEGEF\x18\x03\x20\x03(\rR\x0bPCNNPEJEGEF\x12\x18\n\x07retcode\
    \x18\x08\x20\x01(\rR\x07retcode\x12.\n\x0bPJKIBODPCKI\x18\t\x20\x03(\x0b\
    2\x0c.HIAMKFICMNMR\x0bPJKIBODPCKI\x12\x20\n\x0bAMEFGBICGDI\x18\x06\x20\
    \x01(\rR\x0bAMEFGBICGDI\x12\x14\n\x05level\x18\x01\x20\x01(\rR\x05levelb\
    \x06proto3\
";
