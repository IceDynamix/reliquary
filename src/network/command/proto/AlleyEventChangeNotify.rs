...
pub struct AlleyEventChangeNotify {
    // message fields
    // @@protoc_insertion_point(field:AlleyEventChangeNotify.MHLLAJGIEEK)
    pub MHLLAJGIEEK: ::protobuf::MessageField<super::BLDFMMDKGEP::BLDFMMDKGEP>,
    // @@protoc_insertion_point(field:AlleyEventChangeNotify.FPEDPLMKEFH)
    pub FPEDPLMKEFH: u32,
    // special fields
...
impl AlleyEventChangeNotify {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::BLDFMMDKGEP::BLDFMMDKGEP>(
            "MHLLAJGIEEK",
            |m: &AlleyEventChangeNotify| { &m.MHLLAJGIEEK },
            |m: &mut AlleyEventChangeNotify| { &mut m.MHLLAJGIEEK },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "FPEDPLMKEFH",
            |m: &AlleyEventChangeNotify| { &m.FPEDPLMKEFH },
            |m: &mut AlleyEventChangeNotify| { &mut m.FPEDPLMKEFH },
        ));
...
impl ::protobuf::Message for AlleyEventChangeNotify {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                72 => {
                    self.FPEDPLMKEFH = is.read_uint32()?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.FPEDPLMKEFH != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.FPEDPLMKEFH);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.FPEDPLMKEFH != 0 {
            os.write_uint32(9, self.FPEDPLMKEFH)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1cAlleyEventChangeNotify.proto\x1a\x11BLDFMMDKGEP.proto\"j\n\x16Alle\
    yEventChangeNotify\x12.\n\x0bMHLLAJGIEEK\x18\x0b\x20\x01(\x0b2\x0c.BLDFM\
    MDKGEPR\x0bMHLLAJGIEEK\x12\x20\n\x0bFPEDPLMKEFH\x18\t\x20\x01(\rR\x0bFPE\
    DPLMKEFHb\x06proto3\
";
