...
pub struct AlleyEventChangeNotify {
    // message fields
    // @@protoc_insertion_point(field:AlleyEventChangeNotify.DCLBNIOBOAC)
    pub DCLBNIOBOAC: ::protobuf::MessageField<super::KMLGGPGEBDE::KMLGGPGEBDE>,
    // @@protoc_insertion_point(field:AlleyEventChangeNotify.DFAMNLMMLGN)
    pub DFAMNLMMLGN: u32,
    // special fields
...
impl AlleyEventChangeNotify {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::KMLGGPGEBDE::KMLGGPGEBDE>(
            "DCLBNIOBOAC",
            |m: &AlleyEventChangeNotify| { &m.DCLBNIOBOAC },
            |m: &mut AlleyEventChangeNotify| { &mut m.DCLBNIOBOAC },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "DFAMNLMMLGN",
            |m: &AlleyEventChangeNotify| { &m.DFAMNLMMLGN },
            |m: &mut AlleyEventChangeNotify| { &mut m.DFAMNLMMLGN },
        ));
...
impl ::protobuf::Message for AlleyEventChangeNotify {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                64 => {
                    self.DFAMNLMMLGN = is.read_uint32()?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.DFAMNLMMLGN != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.DFAMNLMMLGN);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.DFAMNLMMLGN != 0 {
            os.write_uint32(8, self.DFAMNLMMLGN)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1cAlleyEventChangeNotify.proto\x1a\x11KMLGGPGEBDE.proto\"j\n\x16Alle\
    yEventChangeNotify\x12.\n\x0bDCLBNIOBOAC\x18\x05\x20\x01(\x0b2\x0c.KMLGG\
    PGEBDER\x0bDCLBNIOBOAC\x12\x20\n\x0bDFAMNLMMLGN\x18\x08\x20\x01(\rR\x0bD\
    FAMNLMMLGNb\x06proto3\
";
