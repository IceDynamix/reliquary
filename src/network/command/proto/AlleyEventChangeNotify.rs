...
impl ::protobuf::Message for AlleyEventChangeNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.HCNLDIBEACA != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.HCNLDIBEACA);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.HCNLDIBEACA != 0 {
            os.write_uint32(2, self.HCNLDIBEACA)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    yEventChangeNotify\x12.\n\x0bNFLDODIABCL\x18\t\x20\x01(\x0b2\x0c.HEHAOMI\
    AMGLR\x0bNFLDODIABCL\x12\x20\n\x0bHCNLDIBEACA\x18\x02\x20\x01(\rR\x0bHCN\
    LDIBEACAb\x06proto3\
";
