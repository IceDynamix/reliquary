...
impl ::protobuf::Message for EGALAGNAEFB {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.GPDEIIIOIPN != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.GPDEIIIOIPN);
        }
        if self.OLGLJHECDOF != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.OLGLJHECDOF);
        }
        if self.GCLEBGDDIIP != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.GCLEBGDDIIP);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.GPDEIIIOIPN != 0 {
            os.write_uint32(8, self.GPDEIIIOIPN)?;
        }
        if self.OLGLJHECDOF != 0 {
            os.write_uint32(7, self.OLGLJHECDOF)?;
        }
        if self.GCLEBGDDIIP != 0 {
            os.write_uint32(10, self.GCLEBGDDIIP)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x08\x20\x01(\rR\x0bGPDEIIIOIPN\x12\x20\n\x0bOLGLJHECDOF\x18\x07\x20\x01\
    (\rR\x0bOLGLJHECDOF\x12\x20\n\x0bGCLEBGDDIIP\x18\n\x20\x01(\rR\x0bGCLEBG\
    DDIIPb\x06proto3\
";
