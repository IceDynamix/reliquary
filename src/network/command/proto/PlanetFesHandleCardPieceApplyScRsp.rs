...
impl ::protobuf::Message for PlanetFesHandleCardPieceApplyScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(5, &self.DLHBCOKCIDP);
        if self.retcode != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.retcode);
        }
        if self.PPIOLCLPMPL != 0 {
            my_size += ::protobuf::rt::int64_size(8, self.PPIOLCLPMPL);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.MDAPCFHELJL != false {
            os.write_bool(15, self.MDAPCFHELJL)?;
        }
        os.write_repeated_packed_uint32(5, &self.DLHBCOKCIDP)?;
        if self.retcode != 0 {
            os.write_uint32(3, self.retcode)?;
        }
        if self.PPIOLCLPMPL != 0 {
            os.write_int64(8, self.PPIOLCLPMPL)?;
        }
        if self.PNAKHNBDJAE != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    CardPieceApplyScRsp\x12\x20\n\x0bMDAPCFHELJL\x18\x0f\x20\x01(\x08R\x0bMD\
    APCFHELJL\x12\x20\n\x0bDLHBCOKCIDP\x18\x05\x20\x03(\rR\x0bDLHBCOKCIDP\
    \x12\x18\n\x07retcode\x18\x03\x20\x01(\rR\x07retcode\x12\x20\n\x0bPPIOLC\
    LPMPL\x18\x08\x20\x01(\x03R\x0bPPIOLCLPMPL\x12\x20\n\x0bPNAKHNBDJAE\x18\
    \x0c\x20\x01(\rR\x0bPNAKHNBDJAEb\x06proto3\
";
