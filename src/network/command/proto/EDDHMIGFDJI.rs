...
impl ::protobuf::Message for EDDHMIGFDJI {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.MBGKCKLDHIB != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.MBGKCKLDHIB);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.MBGKCKLDHIB != 0 {
            os.write_uint32(7, self.MBGKCKLDHIB)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x05\x20\x01(\x08R\x0bPIPMGACMJNN\x12\x20\n\x0bINBJPPAPCAG\x18\x0b\x20\
    \x01(\rR\x0bINBJPPAPCAG\x12\x20\n\x0bMBGKCKLDHIB\x18\x07\x20\x01(\rR\x0b\
    MBGKCKLDHIBb\x06proto3\
";
