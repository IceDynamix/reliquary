...
impl ::protobuf::Message for GetPetDataScRsp {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(15, &self.unlocked_pet_id);
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(15, &self.unlocked_pet_id)?;
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    et_id\x18\x0f\x20\x03(\rR\runlockedPetId\x12\x18\n\x07retcode\x18\x04\
    \x20\x01(\rR\x07retcode\x12\x1c\n\ncur_pet_id\x18\x03\x20\x01(\rR\x08cur\
    PetIdb\x06proto3\
";
