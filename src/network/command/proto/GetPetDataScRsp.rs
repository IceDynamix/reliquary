...
impl ::protobuf::Message for GetPetDataScRsp {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(9, &self.unlocked_pet_id);
        if self.cur_pet_id != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.cur_pet_id);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(9, &self.unlocked_pet_id)?;
        if self.cur_pet_id != 0 {
            os.write_uint32(11, self.cur_pet_id)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    et_id\x18\t\x20\x03(\rR\runlockedPetId\x12\x1c\n\ncur_pet_id\x18\x0b\x20\
    \x01(\rR\x08curPetId\x12\x18\n\x07retcode\x18\n\x20\x01(\rR\x07retcodeb\
    \x06proto3\
";
