...
impl ::protobuf::Message for RefreshTriggerByClientCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.trigger_entity_id != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.trigger_entity_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.trigger_entity_id != 0 {
            os.write_uint32(8, self.trigger_entity_id)?;
        }
        if !self.trigger_name.is_empty() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x1bRefreshTriggerByClientCsReq\x122\n\x0etrigger_motion\x18\x03\x20\x01\
    (\x0b2\x0b.MotionInfoR\rtriggerMotion\x12*\n\x11trigger_entity_id\x18\
    \x08\x20\x01(\rR\x0ftriggerEntityId\x12!\n\x0ctrigger_name\x18\t\x20\x01\
    (\tR\x0btriggerName\x123\n\x16trigger_target_id_list\x18\x01\x20\x03(\rR\
    \x13triggerTargetIdList\x12\x1f\n\x0binteract_id\x18\x06\x20\x01(\x04R\n\
