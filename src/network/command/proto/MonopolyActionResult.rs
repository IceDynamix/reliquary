...
impl ::protobuf::Message for MonopolyActionResult {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.trigger_cell_id != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.trigger_cell_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.trigger_cell_id != 0 {
            os.write_uint32(4, self.trigger_cell_id)?;
        }
        if let Some(v) = self.detail.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x04\x20\x01(\rR\rtriggerCellId\x12$\n\x06detail\x18\x06\x20\x01(\
    \x0b2\x0c.GPPKIMDCPBMR\x06detail\x12\x20\n\x0cclick_map_id\x18\x07\x20\
    \x01(\rR\nclickMapId\x12\"\n\rclick_cell_id\x18\x08\x20\x01(\rR\x0bclick\
    CellId\x12\x1f\n\x0beffect_type\x18\x0b\x20\x01(\rR\neffectType\x12$\n\
    \x0etrigger_map_id\x18\r\x20\x01(\rR\x0ctriggerMapId\x12-\n\x0bsource_ty\
    pe\x18\x0f\x20\x01(\x0e2\x0c.BAKAELIMIJIR\nsourceTypeb\x06proto3\
";
