...
//! Generated file from `RogueCommonVirtualItemInfo.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:RogueCommonVirtualItemInfo)
...
impl<'a> ::std::default::Default for &'a RogueCommonVirtualItemInfo {
    fn default() -> &'a RogueCommonVirtualItemInfo {
        <RogueCommonVirtualItemInfo as ::protobuf::Message>::default_instance()
    }
}

impl RogueCommonVirtualItemInfo {
    pub fn new() -> RogueCommonVirtualItemInfo {
...
impl ::protobuf::Message for RogueCommonVirtualItemInfo {
    const NAME: &'static str = "RogueCommonVirtualItemInfo";
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.virtual_item_id != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.virtual_item_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.virtual_item_id != 0 {
            os.write_uint32(7, self.virtual_item_id)?;
        }
    ...
    fn new() -> RogueCommonVirtualItemInfo {
        RogueCommonVirtualItemInfo::new()
    }
...
impl ::protobuf::MessageFull for RogueCommonVirtualItemInfo {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("RogueCommonVirtualItemInfo").unwrap()).clone()
    }
}

impl ::std::fmt::Display for RogueCommonVirtualItemInfo {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for RogueCommonVirtualItemInfo {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x0fvirtual_item_id\x18\x07\x20\x01(\rR\rvirtualItemIdb\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(RogueCommonVirtualItemInfo::generated_message_descriptor_data());
