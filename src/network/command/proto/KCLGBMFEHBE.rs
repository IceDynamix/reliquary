...
impl ::protobuf::Message for KCLGBMFEHBE {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.NFKMDDNPGBJ != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.NFKMDDNPGBJ);
        }
        if self.DCABNHJMMJG != false {
            my_size += 1 + 1;
        }
        if self.BPOCKMFJMEK != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.BPOCKMFJMEK);
        }
        ...
        if self.BAMEDJDAOMC != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.BAMEDJDAOMC);
        }
        if self.NKBMEBELLFJ != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.NKBMEBELLFJ);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.KDGCCOMKIPO != 0. {
            os.write_double(13, self.KDGCCOMKIPO)?;
        }
        if self.NFKMDDNPGBJ != 0 {
            os.write_uint32(15, self.NFKMDDNPGBJ)?;
        }
        if self.DCABNHJMMJG != false {
            os.write_bool(12, self.DCABNHJMMJG)?;
        }
        if self.BPOCKMFJMEK != 0 {
            os.write_uint32(4, self.BPOCKMFJMEK)?;
        }
        if self.CBLAMACCEPB != 0 {
        ...
        if self.EMPLJNHEPHC != false {
            os.write_bool(11, self.EMPLJNHEPHC)?;
        }
        if self.BAMEDJDAOMC != 0 {
            os.write_uint32(8, self.BAMEDJDAOMC)?;
        }
        if self.NKBMEBELLFJ != 0 {
            os.write_uint32(2, self.NKBMEBELLFJ)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    IPO\x18\r\x20\x01(\x01R\x0bKDGCCOMKIPO\x12\x20\n\x0bNFKMDDNPGBJ\x18\x0f\
    \x20\x01(\rR\x0bNFKMDDNPGBJ\x12\x20\n\x0bDCABNHJMMJG\x18\x0c\x20\x01(\
    \x08R\x0bDCABNHJMMJG\x12\x20\n\x0bBPOCKMFJMEK\x18\x04\x20\x01(\rR\x0bBPO\
    CKMFJMEK\x12\x20\n\x0bCBLAMACCEPB\x18\x0e\x20\x01(\rR\x0bCBLAMACCEPB\x12\
    \x1b\n\tavatar_id\x18\x06\x20\x01(\rR\x08avatarId\x12\x20\n\x0bEMPLJNHEP\
    HC\x18\x0b\x20\x01(\x08R\x0bEMPLJNHEPHC\x12\x20\n\x0bBAMEDJDAOMC\x18\x08\
    \x20\x01(\rR\x0bBAMEDJDAOMC\x12\x20\n\x0bNKBMEBELLFJ\x18\x02\x20\x01(\rR\
    \x0bNKBMEBELLFJb\x06proto3\
";
