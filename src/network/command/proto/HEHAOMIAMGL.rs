...
pub struct HEHAOMIAMGL {
    // message fields
    // @@protoc_insertion_point(field:HEHAOMIAMGL.MGKEHOJCNPA)
    pub MGKEHOJCNPA: u32,
    // @@protoc_insertion_point(field:HEHAOMIAMGL.event_id)
    pub event_id: u32,
    // @@protoc_insertion_point(field:HEHAOMIAMGL.state)
...
impl HEHAOMIAMGL {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "MGKEHOJCNPA",
            |m: &HEHAOMIAMGL| { &m.MGKEHOJCNPA },
            |m: &mut HEHAOMIAMGL| { &mut m.MGKEHOJCNPA },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "event_id",
            |m: &HEHAOMIAMGL| { &m.event_id },
            |m: &mut HEHAOMIAMGL| { &mut m.event_id },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "state",
            |m: &HEHAOMIAMGL| { &m.state },
            |m: &mut HEHAOMIAMGL| { &mut m.state },
        ));
...
impl ::protobuf::Message for HEHAOMIAMGL {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                80 => {
                    self.MGKEHOJCNPA = is.read_uint32()?;
                },
                96 => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.MGKEHOJCNPA != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.MGKEHOJCNPA);
        }
        if self.event_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.MGKEHOJCNPA != 0 {
            os.write_uint32(10, self.MGKEHOJCNPA)?;
        }
        if self.event_id != 0 {
    ...
    fn clear(&mut self) {
        self.MGKEHOJCNPA = 0;
        self.event_id = 0;
        self.state = ::protobuf::EnumOrUnknown::new(super::AlleyEventState::AlleyEventState::ALLEY_STATE_NONE);
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12\x20\n\x0bMGKEHOJCNPA\x18\n\x20\x01(\rR\x0bMGKEHOJCNPA\x12\x19\n\x08\
    event_id\x18\x0c\x20\x01(\rR\x07eventId\x12&\n\x05state\x18\x0f\x20\x01(\
