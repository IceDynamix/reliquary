...
impl ::protobuf::Message for HEHAOMIAMGL {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.NINGBNBMKOP != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.NINGBNBMKOP);
        }
        if self.event_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.NINGBNBMKOP != 0 {
            os.write_uint32(3, self.NINGBNBMKOP)?;
        }
        if self.event_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12\x20\n\x0bNINGBNBMKOP\x18\x03\x20\x01(\rR\x0bNINGBNBMKOP\x12\x19\n\
    \x08event_id\x18\x02\x20\x01(\rR\x07eventId\x12&\n\x05state\x18\x06\x20\
    \x01(\x0e2\x10.AlleyEventStateR\x05stateb\x06proto3\
";
