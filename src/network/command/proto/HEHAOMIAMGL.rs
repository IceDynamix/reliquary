...
impl ::protobuf::Message for HEHAOMIAMGL {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.NINGBNBMKOP != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.NINGBNBMKOP);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.NINGBNBMKOP != 0 {
            os.write_uint32(15, self.NINGBNBMKOP)?;
        }
        if self.state != ::protobuf::EnumOrUnknown::new(super::AlleyEventState::AlleyEventState::ALLEY_STATE_NONE) {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12\x20\n\x0bNINGBNBMKOP\x18\x0f\x20\x01(\rR\x0bNINGBNBMKOP\x12&\n\x05s\
    tate\x18\x0e\x20\x01(\x0e2\x10.AlleyEventStateR\x05state\x12\x19\n\x08ev\
    ent_id\x18\x06\x20\x01(\rR\x07eventIdb\x06proto3\
";
