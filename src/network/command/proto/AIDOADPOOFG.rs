...
//! Generated file from `AIDOADPOOFG.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:AIDOADPOOFG)
...
impl<'a> ::std::default::Default for &'a AIDOADPOOFG {
    fn default() -> &'a AIDOADPOOFG {
        <AIDOADPOOFG as ::protobuf::Message>::default_instance()
    }
}

impl AIDOADPOOFG {
    pub fn new() -> AIDOADPOOFG {
...
impl ::protobuf::Message for AIDOADPOOFG {
    const NAME: &'static str = "AIDOADPOOFG";
...
impl ::protobuf::MessageFull for AIDOADPOOFG {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("AIDOADPOOFG").unwrap()).clone()
    }
}

impl ::std::fmt::Display for AIDOADPOOFG {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for AIDOADPOOFG {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x11AIDOADPOOFG.proto\x1a\x11CBBDIOMIFHD.proto\"=\n\x0bAIDOADPOOFG\x12\
    .\n\x0bLIPJDJPMOKB\x18\x0b\x20\x03(\x0b2\x0c.CBBDIOMIFHDR\x0bLIPJDJPMOKB\
    b\x06proto3\
";
