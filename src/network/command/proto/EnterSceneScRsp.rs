...
impl ::protobuf::Message for EnterSceneScRsp {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.is_close_map != false {
            os.write_bool(4, self.is_close_map)?;
        }
        if self.retcode != 0 {
        ...
        if self.is_over_map != false {
            os.write_bool(13, self.is_over_map)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    e_story_line_id\x18\x01\x20\x01(\rR\x0fgameStoryLineId\x12\x20\n\x0cis_c\
    lose_map\x18\x04\x20\x01(\x08R\nisCloseMap\x12\x18\n\x07retcode\x18\x07\
    \x20\x01(\rR\x07retcode\x12\x1d\n\ncontent_id\x18\x0b\x20\x01(\rR\tconte\
    ntId\x12\x1e\n\x0bis_over_map\x18\r\x20\x01(\x08R\tisOverMapb\x06proto3\
";
