...
pub struct FightFestUnlockSkillNotify {
    // message fields
    // @@protoc_insertion_point(field:FightFestUnlockSkillNotify.AMAGKDCBFGL)
    pub AMAGKDCBFGL: u32,
    // special fields
...
impl FightFestUnlockSkillNotify {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "AMAGKDCBFGL",
            |m: &FightFestUnlockSkillNotify| { &m.AMAGKDCBFGL },
            |m: &mut FightFestUnlockSkillNotify| { &mut m.AMAGKDCBFGL },
        ));
...
impl ::protobuf::Message for FightFestUnlockSkillNotify {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                88 => {
                    self.AMAGKDCBFGL = is.read_uint32()?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.AMAGKDCBFGL != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.AMAGKDCBFGL);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.AMAGKDCBFGL != 0 {
            os.write_uint32(11, self.AMAGKDCBFGL)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    y\x12\x20\n\x0bAMAGKDCBFGL\x18\x0b\x20\x01(\rR\x0bAMAGKDCBFGLb\x06proto3\
";
