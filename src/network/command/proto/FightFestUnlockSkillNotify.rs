...
pub struct FightFestUnlockSkillNotify {
    // message fields
    // @@protoc_insertion_point(field:FightFestUnlockSkillNotify.LLKFGMPIKOF)
    pub LLKFGMPIKOF: u32,
    // special fields
...
impl FightFestUnlockSkillNotify {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "LLKFGMPIKOF",
            |m: &FightFestUnlockSkillNotify| { &m.LLKFGMPIKOF },
            |m: &mut FightFestUnlockSkillNotify| { &mut m.LLKFGMPIKOF },
        ));
...
impl ::protobuf::Message for FightFestUnlockSkillNotify {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                8 => {
                    self.LLKFGMPIKOF = is.read_uint32()?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.LLKFGMPIKOF != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.LLKFGMPIKOF);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.LLKFGMPIKOF != 0 {
            os.write_uint32(1, self.LLKFGMPIKOF)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    y\x12\x20\n\x0bLLKFGMPIKOF\x18\x01\x20\x01(\rR\x0bLLKFGMPIKOFb\x06proto3\
";
