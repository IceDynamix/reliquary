...
pub struct FightFestUnlockSkillNotify {
    // message fields
    // @@protoc_insertion_point(field:FightFestUnlockSkillNotify.BIFKJDLNGFN)
    pub BIFKJDLNGFN: u32,
    // special fields
...
impl FightFestUnlockSkillNotify {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "BIFKJDLNGFN",
            |m: &FightFestUnlockSkillNotify| { &m.BIFKJDLNGFN },
            |m: &mut FightFestUnlockSkillNotify| { &mut m.BIFKJDLNGFN },
        ));
...
impl ::protobuf::Message for FightFestUnlockSkillNotify {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                72 => {
                    self.BIFKJDLNGFN = is.read_uint32()?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.BIFKJDLNGFN != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.BIFKJDLNGFN);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.BIFKJDLNGFN != 0 {
            os.write_uint32(9, self.BIFKJDLNGFN)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    y\x12\x20\n\x0bBIFKJDLNGFN\x18\t\x20\x01(\rR\x0bBIFKJDLNGFNb\x06proto3\
";
