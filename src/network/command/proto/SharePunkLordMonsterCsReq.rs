...
impl ::protobuf::Message for SharePunkLordMonsterCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.share_type != ::protobuf::EnumOrUnknown::new(super::PunkLordShareType::PunkLordShareType::KIDJIFKAJFP_GKJBAODJMJG) {
            my_size += ::protobuf::rt::int32_size(9, self.share_type.value());
        }
        if self.uid != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.share_type != ::protobuf::EnumOrUnknown::new(super::PunkLordShareType::PunkLordShareType::KIDJIFKAJFP_GKJBAODJMJG) {
            os.write_enum(9, ::protobuf::EnumOrUnknown::value(&self.share_type))?;
        }
        if self.uid != 0 {
