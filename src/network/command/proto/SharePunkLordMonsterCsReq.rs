...
impl ::protobuf::Message for SharePunkLordMonsterCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.share_type != ::protobuf::EnumOrUnknown::new(super::PunkLordShareType::PunkLordShareType::PUNK_LORD_SHARE_TYPE_NONE) {
            my_size += ::protobuf::rt::int32_size(2, self.share_type.value());
        }
        if self.uid != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.share_type != ::protobuf::EnumOrUnknown::new(super::PunkLordShareType::PunkLordShareType::PUNK_LORD_SHARE_TYPE_NONE) {
            os.write_enum(2, ::protobuf::EnumOrUnknown::value(&self.share_type))?;
        }
        if self.uid != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x7f\n\x19SharePunkLordMonsterCsReq\x12\x1d\n\nmonster_id\x18\x0b\x20\
    \x01(\rR\tmonsterId\x121\n\nshare_type\x18\x02\x20\x01(\x0e2\x12.PunkLor\
    dShareTypeR\tshareType\x12\x10\n\x03uid\x18\x05\x20\x01(\rR\x03uidb\x06p\
    roto3\
";
