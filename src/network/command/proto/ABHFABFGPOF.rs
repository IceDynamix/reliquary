...
impl ::protobuf::Message for ABHFABFGPOF {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.JAFNPNMOHCM != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.JAFNPNMOHCM);
        }
        ...
        if self.NKHKDJKEGDH != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.NKHKDJKEGDH);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.CLOONOIFEFO != false {
            os.write_bool(5, self.CLOONOIFEFO)?;
        }
        if self.JAFNPNMOHCM != 0 {
            os.write_uint32(3, self.JAFNPNMOHCM)?;
        }
        if self.PIKAPDJHGND != 0 {
        ...
        if self.NKHKDJKEGDH != 0 {
            os.write_uint32(13, self.NKHKDJKEGDH)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    CKB\x18\x07\x20\x01(\rR\x0bFCJECKCICKB\x12\x20\n\x0bNLMDEMOHBOO\x18\t\
    \x20\x01(\rR\x0bNLMDEMOHBOO\x12\x20\n\x0bCLOONOIFEFO\x18\x05\x20\x01(\
    \x08R\x0bCLOONOIFEFO\x12\x20\n\x0bJAFNPNMOHCM\x18\x03\x20\x01(\rR\x0bJAF\
    NPNMOHCM\x12\x20\n\x0bPIKAPDJHGND\x18\x0c\x20\x01(\rR\x0bPIKAPDJHGND\x12\
    \x20\n\x0bBIINNCNDPCG\x18\x04\x20\x01(\x08R\x0bBIINNCNDPCG\x12\x20\n\x0b\
    NKHKDJKEGDH\x18\r\x20\x01(\rR\x0bNKHKDJKEGDHb\x06proto3\
";
