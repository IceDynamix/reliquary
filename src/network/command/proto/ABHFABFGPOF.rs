...
impl ::protobuf::Message for ABHFABFGPOF {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.FCJECKCICKB != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.FCJECKCICKB);
        }
        ...
        if self.JAFNPNMOHCM != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.JAFNPNMOHCM);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.FCJECKCICKB != 0 {
            os.write_uint32(2, self.FCJECKCICKB)?;
        }
        if self.NLMDEMOHBOO != 0 {
        ...
        if self.JAFNPNMOHCM != 0 {
            os.write_uint32(1, self.JAFNPNMOHCM)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    GND\x18\x08\x20\x01(\rR\x0bPIKAPDJHGND\x12\x20\n\x0bFCJECKCICKB\x18\x02\
    \x20\x01(\rR\x0bFCJECKCICKB\x12\x20\n\x0bNLMDEMOHBOO\x18\t\x20\x01(\rR\
    \x0bNLMDEMOHBOO\x12\x20\n\x0bBIINNCNDPCG\x18\x03\x20\x01(\x08R\x0bBIINNC\
    NDPCG\x12\x20\n\x0bNKHKDJKEGDH\x18\n\x20\x01(\rR\x0bNKHKDJKEGDH\x12\x20\
    \n\x0bCLOONOIFEFO\x18\x0c\x20\x01(\x08R\x0bCLOONOIFEFO\x12\x20\n\x0bJAFN\
    PNMOHCM\x18\x01\x20\x01(\rR\x0bJAFNPNMOHCMb\x06proto3\
";
