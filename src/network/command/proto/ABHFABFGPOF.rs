...
impl ::protobuf::Message for ABHFABFGPOF {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.FCJECKCICKB != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.FCJECKCICKB);
        }
        if self.BIINNCNDPCG != false {
            my_size += 1 + 1;
        }
        if self.JAFNPNMOHCM != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.JAFNPNMOHCM);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.FCJECKCICKB != 0 {
            os.write_uint32(6, self.FCJECKCICKB)?;
        }
        if self.BIINNCNDPCG != false {
            os.write_bool(7, self.BIINNCNDPCG)?;
        }
        if self.JAFNPNMOHCM != 0 {
            os.write_uint32(14, self.JAFNPNMOHCM)?;
        }
        if self.CLOONOIFEFO != false {
            os.write_bool(1, self.CLOONOIFEFO)?;
        }
        if self.PIKAPDJHGND != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    CKB\x18\x06\x20\x01(\rR\x0bFCJECKCICKB\x12\x20\n\x0bBIINNCNDPCG\x18\x07\
    \x20\x01(\x08R\x0bBIINNCNDPCG\x12\x20\n\x0bJAFNPNMOHCM\x18\x0e\x20\x01(\
    \rR\x0bJAFNPNMOHCM\x12\x20\n\x0bCLOONOIFEFO\x18\x01\x20\x01(\x08R\x0bCLO\
    ONOIFEFO\x12\x20\n\x0bPIKAPDJHGND\x18\r\x20\x01(\rR\x0bPIKAPDJHGND\x12\
    \x20\n\x0bNKHKDJKEGDH\x18\x02\x20\x01(\rR\x0bNKHKDJKEGDH\x12\x20\n\x0bNL\
