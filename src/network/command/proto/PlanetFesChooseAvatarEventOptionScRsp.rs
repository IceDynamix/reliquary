...
impl ::protobuf::Message for PlanetFesChooseAvatarEventOptionScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.EPMOOHCJNHO != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.EPMOOHCJNHO);
        }
        if self.retcode != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.retcode);
        }
        if self.OJKJPKHDEPE != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.OJKJPKHDEPE);
        }
        ...
        if self.HAKKGODICFI != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.HAKKGODICFI);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.EPMOOHCJNHO != 0 {
            os.write_uint32(15, self.EPMOOHCJNHO)?;
        }
        if self.retcode != 0 {
            os.write_uint32(2, self.retcode)?;
        }
        if self.OJKJPKHDEPE != 0 {
            os.write_uint32(1, self.OJKJPKHDEPE)?;
        }
        if let Some(v) = self.NFJLFNBPPPG.as_ref() {
            ::protobuf::rt::write_message_field_with_cached_size(14, v, os)?;
        }
        if self.HAKKGODICFI != 0 {
            os.write_uint32(13, self.HAKKGODICFI)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    onScRsp\x12(\n\x06reward\x18\x07\x20\x01(\x0b2\x10.PlanetFesRewardR\x06r\
    eward\x12\x20\n\x0bEPMOOHCJNHO\x18\x0f\x20\x01(\rR\x0bEPMOOHCJNHO\x12\
    \x18\n\x07retcode\x18\x02\x20\x01(\rR\x07retcode\x12\x20\n\x0bOJKJPKHDEP\
    E\x18\x01\x20\x01(\rR\x0bOJKJPKHDEPE\x12.\n\x0bNFJLFNBPPPG\x18\x0e\x20\
    \x01(\x0b2\x0c.JOFGDAIADBOR\x0bNFJLFNBPPPG\x12\x20\n\x0bHAKKGODICFI\x18\
    \r\x20\x01(\rR\x0bHAKKGODICFIb\x06proto3\
";
