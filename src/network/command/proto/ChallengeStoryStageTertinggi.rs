...
pub struct ChallengeStoryStageTertinggi {
    ...
    pub buff_one: u32,
    // @@protoc_insertion_point(field:ChallengeStoryStageTertinggi.EENEOPGCKKB)
    pub EENEOPGCKKB: u32,
...
impl ChallengeStoryStageTertinggi {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "EENEOPGCKKB",
            |m: &ChallengeStoryStageTertinggi| { &m.EENEOPGCKKB },
            |m: &mut ChallengeStoryStageTertinggi| { &mut m.EENEOPGCKKB },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "score_id",
...
impl ::protobuf::Message for ChallengeStoryStageTertinggi {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.EENEOPGCKKB != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.EENEOPGCKKB);
        }
        if self.score_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.EENEOPGCKKB != 0 {
            os.write_uint32(5, self.EENEOPGCKKB)?;
        }
        if self.score_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0c\x20\x01(\rR\x07buffOne\x12\x20\n\x0bEENEOPGCKKB\x18\x05\x20\x01(\rR\
    \x0bEENEOPGCKKB\x12\x19\n\x08score_id\x18\r\x20\x01(\rR\x07scoreId\x12\
    \x14\n\x05level\x18\x04\x20\x01(\rR\x05level\x12\x19\n\x08buff_two\x18\
    \x0b\x20\x01(\rR\x07buffTwo\x125\n\x0blineup_list\x18\t\x20\x03(\x0b2\
    \x14.ChallengeLineupListR\nlineupListb\x06proto3\
";
