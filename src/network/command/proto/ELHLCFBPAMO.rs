...
//! Generated file from `ELHLCFBPAMO.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:ELHLCFBPAMO)
...
pub struct ELHLCFBPAMO {
    ...
    pub level: u32,
    // special fields
    // @@protoc_insertion_point(special_field:ELHLCFBPAMO.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a ELHLCFBPAMO {
    fn default() -> &'a ELHLCFBPAMO {
        <ELHLCFBPAMO as ::protobuf::Message>::default_instance()
    }
}

impl ELHLCFBPAMO {
    pub fn new() -> ELHLCFBPAMO {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "level",
            |m: &ELHLCFBPAMO| { &m.level },
            |m: &mut ELHLCFBPAMO| { &mut m.level },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<ELHLCFBPAMO>(
            "ELHLCFBPAMO",
            fields,
            oneofs,
        )
...
impl ::protobuf::Message for ELHLCFBPAMO {
    const NAME: &'static str = "ELHLCFBPAMO";
...
impl ::protobuf::MessageFull for ELHLCFBPAMO {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("ELHLCFBPAMO").unwrap()).clone()
    }
}

impl ::std::fmt::Display for ELHLCFBPAMO {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for ELHLCFBPAMO {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(ELHLCFBPAMO::generated_message_descriptor_data());
