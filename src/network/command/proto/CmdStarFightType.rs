...
impl ::protobuf::Enum for CmdStarFightType {
    ...
    fn from_i32(value: i32) -> ::std::option::Option<CmdStarFightType> {
        match value {
            ...
            7167 => ::std::option::Option::Some(CmdStarFightType::CmdGetStarFightDataScRsp),
            7169 => ::std::option::Option::Some(CmdStarFightType::CmdStartStarFightLevelScRsp),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \xff7\x12\x20\n\x1bCmdStartStarFightLevelScRsp\x10\x818\x12\x1d\n\x18Cmd\
    GetStarFightDataCsReq\x10\xfe7\x12!\n\x1cCmdStarFightDataChangeNotify\
    \x10\x828\x12\x20\n\x1bCmdStartStarFightLevelCsReq\x10\xfc7b\x06proto3\
";
