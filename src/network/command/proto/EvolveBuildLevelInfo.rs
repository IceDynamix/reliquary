...
impl ::protobuf::Message for EvolveBuildLevelInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.cur_game_exp != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.cur_game_exp);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(13, &self.period_id_list);
        if self.round_cnt != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.cur_game_exp != 0 {
            os.write_uint32(4, self.cur_game_exp)?;
        }
        os.write_repeated_packed_uint32(13, &self.period_id_list)?;
        if self.round_cnt != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    veBuildLevelInfo\x12\x20\n\x0ccur_game_exp\x18\x04\x20\x01(\rR\ncurGameE\
    xp\x12$\n\x0eperiod_id_list\x18\r\x20\x03(\rR\x0cperiodIdList\x12\x1b\n\
    \tround_cnt\x18\x02\x20\x01(\rR\x08roundCnt\x127\n\x0bbattle_info\x18\
    \x06\x20\x01(\x0b2\x16.EvolveBuildBattleInfoR\nbattleInfo\x123\n\x0bavat\
    ar_list\x18\x05\x20\x03(\x0b2\x12.EvolveBuildAvatarR\navatarList\x12;\n\
