...
impl ::protobuf::Message for EvolveBuildLevelInfo {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(10, &self.period_id_list);
        ...
        if self.season != ::protobuf::EnumOrUnknown::new(super::KLNIPNJCNMJ::KLNIPNJCNMJ::EVOLVE_BUILD_SEASON_NONE) {
            my_size += ::protobuf::rt::int32_size(7, self.season.value());
        }
        if self.round_cnt != 0 {
        ...
        if self.cur_game_exp != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.cur_game_exp);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(10, &self.period_id_list)?;
        ...
        if self.season != ::protobuf::EnumOrUnknown::new(super::KLNIPNJCNMJ::KLNIPNJCNMJ::EVOLVE_BUILD_SEASON_NONE) {
            os.write_enum(7, ::protobuf::EnumOrUnknown::value(&self.season))?;
        }
        if self.round_cnt != 0 {
        ...
        if self.cur_game_exp != 0 {
            os.write_uint32(14, self.cur_game_exp)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    proto\"\xcc\x02\n\x14EvolveBuildLevelInfo\x12$\n\x0eperiod_id_list\x18\n\
    \x20\x03(\rR\x0cperiodIdList\x12;\n\x12battle_target_list\x18\x01\x20\
    \x03(\x0b2\r.BattleTargetR\x10battleTargetList\x123\n\x0bavatar_list\x18\
    \x0f\x20\x03(\x0b2\x12.EvolveBuildAvatarR\navatarList\x12$\n\x06season\
    \x18\x07\x20\x01(\x0e2\x0c.KLNIPNJCNMJR\x06season\x12\x1b\n\tround_cnt\
    \x18\x02\x20\x01(\rR\x08roundCnt\x127\n\x0bbattle_info\x18\x03\x20\x01(\
