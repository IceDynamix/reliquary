...
impl ::protobuf::Message for HOCHOIHKKDG {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.MDDOFMCJJHH != ::protobuf::EnumOrUnknown::new(super::FOCHDFJANPC::FOCHDFJANPC::RAID_TARGET_STATUS_NONE) {
            my_size += ::protobuf::rt::int32_size(15, self.MDDOFMCJJHH.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.MDDOFMCJJHH != ::protobuf::EnumOrUnknown::new(super::FOCHDFJANPC::FOCHDFJANPC::RAID_TARGET_STATUS_NONE) {
            os.write_enum(15, ::protobuf::EnumOrUnknown::value(&self.MDDOFMCJJHH))?;
        }
        if self.HFALJIHKECN != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    KDG\x12\x20\n\x0bDLPPDPBJIIM\x18\x06\x20\x01(\rR\x0bDLPPDPBJIIM\x12.\n\
    \x0bMDDOFMCJJHH\x18\x0f\x20\x01(\x0e2\x0c.FOCHDFJANPCR\x0bMDDOFMCJJHH\
    \x12\x20\n\x0bHFALJIHKECN\x18\x02\x20\x01(\rR\x0bHFALJIHKECNb\x06proto3\
";
