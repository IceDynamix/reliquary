...
impl ::protobuf::Message for HOCHOIHKKDG {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.MDDOFMCJJHH != ::protobuf::EnumOrUnknown::new(super::FOCHDFJANPC::FOCHDFJANPC::RAID_TARGET_STATUS_NONE) {
            my_size += ::protobuf::rt::int32_size(13, self.MDDOFMCJJHH.value());
        }
        if self.HFALJIHKECN != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.HFALJIHKECN);
        }
        if self.DLPPDPBJIIM != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.DLPPDPBJIIM);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.MDDOFMCJJHH != ::protobuf::EnumOrUnknown::new(super::FOCHDFJANPC::FOCHDFJANPC::RAID_TARGET_STATUS_NONE) {
            os.write_enum(13, ::protobuf::EnumOrUnknown::value(&self.MDDOFMCJJHH))?;
        }
        if self.HFALJIHKECN != 0 {
            os.write_uint32(11, self.HFALJIHKECN)?;
        }
        if self.DLPPDPBJIIM != 0 {
            os.write_uint32(3, self.DLPPDPBJIIM)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    KDG\x12.\n\x0bMDDOFMCJJHH\x18\r\x20\x01(\x0e2\x0c.FOCHDFJANPCR\x0bMDDOFM\
    CJJHH\x12\x20\n\x0bHFALJIHKECN\x18\x0b\x20\x01(\rR\x0bHFALJIHKECN\x12\
    \x20\n\x0bDLPPDPBJIIM\x18\x03\x20\x01(\rR\x0bDLPPDPBJIIMb\x06proto3\
";
