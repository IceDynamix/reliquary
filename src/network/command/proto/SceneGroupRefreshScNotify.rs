...
impl ::protobuf::Message for SceneGroupRefreshScNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.dimension_id != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.dimension_id);
        }
        if self.floor_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.dimension_id != 0 {
            os.write_uint32(14, self.dimension_id)?;
        }
        if self.floor_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x9a\x01\n\x19SceneGroupRefreshScNotify\x12!\n\x0cdimension_id\x18\x0e\
    \x20\x01(\rR\x0bdimensionId\x12\x19\n\x08floor_id\x18\n\x20\x01(\rR\x07f\
    loorId\x12?\n\x12group_refresh_list\x18\x04\x20\x03(\x0b2\x11.GroupRefre\
    shInfoR\x10groupRefreshListb\x06proto3\
";
