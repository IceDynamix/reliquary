...
impl ::protobuf::Message for AddMultiPathAvatarScNotify {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.AEDKJJIBAHK != false {
            os.write_bool(15, self.AEDKJJIBAHK)?;
        }
        if self.avatar_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x1aAddMultiPathAvatarScNotify\x12\x20\n\x0bAEDKJJIBAHK\x18\x0f\x20\x01(\
    \x08R\x0bAEDKJJIBAHK\x12\x1b\n\tavatar_id\x18\x05\x20\x01(\rR\x08avatarI\
    d\x12+\n\x0bBHELBOHKBBM\x18\x06\x20\x01(\x0b2\t.ItemListR\x0bBHELBOHKBBM\
    b\x06proto3\
";
