...
pub struct AddMultiPathAvatarScNotify {
    ...
    // @@protoc_insertion_point(field:AddMultiPathAvatarScNotify.DDFALNFCIOC)
    pub DDFALNFCIOC: ::protobuf::EnumOrUnknown<super::OBIPKIIALHC::OBIPKIIALHC>,
...
impl AddMultiPathAvatarScNotify {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "DDFALNFCIOC",
            |m: &AddMultiPathAvatarScNotify| { &m.DDFALNFCIOC },
            |m: &mut AddMultiPathAvatarScNotify| { &mut m.DDFALNFCIOC },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "avatar_id",
...
impl ::protobuf::Message for AddMultiPathAvatarScNotify {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                80 => {
                    self.DDFALNFCIOC = is.read_enum_or_unknown()?;
                },
                88 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.DDFALNFCIOC != ::protobuf::EnumOrUnknown::new(super::OBIPKIIALHC::OBIPKIIALHC::MULTI_PATH_AVATAR_UNLOCK_REASON_NONE) {
            my_size += ::protobuf::rt::int32_size(10, self.DDFALNFCIOC.value());
        }
        if self.avatar_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.DDFALNFCIOC != ::protobuf::EnumOrUnknown::new(super::OBIPKIIALHC::OBIPKIIALHC::MULTI_PATH_AVATAR_UNLOCK_REASON_NONE) {
            os.write_enum(10, ::protobuf::EnumOrUnknown::value(&self.DDFALNFCIOC))?;
        }
        if self.avatar_id != 0 {
    ...
    fn clear(&mut self) {
        self.reward.clear();
        self.DDFALNFCIOC = ::protobuf::EnumOrUnknown::new(super::OBIPKIIALHC::OBIPKIIALHC::MULTI_PATH_AVATAR_UNLOCK_REASON_NONE);
        self.avatar_id = 0;
        self.is_new = false;
    ...
    fn default_instance() -> &'static AddMultiPathAvatarScNotify {
        static instance: AddMultiPathAvatarScNotify = AddMultiPathAvatarScNotify {
            ...
            DDFALNFCIOC: ::protobuf::EnumOrUnknown::from_i32(0),
            avatar_id: 0,
            is_new: false,
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    KIIALHC.proto\"\xa3\x01\n\x1aAddMultiPathAvatarScNotify\x12!\n\x06reward\
    \x18\x07\x20\x01(\x0b2\t.ItemListR\x06reward\x12.\n\x0bDDFALNFCIOC\x18\n\
    \x20\x01(\x0e2\x0c.OBIPKIIALHCR\x0bDDFALNFCIOC\x12\x1b\n\tavatar_id\x18\
    \x0b\x20\x01(\rR\x08avatarId\x12\x15\n\x06is_new\x18\x0c\x20\x01(\x08R\
    \x05isNewb\x06proto3\
";
