...
//! Generated file from `BELNLOJAFCM.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:BELNLOJAFCM)
...
impl<'a> ::std::default::Default for &'a BELNLOJAFCM {
    fn default() -> &'a BELNLOJAFCM {
        <BELNLOJAFCM as ::protobuf::Message>::default_instance()
    }
}

impl BELNLOJAFCM {
    pub fn new() -> BELNLOJAFCM {
...
impl ::protobuf::Message for BELNLOJAFCM {
    const NAME: &'static str = "BELNLOJAFCM";
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(5, &self.HLLLIKPGOFG);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(5, &self.HLLLIKPGOFG)?;
        if let Some(v) = self.JHBAAHGLFCB.as_ref() {
...
impl ::protobuf::MessageFull for BELNLOJAFCM {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("BELNLOJAFCM").unwrap()).clone()
    }
}

impl ::std::fmt::Display for BELNLOJAFCM {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for BELNLOJAFCM {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x11BELNLOJAFCM.proto\x1a\x11DGHPIDMDOJM.proto\"_\n\x0bBELNLOJAFCM\x12\
    \x20\n\x0bHLLLIKPGOFG\x18\x05\x20\x03(\rR\x0bHLLLIKPGOFG\x12.\n\x0bJHBAA\
    HGLFCB\x18\x0e\x20\x01(\x0b2\x0c.DGHPIDMDOJMR\x0bJHBAAHGLFCBb\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(BELNLOJAFCM::generated_message_descriptor_data());
