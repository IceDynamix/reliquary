...
//! Generated file from `IAABDBBJHOL.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:IAABDBBJHOL)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct IAABDBBJHOL {
    // message fields
...
impl<'a> ::std::default::Default for &'a IAABDBBJHOL {
    fn default() -> &'a IAABDBBJHOL {
        <IAABDBBJHOL as ::protobuf::Message>::default_instance()
    }
}

impl IAABDBBJHOL {
    pub fn new() -> IAABDBBJHOL {
...
impl ::protobuf::Message for IAABDBBJHOL {
    const NAME: &'static str = "IAABDBBJHOL";
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.is_overlock != false {
            os.write_bool(2, self.is_overlock)?;
        }
        if self.division_id != 0 {
...
impl ::protobuf::MessageFull for IAABDBBJHOL {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("IAABDBBJHOL").unwrap()).clone()
    }
}

impl ::std::fmt::Display for IAABDBBJHOL {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for IAABDBBJHOL {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x11IAABDBBJHOL.proto\"q\n\x0bIAABDBBJHOL\x12\x20\n\x0bLJNGPCKPJLF\x18\
    \x07\x20\x01(\rR\x0bLJNGPCKPJLF\x12\x1f\n\x0bis_overlock\x18\x02\x20\x01\
    (\x08R\nisOverlock\x12\x1f\n\x0bdivision_id\x18\n\x20\x01(\rR\ndivisionI\
    db\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(IAABDBBJHOL::generated_message_descriptor_data());
