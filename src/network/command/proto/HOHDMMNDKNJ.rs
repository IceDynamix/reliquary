...
//! Generated file from `HOHDMMNDKNJ.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:HOHDMMNDKNJ)
...
impl<'a> ::std::default::Default for &'a HOHDMMNDKNJ {
    fn default() -> &'a HOHDMMNDKNJ {
        <HOHDMMNDKNJ as ::protobuf::Message>::default_instance()
    }
}

impl HOHDMMNDKNJ {
    pub fn new() -> HOHDMMNDKNJ {
...
impl ::protobuf::Message for HOHDMMNDKNJ {
    const NAME: &'static str = "HOHDMMNDKNJ";
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.PODGJPEKEEG != ::protobuf::EnumOrUnknown::new(super::DFHEJCIJBEJ::DFHEJCIJBEJ::PLANET_FES_BUSINESS_EVENT_CHANGE_REASON_NONE) {
            my_size += ::protobuf::rt::int32_size(13, self.PODGJPEKEEG.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.PODGJPEKEEG != ::protobuf::EnumOrUnknown::new(super::DFHEJCIJBEJ::DFHEJCIJBEJ::PLANET_FES_BUSINESS_EVENT_CHANGE_REASON_NONE) {
            os.write_enum(13, ::protobuf::EnumOrUnknown::value(&self.PODGJPEKEEG))?;
        }
...
impl ::protobuf::MessageFull for HOHDMMNDKNJ {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("HOHDMMNDKNJ").unwrap()).clone()
    }
}

impl ::std::fmt::Display for HOHDMMNDKNJ {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for HOHDMMNDKNJ {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x11HOHDMMNDKNJ.proto\x1a\x11DFHEJCIJBEJ.proto\x1a\x11JOFGDAIADBO.prot\
    o\"m\n\x0bHOHDMMNDKNJ\x12.\n\x0bNFJLFNBPPPG\x18\n\x20\x01(\x0b2\x0c.JOFG\
    DAIADBOR\x0bNFJLFNBPPPG\x12.\n\x0bPODGJPEKEEG\x18\r\x20\x01(\x0e2\x0c.DF\
    HEJCIJBEJR\x0bPODGJPEKEEGb\x06proto3\
";
