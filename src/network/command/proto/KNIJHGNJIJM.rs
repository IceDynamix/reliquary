...
impl ::protobuf::Message for KNIJHGNJIJM {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(9, &self.DPMIBDHKDAE);
        if self.JGMIPMDPPIJ != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.JGMIPMDPPIJ);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(4, &self.DDGCFJDBOOH);
        if self.exp != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_uint32(9, &self.DPMIBDHKDAE)?;
        if self.JGMIPMDPPIJ != 0 {
            os.write_uint32(7, self.JGMIPMDPPIJ)?;
        }
        os.write_repeated_packed_uint32(4, &self.DDGCFJDBOOH)?;
        if self.exp != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\r\x20\x01(\rR\x05level\x12\x17\n\x07aeon_id\x18\x05\x20\x01(\rR\x06\
    aeonId\x12\x20\n\x0bDPMIBDHKDAE\x18\t\x20\x03(\rR\x0bDPMIBDHKDAE\x12\x20\
    \n\x0bJGMIPMDPPIJ\x18\x07\x20\x01(\rR\x0bJGMIPMDPPIJ\x12\x20\n\x0bDDGCFJ\
    DBOOH\x18\x04\x20\x03(\rR\x0bDDGCFJDBOOH\x12\x10\n\x03exp\x18\x08\x20\
