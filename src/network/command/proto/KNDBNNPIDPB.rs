...
impl ::protobuf::Message for KNDBNNPIDPB {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.PEPLINOGEGC != ::protobuf::EnumOrUnknown::new(super::GANMCIJCOKI::GANMCIJCOKI::MATCH3_BATTLE_BUFF_TYPE_NONE) {
            my_size += ::protobuf::rt::int32_size(12, self.PEPLINOGEGC.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.PEPLINOGEGC != ::protobuf::EnumOrUnknown::new(super::GANMCIJCOKI::GANMCIJCOKI::MATCH3_BATTLE_BUFF_TYPE_NONE) {
            os.write_enum(12, ::protobuf::EnumOrUnknown::value(&self.PEPLINOGEGC))?;
        }
        if self.display_value != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    .\n\x0bPEPLINOGEGC\x18\x0c\x20\x01(\x0e2\x0c.GANMCIJCOKIR\x0bPEPLINOGEGC\
