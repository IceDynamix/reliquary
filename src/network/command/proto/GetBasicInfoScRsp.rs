...
impl ::protobuf::Message for GetBasicInfoScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.exchange_times != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.exchange_times);
        }
        if self.retcode != 0 {
        ...
        if self.cur_day != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.cur_day);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.exchange_times != 0 {
            os.write_uint32(3, self.exchange_times)?;
        }
        if self.retcode != 0 {
        ...
        if self.cur_day != 0 {
            os.write_uint32(2, self.cur_day)?;
        }
        if self.last_set_nickname_time != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x11GetBasicInfoScRsp\x12%\n\x0eexchange_times\x18\x03\x20\x01(\rR\rexch\
    angeTimes\x12\x18\n\x07retcode\x18\x0e\x20\x01(\rR\x07retcode\x12;\n\x1a\
    week_cocoon_finished_count\x18\x0b\x20\x01(\rR\x17weekCocoonFinishedCoun\
    t\x12\"\n\ris_gender_set\x18\t\x20\x01(\x08R\x0bisGenderSet\x12*\n\x11ne\
    xt_recover_time\x18\x05\x20\x01(\x03R\x0fnextRecoverTime\x12+\n\x11gamep\
    lay_birthday\x18\x07\x20\x01(\rR\x10gameplayBirthday\x12\x17\n\x07cur_da\
    y\x18\x02\x20\x01(\rR\x06curDay\x123\n\x16last_set_nickname_time\x18\x0f\
    \x20\x01(\x03R\x13lastSetNicknameTime\x12B\n\x13player_setting_info\x18\
    \x08\x20\x01(\x0b2\x12.PlayerSettingInfoR\x11playerSettingInfo\x12\x16\n\
    \x06gender\x18\n\x20\x01(\rR\x06genderb\x06proto3\
";
