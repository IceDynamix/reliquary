...
impl ::protobuf::Message for GetBasicInfoScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.gender != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.gender);
        }
        if self.week_cocoon_finished_count != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.week_cocoon_finished_count);
        }
        if self.next_recover_time != 0 {
            my_size += ::protobuf::rt::int64_size(9, self.next_recover_time);
        }
        if self.last_set_nickname_time != 0 {
            my_size += ::protobuf::rt::int64_size(2, self.last_set_nickname_time);
        }
        ...
        if self.exchange_times != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.exchange_times);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.gender != 0 {
            os.write_uint32(6, self.gender)?;
        }
        if self.week_cocoon_finished_count != 0 {
            os.write_uint32(8, self.week_cocoon_finished_count)?;
        }
        if self.next_recover_time != 0 {
            os.write_int64(9, self.next_recover_time)?;
        }
        if self.last_set_nickname_time != 0 {
            os.write_int64(2, self.last_set_nickname_time)?;
        }
        if self.gameplay_birthday != 0 {
        ...
        if self.exchange_times != 0 {
            os.write_uint32(4, self.exchange_times)?;
        }
        if self.is_gender_set != false {
            os.write_bool(11, self.is_gender_set)?;
        }
        if self.cur_day != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x11GetBasicInfoScRsp\x12B\n\x13player_setting_info\x18\x07\x20\x01(\x0b\
    2\x12.PlayerSettingInfoR\x11playerSettingInfo\x12\x16\n\x06gender\x18\
    \x06\x20\x01(\rR\x06gender\x12;\n\x1aweek_cocoon_finished_count\x18\x08\
    \x20\x01(\rR\x17weekCocoonFinishedCount\x12*\n\x11next_recover_time\x18\
    \t\x20\x01(\x03R\x0fnextRecoverTime\x123\n\x16last_set_nickname_time\x18\
    \x02\x20\x01(\x03R\x13lastSetNicknameTime\x12+\n\x11gameplay_birthday\
    \x18\x05\x20\x01(\rR\x10gameplayBirthday\x12\x18\n\x07retcode\x18\x03\
    \x20\x01(\rR\x07retcode\x12%\n\x0eexchange_times\x18\x04\x20\x01(\rR\rex\
    changeTimes\x12\"\n\ris_gender_set\x18\x0b\x20\x01(\x08R\x0bisGenderSet\
    \x12\x17\n\x07cur_day\x18\x0c\x20\x01(\rR\x06curDayb\x06proto3\
";
