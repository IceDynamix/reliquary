...
impl ::protobuf::Message for GetBasicInfoScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.gender != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.gender);
        }
        if self.last_set_nickname_time != 0 {
            my_size += ::protobuf::rt::int64_size(9, self.last_set_nickname_time);
        }
        if self.retcode != 0 {
        ...
        if self.next_recover_time != 0 {
            my_size += ::protobuf::rt::int64_size(13, self.next_recover_time);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.gender != 0 {
            os.write_uint32(7, self.gender)?;
        }
        if self.last_set_nickname_time != 0 {
            os.write_int64(9, self.last_set_nickname_time)?;
        }
        if self.retcode != 0 {
        ...
        if self.next_recover_time != 0 {
            os.write_int64(13, self.next_recover_time)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x11GetBasicInfoScRsp\x12%\n\x0eexchange_times\x18\x01\x20\x01(\rR\rexch\
    angeTimes\x12+\n\x11gameplay_birthday\x18\x02\x20\x01(\rR\x10gameplayBir\
    thday\x12\"\n\ris_gender_set\x18\x04\x20\x01(\x08R\x0bisGenderSet\x12;\n\
    \x1aweek_cocoon_finished_count\x18\x05\x20\x01(\rR\x17weekCocoonFinished\
    Count\x12\x16\n\x06gender\x18\x07\x20\x01(\rR\x06gender\x123\n\x16last_s\
    et_nickname_time\x18\t\x20\x01(\x03R\x13lastSetNicknameTime\x12\x18\n\
    \x07retcode\x18\n\x20\x01(\rR\x07retcode\x12\x17\n\x07cur_day\x18\x0b\
    \x20\x01(\rR\x06curDay\x12B\n\x13player_setting_info\x18\x0c\x20\x01(\
    \x0b2\x12.PlayerSettingInfoR\x11playerSettingInfo\x12*\n\x11next_recover\
    _time\x18\r\x20\x01(\x03R\x0fnextRecoverTimeb\x06proto3\
";
