...
impl ::protobuf::Message for GetBasicInfoScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.last_set_nickname_time != 0 {
            my_size += ::protobuf::rt::int64_size(5, self.last_set_nickname_time);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.last_set_nickname_time != 0 {
            os.write_int64(5, self.last_set_nickname_time)?;
        }
        if self.next_recover_time != 0 {
        ...
        if self.is_gender_set != false {
            os.write_bool(4, self.is_gender_set)?;
        }
        if self.exchange_times != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x11GetBasicInfoScRsp\x12B\n\x13player_setting_info\x18\x0c\x20\x01(\x0b\
    2\x12.PlayerSettingInfoR\x11playerSettingInfo\x123\n\x16last_set_nicknam\
    e_time\x18\x05\x20\x01(\x03R\x13lastSetNicknameTime\x12*\n\x11next_recov\
    er_time\x18\n\x20\x01(\x03R\x0fnextRecoverTime\x12;\n\x1aweek_cocoon_fin\
    ished_count\x18\x0f\x20\x01(\rR\x17weekCocoonFinishedCount\x12\x16\n\x06\
    gender\x18\x08\x20\x01(\rR\x06gender\x12\"\n\ris_gender_set\x18\x04\x20\
    \x01(\x08R\x0bisGenderSet\x12%\n\x0eexchange_times\x18\r\x20\x01(\rR\rex\
    changeTimes\x12\x18\n\x07retcode\x18\x03\x20\x01(\rR\x07retcode\x12\x17\
    \n\x07cur_day\x18\x02\x20\x01(\rR\x06curDay\x12+\n\x11gameplay_birthday\
    \x18\x01\x20\x01(\rR\x10gameplayBirthdayb\x06proto3\
";
