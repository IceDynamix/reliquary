...
impl ::protobuf::Message for GetBasicInfoScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.gender != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.gender);
        }
        ...
        if self.cur_day != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.cur_day);
        }
        ...
        if self.last_set_nickname_time != 0 {
            my_size += ::protobuf::rt::int64_size(15, self.last_set_nickname_time);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.cur_day != 0 {
            os.write_uint32(6, self.cur_day)?;
        }
        if self.next_recover_time != 0 {
        ...
        if self.last_set_nickname_time != 0 {
            os.write_int64(15, self.last_set_nickname_time)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    GenderSet\x12\x16\n\x06gender\x18\x03\x20\x01(\rR\x06gender\x12+\n\x11ga\
    meplay_birthday\x18\x04\x20\x01(\rR\x10gameplayBirthday\x12\x18\n\x07ret\
    code\x18\x05\x20\x01(\rR\x07retcode\x12\x17\n\x07cur_day\x18\x06\x20\x01\
    (\rR\x06curDay\x12*\n\x11next_recover_time\x18\x07\x20\x01(\x03R\x0fnext\
    RecoverTime\x12;\n\x1aweek_cocoon_finished_count\x18\x0b\x20\x01(\rR\x17\
    weekCocoonFinishedCount\x12%\n\x0eexchange_times\x18\r\x20\x01(\rR\rexch\
    angeTimes\x12B\n\x13player_setting_info\x18\x0e\x20\x01(\x0b2\x12.Player\
    SettingInfoR\x11playerSettingInfo\x123\n\x16last_set_nickname_time\x18\
    \x0f\x20\x01(\x03R\x13lastSetNicknameTimeb\x06proto3\
";
