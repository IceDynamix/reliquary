...
impl ::protobuf::Message for GetBasicInfoScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.gender != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.gender);
        }
        ...
        if self.gameplay_birthday != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.gameplay_birthday);
        }
        if self.exchange_times != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.exchange_times);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.gender != 0 {
            os.write_uint32(5, self.gender)?;
        }
        if self.next_recover_time != 0 {
            os.write_int64(8, self.next_recover_time)?;
        }
        if self.is_gender_set != false {
            os.write_bool(10, self.is_gender_set)?;
        }
        if self.retcode != 0 {
        ...
        if self.gameplay_birthday != 0 {
            os.write_uint32(9, self.gameplay_birthday)?;
        }
        if self.exchange_times != 0 {
            os.write_uint32(13, self.exchange_times)?;
        }
        if self.week_cocoon_finished_count != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x11GetBasicInfoScRsp\x12\x17\n\x07cur_day\x18\x0c\x20\x01(\rR\x06curDay\
    \x12\x16\n\x06gender\x18\x05\x20\x01(\rR\x06gender\x12*\n\x11next_recove\
    r_time\x18\x08\x20\x01(\x03R\x0fnextRecoverTime\x12\"\n\ris_gender_set\
    \x18\n\x20\x01(\x08R\x0bisGenderSet\x12\x18\n\x07retcode\x18\x01\x20\x01\
    (\rR\x07retcode\x123\n\x16last_set_nickname_time\x18\x0b\x20\x01(\x03R\
    \x13lastSetNicknameTime\x12+\n\x11gameplay_birthday\x18\t\x20\x01(\rR\
    \x10gameplayBirthday\x12%\n\x0eexchange_times\x18\r\x20\x01(\rR\rexchang\
    eTimes\x12;\n\x1aweek_cocoon_finished_count\x18\x0f\x20\x01(\rR\x17weekC\
    ocoonFinishedCount\x12B\n\x13player_setting_info\x18\x06\x20\x01(\x0b2\
    \x12.PlayerSettingInfoR\x11playerSettingInfob\x06proto3\
";
