...
impl ::protobuf::Message for ContentPackageData {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.cur_content_id != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.cur_content_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.cur_content_id != 0 {
            os.write_uint32(9, self.cur_content_id)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x12ContentPackageData\x12$\n\x0ecur_content_id\x18\t\x20\x01(\rR\x0cc\
    urContentId\x12E\n\x14content_package_list\x18\x0b\x20\x03(\x0b2\x13.Con\
    tentPackageInfoR\x12contentPackageListb\x06proto3\
";
