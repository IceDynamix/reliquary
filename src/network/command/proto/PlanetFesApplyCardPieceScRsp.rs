...
impl PlanetFesApplyCardPieceScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "MCFFPIEEKNN",
            |m: &PlanetFesApplyCardPieceScRsp| { &m.MCFFPIEEKNN },
...
impl ::protobuf::Message for PlanetFesApplyCardPieceScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.EPCPDOCDOCB != 0 {
            my_size += ::protobuf::rt::int64_size(15, self.EPCPDOCDOCB);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.EPCPDOCDOCB != 0 {
            os.write_int64(15, self.EPCPDOCDOCB)?;
        }
        if self.PNAKHNBDJAE != 0 {
            os.write_uint32(5, self.PNAKHNBDJAE)?;
        }
        if self.MCFFPIEEKNN != false {
            os.write_bool(4, self.MCFFPIEEKNN)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    PieceScRsp\x12\x20\n\x0bEPCPDOCDOCB\x18\x0f\x20\x01(\x03R\x0bEPCPDOCDOCB\
    \x12\x20\n\x0bPNAKHNBDJAE\x18\x05\x20\x01(\rR\x0bPNAKHNBDJAE\x12\x20\n\
    \x0bMCFFPIEEKNN\x18\x04\x20\x01(\x08R\x0bMCFFPIEEKNN\x12\x18\n\x07retcod\
    e\x18\x01\x20\x01(\rR\x07retcode\x12\x20\n\x0bCBEGNBKMHCD\x18\n\x20\x01(\
    \rR\x0bCBEGNBKMHCD\x12\x20\n\x0bJPACOBGBDBG\x18\x06\x20\x03(\rR\x0bJPACO\
    BGBDBGb\x06proto3\
";
