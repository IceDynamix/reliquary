...
impl ::protobuf::Message for PlanetFesApplyCardPieceScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.CBEGNBKMHCD != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.CBEGNBKMHCD);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.MCFFPIEEKNN != false {
            os.write_bool(12, self.MCFFPIEEKNN)?;
        }
        if self.CBEGNBKMHCD != 0 {
            os.write_uint32(4, self.CBEGNBKMHCD)?;
        }
        if self.EPCPDOCDOCB != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0bJPACOBGBDBG\x18\x03\x20\x03(\rR\x0bJPACOBGBDBG\x12\x20\n\x0bMCFFPIEE\
    KNN\x18\x0c\x20\x01(\x08R\x0bMCFFPIEEKNN\x12\x20\n\x0bCBEGNBKMHCD\x18\
    \x04\x20\x01(\rR\x0bCBEGNBKMHCD\x12\x20\n\x0bEPCPDOCDOCB\x18\x01\x20\x01\
    (\x03R\x0bEPCPDOCDOCB\x12\x20\n\x0bPNAKHNBDJAE\x18\r\x20\x01(\rR\x0bPNAK\
    HNBDJAEb\x06proto3\
";
