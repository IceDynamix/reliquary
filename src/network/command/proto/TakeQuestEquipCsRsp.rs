...
//! Generated file from `TakeQuestEquipCsRsp.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:TakeQuestEquipCsRsp)
...
impl<'a> ::std::default::Default for &'a TakeQuestEquipCsRsp {
    fn default() -> &'a TakeQuestEquipCsRsp {
        <TakeQuestEquipCsRsp as ::protobuf::Message>::default_instance()
    }
}

impl TakeQuestEquipCsRsp {
    pub fn new() -> TakeQuestEquipCsRsp {
...
impl ::protobuf::Message for TakeQuestEquipCsRsp {
    const NAME: &'static str = "TakeQuestEquipCsRsp";
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.DKPCAIGPHNO != false {
            os.write_bool(10, self.DKPCAIGPHNO)?;
        }
        if self.quest_id != 0 {
    ...
    fn new() -> TakeQuestEquipCsRsp {
        TakeQuestEquipCsRsp::new()
    }
...
impl ::protobuf::MessageFull for TakeQuestEquipCsRsp {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("TakeQuestEquipCsRsp").unwrap()).clone()
    }
}

impl ::std::fmt::Display for TakeQuestEquipCsRsp {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for TakeQuestEquipCsRsp {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x20\x01(\x08R\x0bDKPCAIGPHNO\x12\x19\n\x08quest_id\x18\x0e\x20\x01(\r\
    R\x07questIdb\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(TakeQuestEquipCsRsp::generated_message_descriptor_data());
