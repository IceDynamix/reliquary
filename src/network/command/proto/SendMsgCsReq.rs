...
impl ::protobuf::Message for SendMsgCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.message_text.is_empty() {
            my_size += ::protobuf::rt::string_size(15, &self.message_text);
        }
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(12, &self.target_list);
        if self.extra_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.message_text.is_empty() {
            os.write_string(15, &self.message_text)?;
        }
        if self.chat_type != ::protobuf::EnumOrUnknown::new(super::ChatType::ChatType::CHAT_TYPE_NONE) {
            os.write_enum(8, ::protobuf::EnumOrUnknown::value(&self.chat_type))?;
        }
        os.write_repeated_packed_uint32(12, &self.target_list)?;
        if self.extra_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x06\x20\x01(\x0e2\x08.MsgTypeR\x0bmessageType\x12!\n\x0cmessage_tex\
    t\x18\x0f\x20\x01(\tR\x0bmessageText\x12&\n\tchat_type\x18\x08\x20\x01(\
    \x0e2\t.ChatTypeR\x08chatType\x12\x1f\n\x0btarget_list\x18\x0c\x20\x03(\
    \rR\ntargetList\x12\x19\n\x08extra_id\x18\r\x20\x01(\rR\x07extraId\x12.\
    \n\x0bHNBEPABNBNG\x18\x07\x20\x01(\x0b2\x0c.PEDLPHDBNAFR\x0bHNBEPABNBNGb\
    \x06proto3\
";
