...
pub struct FightFestScoreUpdateNotify {
    // message fields
    // @@protoc_insertion_point(field:FightFestScoreUpdateNotify.HFEFABJOICD)
    pub HFEFABJOICD: u32,
...
impl FightFestScoreUpdateNotify {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "HFEFABJOICD",
            |m: &FightFestScoreUpdateNotify| { &m.HFEFABJOICD },
            |m: &mut FightFestScoreUpdateNotify| { &mut m.HFEFABJOICD },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "score",
...
impl ::protobuf::Message for FightFestScoreUpdateNotify {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                16 => {
                    self.HFEFABJOICD = is.read_uint32()?;
                },
                64 => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.HFEFABJOICD != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.HFEFABJOICD);
        }
        if self.score != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.HFEFABJOICD != 0 {
            os.write_uint32(2, self.HFEFABJOICD)?;
        }
        if self.score != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    y\x12\x20\n\x0bHFEFABJOICD\x18\x02\x20\x01(\rR\x0bHFEFABJOICD\x12\x14\n\
    \x05score\x18\x08\x20\x01(\rR\x05scoreb\x06proto3\
";
