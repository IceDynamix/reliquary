...
impl ::protobuf::Message for GetSwordTrainingDataScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.DCHGIODEDDK != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.DCHGIODEDDK);
        }
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(1, &self.JOEFNHGGAGO);
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(5, &self.FABKPHMJGHL);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.DCHGIODEDDK != 0 {
            os.write_uint32(2, self.DCHGIODEDDK)?;
        }
        if let Some(v) = self.KJKBKEGIGHK.as_ref() {
            ::protobuf::rt::write_message_field_with_cached_size(8, v, os)?;
        }
        os.write_repeated_packed_uint32(6, &self.CNBCKEFNFGE)?;
        os.write_repeated_packed_uint32(1, &self.JOEFNHGGAGO)?;
        if self.KLBPECANFIG != false {
        ...
        os.write_repeated_packed_uint32(5, &self.FABKPHMJGHL)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    tcode\x18\x0e\x20\x01(\rR\x07retcode\x12\x20\n\x0bDCHGIODEDDK\x18\x02\
    \x20\x01(\rR\x0bDCHGIODEDDK\x12.\n\x0bKJKBKEGIGHK\x18\x08\x20\x01(\x0b2\
    \x0c.NOKODMNOHMNR\x0bKJKBKEGIGHK\x12\x20\n\x0bCNBCKEFNFGE\x18\x06\x20\
    \x03(\rR\x0bCNBCKEFNFGE\x12\x20\n\x0bJOEFNHGGAGO\x18\x01\x20\x03(\rR\x0b\
    JOEFNHGGAGO\x12\x20\n\x0bKLBPECANFIG\x18\x03\x20\x01(\x08R\x0bKLBPECANFI\
    G\x12.\n\x0bGAJBFPCPIGM\x18\x0b\x20\x01(\x0b2\x0c.ALEFDNLLKLBR\x0bGAJBFP\
    CPIGM\x12\x20\n\x0bFABKPHMJGHL\x18\x05\x20\x03(\rR\x0bFABKPHMJGHLb\x06pr\
    oto3\
";
