...
impl ::protobuf::Message for GetSwordTrainingDataScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(3, &self.JOEFNHGGAGO);
        if self.DCHGIODEDDK != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.DCHGIODEDDK);
        }
        if let Some(v) = self.GAJBFPCPIGM.as_ref() {
            let len = v.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(10, &self.FABKPHMJGHL);
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_uint32(3, &self.JOEFNHGGAGO)?;
        if self.DCHGIODEDDK != 0 {
            os.write_uint32(4, self.DCHGIODEDDK)?;
        }
        if let Some(v) = self.GAJBFPCPIGM.as_ref() {
            ::protobuf::rt::write_message_field_with_cached_size(14, v, os)?;
        }
        os.write_repeated_packed_uint32(10, &self.FABKPHMJGHL)?;
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    BPECANFIG\x18\x0b\x20\x01(\x08R\x0bKLBPECANFIG\x12.\n\x0bKJKBKEGIGHK\x18\
    \t\x20\x01(\x0b2\x0c.NOKODMNOHMNR\x0bKJKBKEGIGHK\x12\x20\n\x0bJOEFNHGGAG\
    O\x18\x03\x20\x03(\rR\x0bJOEFNHGGAGO\x12\x20\n\x0bDCHGIODEDDK\x18\x04\
    \x20\x01(\rR\x0bDCHGIODEDDK\x12.\n\x0bGAJBFPCPIGM\x18\x0e\x20\x01(\x0b2\
    \x0c.ALEFDNLLKLBR\x0bGAJBFPCPIGM\x12\x20\n\x0bFABKPHMJGHL\x18\n\x20\x03(\
    \rR\x0bFABKPHMJGHL\x12\x18\n\x07retcode\x18\r\x20\x01(\rR\x07retcode\x12\
    \x20\n\x0bCNBCKEFNFGE\x18\x01\x20\x03(\rR\x0bCNBCKEFNFGEb\x06proto3\
";
