...
//! Generated file from `BCAJNMLLIED.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:BCAJNMLLIED)
...
pub struct BCAJNMLLIED {
    ...
    pub id: u32,
    // special fields
    // @@protoc_insertion_point(special_field:BCAJNMLLIED.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a BCAJNMLLIED {
    fn default() -> &'a BCAJNMLLIED {
        <BCAJNMLLIED as ::protobuf::Message>::default_instance()
    }
}

impl BCAJNMLLIED {
    pub fn new() -> BCAJNMLLIED {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "progress",
            |m: &BCAJNMLLIED| { &m.progress },
            |m: &mut BCAJNMLLIED| { &mut m.progress },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "id",
            |m: &BCAJNMLLIED| { &m.id },
            |m: &mut BCAJNMLLIED| { &mut m.id },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<BCAJNMLLIED>(
            "BCAJNMLLIED",
            fields,
            oneofs,
        )
...
impl ::protobuf::Message for BCAJNMLLIED {
    const NAME: &'static str = "BCAJNMLLIED";
...
impl ::protobuf::MessageFull for BCAJNMLLIED {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("BCAJNMLLIED").unwrap()).clone()
    }
}

impl ::std::fmt::Display for BCAJNMLLIED {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for BCAJNMLLIED {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(BCAJNMLLIED::generated_message_descriptor_data());
