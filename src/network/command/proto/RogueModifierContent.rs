...
impl ::protobuf::Message for RogueModifierContent {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.content_modifier_effect_id != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.content_modifier_effect_id);
        }
        if self.AFFJHMJDIBN != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.AFFJHMJDIBN);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.content_modifier_effect_id != 0 {
            os.write_uint32(5, self.content_modifier_effect_id)?;
        }
        if self.AFFJHMJDIBN != 0 {
            os.write_uint32(7, self.AFFJHMJDIBN)?;
        }
        if self.modifier_content_type != ::protobuf::EnumOrUnknown::new(super::RogueModifierContentType::RogueModifierContentType::ROGUE_MODIFIER_CONTENT_DEFINITE) {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x05\x20\x01(\rR\x17contentModifierEffectId\x12\x20\n\x0bAFFJHMJDIBN\
    \x18\x07\x20\x01(\rR\x0bAFFJHMJDIBN\x12M\n\x15modifier_content_type\x18\
    \x08\x20\x01(\x0e2\x19.RogueModifierContentTypeR\x13modifierContentTypeb\
    \x06proto3\
";
