...
impl ::protobuf::Message for SubmitOfferingItemCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.offering_id != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.offering_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.offering_id != 0 {
            os.write_uint32(3, self.offering_id)?;
        }
        if self.interacted_prop_entity_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x1f\n\x0boffering_id\x18\x03\x20\x01(\rR\nofferingId\x129\n\x19interact\
    ed_prop_entity_id\x18\x01\x20\x01(\rR\x16interactedPropEntityIdb\x06prot\
    o3\
";
