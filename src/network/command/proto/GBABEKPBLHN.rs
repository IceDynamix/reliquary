...
impl ::protobuf::Message for GBABEKPBLHN {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.GDDCGEKOJOI != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.GDDCGEKOJOI);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.GDDCGEKOJOI != 0 {
            os.write_uint32(12, self.GDDCGEKOJOI)?;
        }
        if self.GLDJNHIGGJE != false {
            os.write_bool(9, self.GLDJNHIGGJE)?;
        }
        if self.KDMLLLGHJON != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    o\"\xf5\x01\n\x0bGBABEKPBLHN\x12.\n\x0bCAOAPDCCPCA\x18\n\x20\x01(\x0b2\
    \x0c.ABENFANELFLR\x0bCAOAPDCCPCA\x12\x20\n\x0bGDDCGEKOJOI\x18\x0c\x20\
    \x01(\rR\x0bGDDCGEKOJOI\x12\x20\n\x0bGLDJNHIGGJE\x18\t\x20\x01(\x08R\x0b\
    GLDJNHIGGJE\x12\x20\n\x0bKDMLLLGHJON\x18\x01\x20\x01(\rR\x0bKDMLLLGHJON\
    \x12\x20\n\x0bPIPMGACMJNN\x18\x05\x20\x01(\x08R\x0bPIPMGACMJNN\x12.\n\
    \x0bPOCJCMKKJIK\x18\x07\x20\x03(\x0b2\x0c.HJPGNCNGILGR\x0bPOCJCMKKJIKb\
    \x06proto3\
";
