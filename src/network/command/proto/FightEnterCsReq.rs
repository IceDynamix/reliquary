...
impl ::protobuf::Message for FightEnterCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.FGOJLPAEJEC != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.FGOJLPAEJEC);
        }
        if self.uid != 0 {
        ...
        if self.MKINIOFGIAG != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.MKINIOFGIAG);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.FGOJLPAEJEC != 0 {
            os.write_uint32(15, self.FGOJLPAEJEC)?;
        }
        if self.uid != 0 {
        ...
        if self.MKINIOFGIAG != 0 {
            os.write_uint32(14, self.MKINIOFGIAG)?;
        }
        if self.ICMFPNPIJJF != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    FGOJLPAEJEC\x18\x0f\x20\x01(\rR\x0bFGOJLPAEJEC\x12\x10\n\x03uid\x18\x08\
    \x20\x01(\rR\x03uid\x12\x20\n\x0bAOKCMMPFGBC\x18\x03\x20\x01(\tR\x0bAOKC\
    MMPFGBC\x12\x20\n\x0bMKINIOFGIAG\x18\x0e\x20\x01(\rR\x0bMKINIOFGIAG\x12\
    \x20\n\x0bICMFPNPIJJF\x18\x06\x20\x01(\rR\x0bICMFPNPIJJF\x12,\n\x12clien\
    t_res_version\x18\t\x20\x01(\rR\x10clientResVersion\x12\x20\n\x0bKPKDNMD\
    AJGL\x18\x05\x20\x01(\x04R\x0bKPKDNMDAJGL\x12#\n\rplatform_type\x18\x02\
    \x20\x01(\rR\x0cplatformTypeb\x06proto3\
";
