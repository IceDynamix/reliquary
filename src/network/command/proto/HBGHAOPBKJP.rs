...
impl ::protobuf::Message for HBGHAOPBKJP {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.JLCIKBLNENH != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.JLCIKBLNENH);
        }
        ...
        if self.TURN_FOOD_SWITCH_ATTACK != 0 {
            my_size += ::protobuf::rt::int32_size(6, self.TURN_FOOD_SWITCH_ATTACK);
        }
        if self.id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.PMANBPLFLKL != false {
            os.write_bool(15, self.PMANBPLFLKL)?;
        }
        if self.buff_id != 0 {
        ...
        if self.JLCIKBLNENH != 0 {
            os.write_uint32(14, self.JLCIKBLNENH)?;
        }
        if let Some(v) = self.FNIHJJJGOEE.as_ref() {
            ::protobuf::rt::write_message_field_with_cached_size(11, v, os)?;
        }
        if self.TURN_FOOD_SWITCH_ATTACK != 0 {
            os.write_int32(6, self.TURN_FOOD_SWITCH_ATTACK)?;
        }
        if self.id != 0 {
            os.write_uint32(12, self.id)?;
        }
        if self.BMNECPIOPDN != false {
            os.write_bool(1, self.BMNECPIOPDN)?;
        }
        if self.max_hp != 0 {
        ...
        if self.PLFKOCCDBAG != false {
            os.write_bool(2, self.PLFKOCCDBAG)?;
        }
        if self.DMBBMFFEJGI != false {
            os.write_bool(7, self.DMBBMFFEJGI)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    KJP\x12\x20\n\x0bPMANBPLFLKL\x18\x0f\x20\x01(\x08R\x0bPMANBPLFLKL\x12\
    \x17\n\x07buff_id\x18\x03\x20\x01(\rR\x06buffId\x12\x14\n\x05level\x18\
    \x05\x20\x01(\rR\x05level\x12\x20\n\x0bMNBEMGNNFOD\x18\x08\x20\x01(\x02R\
    \x0bMNBEMGNNFOD\x12\x20\n\x0bJLCIKBLNENH\x18\x0e\x20\x01(\rR\x0bJLCIKBLN\
    ENH\x12.\n\x0bFNIHJJJGOEE\x18\x0b\x20\x01(\x0b2\x0c.PFGAIEBGHCPR\x0bFNIH\
    JJJGOEE\x125\n\x17TURN_FOOD_SWITCH_ATTACK\x18\x06\x20\x01(\x05R\x14TURNF\
    OODSWITCHATTACK\x12\x0e\n\x02id\x18\x0c\x20\x01(\rR\x02id\x12\x20\n\x0bB\
    MNECPIOPDN\x18\x01\x20\x01(\x08R\x0bBMNECPIOPDN\x12\x15\n\x06max_hp\x18\
    \x04\x20\x01(\x05R\x05maxHp\x12.\n\x0bLKEFOLCGFGD\x18\r\x20\x01(\x0b2\
    \x0c.PFGAIEBGHCPR\x0bLKEFOLCGFGD\x12\x0e\n\x02hp\x18\n\x20\x01(\x05R\x02\
    hp\x12\x20\n\x0bPLFKOCCDBAG\x18\x02\x20\x01(\x08R\x0bPLFKOCCDBAG\x12\x20\
    \n\x0bDMBBMFFEJGI\x18\x07\x20\x01(\x08R\x0bDMBBMFFEJGIb\x06proto3\
";
