...
impl ::protobuf::Message for EOAEGAEFPFH {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.PAEHAMJHNDD != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.PAEHAMJHNDD);
        }
        if self.avatar_id != 0 {
        ...
        if self.MAIL_TYPE_STAR != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.MAIL_TYPE_STAR);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.PAEHAMJHNDD != 0 {
            os.write_uint32(3, self.PAEHAMJHNDD)?;
        }
        if self.avatar_id != 0 {
        ...
        if self.MAIL_TYPE_STAR != 0 {
            os.write_uint32(5, self.MAIL_TYPE_STAR)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    NDD\x18\x03\x20\x01(\rR\x0bPAEHAMJHNDD\x12\x1b\n\tavatar_id\x18\n\x20\
    \x01(\rR\x08avatarId\x12\x14\n\x05level\x18\x0b\x20\x01(\rR\x05level\x12\
    $\n\x0eMAIL_TYPE_STAR\x18\x05\x20\x01(\rR\x0cMAILTYPESTARb\x06proto3\
";
