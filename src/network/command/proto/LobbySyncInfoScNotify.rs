...
pub struct LobbySyncInfoScNotify {
    ...
    pub uid: u32,
    // @@protoc_insertion_point(field:LobbySyncInfoScNotify.DDDJPDDBFIP)
...
impl LobbySyncInfoScNotify {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "DDDJPDDBFIP",
            |m: &LobbySyncInfoScNotify| { &m.DDDJPDDBFIP },
            |m: &mut LobbySyncInfoScNotify| { &mut m.DDDJPDDBFIP },
        ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x01(\rR\x03uid\x12.\n\x0bDDDJPDDBFIP\x18\x0f\x20\x03(\x0b2\x0c.CBBDIOMI\
    FHDR\x0bDDDJPDDBFIPb\x06proto3\
";
