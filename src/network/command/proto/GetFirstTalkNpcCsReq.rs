...
impl ::protobuf::Message for GetFirstTalkNpcCsReq {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(1, &self.BPIDOKOFIDI);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(1, &self.BPIDOKOFIDI)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0bBPIDOKOFIDI\x18\x01\x20\x03(\rR\x0bBPIDOKOFIDIb\x06proto3\
";
