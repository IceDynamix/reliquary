...
impl ::protobuf::Message for GetFirstTalkNpcCsReq {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(4, &self.npc_id_list);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(4, &self.npc_id_list)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0bnpc_id_list\x18\x04\x20\x03(\rR\tnpcIdListb\x06proto3\
";
