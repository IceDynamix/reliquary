...
impl ::protobuf::Message for MuseumTargetRewardNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.PNGDDNAJCGG != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.PNGDDNAJCGG);
        }
        if self.item_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.PNGDDNAJCGG != 0 {
            os.write_uint32(9, self.PNGDDNAJCGG)?;
        }
        if self.item_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12\x20\n\x0bPNGDDNAJCGG\x18\t\x20\x01(\rR\x0bPNGDDNAJCGG\x12\x17\n\x07\
    item_id\x18\x0c\x20\x01(\rR\x06itemId\x12\x1d\n\nitem_count\x18\x0b\x20\
    \x01(\rR\titemCountb\x06proto3\
";
