...
pub struct MuseumTargetRewardNotify {
    // message fields
    // @@protoc_insertion_point(field:MuseumTargetRewardNotify.item_id)
    pub item_id: u32,
    // @@protoc_insertion_point(field:MuseumTargetRewardNotify.destroy_count)
    pub destroy_count: u32,
    // @@protoc_insertion_point(field:MuseumTargetRewardNotify.DMFNJEDPCFF)
    pub DMFNJEDPCFF: u32,
    // special fields
...
impl MuseumTargetRewardNotify {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "item_id",
            |m: &MuseumTargetRewardNotify| { &m.item_id },
            |m: &mut MuseumTargetRewardNotify| { &mut m.item_id },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "destroy_count",
            |m: &MuseumTargetRewardNotify| { &m.destroy_count },
            |m: &mut MuseumTargetRewardNotify| { &mut m.destroy_count },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "DMFNJEDPCFF",
            |m: &MuseumTargetRewardNotify| { &m.DMFNJEDPCFF },
            |m: &mut MuseumTargetRewardNotify| { &mut m.DMFNJEDPCFF },
        ));
...
impl ::protobuf::Message for MuseumTargetRewardNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.destroy_count != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.destroy_count);
        }
        if self.DMFNJEDPCFF != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.DMFNJEDPCFF);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.destroy_count != 0 {
            os.write_uint32(10, self.destroy_count)?;
        }
        if self.DMFNJEDPCFF != 0 {
            os.write_uint32(13, self.DMFNJEDPCFF)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1eMuseumTargetRewardNotify.proto\"z\n\x18MuseumTargetRewardNotify\
    \x12\x17\n\x07item_id\x18\t\x20\x01(\rR\x06itemId\x12#\n\rdestroy_count\
    \x18\n\x20\x01(\rR\x0cdestroyCount\x12\x20\n\x0bDMFNJEDPCFF\x18\r\x20\
    \x01(\rR\x0bDMFNJEDPCFFb\x06proto3\
";
