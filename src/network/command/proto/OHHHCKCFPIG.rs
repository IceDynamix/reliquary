...
//! Generated file from `OHHHCKCFPIG.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:OHHHCKCFPIG)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct OHHHCKCFPIG {
    // message fields
...
impl<'a> ::std::default::Default for &'a OHHHCKCFPIG {
    fn default() -> &'a OHHHCKCFPIG {
        <OHHHCKCFPIG as ::protobuf::Message>::default_instance()
    }
}

impl OHHHCKCFPIG {
    pub fn new() -> OHHHCKCFPIG {
...
impl ::protobuf::Message for OHHHCKCFPIG {
    const NAME: &'static str = "OHHHCKCFPIG";
...
impl ::protobuf::MessageFull for OHHHCKCFPIG {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("OHHHCKCFPIG").unwrap()).clone()
    }
}

impl ::std::fmt::Display for OHHHCKCFPIG {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for OHHHCKCFPIG {
