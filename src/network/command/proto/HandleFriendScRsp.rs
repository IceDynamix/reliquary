...
impl ::protobuf::Message for HandleFriendScRsp {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.is_accept != false {
            os.write_bool(3, self.is_accept)?;
        }
        if self.uid != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x11HandleFriendScRsp\x12\x18\n\x07retcode\x18\x02\x20\x01(\rR\x07retcod\
    e\x12\x1b\n\tis_accept\x18\x03\x20\x01(\x08R\x08isAccept\x12\x10\n\x03ui\
    d\x18\x08\x20\x01(\rR\x03uid\x122\n\x0bfriend_info\x18\x0c\x20\x01(\x0b2\
