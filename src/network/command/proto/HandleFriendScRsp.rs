...
impl HandleFriendScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::FriendSimpleInfo::FriendSimpleInfo>(
            "friend_info",
            |m: &HandleFriendScRsp| { &m.friend_info },
...
impl ::protobuf::Message for HandleFriendScRsp {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.is_accept != false {
            os.write_bool(5, self.is_accept)?;
        }
        if self.uid != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x11HandleFriendScRsp\x12\x1b\n\tis_accept\x18\x05\x20\x01(\x08R\x08isAc\
    cept\x12\x10\n\x03uid\x18\x01\x20\x01(\rR\x03uid\x12\x18\n\x07retcode\
    \x18\x08\x20\x01(\rR\x07retcode\x122\n\x0bfriend_info\x18\x02\x20\x01(\
    \x0b2\x11.FriendSimpleInfoR\nfriendInfob\x06proto3\
";
