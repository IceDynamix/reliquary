...
impl ::protobuf::Message for GetPunkLordDataScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.GNLMKKHAEKM != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.GNLMKKHAEKM);
        }
        if self.PPNKPNBIIEN != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.PPNKPNBIIEN);
        }
        if self.GBJODJCOLGA != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.GBJODJCOLGA);
        }
        ...
        if self.BEDJDEANCOJ != 0 {
            my_size += ::protobuf::rt::int64_size(11, self.BEDJDEANCOJ);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.GNLMKKHAEKM != 0 {
            os.write_uint32(9, self.GNLMKKHAEKM)?;
        }
        if self.PPNKPNBIIEN != 0 {
            os.write_uint32(2, self.PPNKPNBIIEN)?;
        }
        if self.GBJODJCOLGA != 0 {
            os.write_uint32(14, self.GBJODJCOLGA)?;
        }
        if self.BDPBDGBKDOO != 0 {
        ...
        if self.BEDJDEANCOJ != 0 {
            os.write_int64(11, self.BEDJDEANCOJ)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x20\n\x0bGNLMKKHAEKM\x18\t\x20\x01(\rR\x0bGNLMKKHAEKM\x12\x20\n\x0bPPNK\
    PNBIIEN\x18\x02\x20\x01(\rR\x0bPPNKPNBIIEN\x12\x20\n\x0bGBJODJCOLGA\x18\
    \x0e\x20\x01(\rR\x0bGBJODJCOLGA\x12\x20\n\x0bBDPBDGBKDOO\x18\x0f\x20\x01\
    (\rR\x0bBDPBDGBKDOO\x12\x18\n\x07retcode\x18\x04\x20\x01(\rR\x07retcode\
    \x12\x20\n\x0bIADCOHODGJN\x18\r\x20\x01(\rR\x0bIADCOHODGJN\x12\x20\n\x0b\
    EAHBIKFALLF\x18\x01\x20\x03(\rR\x0bEAHBIKFALLF\x12\x20\n\x0bBEDJDEANCOJ\
    \x18\x0b\x20\x01(\x03R\x0bBEDJDEANCOJb\x06proto3\
";
