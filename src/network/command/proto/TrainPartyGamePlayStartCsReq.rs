...
impl ::protobuf::Message for TrainPartyGamePlayStartCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.GONEAKBDGEK != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.GONEAKBDGEK);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(11, &self.KBGDCEHIFFJ);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.GONEAKBDGEK != 0 {
            os.write_uint32(12, self.GONEAKBDGEK)?;
        }
        os.write_repeated_packed_uint32(11, &self.KBGDCEHIFFJ)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    Req\x12\x20\n\x0bGONEAKBDGEK\x18\x0c\x20\x01(\rR\x0bGONEAKBDGEK\x12\x20\
    \n\x0bKBGDCEHIFFJ\x18\x0b\x20\x03(\rR\x0bKBGDCEHIFFJb\x06proto3\
";
