...
impl ::protobuf::Message for GetGachaCeilingScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.gacha_type != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.gacha_type);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.gacha_type != 0 {
            os.write_uint32(12, self.gacha_type)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x14GetGachaCeilingScRsp\x122\n\rgacha_ceiling\x18\x03\x20\x01(\x0b2\r.G\
    achaCeilingR\x0cgachaCeiling\x12\x1d\n\ngacha_type\x18\x0c\x20\x01(\rR\t\
