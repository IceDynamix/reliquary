...
impl ::protobuf::Message for GetGachaCeilingScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.gacha_type != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.gacha_type);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.gacha_type != 0 {
            os.write_uint32(9, self.gacha_type)?;
        }
        if let Some(v) = self.gacha_ceiling.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    code\x12\x1d\n\ngacha_type\x18\t\x20\x01(\rR\tgachaType\x122\n\rgacha_ce\
    iling\x18\x07\x20\x01(\x0b2\r.GachaCeilingR\x0cgachaCeilingb\x06proto3\
";
