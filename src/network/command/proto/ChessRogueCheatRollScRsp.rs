...
impl ::protobuf::Message for ChessRogueCheatRollScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.NLJOLDMCGAI != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.NLJOLDMCGAI);
        }
        if self.retcode != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.retcode);
        }
        if self.dice_surface_id != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.dice_surface_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.NLJOLDMCGAI != 0 {
            os.write_uint32(14, self.NLJOLDMCGAI)?;
        }
        if self.retcode != 0 {
            os.write_uint32(12, self.retcode)?;
        }
        if self.dice_surface_id != 0 {
            os.write_uint32(7, self.dice_surface_id)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \xbb\x01\n\x18ChessRogueCheatRollScRsp\x12;\n\x0frogue_dice_info\x18\x03\
    \x20\x01(\x0b2\x13.ChessRogueDiceInfoR\rrogueDiceInfo\x12\x20\n\x0bNLJOL\
    DMCGAI\x18\x0e\x20\x01(\rR\x0bNLJOLDMCGAI\x12\x18\n\x07retcode\x18\x0c\
    \x20\x01(\rR\x07retcode\x12&\n\x0fdice_surface_id\x18\x07\x20\x01(\rR\rd\
    iceSurfaceIdb\x06proto3\
";
