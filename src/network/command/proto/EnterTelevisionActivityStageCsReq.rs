...
pub struct EnterTelevisionActivityStageCsReq {
    // message fields
    // @@protoc_insertion_point(field:EnterTelevisionActivityStageCsReq.television_id)
    pub television_id: u32,
    // @@protoc_insertion_point(field:EnterTelevisionActivityStageCsReq.avatar_list)
    pub avatar_list: ::std::vec::Vec<super::TelevisionActivityAvatar::TelevisionActivityAvatar>,
...
impl EnterTelevisionActivityStageCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "television_id",
            |m: &EnterTelevisionActivityStageCsReq| { &m.television_id },
            |m: &mut EnterTelevisionActivityStageCsReq| { &mut m.television_id },
        ));
...
impl ::protobuf::Message for EnterTelevisionActivityStageCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.television_id != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.television_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.television_id != 0 {
            os.write_uint32(4, self.television_id)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n'EnterTelevisionActivityStageCsReq.proto\x1a\x1eTelevisionActivityAvat\
    ar.proto\"\xa1\x01\n!EnterTelevisionActivityStageCsReq\x12#\n\rtelevisio\
    n_id\x18\x04\x20\x01(\rR\x0ctelevisionId\x12:\n\x0bavatar_list\x18\x06\
    \x20\x03(\x0b2\x19.TelevisionActivityAvatarR\navatarList\x12\x1b\n\tbuff\
    _list\x18\x0f\x20\x03(\rR\x08buffListb\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::TelevisionActivityAvatar::file_descriptor().clone());
