...
pub struct AlleyPlacingShip {
    ...
    pub goods_list: ::std::vec::Vec<super::CBBPDLPAIPL::CBBPDLPAIPL>,
    // special fields
...
impl ::protobuf::Message for AlleyPlacingShip {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.ship_id != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.ship_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.ship_id != 0 {
            os.write_uint32(4, self.ship_id)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x16AlleyPlacingShip.proto\x1a\x11CBBPDLPAIPL.proto\"X\n\x10AlleyPlaci\
    ngShip\x12\x17\n\x07ship_id\x18\x04\x20\x01(\rR\x06shipId\x12+\n\ngoods_\
    list\x18\x07\x20\x03(\x0b2\x0c.CBBPDLPAIPLR\tgoodsListb\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::CBBPDLPAIPL::file_descriptor().clone());
