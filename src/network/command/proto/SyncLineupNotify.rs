...
impl ::protobuf::Message for SyncLineupNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_enum_or_unknown_size(7, &self.reason_list);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_enum_or_unknown(7, &self.reason_list)?;
