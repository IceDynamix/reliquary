...
impl ::protobuf::Message for SocialEventServerCache {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.sub_coin != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.sub_coin);
        }
        if self.add_coin != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.add_coin);
        }
        if self.src_uid != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.src_uid);
        }
        if self.id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.sub_coin != 0 {
            os.write_uint32(9, self.sub_coin)?;
        }
        if self.add_coin != 0 {
            os.write_uint32(2, self.add_coin)?;
        }
        if self.src_uid != 0 {
            os.write_uint32(3, self.src_uid)?;
        }
        if self.id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x19\n\x08sub_coin\x18\t\x20\x01(\rR\x07subCoin\x12\x19\n\x08add_coin\
    \x18\x02\x20\x01(\rR\x07addCoin\x12\x17\n\x07src_uid\x18\x03\x20\x01(\rR\
