...
impl ::protobuf::Message for SocialEventServerCache {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.sub_coin != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.sub_coin);
        }
        if self.src_uid != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.src_uid);
        }
        if self.add_coin != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.add_coin);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.sub_coin != 0 {
            os.write_uint32(15, self.sub_coin)?;
        }
        if self.src_uid != 0 {
            os.write_uint32(9, self.src_uid)?;
        }
        if self.add_coin != 0 {
            os.write_uint32(7, self.add_coin)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0e\n\x02id\x18\n\x20\x01(\rR\x02id\x12\x19\n\x08sub_coin\x18\x0f\x20\
    \x01(\rR\x07subCoin\x12\x17\n\x07src_uid\x18\t\x20\x01(\rR\x06srcUid\x12\
    \x19\n\x08add_coin\x18\x07\x20\x01(\rR\x07addCoinb\x06proto3\
";
