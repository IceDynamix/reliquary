...
//! Generated file from `NPCIGEBNOFG.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:NPCIGEBNOFG)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct NPCIGEBNOFG {
    // message fields
...
impl<'a> ::std::default::Default for &'a NPCIGEBNOFG {
    fn default() -> &'a NPCIGEBNOFG {
        <NPCIGEBNOFG as ::protobuf::Message>::default_instance()
    }
}

impl NPCIGEBNOFG {
    pub fn new() -> NPCIGEBNOFG {
...
impl ::protobuf::Message for NPCIGEBNOFG {
    const NAME: &'static str = "NPCIGEBNOFG";
...
impl ::protobuf::MessageFull for NPCIGEBNOFG {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("NPCIGEBNOFG").unwrap()).clone()
    }
}

impl ::std::fmt::Display for NPCIGEBNOFG {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for NPCIGEBNOFG {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(NPCIGEBNOFG::generated_message_descriptor_data());
