...
pub struct HIEJJBDNCNH {
    ...
    // @@protoc_insertion_point(field:HIEJJBDNCNH.display_type)
...
impl HIEJJBDNCNH {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "display_type",
            |m: &HIEJJBDNCNH| { &m.display_type },
            |m: &mut HIEJJBDNCNH| { &mut m.display_type },
        ));
...
impl ::protobuf::Message for HIEJJBDNCNH {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.display_type != ::protobuf::EnumOrUnknown::new(super::BattleRecordType::BattleRecordType::BATTLE_RECORD_NONE) {
            my_size += ::protobuf::rt::int32_size(14, self.display_type.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.display_type != ::protobuf::EnumOrUnknown::new(super::BattleRecordType::BattleRecordType::BATTLE_RECORD_NONE) {
            os.write_enum(14, ::protobuf::EnumOrUnknown::value(&self.display_type))?;
        }
        if let Some(v) = self.EBOOMGDGNEP.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    .proto\x1a\x11OBIHNGMNKEK.proto\"\xa3\x01\n\x0bHIEJJBDNCNH\x12.\n\x0bJFP\
    CPDCFLMD\x18\x02\x20\x01(\x0b2\x0c.OBIHNGMNKEKR\x0bJFPCPDCFLMD\x124\n\
    \x0cdisplay_type\x18\x0e\x20\x01(\x0e2\x11.BattleRecordTypeR\x0bdisplayT\
    ype\x12.\n\x0bEBOOMGDGNEP\x18\x03\x20\x01(\x0b2\x0c.IHKGNJDNALJR\x0bEBOO\
    MGDGNEPb\x06proto3\
";
