...
impl ::protobuf::Message for Shop {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.city_taken_level_reward != 0 {
            my_size += ::protobuf::rt::uint64_size(15, self.city_taken_level_reward);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.city_taken_level_reward != 0 {
            os.write_uint64(15, self.city_taken_level_reward)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    vel\x18\x01\x20\x01(\rR\tcityLevel\x12\x17\n\x07shop_id\x18\x05\x20\x01(\
    \rR\x06shopId\x12\x19\n\x08end_time\x18\x07\x20\x01(\x03R\x07endTime\x12\
    %\n\ngoods_list\x18\n\x20\x03(\x0b2\x06.GoodsR\tgoodsList\x12\x1d\n\nbeg\
    in_time\x18\r\x20\x01(\x03R\tbeginTime\x12\x19\n\x08city_exp\x18\x0e\x20\
    \x01(\rR\x07cityExp\x125\n\x17city_taken_level_reward\x18\x0f\x20\x01(\
    \x04R\x14cityTakenLevelRewardb\x06proto3\
";
