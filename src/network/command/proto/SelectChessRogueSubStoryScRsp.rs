...
impl ::protobuf::Message for SelectChessRogueSubStoryScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.rogue_dialogue_event_id != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.rogue_dialogue_event_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.rogue_dialogue_event_id != 0 {
            os.write_uint32(14, self.rogue_dialogue_event_id)?;
        }
        if self.IFIIJGNGOGP != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    KJAFA\x18\t\x20\x01(\rR\x0bIKMNAMKJAFA\x125\n\x17rogue_dialogue_event_id\
    \x18\x0e\x20\x01(\rR\x14rogueDialogueEventId\x12\x20\n\x0bIFIIJGNGOGP\
    \x18\r\x20\x01(\rR\x0bIFIIJGNGOGPb\x06proto3\
";
