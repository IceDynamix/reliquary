...
impl ::protobuf::Message for SelectChessRogueSubStoryScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.IFIIJGNGOGP != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.IFIIJGNGOGP);
        }
        if self.retcode != 0 {
        ...
        if self.FAHIHDJFOHM != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.FAHIHDJFOHM);
        }
        if self.DDJPKFLBIGF != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.DDJPKFLBIGF);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.IFIIJGNGOGP != 0 {
            os.write_uint32(9, self.IFIIJGNGOGP)?;
        }
        if self.retcode != 0 {
        ...
        if self.FAHIHDJFOHM != 0 {
            os.write_uint32(5, self.FAHIHDJFOHM)?;
        }
        if self.DDJPKFLBIGF != 0 {
            os.write_uint32(4, self.DDJPKFLBIGF)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    bStoryScRsp\x12\x20\n\x0bIFIIJGNGOGP\x18\t\x20\x01(\rR\x0bIFIIJGNGOGP\
    \x12\x18\n\x07retcode\x18\x0c\x20\x01(\rR\x07retcode\x12\x20\n\x0bIKMNAM\
    KJAFA\x18\x0b\x20\x01(\rR\x0bIKMNAMKJAFA\x12\x20\n\x0bFAHIHDJFOHM\x18\
    \x05\x20\x01(\rR\x0bFAHIHDJFOHM\x12\x20\n\x0bDDJPKFLBIGF\x18\x04\x20\x01\
    (\rR\x0bDDJPKFLBIGFb\x06proto3\
";
