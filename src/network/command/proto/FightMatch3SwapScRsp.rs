...
pub struct FightMatch3SwapScRsp {
    // message fields
    // @@protoc_insertion_point(field:FightMatch3SwapScRsp.BBLBLAFIGHM)
    pub BBLBLAFIGHM: u32,
...
impl FightMatch3SwapScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "BBLBLAFIGHM",
            |m: &FightMatch3SwapScRsp| { &m.BBLBLAFIGHM },
            |m: &mut FightMatch3SwapScRsp| { &mut m.BBLBLAFIGHM },
        ));
...
impl ::protobuf::Message for FightMatch3SwapScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.BBLBLAFIGHM != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.BBLBLAFIGHM);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.BBLBLAFIGHM != 0 {
            os.write_uint32(4, self.BBLBLAFIGHM)?;
        }
        if let Some(v) = self.CHMAONMMEGM.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1aFightMatch3SwapScRsp.proto\x1a\x11MDOHAFBEEPK.proto\"\xa4\x01\n\
    \x14FightMatch3SwapScRsp\x12\x20\n\x0bBBLBLAFIGHM\x18\x04\x20\x01(\rR\
    \x0bBBLBLAFIGHM\x12.\n\x0bCHMAONMMEGM\x18\x05\x20\x01(\x0b2\x0c.MDOHAFBE\
    EPKR\x0bCHMAONMMEGM\x12\x20\n\x0bPGMGMJDILCL\x18\r\x20\x01(\x08R\x0bPGMG\
