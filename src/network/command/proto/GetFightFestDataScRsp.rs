...
impl ::protobuf::Message for GetFightFestDataScRsp {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(6, &self.GILJLEOAOMA);
        if self.score_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(6, &self.GILJLEOAOMA)?;
        if self.score_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x15GetFightFestDataScRsp\x12\x20\n\x0bGILJLEOAOMA\x18\x06\x20\x03(\rR\
    \x0bGILJLEOAOMA\x12\x19\n\x08score_id\x18\x07\x20\x01(\rR\x07scoreId\x12\
    \x18\n\x07retcode\x18\x08\x20\x01(\rR\x07retcode\x123\n\x0echallenge_lis\
    t\x18\n\x20\x03(\x0b2\x0c.LPJOINCGBBPR\rchallengeList\x12\x1d\n\nitem_va\
    lue\x18\x0f\x20\x01(\rR\titemValueb\x06proto3\
";
