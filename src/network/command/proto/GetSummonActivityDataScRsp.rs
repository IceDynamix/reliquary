...
pub struct GetSummonActivityDataScRsp {
    ...
    pub retcode: u32,
    // @@protoc_insertion_point(field:GetSummonActivityDataScRsp.BODOHCCDPDC)
    pub BODOHCCDPDC: ::std::vec::Vec<super::PGBHMOLFBMM::PGBHMOLFBMM>,
    // special fields
...
impl GetSummonActivityDataScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "BODOHCCDPDC",
            |m: &GetSummonActivityDataScRsp| { &m.BODOHCCDPDC },
            |m: &mut GetSummonActivityDataScRsp| { &mut m.BODOHCCDPDC },
        ));
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                122 => {
                    self.BODOHCCDPDC.push(is.read_message()?);
                },
                tag => {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    etcode\x12.\n\x0bBODOHCCDPDC\x18\x0f\x20\x03(\x0b2\x0c.PGBHMOLFBMMR\x0bB\
    ODOHCCDPDCb\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::PGBHMOLFBMM::file_descriptor().clone());
