...
impl ::protobuf::Message for GetAuthkeyCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.auth_appid.is_empty() {
            my_size += ::protobuf::rt::string_size(10, &self.auth_appid);
        }
        if self.authkey_ver != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.authkey_ver);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.auth_appid.is_empty() {
            os.write_string(10, &self.auth_appid)?;
        }
        if self.authkey_ver != 0 {
            os.write_uint32(15, self.authkey_ver)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x04\x20\x01(\rR\x08signType\x12\x1d\n\nauth_appid\x18\n\x20\x01(\tR\
    \tauthAppid\x12\x1f\n\x0bauthkey_ver\x18\x0f\x20\x01(\rR\nauthkeyVerb\
    \x06proto3\
";
