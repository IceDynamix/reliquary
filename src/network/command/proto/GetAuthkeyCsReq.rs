...
impl ::protobuf::Message for GetAuthkeyCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.auth_appid.is_empty() {
            my_size += ::protobuf::rt::string_size(6, &self.auth_appid);
        }
        if self.sign_type != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.auth_appid.is_empty() {
            os.write_string(6, &self.auth_appid)?;
        }
        if self.sign_type != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    _ver\x18\x04\x20\x01(\rR\nauthkeyVer\x12\x1d\n\nauth_appid\x18\x06\x20\
    \x01(\tR\tauthAppid\x12\x1b\n\tsign_type\x18\x07\x20\x01(\rR\x08signType\
    b\x06proto3\
";
