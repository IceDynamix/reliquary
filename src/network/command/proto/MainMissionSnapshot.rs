...
//! Generated file from `MainMissionSnapshot.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:MainMissionSnapshot)
...
impl<'a> ::std::default::Default for &'a MainMissionSnapshot {
    fn default() -> &'a MainMissionSnapshot {
        <MainMissionSnapshot as ::protobuf::Message>::default_instance()
    }
}

impl MainMissionSnapshot {
    pub fn new() -> MainMissionSnapshot {
...
impl ::protobuf::Message for MainMissionSnapshot {
    const NAME: &'static str = "MainMissionSnapshot";
    ...
    fn new() -> MainMissionSnapshot {
        MainMissionSnapshot::new()
    }
...
impl ::protobuf::MessageFull for MainMissionSnapshot {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("MainMissionSnapshot").unwrap()).clone()
    }
}

impl ::std::fmt::Display for MainMissionSnapshot {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for MainMissionSnapshot {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::SubMissionSnapshot::file_descriptor().clone());
            let mut messages = ::std::vec::Vec::with_capacity(1);
            messages.push(MainMissionSnapshot::generated_message_descriptor_data());
