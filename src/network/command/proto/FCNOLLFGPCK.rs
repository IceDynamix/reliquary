...
impl ::protobuf::Message for FCNOLLFGPCK {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.INHDDNNPBDB != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.INHDDNNPBDB);
        }
        if self.score_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.INHDDNNPBDB != 0 {
            os.write_uint32(11, self.INHDDNNPBDB)?;
        }
        if self.score_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    PBDB\x18\x0b\x20\x01(\rR\x0bINHDDNNPBDB\x12\x19\n\x08score_id\x18\x06\
    \x20\x01(\rR\x07scoreId\x12\x19\n\x08buff_one\x18\x0e\x20\x01(\rR\x07buf\
    fOne\x122\n\x0bplayer_info\x18\x03\x20\x01(\x0b2\x11.PlayerSimpleInfoR\n\
    playerInfo\x12\x19\n\x08buff_two\x18\x05\x20\x01(\rR\x07buffTwo\x12\x1f\
