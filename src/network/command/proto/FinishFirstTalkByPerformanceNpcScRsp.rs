...
pub struct FinishFirstTalkByPerformanceNpcScRsp {
    // message fields
    // @@protoc_insertion_point(field:FinishFirstTalkByPerformanceNpcScRsp.npc_talk_id)
    pub npc_talk_id: u32,
...
impl FinishFirstTalkByPerformanceNpcScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "npc_talk_id",
            |m: &FinishFirstTalkByPerformanceNpcScRsp| { &m.npc_talk_id },
            |m: &mut FinishFirstTalkByPerformanceNpcScRsp| { &mut m.npc_talk_id },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "retcode",
...
impl ::protobuf::Message for FinishFirstTalkByPerformanceNpcScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.npc_talk_id != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.npc_talk_id);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.npc_talk_id != 0 {
            os.write_uint32(5, self.npc_talk_id)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x83\x01\n$FinishFirstTalkByPerformanceNpcScRsp\x12\x1e\n\x0bnpc_talk_id\
    \x18\x05\x20\x01(\rR\tnpcTalkId\x12\x18\n\x07retcode\x18\x0f\x20\x01(\rR\
