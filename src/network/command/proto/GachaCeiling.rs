...
impl ::protobuf::Message for GachaCeiling {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.ceiling_num != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.ceiling_num);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.ceiling_num != 0 {
            os.write_uint32(8, self.ceiling_num)?;
        }
        for v in &self.avatar_list {
            ::protobuf::rt::write_message_field_with_cached_size(15, v, os)?;
        };
        if self.is_claimed != false {
            os.write_bool(14, self.is_claimed)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    GachaCeiling\x12\x1f\n\x0bceiling_num\x18\x08\x20\x01(\rR\nceilingNum\
    \x124\n\x0bavatar_list\x18\x0f\x20\x03(\x0b2\x13.GachaCeilingAvatarR\nav\
    atarList\x12\x1d\n\nis_claimed\x18\x0e\x20\x01(\x08R\tisClaimedb\x06prot\
    o3\
";
