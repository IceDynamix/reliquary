...
impl ::protobuf::Message for ScenePropInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.life_time_ms != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.life_time_ms);
        }
        if self.prop_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.life_time_ms != 0 {
            os.write_uint32(14, self.life_time_ms)?;
        }
        if self.prop_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ropInfo\x12*\n\x11trigger_name_list\x18\x0f\x20\x03(\tR\x0ftriggerNameLi\
    st\x12-\n\nextra_info\x18\x07\x20\x01(\x0b2\x0e.PropExtraInfoR\textraInf\
    o\x12\x20\n\x0clife_time_ms\x18\x0e\x20\x01(\rR\nlifeTimeMs\x12\x17\n\
    \x07prop_id\x18\x03\x20\x01(\rR\x06propId\x12$\n\x0ecreate_time_ms\x18\
    \x08\x20\x01(\x04R\x0ccreateTimeMs\x12\x1d\n\nprop_state\x18\x01\x20\x01\
    (\rR\tpropStateb\x06proto3\
";
