...
impl ::protobuf::Message for ScenePropInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.create_time_ms != 0 {
            my_size += ::protobuf::rt::uint64_size(10, self.create_time_ms);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.create_time_ms != 0 {
            os.write_uint64(10, self.create_time_ms)?;
        }
        if self.life_time_ms != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ropInfo\x12\x1d\n\nprop_state\x18\x01\x20\x01(\rR\tpropState\x12*\n\x11t\
    rigger_name_list\x18\x03\x20\x03(\tR\x0ftriggerNameList\x12-\n\nextra_in\
    fo\x18\x08\x20\x01(\x0b2\x0e.PropExtraInfoR\textraInfo\x12$\n\x0ecreate_\
    time_ms\x18\n\x20\x01(\x04R\x0ccreateTimeMs\x12\x20\n\x0clife_time_ms\
    \x18\x0c\x20\x01(\rR\nlifeTimeMs\x12\x17\n\x07prop_id\x18\r\x20\x01(\rR\
    \x06propIdb\x06proto3\
";
