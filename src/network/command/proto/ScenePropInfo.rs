...
impl ::protobuf::Message for ScenePropInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.prop_state != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.prop_state);
        }
        if self.prop_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.prop_state != 0 {
            os.write_uint32(8, self.prop_state)?;
        }
        if self.prop_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    pInfo\x12+\n\nextra_info\x18\r\x20\x01(\x0b2\x0c.JNEOBOCBFFGR\textraInfo\
    \x12$\n\x0ecreate_time_ms\x18\x03\x20\x01(\x04R\x0ccreateTimeMs\x12\x20\
    \n\x0clife_time_ms\x18\x0c\x20\x01(\rR\nlifeTimeMs\x12\x1d\n\nprop_state\
    \x18\x08\x20\x01(\rR\tpropState\x12\x17\n\x07prop_id\x18\n\x20\x01(\rR\
    \x06propId\x12*\n\x11trigger_name_list\x18\x0b\x20\x03(\tR\x0ftriggerNam\
    eListb\x06proto3\
";
