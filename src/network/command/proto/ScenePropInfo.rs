...
impl ::protobuf::Message for ScenePropInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.life_time_ms != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.life_time_ms);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.life_time_ms != 0 {
            os.write_uint32(15, self.life_time_ms)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ropInfo\x12\x1d\n\nprop_state\x18\x04\x20\x01(\rR\tpropState\x12*\n\x11t\
    rigger_name_list\x18\r\x20\x03(\tR\x0ftriggerNameList\x12\x17\n\x07prop_\
    id\x18\x08\x20\x01(\rR\x06propId\x12-\n\nextra_info\x18\t\x20\x01(\x0b2\
    \x0e.PropExtraInfoR\textraInfo\x12$\n\x0ecreate_time_ms\x18\x0c\x20\x01(\
    \x04R\x0ccreateTimeMs\x12\x20\n\x0clife_time_ms\x18\x0f\x20\x01(\rR\nlif\
    eTimeMsb\x06proto3\
";
