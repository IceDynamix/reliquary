...
impl ::protobuf::Message for EndDrinkMakerSequenceScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.next_sequence_id != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.next_sequence_id);
        }
        if self.level != 0 {
        ...
        if self.tips != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.tips);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.next_sequence_id != 0 {
            os.write_uint32(9, self.next_sequence_id)?;
        }
        if self.level != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    SequenceScRsp\x12(\n\x10next_sequence_id\x18\t\x20\x01(\rR\x0enextSequen\
    ceId\x12\x14\n\x05level\x18\x0b\x20\x01(\rR\x05level\x12\x10\n\x03exp\
    \x18\x02\x20\x01(\rR\x03exp\x12/\n\x0crequest_list\x18\x08\x20\x03(\x0b2\
    \x0c.MFLPAMAFJNCR\x0brequestList\x12&\n\x05guest\x18\x04\x20\x01(\x0b2\
    \x10.DrinkMakerGuestR\x05guest\x12\x12\n\x04tips\x18\x03\x20\x01(\rR\x04\
