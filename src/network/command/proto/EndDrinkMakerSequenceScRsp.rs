...
pub struct EndDrinkMakerSequenceScRsp {
    ...
    pub request_list: ::std::vec::Vec<super::MFLPAMAFJNC::MFLPAMAFJNC>,
...
impl ::protobuf::Message for EndDrinkMakerSequenceScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.tips != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.tips);
        }
        if self.level != 0 {
        ...
        if self.next_sequence_id != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.next_sequence_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.next_sequence_id != 0 {
            os.write_uint32(4, self.next_sequence_id)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0eItemList.proto\x1a\x11MFLPAMAFJNC.proto\"\x98\x02\n\x1aEndDrinkMaker\
    SequenceScRsp\x12!\n\x06reward\x18\x0f\x20\x01(\x0b2\t.ItemListR\x06rewa\
    rd\x12\x12\n\x04tips\x18\x0b\x20\x01(\rR\x04tips\x12\x14\n\x05level\x18\
    \x06\x20\x01(\rR\x05level\x12\x10\n\x03exp\x18\x0e\x20\x01(\rR\x03exp\
    \x12&\n\x05guest\x18\x03\x20\x01(\x0b2\x10.DrinkMakerGuestR\x05guest\x12\
    /\n\x0crequest_list\x18\x07\x20\x03(\x0b2\x0c.MFLPAMAFJNCR\x0brequestLis\
    t\x12\x18\n\x07retcode\x18\x08\x20\x01(\rR\x07retcode\x12(\n\x10next_seq\
    uence_id\x18\x04\x20\x01(\rR\x0enextSequenceIdb\x06proto3\
";
