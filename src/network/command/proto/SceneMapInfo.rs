...
impl ::protobuf::Message for SceneMapInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.cur_map_entry_id != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.cur_map_entry_id);
        }
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(3, &self.unlock_teleport_list);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.cur_map_entry_id != 0 {
            os.write_uint32(4, self.cur_map_entry_id)?;
        }
        ...
        os.write_repeated_packed_uint32(3, &self.unlock_teleport_list)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    proto\"\x93\x05\n\x0cSceneMapInfo\x12)\n\nchest_list\x18\x0b\x20\x03(\
    \x0b2\n.ChestInfoR\tchestList\x12.\n\x0bLMNGAHFNAON\x18\x02\x20\x03(\x0b\
    2\x0c.OFCAIGDHPOHR\x0bLMNGAHFNAON\x12.\n\x0bJMLDMOCNMHM\x18\x0f\x20\x03(\
    \x0b2\x0c.NPAOGKFKAAER\x0bJMLDMOCNMHM\x12\x19\n\x08entry_id\x18\t\x20\
    \x01(\rR\x07entryId\x12!\n\x0cdimension_id\x18\x06\x20\x01(\rR\x0bdimens\
    ionId\x12\x19\n\x08floor_id\x18\x0e\x20\x01(\rR\x07floorId\x12\x18\n\x07\
    retcode\x18\x07\x20\x01(\rR\x07retcode\x12'\n\x10cur_map_entry_id\x18\
    \x04\x20\x01(\rR\rcurMapEntryId\x124\n\x0emaze_prop_list\x18\x0c\x20\x03\
    (\x0b2\x0e.MazePropStateR\x0cmazePropList\x12K\n\x10floor_saved_data\x18\
    \x01\x20\x03(\x0b2!.SceneMapInfo.FloorSavedDataEntryR\x0efloorSavedData\
    \x120\n\x14unlock_teleport_list\x18\x03\x20\x03(\rR\x12unlockTeleportLis\
    t\x122\n\x0fmaze_group_list\x18\r\x20\x03(\x0b2\n.MazeGroupR\rmazeGroupL\
    ist\x120\n\x14lighten_section_list\x18\x05\x20\x03(\rR\x12lightenSection\
