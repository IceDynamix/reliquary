...
impl ::protobuf::Message for PropChessRogueInfo {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.enter_next_cell != false {
            os.write_bool(13, self.enter_next_cell)?;
        }
        if self.AKCGHBFGBCC != false {
            os.write_bool(4, self.AKCGHBFGBCC)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    r_next_cell\x18\r\x20\x01(\x08R\renterNextCell\x12\x20\n\x0bAKCGHBFGBCC\
    \x18\x04\x20\x01(\x08R\x0bAKCGHBFGBCCb\x06proto3\
";
