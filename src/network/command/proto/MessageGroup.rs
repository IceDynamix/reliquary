...
impl ::protobuf::Message for MessageGroup {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.refresh_time != 0 {
            my_size += ::protobuf::rt::int64_size(3, self.refresh_time);
        }
        if self.id != 0 {
        ...
        if self.message_section_id != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.message_section_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.refresh_time != 0 {
            os.write_int64(3, self.refresh_time)?;
        }
        if self.id != 0 {
        ...
        if self.message_section_id != 0 {
            os.write_uint32(4, self.message_section_id)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ection.proto\"\xdf\x01\n\x0cMessageGroup\x12!\n\x0crefresh_time\x18\x03\
    \x20\x01(\x03R\x0brefreshTime\x12\x0e\n\x02id\x18\x06\x20\x01(\rR\x02id\
    \x12A\n\x14message_section_list\x18\x02\x20\x03(\x0b2\x0f.MessageSection\
    R\x12messageSectionList\x12+\n\x06status\x18\r\x20\x01(\x0e2\x13.Message\
    GroupStatusR\x06status\x12,\n\x12message_section_id\x18\x04\x20\x01(\rR\
    \x10messageSectionIdb\x06proto3\
";
