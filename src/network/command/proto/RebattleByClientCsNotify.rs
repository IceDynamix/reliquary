...
impl ::protobuf::Message for RebattleByClientCsNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.rebattle_type != ::protobuf::EnumOrUnknown::new(super::RebattleType::RebattleType::REBATTLE_TYPE_NONE) {
            my_size += ::protobuf::rt::int32_size(10, self.rebattle_type.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.rebattle_type != ::protobuf::EnumOrUnknown::new(super::RebattleType::RebattleType::REBATTLE_TYPE_NONE) {
            os.write_enum(10, ::protobuf::EnumOrUnknown::value(&self.rebattle_type))?;
        }
        if let Some(v) = self.stt.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    _type\x18\n\x20\x01(\x0e2\r.RebattleTypeR\x0crebattleType\x12#\n\x03stt\
    \x18\r\x20\x01(\x0b2\x11.BattleStatisticsR\x03sttb\x06proto3\
";
