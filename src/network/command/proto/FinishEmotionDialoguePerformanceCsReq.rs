...
impl ::protobuf::Message for FinishEmotionDialoguePerformanceCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.BLKFCFGMMBD != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.BLKFCFGMMBD);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.BLKFCFGMMBD != 0 {
            os.write_uint32(3, self.BLKFCFGMMBD)?;
        }
        if self.dialogue_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    DialoguePerformanceCsReq\x12\x1b\n\tscript_id\x18\x02\x20\x01(\rR\x08scr\
    iptId\x12\x20\n\x0bBLKFCFGMMBD\x18\x03\x20\x01(\rR\x0bBLKFCFGMMBD\x12\
