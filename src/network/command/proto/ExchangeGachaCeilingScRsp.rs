...
pub struct ExchangeGachaCeilingScRsp {
    ...
    pub retcode: u32,
    // @@protoc_insertion_point(field:ExchangeGachaCeilingScRsp.MENLIBPOAJA)
    pub MENLIBPOAJA: ::protobuf::MessageField<super::INJNDJJFAKJ::INJNDJJFAKJ>,
    // @@protoc_insertion_point(field:ExchangeGachaCeilingScRsp.IDDDLEKCICN)
    pub IDDDLEKCICN: u32,
    // @@protoc_insertion_point(field:ExchangeGachaCeilingScRsp.PMJIDGLBDMC)
...
impl ExchangeGachaCeilingScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::INJNDJJFAKJ::INJNDJJFAKJ>(
            "MENLIBPOAJA",
            |m: &ExchangeGachaCeilingScRsp| { &m.MENLIBPOAJA },
            |m: &mut ExchangeGachaCeilingScRsp| { &mut m.MENLIBPOAJA },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "IDDDLEKCICN",
            |m: &ExchangeGachaCeilingScRsp| { &m.IDDDLEKCICN },
            |m: &mut ExchangeGachaCeilingScRsp| { &mut m.IDDDLEKCICN },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::ItemList::ItemList>(
            "PMJIDGLBDMC",
            |m: &ExchangeGachaCeilingScRsp| { &m.PMJIDGLBDMC },
            |m: &mut ExchangeGachaCeilingScRsp| { &mut m.PMJIDGLBDMC },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "avatar_id",
...
impl ::protobuf::Message for ExchangeGachaCeilingScRsp {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                88 => {
                    self.IDDDLEKCICN = is.read_uint32()?;
                },
                122 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.IDDDLEKCICN != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.IDDDLEKCICN);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.IDDDLEKCICN != 0 {
            os.write_uint32(11, self.IDDDLEKCICN)?;
        }
        if let Some(v) = self.PMJIDGLBDMC.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1fExchangeGachaCeilingScRsp.proto\x1a\x11INJNDJJFAKJ.proto\x1a\x0eIt\
    emList.proto\"\xd1\x01\n\x19ExchangeGachaCeilingScRsp\x12\x18\n\x07retco\
    de\x18\r\x20\x01(\rR\x07retcode\x12.\n\x0bMENLIBPOAJA\x18\x0c\x20\x01(\
    \x0b2\x0c.INJNDJJFAKJR\x0bMENLIBPOAJA\x12\x20\n\x0bIDDDLEKCICN\x18\x0b\
    \x20\x01(\rR\x0bIDDDLEKCICN\x12+\n\x0bPMJIDGLBDMC\x18\x0f\x20\x01(\x0b2\
    \t.ItemListR\x0bPMJIDGLBDMC\x12\x1b\n\tavatar_id\x18\x01\x20\x01(\rR\x08\
    avatarIdb\x06proto3\
";
