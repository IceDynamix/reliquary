...
pub struct RogueCommonDialogueOptionResultInfo {
    ...
    pub DCOECLCEDOB: ::std::option::Option<rogue_common_dialogue_option_result_info::DCOECLCEDOB>,
    // special fields
...
impl RogueCommonDialogueOptionResultInfo {
    ...
    pub fn battle_result_info(&self) -> &super::RogueCommonDialogueOptionBattleResultInfo::RogueCommonDialogueOptionBattleResultInfo {
        match self.DCOECLCEDOB {
            ::std::option::Option::Some(rogue_common_dialogue_option_result_info::DCOECLCEDOB::BattleResultInfo(ref v)) => v,
    ...
    pub fn has_battle_result_info(&self) -> bool {
        match self.DCOECLCEDOB {
            ::std::option::Option::Some(rogue_common_dialogue_option_result_info::DCOECLCEDOB::BattleResultInfo(..)) => true,
            _ => false,
        }
    }
    ...
    pub fn set_battle_result_info(&mut self, v: super::RogueCommonDialogueOptionBattleResultInfo::RogueCommonDialogueOptionBattleResultInfo) {
        self.DCOECLCEDOB = ::std::option::Option::Some(rogue_common_dialogue_option_result_info::DCOECLCEDOB::BattleResultInfo(v))
    }
    ...
    pub fn mut_battle_result_info(&mut self) -> &mut super::RogueCommonDialogueOptionBattleResultInfo::RogueCommonDialogueOptionBattleResultInfo {
        if let ::std::option::Option::Some(rogue_common_dialogue_option_result_info::DCOECLCEDOB::BattleResultInfo(_)) = self.DCOECLCEDOB {
        } else {
            self.DCOECLCEDOB = ::std::option::Option::Some(rogue_common_dialogue_option_result_info::DCOECLCEDOB::BattleResultInfo(super::RogueCommonDialogueOptionBattleResultInfo::RogueCommonDialogueOptionBattleResultInfo::new()));
        }
        match self.DCOECLCEDOB {
            ::std::option::Option::Some(rogue_common_dialogue_option_result_info::DCOECLCEDOB::BattleResultInfo(ref mut v)) => v,
            _ => panic!(),
        }
    }
    ...
    pub fn take_battle_result_info(&mut self) -> super::RogueCommonDialogueOptionBattleResultInfo::RogueCommonDialogueOptionBattleResultInfo {
        if self.has_battle_result_info() {
            match self.DCOECLCEDOB.take() {
                ::std::option::Option::Some(rogue_common_dialogue_option_result_info::DCOECLCEDOB::BattleResultInfo(v)) => v,
                _ => panic!(),
            }
        } else {
    ...
    pub fn HMLCEHIKFFK(&self) -> &super::NEBPGHDDEPC::NEBPGHDDEPC {
        match self.DCOECLCEDOB {
            ::std::option::Option::Some(rogue_common_dialogue_option_result_info::DCOECLCEDOB::HMLCEHIKFFK(ref v)) => v,
    ...
    pub fn has_HMLCEHIKFFK(&self) -> bool {
        match self.DCOECLCEDOB {
            ::std::option::Option::Some(rogue_common_dialogue_option_result_info::DCOECLCEDOB::HMLCEHIKFFK(..)) => true,
            _ => false,
        }
    }
    ...
    pub fn set_HMLCEHIKFFK(&mut self, v: super::NEBPGHDDEPC::NEBPGHDDEPC) {
        self.DCOECLCEDOB = ::std::option::Option::Some(rogue_common_dialogue_option_result_info::DCOECLCEDOB::HMLCEHIKFFK(v))
    }

    // Mutable pointer to the field.
    pub fn mut_HMLCEHIKFFK(&mut self) -> &mut super::NEBPGHDDEPC::NEBPGHDDEPC {
        if let ::std::option::Option::Some(rogue_common_dialogue_option_result_info::DCOECLCEDOB::HMLCEHIKFFK(_)) = self.DCOECLCEDOB {
        } else {
            self.DCOECLCEDOB = ::std::option::Option::Some(rogue_common_dialogue_option_result_info::DCOECLCEDOB::HMLCEHIKFFK(super::NEBPGHDDEPC::NEBPGHDDEPC::new()));
        }
        match self.DCOECLCEDOB {
            ::std::option::Option::Some(rogue_common_dialogue_option_result_info::DCOECLCEDOB::HMLCEHIKFFK(ref mut v)) => v,
            _ => panic!(),
        }
    }
    ...
    pub fn take_HMLCEHIKFFK(&mut self) -> super::NEBPGHDDEPC::NEBPGHDDEPC {
        if self.has_HMLCEHIKFFK() {
            match self.DCOECLCEDOB.take() {
                ::std::option::Option::Some(rogue_common_dialogue_option_result_info::DCOECLCEDOB::HMLCEHIKFFK(v)) => v,
                _ => panic!(),
            }
        } else {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_oneof_message_has_get_mut_set_accessor::<_, super::NEBPGHDDEPC::NEBPGHDDEPC>(
            "HMLCEHIKFFK",
            RogueCommonDialogueOptionResultInfo::has_HMLCEHIKFFK,
            RogueCommonDialogueOptionResultInfo::HMLCEHIKFFK,
            RogueCommonDialogueOptionResultInfo::mut_HMLCEHIKFFK,
            RogueCommonDialogueOptionResultInfo::set_HMLCEHIKFFK,
        ));
        oneofs.push(rogue_common_dialogue_option_result_info::DCOECLCEDOB::generated_oneof_descriptor_data());
...
pub mod rogue_common_dialogue_option_result_info {
    ...
    #[non_exhaustive]
    // @@protoc_insertion_point(oneof:RogueCommonDialogueOptionResultInfo.DCOECLCEDOB)
    pub enum DCOECLCEDOB {
        ...
        // @@protoc_insertion_point(oneof_field:RogueCommonDialogueOptionResultInfo.HMLCEHIKFFK)
    ...
    impl ::protobuf::OneofFull for DCOECLCEDOB {
        fn descriptor() -> ::protobuf::reflect::OneofDescriptor {
            ...
            descriptor.get(|| <super::RogueCommonDialogueOptionResultInfo as ::protobuf::MessageFull>::descriptor().oneof_by_name("DCOECLCEDOB").unwrap()).clone()
        }
    }
