...
//! Generated file from `OFGBMCKNLDJ.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:OFGBMCKNLDJ)
...
impl<'a> ::std::default::Default for &'a OFGBMCKNLDJ {
    fn default() -> &'a OFGBMCKNLDJ {
        <OFGBMCKNLDJ as ::protobuf::Message>::default_instance()
    }
}

impl OFGBMCKNLDJ {
    pub fn new() -> OFGBMCKNLDJ {
...
impl ::protobuf::Message for OFGBMCKNLDJ {
    const NAME: &'static str = "OFGBMCKNLDJ";
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.MFKNHHNFKGI != 0 {
            my_size += ::protobuf::rt::int64_size(10, self.MFKNHHNFKGI);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.MFKNHHNFKGI != 0 {
            os.write_int64(10, self.MFKNHHNFKGI)?;
        }
        if let Some(v) = self.JCFPLGHKJAA.as_ref() {
...
impl ::protobuf::MessageFull for OFGBMCKNLDJ {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("OFGBMCKNLDJ").unwrap()).clone()
    }
}

impl ::std::fmt::Display for OFGBMCKNLDJ {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for OFGBMCKNLDJ {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x11OFGBMCKNLDJ.proto\x1a\x11IIKNGNHDMFI.proto\"\xb1\x01\n\x0bOFGBMCKN\
    LDJ\x12\x20\n\x0bDGCFLHCPJLN\x18\x04\x20\x01(\rR\x0bDGCFLHCPJLN\x12\x20\
    \n\x0bMFKNHHNFKGI\x18\n\x20\x01(\x03R\x0bMFKNHHNFKGI\x12.\n\x0bJCFPLGHKJ\
    AA\x18\x0c\x20\x01(\x0b2\x0c.IIKNGNHDMFIR\x0bJCFPLGHKJAA\x12.\n\x0bBJODE\
    EPGOPC\x18\x03\x20\x01(\x0b2\x0c.IIKNGNHDMFIR\x0bBJODEEPGOPCb\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(OFGBMCKNLDJ::generated_message_descriptor_data());
