...
impl ::protobuf::Message for SetRedPointStatusScNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.CFKKNEHABHH != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.CFKKNEHABHH);
        }
        if self.uid != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.uid);
        }
        if self.BMFJFFBPADD != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.BMFJFFBPADD);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.CFKKNEHABHH != 0 {
            os.write_uint32(5, self.CFKKNEHABHH)?;
        }
        if self.uid != 0 {
            os.write_uint32(15, self.uid)?;
        }
        if self.BMFJFFBPADD != 0 {
            os.write_uint32(2, self.BMFJFFBPADD)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x19SetRedPointStatusScNotify\x12.\n\x0bBKAKIJOACPO\x18\x04\x20\x03(\
    \x0b2\x0c.LFCHHMGGMPCR\x0bBKAKIJOACPO\x12\x1d\n\ncontent_id\x18\x01\x20\
    \x01(\rR\tcontentId\x12\x20\n\x0bCFKKNEHABHH\x18\x05\x20\x01(\rR\x0bCFKK\
    NEHABHH\x12\x10\n\x03uid\x18\x0f\x20\x01(\rR\x03uid\x12\x20\n\x0bBMFJFFB\
    PADD\x18\x02\x20\x01(\rR\x0bBMFJFFBPADDb\x06proto3\
";
