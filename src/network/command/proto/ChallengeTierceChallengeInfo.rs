...
//! Generated file from `ChallengeTierceChallengeInfo.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:ChallengeTierceChallengeInfo)
...
pub struct ChallengeTierceChallengeInfo {
    ...
    // special fields
    // @@protoc_insertion_point(special_field:ChallengeTierceChallengeInfo.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a ChallengeTierceChallengeInfo {
    fn default() -> &'a ChallengeTierceChallengeInfo {
        <ChallengeTierceChallengeInfo as ::protobuf::Message>::default_instance()
    }
}

impl ChallengeTierceChallengeInfo {
    pub fn new() -> ChallengeTierceChallengeInfo {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "challenge_id",
            |m: &ChallengeTierceChallengeInfo| { &m.challenge_id },
            |m: &mut ChallengeTierceChallengeInfo| { &mut m.challenge_id },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<ChallengeTierceChallengeInfo>(
            "ChallengeTierceChallengeInfo",
            fields,
            oneofs,
        )
    }
...
impl ::protobuf::Message for ChallengeTierceChallengeInfo {
    const NAME: &'static str = "ChallengeTierceChallengeInfo";
    ...
    fn new() -> ChallengeTierceChallengeInfo {
        ChallengeTierceChallengeInfo::new()
    }
...
impl ::protobuf::MessageFull for ChallengeTierceChallengeInfo {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("ChallengeTierceChallengeInfo").unwrap()).clone()
    }
}

impl ::std::fmt::Display for ChallengeTierceChallengeInfo {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for ChallengeTierceChallengeInfo {
