...
//! Generated file from `BlackLimitLevel.proto`
...
impl ::protobuf::Enum for BlackLimitLevel {
    const NAME: &'static str = "BlackLimitLevel";
...
impl ::protobuf::EnumFull for BlackLimitLevel {
    fn enum_descriptor() -> ::protobuf::reflect::EnumDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::EnumDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().enum_by_package_relative_name("BlackLimitLevel").unwrap()).clone()
    }
...
impl BlackLimitLevel {
    fn generated_enum_descriptor_data() -> ::protobuf::reflect::GeneratedEnumDescriptorData {
        ::protobuf::reflect::GeneratedEnumDescriptorData::new::<BlackLimitLevel>("BlackLimitLevel")
    }
}
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            enums.push(BlackLimitLevel::generated_enum_descriptor_data());
