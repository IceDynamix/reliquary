...
impl ::protobuf::Message for StartCocoonStageScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.challenge_cnt != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.challenge_cnt);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.challenge_cnt != 0 {
            os.write_uint32(14, self.challenge_cnt)?;
        }
        if let Some(v) = self.battle_info.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x15StartCocoonStageScRsp\x12#\n\rchallenge_cnt\x18\x0e\x20\x01(\rR\
    \x0cchallengeCnt\x121\n\x0bbattle_info\x18\x05\x20\x01(\x0b2\x10.SceneBa\
    ttleInfoR\nbattleInfo\x12$\n\x0eprop_entity_id\x18\x01\x20\x01(\rR\x0cpr\
