...
pub struct FLCMJAHGKFK {
    ...
    pub NPPPHGFENPH: u32,
    // @@protoc_insertion_point(field:FLCMJAHGKFK.friend_name)
...
impl FLCMJAHGKFK {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "friend_name",
            |m: &FLCMJAHGKFK| { &m.friend_name },
            |m: &mut FLCMJAHGKFK| { &mut m.friend_name },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "head_icon",
...
impl ::protobuf::Message for FLCMJAHGKFK {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.friend_name.is_empty() {
            my_size += ::protobuf::rt::string_size(1, &self.friend_name);
        }
        if self.head_icon != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.friend_name.is_empty() {
            os.write_string(1, &self.friend_name)?;
        }
        if self.head_icon != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x05level\x18\x08\x20\x01(\rR\x05level\x12\x1a\n\x08nickname\x18\x0b\x20\
    \x01(\tR\x08nickname\x12\x20\n\x0bNPPPHGFENPH\x18\x0c\x20\x01(\rR\x0bNPP\
    PHGFENPH\x12\x1f\n\x0bfriend_name\x18\x01\x20\x01(\tR\nfriendName\x12\
    \x1b\n\thead_icon\x18\x02\x20\x01(\rR\x08headIcon\x12\x20\n\x0bINNANICLC\
    AE\x18\x03\x20\x01(\rR\x0bINNANICLCAE\x12\x10\n\x03uid\x18\x06\x20\x01(\
    \rR\x03uid\x122\n\rplatform_type\x18\x04\x20\x01(\x0e2\r.PlatformTypeR\
    \x0cplatformTypeb\x06proto3\
";
