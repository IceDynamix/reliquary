...
//! Generated file from `LHHGCDLCJDA.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:LHHGCDLCJDA)
...
pub struct LHHGCDLCJDA {
    ...
    // special fields
    // @@protoc_insertion_point(special_field:LHHGCDLCJDA.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a LHHGCDLCJDA {
    fn default() -> &'a LHHGCDLCJDA {
        <LHHGCDLCJDA as ::protobuf::Message>::default_instance()
    }
}

impl LHHGCDLCJDA {
    pub fn new() -> LHHGCDLCJDA {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<LHHGCDLCJDA>(
            "LHHGCDLCJDA",
            fields,
            oneofs,
        )
...
impl ::protobuf::Message for LHHGCDLCJDA {
    const NAME: &'static str = "LHHGCDLCJDA";
...
impl ::protobuf::MessageFull for LHHGCDLCJDA {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("LHHGCDLCJDA").unwrap()).clone()
    }
}

impl ::std::fmt::Display for LHHGCDLCJDA {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for LHHGCDLCJDA {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(LHHGCDLCJDA::generated_message_descriptor_data());
