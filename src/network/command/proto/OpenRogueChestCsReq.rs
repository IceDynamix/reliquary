...
impl ::protobuf::Message for OpenRogueChestCsReq {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.FDEKKOKBDIC != false {
            os.write_bool(1, self.FDEKKOKBDIC)?;
        }
        if self.interacted_prop_entity_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0bFDEKKOKBDIC\x18\x01\x20\x01(\x08R\x0bFDEKKOKBDIC\x129\n\x19interacte\
    d_prop_entity_id\x18\r\x20\x01(\rR\x16interactedPropEntityIdb\x06proto3\
";
