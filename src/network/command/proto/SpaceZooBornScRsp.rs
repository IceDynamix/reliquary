...
impl ::protobuf::Message for SpaceZooBornScRsp {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.IKLPNCGBPPC != false {
            os.write_bool(2, self.IKLPNCGBPPC)?;
        }
        if let Some(v) = self.KPKDHGHDGNB.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x20\x01(\rR\x07retcode\x12.\n\x0bGOEAOFNFJOD\x18\x0e\x20\x03(\x0b2\x0c.\
    IPJAIINEGELR\x0bGOEAOFNFJOD\x12\x20\n\x0bIKLPNCGBPPC\x18\x02\x20\x01(\
    \x08R\x0bIKLPNCGBPPC\x12.\n\x0bKPKDHGHDGNB\x18\n\x20\x01(\x0b2\x0c.FAFGM\
    LPADMIR\x0bKPKDHGHDGNBb\x06proto3\
";
