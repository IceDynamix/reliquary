...
impl ::protobuf::Message for SpaceZooBornScRsp {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.IKLPNCGBPPC != false {
            os.write_bool(3, self.IKLPNCGBPPC)?;
        }
        if let Some(v) = self.KPKDHGHDGNB.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x03\x20\x01(\x08R\x0bIKLPNCGBPPC\x12.\n\x0bKPKDHGHDGNB\x18\x01\x20\x01(\
    \x0b2\x0c.FAFGMLPADMIR\x0bKPKDHGHDGNB\x12.\n\x0bGOEAOFNFJOD\x18\t\x20\
