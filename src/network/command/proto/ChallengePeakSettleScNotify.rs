...
impl ::protobuf::Message for ChallengePeakSettleScNotify {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.is_first_pass != false {
            os.write_bool(2, self.is_first_pass)?;
        }
        if self.is_boss_target_better != false {
            os.write_bool(3, self.is_boss_target_better)?;
        }
        if self.cycles_used != 0 {
            os.write_uint32(6, self.cycles_used)?;
        }
        if self.is_unlock_easy_boss != false {
            os.write_bool(7, self.is_unlock_easy_boss)?;
        }
        if self.is_wait_confirm != false {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x01\x20\x01(\rR\x08turnLeft\x12\"\n\ris_first_pass\x18\x02\x20\x01(\x08\
    R\x0bisFirstPass\x121\n\x15is_boss_target_better\x18\x03\x20\x01(\x08R\
    \x12isBossTargetBetter\x12\x1f\n\x0bcycles_used\x18\x06\x20\x01(\rR\ncyc\
    lesUsed\x12-\n\x13is_unlock_easy_boss\x18\x07\x20\x01(\x08R\x10isUnlockE\
    asyBoss\x12&\n\x0fis_wait_confirm\x18\x08\x20\x01(\x08R\risWaitConfirm\
    \x12\x15\n\x06is_win\x18\t\x20\x01(\x08R\x05isWin\x12N\n\x16peak_reward_\
    group_list\x18\x0b\x20\x03(\x0b2\x19.ChallengePeakRewardGroupR\x13peakRe\
    wardGroupList\x120\n\x14finished_target_list\x18\x0c\x20\x03(\rR\x12fini\
    shedTargetList\x12\x17\n\x07peak_id\x18\r\x20\x01(\rR\x06peakId\x12/\n\
    \x14hard_mode_has_passed\x18\x0f\x20\x01(\x08R\x11hardModeHasPassedb\x06\
    proto3\
";
