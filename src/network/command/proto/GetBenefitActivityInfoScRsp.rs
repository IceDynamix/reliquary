...
pub struct GetBenefitActivityInfoScRsp {
    // message fields
    // @@protoc_insertion_point(field:GetBenefitActivityInfoScRsp.JJDNHCAELIL)
    pub JJDNHCAELIL: ::std::vec::Vec<super::BenefitData::BenefitData>,
    // @@protoc_insertion_point(field:GetBenefitActivityInfoScRsp.KNMDFLFCNFP)
    pub KNMDFLFCNFP: bool,
...
impl GetBenefitActivityInfoScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "JJDNHCAELIL",
            |m: &GetBenefitActivityInfoScRsp| { &m.JJDNHCAELIL },
            |m: &mut GetBenefitActivityInfoScRsp| { &mut m.JJDNHCAELIL },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "KNMDFLFCNFP",
            |m: &GetBenefitActivityInfoScRsp| { &m.KNMDFLFCNFP },
            |m: &mut GetBenefitActivityInfoScRsp| { &mut m.KNMDFLFCNFP },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "retcode",
...
impl ::protobuf::Message for GetBenefitActivityInfoScRsp {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                82 => {
                    self.JJDNHCAELIL.push(is.read_message()?);
                },
                32 => {
                    self.KNMDFLFCNFP = is.read_bool()?;
                },
                48 => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        for value in &self.JJDNHCAELIL {
            let len = value.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
        };
        if self.KNMDFLFCNFP != false {
            my_size += 1 + 1;
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        for v in &self.JJDNHCAELIL {
            ::protobuf::rt::write_message_field_with_cached_size(10, v, os)?;
        };
        if self.KNMDFLFCNFP != false {
            os.write_bool(4, self.KNMDFLFCNFP)?;
        }
        if self.retcode != 0 {
    ...
    fn clear(&mut self) {
        self.JJDNHCAELIL.clear();
        self.KNMDFLFCNFP = false;
        self.retcode = 0;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n!GetBenefitActivityInfoScRsp.proto\x1a\x11BenefitData.proto\"\x89\x01\
    \n\x1bGetBenefitActivityInfoScRsp\x12.\n\x0bJJDNHCAELIL\x18\n\x20\x03(\
    \x0b2\x0c.BenefitDataR\x0bJJDNHCAELIL\x12\x20\n\x0bKNMDFLFCNFP\x18\x04\
    \x20\x01(\x08R\x0bKNMDFLFCNFP\x12\x18\n\x07retcode\x18\x06\x20\x01(\rR\
