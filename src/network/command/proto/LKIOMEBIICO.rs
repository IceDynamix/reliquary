...
//! Generated file from `LKIOMEBIICO.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:LKIOMEBIICO)
...
impl<'a> ::std::default::Default for &'a LKIOMEBIICO {
    fn default() -> &'a LKIOMEBIICO {
        <LKIOMEBIICO as ::protobuf::Message>::default_instance()
    }
}

impl LKIOMEBIICO {
    pub fn new() -> LKIOMEBIICO {
...
impl ::protobuf::Message for LKIOMEBIICO {
    const NAME: &'static str = "LKIOMEBIICO";
...
impl ::protobuf::MessageFull for LKIOMEBIICO {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("LKIOMEBIICO").unwrap()).clone()
    }
}

impl ::std::fmt::Display for LKIOMEBIICO {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for LKIOMEBIICO {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::GOKOIADHFCN::file_descriptor().clone());
            let mut messages = ::std::vec::Vec::with_capacity(1);
            messages.push(LKIOMEBIICO::generated_message_descriptor_data());
