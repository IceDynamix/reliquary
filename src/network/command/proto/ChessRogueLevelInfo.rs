...
pub struct ChessRogueLevelInfo {
    ...
    // @@protoc_insertion_point(field:ChessRogueLevelInfo.HLPHKNKIPKB)
    pub HLPHKNKIPKB: u32,
    ...
    // @@protoc_insertion_point(field:ChessRogueLevelInfo.GJBJIAALKMF)
    pub GJBJIAALKMF: i32,
...
impl ChessRogueLevelInfo {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "HLPHKNKIPKB",
            |m: &ChessRogueLevelInfo| { &m.HLPHKNKIPKB },
            |m: &mut ChessRogueLevelInfo| { &mut m.HLPHKNKIPKB },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "id",
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "GJBJIAALKMF",
            |m: &ChessRogueLevelInfo| { &m.GJBJIAALKMF },
            |m: &mut ChessRogueLevelInfo| { &mut m.GJBJIAALKMF },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "action_point",
...
impl ::protobuf::Message for ChessRogueLevelInfo {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                16 => {
                    self.HLPHKNKIPKB = is.read_uint32()?;
                },
                32 => {
                ...
                64 => {
                    self.GJBJIAALKMF = is.read_int32()?;
                },
                80 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.level_status != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.level_status);
        }
        if self.HLPHKNKIPKB != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.HLPHKNKIPKB);
        }
        if self.id != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.id);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(6, &self.area_id_list);
        if self.GJBJIAALKMF != 0 {
            my_size += ::protobuf::rt::int32_size(8, self.GJBJIAALKMF);
        }
        if self.action_point != 0 {
            my_size += ::protobuf::rt::int32_size(10, self.action_point);
        }
        if self.layer_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.level_status != 0 {
            os.write_uint32(1, self.level_status)?;
        }
        if self.HLPHKNKIPKB != 0 {
            os.write_uint32(2, self.HLPHKNKIPKB)?;
        }
        if self.id != 0 {
            os.write_uint32(4, self.id)?;
        }
        os.write_repeated_packed_uint32(6, &self.area_id_list)?;
        if self.GJBJIAALKMF != 0 {
            os.write_int32(8, self.GJBJIAALKMF)?;
        }
        if self.action_point != 0 {
            os.write_int32(10, self.action_point)?;
        }
        if self.layer_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x02\n\x13ChessRogueLevelInfo\x12!\n\x0clevel_status\x18\x01\x20\x01(\rR\
    \x0blevelStatus\x12\x20\n\x0bHLPHKNKIPKB\x18\x02\x20\x01(\rR\x0bHLPHKNKI\
    PKB\x12\x0e\n\x02id\x18\x04\x20\x01(\rR\x02id\x12\x20\n\x0carea_id_list\
    \x18\x06\x20\x03(\rR\nareaIdList\x12\x20\n\x0bGJBJIAALKMF\x18\x08\x20\
    \x01(\x05R\x0bGJBJIAALKMF\x12!\n\x0caction_point\x18\n\x20\x01(\x05R\x0b\
    actionPoint\x12\x19\n\x08layer_id\x18\x0b\x20\x01(\rR\x07layerId\x120\n\
    \tarea_info\x18\x0f\x20\x01(\x0b2\x13.ChessRogueAreaInfoR\x08areaInfob\
    \x06proto3\
";
