...
//! Generated file from `MACHNDHAMNM.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:MACHNDHAMNM)
...
impl<'a> ::std::default::Default for &'a MACHNDHAMNM {
    fn default() -> &'a MACHNDHAMNM {
        <MACHNDHAMNM as ::protobuf::Message>::default_instance()
    }
}

impl MACHNDHAMNM {
    pub fn new() -> MACHNDHAMNM {
...
impl ::protobuf::Message for MACHNDHAMNM {
    const NAME: &'static str = "MACHNDHAMNM";
...
impl ::protobuf::MessageFull for MACHNDHAMNM {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("MACHNDHAMNM").unwrap()).clone()
    }
}

impl ::std::fmt::Display for MACHNDHAMNM {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for MACHNDHAMNM {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x11MACHNDHAMNM.proto\x1a\x11HDCKCHPDMMI.proto\"=\n\x0bMACHNDHAMNM\x12\
    .\n\x0bANCPCPCLJED\x18\x03\x20\x01(\x0b2\x0c.HDCKCHPDMMIR\x0bANCPCPCLJED\
    b\x06proto3\
";
