...
impl ::protobuf::Message for FightHeartBeatScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.server_time_ms != 0 {
            my_size += ::protobuf::rt::uint64_size(3, self.server_time_ms);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.server_time_ms != 0 {
            os.write_uint64(3, self.server_time_ms)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ient_time_ms\x18\t\x20\x01(\x04R\x0cclientTimeMs\x12$\n\x0eserver_time_m\
    s\x18\x03\x20\x01(\x04R\x0cserverTimeMs\x12\x18\n\x07retcode\x18\x07\x20\
