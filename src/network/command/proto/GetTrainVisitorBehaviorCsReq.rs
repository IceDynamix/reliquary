...
impl ::protobuf::Message for GetTrainVisitorBehaviorCsReq {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(4, &self.OIFNLNBKDMA);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(4, &self.OIFNLNBKDMA)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    Req\x12\x20\n\x0bOIFNLNBKDMA\x18\x04\x20\x03(\rR\x0bOIFNLNBKDMAb\x06prot\
    o3\
";
