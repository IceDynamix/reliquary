...
pub struct GetTrainVisitorBehaviorCsReq {
    // message fields
    // @@protoc_insertion_point(field:GetTrainVisitorBehaviorCsReq.MOLLACOIMDC)
    pub MOLLACOIMDC: ::std::vec::Vec<u32>,
    // special fields
...
impl GetTrainVisitorBehaviorCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "MOLLACOIMDC",
            |m: &GetTrainVisitorBehaviorCsReq| { &m.MOLLACOIMDC },
            |m: &mut GetTrainVisitorBehaviorCsReq| { &mut m.MOLLACOIMDC },
        ));
...
impl ::protobuf::Message for GetTrainVisitorBehaviorCsReq {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                26 => {
                    is.read_repeated_packed_uint32_into(&mut self.MOLLACOIMDC)?;
                },
                24 => {
                    self.MOLLACOIMDC.push(is.read_uint32()?);
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(3, &self.MOLLACOIMDC);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(3, &self.MOLLACOIMDC)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    Req\x12\x20\n\x0bMOLLACOIMDC\x18\x03\x20\x03(\rR\x0bMOLLACOIMDCb\x06prot\
    o3\
";
