...
impl ::protobuf::Message for JNIPIAADOIP {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.BCFBFMMENJK != 0 {
            my_size += ::protobuf::rt::int64_size(7, self.BCFBFMMENJK);
        }
        ...
        if self.BLMNEKFPAGH != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.BLMNEKFPAGH);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.BCFBFMMENJK != 0 {
            os.write_int64(7, self.BCFBFMMENJK)?;
        }
        if self.MLGFJGCHONH != 0 {
        ...
        if self.BLMNEKFPAGH != 0 {
            os.write_uint32(5, self.BLMNEKFPAGH)?;
        }
        if self.BIINNCNDPCG != false {
            os.write_bool(11, self.BIINNCNDPCG)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    NJK\x18\x07\x20\x01(\x03R\x0bBCFBFMMENJK\x12\x20\n\x0bMLGFJGCHONH\x18\
    \x06\x20\x01(\rR\x0bMLGFJGCHONH\x12\x20\n\x0bDKHIGCIPEKF\x18\n\x20\x01(\
    \x08R\x0bDKHIGCIPEKF\x12\x20\n\x0bHJNOIENGEDL\x18\x02\x20\x01(\rR\x0bHJN\
    OIENGEDL\x12\x20\n\x0bBLMNEKFPAGH\x18\x05\x20\x01(\rR\x0bBLMNEKFPAGH\x12\
    \x20\n\x0bBIINNCNDPCG\x18\x0b\x20\x01(\x08R\x0bBIINNCNDPCGb\x06proto3\
";
