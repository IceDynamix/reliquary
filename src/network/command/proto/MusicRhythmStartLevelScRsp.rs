...
impl ::protobuf::Message for MusicRhythmStartLevelScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.MDLNDGIJNML.is_empty() {
            my_size += ::protobuf::rt::string_size(2, &self.MDLNDGIJNML);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.MDLNDGIJNML.is_empty() {
            os.write_string(2, &self.MDLNDGIJNML)?;
        }
        if self.ACJCPHIFMLN != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    JNML\x18\x02\x20\x01(\tR\x0bMDLNDGIJNML\x12\x20\n\x0bACJCPHIFMLN\x18\x06\
