...
impl ::protobuf::Message for MuseumInfoChangedScNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.EJNKMKFFCCL != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.EJNKMKFFCCL);
        }
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(11, &self.KNDJAPNPAPK);
        if self.DBJHEMIPPIM != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.DBJHEMIPPIM);
        }
        if self.JBJLDPPDBBC != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.JBJLDPPDBBC);
        }
        if let Some(v) = self.JPIBMBBKGND.as_ref() {
            let len = v.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(5, &self.KNDMDPEFADC);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.EJNKMKFFCCL != 0 {
            os.write_uint32(12, self.EJNKMKFFCCL)?;
        }
        if self.EJKGHBEMOOB != 0 {
        ...
        os.write_repeated_packed_uint32(11, &self.KNDJAPNPAPK)?;
        if self.DBJHEMIPPIM != 0 {
            os.write_uint32(4, self.DBJHEMIPPIM)?;
        }
        if self.JBJLDPPDBBC != 0 {
            os.write_uint32(13, self.JBJLDPPDBBC)?;
        }
        if let Some(v) = self.JPIBMBBKGND.as_ref() {
            ::protobuf::rt::write_message_field_with_cached_size(7, v, os)?;
        }
        os.write_repeated_packed_uint32(5, &self.KNDMDPEFADC)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x03\n\x19MuseumInfoChangedScNotify\x12\x20\n\x0bHPNMPDOCJMA\x18\x02\x20\
    \x01(\rR\x0bHPNMPDOCJMA\x12\x20\n\x0bEJNKMKFFCCL\x18\x0c\x20\x01(\rR\x0b\
    EJNKMKFFCCL\x12\x20\n\x0bEJKGHBEMOOB\x18\n\x20\x01(\rR\x0bEJKGHBEMOOB\
    \x12\x14\n\x05level\x18\x0e\x20\x01(\rR\x05level\x12\x20\n\x0bKNDJAPNPAP\
    K\x18\x0b\x20\x03(\rR\x0bKNDJAPNPAPK\x12\x20\n\x0bDBJHEMIPPIM\x18\x04\
    \x20\x01(\rR\x0bDBJHEMIPPIM\x12\x20\n\x0bJBJLDPPDBBC\x18\r\x20\x01(\rR\
    \x0bJBJLDPPDBBC\x12.\n\x0bJPIBMBBKGND\x18\x07\x20\x01(\x0b2\x0c.DOLGFNLH\
    EAER\x0bJPIBMBBKGND\x12\x20\n\x0bKNDMDPEFADC\x18\x05\x20\x03(\rR\x0bKNDM\
    DPEFADC\x12.\n\x0bBOJMNAFDJKH\x18\x0f\x20\x03(\x0b2\x0c.OLKMLFEEFCJR\x0b\
    BOJMNAFDJKH\x12.\n\x0bEKKOLCCCNNK\x18\x03\x20\x01(\x0b2\x0c.JNBCPNCNOHOR\
    \x0bEKKOLCCCNNK\x12.\n\x0bLLEPHOELGDA\x18\x08\x20\x03(\x0b2\x0c.JMEAOCPF\
    EOLR\x0bLLEPHOELGDA\x12\x10\n\x03exp\x18\x01\x20\x01(\rR\x03expb\x06prot\
    o3\
";
