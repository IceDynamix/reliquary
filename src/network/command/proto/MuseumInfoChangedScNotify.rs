...
impl ::protobuf::Message for MuseumInfoChangedScNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.DBJHEMIPPIM != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.DBJHEMIPPIM);
        }
        if self.level != 0 {
        ...
        if self.HPNMPDOCJMA != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.HPNMPDOCJMA);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.DBJHEMIPPIM != 0 {
            os.write_uint32(14, self.DBJHEMIPPIM)?;
        }
        if self.level != 0 {
        ...
        if self.HPNMPDOCJMA != 0 {
            os.write_uint32(7, self.HPNMPDOCJMA)?;
        }
        if self.EJNKMKFFCCL != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x03exp\x12.\n\x0bEKKOLCCCNNK\x18\x04\x20\x01(\x0b2\x0c.JNBCPNCNOHOR\x0b\
    EKKOLCCCNNK\x12\x20\n\x0bDBJHEMIPPIM\x18\x0e\x20\x01(\rR\x0bDBJHEMIPPIM\
    \x12\x14\n\x05level\x18\x01\x20\x01(\rR\x05level\x12\x20\n\x0bKNDJAPNPAP\
    K\x18\t\x20\x03(\rR\x0bKNDJAPNPAPK\x12\x20\n\x0bHPNMPDOCJMA\x18\x07\x20\
    \x01(\rR\x0bHPNMPDOCJMA\x12\x20\n\x0bEJNKMKFFCCL\x18\x03\x20\x01(\rR\x0b\
    EJNKMKFFCCL\x12.\n\x0bLLEPHOELGDA\x18\x0b\x20\x03(\x0b2\x0c.JMEAOCPFEOLR\
    \x0bLLEPHOELGDA\x12\x20\n\x0bJBJLDPPDBBC\x18\x06\x20\x01(\rR\x0bJBJLDPPD\
    BBC\x12.\n\x0bBOJMNAFDJKH\x18\x05\x20\x03(\x0b2\x0c.OLKMLFEEFCJR\x0bBOJM\
    NAFDJKH\x12\x20\n\x0bEJKGHBEMOOB\x18\x08\x20\x01(\rR\x0bEJKGHBEMOOB\x12.\
    \n\x0bJPIBMBBKGND\x18\n\x20\x01(\x0b2\x0c.DOLGFNLHEAER\x0bJPIBMBBKGND\
    \x12\x20\n\x0bKNDMDPEFADC\x18\r\x20\x03(\rR\x0bKNDMDPEFADCb\x06proto3\
";
