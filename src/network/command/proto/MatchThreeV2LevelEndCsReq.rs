...
impl ::protobuf::Message for MatchThreeV2LevelEndCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.DKBJHPIJCAE != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.DKBJHPIJCAE);
        }
        ...
        if self.JKFPENGNJPI != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.JKFPENGNJPI);
        }
        if self.EHMPEMEONGE != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.EHMPEMEONGE);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(5, &self.BBGKAKHGOIO);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.DKBJHPIJCAE != 0 {
            os.write_uint32(9, self.DKBJHPIJCAE)?;
        }
        for v in &self.HLDNMIBKLKJ {
            ::protobuf::rt::write_message_field_with_cached_size(10, v, os)?;
        };
        if self.JKFPENGNJPI != 0 {
            os.write_uint32(14, self.JKFPENGNJPI)?;
        }
        if self.EHMPEMEONGE != 0 {
            os.write_uint32(13, self.EHMPEMEONGE)?;
        }
        os.write_repeated_packed_uint32(5, &self.BBGKAKHGOIO)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x19MatchThreeV2LevelEndCsReq\x12\x12\n\x04uuid\x18\x0c\x20\x01(\tR\
    \x04uuid\x12\x19\n\x08level_id\x18\x03\x20\x01(\rR\x07levelId\x12\x20\n\
    \x0bBKMPFEOCFIB\x18\x01\x20\x01(\rR\x0bBKMPFEOCFIB\x12\x20\n\x0bDKBJHPIJ\
    CAE\x18\t\x20\x01(\rR\x0bDKBJHPIJCAE\x12.\n\x0bHLDNMIBKLKJ\x18\n\x20\x03\
    (\x0b2\x0c.KHOCCHABNMNR\x0bHLDNMIBKLKJ\x12\x20\n\x0bJKFPENGNJPI\x18\x0e\
    \x20\x01(\rR\x0bJKFPENGNJPI\x12\x20\n\x0bEHMPEMEONGE\x18\r\x20\x01(\rR\
    \x0bEHMPEMEONGE\x12\x20\n\x0bBBGKAKHGOIO\x18\x05\x20\x03(\rR\x0bBBGKAKHG\
    OIOb\x06proto3\
";
