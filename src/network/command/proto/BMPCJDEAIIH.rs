...
impl ::protobuf::Message for BMPCJDEAIIH {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.OFIKKOGKLGO != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.OFIKKOGKLGO);
        }
        ...
        if self.FCLOLOBFPAL != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.FCLOLOBFPAL);
        }
        if self.max_times != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.OFIKKOGKLGO != 0 {
            os.write_uint32(9, self.OFIKKOGKLGO)?;
        }
        ...
        if self.FCLOLOBFPAL != 0 {
            os.write_uint32(15, self.FCLOLOBFPAL)?;
        }
        if self.max_times != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    LGO\x18\t\x20\x01(\rR\x0bOFIKKOGKLGO\x12\x20\n\x0bBIJGJECJMHM\x18\x07\
    \x20\x03(\rR\x0bBIJGJECJMHM\x12\x1b\n\tavatar_id\x18\x04\x20\x01(\rR\x08\
    avatarId\x12\x20\n\x0bFCLOLOBFPAL\x18\x0f\x20\x01(\rR\x0bFCLOLOBFPAL\x12\
