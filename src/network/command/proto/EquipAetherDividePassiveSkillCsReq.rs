...
pub struct EquipAetherDividePassiveSkillCsReq {
    // message fields
    // @@protoc_insertion_point(field:EquipAetherDividePassiveSkillCsReq.APGDJGPGGMO)
    pub APGDJGPGGMO: u32,
...
impl EquipAetherDividePassiveSkillCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "APGDJGPGGMO",
            |m: &EquipAetherDividePassiveSkillCsReq| { &m.APGDJGPGGMO },
            |m: &mut EquipAetherDividePassiveSkillCsReq| { &mut m.APGDJGPGGMO },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "slot",
...
impl ::protobuf::Message for EquipAetherDividePassiveSkillCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.APGDJGPGGMO != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.APGDJGPGGMO);
        }
        if self.slot != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.APGDJGPGGMO != 0 {
            os.write_uint32(6, self.APGDJGPGGMO)?;
        }
        if self.slot != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    veSkillCsReq\x12\x20\n\x0bAPGDJGPGGMO\x18\x06\x20\x01(\rR\x0bAPGDJGPGGMO\
    \x12\x12\n\x04slot\x18\r\x20\x01(\rR\x04slot\x12\x17\n\x07item_id\x18\
