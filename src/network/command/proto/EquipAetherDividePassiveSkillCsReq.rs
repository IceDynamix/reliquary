...
impl ::protobuf::Message for EquipAetherDividePassiveSkillCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.OFFGCGDNDIL != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.OFFGCGDNDIL);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.OFFGCGDNDIL != 0 {
            os.write_uint32(3, self.OFFGCGDNDIL)?;
        }
        if self.CGGDOGDIDNK != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    dePassiveSkillCsReq\x12\x20\n\x0bOFFGCGDNDIL\x18\x03\x20\x01(\rR\x0bOFFG\
    CGDNDIL\x12\x20\n\x0bCGGDOGDIDNK\x18\n\x20\x01(\rR\x0bCGGDOGDIDNK\x12\
    \x20\n\x0bFILDLBJOMLD\x18\x0e\x20\x01(\rR\x0bFILDLBJOMLDb\x06proto3\
";
