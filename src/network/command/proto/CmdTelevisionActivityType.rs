...
impl ::protobuf::Enum for CmdTelevisionActivityType {
    ...
    fn from_i32(value: i32) -> ::std::option::Option<CmdTelevisionActivityType> {
        match value {
            ...
            6976 => ::std::option::Option::Some(CmdTelevisionActivityType::CmdEnterTelevisionActivityStageCsReq),
            6967 => ::std::option::Option::Some(CmdTelevisionActivityType::CmdEnterTelevisionActivityStageScRsp),
            6971 => ::std::option::Option::Some(CmdTelevisionActivityType::CmdTelevisionActivityBattleEndScNotify),
            6969 => ::std::option::Option::Some(CmdTelevisionActivityType::CmdGetTelevisionActivityDataScRsp),
            6970 => ::std::option::Option::Some(CmdTelevisionActivityType::CmdTelevisionActivityDataChangeScNotify),
            6978 => ::std::option::Option::Some(CmdTelevisionActivityType::CmdGetTelevisionActivityDataCsReq),
...
impl ::protobuf::EnumFull for CmdTelevisionActivityType {
    ...
    fn descriptor(&self) -> ::protobuf::reflect::EnumValueDescriptor {
        let index = match self {
            ...
            CmdTelevisionActivityType::CmdEnterTelevisionActivityStageCsReq => 1,
            CmdTelevisionActivityType::CmdEnterTelevisionActivityStageScRsp => 2,
            CmdTelevisionActivityType::CmdTelevisionActivityBattleEndScNotify => 3,
            CmdTelevisionActivityType::CmdGetTelevisionActivityDataScRsp => 4,
            CmdTelevisionActivityType::CmdTelevisionActivityDataChangeScNotify => 5,
            CmdTelevisionActivityType::CmdGetTelevisionActivityDataCsReq => 6,
        };
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    isionActivityStageCsReq\x10\xc06\x12)\n$CmdEnterTelevisionActivityStageS\
    cRsp\x10\xb76\x12+\n&CmdTelevisionActivityBattleEndScNotify\x10\xbb6\x12\
    &\n!CmdGetTelevisionActivityDataScRsp\x10\xb96\x12,\n'CmdTelevisionActiv\
    ityDataChangeScNotify\x10\xba6\x12&\n!CmdGetTelevisionActivityDataCsReq\
    \x10\xc26b\x06proto3\
";
