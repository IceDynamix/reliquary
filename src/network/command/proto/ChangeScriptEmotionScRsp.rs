...
impl ::protobuf::Message for ChangeScriptEmotionScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.emotion_type != ::protobuf::EnumOrUnknown::new(super::HeartDialEmotionType::HeartDialEmotionType::HEART_DIAL_EMOTION_TYPE_PEACE) {
            my_size += ::protobuf::rt::int32_size(3, self.emotion_type.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.emotion_type != ::protobuf::EnumOrUnknown::new(super::HeartDialEmotionType::HeartDialEmotionType::HEART_DIAL_EMOTION_TYPE_PEACE) {
            os.write_enum(3, ::protobuf::EnumOrUnknown::value(&self.emotion_type))?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x128\n\x0cemotion_type\x18\x03\x20\x01(\x0e2\x15.HeartDialEmotionTypeR\
