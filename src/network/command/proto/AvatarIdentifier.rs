...
//! Generated file from `AvatarIdentifier.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:AvatarIdentifier)
...
pub struct AvatarIdentifier {
    ...
    pub id: u32,
    // special fields
    // @@protoc_insertion_point(special_field:AvatarIdentifier.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a AvatarIdentifier {
    fn default() -> &'a AvatarIdentifier {
        <AvatarIdentifier as ::protobuf::Message>::default_instance()
    }
}

impl AvatarIdentifier {
    pub fn new() -> AvatarIdentifier {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "id",
            |m: &AvatarIdentifier| { &m.id },
            |m: &mut AvatarIdentifier| { &mut m.id },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<AvatarIdentifier>(
            "AvatarIdentifier",
            fields,
            oneofs,
        )
...
impl ::protobuf::Message for AvatarIdentifier {
    const NAME: &'static str = "AvatarIdentifier";
    ...
    fn new() -> AvatarIdentifier {
        AvatarIdentifier::new()
    }
...
impl ::protobuf::MessageFull for AvatarIdentifier {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("AvatarIdentifier").unwrap()).clone()
    }
}

impl ::std::fmt::Display for AvatarIdentifier {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for AvatarIdentifier {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(AvatarIdentifier::generated_message_descriptor_data());
