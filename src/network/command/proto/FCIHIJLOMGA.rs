...
impl ::protobuf::Message for FCIHIJLOMGA {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.HNPEAPPMGAA != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.HNPEAPPMGAA);
        }
        if self.NAALCBMBPGC != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.NAALCBMBPGC);
        }
        if self.LLFOFPNDAFG != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.LLFOFPNDAFG);
        }
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(13, &self.HLIBIJFHHPG);
        if self.challenge_id != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.challenge_id);
        }
        if self.HJMGLEMJHKG != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.HJMGLEMJHKG);
        }
        if self.CPGOIPICPJF != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.CPGOIPICPJF);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.HNPEAPPMGAA != 0 {
            os.write_uint32(2, self.HNPEAPPMGAA)?;
        }
        if self.NAALCBMBPGC != 0 {
            os.write_uint32(14, self.NAALCBMBPGC)?;
        }
        if self.LLFOFPNDAFG != 0 {
            os.write_uint32(9, self.LLFOFPNDAFG)?;
        }
        ...
        if self.APLKNJEGBKF != false {
            os.write_bool(7, self.APLKNJEGBKF)?;
        }
        os.write_repeated_packed_uint32(13, &self.HLIBIJFHHPG)?;
        if self.challenge_id != 0 {
            os.write_uint32(6, self.challenge_id)?;
        }
        if self.HJMGLEMJHKG != 0 {
            os.write_uint32(3, self.HJMGLEMJHKG)?;
        }
        if self.CPGOIPICPJF != 0 {
            os.write_uint32(5, self.CPGOIPICPJF)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    MGA\x12\x20\n\x0bHNPEAPPMGAA\x18\x02\x20\x01(\rR\x0bHNPEAPPMGAA\x12\x20\
    \n\x0bNAALCBMBPGC\x18\x0e\x20\x01(\rR\x0bNAALCBMBPGC\x12\x20\n\x0bLLFOFP\
    NDAFG\x18\t\x20\x01(\rR\x0bLLFOFPNDAFG\x12\x1f\n\x0bavatar_list\x18\x0c\
    \x20\x03(\rR\navatarList\x12.\n\x0bMDLACHDKMPH\x18\x04\x20\x03(\x0b2\x0c\
    .IJKJJDHLKLBR\x0bMDLACHDKMPH\x12\x20\n\x0bAPLKNJEGBKF\x18\x07\x20\x01(\
    \x08R\x0bAPLKNJEGBKF\x12\x20\n\x0bHLIBIJFHHPG\x18\r\x20\x03(\rR\x0bHLIBI\
    JFHHPG\x12!\n\x0cchallenge_id\x18\x06\x20\x01(\rR\x0bchallengeId\x12\x20\
    \n\x0bHJMGLEMJHKG\x18\x03\x20\x01(\rR\x0bHJMGLEMJHKG\x12\x20\n\x0bCPGOIP\
    ICPJF\x18\x05\x20\x01(\rR\x0bCPGOIPICPJFb\x06proto3\
";
