...
impl ::protobuf::Message for FCIHIJLOMGA {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.HJMGLEMJHKG != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.HJMGLEMJHKG);
        }
        if self.HNPEAPPMGAA != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.HNPEAPPMGAA);
        }
        ...
        if self.LLFOFPNDAFG != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.LLFOFPNDAFG);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(9, &self.HLIBIJFHHPG);
        if self.NAALCBMBPGC != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.NAALCBMBPGC);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.HJMGLEMJHKG != 0 {
            os.write_uint32(13, self.HJMGLEMJHKG)?;
        }
        if self.HNPEAPPMGAA != 0 {
            os.write_uint32(3, self.HNPEAPPMGAA)?;
        }
        ...
        if self.LLFOFPNDAFG != 0 {
            os.write_uint32(8, self.LLFOFPNDAFG)?;
        }
        os.write_repeated_packed_uint32(9, &self.HLIBIJFHHPG)?;
        if self.NAALCBMBPGC != 0 {
            os.write_uint32(2, self.NAALCBMBPGC)?;
        }
        if self.challenge_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    MGA\x12\x20\n\x0bHJMGLEMJHKG\x18\r\x20\x01(\rR\x0bHJMGLEMJHKG\x12\x20\n\
    \x0bHNPEAPPMGAA\x18\x03\x20\x01(\rR\x0bHNPEAPPMGAA\x12.\n\x0bMDLACHDKMPH\
    \x18\x06\x20\x03(\x0b2\x0c.IJKJJDHLKLBR\x0bMDLACHDKMPH\x12\x20\n\x0bCPGO\
    IPICPJF\x18\x0e\x20\x01(\rR\x0bCPGOIPICPJF\x12\x20\n\x0bLLFOFPNDAFG\x18\
    \x08\x20\x01(\rR\x0bLLFOFPNDAFG\x12\x20\n\x0bHLIBIJFHHPG\x18\t\x20\x03(\
    \rR\x0bHLIBIJFHHPG\x12\x20\n\x0bNAALCBMBPGC\x18\x02\x20\x01(\rR\x0bNAALC\
    BMBPGC\x12!\n\x0cchallenge_id\x18\x0f\x20\x01(\rR\x0bchallengeId\x12\x1f\
    \n\x0bavatar_list\x18\x05\x20\x03(\rR\navatarList\x12\x20\n\x0bAPLKNJEGB\
    KF\x18\x01\x20\x01(\x08R\x0bAPLKNJEGBKFb\x06proto3\
";
