...
impl ::protobuf::Message for QueryProductInfoScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.ODNFIAAHKCI != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.ODNFIAAHKCI);
        }
        ...
        if self.CMGHDMPEAKO != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.CMGHDMPEAKO);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.ODNFIAAHKCI != 0 {
            os.write_uint32(12, self.ODNFIAAHKCI)?;
        }
        ...
        if self.CMGHDMPEAKO != 0 {
            os.write_uint32(6, self.CMGHDMPEAKO)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    yProductInfoScRsp\x126\n\x18month_card_out_date_time\x18\x01\x20\x01(\
    \x04R\x14monthCardOutDateTime\x12\x20\n\x0bODNFIAAHKCI\x18\x0c\x20\x01(\
    \rR\x0bODNFIAAHKCI\x12+\n\x0cproduct_list\x18\x0f\x20\x03(\x0b2\x08.Prod\
    uctR\x0bproductList\x12\x18\n\x07retcode\x18\x0b\x20\x01(\rR\x07retcode\
    \x12\x20\n\x0bCMGHDMPEAKO\x18\x06\x20\x01(\rR\x0bCMGHDMPEAKOb\x06proto3\
";
