...
impl ::protobuf::Message for GetPlayerBoardDataScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(2, &self.assist_avatar_id_list);
        if self.OLDMJONBJOM != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.OLDMJONBJOM);
        }
        if self.retcode != 0 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(4, &self.KKNJHENMGPK);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_uint32(2, &self.assist_avatar_id_list)?;
        if self.OLDMJONBJOM != 0 {
            os.write_uint32(3, self.OLDMJONBJOM)?;
        }
        if self.retcode != 0 {
        ...
        os.write_repeated_packed_uint32(4, &self.KKNJHENMGPK)?;
        if let Some(v) = self.display_avatar_vec.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12HeadIconData.proto\"\x80\x03\n\x17GetPlayerBoardDataScRsp\x12D\n\x17\
    unlocked_head_icon_list\x18\x05\x20\x03(\x0b2\r.HeadIconDataR\x14unlocke\
    dHeadIconList\x121\n\x15assist_avatar_id_list\x18\x02\x20\x03(\rR\x12ass\
    istAvatarIdList\x12\x20\n\x0bOLDMJONBJOM\x18\x03\x20\x01(\rR\x0bOLDMJONB\
    JOM\x12\x18\n\x07retcode\x18\x0b\x20\x01(\rR\x07retcode\x12\x1c\n\tsigna\
    ture\x18\x0c\x20\x01(\tR\tsignature\x12/\n\x14current_head_icon_id\x18\t\
    \x20\x01(\rR\x11currentHeadIconId\x12\x20\n\x0bKKNJHENMGPK\x18\x04\x20\
    \x03(\rR\x0bKKNJHENMGPK\x12?\n\x12display_avatar_vec\x18\x0f\x20\x01(\
    \x0b2\x11.DisplayAvatarVecR\x10displayAvatarVecb\x06proto3\
";
