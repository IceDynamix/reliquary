...
impl ::protobuf::Message for GetPlayerBoardDataScRsp {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(8, &self.assist_avatar_id_list);
        if self.retcode != 0 {
        ...
        if self.current_head_icon_id != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.current_head_icon_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(8, &self.assist_avatar_id_list)?;
        if self.retcode != 0 {
        ...
        if self.current_head_icon_id != 0 {
            os.write_uint32(5, self.current_head_icon_id)?;
        }
        if let Some(v) = self.display_avatar_vec.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    erBoardDataScRsp\x121\n\x15assist_avatar_id_list\x18\x08\x20\x03(\rR\x12\
    assistAvatarIdList\x12\x18\n\x07retcode\x18\n\x20\x01(\rR\x07retcode\x12\
    D\n\x17unlocked_head_icon_list\x18\x0c\x20\x03(\x0b2\r.HeadIconDataR\x14\
    unlockedHeadIconList\x12\x1c\n\tsignature\x18\t\x20\x01(\tR\tsignature\
    \x12/\n\x14current_head_icon_id\x18\x05\x20\x01(\rR\x11currentHeadIconId\
    \x12?\n\x12display_avatar_vec\x18\x0f\x20\x01(\x0b2\x11.DisplayAvatarVec\
    R\x10displayAvatarVec\x126\n\x0fhead_frame_info\x18\x0e\x20\x01(\x0b2\
    \x0e.HeadFrameInfoR\rheadFrameInfo\x127\n\x18current_personal_card_id\
    \x18\r\x20\x01(\rR\x15currentPersonalCardId\x12=\n\x1bunlocked_personal_\
    card_list\x18\x06\x20\x03(\rR\x18unlockedPersonalCardListb\x06proto3\
";
