...
impl ::protobuf::Message for GetPlayerBoardDataScRsp {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(10, &self.unlocked_personal_card_list);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(10, &self.unlocked_personal_card_list)?;
        if !self.signature.is_empty() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    erBoardDataScRsp\x12=\n\x1bunlocked_personal_card_list\x18\n\x20\x03(\rR\
    \x18unlockedPersonalCardList\x12\x1c\n\tsignature\x18\x0c\x20\x01(\tR\ts\
    ignature\x121\n\x15assist_avatar_id_list\x18\x08\x20\x03(\rR\x12assistAv\
    atarIdList\x12D\n\x17unlocked_head_icon_list\x18\x04\x20\x03(\x0b2\r.Hea\
    dIconDataR\x14unlockedHeadIconList\x126\n\x0fhead_frame_info\x18\x05\x20\
    \x01(\x0b2\x0e.HeadFrameInfoR\rheadFrameInfo\x12?\n\x12display_avatar_ve\
    c\x18\x02\x20\x01(\x0b2\x11.DisplayAvatarVecR\x10displayAvatarVec\x12/\n\
    \x14current_head_icon_id\x18\r\x20\x01(\rR\x11currentHeadIconId\x127\n\
    \x18current_personal_card_id\x18\x07\x20\x01(\rR\x15currentPersonalCardI\
