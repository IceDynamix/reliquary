...
impl ::protobuf::Message for SecretKeyInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.secret_key.is_empty() {
            my_size += ::protobuf::rt::string_size(13, &self.secret_key);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.secret_key.is_empty() {
            os.write_string(13, &self.secret_key)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12\"\n\x04type\x18\x03\x20\x01(\x0e2\x0e.SecretKeyTypeR\x04type\x12\
    \x1d\n\nsecret_key\x18\r\x20\x01(\tR\tsecretKeyb\x06proto3\
";
