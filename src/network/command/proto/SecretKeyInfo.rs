...
impl ::protobuf::Message for SecretKeyInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.secret_key.is_empty() {
            my_size += ::protobuf::rt::string_size(2, &self.secret_key);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if !self.secret_key.is_empty() {
            os.write_string(2, &self.secret_key)?;
        }
        if self.type_ != ::protobuf::EnumOrUnknown::new(super::SecretKeyType::SecretKeyType::SECRET_KEY_NONE) {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12\x1d\n\nsecret_key\x18\x02\x20\x01(\tR\tsecretKey\x12\"\n\x04type\
    \x18\x05\x20\x01(\x0e2\x0e.SecretKeyTypeR\x04typeb\x06proto3\
";
