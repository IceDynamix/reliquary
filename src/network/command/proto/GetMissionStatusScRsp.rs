...
impl ::protobuf::Message for GetMissionStatusScRsp {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(8, &self.unfinished_main_mission_id_list);
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(15, &self.disabled_main_mission_id_list);
        my_size += ::protobuf::rt::vec_packed_uint32_size(13, &self.curversion_finished_main_mission_id_list);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(8, &self.unfinished_main_mission_id_list)?;
        ...
        os.write_repeated_packed_uint32(15, &self.disabled_main_mission_id_list)?;
        os.write_repeated_packed_uint32(13, &self.curversion_finished_main_mission_id_list)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ished_main_mission_id_list\x18\x08\x20\x03(\rR\x1bunfinishedMainMissionI\
    dList\x12?\n\x17sub_mission_status_list\x18\x06\x20\x03(\x0b2\x08.Missio\
    nR\x14subMissionStatusList\x12@\n\x1dfinished_main_mission_id_list\x18\
    \x04\x20\x03(\rR\x19finishedMainMissionIdList\x12J\n\x15main_mission_mcv\
    _list\x18\x02\x20\x03(\x0b2\x17.MainMissionCustomValueR\x12mainMissionMc\
    vList\x12\x18\n\x07retcode\x18\x0c\x20\x01(\rR\x07retcode\x12@\n\x1ddisa\
    bled_main_mission_id_list\x18\x0f\x20\x03(\rR\x19disabledMainMissionIdLi\
    st\x12U\n(curversion_finished_main_mission_id_list\x18\r\x20\x03(\rR#cur\
    versionFinishedMainMissionIdListb\x06proto3\
";
