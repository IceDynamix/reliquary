...
impl ::protobuf::Message for GetMissionStatusScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(5, &self.curversion_finished_main_mission_id_list);
        for value in &self.sub_mission_status_list {
            let len = value.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
        };
        my_size += ::protobuf::rt::vec_packed_uint32_size(8, &self.finished_main_mission_id_list);
        if self.retcode != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.retcode);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(3, &self.disabled_main_mission_id_list);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_uint32(5, &self.curversion_finished_main_mission_id_list)?;
        for v in &self.sub_mission_status_list {
            ::protobuf::rt::write_message_field_with_cached_size(1, v, os)?;
        };
        os.write_repeated_packed_uint32(8, &self.finished_main_mission_id_list)?;
        if self.retcode != 0 {
            os.write_uint32(9, self.retcode)?;
        }
        os.write_repeated_packed_uint32(3, &self.disabled_main_mission_id_list)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x1a\rMission.proto\"\xdf\x03\n\x15GetMissionStatusScRsp\x12J\n\x15main_\
    mission_mcv_list\x18\x0e\x20\x03(\x0b2\x17.MainMissionCustomValueR\x12ma\
    inMissionMcvList\x12D\n\x1funfinished_main_mission_id_list\x18\r\x20\x03\
    (\rR\x1bunfinishedMainMissionIdList\x12U\n(curversion_finished_main_miss\
    ion_id_list\x18\x05\x20\x03(\rR#curversionFinishedMainMissionIdList\x12?\
    \n\x17sub_mission_status_list\x18\x01\x20\x03(\x0b2\x08.MissionR\x14subM\
    issionStatusList\x12@\n\x1dfinished_main_mission_id_list\x18\x08\x20\x03\
    (\rR\x19finishedMainMissionIdList\x12\x18\n\x07retcode\x18\t\x20\x01(\rR\
    \x07retcode\x12@\n\x1ddisabled_main_mission_id_list\x18\x03\x20\x03(\rR\
    \x19disabledMainMissionIdListb\x06proto3\
";
