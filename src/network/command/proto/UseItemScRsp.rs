...
impl ::protobuf::Message for UseItemScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.use_item_count != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.use_item_count);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.use_item_count != 0 {
            os.write_uint32(9, self.use_item_count)?;
        }
        if self.formula_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    sp\x12*\n\x0breturn_data\x18\x0f\x20\x01(\x0b2\t.ItemListR\nreturnData\
    \x126\n\x18month_card_out_date_time\x18\x07\x20\x01(\x04R\x14monthCardOu\
    tDateTime\x12$\n\x0euse_item_count\x18\t\x20\x01(\rR\x0cuseItemCount\x12\
    \x1d\n\nformula_id\x18\x02\x20\x01(\rR\tformulaId\x12\x18\n\x07retcode\
    \x18\x0e\x20\x01(\rR\x07retcode\x12\x1e\n\x0buse_item_id\x18\x01\x20\x01\
    (\rR\tuseItemIdb\x06proto3\
";
