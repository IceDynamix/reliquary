...
impl ::protobuf::Message for UseItemScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.use_item_id != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.use_item_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.use_item_id != 0 {
            os.write_uint32(2, self.use_item_id)?;
        }
        if self.formula_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    sp\x12\x1e\n\x0buse_item_id\x18\x02\x20\x01(\rR\tuseItemId\x12\x1d\n\nfo\
    rmula_id\x18\x05\x20\x01(\rR\tformulaId\x126\n\x18month_card_out_date_ti\
    me\x18\n\x20\x01(\x04R\x14monthCardOutDateTime\x12*\n\x0breturn_data\x18\
    \x0c\x20\x01(\x0b2\t.ItemListR\nreturnData\x12$\n\x0euse_item_count\x18\
    \x0e\x20\x01(\rR\x0cuseItemCount\x12\x18\n\x07retcode\x18\x0f\x20\x01(\r\
