...
impl ::protobuf::Message for UseItemScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.use_item_id != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.use_item_id);
        }
        if self.retcode != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.retcode);
        }
        if self.use_item_count != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.use_item_count);
        }
        if self.formula_id != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.formula_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.use_item_id != 0 {
            os.write_uint32(8, self.use_item_id)?;
        }
        if self.retcode != 0 {
            os.write_uint32(13, self.retcode)?;
        }
        if self.use_item_count != 0 {
            os.write_uint32(10, self.use_item_count)?;
        }
        if self.formula_id != 0 {
            os.write_uint32(3, self.formula_id)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    sp\x12*\n\x0breturn_data\x18\t\x20\x01(\x0b2\t.ItemListR\nreturnData\x12\
    6\n\x18month_card_out_date_time\x18\x01\x20\x01(\x04R\x14monthCardOutDat\
    eTime\x12\x1e\n\x0buse_item_id\x18\x08\x20\x01(\rR\tuseItemId\x12\x18\n\
    \x07retcode\x18\r\x20\x01(\rR\x07retcode\x12$\n\x0euse_item_count\x18\n\
    \x20\x01(\rR\x0cuseItemCount\x12\x1d\n\nformula_id\x18\x03\x20\x01(\rR\t\
