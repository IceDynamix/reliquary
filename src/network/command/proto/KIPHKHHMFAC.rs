...
pub struct KIPHKHHMFAC {
    ...
    pub MNCIHJHGNMJ: u32,
    // @@protoc_insertion_point(field:KIPHKHHMFAC.PJBIPPDMCHE)
    pub PJBIPPDMCHE: i64,
    // @@protoc_insertion_point(field:KIPHKHHMFAC.OGCKDLKCABG)
    pub OGCKDLKCABG: i64,
...
impl KIPHKHHMFAC {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "PJBIPPDMCHE",
            |m: &KIPHKHHMFAC| { &m.PJBIPPDMCHE },
            |m: &mut KIPHKHHMFAC| { &mut m.PJBIPPDMCHE },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "OGCKDLKCABG",
            |m: &KIPHKHHMFAC| { &m.OGCKDLKCABG },
            |m: &mut KIPHKHHMFAC| { &mut m.OGCKDLKCABG },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "GHCAAONIGCA",
...
impl ::protobuf::Message for KIPHKHHMFAC {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.POKIDOENKEK != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.POKIDOENKEK);
        }
        if !self.BCAFJHGDODI.is_empty() {
            my_size += ::protobuf::rt::string_size(1, &self.BCAFJHGDODI);
        }
        if !self.ADJCAKNJCGO.is_empty() {
            my_size += ::protobuf::rt::string_size(3, &self.ADJCAKNJCGO);
        }
        if self.MNCIHJHGNMJ != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.MNCIHJHGNMJ);
        }
        if self.PJBIPPDMCHE != 0 {
            my_size += ::protobuf::rt::int64_size(11, self.PJBIPPDMCHE);
        }
        ...
        if !self.DBCKEIOJLDI.is_empty() {
            my_size += ::protobuf::rt::string_size(9, &self.DBCKEIOJLDI);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.POKIDOENKEK != 0 {
            os.write_uint32(8, self.POKIDOENKEK)?;
        }
        if !self.BCAFJHGDODI.is_empty() {
            os.write_string(1, &self.BCAFJHGDODI)?;
        }
        if !self.ADJCAKNJCGO.is_empty() {
            os.write_string(3, &self.ADJCAKNJCGO)?;
        }
        if self.MNCIHJHGNMJ != 0 {
            os.write_uint32(15, self.MNCIHJHGNMJ)?;
        }
        if self.PJBIPPDMCHE != 0 {
            os.write_int64(11, self.PJBIPPDMCHE)?;
        }
        if self.OGCKDLKCABG != 0 {
            os.write_int64(2, self.OGCKDLKCABG)?;
        }
        if self.GHCAAONIGCA != false {
            os.write_bool(6, self.GHCAAONIGCA)?;
        }
        if !self.DBCKEIOJLDI.is_empty() {
            os.write_string(9, &self.DBCKEIOJLDI)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x11KIPHKHHMFAC.proto\"\xbf\x02\n\x0bKIPHKHHMFAC\x12\x20\n\x0bKDCIGPAM\
    GHO\x18\r\x20\x01(\rR\x0bKDCIGPAMGHO\x12\x20\n\x0bPOKIDOENKEK\x18\x08\
    \x20\x01(\rR\x0bPOKIDOENKEK\x12\x20\n\x0bBCAFJHGDODI\x18\x01\x20\x01(\tR\
    \x0bBCAFJHGDODI\x12\x20\n\x0bADJCAKNJCGO\x18\x03\x20\x01(\tR\x0bADJCAKNJ\
    CGO\x12\x20\n\x0bMNCIHJHGNMJ\x18\x0f\x20\x01(\rR\x0bMNCIHJHGNMJ\x12\x20\
    \n\x0bPJBIPPDMCHE\x18\x0b\x20\x01(\x03R\x0bPJBIPPDMCHE\x12\x20\n\x0bOGCK\
    DLKCABG\x18\x02\x20\x01(\x03R\x0bOGCKDLKCABG\x12\x20\n\x0bGHCAAONIGCA\
    \x18\x06\x20\x01(\x08R\x0bGHCAAONIGCA\x12\x20\n\x0bDBCKEIOJLDI\x18\t\x20\
    \x01(\tR\x0bDBCKEIOJLDIb\x06proto3\
";
