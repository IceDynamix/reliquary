...
impl ::protobuf::Message for SharePunkLordMonsterScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.share_type != ::protobuf::EnumOrUnknown::new(super::PunkLordShareType::PunkLordShareType::PUNK_LORD_SHARE_TYPE_NONE) {
            my_size += ::protobuf::rt::int32_size(11, self.share_type.value());
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.share_type != ::protobuf::EnumOrUnknown::new(super::PunkLordShareType::PunkLordShareType::PUNK_LORD_SHARE_TYPE_NONE) {
            os.write_enum(11, ::protobuf::EnumOrUnknown::value(&self.share_type))?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    (\rR\x03uid\x121\n\nshare_type\x18\x0b\x20\x01(\x0e2\x12.PunkLordShareTy\
    peR\tshareType\x12\x18\n\x07retcode\x18\r\x20\x01(\rR\x07retcode\x12\x1d\
    \n\nmonster_id\x18\x0f\x20\x01(\rR\tmonsterIdb\x06proto3\
";
