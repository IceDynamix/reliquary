...
impl ::protobuf::Message for SharePunkLordMonsterScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.share_type != ::protobuf::EnumOrUnknown::new(super::PunkLordShareType::PunkLordShareType::KIDJIFKAJFP_GKJBAODJMJG) {
            my_size += ::protobuf::rt::int32_size(6, self.share_type.value());
        }
        if self.uid != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.share_type != ::protobuf::EnumOrUnknown::new(super::PunkLordShareType::PunkLordShareType::KIDJIFKAJFP_GKJBAODJMJG) {
            os.write_enum(6, ::protobuf::EnumOrUnknown::value(&self.share_type))?;
        }
        if self.uid != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x99\x01\n\x19SharePunkLordMonsterScRsp\x12\x18\n\x07retcode\x18\x02\x20\
    \x01(\rR\x07retcode\x12\x1d\n\nmonster_id\x18\x0f\x20\x01(\rR\tmonsterId\
    \x121\n\nshare_type\x18\x06\x20\x01(\x0e2\x12.PunkLordShareTypeR\tshareT\
