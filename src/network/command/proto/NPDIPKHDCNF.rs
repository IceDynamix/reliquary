...
impl ::protobuf::Message for NPDIPKHDCNF {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.block_type != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.block_type);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.block_type != 0 {
            os.write_uint32(8, self.block_type)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    GMA\x18\x0b\x20\x03(\rR\x0bNHGOJDODGMA\x12$\n\x0eselect_cell_id\x18\r\
    \x20\x01(\rR\x0cselectCellId\x12\x18\n\x07confirm\x18\x03\x20\x01(\x08R\
    \x07confirm\x12\x1d\n\nblock_type\x18\x08\x20\x01(\rR\tblockTypeb\x06pro\
    to3\
";
