...
impl ::protobuf::Message for NPDIPKHDCNF {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.block_type != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.block_type);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(7, &self.NHGOJDODGMA);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.block_type != 0 {
            os.write_uint32(2, self.block_type)?;
        }
        os.write_repeated_packed_uint32(7, &self.NHGOJDODGMA)?;
        if self.select_cell_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x03\x20\x01(\x08R\x07confirm\x12\x1d\n\nblock_type\x18\x02\x20\x01(\
    \rR\tblockType\x12\x20\n\x0bNHGOJDODGMA\x18\x07\x20\x03(\rR\x0bNHGOJDODG\
    MA\x12$\n\x0eselect_cell_id\x18\x0f\x20\x01(\rR\x0cselectCellIdb\x06prot\
    o3\
";
