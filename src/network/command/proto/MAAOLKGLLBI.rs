...
impl ::protobuf::Message for MAAOLKGLLBI {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(4, &self.monster_list);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.HHENFGJPFOA != false {
            os.write_bool(6, self.HHENFGJPFOA)?;
        }
        if self.KKEAEBAGMKE != false {
            os.write_bool(9, self.KKEAEBAGMKE)?;
        }
        os.write_repeated_packed_uint32(4, &self.monster_list)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x01\x20\x01(\rR\x07affixId\x12\x1b\n\tunique_id\x18\n\x20\x01(\rR\
    \x08uniqueId\x12\x20\n\x0bHHENFGJPFOA\x18\x06\x20\x01(\x08R\x0bHHENFGJPF\
    OA\x12\x20\n\x0bKKEAEBAGMKE\x18\t\x20\x01(\x08R\x0bKKEAEBAGMKE\x12!\n\
    \x0cmonster_list\x18\x04\x20\x03(\rR\x0bmonsterListb\x06proto3\
";
