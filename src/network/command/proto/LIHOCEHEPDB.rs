...
impl ::protobuf::Message for LIHOCEHEPDB {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.LFCMBGOAIBB != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.LFCMBGOAIBB);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(13, &self.HFEJHLNIGGH);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.LFCMBGOAIBB != 0 {
            os.write_uint32(12, self.LFCMBGOAIBB)?;
        }
        os.write_repeated_packed_uint32(13, &self.HFEJHLNIGGH)?;
        if self.KDMLLLGHJON != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x06\x20\x01(\rR\x07eventId\x12\x20\n\x0bLFCMBGOAIBB\x18\x0c\x20\x01\
    (\rR\x0bLFCMBGOAIBB\x12\x20\n\x0bHFEJHLNIGGH\x18\r\x20\x03(\rR\x0bHFEJHL\
    NIGGH\x12\x20\n\x0bKDMLLLGHJON\x18\x01\x20\x01(\rR\x0bKDMLLLGHJONb\x06pr\
    oto3\
";
