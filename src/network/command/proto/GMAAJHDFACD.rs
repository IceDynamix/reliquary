...
impl ::protobuf::Message for GMAAJHDFACD {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.IFAIKOIOIDD != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.IFAIKOIOIDD);
        }
        if self.PDOMACFEMGG != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.PDOMACFEMGG);
        }
        if self.level != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.IFAIKOIOIDD != 0 {
            os.write_uint32(10, self.IFAIKOIOIDD)?;
        }
        if self.PDOMACFEMGG != 0 {
            os.write_uint32(3, self.PDOMACFEMGG)?;
        }
        if self.level != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    JHDFACD\x12$\n\x04type\x18\x08\x20\x01(\x0e2\x10.MovieRacingTypeR\x04typ\
    e\x12\x20\n\x0bIFAIKOIOIDD\x18\n\x20\x01(\rR\x0bIFAIKOIOIDD\x12\x20\n\
    \x0bPDOMACFEMGG\x18\x03\x20\x01(\rR\x0bPDOMACFEMGG\x12\x14\n\x05level\
