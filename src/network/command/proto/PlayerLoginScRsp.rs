...
impl ::protobuf::Message for PlayerLoginScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.PDIKPEIFANN.is_empty() {
            my_size += ::protobuf::rt::string_size(12, &self.PDIKPEIFANN);
        }
        ...
        if self.cur_timezone != 0 {
            my_size += ::protobuf::rt::int32_size(5, self.cur_timezone);
        }
        if self.JLPKEOBINCP != false {
            my_size += 1 + 1;
        }
        if !self.NHMHABJKHOG.is_empty() {
            my_size += ::protobuf::rt::string_size(2, &self.NHMHABJKHOG);
        }
        if self.stamina != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.PDIKPEIFANN.is_empty() {
            os.write_string(12, &self.PDIKPEIFANN)?;
        }
        if self.login_random != 0 {
        ...
        if self.IGKBEAMLNBJ != false {
            os.write_bool(15, self.IGKBEAMLNBJ)?;
        }
        if self.cur_timezone != 0 {
            os.write_int32(5, self.cur_timezone)?;
        }
        if self.JLPKEOBINCP != false {
            os.write_bool(4, self.JLPKEOBINCP)?;
        }
        if !self.NHMHABJKHOG.is_empty() {
            os.write_string(2, &self.NHMHABJKHOG)?;
        }
        if self.stamina != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    sicInfoR\tbasicInfo\x12\x20\n\x0bPDIKPEIFANN\x18\x0c\x20\x01(\tR\x0bPDIK\
    PEIFANN\x12!\n\x0clogin_random\x18\x01\x20\x01(\x04R\x0bloginRandom\x12\
    \x18\n\x07retcode\x18\x0b\x20\x01(\rR\x07retcode\x12\x20\n\x0bIGKBEAMLNB\
    J\x18\x0f\x20\x01(\x08R\x0bIGKBEAMLNBJ\x12!\n\x0ccur_timezone\x18\x05\
    \x20\x01(\x05R\x0bcurTimezone\x12\x20\n\x0bJLPKEOBINCP\x18\x04\x20\x01(\
    \x08R\x0bJLPKEOBINCP\x12\x20\n\x0bNHMHABJKHOG\x18\x02\x20\x01(\tR\x0bNHM\
    HABJKHOG\x12\x18\n\x07stamina\x18\x03\x20\x01(\rR\x07stamina\x12.\n\x13s\
    erver_timestamp_ms\x18\x0e\x20\x01(\x04R\x11serverTimestampMsb\x06proto3\
";
