...
//! Generated file from `ODDKKAHNMHK.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:ODDKKAHNMHK)
...
impl<'a> ::std::default::Default for &'a ODDKKAHNMHK {
    fn default() -> &'a ODDKKAHNMHK {
        <ODDKKAHNMHK as ::protobuf::Message>::default_instance()
    }
}

impl ODDKKAHNMHK {
    pub fn new() -> ODDKKAHNMHK {
...
impl ::protobuf::Message for ODDKKAHNMHK {
    const NAME: &'static str = "ODDKKAHNMHK";
...
impl ::protobuf::MessageFull for ODDKKAHNMHK {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("ODDKKAHNMHK").unwrap()).clone()
    }
}

impl ::std::fmt::Display for ODDKKAHNMHK {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for ODDKKAHNMHK {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::NLAAMOGOOBE::file_descriptor().clone());
            let mut messages = ::std::vec::Vec::with_capacity(1);
            messages.push(ODDKKAHNMHK::generated_message_descriptor_data());
