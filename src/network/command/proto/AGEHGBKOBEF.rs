...
//! Generated file from `AGEHGBKOBEF.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:AGEHGBKOBEF)
...
impl<'a> ::std::default::Default for &'a AGEHGBKOBEF {
    fn default() -> &'a AGEHGBKOBEF {
        <AGEHGBKOBEF as ::protobuf::Message>::default_instance()
    }
}

impl AGEHGBKOBEF {
    pub fn new() -> AGEHGBKOBEF {
...
impl ::protobuf::Message for AGEHGBKOBEF {
    const NAME: &'static str = "AGEHGBKOBEF";
...
impl ::protobuf::MessageFull for AGEHGBKOBEF {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("AGEHGBKOBEF").unwrap()).clone()
    }
}

impl ::std::fmt::Display for AGEHGBKOBEF {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for AGEHGBKOBEF {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::EDOIEMCFFCA::file_descriptor().clone());
            deps.push(super::HNKAOFDGLIE::file_descriptor().clone());
            let mut messages = ::std::vec::Vec::with_capacity(1);
            messages.push(AGEHGBKOBEF::generated_message_descriptor_data());
