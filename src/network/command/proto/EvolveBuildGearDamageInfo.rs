...
//! Generated file from `EvolveBuildGearDamageInfo.proto`
...
pub struct EvolveBuildGearDamageInfo {
    // message fields
    // @@protoc_insertion_point(field:EvolveBuildGearDamageInfo.gear_id)
    pub gear_id: u32,
    // @@protoc_insertion_point(field:EvolveBuildGearDamageInfo.damage)
    pub damage: f64,
    // @@protoc_insertion_point(field:EvolveBuildGearDamageInfo.hp_damage)
    pub hp_damage: f64,
    // special fields
...
impl EvolveBuildGearDamageInfo {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "gear_id",
            |m: &EvolveBuildGearDamageInfo| { &m.gear_id },
            |m: &mut EvolveBuildGearDamageInfo| { &mut m.gear_id },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "damage",
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "hp_damage",
            |m: &EvolveBuildGearDamageInfo| { &m.hp_damage },
            |m: &mut EvolveBuildGearDamageInfo| { &mut m.hp_damage },
        ));
...
impl ::protobuf::Message for EvolveBuildGearDamageInfo {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                8 => {
                    self.gear_id = is.read_uint32()?;
                },
                17 => {
                    self.damage = is.read_double()?;
                },
                25 => {
                    self.hp_damage = is.read_double()?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.gear_id != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.gear_id);
        }
        if self.damage != 0. {
            my_size += 1 + 8;
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.gear_id != 0 {
            os.write_uint32(1, self.gear_id)?;
        }
        if self.damage != 0. {
            os.write_double(2, self.damage)?;
        }
        if self.hp_damage != 0. {
            os.write_double(3, self.hp_damage)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1fEvolveBuildGearDamageInfo.proto\"i\n\x19EvolveBuildGearDamageInfo\
    \x12\x17\n\x07gear_id\x18\x01\x20\x01(\rR\x06gearId\x12\x16\n\x06damage\
    \x18\x02\x20\x01(\x01R\x06damage\x12\x1b\n\thp_damage\x18\x03\x20\x01(\
    \x01R\x08hpDamageb\x06proto3\
";
