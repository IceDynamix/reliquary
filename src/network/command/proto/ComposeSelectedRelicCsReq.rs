...
impl ::protobuf::Message for ComposeSelectedRelicCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(6, &self.sub_affix_id_list);
        ...
        if self.compose_relic_id != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.compose_relic_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_uint32(6, &self.sub_affix_id_list)?;
        if let Some(v) = self.compose_item_list.as_ref() {
        ...
        if self.compose_relic_id != 0 {
            os.write_uint32(5, self.compose_relic_id)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x02\n\x19ComposeSelectedRelicCsReq\x12/\n\x0cwr_item_list\x18\r\x20\x01\
    (\x0b2\r.ItemCostDataR\nwrItemList\x12)\n\x11sub_affix_id_list\x18\x06\
    \x20\x03(\rR\x0esubAffixIdList\x129\n\x11compose_item_list\x18\x0f\x20\
    \x01(\x0b2\r.ItemCostDataR\x0fcomposeItemList\x12\x14\n\x05count\x18\t\
    \x20\x01(\rR\x05count\x12\"\n\rmain_affix_id\x18\x03\x20\x01(\rR\x0bmain\
    AffixId\x12\x1d\n\ncompose_id\x18\x02\x20\x01(\rR\tcomposeId\x12(\n\x10c\
    ompose_relic_id\x18\x05\x20\x01(\rR\x0ecomposeRelicIdb\x06proto3\
";
