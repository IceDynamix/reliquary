...
impl ::protobuf::Message for ComposeSelectedRelicCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.compose_relic_id != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.compose_relic_id);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(3, &self.sub_affix_id_list);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.compose_relic_id != 0 {
            os.write_uint32(8, self.compose_relic_id)?;
        }
        os.write_repeated_packed_uint32(3, &self.sub_affix_id_list)?;
        if self.main_affix_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x01(\rR\tcomposeId\x12/\n\x0cwr_item_list\x18\t\x20\x01(\x0b2\r.ItemCos\
    tDataR\nwrItemList\x129\n\x11compose_item_list\x18\x0b\x20\x01(\x0b2\r.I\
    temCostDataR\x0fcomposeItemList\x12(\n\x10compose_relic_id\x18\x08\x20\
    \x01(\rR\x0ecomposeRelicId\x12)\n\x11sub_affix_id_list\x18\x03\x20\x03(\
    \rR\x0esubAffixIdList\x12\"\n\rmain_affix_id\x18\x07\x20\x01(\rR\x0bmain\
