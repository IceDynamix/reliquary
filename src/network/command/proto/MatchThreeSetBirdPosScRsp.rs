...
pub struct MatchThreeSetBirdPosScRsp {
    // message fields
    // @@protoc_insertion_point(field:MatchThreeSetBirdPosScRsp.ADOGOONNMOI)
    pub ADOGOONNMOI: u32,
    // @@protoc_insertion_point(field:MatchThreeSetBirdPosScRsp.pos)
    pub pos: u32,
...
impl MatchThreeSetBirdPosScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "ADOGOONNMOI",
            |m: &MatchThreeSetBirdPosScRsp| { &m.ADOGOONNMOI },
            |m: &mut MatchThreeSetBirdPosScRsp| { &mut m.ADOGOONNMOI },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "pos",
            |m: &MatchThreeSetBirdPosScRsp| { &m.pos },
            |m: &mut MatchThreeSetBirdPosScRsp| { &mut m.pos },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "retcode",
...
impl ::protobuf::Message for MatchThreeSetBirdPosScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.ADOGOONNMOI != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.ADOGOONNMOI);
        }
        if self.pos != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.ADOGOONNMOI != 0 {
            os.write_uint32(15, self.ADOGOONNMOI)?;
        }
        if self.pos != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12\x20\n\x0bADOGOONNMOI\x18\x0f\x20\x01(\rR\x0bADOGOONNMOI\x12\x10\n\
    \x03pos\x18\x06\x20\x01(\rR\x03pos\x12\x18\n\x07retcode\x18\x0b\x20\x01(\
