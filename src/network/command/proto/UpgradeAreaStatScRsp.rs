...
pub struct UpgradeAreaStatScRsp {
    ...
    pub level: u32,
    // @@protoc_insertion_point(field:UpgradeAreaStatScRsp.ECOHHFOIDLI)
...
impl UpgradeAreaStatScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "ECOHHFOIDLI",
            |m: &UpgradeAreaStatScRsp| { &m.ECOHHFOIDLI },
            |m: &mut UpgradeAreaStatScRsp| { &mut m.ECOHHFOIDLI },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "area_id",
...
impl ::protobuf::Message for UpgradeAreaStatScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.ECOHHFOIDLI != ::protobuf::EnumOrUnknown::new(super::StatType::StatType::ACPAHOKPFPD_GKJBAODJMJG) {
            my_size += ::protobuf::rt::int32_size(10, self.ECOHHFOIDLI.value());
        }
        if self.area_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.ECOHHFOIDLI != ::protobuf::EnumOrUnknown::new(super::StatType::StatType::ACPAHOKPFPD_GKJBAODJMJG) {
            os.write_enum(10, ::protobuf::EnumOrUnknown::value(&self.ECOHHFOIDLI))?;
        }
        if self.area_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x0bECOHHFOIDLI\x18\n\x20\x01(\x0e2\t.StatTypeR\x0bECOHHFOIDLI\x12\x17\
    \n\x07area_id\x18\x05\x20\x01(\rR\x06areaId\x12\x18\n\x07retcode\x18\x03\
