...
pub struct UpgradeAreaStatScRsp {
    // message fields
    // @@protoc_insertion_point(field:UpgradeAreaStatScRsp.GNBKDCHLDGL)
...
impl UpgradeAreaStatScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "GNBKDCHLDGL",
            |m: &UpgradeAreaStatScRsp| { &m.GNBKDCHLDGL },
            |m: &mut UpgradeAreaStatScRsp| { &mut m.GNBKDCHLDGL },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "retcode",
...
impl ::protobuf::Message for UpgradeAreaStatScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.GNBKDCHLDGL != ::protobuf::EnumOrUnknown::new(super::StatType::StatType::GOPHGIHIDPP_NLCDGIPGFDJ) {
            my_size += ::protobuf::rt::int32_size(1, self.GNBKDCHLDGL.value());
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.GNBKDCHLDGL != ::protobuf::EnumOrUnknown::new(super::StatType::StatType::GOPHGIHIDPP_NLCDGIPGFDJ) {
            os.write_enum(1, ::protobuf::EnumOrUnknown::value(&self.GNBKDCHLDGL))?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1aUpgradeAreaStatScRsp.proto\x1a\x0eStatType.proto\"\x8c\x01\n\x14Up\
    gradeAreaStatScRsp\x12+\n\x0bGNBKDCHLDGL\x18\x01\x20\x01(\x0e2\t.StatTyp\
    eR\x0bGNBKDCHLDGL\x12\x18\n\x07retcode\x18\x04\x20\x01(\rR\x07retcode\
