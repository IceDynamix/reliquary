...
impl ::protobuf::Message for UpgradeAreaStatScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.status_info != ::protobuf::EnumOrUnknown::new(super::StatType::StatType::STAT_TYPE_NONE) {
            my_size += ::protobuf::rt::int32_size(2, self.status_info.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.status_info != ::protobuf::EnumOrUnknown::new(super::StatType::StatType::STAT_TYPE_NONE) {
            os.write_enum(2, ::protobuf::EnumOrUnknown::value(&self.status_info))?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0f\x20\x01(\rR\x06areaId\x12*\n\x0bstatus_info\x18\x02\x20\x01(\x0e2\t\
