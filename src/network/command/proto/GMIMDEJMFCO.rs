...
//! Generated file from `GMIMDEJMFCO.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:GMIMDEJMFCO)
...
impl<'a> ::std::default::Default for &'a GMIMDEJMFCO {
    fn default() -> &'a GMIMDEJMFCO {
        <GMIMDEJMFCO as ::protobuf::Message>::default_instance()
    }
}

impl GMIMDEJMFCO {
    pub fn new() -> GMIMDEJMFCO {
...
impl ::protobuf::Message for GMIMDEJMFCO {
    const NAME: &'static str = "GMIMDEJMFCO";
...
impl ::protobuf::MessageFull for GMIMDEJMFCO {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("GMIMDEJMFCO").unwrap()).clone()
    }
}

impl ::std::fmt::Display for GMIMDEJMFCO {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for GMIMDEJMFCO {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::LGEFLGJIGIJ::file_descriptor().clone());
            deps.push(super::MGGBPKANFOA::file_descriptor().clone());
            let mut messages = ::std::vec::Vec::with_capacity(1);
            messages.push(GMIMDEJMFCO::generated_message_descriptor_data());
