...
impl ::protobuf::Message for ClockParkHandleWaitOperationCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.AHIDJBJGGPP != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.AHIDJBJGGPP);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.AHIDJBJGGPP != 0 {
            os.write_uint32(12, self.AHIDJBJGGPP)?;
        }
        if let ::std::option::Option::Some(ref v) = self.DEJMPMFHIOC {
            match v {
                &clock_park_handle_wait_operation_cs_req::DEJMPMFHIOC::JFBCKCLPAKO(ref v) => {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x02\x20\x01(\rR\x08scriptId\x12\x20\n\x0bAHIDJBJGGPP\x18\x0c\x20\
    ...
    \x0f\x20\x01(\x0b2\x0c.AMGHDCABJMJH\0R\x0bABKKDHAPCHN\x120\n\x0bLIHJMEIN\
    GIK\x18\x06\x20\x01(\x0b2\x0c.INNNICFOLIIH\0R\x0bLIHJMEINGIK\x120\n\x0bL\
    MGGLCNCDHF\x18\r\x20\x01(\x0b2\x0c.CEOONFLONDJH\0R\x0bLMGGLCNCDHF\x120\n\
    \x0bFNGFOAEPFJN\x18\x01\x20\x01(\x0b2\x0c.HELNOIHMDHAH\0R\x0bFNGFOAEPFJN\
    \x12\"\n\x0bOBPFBLNBFKI\x18\n\x20\x01(\rH\0R\x0bOBPFBLNBFKIB\r\n\x0bDEJM\
    PMFHIOCb\x06proto3\
";
