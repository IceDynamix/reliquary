...
impl ::protobuf::Message for ChestInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.exist_num != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.exist_num);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.exist_num != 0 {
            os.write_uint32(10, self.exist_num)?;
        }
        if self.chest_type != ::protobuf::EnumOrUnknown::new(super::ChestType::ChestType::MAP_INFO_CHEST_TYPE_NONE) {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    opened_num\x18\x02\x20\x01(\rR\topenedNum\x12\x1b\n\texist_num\x18\n\x20\
    \x01(\rR\x08existNum\x12)\n\nchest_type\x18\x04\x20\x01(\x0e2\n.ChestTyp\
    eR\tchestTypeb\x06proto3\
";
