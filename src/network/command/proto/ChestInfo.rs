...
impl ::protobuf::Message for ChestInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.opened_num != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.opened_num);
        }
        if self.exist_num != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.opened_num != 0 {
            os.write_uint32(3, self.opened_num)?;
        }
        if self.exist_num != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    opened_num\x18\x03\x20\x01(\rR\topenedNum\x12\x1b\n\texist_num\x18\x07\
    \x20\x01(\rR\x08existNum\x12)\n\nchest_type\x18\r\x20\x01(\x0e2\n.ChestT\
    ypeR\tchestTypeb\x06proto3\
";
