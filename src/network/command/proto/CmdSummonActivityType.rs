...
impl ::protobuf::Enum for CmdSummonActivityType {
    ...
    fn from_i32(value: i32) -> ::std::option::Option<CmdSummonActivityType> {
        match value {
            ...
            7566 => ::std::option::Option::Some(CmdSummonActivityType::CmdSummonActivityBattleEndScNotify),
            7565 => ::std::option::Option::Some(CmdSummonActivityType::CmdGetSummonActivityDataCsReq),
            7568 => ::std::option::Option::Some(CmdSummonActivityType::CmdEnterSummonActivityStageCsReq),
            7563 => ::std::option::Option::Some(CmdSummonActivityType::CmdEnterSummonActivityStageScRsp),
            7569 => ::std::option::Option::Some(CmdSummonActivityType::CmdGetSummonActivityDataScRsp),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    attleEndScNotify\x10\x8e;\x12\"\n\x1dCmdGetSummonActivityDataCsReq\x10\
    \x8d;\x12%\n\x20CmdEnterSummonActivityStageCsReq\x10\x90;\x12%\n\x20CmdE\
    nterSummonActivityStageScRsp\x10\x8b;\x12\"\n\x1dCmdGetSummonActivityDat\
    aScRsp\x10\x91;b\x06proto3\
";
