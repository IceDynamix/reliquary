...
impl ::protobuf::Message for GetPhoneDataScRsp {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(1, &self.owned_phone_cases);
        if self.retcode != 0 {
        ...
        if self.cur_chat_bubble != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.cur_chat_bubble);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(14, &self.owned_chat_bubbles);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(1, &self.owned_phone_cases)?;
        if self.retcode != 0 {
        ...
        if self.cur_chat_bubble != 0 {
            os.write_uint32(11, self.cur_chat_bubble)?;
        }
        os.write_repeated_packed_uint32(14, &self.owned_chat_bubbles)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x11owned_phone_cases\x18\x01\x20\x03(\rR\x0fownedPhoneCases\x12\x18\n\
    \x07retcode\x18\x02\x20\x01(\rR\x07retcode\x12&\n\x0fcur_phone_theme\x18\
    \x03\x20\x01(\rR\rcurPhoneTheme\x12,\n\x12owned_phone_themes\x18\x06\x20\
    \x03(\rR\x10ownedPhoneThemes\x12$\n\x0ecur_phone_case\x18\n\x20\x01(\rR\
    \x0ccurPhoneCase\x12&\n\x0fcur_chat_bubble\x18\x0b\x20\x01(\rR\rcurChatB\
    ubble\x12,\n\x12owned_chat_bubbles\x18\x0e\x20\x03(\rR\x10ownedChatBubbl\
    esb\x06proto3\
";
