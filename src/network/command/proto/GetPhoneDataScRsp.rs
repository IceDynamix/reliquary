...
impl ::protobuf::Message for GetPhoneDataScRsp {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(5, &self.owned_phone_cases);
        my_size += ::protobuf::rt::vec_packed_uint32_size(8, &self.owned_chat_bubbles);
        if self.retcode != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.retcode);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(15, &self.owned_phone_themes);
        ...
        if self.cur_phone_case != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.cur_phone_case);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(5, &self.owned_phone_cases)?;
        os.write_repeated_packed_uint32(8, &self.owned_chat_bubbles)?;
        if self.retcode != 0 {
            os.write_uint32(6, self.retcode)?;
        }
        os.write_repeated_packed_uint32(15, &self.owned_phone_themes)?;
        if self.cur_phone_theme != 0 {
        ...
        if self.cur_phone_case != 0 {
            os.write_uint32(1, self.cur_phone_case)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x11owned_phone_cases\x18\x05\x20\x03(\rR\x0fownedPhoneCases\x12,\n\x12o\
    wned_chat_bubbles\x18\x08\x20\x03(\rR\x10ownedChatBubbles\x12\x18\n\x07r\
    etcode\x18\x06\x20\x01(\rR\x07retcode\x12,\n\x12owned_phone_themes\x18\
    \x0f\x20\x03(\rR\x10ownedPhoneThemes\x12&\n\x0fcur_phone_theme\x18\t\x20\
    \x01(\rR\rcurPhoneTheme\x12&\n\x0fcur_chat_bubble\x18\x0c\x20\x01(\rR\rc\
    urChatBubble\x12$\n\x0ecur_phone_case\x18\x01\x20\x01(\rR\x0ccurPhoneCas\
    eb\x06proto3\
";
