...
impl ::protobuf::Message for GetPhoneDataScRsp {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(10, &self.owned_chat_bubbles);
        my_size += ::protobuf::rt::vec_packed_uint32_size(9, &self.owned_phone_cases);
        my_size += ::protobuf::rt::vec_packed_uint32_size(2, &self.owned_phone_themes);
        if self.cur_phone_case != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.cur_phone_case);
        }
        if self.cur_chat_bubble != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.cur_chat_bubble);
        }
        if self.cur_phone_theme != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.cur_phone_theme);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(10, &self.owned_chat_bubbles)?;
        os.write_repeated_packed_uint32(9, &self.owned_phone_cases)?;
        os.write_repeated_packed_uint32(2, &self.owned_phone_themes)?;
        if self.cur_phone_case != 0 {
            os.write_uint32(12, self.cur_phone_case)?;
        }
        if self.cur_chat_bubble != 0 {
            os.write_uint32(6, self.cur_chat_bubble)?;
        }
        if self.cur_phone_theme != 0 {
            os.write_uint32(3, self.cur_phone_theme)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    wned_phone_cases\x18\t\x20\x03(\rR\x0fownedPhoneCases\x12,\n\x12owned_ph\
    one_themes\x18\x02\x20\x03(\rR\x10ownedPhoneThemes\x12$\n\x0ecur_phone_c\
    ase\x18\x0c\x20\x01(\rR\x0ccurPhoneCase\x12&\n\x0fcur_chat_bubble\x18\
    \x06\x20\x01(\rR\rcurChatBubble\x12&\n\x0fcur_phone_theme\x18\x03\x20\
    \x01(\rR\rcurPhoneTheme\x12\x18\n\x07retcode\x18\x07\x20\x01(\rR\x07retc\
    odeb\x06proto3\
";
