...
impl ::protobuf::Message for GetPhoneDataScRsp {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(13, &self.owned_chat_bubbles);
        my_size += ::protobuf::rt::vec_packed_uint32_size(6, &self.owned_phone_cases);
        if self.cur_phone_case != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.cur_phone_case);
        }
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(3, &self.owned_phone_themes);
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(13, &self.owned_chat_bubbles)?;
        os.write_repeated_packed_uint32(6, &self.owned_phone_cases)?;
        if self.cur_phone_case != 0 {
            os.write_uint32(2, self.cur_phone_case)?;
        }
        if self.cur_chat_bubble != 0 {
        ...
        os.write_repeated_packed_uint32(3, &self.owned_phone_themes)?;
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12owned_chat_bubbles\x18\r\x20\x03(\rR\x10ownedChatBubbles\x12*\n\x11o\
    wned_phone_cases\x18\x06\x20\x03(\rR\x0fownedPhoneCases\x12$\n\x0ecur_ph\
    one_case\x18\x02\x20\x01(\rR\x0ccurPhoneCase\x12&\n\x0fcur_chat_bubble\
    \x18\x05\x20\x01(\rR\rcurChatBubble\x12&\n\x0fcur_phone_theme\x18\x07\
    \x20\x01(\rR\rcurPhoneTheme\x12,\n\x12owned_phone_themes\x18\x03\x20\x03\
    (\rR\x10ownedPhoneThemes\x12\x18\n\x07retcode\x18\x0c\x20\x01(\rR\x07ret\
    codeb\x06proto3\
";
