...
impl ::protobuf::Message for DeleteSocialEventServerCacheScRsp {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(12, &self.BFGJMMPCPNJ);
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(12, &self.BFGJMMPCPNJ)?;
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    acheScRsp\x12\x20\n\x0bBFGJMMPCPNJ\x18\x0c\x20\x03(\rR\x0bBFGJMMPCPNJ\
