...
impl ::protobuf::Message for FriendSimpleInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.create_time != 0 {
            my_size += ::protobuf::rt::int64_size(14, self.create_time);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.create_time != 0 {
            os.write_int64(14, self.create_time)?;
        }
        if let Some(v) = self.ILCHAJCFFBF.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    tate\x12\x1f\n\x0bcreate_time\x18\x0e\x20\x01(\x03R\ncreateTime\x12.\n\
    \x0bILCHAJCFFBF\x18\x03\x20\x01(\x0b2\x0c.HIEJJBDNCNHR\x0bILCHAJCFFBF\
    \x12\x1f\n\x0bremark_name\x18\x0c\x20\x01(\tR\nremarkName\x12?\n\x12play\
    er_simple_info\x18\x06\x20\x01(\x0b2\x11.PlayerSimpleInfoR\x10playerSimp\
    leInfo\x12\x1b\n\tis_marked\x18\x0f\x20\x01(\x08R\x08isMarkedb\x06proto3\
";
