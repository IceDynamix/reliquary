...
pub struct EnterFightActivityStageCsReq {
    // message fields
    // @@protoc_insertion_point(field:EnterFightActivityStageCsReq.DBKHHCGGKNN)
    pub DBKHHCGGKNN: u32,
    // @@protoc_insertion_point(field:EnterFightActivityStageCsReq.MACCJKCGGII)
    pub MACCJKCGGII: ::std::vec::Vec<super::DOIBLFFDHDG::DOIBLFFDHDG>,
...
impl EnterFightActivityStageCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "DBKHHCGGKNN",
            |m: &EnterFightActivityStageCsReq| { &m.DBKHHCGGKNN },
            |m: &mut EnterFightActivityStageCsReq| { &mut m.DBKHHCGGKNN },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "MACCJKCGGII",
            |m: &EnterFightActivityStageCsReq| { &m.MACCJKCGGII },
            |m: &mut EnterFightActivityStageCsReq| { &mut m.MACCJKCGGII },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "avatar_list",
...
impl ::protobuf::Message for EnterFightActivityStageCsReq {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                34 => {
                    self.MACCJKCGGII.push(is.read_message()?);
                },
                66 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        for value in &self.MACCJKCGGII {
            let len = value.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
        };
        my_size += ::protobuf::rt::vec_packed_uint32_size(8, &self.avatar_list);
        my_size += ::protobuf::rt::vec_packed_uint32_size(9, &self.item_list);
        if self.group_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        for v in &self.MACCJKCGGII {
            ::protobuf::rt::write_message_field_with_cached_size(4, v, os)?;
        };
        os.write_repeated_packed_uint32(8, &self.avatar_list)?;
        os.write_repeated_packed_uint32(9, &self.item_list)?;
        if self.group_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\"EnterFightActivityStageCsReq.proto\x1a\x11DOIBLFFDHDG.proto\"\xc9\
    \x01\n\x1cEnterFightActivityStageCsReq\x12\x20\n\x0bDBKHHCGGKNN\x18\x03\
    \x20\x01(\rR\x0bDBKHHCGGKNN\x12.\n\x0bMACCJKCGGII\x18\x04\x20\x03(\x0b2\
    \x0c.DOIBLFFDHDGR\x0bMACCJKCGGII\x12\x1f\n\x0bavatar_list\x18\x08\x20\
    \x03(\rR\navatarList\x12\x1b\n\titem_list\x18\t\x20\x03(\rR\x08itemList\
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::DOIBLFFDHDG::file_descriptor().clone());
