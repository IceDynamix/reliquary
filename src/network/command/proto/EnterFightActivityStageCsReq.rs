...
pub struct EnterFightActivityStageCsReq {
    // message fields
    // @@protoc_insertion_point(field:EnterFightActivityStageCsReq.JBKPKDKLLIP)
    pub JBKPKDKLLIP: ::std::vec::Vec<super::JHAPCAGDHDO::JHAPCAGDHDO>,
    // @@protoc_insertion_point(field:EnterFightActivityStageCsReq.OHAHIIFJJMI)
    pub OHAHIIFJJMI: u32,
...
impl EnterFightActivityStageCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "JBKPKDKLLIP",
            |m: &EnterFightActivityStageCsReq| { &m.JBKPKDKLLIP },
            |m: &mut EnterFightActivityStageCsReq| { &mut m.JBKPKDKLLIP },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "OHAHIIFJJMI",
            |m: &EnterFightActivityStageCsReq| { &m.OHAHIIFJJMI },
            |m: &mut EnterFightActivityStageCsReq| { &mut m.OHAHIIFJJMI },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "group_id",
...
impl ::protobuf::Message for EnterFightActivityStageCsReq {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                50 => {
                    self.JBKPKDKLLIP.push(is.read_message()?);
                },
                88 => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        for value in &self.JBKPKDKLLIP {
            let len = value.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
        };
        if self.OHAHIIFJJMI != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.OHAHIIFJJMI);
        }
        if self.group_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        for v in &self.JBKPKDKLLIP {
            ::protobuf::rt::write_message_field_with_cached_size(6, v, os)?;
        };
        if self.OHAHIIFJJMI != 0 {
            os.write_uint32(11, self.OHAHIIFJJMI)?;
        }
        if self.group_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\"EnterFightActivityStageCsReq.proto\x1a\x11JHAPCAGDHDO.proto\"\xc9\
    \x01\n\x1cEnterFightActivityStageCsReq\x12.\n\x0bJBKPKDKLLIP\x18\x06\x20\
    \x03(\x0b2\x0c.JHAPCAGDHDOR\x0bJBKPKDKLLIP\x12\x20\n\x0bOHAHIIFJJMI\x18\
    \x0b\x20\x01(\rR\x0bOHAHIIFJJMI\x12\x19\n\x08group_id\x18\x0c\x20\x01(\r\
    R\x07groupId\x12\x1f\n\x0bavatar_list\x18\n\x20\x03(\rR\navatarList\x12\
    \x1b\n\titem_list\x18\x03\x20\x03(\rR\x08itemListb\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::JHAPCAGDHDO::file_descriptor().clone());
