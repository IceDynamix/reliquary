...
pub struct EnterFightActivityStageCsReq {
    // message fields
    // @@protoc_insertion_point(field:EnterFightActivityStageCsReq.DNPOPPIKLML)
    pub DNPOPPIKLML: u32,
    ...
    // @@protoc_insertion_point(field:EnterFightActivityStageCsReq.LHJGGNNIFHP)
    pub LHJGGNNIFHP: ::std::vec::Vec<super::MHAMHHHECBD::MHAMHHHECBD>,
    // special fields
...
impl EnterFightActivityStageCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "DNPOPPIKLML",
            |m: &EnterFightActivityStageCsReq| { &m.DNPOPPIKLML },
            |m: &mut EnterFightActivityStageCsReq| { &mut m.DNPOPPIKLML },
        ));
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "LHJGGNNIFHP",
            |m: &EnterFightActivityStageCsReq| { &m.LHJGGNNIFHP },
            |m: &mut EnterFightActivityStageCsReq| { &mut m.LHJGGNNIFHP },
        ));
...
impl ::protobuf::Message for EnterFightActivityStageCsReq {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                74 => {
                    self.LHJGGNNIFHP.push(is.read_message()?);
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(12, &self.item_list);
        if self.group_id != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.group_id);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(6, &self.avatar_list);
        for value in &self.LHJGGNNIFHP {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_uint32(12, &self.item_list)?;
        if self.group_id != 0 {
            os.write_uint32(14, self.group_id)?;
        }
        os.write_repeated_packed_uint32(6, &self.avatar_list)?;
        for v in &self.LHJGGNNIFHP {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\"EnterFightActivityStageCsReq.proto\x1a\x11MHAMHHHECBD.proto\"\xc9\
    \x01\n\x1cEnterFightActivityStageCsReq\x12\x20\n\x0bDNPOPPIKLML\x18\x07\
    \x20\x01(\rR\x0bDNPOPPIKLML\x12\x1b\n\titem_list\x18\x0c\x20\x03(\rR\x08\
    itemList\x12\x19\n\x08group_id\x18\x0e\x20\x01(\rR\x07groupId\x12\x1f\n\
    \x0bavatar_list\x18\x06\x20\x03(\rR\navatarList\x12.\n\x0bLHJGGNNIFHP\
    \x18\t\x20\x03(\x0b2\x0c.MHAMHHHECBDR\x0bLHJGGNNIFHPb\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::MHAMHHHECBD::file_descriptor().clone());
