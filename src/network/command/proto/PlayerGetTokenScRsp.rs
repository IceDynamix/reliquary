...
pub struct PlayerGetTokenScRsp {
    // message fields
    // @@protoc_insertion_point(field:PlayerGetTokenScRsp.stop_desc)
...
impl PlayerGetTokenScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "stop_desc",
            |m: &PlayerGetTokenScRsp| { &m.stop_desc },
            |m: &mut PlayerGetTokenScRsp| { &mut m.stop_desc },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "retcode",
...
impl ::protobuf::Message for PlayerGetTokenScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.stop_desc.is_empty() {
            my_size += ::protobuf::rt::string_size(3, &self.stop_desc);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if !self.stop_desc.is_empty() {
            os.write_string(3, &self.stop_desc)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ayerGetTokenScRsp\x12\x1b\n\tstop_desc\x18\x03\x20\x01(\tR\x08stopDesc\
    \x12\x18\n\x07retcode\x18\x04\x20\x01(\rR\x07retcode\x12&\n\x0fsecret_ke\
    y_seed\x18\x08\x20\x01(\x04R\rsecretKeySeed\x12)\n\nblack_info\x18\t\x20\
    \x01(\x0b2\n.BlackInfoR\tblackInfo\x12\x10\n\x03uid\x18\x0e\x20\x01(\rR\
    \x03uid\x12\x18\n\x07authkey\x18\x0f\x20\x01(\tR\x07authkeyb\x06proto3\
";
