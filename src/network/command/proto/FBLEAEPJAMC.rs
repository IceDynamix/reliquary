...
//! Generated file from `FBLEAEPJAMC.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:FBLEAEPJAMC)
...
impl<'a> ::std::default::Default for &'a FBLEAEPJAMC {
    fn default() -> &'a FBLEAEPJAMC {
        <FBLEAEPJAMC as ::protobuf::Message>::default_instance()
    }
}

impl FBLEAEPJAMC {
    pub fn new() -> FBLEAEPJAMC {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "IEAGBPEMFLG",
            |m: &FBLEAEPJAMC| { &m.IEAGBPEMFLG },
            |m: &mut FBLEAEPJAMC| { &mut m.IEAGBPEMFLG },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "KBCDECDNEFM",
            |m: &FBLEAEPJAMC| { &m.KBCDECDNEFM },
...
impl ::protobuf::Message for FBLEAEPJAMC {
    const NAME: &'static str = "FBLEAEPJAMC";
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.LLJAEGOBHMP != 0 {
            my_size += ::protobuf::rt::int32_size(1, self.LLJAEGOBHMP);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.LLJAEGOBHMP != 0 {
            os.write_int32(1, self.LLJAEGOBHMP)?;
        }
        if self.IEAGBPEMFLG != 0 {
...
impl ::protobuf::MessageFull for FBLEAEPJAMC {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("FBLEAEPJAMC").unwrap()).clone()
    }
}

impl ::std::fmt::Display for FBLEAEPJAMC {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for FBLEAEPJAMC {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x11FBLEAEPJAMC.proto\"\xd0\x01\n\x0bFBLEAEPJAMC\x12\x20\n\x0bCPODEJOF\
    PDD\x18\x03\x20\x01(\rR\x0bCPODEJOFPDD\x12\x20\n\x0bIIMOPLCFHAH\x18\x06\
    \x20\x01(\rR\x0bIIMOPLCFHAH\x12\x20\n\x0bLLJAEGOBHMP\x18\x01\x20\x01(\
    \x05R\x0bLLJAEGOBHMP\x12\x20\n\x0bIEAGBPEMFLG\x18\x02\x20\x01(\x05R\x0bI\
    EAGBPEMFLG\x12\x20\n\x0bKBCDECDNEFM\x18\x05\x20\x01(\rR\x0bKBCDECDNEFM\
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(FBLEAEPJAMC::generated_message_descriptor_data());
