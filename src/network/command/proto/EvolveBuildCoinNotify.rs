...
//! Generated file from `EvolveBuildCoinNotify.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:EvolveBuildCoinNotify)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct EvolveBuildCoinNotify {
    // message fields
    // @@protoc_insertion_point(field:EvolveBuildCoinNotify.CMMOFODEEFN)
...
impl<'a> ::std::default::Default for &'a EvolveBuildCoinNotify {
    fn default() -> &'a EvolveBuildCoinNotify {
        <EvolveBuildCoinNotify as ::protobuf::Message>::default_instance()
    }
}

impl EvolveBuildCoinNotify {
    pub fn new() -> EvolveBuildCoinNotify {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "CMMOFODEEFN",
            |m: &EvolveBuildCoinNotify| { &m.CMMOFODEEFN },
            |m: &mut EvolveBuildCoinNotify| { &mut m.CMMOFODEEFN },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "item_value",
...
impl ::protobuf::Message for EvolveBuildCoinNotify {
    const NAME: &'static str = "EvolveBuildCoinNotify";
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.CMMOFODEEFN != ::protobuf::EnumOrUnknown::new(super::KLNIPNJCNMJ::KLNIPNJCNMJ::EVOLVE_BUILD_SEASON_NONE) {
            my_size += ::protobuf::rt::int32_size(4, self.CMMOFODEEFN.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.CMMOFODEEFN != ::protobuf::EnumOrUnknown::new(super::KLNIPNJCNMJ::KLNIPNJCNMJ::EVOLVE_BUILD_SEASON_NONE) {
            os.write_enum(4, ::protobuf::EnumOrUnknown::value(&self.CMMOFODEEFN))?;
        }
        if self.item_value != 0 {
    ...
    fn new() -> EvolveBuildCoinNotify {
        EvolveBuildCoinNotify::new()
    }
...
impl ::protobuf::MessageFull for EvolveBuildCoinNotify {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("EvolveBuildCoinNotify").unwrap()).clone()
    }
}

impl ::std::fmt::Display for EvolveBuildCoinNotify {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for EvolveBuildCoinNotify {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1bEvolveBuildCoinNotify.proto\x1a\x11KLNIPNJCNMJ.proto\"f\n\x15Evolv\
    eBuildCoinNotify\x12.\n\x0bCMMOFODEEFN\x18\x04\x20\x01(\x0e2\x0c.KLNIPNJ\
    CNMJR\x0bCMMOFODEEFN\x12\x1d\n\nitem_value\x18\x0c\x20\x01(\rR\titemValu\
    eb\x06proto3\
";
