...
impl ::protobuf::Message for BPPMEIGAHGI {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.PDMDKAPCOJM != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.PDMDKAPCOJM);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.PDMDKAPCOJM != 0 {
            os.write_uint32(2, self.PDMDKAPCOJM)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    HGI\x12.\n\x0bMIGFMPJBELG\x18\x05\x20\x03(\x0b2\x0c.MMOIBACBPKAR\x0bMIGF\
    MPJBELG\x12\x20\n\x0bIOMGDIKELIA\x18\x03\x20\x01(\rR\x0bIOMGDIKELIA\x12\
    \x20\n\x0bPDMDKAPCOJM\x18\x02\x20\x01(\rR\x0bPDMDKAPCOJMb\x06proto3\
";
