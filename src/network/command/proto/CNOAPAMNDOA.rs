...
//! Generated file from `CNOAPAMNDOA.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:CNOAPAMNDOA)
...
pub struct CNOAPAMNDOA {
    ...
    pub retcode: u32,
    // special fields
    // @@protoc_insertion_point(special_field:CNOAPAMNDOA.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a CNOAPAMNDOA {
    fn default() -> &'a CNOAPAMNDOA {
        <CNOAPAMNDOA as ::protobuf::Message>::default_instance()
    }
}

impl CNOAPAMNDOA {
    pub fn new() -> CNOAPAMNDOA {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "retcode",
            |m: &CNOAPAMNDOA| { &m.retcode },
            |m: &mut CNOAPAMNDOA| { &mut m.retcode },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<CNOAPAMNDOA>(
            "CNOAPAMNDOA",
            fields,
            oneofs,
        )
...
impl ::protobuf::Message for CNOAPAMNDOA {
    const NAME: &'static str = "CNOAPAMNDOA";
...
impl ::protobuf::MessageFull for CNOAPAMNDOA {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("CNOAPAMNDOA").unwrap()).clone()
    }
}

impl ::std::fmt::Display for CNOAPAMNDOA {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for CNOAPAMNDOA {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::LHCOHLJIAII::file_descriptor().clone());
            deps.push(super::NBNLDHBELLO::file_descriptor().clone());
            let mut messages = ::std::vec::Vec::with_capacity(1);
            messages.push(CNOAPAMNDOA::generated_message_descriptor_data());
