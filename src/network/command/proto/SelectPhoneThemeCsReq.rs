...
pub struct SelectPhoneThemeCsReq {
    // message fields
    // @@protoc_insertion_point(field:SelectPhoneThemeCsReq.ONECPKEFAPP)
    pub ONECPKEFAPP: u32,
    // special fields
...
impl SelectPhoneThemeCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "ONECPKEFAPP",
            |m: &SelectPhoneThemeCsReq| { &m.ONECPKEFAPP },
            |m: &mut SelectPhoneThemeCsReq| { &mut m.ONECPKEFAPP },
        ));
...
impl ::protobuf::Message for SelectPhoneThemeCsReq {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                40 => {
                    self.ONECPKEFAPP = is.read_uint32()?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.ONECPKEFAPP != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.ONECPKEFAPP);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.ONECPKEFAPP != 0 {
            os.write_uint32(5, self.ONECPKEFAPP)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1bSelectPhoneThemeCsReq.proto\"9\n\x15SelectPhoneThemeCsReq\x12\x20\
    \n\x0bONECPKEFAPP\x18\x05\x20\x01(\rR\x0bONECPKEFAPPb\x06proto3\
";
