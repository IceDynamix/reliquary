...
impl ::protobuf::Message for CAAAKPFOEJI {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.JGBAINFDBAN != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.JGBAINFDBAN);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.JGBAINFDBAN != 0 {
            os.write_uint32(9, self.JGBAINFDBAN)?;
        }
        if let Some(v) = self.AHINPCKGKJG.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    EJI\x12\x20\n\x0bABLICGMCINN\x18\x03\x20\x01(\rR\x0bABLICGMCINN\x12\x20\
    \n\x0bJGBAINFDBAN\x18\t\x20\x01(\rR\x0bJGBAINFDBAN\x12.\n\x0bAHINPCKGKJG\
    \x18\x01\x20\x01(\x0b2\x0c.JPFJGFOPKHBR\x0bAHINPCKGKJG\x12\x20\n\x0bCFON\
    LBPOABP\x18\x08\x20\x01(\rR\x0bCFONLBPOABP\x12\x20\n\x0bDKKLLMOHGFD\x18\
    \x05\x20\x01(\rR\x0bDKKLLMOHGFDb\x06proto3\
";
