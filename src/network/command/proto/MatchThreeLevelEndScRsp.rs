...
pub struct MatchThreeLevelEndScRsp {
    // message fields
    // @@protoc_insertion_point(field:MatchThreeLevelEndScRsp.FBIKDJDCMLA)
    pub FBIKDJDCMLA: u32,
    // @@protoc_insertion_point(field:MatchThreeLevelEndScRsp.retcode)
    pub retcode: u32,
    // @@protoc_insertion_point(field:MatchThreeLevelEndScRsp.level_id)
    pub level_id: u32,
    // special fields
...
impl MatchThreeLevelEndScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "FBIKDJDCMLA",
            |m: &MatchThreeLevelEndScRsp| { &m.FBIKDJDCMLA },
            |m: &mut MatchThreeLevelEndScRsp| { &mut m.FBIKDJDCMLA },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "retcode",
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "level_id",
            |m: &MatchThreeLevelEndScRsp| { &m.level_id },
            |m: &mut MatchThreeLevelEndScRsp| { &mut m.level_id },
        ));
...
impl ::protobuf::Message for MatchThreeLevelEndScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.FBIKDJDCMLA != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.FBIKDJDCMLA);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.FBIKDJDCMLA != 0 {
            os.write_uint32(1, self.FBIKDJDCMLA)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1dMatchThreeLevelEndScRsp.proto\"p\n\x17MatchThreeLevelEndScRsp\x12\
    \x20\n\x0bFBIKDJDCMLA\x18\x01\x20\x01(\rR\x0bFBIKDJDCMLA\x12\x18\n\x07re\
    tcode\x18\x02\x20\x01(\rR\x07retcode\x12\x19\n\x08level_id\x18\x0b\x20\
    \x01(\rR\x07levelIdb\x06proto3\
";
