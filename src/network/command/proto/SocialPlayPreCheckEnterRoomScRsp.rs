...
//! Generated file from `SocialPlayPreCheckEnterRoomScRsp.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:SocialPlayPreCheckEnterRoomScRsp)
...
impl<'a> ::std::default::Default for &'a SocialPlayPreCheckEnterRoomScRsp {
    fn default() -> &'a SocialPlayPreCheckEnterRoomScRsp {
        <SocialPlayPreCheckEnterRoomScRsp as ::protobuf::Message>::default_instance()
    }
}

impl SocialPlayPreCheckEnterRoomScRsp {
    pub fn new() -> SocialPlayPreCheckEnterRoomScRsp {
...
impl ::protobuf::Message for SocialPlayPreCheckEnterRoomScRsp {
    const NAME: &'static str = "SocialPlayPreCheckEnterRoomScRsp";
    ...
    fn new() -> SocialPlayPreCheckEnterRoomScRsp {
        SocialPlayPreCheckEnterRoomScRsp::new()
    }
...
impl ::protobuf::MessageFull for SocialPlayPreCheckEnterRoomScRsp {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("SocialPlayPreCheckEnterRoomScRsp").unwrap()).clone()
    }
}

impl ::std::fmt::Display for SocialPlayPreCheckEnterRoomScRsp {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for SocialPlayPreCheckEnterRoomScRsp {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

static file_descriptor_proto_data: &'static [u8] = b"\
    \n&SocialPlayPreCheckEnterRoomScRsp.proto\"^\n\x20SocialPlayPreCheckEnte\
    rRoomScRsp\x12\x20\n\x0bCMHKFNFKGOI\x18\x0e\x20\x01(\x03R\x0bCMHKFNFKGOI\
