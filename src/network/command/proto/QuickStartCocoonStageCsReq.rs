...
impl ::protobuf::Message for QuickStartCocoonStageCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.HECCOBFBJFI != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.HECCOBFBJFI);
        }
        if self.cocoon_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.HECCOBFBJFI != 0 {
            os.write_uint32(5, self.HECCOBFBJFI)?;
        }
        if self.cocoon_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x20\x01(\rR\nworldLevel\x12\x20\n\x0bHECCOBFBJFI\x18\x05\x20\x01(\rR\
    \x0bHECCOBFBJFI\x12\x1b\n\tcocoon_id\x18\x07\x20\x01(\rR\x08cocoonId\x12\
    \x12\n\x04wave\x18\t\x20\x01(\rR\x04wave\x12.\n\x0bCBJCKEIGGNL\x18\x0f\
