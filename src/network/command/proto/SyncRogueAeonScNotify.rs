...
pub struct SyncRogueAeonScNotify {
    // message fields
    // @@protoc_insertion_point(field:SyncRogueAeonScNotify.GCJOGFLGBBH)
    pub GCJOGFLGBBH: ::protobuf::MessageField<super::NIKKCCAKNNP::NIKKCCAKNNP>,
    // special fields
...
impl SyncRogueAeonScNotify {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::NIKKCCAKNNP::NIKKCCAKNNP>(
            "GCJOGFLGBBH",
            |m: &SyncRogueAeonScNotify| { &m.GCJOGFLGBBH },
            |m: &mut SyncRogueAeonScNotify| { &mut m.GCJOGFLGBBH },
        ));
...
impl ::protobuf::Message for SyncRogueAeonScNotify {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                42 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.GCJOGFLGBBH)?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if let Some(v) = self.GCJOGFLGBBH.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1bSyncRogueAeonScNotify.proto\x1a\x11NIKKCCAKNNP.proto\"G\n\x15SyncR\
    ogueAeonScNotify\x12.\n\x0bGCJOGFLGBBH\x18\x05\x20\x01(\x0b2\x0c.NIKKCCA\
    KNNPR\x0bGCJOGFLGBBHb\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::NIKKCCAKNNP::file_descriptor().clone());
