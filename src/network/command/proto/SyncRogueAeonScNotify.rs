...
pub struct SyncRogueAeonScNotify {
    // message fields
    // @@protoc_insertion_point(field:SyncRogueAeonScNotify.aeon)
    pub aeon: ::protobuf::MessageField<super::RogueAeon::RogueAeon>,
    // special fields
...
impl SyncRogueAeonScNotify {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::RogueAeon::RogueAeon>(
            "aeon",
            |m: &SyncRogueAeonScNotify| { &m.aeon },
            |m: &mut SyncRogueAeonScNotify| { &mut m.aeon },
        ));
...
impl ::protobuf::Message for SyncRogueAeonScNotify {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                74 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.aeon)?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if let Some(v) = self.aeon.as_ref() {
    ...
    fn default_instance() -> &'static SyncRogueAeonScNotify {
        static instance: SyncRogueAeonScNotify = SyncRogueAeonScNotify {
            aeon: ::protobuf::MessageField::none(),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1bSyncRogueAeonScNotify.proto\x1a\x0fRogueAeon.proto\"7\n\x15SyncRog\
    ueAeonScNotify\x12\x1e\n\x04aeon\x18\t\x20\x01(\x0b2\n.RogueAeonR\x04aeo\
    nb\x06proto3\
";
