...
pub struct TakeChallengeRewardScRsp {
    // message fields
    // @@protoc_insertion_point(field:TakeChallengeRewardScRsp.OAKNHADPLJD)
    pub OAKNHADPLJD: ::protobuf::MessageField<super::ItemList::ItemList>,
...
impl TakeChallengeRewardScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::ItemList::ItemList>(
            "OAKNHADPLJD",
            |m: &TakeChallengeRewardScRsp| { &m.OAKNHADPLJD },
            |m: &mut TakeChallengeRewardScRsp| { &mut m.OAKNHADPLJD },
        ));
...
impl ::protobuf::Message for TakeChallengeRewardScRsp {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                58 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.OAKNHADPLJD)?;
                },
                82 => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if let Some(v) = self.OAKNHADPLJD.as_ref() {
    ...
    fn default_instance() -> &'static TakeChallengeRewardScRsp {
        static instance: TakeChallengeRewardScRsp = TakeChallengeRewardScRsp {
            OAKNHADPLJD: ::protobuf::MessageField::none(),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1eTakeChallengeRewardScRsp.proto\x1a\x0eItemList.proto\x1a\x1eTakenC\
    hallengeRewardInfo.proto\"\xc3\x01\n\x18TakeChallengeRewardScRsp\x12+\n\
    \x0bOAKNHADPLJD\x18\x07\x20\x01(\x0b2\t.ItemListR\x0bOAKNHADPLJD\x12E\n\
    \x11taken_reward_list\x18\n\x20\x03(\x0b2\x19.TakenChallengeRewardInfoR\
    \x0ftakenRewardList\x12\x18\n\x07retcode\x18\x03\x20\x01(\rR\x07retcode\
