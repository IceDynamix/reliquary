...
//! Generated file from `KAKEBEHFEIO.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:KAKEBEHFEIO)
...
pub struct KAKEBEHFEIO {
    ...
    pub rank: u32,
    // special fields
    // @@protoc_insertion_point(special_field:KAKEBEHFEIO.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a KAKEBEHFEIO {
    fn default() -> &'a KAKEBEHFEIO {
        <KAKEBEHFEIO as ::protobuf::Message>::default_instance()
    }
}

impl KAKEBEHFEIO {
    pub fn new() -> KAKEBEHFEIO {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "rank",
            |m: &KAKEBEHFEIO| { &m.rank },
            |m: &mut KAKEBEHFEIO| { &mut m.rank },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<KAKEBEHFEIO>(
            "KAKEBEHFEIO",
            fields,
            oneofs,
        )
...
impl ::protobuf::Message for KAKEBEHFEIO {
    const NAME: &'static str = "KAKEBEHFEIO";
...
impl ::protobuf::MessageFull for KAKEBEHFEIO {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("KAKEBEHFEIO").unwrap()).clone()
    }
}

impl ::std::fmt::Display for KAKEBEHFEIO {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for KAKEBEHFEIO {
