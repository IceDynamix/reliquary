...
impl ::protobuf::Message for INDGLKCECDC {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.DPJKOJGCJLP != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.DPJKOJGCJLP);
        }
        if self.FNIGPGBGEHN != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.FNIGPGBGEHN);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.DPJKOJGCJLP != 0 {
            os.write_uint32(15, self.DPJKOJGCJLP)?;
        }
        if self.FNIGPGBGEHN != 0 {
            os.write_uint32(1, self.FNIGPGBGEHN)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    AOF\x18\x0e\x20\x01(\rR\x0bPILAAGOKAOF\x12\x20\n\x0bHDILBDIPGHO\x18\x05\
    \x20\x01(\rR\x0bHDILBDIPGHO\x12\x10\n\x03uid\x18\n\x20\x01(\rR\x03uid\
    \x12\x20\n\x0bDPJKOJGCJLP\x18\x0f\x20\x01(\rR\x0bDPJKOJGCJLP\x12\x20\n\
    \x0bFNIGPGBGEHN\x18\x01\x20\x01(\rR\x0bFNIGPGBGEHNb\x06proto3\
";
