...
impl ::protobuf::Message for TextJoinQueryCsReq {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(9, &self.OBAOJAOAPBC);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(9, &self.OBAOJAOAPBC)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    BAOJAOAPBC\x18\t\x20\x03(\rR\x0bOBAOJAOAPBCb\x06proto3\
";
