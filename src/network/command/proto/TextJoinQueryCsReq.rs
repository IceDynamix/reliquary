...
pub struct TextJoinQueryCsReq {
    // message fields
    // @@protoc_insertion_point(field:TextJoinQueryCsReq.OBAOJAOAPBC)
    pub OBAOJAOAPBC: ::std::vec::Vec<u32>,
    // special fields
...
impl TextJoinQueryCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "OBAOJAOAPBC",
            |m: &TextJoinQueryCsReq| { &m.OBAOJAOAPBC },
            |m: &mut TextJoinQueryCsReq| { &mut m.OBAOJAOAPBC },
        ));
...
impl ::protobuf::Message for TextJoinQueryCsReq {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                98 => {
                    is.read_repeated_packed_uint32_into(&mut self.OBAOJAOAPBC)?;
                },
                96 => {
                    self.OBAOJAOAPBC.push(is.read_uint32()?);
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(12, &self.OBAOJAOAPBC);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(12, &self.OBAOJAOAPBC)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    BAOJAOAPBC\x18\x0c\x20\x03(\rR\x0bOBAOJAOAPBCb\x06proto3\
";
