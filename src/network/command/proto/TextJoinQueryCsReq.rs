...
impl ::protobuf::Message for TextJoinQueryCsReq {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(7, &self.PONENNKHCMJ);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(7, &self.PONENNKHCMJ)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ONENNKHCMJ\x18\x07\x20\x03(\rR\x0bPONENNKHCMJb\x06proto3\
";
