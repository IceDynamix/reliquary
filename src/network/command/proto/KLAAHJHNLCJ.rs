...
//! Generated file from `KLAAHJHNLCJ.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:KLAAHJHNLCJ)
...
impl<'a> ::std::default::Default for &'a KLAAHJHNLCJ {
    fn default() -> &'a KLAAHJHNLCJ {
        <KLAAHJHNLCJ as ::protobuf::Message>::default_instance()
    }
}

impl KLAAHJHNLCJ {
    pub fn new() -> KLAAHJHNLCJ {
...
impl ::protobuf::Message for KLAAHJHNLCJ {
    const NAME: &'static str = "KLAAHJHNLCJ";
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.CDIAJKEJDHA != false {
            os.write_bool(6, self.CDIAJKEJDHA)?;
        }
        if self.BHPCNNFOKEE != 0 {
...
impl ::protobuf::MessageFull for KLAAHJHNLCJ {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("KLAAHJHNLCJ").unwrap()).clone()
    }
}

impl ::std::fmt::Display for KLAAHJHNLCJ {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for KLAAHJHNLCJ {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x11KLAAHJHNLCJ.proto\"m\n\x0bKLAAHJHNLCJ\x12\x20\n\x0bCDIAJKEJDHA\x18\
    \x06\x20\x01(\x08R\x0bCDIAJKEJDHA\x12\x20\n\x0bBHPCNNFOKEE\x18\x03\x20\
    \x01(\rR\x0bBHPCNNFOKEE\x12\x1a\n\x08progress\x18\n\x20\x01(\rR\x08progr\
    essb\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(KLAAHJHNLCJ::generated_message_descriptor_data());
