...
impl ::protobuf::Message for ODAIJIGEAJL {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.EJHDCNEEGMI != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.EJHDCNEEGMI);
        }
        if self.FLJBJPAHJIF != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.FLJBJPAHJIF);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.HGMMCHHBKPB != false {
            os.write_bool(5, self.HGMMCHHBKPB)?;
        }
        if self.LJFGIFBDANC != false {
        ...
        if self.EJHDCNEEGMI != 0 {
            os.write_uint32(8, self.EJHDCNEEGMI)?;
        }
        if self.FLJBJPAHJIF != 0 {
            os.write_uint32(2, self.FLJBJPAHJIF)?;
        }
        if self.item_value != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    KPB\x18\x05\x20\x01(\x08R\x0bHGMMCHHBKPB\x12\x20\n\x0bLJFGIFBDANC\x18\
    \x0f\x20\x01(\x08R\x0bLJFGIFBDANC\x12\x20\n\x0bENGJFICHDML\x18\t\x20\x01\
    (\rR\x0bENGJFICHDML\x12\x20\n\x0bEJHDCNEEGMI\x18\x08\x20\x01(\rR\x0bEJHD\
    CNEEGMI\x12\x20\n\x0bFLJBJPAHJIF\x18\x02\x20\x01(\rR\x0bFLJBJPAHJIF\x12\
    \x1d\n\nitem_value\x18\x03\x20\x01(\rR\titemValueb\x06proto3\
";
