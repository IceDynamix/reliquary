...
impl ::protobuf::Message for AHCLNMJPMIJ {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.BPHCBOHKHMD != false {
            os.write_bool(6, self.BPHCBOHKHMD)?;
        }
        if self.miracle_id != 0 {
            os.write_uint32(12, self.miracle_id)?;
        }
        if self.POAPEGKPFOB != false {
            os.write_bool(5, self.POAPEGKPFOB)?;
        }
        if let Some(v) = self.cost_data.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    PMIJ\x12\x20\n\x0bBPHCBOHKHMD\x18\x06\x20\x01(\x08R\x0bBPHCBOHKHMD\x12\
    \x1d\n\nmiracle_id\x18\x0c\x20\x01(\rR\tmiracleId\x12\x20\n\x0bPOAPEGKPF\
    OB\x18\x05\x20\x01(\x08R\x0bPOAPEGKPFOB\x12*\n\tcost_data\x18\x07\x20\
    \x01(\x0b2\r.ItemCostDataR\x08costData\x12/\n\x0bNBLFFDIPBHI\x18\x0f\x20\
