...
impl ::protobuf::Message for AHCLNMJPMIJ {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.POAPEGKPFOB != false {
            os.write_bool(8, self.POAPEGKPFOB)?;
        }
        if let Some(v) = self.cost_data.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    PMIJ\x12\x20\n\x0bPOAPEGKPFOB\x18\x08\x20\x01(\x08R\x0bPOAPEGKPFOB\x12*\
    \n\tcost_data\x18\t\x20\x01(\x0b2\r.ItemCostDataR\x08costData\x12/\n\x0b\
    NBLFFDIPBHI\x18\x02\x20\x01(\x0b2\r.ItemCostDataR\x0bNBLFFDIPBHI\x12\x20\
    \n\x0bBPHCBOHKHMD\x18\x0b\x20\x01(\x08R\x0bBPHCBOHKHMD\x12\x1d\n\nmiracl\
    e_id\x18\x04\x20\x01(\rR\tmiracleIdb\x06proto3\
";
