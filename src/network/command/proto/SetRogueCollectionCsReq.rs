...
impl ::protobuf::Message for SetRogueCollectionCsReq {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(14, &self.FPIPMKCAGPD);
        my_size += ::protobuf::rt::vec_packed_enum_or_unknown_size(9, &self.LGHPHFPPJEN);
        my_size += ::protobuf::rt::vec_packed_uint32_size(2, &self.OPKMCIFFCCH);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(14, &self.FPIPMKCAGPD)?;
        os.write_repeated_packed_enum_or_unknown(9, &self.LGHPHFPPJEN)?;
        os.write_repeated_packed_uint32(2, &self.OPKMCIFFCCH)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    PD\x18\x0e\x20\x03(\rR\x0bFPIPMKCAGPD\x12G\n\x0bLGHPHFPPJEN\x18\t\x20\
    \x03(\x0e2%.RogueCollectionExhibitionOperateTypeR\x0bLGHPHFPPJEN\x12\x20\
    \n\x0bOPKMCIFFCCH\x18\x02\x20\x03(\rR\x0bOPKMCIFFCCHb\x06proto3\
";
