...
pub struct GetRogueCollectionScRsp {
    ...
    pub retcode: u32,
    // @@protoc_insertion_point(field:GetRogueCollectionScRsp.MFDCKNBIIEM)
    pub MFDCKNBIIEM: ::std::vec::Vec<super::AJAKDCDDAMO::AJAKDCDDAMO>,
    // @@protoc_insertion_point(field:GetRogueCollectionScRsp.HFPFBPCGPAM)
    pub HFPFBPCGPAM: ::std::vec::Vec<super::FKBFOOEFPAE::FKBFOOEFPAE>,
    // special fields
...
impl GetRogueCollectionScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "MFDCKNBIIEM",
            |m: &GetRogueCollectionScRsp| { &m.MFDCKNBIIEM },
            |m: &mut GetRogueCollectionScRsp| { &mut m.MFDCKNBIIEM },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "HFPFBPCGPAM",
            |m: &GetRogueCollectionScRsp| { &m.HFPFBPCGPAM },
            |m: &mut GetRogueCollectionScRsp| { &mut m.HFPFBPCGPAM },
        ));
...
impl ::protobuf::Message for GetRogueCollectionScRsp {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                74 => {
                    self.MFDCKNBIIEM.push(is.read_message()?);
                },
                106 => {
                    self.HFPFBPCGPAM.push(is.read_message()?);
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        for value in &self.MFDCKNBIIEM {
            let len = value.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
        };
        for value in &self.HFPFBPCGPAM {
            let len = value.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
        };
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        for v in &self.MFDCKNBIIEM {
            ::protobuf::rt::write_message_field_with_cached_size(9, v, os)?;
        };
        for v in &self.HFPFBPCGPAM {
    ...
    fn clear(&mut self) {
        self.retcode = 0;
        self.MFDCKNBIIEM.clear();
        self.HFPFBPCGPAM.clear();
    ...
    fn default_instance() -> &'static GetRogueCollectionScRsp {
        static instance: GetRogueCollectionScRsp = GetRogueCollectionScRsp {
            retcode: 0,
            MFDCKNBIIEM: ::std::vec::Vec::new(),
            HFPFBPCGPAM: ::std::vec::Vec::new(),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    e\x18\x02\x20\x01(\rR\x07retcode\x12.\n\x0bMFDCKNBIIEM\x18\t\x20\x03(\
    \x0b2\x0c.AJAKDCDDAMOR\x0bMFDCKNBIIEM\x12.\n\x0bHFPFBPCGPAM\x18\r\x20\
    \x03(\x0b2\x0c.FKBFOOEFPAER\x0bHFPFBPCGPAMb\x06proto3\
";
