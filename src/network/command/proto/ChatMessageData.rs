...
impl ::protobuf::Message for ChatMessageData {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.create_time != 0 {
            my_size += ::protobuf::rt::uint64_size(9, self.create_time);
        }
        ...
        if self.extra_id != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.extra_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.create_time != 0 {
            os.write_uint64(9, self.create_time)?;
        }
        if self.message_type != ::protobuf::EnumOrUnknown::new(super::MsgType::MsgType::MSG_TYPE_NONE) {
        ...
        if self.extra_id != 0 {
            os.write_uint32(6, self.extra_id)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x07content\x12.\n\x0bHNBEPABNBNG\x18\x07\x20\x01(\x0b2\x0c.PEDLPHDBNAFR\
    \x0bHNBEPABNBNG\x12\x1f\n\x0bcreate_time\x18\t\x20\x01(\x04R\ncreateTime\
    \x12+\n\x0cmessage_type\x18\x0c\x20\x01(\x0e2\x08.MsgTypeR\x0bmessageTyp\
    e\x12\x1b\n\tsender_id\x18\r\x20\x01(\rR\x08senderId\x12\x19\n\x08extra_\
    id\x18\x06\x20\x01(\rR\x07extraIdb\x06proto3\
";
