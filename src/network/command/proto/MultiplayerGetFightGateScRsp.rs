...
impl ::protobuf::Message for MultiplayerGetFightGateScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.NOGFEEMNHPC != 0 {
            my_size += ::protobuf::rt::uint64_size(3, self.NOGFEEMNHPC);
        }
        if self.retcode != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.retcode);
        }
        if self.port != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.port);
        }
        if !self.AOKCMMPFGBC.is_empty() {
            my_size += ::protobuf::rt::string_size(9, &self.AOKCMMPFGBC);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.NOGFEEMNHPC != 0 {
            os.write_uint64(3, self.NOGFEEMNHPC)?;
        }
        if self.retcode != 0 {
            os.write_uint32(1, self.retcode)?;
        }
        if self.port != 0 {
            os.write_uint32(10, self.port)?;
        }
        if !self.AOKCMMPFGBC.is_empty() {
            os.write_string(9, &self.AOKCMMPFGBC)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    tGateScRsp\x12\x0e\n\x02ip\x18\x06\x20\x01(\tR\x02ip\x12\x20\n\x0bNOGFEE\
    MNHPC\x18\x03\x20\x01(\x04R\x0bNOGFEEMNHPC\x12\x18\n\x07retcode\x18\x01\
    \x20\x01(\rR\x07retcode\x12\x12\n\x04port\x18\n\x20\x01(\rR\x04port\x12\
    \x20\n\x0bAOKCMMPFGBC\x18\t\x20\x01(\tR\x0bAOKCMMPFGBCb\x06proto3\
";
