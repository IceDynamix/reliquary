...
//! Generated file from `CEDCMIMKJHK.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:CEDCMIMKJHK)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct CEDCMIMKJHK {
    // message fields
...
impl<'a> ::std::default::Default for &'a CEDCMIMKJHK {
    fn default() -> &'a CEDCMIMKJHK {
        <CEDCMIMKJHK as ::protobuf::Message>::default_instance()
    }
}

impl CEDCMIMKJHK {
    pub fn new() -> CEDCMIMKJHK {
...
impl ::protobuf::Message for CEDCMIMKJHK {
    const NAME: &'static str = "CEDCMIMKJHK";
...
impl ::protobuf::MessageFull for CEDCMIMKJHK {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("CEDCMIMKJHK").unwrap()).clone()
    }
}

impl ::std::fmt::Display for CEDCMIMKJHK {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for CEDCMIMKJHK {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(CEDCMIMKJHK::generated_message_descriptor_data());
