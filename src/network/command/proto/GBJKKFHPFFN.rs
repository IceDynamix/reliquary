...
impl ::protobuf::Message for GBJKKFHPFFN {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.JFMOFIIDCNP != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.JFMOFIIDCNP);
        }
        if self.AKNKPKPLJHF != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.AKNKPKPLJHF);
        }
        ...
        if self.CMHGBBHKNCI != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.CMHGBBHKNCI);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.JFMOFIIDCNP != 0 {
            os.write_uint32(1, self.JFMOFIIDCNP)?;
        }
        if self.AKNKPKPLJHF != 0 {
            os.write_uint32(4, self.AKNKPKPLJHF)?;
        }
        if self.AJCIODKLLML != false {
        ...
        if self.CMHGBBHKNCI != 0 {
            os.write_uint32(11, self.CMHGBBHKNCI)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x0bDEKHDIBCFAB\x18\r\x20\x01(\x08R\x0bDEKHDIBCFAB\x12.\n\x0bNDJFNHFPC\
    GD\x18\x07\x20\x03(\x0b2\x0c.GOAMMAGCIJJR\x0bNDJFNHFPCGD\x12\x20\n\x0bJF\
    MOFIIDCNP\x18\x01\x20\x01(\rR\x0bJFMOFIIDCNP\x12\x20\n\x0bAKNKPKPLJHF\
    \x18\x04\x20\x01(\rR\x0bAKNKPKPLJHF\x12\x20\n\x0bAJCIODKLLML\x18\x03\x20\
    \x01(\x08R\x0bAJCIODKLLML\x12\x20\n\x0bFCLNOOGEHMC\x18\t\x20\x01(\rR\x0b\
    FCLNOOGEHMC\x12\x20\n\x0bCMHGBBHKNCI\x18\x0b\x20\x01(\rR\x0bCMHGBBHKNCIb\
    \x06proto3\
";
