...
pub struct UseItemCsReq {
    ...
    // @@protoc_insertion_point(field:UseItemCsReq.KANPPCMBJHG)
    pub KANPPCMBJHG: ::protobuf::EnumOrUnknown<super::AvatarType::AvatarType>,
    // @@protoc_insertion_point(field:UseItemCsReq.DGEKFCHEAPO)
    pub DGEKFCHEAPO: bool,
...
impl UseItemCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "KANPPCMBJHG",
            |m: &UseItemCsReq| { &m.KANPPCMBJHG },
            |m: &mut UseItemCsReq| { &mut m.KANPPCMBJHG },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "DGEKFCHEAPO",
            |m: &UseItemCsReq| { &m.DGEKFCHEAPO },
            |m: &mut UseItemCsReq| { &mut m.DGEKFCHEAPO },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "optional_reward_id",
...
impl ::protobuf::Message for UseItemCsReq {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                32 => {
                    self.KANPPCMBJHG = is.read_enum_or_unknown()?;
                },
                40 => {
                    self.DGEKFCHEAPO = is.read_bool()?;
                },
                72 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.use_item_id != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.use_item_id);
        }
        if self.use_item_count != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.use_item_count);
        }
        if self.KANPPCMBJHG != ::protobuf::EnumOrUnknown::new(super::AvatarType::AvatarType::AVATAR_TYPE_NONE) {
            my_size += ::protobuf::rt::int32_size(4, self.KANPPCMBJHG.value());
        }
        if self.DGEKFCHEAPO != false {
            my_size += 1 + 1;
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.use_item_id != 0 {
            os.write_uint32(1, self.use_item_id)?;
        }
        if self.use_item_count != 0 {
            os.write_uint32(2, self.use_item_count)?;
        }
        if self.KANPPCMBJHG != ::protobuf::EnumOrUnknown::new(super::AvatarType::AvatarType::AVATAR_TYPE_NONE) {
            os.write_enum(4, ::protobuf::EnumOrUnknown::value(&self.KANPPCMBJHG))?;
        }
        if self.DGEKFCHEAPO != false {
            os.write_bool(5, self.DGEKFCHEAPO)?;
        }
        if self.optional_reward_id != 0 {
    ...
    fn clear(&mut self) {
        ...
        self.KANPPCMBJHG = ::protobuf::EnumOrUnknown::new(super::AvatarType::AvatarType::AVATAR_TYPE_NONE);
        self.DGEKFCHEAPO = false;
    ...
    fn default_instance() -> &'static UseItemCsReq {
        static instance: UseItemCsReq = UseItemCsReq {
            use_item_id: 0,
            use_item_count: 0,
            KANPPCMBJHG: ::protobuf::EnumOrUnknown::from_i32(0),
            DGEKFCHEAPO: false,
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    sReq\x12\x1e\n\x0buse_item_id\x18\x01\x20\x01(\rR\tuseItemId\x12$\n\x0eu\
    se_item_count\x18\x02\x20\x01(\rR\x0cuseItemCount\x12-\n\x0bKANPPCMBJHG\
    \x18\x04\x20\x01(\x0e2\x0b.AvatarTypeR\x0bKANPPCMBJHG\x12\x20\n\x0bDGEKF\
    CHEAPO\x18\x05\x20\x01(\x08R\x0bDGEKFCHEAPO\x12,\n\x12optional_reward_id\
    \x18\t\x20\x01(\rR\x10optionalRewardId\x12$\n\x0ebase_avatar_id\x18\x0c\
