...
pub struct UseItemCsReq {
    ...
    // @@protoc_insertion_point(field:UseItemCsReq.DICCCKFOGBK)
    pub DICCCKFOGBK: u32,
    // @@protoc_insertion_point(field:UseItemCsReq.JILDEKGDDKB)
    pub JILDEKGDDKB: bool,
    // @@protoc_insertion_point(field:UseItemCsReq.base_avatar_id)
    pub base_avatar_id: u32,
    // @@protoc_insertion_point(field:UseItemCsReq.FJLJFANECON)
    pub FJLJFANECON: u32,
    // special fields
...
impl UseItemCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "DICCCKFOGBK",
            |m: &UseItemCsReq| { &m.DICCCKFOGBK },
            |m: &mut UseItemCsReq| { &mut m.DICCCKFOGBK },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "JILDEKGDDKB",
            |m: &UseItemCsReq| { &m.JILDEKGDDKB },
            |m: &mut UseItemCsReq| { &mut m.JILDEKGDDKB },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "base_avatar_id",
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "FJLJFANECON",
            |m: &UseItemCsReq| { &m.FJLJFANECON },
            |m: &mut UseItemCsReq| { &mut m.FJLJFANECON },
        ));
...
impl ::protobuf::Message for UseItemCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.use_avatar_type != ::protobuf::EnumOrUnknown::new(super::AvatarType::AvatarType::AVATAR_TYPE_NONE) {
            my_size += ::protobuf::rt::int32_size(2, self.use_avatar_type.value());
        }
        if self.optional_reward_id != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.optional_reward_id);
        }
        if self.DICCCKFOGBK != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.DICCCKFOGBK);
        }
        if self.JILDEKGDDKB != false {
            my_size += 1 + 1;
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.use_avatar_type != ::protobuf::EnumOrUnknown::new(super::AvatarType::AvatarType::AVATAR_TYPE_NONE) {
            os.write_enum(2, ::protobuf::EnumOrUnknown::value(&self.use_avatar_type))?;
        }
        if self.optional_reward_id != 0 {
            os.write_uint32(8, self.optional_reward_id)?;
        }
        if self.DICCCKFOGBK != 0 {
            os.write_uint32(9, self.DICCCKFOGBK)?;
        }
        if self.JILDEKGDDKB != false {
            os.write_bool(11, self.JILDEKGDDKB)?;
        }
        if self.base_avatar_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x12UseItemCsReq.proto\x1a\x10AvatarType.proto\"\xfd\x01\n\x0cUseItemC\
    sReq\x123\n\x0fuse_avatar_type\x18\x02\x20\x01(\x0e2\x0b.AvatarTypeR\rus\
    eAvatarType\x12,\n\x12optional_reward_id\x18\x08\x20\x01(\rR\x10optional\
    RewardId\x12\x20\n\x0bDICCCKFOGBK\x18\t\x20\x01(\rR\x0bDICCCKFOGBK\x12\
    \x20\n\x0bJILDEKGDDKB\x18\x0b\x20\x01(\x08R\x0bJILDEKGDDKB\x12$\n\x0ebas\
    e_avatar_id\x18\x0c\x20\x01(\rR\x0cbaseAvatarId\x12\x20\n\x0bFJLJFANECON\
    \x18\x0f\x20\x01(\rR\x0bFJLJFANECONb\x06proto3\
";
