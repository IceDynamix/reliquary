...
impl ::protobuf::Message for UseItemCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.KANPPCMBJHG != ::protobuf::EnumOrUnknown::new(super::AvatarType::AvatarType::AVATAR_TYPE_NONE) {
            my_size += ::protobuf::rt::int32_size(7, self.KANPPCMBJHG.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.KANPPCMBJHG != ::protobuf::EnumOrUnknown::new(super::AvatarType::AvatarType::AVATAR_TYPE_NONE) {
            os.write_enum(7, ::protobuf::EnumOrUnknown::value(&self.KANPPCMBJHG))?;
        }
        if self.optional_reward_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    sReq\x12\x20\n\x0bDGEKFCHEAPO\x18\x05\x20\x01(\x08R\x0bDGEKFCHEAPO\x12\
    \x1e\n\x0buse_item_id\x18\x06\x20\x01(\rR\tuseItemId\x12$\n\x0ebase_avat\
    ar_id\x18\x08\x20\x01(\rR\x0cbaseAvatarId\x12-\n\x0bKANPPCMBJHG\x18\x07\
    \x20\x01(\x0e2\x0b.AvatarTypeR\x0bKANPPCMBJHG\x12,\n\x12optional_reward_\
    id\x18\n\x20\x01(\rR\x10optionalRewardId\x12$\n\x0euse_item_count\x18\
    \x0f\x20\x01(\rR\x0cuseItemCountb\x06proto3\
";
