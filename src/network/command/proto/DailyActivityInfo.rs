...
impl ::protobuf::Message for DailyActivityInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.daily_active_point != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.daily_active_point);
        }
        if self.level != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.daily_active_point != 0 {
            os.write_uint32(2, self.daily_active_point)?;
        }
        if self.level != 0 {
        ...
        if self.is_has_taken != false {
            os.write_bool(13, self.is_has_taken)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12daily_active_point\x18\x02\x20\x01(\rR\x10dailyActivePoint\x12\x14\n\
    \x05level\x18\x07\x20\x01(\rR\x05level\x12\x1f\n\x0bworld_level\x18\x0f\
    \x20\x01(\rR\nworldLevel\x12\x20\n\x0cis_has_taken\x18\r\x20\x01(\x08R\n\
    isHasTakenb\x06proto3\
";
