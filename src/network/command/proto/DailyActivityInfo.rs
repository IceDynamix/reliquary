...
impl ::protobuf::Message for DailyActivityInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.daily_active_point != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.daily_active_point);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.daily_active_point != 0 {
            os.write_uint32(15, self.daily_active_point)?;
        }
        if self.world_level != 0 {
            os.write_uint32(9, self.world_level)?;
        }
        if self.is_has_taken != false {
            os.write_bool(6, self.is_has_taken)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0f\x20\x01(\rR\x10dailyActivePoint\x12\x1f\n\x0bworld_level\x18\t\x20\
    \x01(\rR\nworldLevel\x12\x20\n\x0cis_has_taken\x18\x06\x20\x01(\x08R\nis\
    HasTakenb\x06proto3\
";
