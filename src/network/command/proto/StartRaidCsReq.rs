...
impl ::protobuf::Message for StartRaidCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.is_save != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.is_save);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.is_save != 0 {
            os.write_uint32(7, self.is_save)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x14StartRaidCsReq.proto\"\xaa\x01\n\x0eStartRaidCsReq\x12\x1f\n\x0bwo\
    rld_level\x18\x05\x20\x01(\rR\nworldLevel\x12\x1f\n\x0bavatar_list\x18\r\
    \x20\x03(\rR\navatarList\x12\x17\n\x07raid_id\x18\t\x20\x01(\rR\x06raidI\
    d\x12$\n\x0eprop_entity_id\x18\x0e\x20\x01(\rR\x0cpropEntityId\x12\x17\n\
    \x07is_save\x18\x07\x20\x01(\rR\x06isSaveb\x06proto3\
";
