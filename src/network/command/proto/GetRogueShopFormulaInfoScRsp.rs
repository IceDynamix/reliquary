...
impl ::protobuf::Message for GetRogueShopFormulaInfoScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.EFOJOCFGIDJ != 0 {
            my_size += ::protobuf::rt::int32_size(6, self.EFOJOCFGIDJ);
        }
        if self.AEFHKANBFNC != 0 {
            my_size += ::protobuf::rt::int32_size(9, self.AEFHKANBFNC);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.EFOJOCFGIDJ != 0 {
            os.write_int32(6, self.EFOJOCFGIDJ)?;
        }
        if self.AEFHKANBFNC != 0 {
            os.write_int32(9, self.AEFHKANBFNC)?;
        }
        if let Some(v) = self.CKAANMDDKCJ.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    NAPAIOFJIE.proto\"\xdc\x01\n\x1cGetRogueShopFormulaInfoScRsp\x12\x18\n\
    \x07retcode\x18\x0e\x20\x01(\rR\x07retcode\x12\x20\n\x0bEFOJOCFGIDJ\x18\
    \x06\x20\x01(\x05R\x0bEFOJOCFGIDJ\x12\x20\n\x0bAEFHKANBFNC\x18\t\x20\x01\
    (\x05R\x0bAEFHKANBFNC\x12.\n\x0bCKAANMDDKCJ\x18\x01\x20\x01(\x0b2\x0c.GL\
    PPDLECCLIR\x0bCKAANMDDKCJ\x12.\n\x0bIHJHCCFMIFD\x18\x02\x20\x01(\x0b2\
