...
//! Generated file from `BLPLICDMFEL.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:BLPLICDMFEL)
...
impl<'a> ::std::default::Default for &'a BLPLICDMFEL {
    fn default() -> &'a BLPLICDMFEL {
        <BLPLICDMFEL as ::protobuf::Message>::default_instance()
    }
}

impl BLPLICDMFEL {
    pub fn new() -> BLPLICDMFEL {
...
impl ::protobuf::Message for BLPLICDMFEL {
    const NAME: &'static str = "BLPLICDMFEL";
...
impl ::protobuf::MessageFull for BLPLICDMFEL {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("BLPLICDMFEL").unwrap()).clone()
    }
}

impl ::std::fmt::Display for BLPLICDMFEL {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for BLPLICDMFEL {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::MJEIKNGOCJO::file_descriptor().clone());
            let mut messages = ::std::vec::Vec::with_capacity(1);
            messages.push(BLPLICDMFEL::generated_message_descriptor_data());
