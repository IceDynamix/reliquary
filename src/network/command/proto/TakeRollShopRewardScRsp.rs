...
impl ::protobuf::Message for TakeRollShopRewardScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.group_type != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.group_type);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.group_type != 0 {
            os.write_uint32(5, self.group_type)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x06reward\x18\x01\x20\x01(\x0b2\t.ItemListR\x06reward\x12\x1d\n\ngroup_\
    type\x18\x05\x20\x01(\rR\tgroupTypeb\x06proto3\
";
