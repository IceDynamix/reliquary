...
impl ::protobuf::Message for TakeRollShopRewardScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.group_type != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.group_type);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.group_type != 0 {
            os.write_uint32(8, self.group_type)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x17TakeRollShopRewardScRsp\x12!\n\x06reward\x18\x06\x20\x01(\x0b2\t.Ite\
    mListR\x06reward\x12\x1d\n\ngroup_type\x18\x08\x20\x01(\rR\tgroupType\
    \x12\x18\n\x07retcode\x18\x0b\x20\x01(\rR\x07retcode\x12\x20\n\x0croll_s\
    hop_id\x18\x0e\x20\x01(\rR\nrollShopIdb\x06proto3\
";
