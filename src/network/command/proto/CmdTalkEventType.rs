...
pub enum CmdTalkEventType {
    ...
    CmdGetFirstTalkByPerformanceNpcScRsp = 2169,
...
impl ::protobuf::Enum for CmdTalkEventType {
    ...
    fn from_i32(value: i32) -> ::std::option::Option<CmdTalkEventType> {
        match value {
            ...
            2194 => ::std::option::Option::Some(CmdTalkEventType::CmdFinishFirstTalkNpcCsReq),
            2199 => ::std::option::Option::Some(CmdTalkEventType::CmdGetNpcTakenRewardCsReq),
            2157 => ::std::option::Option::Some(CmdTalkEventType::CmdFinishFirstTalkByPerformanceNpcCsReq),
            2181 => ::std::option::Option::Some(CmdTalkEventType::CmdGetFirstTalkByPerformanceNpcCsReq),
            2198 => ::std::option::Option::Some(CmdTalkEventType::CmdTakeTalkRewardCsReq),
            2115 => ::std::option::Option::Some(CmdTalkEventType::CmdFinishFirstTalkByPerformanceNpcScRsp),
            2144 => ::std::option::Option::Some(CmdTalkEventType::CmdSelectInclinationTextScRsp),
            2152 => ::std::option::Option::Some(CmdTalkEventType::CmdFinishFirstTalkNpcScRsp),
            2165 => ::std::option::Option::Some(CmdTalkEventType::CmdTakeTalkRewardScRsp),
            2123 => ::std::option::Option::Some(CmdTalkEventType::CmdGetNpcTakenRewardScRsp),
            2186 => ::std::option::Option::Some(CmdTalkEventType::CmdGetFirstTalkNpcScRsp),
            2119 => ::std::option::Option::Some(CmdTalkEventType::CmdSelectInclinationTextCsReq),
            2169 => ::std::option::Option::Some(CmdTalkEventType::CmdGetFirstTalkByPerformanceNpcScRsp),
            2183 => ::std::option::Option::Some(CmdTalkEventType::CmdGetFirstTalkNpcCsReq),
...
impl ::protobuf::EnumFull for CmdTalkEventType {
    ...
    fn descriptor(&self) -> ::protobuf::reflect::EnumValueDescriptor {
        let index = match self {
            ...
            CmdTalkEventType::CmdFinishFirstTalkNpcCsReq => 1,
            CmdTalkEventType::CmdGetNpcTakenRewardCsReq => 2,
            CmdTalkEventType::CmdFinishFirstTalkByPerformanceNpcCsReq => 3,
            CmdTalkEventType::CmdGetFirstTalkByPerformanceNpcCsReq => 4,
            CmdTalkEventType::CmdTakeTalkRewardCsReq => 5,
            CmdTalkEventType::CmdFinishFirstTalkByPerformanceNpcScRsp => 6,
            ...
            CmdTalkEventType::CmdGetNpcTakenRewardScRsp => 10,
            CmdTalkEventType::CmdGetFirstTalkNpcScRsp => 11,
            CmdTalkEventType::CmdSelectInclinationTextCsReq => 12,
            CmdTalkEventType::CmdGetFirstTalkByPerformanceNpcScRsp => 13,
            CmdTalkEventType::CmdGetFirstTalkNpcCsReq => 14,
        };
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x10\x92\x11\x12\x1e\n\x19CmdGetNpcTakenRewardCsReq\x10\x97\x11\x12,\n'C\
    mdFinishFirstTalkByPerformanceNpcCsReq\x10\xed\x10\x12)\n$CmdGetFirstTal\
    kByPerformanceNpcCsReq\x10\x85\x11\x12\x1b\n\x16CmdTakeTalkRewardCsReq\
    \x10\x96\x11\x12,\n'CmdFinishFirstTalkByPerformanceNpcScRsp\x10\xc3\x10\
    \x12\"\n\x1dCmdSelectInclinationTextScRsp\x10\xe0\x10\x12\x1f\n\x1aCmdFi\
    nishFirstTalkNpcScRsp\x10\xe8\x10\x12\x1b\n\x16CmdTakeTalkRewardScRsp\
    \x10\xf5\x10\x12\x1e\n\x19CmdGetNpcTakenRewardScRsp\x10\xcb\x10\x12\x1c\
    \n\x17CmdGetFirstTalkNpcScRsp\x10\x8a\x11\x12\"\n\x1dCmdSelectInclinatio\
    nTextCsReq\x10\xc7\x10\x12)\n$CmdGetFirstTalkByPerformanceNpcScRsp\x10\
    \xf9\x10\x12\x1c\n\x17CmdGetFirstTalkNpcCsReq\x10\x87\x11b\x06proto3\
";
