...
//! Generated file from `DLCNDCKCIPC.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:DLCNDCKCIPC)
...
pub struct DLCNDCKCIPC {
    ...
    pub HGKBJIAAFPC: u32,
    // special fields
    // @@protoc_insertion_point(special_field:DLCNDCKCIPC.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a DLCNDCKCIPC {
    fn default() -> &'a DLCNDCKCIPC {
        <DLCNDCKCIPC as ::protobuf::Message>::default_instance()
    }
}

impl DLCNDCKCIPC {
    pub fn new() -> DLCNDCKCIPC {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "HGKBJIAAFPC",
            |m: &DLCNDCKCIPC| { &m.HGKBJIAAFPC },
            |m: &mut DLCNDCKCIPC| { &mut m.HGKBJIAAFPC },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<DLCNDCKCIPC>(
            "DLCNDCKCIPC",
            fields,
            oneofs,
        )
...
impl ::protobuf::Message for DLCNDCKCIPC {
    const NAME: &'static str = "DLCNDCKCIPC";
...
impl ::protobuf::MessageFull for DLCNDCKCIPC {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("DLCNDCKCIPC").unwrap()).clone()
    }
}

impl ::std::fmt::Display for DLCNDCKCIPC {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for DLCNDCKCIPC {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(DLCNDCKCIPC::generated_message_descriptor_data());
