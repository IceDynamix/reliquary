...
impl ::protobuf::Message for EnterStrongChallengeActivityStageCsReq {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(13, &self.buff_list);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(13, &self.buff_list)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \tbuff_list\x18\r\x20\x03(\rR\x08buffList\x127\n\x0bavatar_list\x18\x03\
