...
pub struct UpdatePsnSettingsInfoCsReq {
    ...
    pub CMBKKKAPAKM: ::std::option::Option<update_psn_settings_info_cs_req::CMBKKKAPAKM>,
    // special fields
...
impl UpdatePsnSettingsInfoCsReq {
    ...
    // .NCBIMLPODON DOOCPLCLDPD = 237;

    pub fn DOOCPLCLDPD(&self) -> &super::NCBIMLPODON::NCBIMLPODON {
        match self.CMBKKKAPAKM {
            ::std::option::Option::Some(update_psn_settings_info_cs_req::CMBKKKAPAKM::DOOCPLCLDPD(ref v)) => v,
            _ => <super::NCBIMLPODON::NCBIMLPODON as ::protobuf::Message>::default_instance(),
        }
    }

    pub fn clear_DOOCPLCLDPD(&mut self) {
        self.CMBKKKAPAKM = ::std::option::Option::None;
    }

    pub fn has_DOOCPLCLDPD(&self) -> bool {
        match self.CMBKKKAPAKM {
            ::std::option::Option::Some(update_psn_settings_info_cs_req::CMBKKKAPAKM::DOOCPLCLDPD(..)) => true,
            _ => false,
        }
    }
    ...
    pub fn set_DOOCPLCLDPD(&mut self, v: super::NCBIMLPODON::NCBIMLPODON) {
        self.CMBKKKAPAKM = ::std::option::Option::Some(update_psn_settings_info_cs_req::CMBKKKAPAKM::DOOCPLCLDPD(v))
    }

    // Mutable pointer to the field.
    pub fn mut_DOOCPLCLDPD(&mut self) -> &mut super::NCBIMLPODON::NCBIMLPODON {
        if let ::std::option::Option::Some(update_psn_settings_info_cs_req::CMBKKKAPAKM::DOOCPLCLDPD(_)) = self.CMBKKKAPAKM {
        } else {
            self.CMBKKKAPAKM = ::std::option::Option::Some(update_psn_settings_info_cs_req::CMBKKKAPAKM::DOOCPLCLDPD(super::NCBIMLPODON::NCBIMLPODON::new()));
        }
        match self.CMBKKKAPAKM {
            ::std::option::Option::Some(update_psn_settings_info_cs_req::CMBKKKAPAKM::DOOCPLCLDPD(ref mut v)) => v,
            _ => panic!(),
        }
    }
    ...
    pub fn take_DOOCPLCLDPD(&mut self) -> super::NCBIMLPODON::NCBIMLPODON {
        if self.has_DOOCPLCLDPD() {
            match self.CMBKKKAPAKM.take() {
                ::std::option::Option::Some(update_psn_settings_info_cs_req::CMBKKKAPAKM::DOOCPLCLDPD(v)) => v,
                _ => panic!(),
            }
        } else {
    ...
    // .CJAKIBDIMMJ INHLDIDJGHA = 908;

    pub fn INHLDIDJGHA(&self) -> &super::CJAKIBDIMMJ::CJAKIBDIMMJ {
        match self.CMBKKKAPAKM {
            ::std::option::Option::Some(update_psn_settings_info_cs_req::CMBKKKAPAKM::INHLDIDJGHA(ref v)) => v,
    ...
    pub fn has_INHLDIDJGHA(&self) -> bool {
        match self.CMBKKKAPAKM {
            ::std::option::Option::Some(update_psn_settings_info_cs_req::CMBKKKAPAKM::INHLDIDJGHA(..)) => true,
            _ => false,
        }
    }
    ...
    pub fn set_INHLDIDJGHA(&mut self, v: super::CJAKIBDIMMJ::CJAKIBDIMMJ) {
        self.CMBKKKAPAKM = ::std::option::Option::Some(update_psn_settings_info_cs_req::CMBKKKAPAKM::INHLDIDJGHA(v))
    }

    // Mutable pointer to the field.
    pub fn mut_INHLDIDJGHA(&mut self) -> &mut super::CJAKIBDIMMJ::CJAKIBDIMMJ {
        if let ::std::option::Option::Some(update_psn_settings_info_cs_req::CMBKKKAPAKM::INHLDIDJGHA(_)) = self.CMBKKKAPAKM {
        } else {
            self.CMBKKKAPAKM = ::std::option::Option::Some(update_psn_settings_info_cs_req::CMBKKKAPAKM::INHLDIDJGHA(super::CJAKIBDIMMJ::CJAKIBDIMMJ::new()));
        }
        match self.CMBKKKAPAKM {
            ::std::option::Option::Some(update_psn_settings_info_cs_req::CMBKKKAPAKM::INHLDIDJGHA(ref mut v)) => v,
            _ => panic!(),
        }
    }
    ...
    pub fn take_INHLDIDJGHA(&mut self) -> super::CJAKIBDIMMJ::CJAKIBDIMMJ {
        if self.has_INHLDIDJGHA() {
            match self.CMBKKKAPAKM.take() {
                ::std::option::Option::Some(update_psn_settings_info_cs_req::CMBKKKAPAKM::INHLDIDJGHA(v)) => v,
                _ => panic!(),
            }
        } else {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        oneofs.push(update_psn_settings_info_cs_req::CMBKKKAPAKM::generated_oneof_descriptor_data());
...
impl ::protobuf::Message for UpdatePsnSettingsInfoCsReq {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                1898 => {
                    self.CMBKKKAPAKM = ::std::option::Option::Some(update_psn_settings_info_cs_req::CMBKKKAPAKM::DOOCPLCLDPD(is.read_message()?));
                },
                7266 => {
                    self.CMBKKKAPAKM = ::std::option::Option::Some(update_psn_settings_info_cs_req::CMBKKKAPAKM::INHLDIDJGHA(is.read_message()?));
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if let ::std::option::Option::Some(ref v) = self.CMBKKKAPAKM {
            match v {
                &update_psn_settings_info_cs_req::CMBKKKAPAKM::DOOCPLCLDPD(ref v) => {
                    let len = v.compute_size();
                    my_size += 2 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
                },
                &update_psn_settings_info_cs_req::CMBKKKAPAKM::INHLDIDJGHA(ref v) => {
                    let len = v.compute_size();
                    my_size += 2 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
                },
            };
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if let ::std::option::Option::Some(ref v) = self.CMBKKKAPAKM {
            match v {
                &update_psn_settings_info_cs_req::CMBKKKAPAKM::DOOCPLCLDPD(ref v) => {
                    ::protobuf::rt::write_message_field_with_cached_size(237, v, os)?;
                },
                &update_psn_settings_info_cs_req::CMBKKKAPAKM::INHLDIDJGHA(ref v) => {
    ...
    fn default_instance() -> &'static UpdatePsnSettingsInfoCsReq {
        static instance: UpdatePsnSettingsInfoCsReq = UpdatePsnSettingsInfoCsReq {
            CMBKKKAPAKM: ::std::option::Option::None,
...
pub mod update_psn_settings_info_cs_req {
    ...
    #[non_exhaustive]
    // @@protoc_insertion_point(oneof:UpdatePsnSettingsInfoCsReq.CMBKKKAPAKM)
    pub enum CMBKKKAPAKM {
    ...
    impl ::protobuf::Oneof for CMBKKKAPAKM {
    }

    impl ::protobuf::OneofFull for CMBKKKAPAKM {
        fn descriptor() -> ::protobuf::reflect::OneofDescriptor {
            static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::OneofDescriptor> = ::protobuf::rt::Lazy::new();
            descriptor.get(|| <super::UpdatePsnSettingsInfoCsReq as ::protobuf::MessageFull>::descriptor().oneof_by_name("CMBKKKAPAKM").unwrap()).clone()
        }
    }

    impl CMBKKKAPAKM {
        pub(in super) fn generated_oneof_descriptor_data() -> ::protobuf::reflect::GeneratedOneofDescriptorData {
            ::protobuf::reflect::GeneratedOneofDescriptorData::new::<CMBKKKAPAKM>("CMBKKKAPAKM")
        }
    }
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    CPLCLDPD\x18\xed\x01\x20\x01(\x0b2\x0c.NCBIMLPODONH\0R\x0bDOOCPLCLDPD\
    \x121\n\x0bINHLDIDJGHA\x18\x8c\x07\x20\x01(\x0b2\x0c.CJAKIBDIMMJH\0R\x0b\
    INHLDIDJGHAB\r\n\x0bCMBKKKAPAKMb\x06proto3\
";
