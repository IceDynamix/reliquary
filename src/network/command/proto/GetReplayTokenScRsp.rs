...
impl ::protobuf::Message for GetReplayTokenScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.replay_type != ::protobuf::EnumOrUnknown::new(super::ReplayType::ReplayType::REPLAY_TYPE_NONE) {
            my_size += ::protobuf::rt::int32_size(14, self.replay_type.value());
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.replay_type != ::protobuf::EnumOrUnknown::new(super::ReplayType::ReplayType::REPLAY_TYPE_NONE) {
            os.write_enum(14, ::protobuf::EnumOrUnknown::value(&self.replay_type))?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    etReplayTokenScRsp\x12\x20\n\x0bKIHBIGPFKKN\x18\x06\x20\x01(\tR\x0bKIHBI\
    GPFKKN\x12\x19\n\x08stage_id\x18\x0f\x20\x01(\rR\x07stageId\x12,\n\x0bre\
    play_type\x18\x0e\x20\x01(\x0e2\x0b.ReplayTypeR\nreplayType\x12\x18\n\
    \x07retcode\x18\x0c\x20\x01(\rR\x07retcode\x12\x14\n\x05token\x18\x05\
    \x20\x01(\tR\x05tokenb\x06proto3\
";
