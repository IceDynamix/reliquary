...
pub struct GetReplayTokenScRsp {
    ...
    // @@protoc_insertion_point(field:GetReplayTokenScRsp.PCJHHFOMKJJ)
    pub PCJHHFOMKJJ: ::std::string::String,
    // @@protoc_insertion_point(field:GetReplayTokenScRsp.retcode)
    pub retcode: u32,
    // @@protoc_insertion_point(field:GetReplayTokenScRsp.token)
...
impl GetReplayTokenScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "PCJHHFOMKJJ",
            |m: &GetReplayTokenScRsp| { &m.PCJHHFOMKJJ },
            |m: &mut GetReplayTokenScRsp| { &mut m.PCJHHFOMKJJ },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "retcode",
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "token",
            |m: &GetReplayTokenScRsp| { &m.token },
            |m: &mut GetReplayTokenScRsp| { &mut m.token },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "stage_id",
...
impl ::protobuf::Message for GetReplayTokenScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.replay_type != ::protobuf::EnumOrUnknown::new(super::ReplayType::ReplayType::ReplayType_GKJBAODJMJG) {
            my_size += ::protobuf::rt::int32_size(9, self.replay_type.value());
        }
        if !self.PCJHHFOMKJJ.is_empty() {
            my_size += ::protobuf::rt::string_size(4, &self.PCJHHFOMKJJ);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.replay_type != ::protobuf::EnumOrUnknown::new(super::ReplayType::ReplayType::ReplayType_GKJBAODJMJG) {
            os.write_enum(9, ::protobuf::EnumOrUnknown::value(&self.replay_type))?;
        }
        if !self.PCJHHFOMKJJ.is_empty() {
            os.write_string(4, &self.PCJHHFOMKJJ)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x19GetReplayTokenScRsp.proto\x1a\x10ReplayType.proto\"\xb0\x01\n\x13G\
    etReplayTokenScRsp\x12,\n\x0breplay_type\x18\t\x20\x01(\x0e2\x0b.ReplayT\
    ypeR\nreplayType\x12\x20\n\x0bPCJHHFOMKJJ\x18\x04\x20\x01(\tR\x0bPCJHHFO\
    MKJJ\x12\x18\n\x07retcode\x18\x08\x20\x01(\rR\x07retcode\x12\x14\n\x05to\
    ken\x18\x03\x20\x01(\tR\x05token\x12\x19\n\x08stage_id\x18\x0b\x20\x01(\
