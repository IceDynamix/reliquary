...
impl ::protobuf::Message for RotateMapCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.GLHAGJGAEHE != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.GLHAGJGAEHE);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.GLHAGJGAEHE != 0 {
            os.write_uint32(1, self.GLHAGJGAEHE)?;
        }
        if let Some(v) = self.motion.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    proto\"\x9f\x01\n\x0eRotateMapCsReq\x12+\n\trogue_map\x18\x06\x20\x01(\
    \x0b2\x0e.RotateMapInfoR\x08rogueMap\x12\x20\n\x0bGLHAGJGAEHE\x18\x01\
    \x20\x01(\rR\x0bGLHAGJGAEHE\x12#\n\x06motion\x18\x05\x20\x01(\x0b2\x0b.M\
    otionInfoR\x06motion\x12\x19\n\x08group_id\x18\x0e\x20\x01(\rR\x07groupI\
    db\x06proto3\
";
