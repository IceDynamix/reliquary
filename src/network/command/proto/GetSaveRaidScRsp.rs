...
impl ::protobuf::Message for GetSaveRaidScRsp {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.JGEAEGMHDOC != false {
            os.write_bool(7, self.JGEAEGMHDOC)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    SaveRaidScRsp\x12\x20\n\x0bCENIFNKNFNP\x18\x0b\x20\x01(\rR\x0bCENIFNKNFN\
    P\x12.\n\x0bLHEILNACNOD\x18\x0e\x20\x03(\x0b2\x0c.HOCHOIHKKDGR\x0bLHEILN\
    ACNOD\x12\x20\n\x0bJGEAEGMHDOC\x18\x07\x20\x01(\x08R\x0bJGEAEGMHDOC\x12\
