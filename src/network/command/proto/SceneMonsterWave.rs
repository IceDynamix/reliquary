...
impl ::protobuf::Message for SceneMonsterWave {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.battle_wave_id != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.battle_wave_id);
        }
        if self.battle_stage_id != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.battle_stage_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.battle_wave_id != 0 {
            os.write_uint32(11, self.battle_wave_id)?;
        }
        if self.battle_stage_id != 0 {
            os.write_uint32(4, self.battle_stage_id)?;
        }
        if let Some(v) = self.monster_param.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12+\n\x0bJCDLJGHHAOF\x18\x0c\x20\x03(\x0b2\t.ItemListR\x0bJCDLJGHHAOF\
    \x12$\n\x0ebattle_wave_id\x18\x0b\x20\x01(\rR\x0cbattleWaveId\x12&\n\x0f\
    battle_stage_id\x18\x04\x20\x01(\rR\rbattleStageId\x12;\n\rmonster_param\
    \x18\x02\x20\x01(\x0b2\x16.SceneMonsterWaveParamR\x0cmonsterParam\x120\n\
    \x0cmonster_list\x18\n\x20\x03(\x0b2\r.SceneMonsterR\x0bmonsterListb\x06\
    proto3\
";
