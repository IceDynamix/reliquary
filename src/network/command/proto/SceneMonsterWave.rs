...
pub struct SceneMonsterWave {
    // message fields
    // @@protoc_insertion_point(field:SceneMonsterWave.NMGIABHIJJB)
    pub NMGIABHIJJB: ::std::vec::Vec<super::ItemList::ItemList>,
...
impl SceneMonsterWave {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "NMGIABHIJJB",
            |m: &SceneMonsterWave| { &m.NMGIABHIJJB },
            |m: &mut SceneMonsterWave| { &mut m.NMGIABHIJJB },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "monster_list",
...
impl ::protobuf::Message for SceneMonsterWave {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                34 => {
                    self.NMGIABHIJJB.push(is.read_message()?);
                },
                58 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.battle_stage_id != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.battle_stage_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.battle_stage_id != 0 {
            os.write_uint32(2, self.battle_stage_id)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12+\n\x0bNMGIABHIJJB\x18\x04\x20\x03(\x0b2\t.ItemListR\x0bNMGIABHIJJB\
    \x120\n\x0cmonster_list\x18\x07\x20\x03(\x0b2\r.SceneMonsterR\x0bmonster\
    List\x12;\n\rmonster_param\x18\x0b\x20\x01(\x0b2\x16.SceneMonsterWavePar\
    amR\x0cmonsterParam\x12$\n\x0ebattle_wave_id\x18\x0e\x20\x01(\rR\x0cbatt\
    leWaveId\x12&\n\x0fbattle_stage_id\x18\x02\x20\x01(\rR\rbattleStageIdb\
    \x06proto3\
";
