...
impl ::protobuf::Message for SceneMonsterWave {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.battle_wave_id != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.battle_wave_id);
        }
        ...
        if self.battle_stage_id != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.battle_stage_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.battle_wave_id != 0 {
            os.write_uint32(9, self.battle_wave_id)?;
        }
        if let Some(v) = self.monster_param.as_ref() {
        ...
        if self.battle_stage_id != 0 {
            os.write_uint32(8, self.battle_stage_id)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x120\n\x0cmonster_list\x18\x04\x20\x03(\x0b2\r.SceneMonsterR\x0bmonster\
    List\x12$\n\x0ebattle_wave_id\x18\t\x20\x01(\rR\x0cbattleWaveId\x12;\n\r\
    monster_param\x18\r\x20\x01(\x0b2\x16.SceneMonsterWaveParamR\x0cmonsterP\
    aram\x12+\n\x0bJCDLJGHHAOF\x18\x0b\x20\x03(\x0b2\t.ItemListR\x0bJCDLJGHH\
    AOF\x12&\n\x0fbattle_stage_id\x18\x08\x20\x01(\rR\rbattleStageIdb\x06pro\
    to3\
";
