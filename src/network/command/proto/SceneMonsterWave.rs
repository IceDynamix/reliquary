...
impl ::protobuf::Message for SceneMonsterWave {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.battle_wave_id != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.battle_wave_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.battle_wave_id != 0 {
            os.write_uint32(8, self.battle_wave_id)?;
        }
        if self.battle_stage_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12+\n\x0bNMGIABHIJJB\x18\x03\x20\x03(\x0b2\t.ItemListR\x0bNMGIABHIJJB\
    \x12$\n\x0ebattle_wave_id\x18\x08\x20\x01(\rR\x0cbattleWaveId\x12&\n\x0f\
    battle_stage_id\x18\x0c\x20\x01(\rR\rbattleStageId\x120\n\x0cmonster_lis\
    t\x18\r\x20\x03(\x0b2\r.SceneMonsterR\x0bmonsterList\x12;\n\rmonster_par\
    am\x18\x0f\x20\x01(\x0b2\x16.SceneMonsterWaveParamR\x0cmonsterParamb\x06\
    proto3\
";
