...
impl ::protobuf::Message for RecallPetScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.select_pet_id != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.select_pet_id);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.select_pet_id != 0 {
            os.write_uint32(11, self.select_pet_id)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x0b\x20\x01(\rR\x0bselectPetId\x12\x18\n\x07retcode\x18\x07\x20\x01\
    (\rR\x07retcode\x12\x1c\n\ncur_pet_id\x18\x08\x20\x01(\rR\x08curPetIdb\
    \x06proto3\
";
