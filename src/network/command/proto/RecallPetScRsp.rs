...
impl ::protobuf::Message for RecallPetScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.select_pet_id != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.select_pet_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.select_pet_id != 0 {
            os.write_uint32(14, self.select_pet_id)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x04\x20\x01(\rR\x07retcode\x12\x1c\n\ncur_pet_id\x18\x08\x20\x01(\r\
    R\x08curPetId\x12\"\n\rselect_pet_id\x18\x0e\x20\x01(\rR\x0bselectPetIdb\
    \x06proto3\
";
