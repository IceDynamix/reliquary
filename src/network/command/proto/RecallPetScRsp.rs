...
impl ::protobuf::Message for RecallPetScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.select_pet_id != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.select_pet_id);
        }
        if self.cur_pet_id != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.cur_pet_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.select_pet_id != 0 {
            os.write_uint32(3, self.select_pet_id)?;
        }
        if self.cur_pet_id != 0 {
            os.write_uint32(12, self.cur_pet_id)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x02\x20\x01(\rR\x07retcode\x12\"\n\rselect_pet_id\x18\x03\x20\x01(\
    \rR\x0bselectPetId\x12\x1c\n\ncur_pet_id\x18\x0c\x20\x01(\rR\x08curPetId\
    b\x06proto3\
";
