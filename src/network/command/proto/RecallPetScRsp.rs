...
pub struct RecallPetScRsp {
    ...
    pub retcode: u32,
    // @@protoc_insertion_point(field:RecallPetScRsp.pet_item_id)
    pub pet_item_id: u32,
    // @@protoc_insertion_point(field:RecallPetScRsp.pet_id)
    pub pet_id: u32,
    // special fields
...
impl RecallPetScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "pet_item_id",
            |m: &RecallPetScRsp| { &m.pet_item_id },
            |m: &mut RecallPetScRsp| { &mut m.pet_item_id },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "pet_id",
            |m: &RecallPetScRsp| { &m.pet_id },
            |m: &mut RecallPetScRsp| { &mut m.pet_id },
        ));
...
impl ::protobuf::Message for RecallPetScRsp {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                24 => {
                    self.pet_item_id = is.read_uint32()?;
                },
                64 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.pet_item_id != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.pet_item_id);
        }
        if self.pet_id != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.pet_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.pet_item_id != 0 {
            os.write_uint32(3, self.pet_item_id)?;
        }
        if self.pet_id != 0 {
            os.write_uint32(8, self.pet_id)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x14RecallPetScRsp.proto\"a\n\x0eRecallPetScRsp\x12\x18\n\x07retcode\
    \x18\x01\x20\x01(\rR\x07retcode\x12\x1e\n\x0bpet_item_id\x18\x03\x20\x01\
    (\rR\tpetItemId\x12\x15\n\x06pet_id\x18\x08\x20\x01(\rR\x05petIdb\x06pro\
    to3\
";
