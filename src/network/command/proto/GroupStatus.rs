...
impl ::protobuf::Message for GroupStatus {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.refresh_time != 0 {
            my_size += ::protobuf::rt::int64_size(4, self.refresh_time);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.refresh_time != 0 {
            os.write_int64(4, self.refresh_time)?;
        }
        if self.group_status != ::protobuf::EnumOrUnknown::new(super::MessageGroupStatus::MessageGroupStatus::MESSAGE_GROUP_NONE) {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    refresh_time\x18\x04\x20\x01(\x03R\x0brefreshTime\x126\n\x0cgroup_status\
    \x18\x07\x20\x01(\x0e2\x13.MessageGroupStatusR\x0bgroupStatusb\x06proto3\
";
