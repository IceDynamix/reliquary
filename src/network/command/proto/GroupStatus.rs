...
impl ::protobuf::Message for GroupStatus {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.group_status != ::protobuf::EnumOrUnknown::new(super::MessageGroupStatus::MessageGroupStatus::MESSAGE_GROUP_NONE) {
            my_size += ::protobuf::rt::int32_size(15, self.group_status.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.group_status != ::protobuf::EnumOrUnknown::new(super::MessageGroupStatus::MessageGroupStatus::MESSAGE_GROUP_NONE) {
            os.write_enum(15, ::protobuf::EnumOrUnknown::value(&self.group_status))?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    roupStatus\x12!\n\x0crefresh_time\x18\x01\x20\x01(\x03R\x0brefreshTime\
    \x12\x19\n\x08group_id\x18\x05\x20\x01(\rR\x07groupId\x126\n\x0cgroup_st\
    atus\x18\x0f\x20\x01(\x0e2\x13.MessageGroupStatusR\x0bgroupStatusb\x06pr\
    oto3\
";
