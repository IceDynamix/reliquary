...
impl ::protobuf::Message for GroupStatus {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.group_status != ::protobuf::EnumOrUnknown::new(super::MessageGroupStatus::MessageGroupStatus::MESSAGE_GROUP_NONE) {
            my_size += ::protobuf::rt::int32_size(7, self.group_status.value());
        }
        if self.group_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.group_status != ::protobuf::EnumOrUnknown::new(super::MessageGroupStatus::MessageGroupStatus::MESSAGE_GROUP_NONE) {
            os.write_enum(7, ::protobuf::EnumOrUnknown::value(&self.group_status))?;
        }
        if self.group_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    roupStatus\x12!\n\x0crefresh_time\x18\x06\x20\x01(\x03R\x0brefreshTime\
    \x126\n\x0cgroup_status\x18\x07\x20\x01(\x0e2\x13.MessageGroupStatusR\
    \x0bgroupStatus\x12\x19\n\x08group_id\x18\x03\x20\x01(\rR\x07groupIdb\
    \x06proto3\
";
