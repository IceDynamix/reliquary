...
impl ::protobuf::Message for GroupStatus {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.group_status != ::protobuf::EnumOrUnknown::new(super::MessageGroupStatus::MessageGroupStatus::MESSAGE_GROUP_NONE) {
            my_size += ::protobuf::rt::int32_size(10, self.group_status.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.group_status != ::protobuf::EnumOrUnknown::new(super::MessageGroupStatus::MessageGroupStatus::MESSAGE_GROUP_NONE) {
            os.write_enum(10, ::protobuf::EnumOrUnknown::value(&self.group_status))?;
        }
        if self.refresh_time != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    roupStatus\x12\x19\n\x08group_id\x18\x01\x20\x01(\rR\x07groupId\x126\n\
    \x0cgroup_status\x18\n\x20\x01(\x0e2\x13.MessageGroupStatusR\x0bgroupSta\
    tus\x12!\n\x0crefresh_time\x18\x03\x20\x01(\x03R\x0brefreshTimeb\x06prot\
    o3\
";
