...
impl ::protobuf::Message for CGOMNLBLJGH {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.AFGKFIFJFCL != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.AFGKFIFJFCL);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.AFGKFIFJFCL != 0 {
            os.write_uint32(12, self.AFGKFIFJFCL)?;
        }
        if let Some(v) = self.OMCBCGCHLGN.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x0bAFGKFIFJFCL\x18\x0c\x20\x01(\rR\x0bAFGKFIFJFCL\x12.\n\x0bOMCBCGCHL\
    GN\x18\x0e\x20\x01(\x0b2\x0c.HLDHEMLPJNGR\x0bOMCBCGCHLGNb\x06proto3\
";
