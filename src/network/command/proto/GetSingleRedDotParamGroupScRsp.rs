...
impl ::protobuf::Message for GetSingleRedDotParamGroupScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.NOPDKLDEKKF != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.NOPDKLDEKKF);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.NOPDKLDEKKF != 0 {
            os.write_uint32(15, self.NOPDKLDEKKF)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x20\x01(\rR\x07panelId\x12\x20\n\x0bNOPDKLDEKKF\x18\x0f\x20\x01(\rR\x0b\
    NOPDKLDEKKF\x12\x18\n\x07retcode\x18\t\x20\x01(\rR\x07retcode\x12.\n\x0b\
    CHPJJKLGOKM\x18\x0c\x20\x01(\x0b2\x0c.EJBIOKMOLAFR\x0bCHPJJKLGOKM\x12\
