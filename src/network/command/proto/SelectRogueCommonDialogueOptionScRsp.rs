...
impl ::protobuf::Message for SelectRogueCommonDialogueOptionScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(5, &self.effect_event_id_list);
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_uint32(5, &self.effect_event_id_list)?;
        if self.retcode != 0 {
            os.write_uint32(11, self.retcode)?;
        }
        if self.event_has_effect != false {
            os.write_bool(10, self.event_has_effect)?;
        }
        if self.event_unique_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    logue_data\x18\x03\x20\x01(\x0b2\x1c.RogueCommonDialogueDataInfoR\x0cdia\
    logueData\x12\x1b\n\toption_id\x18\x08\x20\x01(\rR\x08optionId\x12/\n\
    \x14effect_event_id_list\x18\x05\x20\x03(\rR\x11effectEventIdList\x12\
    \x18\n\x07retcode\x18\x0b\x20\x01(\rR\x07retcode\x12(\n\x10event_has_eff\
    ect\x18\n\x20\x01(\x08R\x0eeventHasEffect\x12&\n\x0fevent_unique_id\x18\
    \x0f\x20\x01(\rR\reventUniqueIdb\x06proto3\
";
