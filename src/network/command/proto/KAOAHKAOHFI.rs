...
impl ::protobuf::Message for KAOAHKAOHFI {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.COJKEIFJNEK != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.COJKEIFJNEK);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.COJKEIFJNEK != 0 {
            os.write_uint32(15, self.COJKEIFJNEK)?;
        }
        if self.EKKJLAOKIJI != ::protobuf::EnumOrUnknown::new(super::PunkLordAttackerStatus::PunkLordAttackerStatus::PUNK_LORD_ATTACKER_STATUS_NONE) {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x01\n\x0bKAOAHKAOHFI\x12;\n\x0bDHLPKMIHDNM\x18\r\x20\x01(\x0b2\x19.Punk\
    LordBattleRecordListR\x0bDHLPKMIHDNM\x12\x20\n\x0bCOJKEIFJNEK\x18\x0f\
