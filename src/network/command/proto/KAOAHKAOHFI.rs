...
impl ::protobuf::Message for KAOAHKAOHFI {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.COJKEIFJNEK != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.COJKEIFJNEK);
        }
        ...
        if self.EKKJLAOKIJI != ::protobuf::EnumOrUnknown::new(super::PunkLordAttackerStatus::PunkLordAttackerStatus::PUNK_LORD_ATTACKER_STATUS_NONE) {
            my_size += ::protobuf::rt::int32_size(10, self.EKKJLAOKIJI.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.COJKEIFJNEK != 0 {
            os.write_uint32(12, self.COJKEIFJNEK)?;
        }
        if let Some(v) = self.DHLPKMIHDNM.as_ref() {
        ...
        if self.EKKJLAOKIJI != ::protobuf::EnumOrUnknown::new(super::PunkLordAttackerStatus::PunkLordAttackerStatus::PUNK_LORD_ATTACKER_STATUS_NONE) {
            os.write_enum(10, ::protobuf::EnumOrUnknown::value(&self.EKKJLAOKIJI))?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x0bCOJKEIFJNEK\x18\x0c\x20\x01(\rR\x0bCOJKEIFJNEK\x12.\n\x0bDHLPKMIHD\
    NM\x18\x02\x20\x01(\x0b2\x0c.FDHAMNOJNIOR\x0bDHLPKMIHDNM\x12.\n\x0bGPKGJ\
    LNHPJK\x18\x0e\x20\x01(\x0b2\x0c.GJNAAGHKOOKR\x0bGPKGJLNHPJK\x129\n\x0bE\
    KKJLAOKIJI\x18\n\x20\x01(\x0e2\x17.PunkLordAttackerStatusR\x0bEKKJLAOKIJ\
    Ib\x06proto3\
";
