...
impl ::protobuf::Message for GetAetherDivideChallengeInfoScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.PCNNMJBJIOC != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.PCNNMJBJIOC);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(7, &self.BFDIPGBLMMO);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.PCNNMJBJIOC != 0 {
            os.write_uint32(13, self.PCNNMJBJIOC)?;
        }
        os.write_repeated_packed_uint32(7, &self.BFDIPGBLMMO)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    allengeInfoScRsp\x12\x20\n\x0bPCNNMJBJIOC\x18\r\x20\x01(\rR\x0bPCNNMJBJI\
    OC\x12\x20\n\x0bBFDIPGBLMMO\x18\x07\x20\x03(\rR\x0bBFDIPGBLMMO\x12\x20\n\
    \x0bGKHJKFCCCGP\x18\x0c\x20\x03(\rR\x0bGKHJKFCCCGP\x12\x18\n\x07retcode\
