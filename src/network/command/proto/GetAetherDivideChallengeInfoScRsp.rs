...
impl ::protobuf::Message for GetAetherDivideChallengeInfoScRsp {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(2, &self.GKHJKFCCCGP);
        if self.PCNNMJBJIOC != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.PCNNMJBJIOC);
        }
        if self.retcode != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.retcode);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(13, &self.BFDIPGBLMMO);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(2, &self.GKHJKFCCCGP)?;
        if self.PCNNMJBJIOC != 0 {
            os.write_uint32(14, self.PCNNMJBJIOC)?;
        }
        if self.retcode != 0 {
            os.write_uint32(5, self.retcode)?;
        }
        os.write_repeated_packed_uint32(13, &self.BFDIPGBLMMO)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    allengeInfoScRsp\x12\x20\n\x0bGKHJKFCCCGP\x18\x02\x20\x03(\rR\x0bGKHJKFC\
    CCGP\x12\x20\n\x0bPCNNMJBJIOC\x18\x0e\x20\x01(\rR\x0bPCNNMJBJIOC\x12\x18\
    \n\x07retcode\x18\x05\x20\x01(\rR\x07retcode\x12\x20\n\x0bBFDIPGBLMMO\
    \x18\r\x20\x03(\rR\x0bBFDIPGBLMMOb\x06proto3\
";
