...
//! Generated file from `ONOEPLFNELL.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:ONOEPLFNELL)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct ONOEPLFNELL {
    // message fields
    // @@protoc_insertion_point(field:ONOEPLFNELL.avatar_type)
...
impl<'a> ::std::default::Default for &'a ONOEPLFNELL {
    fn default() -> &'a ONOEPLFNELL {
        <ONOEPLFNELL as ::protobuf::Message>::default_instance()
    }
}

impl ONOEPLFNELL {
    pub fn new() -> ONOEPLFNELL {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "avatar_type",
            |m: &ONOEPLFNELL| { &m.avatar_type },
            |m: &mut ONOEPLFNELL| { &mut m.avatar_type },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "avatar_id",
...
impl ::protobuf::Message for ONOEPLFNELL {
    const NAME: &'static str = "ONOEPLFNELL";
...
impl ::protobuf::MessageFull for ONOEPLFNELL {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("ONOEPLFNELL").unwrap()).clone()
    }
}

impl ::std::fmt::Display for ONOEPLFNELL {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for ONOEPLFNELL {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(ONOEPLFNELL::generated_message_descriptor_data());
