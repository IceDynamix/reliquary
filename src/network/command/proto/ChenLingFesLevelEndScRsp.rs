...
//! Generated file from `ChenLingFesLevelEndScRsp.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:ChenLingFesLevelEndScRsp)
...
pub struct ChenLingFesLevelEndScRsp {
    ...
    pub retcode: u32,
    // special fields
    // @@protoc_insertion_point(special_field:ChenLingFesLevelEndScRsp.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a ChenLingFesLevelEndScRsp {
    fn default() -> &'a ChenLingFesLevelEndScRsp {
        <ChenLingFesLevelEndScRsp as ::protobuf::Message>::default_instance()
    }
}

impl ChenLingFesLevelEndScRsp {
    pub fn new() -> ChenLingFesLevelEndScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "retcode",
            |m: &ChenLingFesLevelEndScRsp| { &m.retcode },
            |m: &mut ChenLingFesLevelEndScRsp| { &mut m.retcode },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<ChenLingFesLevelEndScRsp>(
            "ChenLingFesLevelEndScRsp",
            fields,
            oneofs,
        )
    }
...
impl ::protobuf::Message for ChenLingFesLevelEndScRsp {
    const NAME: &'static str = "ChenLingFesLevelEndScRsp";
    ...
    fn new() -> ChenLingFesLevelEndScRsp {
        ChenLingFesLevelEndScRsp::new()
    }
...
impl ::protobuf::MessageFull for ChenLingFesLevelEndScRsp {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("ChenLingFesLevelEndScRsp").unwrap()).clone()
    }
}

impl ::std::fmt::Display for ChenLingFesLevelEndScRsp {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for ChenLingFesLevelEndScRsp {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(ChenLingFesLevelEndScRsp::generated_message_descriptor_data());
