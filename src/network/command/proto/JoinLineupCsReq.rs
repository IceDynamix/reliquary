...
pub struct JoinLineupCsReq {
    // message fields
    // @@protoc_insertion_point(field:JoinLineupCsReq.NJDMFPFKKIH)
    pub NJDMFPFKKIH: ::protobuf::EnumOrUnknown<super::ExtraLineupType::ExtraLineupType>,
    // @@protoc_insertion_point(field:JoinLineupCsReq.CGGDOGDIDNK)
    pub CGGDOGDIDNK: u32,
    // @@protoc_insertion_point(field:JoinLineupCsReq.EGMAFIOOKJJ)
    pub EGMAFIOOKJJ: u32,
    // @@protoc_insertion_point(field:JoinLineupCsReq.PDONLOOBBCI)
    pub PDONLOOBBCI: u32,
    // @@protoc_insertion_point(field:JoinLineupCsReq.IHLEAMDIKKN)
    ...
    // @@protoc_insertion_point(field:JoinLineupCsReq.HCDNLLHBBOK)
...
impl JoinLineupCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "NJDMFPFKKIH",
            |m: &JoinLineupCsReq| { &m.NJDMFPFKKIH },
            |m: &mut JoinLineupCsReq| { &mut m.NJDMFPFKKIH },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "CGGDOGDIDNK",
            |m: &JoinLineupCsReq| { &m.CGGDOGDIDNK },
            |m: &mut JoinLineupCsReq| { &mut m.CGGDOGDIDNK },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "EGMAFIOOKJJ",
            |m: &JoinLineupCsReq| { &m.EGMAFIOOKJJ },
            |m: &mut JoinLineupCsReq| { &mut m.EGMAFIOOKJJ },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "PDONLOOBBCI",
            |m: &JoinLineupCsReq| { &m.PDONLOOBBCI },
            |m: &mut JoinLineupCsReq| { &mut m.PDONLOOBBCI },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "IHLEAMDIKKN",
            |m: &JoinLineupCsReq| { &m.IHLEAMDIKKN },
            |m: &mut JoinLineupCsReq| { &mut m.IHLEAMDIKKN },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "base_avatar_id",
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "HCDNLLHBBOK",
            |m: &JoinLineupCsReq| { &m.HCDNLLHBBOK },
            |m: &mut JoinLineupCsReq| { &mut m.HCDNLLHBBOK },
        ));
...
impl ::protobuf::Message for JoinLineupCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.EGMAFIOOKJJ != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.EGMAFIOOKJJ);
        }
        if self.PDONLOOBBCI != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.PDONLOOBBCI);
        }
        if self.IHLEAMDIKKN != ::protobuf::EnumOrUnknown::new(super::AvatarType::AvatarType::AVATAR_TYPE_NONE) {
            my_size += ::protobuf::rt::int32_size(5, self.IHLEAMDIKKN.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.EGMAFIOOKJJ != 0 {
            os.write_uint32(9, self.EGMAFIOOKJJ)?;
        }
        if self.PDONLOOBBCI != 0 {
            os.write_uint32(7, self.PDONLOOBBCI)?;
        }
        if self.IHLEAMDIKKN != ::protobuf::EnumOrUnknown::new(super::AvatarType::AvatarType::AVATAR_TYPE_NONE) {
            os.write_enum(5, ::protobuf::EnumOrUnknown::value(&self.IHLEAMDIKKN))?;
        }
        if self.base_avatar_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    pe.proto\"\xa2\x02\n\x0fJoinLineupCsReq\x122\n\x0bNJDMFPFKKIH\x18\x0b\
    \x20\x01(\x0e2\x10.ExtraLineupTypeR\x0bNJDMFPFKKIH\x12\x20\n\x0bCGGDOGDI\
    DNK\x18\n\x20\x01(\rR\x0bCGGDOGDIDNK\x12\x20\n\x0bEGMAFIOOKJJ\x18\t\x20\
    \x01(\rR\x0bEGMAFIOOKJJ\x12\x20\n\x0bPDONLOOBBCI\x18\x07\x20\x01(\rR\x0b\
    PDONLOOBBCI\x12-\n\x0bIHLEAMDIKKN\x18\x05\x20\x01(\x0e2\x0b.AvatarTypeR\
    \x0bIHLEAMDIKKN\x12$\n\x0ebase_avatar_id\x18\x03\x20\x01(\rR\x0cbaseAvat\
    arId\x12\x20\n\x0bHCDNLLHBBOK\x18\x04\x20\x01(\x08R\x0bHCDNLLHBBOKb\x06p\
    roto3\
";
