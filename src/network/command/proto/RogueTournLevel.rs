...
impl ::protobuf::Message for RogueTournLevel {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.level_index != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.level_index);
        }
        if self.layer_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.level_index != 0 {
            os.write_uint32(9, self.level_index)?;
        }
        if self.layer_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    gueTournRoomList.proto\"\xe0\x01\n\x0fRogueTournLevel\x12\x1f\n\x0blevel\
    _index\x18\t\x20\x01(\rR\nlevelIndex\x12\x19\n\x08layer_id\x18\x05\x20\
    \x01(\rR\x07layerId\x12;\n\x0ftourn_room_list\x18\r\x20\x03(\x0b2\x13.Ro\
    gueTournRoomListR\rtournRoomList\x12.\n\x06status\x18\x0e\x20\x01(\x0e2\
    \x16.RogueTournLayerStatusR\x06status\x12$\n\x0ecur_room_index\x18\n\x20\
    \x01(\rR\x0ccurRoomIndexb\x06proto3\
";
