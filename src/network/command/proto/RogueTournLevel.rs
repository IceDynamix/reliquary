...
pub struct RogueTournLevel {
    ...
    // @@protoc_insertion_point(field:RogueTournLevel.tourn_room_list)
    pub tourn_room_list: ::std::vec::Vec<super::RogueTournRoomList::RogueTournRoomList>,
...
impl RogueTournLevel {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "tourn_room_list",
            |m: &RogueTournLevel| { &m.tourn_room_list },
            |m: &mut RogueTournLevel| { &mut m.tourn_room_list },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "layer_id",
...
impl ::protobuf::Message for RogueTournLevel {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.level_index != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.level_index);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.level_index != 0 {
            os.write_uint32(6, self.level_index)?;
        }
        if self.status != ::protobuf::EnumOrUnknown::new(super::RogueTournLayerStatus::RogueTournLayerStatus::ROGUE_TOURN_LAYER_STATUS_NONE) {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    gueTournRoomList.proto\"\xe0\x01\n\x0fRogueTournLevel\x12$\n\x0ecur_room\
    _index\x18\x02\x20\x01(\rR\x0ccurRoomIndex\x12;\n\x0ftourn_room_list\x18\
    \x08\x20\x03(\x0b2\x13.RogueTournRoomListR\rtournRoomList\x12\x19\n\x08l\
    ayer_id\x18\x0b\x20\x01(\rR\x07layerId\x12\x1f\n\x0blevel_index\x18\x06\
    \x20\x01(\rR\nlevelIndex\x12.\n\x06status\x18\x0f\x20\x01(\x0e2\x16.Rogu\
    eTournLayerStatusR\x06statusb\x06proto3\
";
