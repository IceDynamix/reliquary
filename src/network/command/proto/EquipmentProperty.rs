...
//! Generated file from `EquipmentProperty.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:EquipmentProperty)
...
impl<'a> ::std::default::Default for &'a EquipmentProperty {
    fn default() -> &'a EquipmentProperty {
        <EquipmentProperty as ::protobuf::Message>::default_instance()
    }
}

impl EquipmentProperty {
    pub fn new() -> EquipmentProperty {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "promotion",
            |m: &EquipmentProperty| { &m.promotion },
...
impl ::protobuf::Message for EquipmentProperty {
    const NAME: &'static str = "EquipmentProperty";
...
impl ::protobuf::MessageFull for EquipmentProperty {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("EquipmentProperty").unwrap()).clone()
    }
}

impl ::std::fmt::Display for EquipmentProperty {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for EquipmentProperty {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(EquipmentProperty::generated_message_descriptor_data());
