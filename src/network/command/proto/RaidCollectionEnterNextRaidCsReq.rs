...
impl ::protobuf::Message for RaidCollectionEnterNextRaidCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.is_save != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.is_save);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.is_save != 0 {
            os.write_uint32(2, self.is_save)?;
        }
