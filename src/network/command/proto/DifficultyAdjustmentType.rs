...
pub enum DifficultyAdjustmentType {
    // @@protoc_insertion_point(enum_value:DifficultyAdjustmentType.IEKKFNMODPB_CHPJNDAHILJ)
    IEKKFNMODPB_CHPJNDAHILJ = 0,
    // @@protoc_insertion_point(enum_value:DifficultyAdjustmentType.IEKKFNMODPB_FELIDDGLAEA)
    IEKKFNMODPB_FELIDDGLAEA = 1,
}
...
impl ::protobuf::Enum for DifficultyAdjustmentType {
    ...
    fn from_i32(value: i32) -> ::std::option::Option<DifficultyAdjustmentType> {
        match value {
            0 => ::std::option::Option::Some(DifficultyAdjustmentType::IEKKFNMODPB_CHPJNDAHILJ),
            1 => ::std::option::Option::Some(DifficultyAdjustmentType::IEKKFNMODPB_FELIDDGLAEA),
    ...
    fn from_str(str: &str) -> ::std::option::Option<DifficultyAdjustmentType> {
        match str {
            "IEKKFNMODPB_CHPJNDAHILJ" => ::std::option::Option::Some(DifficultyAdjustmentType::IEKKFNMODPB_CHPJNDAHILJ),
            "IEKKFNMODPB_FELIDDGLAEA" => ::std::option::Option::Some(DifficultyAdjustmentType::IEKKFNMODPB_FELIDDGLAEA),
            _ => ::std::option::Option::None
        }
    }

    const VALUES: &'static [DifficultyAdjustmentType] = &[
        DifficultyAdjustmentType::IEKKFNMODPB_CHPJNDAHILJ,
        DifficultyAdjustmentType::IEKKFNMODPB_FELIDDGLAEA,
    ];
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x1b\n\x17IEKKFNMODPB_CHPJNDAHILJ\x10\0\x12\x1b\n\x17IEKKFNMODPB_FELIDDG\
    LAEA\x10\x01b\x06proto3\
";
