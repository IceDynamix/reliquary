...
impl ::protobuf::Message for MMEINFMDJFG {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.KBMMMMCKJNI != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.KBMMMMCKJNI);
        }
        if self.script_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.KBMMMMCKJNI != 0 {
            os.write_uint32(14, self.KBMMMMCKJNI)?;
        }
        if self.script_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0e\x20\x01(\rR\x0bKBMMMMCKJNI\x12\x1b\n\tscript_id\x18\x06\x20\x01(\rR\
