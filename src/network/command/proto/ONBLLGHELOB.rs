...
//! Generated file from `ONBLLGHELOB.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:ONBLLGHELOB)
...
impl<'a> ::std::default::Default for &'a ONBLLGHELOB {
    fn default() -> &'a ONBLLGHELOB {
        <ONBLLGHELOB as ::protobuf::Message>::default_instance()
    }
}

impl ONBLLGHELOB {
    pub fn new() -> ONBLLGHELOB {
...
impl ::protobuf::Message for ONBLLGHELOB {
    const NAME: &'static str = "ONBLLGHELOB";
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.ENGEPMPCJPC != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.ENGEPMPCJPC);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.ENGEPMPCJPC != 0 {
            os.write_uint32(13, self.ENGEPMPCJPC)?;
        }
...
impl ::protobuf::MessageFull for ONBLLGHELOB {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("ONBLLGHELOB").unwrap()).clone()
    }
}

impl ::std::fmt::Display for ONBLLGHELOB {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for ONBLLGHELOB {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x11ONBLLGHELOB.proto\"Q\n\x0bONBLLGHELOB\x12\x20\n\x0bNGONANKBKMF\x18\
    \x08\x20\x03(\rR\x0bNGONANKBKMF\x12\x20\n\x0bENGEPMPCJPC\x18\r\x20\x01(\
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(ONBLLGHELOB::generated_message_descriptor_data());
