...
impl ::protobuf::Message for NHBDDINFKOH {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.IIMOPLCFHAH != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.IIMOPLCFHAH);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.IIMOPLCFHAH != 0 {
            os.write_uint32(3, self.IIMOPLCFHAH)?;
        }
        if self.LLJAEGOBHMP != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    HAH\x18\x03\x20\x01(\rR\x0bIIMOPLCFHAH\x12\x20\n\x0bLLJAEGOBHMP\x18\n\
    \x20\x01(\x05R\x0bLLJAEGOBHMP\x12\x17\n\x07item_id\x18\x0b\x20\x01(\rR\
    \x06itemId\x12\x1b\n\tunique_id\x18\x0c\x20\x01(\x04R\x08uniqueId\x12\
    \x20\n\x0bIEAGBPEMFLG\x18\x02\x20\x01(\x05R\x0bIEAGBPEMFLG\x12\x20\n\x0b\
    KBCDECDNEFM\x18\x0e\x20\x01(\rR\x0bKBCDECDNEFMb\x06proto3\
";
