...
impl ::protobuf::Message for ChessRogueStartCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(2, &self.start_difficulty_id_list);
        if self.id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_uint32(2, &self.start_difficulty_id_list)?;
        if self.id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    -\n\x13base_avatar_id_list\x18\t\x20\x03(\rR\x10baseAvatarIdList\x12\x20\
    \n\x0bHJGNDHLMMIB\x18\x01\x20\x03(\rR\x0bHJGNDHLMMIB\x12\x1b\n\tbranch_i\
    d\x18\x05\x20\x01(\rR\x08branchId\x12\x17\n\x07aeon_id\x18\x08\x20\x01(\
    \rR\x06aeonId\x12/\n\x14trial_avatar_id_list\x18\x0e\x20\x03(\rR\x11tria\
    lAvatarIdList\x127\n\x18start_difficulty_id_list\x18\x02\x20\x03(\rR\x15\
    startDifficultyIdList\x12\x0e\n\x02id\x18\x07\x20\x01(\rR\x02idb\x06prot\
    o3\
";
