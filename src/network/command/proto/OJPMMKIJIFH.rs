...
//! Generated file from `OJPMMKIJIFH.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:OJPMMKIJIFH)
...
impl<'a> ::std::default::Default for &'a OJPMMKIJIFH {
    fn default() -> &'a OJPMMKIJIFH {
        <OJPMMKIJIFH as ::protobuf::Message>::default_instance()
    }
}

impl OJPMMKIJIFH {
    pub fn new() -> OJPMMKIJIFH {
...
impl ::protobuf::Message for OJPMMKIJIFH {
    const NAME: &'static str = "OJPMMKIJIFH";
    ...
    fn default_instance() -> &'static OJPMMKIJIFH {
        static instance: ::protobuf::rt::Lazy<OJPMMKIJIFH> = ::protobuf::rt::Lazy::new();
        instance.get(OJPMMKIJIFH::new)
    }
}

impl ::protobuf::MessageFull for OJPMMKIJIFH {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("OJPMMKIJIFH").unwrap()).clone()
    }
}

impl ::std::fmt::Display for OJPMMKIJIFH {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for OJPMMKIJIFH {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(OJPMMKIJIFH::generated_message_descriptor_data());
