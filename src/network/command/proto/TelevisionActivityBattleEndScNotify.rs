...
impl ::protobuf::Message for TelevisionActivityBattleEndScNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.FCEPIPCCOMN != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.FCEPIPCCOMN);
        }
        ...
        if self.FIDIOIHLLGA != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.FIDIOIHLLGA);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.FCEPIPCCOMN != 0 {
            os.write_uint32(1, self.FCEPIPCCOMN)?;
        }
        if self.HOEHIOBIIEJ != 0 {
        ...
        if self.FIDIOIHLLGA != 0 {
            os.write_uint32(12, self.FIDIOIHLLGA)?;
        }
        if self.NPJEECEDPOK != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x01\x20\x01(\rR\x0bFCEPIPCCOMN\x12\x20\n\x0bHOEHIOBIIEJ\x18\x0e\x20\
    \x01(\rR\x0bHOEHIOBIIEJ\x12.\n\x0bDFCCBDPNLEA\x18\x06\x20\x01(\x0b2\x0c.\
    OGJDNLIJKFBR\x0bDFCCBDPNLEA\x12\x20\n\x0bFIDIOIHLLGA\x18\x0c\x20\x01(\rR\
    \x0bFIDIOIHLLGA\x12\x20\n\x0bNPJEECEDPOK\x18\x0b\x20\x01(\rR\x0bNPJEECED\
    POKb\x06proto3\
";
