...
impl ::protobuf::Message for TelevisionActivityBattleEndScNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.FIDIOIHLLGA != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.FIDIOIHLLGA);
        }
        if self.HOEHIOBIIEJ != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.HOEHIOBIIEJ);
        }
        if self.FCEPIPCCOMN != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.FCEPIPCCOMN);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.FIDIOIHLLGA != 0 {
            os.write_uint32(9, self.FIDIOIHLLGA)?;
        }
        if self.HOEHIOBIIEJ != 0 {
            os.write_uint32(1, self.HOEHIOBIIEJ)?;
        }
        if self.FCEPIPCCOMN != 0 {
            os.write_uint32(10, self.FCEPIPCCOMN)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x0b\x20\x01(\rR\x0bNPJEECEDPOK\x12.\n\x0bDFCCBDPNLEA\x18\x0c\x20\
    \x01(\x0b2\x0c.OGJDNLIJKFBR\x0bDFCCBDPNLEA\x12\x20\n\x0bFIDIOIHLLGA\x18\
    \t\x20\x01(\rR\x0bFIDIOIHLLGA\x12\x20\n\x0bHOEHIOBIIEJ\x18\x01\x20\x01(\
    \rR\x0bHOEHIOBIIEJ\x12\x20\n\x0bFCEPIPCCOMN\x18\n\x20\x01(\rR\x0bFCEPIPC\
    COMNb\x06proto3\
";
