...
impl ::protobuf::Message for PlayerHeartBeatCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.JBPEMOFNEDG != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.JBPEMOFNEDG);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.JBPEMOFNEDG != 0 {
            os.write_uint32(6, self.JBPEMOFNEDG)?;
        }
        if let Some(v) = self.LKJMJGDEBEE.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x14PlayerHeartBeatCsReq\x12\x20\n\x0bJBPEMOFNEDG\x18\x06\x20\x01(\rR\
    \x0bJBPEMOFNEDG\x123\n\x0bLKJMJGDEBEE\x18\x07\x20\x01(\x0b2\x11.ClientUp\
    loadDataR\x0bLKJMJGDEBEE\x12$\n\x0eclient_time_ms\x18\x05\x20\x01(\x04R\
