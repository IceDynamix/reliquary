...
impl ::protobuf::Message for ChallengeReward {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.taken_challenge_reward != 0 {
            my_size += ::protobuf::rt::uint64_size(15, self.taken_challenge_reward);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.taken_challenge_reward != 0 {
            os.write_uint64(15, self.taken_challenge_reward)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x15ChallengeReward.proto\"b\n\x0fChallengeReward\x12\x19\n\x08group_i\
    d\x18\x0b\x20\x01(\rR\x07groupId\x124\n\x16taken_challenge_reward\x18\
    \x0f\x20\x01(\x04R\x14takenChallengeRewardb\x06proto3\
";
