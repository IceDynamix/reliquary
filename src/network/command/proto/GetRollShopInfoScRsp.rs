...
impl ::protobuf::Message for GetRollShopInfoScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(12, &self.shop_group_id_list);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_uint32(12, &self.shop_group_id_list)?;
        if self.roll_shop_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x01\x20\x01(\rR\x0bgachaRandom\x12+\n\x12shop_group_id_list\x18\x0c\
    \x20\x03(\rR\x0fshopGroupIdList\x12\x20\n\x0croll_shop_id\x18\x07\x20\
