...
impl ::protobuf::Message for GetRollShopInfoScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(2, &self.shop_group_id_list);
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_uint32(2, &self.shop_group_id_list)?;
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    andom\x18\x05\x20\x01(\rR\x0bgachaRandom\x12+\n\x12shop_group_id_list\
    \x18\x02\x20\x03(\rR\x0fshopGroupIdList\x12\x18\n\x07retcode\x18\t\x20\
