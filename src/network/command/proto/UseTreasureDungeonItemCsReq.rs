...
pub struct UseTreasureDungeonItemCsReq {
    // message fields
    // @@protoc_insertion_point(field:UseTreasureDungeonItemCsReq.EICEKDBENKM)
    pub EICEKDBENKM: u32,
    // @@protoc_insertion_point(field:UseTreasureDungeonItemCsReq.item_id)
    pub item_id: u32,
    // @@protoc_insertion_point(field:UseTreasureDungeonItemCsReq.GDNEHLEOMOM)
    pub GDNEHLEOMOM: u32,
    // special fields
...
impl UseTreasureDungeonItemCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "EICEKDBENKM",
            |m: &UseTreasureDungeonItemCsReq| { &m.EICEKDBENKM },
            |m: &mut UseTreasureDungeonItemCsReq| { &mut m.EICEKDBENKM },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "item_id",
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "GDNEHLEOMOM",
            |m: &UseTreasureDungeonItemCsReq| { &m.GDNEHLEOMOM },
            |m: &mut UseTreasureDungeonItemCsReq| { &mut m.GDNEHLEOMOM },
        ));
...
impl ::protobuf::Message for UseTreasureDungeonItemCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.EICEKDBENKM != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.EICEKDBENKM);
        }
        if self.item_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.EICEKDBENKM != 0 {
            os.write_uint32(4, self.EICEKDBENKM)?;
        }
        if self.item_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12\x20\n\x0bEICEKDBENKM\x18\x04\x20\x01(\rR\x0bEICEKDBENKM\x12\x17\n\
    \x07item_id\x18\x05\x20\x01(\rR\x06itemId\x12\x20\n\x0bGDNEHLEOMOM\x18\
    \x0b\x20\x01(\rR\x0bGDNEHLEOMOMb\x06proto3\
";
