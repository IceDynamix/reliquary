...
pub struct Relic {
    ...
    pub exp: u32,
    // @@protoc_insertion_point(field:Relic.preview_sub_affix_list)
    pub preview_sub_affix_list: ::std::vec::Vec<super::RelicAffix::RelicAffix>,
...
impl Relic {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            ...
            |m: &Relic| { &m.preview_sub_affix_list },
            |m: &mut Relic| { &mut m.preview_sub_affix_list },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
...
impl ::protobuf::Message for Relic {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                114 => {
                    self.preview_sub_affix_list.push(is.read_message()?);
                },
                120 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.equip_avatar_id != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.equip_avatar_id);
        }
        if self.exp != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.exp);
        }
        for value in &self.preview_sub_affix_list {
            let len = value.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
        };
        if self.reforge_block_sub_affix_id != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.reforge_block_sub_affix_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.is_discarded != false {
            os.write_bool(3, self.is_discarded)?;
        }
        ...
        if self.equip_avatar_id != 0 {
            os.write_uint32(11, self.equip_avatar_id)?;
        }
        if self.exp != 0 {
            os.write_uint32(13, self.exp)?;
        }
        for v in &self.preview_sub_affix_list {
            ::protobuf::rt::write_message_field_with_cached_size(14, v, os)?;
        };
        if self.reforge_block_sub_affix_id != 0 {
            os.write_uint32(15, self.reforge_block_sub_affix_id)?;
        }
    ...
    fn clear(&mut self) {
        ...
        self.exp = 0;
        self.preview_sub_affix_list.clear();
    ...
    fn default_instance() -> &'static Relic {
        static instance: Relic = Relic {
            ...
            equip_avatar_id: 0,
            exp: 0,
            preview_sub_affix_list: ::std::vec::Vec::new(),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x0bRelic.proto\x1a\x10RelicAffix.proto\"\xe3\x03\n\x05Relic\x12\x1b\n\
    \tunique_id\x18\x01\x20\x01(\rR\x08uniqueId\x121\n\x0esub_affix_list\x18\
    \x02\x20\x03(\x0b2\x0b.RelicAffixR\x0csubAffixList\x12!\n\x0cis_discarde\
    d\x18\x03\x20\x01(\x08R\x0bisDiscarded\x12@\n\x16reforge_sub_affix_list\
    \x18\x04\x20\x03(\x0b2\x0b.RelicAffixR\x13reforgeSubAffixList\x12\"\n\rm\
    ain_affix_id\x18\x06\x20\x01(\rR\x0bmainAffixId\x12\x14\n\x05level\x18\
    \x07\x20\x01(\rR\x05level\x12\x10\n\x03tid\x18\x08\x20\x01(\rR\x03tid\
    \x12!\n\x0cis_protected\x18\n\x20\x01(\x08R\x0bisProtected\x12&\n\x0fequ\
    ip_avatar_id\x18\x0b\x20\x01(\rR\requipAvatarId\x12\x10\n\x03exp\x18\r\
    \x20\x01(\rR\x03exp\x12@\n\x16preview_sub_affix_list\x18\x0e\x20\x03(\
    \x0b2\x0b.RelicAffixR\x13previewSubAffixList\x12:\n\x1areforge_block_sub\
    _affix_id\x18\x0f\x20\x01(\rR\x16reforgeBlockSubAffixIdb\x06proto3\
";
