...
impl ::protobuf::Message for BuyGoodsCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.goods_num != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.goods_num);
        }
        if self.shop_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.goods_num != 0 {
            os.write_uint32(5, self.goods_num)?;
        }
        if self.shop_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    d_prop_entity_id\x18\x0b\x20\x01(\rR\x16interactedPropEntityId\x12\x20\n\
    \x0bFMPNHEAIMDN\x18\t\x20\x03(\rR\x0bFMPNHEAIMDN\x12\x19\n\x08goods_id\
    \x18\x03\x20\x01(\rR\x07goodsId\x12\x17\n\x07item_id\x18\r\x20\x01(\rR\
    \x06itemId\x12\x1b\n\tgoods_num\x18\x05\x20\x01(\rR\x08goodsNum\x12\x17\
    \n\x07shop_id\x18\x01\x20\x01(\rR\x06shopIdb\x06proto3\
";
