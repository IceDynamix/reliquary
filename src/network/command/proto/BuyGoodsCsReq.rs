...
pub struct BuyGoodsCsReq {
    // message fields
    // @@protoc_insertion_point(field:BuyGoodsCsReq.NLLKNCINGFM)
    pub NLLKNCINGFM: ::std::vec::Vec<u32>,
...
impl BuyGoodsCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "NLLKNCINGFM",
            |m: &BuyGoodsCsReq| { &m.NLLKNCINGFM },
            |m: &mut BuyGoodsCsReq| { &mut m.NLLKNCINGFM },
        ));
...
impl ::protobuf::Message for BuyGoodsCsReq {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                50 => {
                    is.read_repeated_packed_uint32_into(&mut self.NLLKNCINGFM)?;
                },
                48 => {
                    self.NLLKNCINGFM.push(is.read_uint32()?);
                },
                32 => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(6, &self.NLLKNCINGFM);
        if self.goods_num != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(6, &self.NLLKNCINGFM)?;
        if self.goods_num != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    INGFM\x18\x06\x20\x03(\rR\x0bNLLKNCINGFM\x12\x1b\n\tgoods_num\x18\x04\
    \x20\x01(\rR\x08goodsNum\x12\x17\n\x07item_id\x18\x02\x20\x01(\rR\x06ite\
    mId\x12\x19\n\x08goods_id\x18\x07\x20\x01(\rR\x07goodsId\x129\n\x19inter\
    acted_prop_entity_id\x18\r\x20\x01(\rR\x16interactedPropEntityId\x12\x17\
    \n\x07shop_id\x18\x08\x20\x01(\rR\x06shopIdb\x06proto3\
";
