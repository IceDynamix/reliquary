...
impl ::protobuf::Message for SetRogueExhibitionCsReq {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(7, &self.HEEPOEOLILO);
        my_size += ::protobuf::rt::vec_packed_enum_or_unknown_size(8, &self.ANEKPINLKFJ);
        my_size += ::protobuf::rt::vec_packed_uint32_size(10, &self.LDIFBJDGFFE);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(7, &self.HEEPOEOLILO)?;
        os.write_repeated_packed_enum_or_unknown(8, &self.ANEKPINLKFJ)?;
        os.write_repeated_packed_uint32(10, &self.LDIFBJDGFFE)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    LO\x18\x07\x20\x03(\rR\x0bHEEPOEOLILO\x12G\n\x0bANEKPINLKFJ\x18\x08\x20\
    \x03(\x0e2%.RogueCollectionExhibitionOperateTypeR\x0bANEKPINLKFJ\x12\x20\
    \n\x0bLDIFBJDGFFE\x18\n\x20\x03(\rR\x0bLDIFBJDGFFEb\x06proto3\
";
