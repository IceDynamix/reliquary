...
impl ::protobuf::Message for RelicFilterPlanIcon {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.icon_id != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.icon_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.icon_id != 0 {
            os.write_uint32(11, self.icon_id)?;
        }
        if self.is_avatar_icon != false {
            os.write_bool(10, self.is_avatar_icon)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x07icon_id\x18\x0b\x20\x01(\rR\x06iconId\x12$\n\x0eis_avatar_icon\x18\n\
    \x20\x01(\x08R\x0cisAvatarIconb\x06proto3\
";
