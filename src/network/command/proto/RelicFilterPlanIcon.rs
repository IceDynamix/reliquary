...
impl ::protobuf::Message for RelicFilterPlanIcon {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.icon_id != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.icon_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.is_avatar_icon != false {
            os.write_bool(8, self.is_avatar_icon)?;
        }
        if self.icon_id != 0 {
            os.write_uint32(10, self.icon_id)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    _avatar_icon\x18\x08\x20\x01(\x08R\x0cisAvatarIcon\x12\x17\n\x07icon_id\
    \x18\n\x20\x01(\rR\x06iconIdb\x06proto3\
";
