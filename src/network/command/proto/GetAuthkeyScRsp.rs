...
impl ::protobuf::Message for GetAuthkeyScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.authkey.is_empty() {
            my_size += ::protobuf::rt::string_size(4, &self.authkey);
        }
        if self.retcode != 0 {
        ...
        if self.authkey_ver != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.authkey_ver);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.authkey.is_empty() {
            os.write_string(4, &self.authkey)?;
        }
        if self.retcode != 0 {
        ...
        if self.authkey_ver != 0 {
            os.write_uint32(3, self.authkey_ver)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    th_appid\x18\x05\x20\x01(\tR\tauthAppid\x12\x18\n\x07authkey\x18\x04\x20\
    \x01(\tR\x07authkey\x12\x18\n\x07retcode\x18\x08\x20\x01(\rR\x07retcode\
    \x12\x1b\n\tsign_type\x18\t\x20\x01(\rR\x08signType\x12\x1f\n\x0bauthkey\
    _ver\x18\x03\x20\x01(\rR\nauthkeyVerb\x06proto3\
";
