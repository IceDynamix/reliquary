...
impl ::protobuf::Message for GetAuthkeyScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.authkey.is_empty() {
            my_size += ::protobuf::rt::string_size(12, &self.authkey);
        }
        ...
        if self.sign_type != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.sign_type);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.authkey.is_empty() {
            os.write_string(12, &self.authkey)?;
        }
        if self.authkey_ver != 0 {
        ...
        if self.sign_type != 0 {
            os.write_uint32(9, self.sign_type)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x15GetAuthkeyScRsp.proto\"\xa2\x01\n\x0fGetAuthkeyScRsp\x12\x1d\n\nau\
    th_appid\x18\x01\x20\x01(\tR\tauthAppid\x12\x18\n\x07authkey\x18\x0c\x20\
    \x01(\tR\x07authkey\x12\x1f\n\x0bauthkey_ver\x18\x08\x20\x01(\rR\nauthke\
    yVer\x12\x18\n\x07retcode\x18\x05\x20\x01(\rR\x07retcode\x12\x1b\n\tsign\
    _type\x18\t\x20\x01(\rR\x08signTypeb\x06proto3\
";
