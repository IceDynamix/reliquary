...
//! Generated file from `EraFlipperRegionDataSnapshot.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:EraFlipperRegionDataSnapshot)
...
impl<'a> ::std::default::Default for &'a EraFlipperRegionDataSnapshot {
    fn default() -> &'a EraFlipperRegionDataSnapshot {
        <EraFlipperRegionDataSnapshot as ::protobuf::Message>::default_instance()
    }
}

impl EraFlipperRegionDataSnapshot {
    pub fn new() -> EraFlipperRegionDataSnapshot {
...
impl ::protobuf::Message for EraFlipperRegionDataSnapshot {
    const NAME: &'static str = "EraFlipperRegionDataSnapshot";
    ...
    fn new() -> EraFlipperRegionDataSnapshot {
        EraFlipperRegionDataSnapshot::new()
    }
...
impl ::protobuf::MessageFull for EraFlipperRegionDataSnapshot {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("EraFlipperRegionDataSnapshot").unwrap()).clone()
    }
}

impl ::std::fmt::Display for EraFlipperRegionDataSnapshot {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for EraFlipperRegionDataSnapshot {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(EraFlipperRegionDataSnapshot::generated_message_descriptor_data());
