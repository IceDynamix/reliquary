...
pub struct RogueTournGetAllArchiveScRsp {
    ...
    pub retcode: u32,
    // @@protoc_insertion_point(field:RogueTournGetAllArchiveScRsp.EDJPODPNMED)
    pub EDJPODPNMED: ::std::vec::Vec<super::RogueTournSaveList::RogueTournSaveList>,
    // special fields
...
impl RogueTournGetAllArchiveScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "EDJPODPNMED",
            |m: &RogueTournGetAllArchiveScRsp| { &m.EDJPODPNMED },
            |m: &mut RogueTournGetAllArchiveScRsp| { &mut m.EDJPODPNMED },
        ));
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                114 => {
                    self.EDJPODPNMED.push(is.read_message()?);
                },
                tag => {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\"RogueTournGetAllArchiveScRsp.proto\x1a\x18RogueTournSaveList.proto\"\
    o\n\x1cRogueTournGetAllArchiveScRsp\x12\x18\n\x07retcode\x18\x0f\x20\x01\
    (\rR\x07retcode\x125\n\x0bEDJPODPNMED\x18\x0e\x20\x03(\x0b2\x13.RogueTou\
    rnSaveListR\x0bEDJPODPNMEDb\x06proto3\
";
