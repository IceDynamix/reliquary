...
pub struct SceneCastSkillCsReq {
    ...
    // @@protoc_insertion_point(field:SceneCastSkillCsReq.KCFABNFPOPN)
    pub KCFABNFPOPN: u32,
...
impl SceneCastSkillCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "KCFABNFPOPN",
            |m: &SceneCastSkillCsReq| { &m.KCFABNFPOPN },
            |m: &mut SceneCastSkillCsReq| { &mut m.KCFABNFPOPN },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
...
impl ::protobuf::Message for SceneCastSkillCsReq {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                56 => {
                    self.KCFABNFPOPN = is.read_uint32()?;
                },
                64 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.KCFABNFPOPN != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.KCFABNFPOPN);
        }
        if self.attacked_by_entity_id != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.attacked_by_entity_id);
        }
        ...
        if !self.maze_ability_str.is_empty() {
            my_size += ::protobuf::rt::string_size(10, &self.maze_ability_str);
        }
        if self.skill_index != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.skill_index);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(15, &self.hit_target_entity_id_list);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.KCFABNFPOPN != 0 {
            os.write_uint32(7, self.KCFABNFPOPN)?;
        }
        if self.attacked_by_entity_id != 0 {
            os.write_uint32(8, self.attacked_by_entity_id)?;
        }
        if let Some(v) = self.target_motion.as_ref() {
            ::protobuf::rt::write_message_field_with_cached_size(9, v, os)?;
        }
        if !self.maze_ability_str.is_empty() {
            os.write_string(10, &self.maze_ability_str)?;
        }
        if self.skill_index != 0 {
            os.write_uint32(13, self.skill_index)?;
        }
        os.write_repeated_packed_uint32(15, &self.hit_target_entity_id_list)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    to\"\xd1\x04\n\x13SceneCastSkillCsReq\x128\n\x10skill_extra_tags\x18\x01\
    \x20\x03(\x0e2\x0e.SkillExtraTagR\x0eskillExtraTags\x12$\n\x0ecast_entit\
    y_id\x18\x03\x20\x01(\rR\x0ccastEntityId\x125\n\x0edynamic_values\x18\
    \x04\x20\x03(\x0b2\x0e.DynamicValuesR\rdynamicValues\x12U\n\x1aassist_mo\
    nster_entity_info\x18\x05\x20\x03(\x0b2\x18.AssistMonsterEntityInfoR\x17\
    assistMonsterEntityInfo\x12@\n\x1dassist_monster_entity_id_list\x18\x06\
    \x20\x03(\rR\x19assistMonsterEntityIdList\x12\x20\n\x0bKCFABNFPOPN\x18\
    \x07\x20\x01(\rR\x0bKCFABNFPOPN\x121\n\x15attacked_by_entity_id\x18\x08\
    \x20\x01(\rR\x12attackedByEntityId\x120\n\rtarget_motion\x18\t\x20\x01(\
    \x0b2\x0b.MotionInfoR\x0ctargetMotion\x12(\n\x10maze_ability_str\x18\n\
    \x20\x01(\tR\x0emazeAbilityStr\x12\x1f\n\x0bskill_index\x18\r\x20\x01(\r\
    R\nskillIndex\x128\n\x19hit_target_entity_id_list\x18\x0f\x20\x03(\rR\
    \x15hitTargetEntityIdListb\x06proto3\
";
