...
pub struct SceneCastSkillCsReq {
    ...
    // @@protoc_insertion_point(field:SceneCastSkillCsReq.MGLONOOHJLI)
    pub MGLONOOHJLI: u32,
...
impl SceneCastSkillCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "MGLONOOHJLI",
            |m: &SceneCastSkillCsReq| { &m.MGLONOOHJLI },
            |m: &mut SceneCastSkillCsReq| { &mut m.MGLONOOHJLI },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "dynamic_values",
...
impl ::protobuf::Message for SceneCastSkillCsReq {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                8 => {
                    self.MGLONOOHJLI = is.read_uint32()?;
                },
                122 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(2, &self.assist_monster_entity_id_list);
        if !self.maze_ability_str.is_empty() {
            my_size += ::protobuf::rt::string_size(12, &self.maze_ability_str);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(3, &self.hit_target_entity_id_list);
        for value in &self.assist_monster_entity_info {
            let len = value.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
        };
        if self.MGLONOOHJLI != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.MGLONOOHJLI);
        }
        ...
        if self.skill_index != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.skill_index);
        }
        my_size += ::protobuf::rt::vec_packed_enum_or_unknown_size(4, &self.skill_extra_tags);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_uint32(2, &self.assist_monster_entity_id_list)?;
        if !self.maze_ability_str.is_empty() {
            os.write_string(12, &self.maze_ability_str)?;
        }
        os.write_repeated_packed_uint32(3, &self.hit_target_entity_id_list)?;
        for v in &self.assist_monster_entity_info {
            ::protobuf::rt::write_message_field_with_cached_size(14, v, os)?;
        };
        if self.MGLONOOHJLI != 0 {
            os.write_uint32(1, self.MGLONOOHJLI)?;
        }
        for v in &self.dynamic_values {
            ::protobuf::rt::write_message_field_with_cached_size(15, v, os)?;
        };
        if self.skill_index != 0 {
            os.write_uint32(13, self.skill_index)?;
        }
        os.write_repeated_packed_enum_or_unknown(4, &self.skill_extra_tags)?;
        if self.attacked_by_entity_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    to\"\xd1\x04\n\x13SceneCastSkillCsReq\x12$\n\x0ecast_entity_id\x18\x08\
    \x20\x01(\rR\x0ccastEntityId\x120\n\rtarget_motion\x18\x07\x20\x01(\x0b2\
    \x0b.MotionInfoR\x0ctargetMotion\x12@\n\x1dassist_monster_entity_id_list\
    \x18\x02\x20\x03(\rR\x19assistMonsterEntityIdList\x12(\n\x10maze_ability\
    _str\x18\x0c\x20\x01(\tR\x0emazeAbilityStr\x128\n\x19hit_target_entity_i\
    d_list\x18\x03\x20\x03(\rR\x15hitTargetEntityIdList\x12U\n\x1aassist_mon\
    ster_entity_info\x18\x0e\x20\x03(\x0b2\x18.AssistMonsterEntityInfoR\x17a\
    ssistMonsterEntityInfo\x12\x20\n\x0bMGLONOOHJLI\x18\x01\x20\x01(\rR\x0bM\
    GLONOOHJLI\x125\n\x0edynamic_values\x18\x0f\x20\x03(\x0b2\x0e.DynamicVal\
    uesR\rdynamicValues\x12\x1f\n\x0bskill_index\x18\r\x20\x01(\rR\nskillInd\
    ex\x128\n\x10skill_extra_tags\x18\x04\x20\x03(\x0e2\x0e.SkillExtraTagR\
    \x0eskillExtraTags\x121\n\x15attacked_by_entity_id\x18\x06\x20\x01(\rR\
    \x12attackedByEntityIdb\x06proto3\
";
