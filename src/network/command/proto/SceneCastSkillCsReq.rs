...
pub struct SceneCastSkillCsReq {
    // message fields
    // @@protoc_insertion_point(field:SceneCastSkillCsReq.attacked_by_entity_id)
    ...
    pub dynamic_values: ::std::vec::Vec<super::DynamicValues::DynamicValues>,
    ...
    // @@protoc_insertion_point(field:SceneCastSkillCsReq.EMCCHDMINOL)
    pub EMCCHDMINOL: u32,
    // special fields
...
impl SceneCastSkillCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            ...
            |m: &SceneCastSkillCsReq| { &m.attacked_by_entity_id },
            |m: &mut SceneCastSkillCsReq| { &mut m.attacked_by_entity_id },
        ));
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "EMCCHDMINOL",
            |m: &SceneCastSkillCsReq| { &m.EMCCHDMINOL },
            |m: &mut SceneCastSkillCsReq| { &mut m.EMCCHDMINOL },
        ));
...
impl ::protobuf::Message for SceneCastSkillCsReq {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                88 => {
                    self.EMCCHDMINOL = is.read_uint32()?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.attacked_by_entity_id != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.attacked_by_entity_id);
        }
        my_size += ::protobuf::rt::vec_packed_enum_or_unknown_size(1, &self.skill_extra_tags);
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(14, &self.assist_monster_entity_id_list);
        if !self.maze_ability_str.is_empty() {
            my_size += ::protobuf::rt::string_size(9, &self.maze_ability_str);
        }
        if self.cast_entity_id != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.cast_entity_id);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(12, &self.hit_target_entity_id_list);
        if self.EMCCHDMINOL != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.EMCCHDMINOL);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.attacked_by_entity_id != 0 {
            os.write_uint32(4, self.attacked_by_entity_id)?;
        }
        os.write_repeated_packed_enum_or_unknown(1, &self.skill_extra_tags)?;
        ...
        os.write_repeated_packed_uint32(14, &self.assist_monster_entity_id_list)?;
        if !self.maze_ability_str.is_empty() {
            os.write_string(9, &self.maze_ability_str)?;
        }
        if self.cast_entity_id != 0 {
            os.write_uint32(10, self.cast_entity_id)?;
        }
        os.write_repeated_packed_uint32(12, &self.hit_target_entity_id_list)?;
        if self.EMCCHDMINOL != 0 {
            os.write_uint32(11, self.EMCCHDMINOL)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x13DynamicValues.proto\x1a\x10MotionInfo.proto\x1a\x13SkillExtraTag.pro\
    to\"\xd1\x04\n\x13SceneCastSkillCsReq\x121\n\x15attacked_by_entity_id\
    \x18\x04\x20\x01(\rR\x12attackedByEntityId\x128\n\x10skill_extra_tags\
    \x18\x01\x20\x03(\x0e2\x0e.SkillExtraTagR\x0eskillExtraTags\x12U\n\x1aas\
    sist_monster_entity_info\x18\x02\x20\x03(\x0b2\x18.AssistMonsterEntityIn\
    foR\x17assistMonsterEntityInfo\x120\n\rtarget_motion\x18\x05\x20\x01(\
    \x0b2\x0b.MotionInfoR\x0ctargetMotion\x125\n\x0edynamic_values\x18\x06\
    \x20\x03(\x0b2\x0e.DynamicValuesR\rdynamicValues\x12\x1f\n\x0bskill_inde\
    x\x18\x07\x20\x01(\rR\nskillIndex\x12@\n\x1dassist_monster_entity_id_lis\
    t\x18\x0e\x20\x03(\rR\x19assistMonsterEntityIdList\x12(\n\x10maze_abilit\
    y_str\x18\t\x20\x01(\tR\x0emazeAbilityStr\x12$\n\x0ecast_entity_id\x18\n\
    \x20\x01(\rR\x0ccastEntityId\x128\n\x19hit_target_entity_id_list\x18\x0c\
    \x20\x03(\rR\x15hitTargetEntityIdList\x12\x20\n\x0bEMCCHDMINOL\x18\x0b\
    \x20\x01(\rR\x0bEMCCHDMINOLb\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::DynamicValues::file_descriptor().clone());
