...
pub struct SceneCastSkillCsReq {
    ...
    // @@protoc_insertion_point(field:SceneCastSkillCsReq.BGBFPCHAOIL)
    pub BGBFPCHAOIL: u32,
    // special fields
...
impl SceneCastSkillCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "BGBFPCHAOIL",
            |m: &SceneCastSkillCsReq| { &m.BGBFPCHAOIL },
            |m: &mut SceneCastSkillCsReq| { &mut m.BGBFPCHAOIL },
        ));
...
impl ::protobuf::Message for SceneCastSkillCsReq {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                104 => {
                    self.BGBFPCHAOIL = is.read_uint32()?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(15, &self.assist_monster_entity_id_list);
        if !self.maze_ability_str.is_empty() {
            my_size += ::protobuf::rt::string_size(7, &self.maze_ability_str);
        }
        my_size += ::protobuf::rt::vec_packed_enum_or_unknown_size(11, &self.skill_extra_tags);
        ...
        if self.attacked_by_entity_id != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.attacked_by_entity_id);
        }
        if self.cast_entity_id != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.cast_entity_id);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(4, &self.hit_target_entity_id_list);
        if self.BGBFPCHAOIL != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.BGBFPCHAOIL);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_uint32(15, &self.assist_monster_entity_id_list)?;
        if !self.maze_ability_str.is_empty() {
            os.write_string(7, &self.maze_ability_str)?;
        }
        os.write_repeated_packed_enum_or_unknown(11, &self.skill_extra_tags)?;
        ...
        if self.attacked_by_entity_id != 0 {
            os.write_uint32(1, self.attacked_by_entity_id)?;
        }
        if self.cast_entity_id != 0 {
            os.write_uint32(12, self.cast_entity_id)?;
        }
        os.write_repeated_packed_uint32(4, &self.hit_target_entity_id_list)?;
        if self.BGBFPCHAOIL != 0 {
            os.write_uint32(13, self.BGBFPCHAOIL)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    to\"\xd1\x04\n\x13SceneCastSkillCsReq\x125\n\x0edynamic_values\x18\x0e\
    \x20\x03(\x0b2\x0e.DynamicValuesR\rdynamicValues\x12\x1f\n\x0bskill_inde\
    x\x18\n\x20\x01(\rR\nskillIndex\x12@\n\x1dassist_monster_entity_id_list\
    \x18\x0f\x20\x03(\rR\x19assistMonsterEntityIdList\x12(\n\x10maze_ability\
    _str\x18\x07\x20\x01(\tR\x0emazeAbilityStr\x128\n\x10skill_extra_tags\
    \x18\x0b\x20\x03(\x0e2\x0e.SkillExtraTagR\x0eskillExtraTags\x12U\n\x1aas\
    sist_monster_entity_info\x18\x06\x20\x03(\x0b2\x18.AssistMonsterEntityIn\
    foR\x17assistMonsterEntityInfo\x120\n\rtarget_motion\x18\t\x20\x01(\x0b2\
    \x0b.MotionInfoR\x0ctargetMotion\x121\n\x15attacked_by_entity_id\x18\x01\
    \x20\x01(\rR\x12attackedByEntityId\x12$\n\x0ecast_entity_id\x18\x0c\x20\
    \x01(\rR\x0ccastEntityId\x128\n\x19hit_target_entity_id_list\x18\x04\x20\
    \x03(\rR\x15hitTargetEntityIdList\x12\x20\n\x0bBGBFPCHAOIL\x18\r\x20\x01\
    (\rR\x0bBGBFPCHAOILb\x06proto3\
";
