...
impl ::protobuf::Message for SceneCastSkillCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_enum_or_unknown_size(2, &self.skill_extra_tags);
        if !self.maze_ability_str.is_empty() {
            my_size += ::protobuf::rt::string_size(7, &self.maze_ability_str);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(11, &self.hit_target_entity_id_list);
        ...
        if self.KCFABNFPOPN != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.KCFABNFPOPN);
        }
        if self.attacked_by_entity_id != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.attacked_by_entity_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_enum_or_unknown(2, &self.skill_extra_tags)?;
        if !self.maze_ability_str.is_empty() {
            os.write_string(7, &self.maze_ability_str)?;
        }
        os.write_repeated_packed_uint32(11, &self.hit_target_entity_id_list)?;
        if let Some(v) = self.target_motion.as_ref() {
            ::protobuf::rt::write_message_field_with_cached_size(1, v, os)?;
        }
        os.write_repeated_packed_uint32(6, &self.assist_monster_entity_id_list)?;
        if self.KCFABNFPOPN != 0 {
            os.write_uint32(12, self.KCFABNFPOPN)?;
        }
        if self.attacked_by_entity_id != 0 {
            os.write_uint32(3, self.attacked_by_entity_id)?;
        }
        if self.skill_index != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    to\"\xd1\x04\n\x13SceneCastSkillCsReq\x12U\n\x1aassist_monster_entity_in\
    fo\x18\n\x20\x03(\x0b2\x18.AssistMonsterEntityInfoR\x17assistMonsterEnti\
    tyInfo\x125\n\x0edynamic_values\x18\r\x20\x03(\x0b2\x0e.DynamicValuesR\r\
    dynamicValues\x128\n\x10skill_extra_tags\x18\x02\x20\x03(\x0e2\x0e.Skill\
    ExtraTagR\x0eskillExtraTags\x12(\n\x10maze_ability_str\x18\x07\x20\x01(\
    \tR\x0emazeAbilityStr\x128\n\x19hit_target_entity_id_list\x18\x0b\x20\
    \x03(\rR\x15hitTargetEntityIdList\x120\n\rtarget_motion\x18\x01\x20\x01(\
    \x0b2\x0b.MotionInfoR\x0ctargetMotion\x12@\n\x1dassist_monster_entity_id\
    _list\x18\x06\x20\x03(\rR\x19assistMonsterEntityIdList\x12\x20\n\x0bKCFA\
    BNFPOPN\x18\x0c\x20\x01(\rR\x0bKCFABNFPOPN\x121\n\x15attacked_by_entity_\
    id\x18\x03\x20\x01(\rR\x12attackedByEntityId\x12\x1f\n\x0bskill_index\
    \x18\t\x20\x01(\rR\nskillIndex\x12$\n\x0ecast_entity_id\x18\x08\x20\x01(\
    \rR\x0ccastEntityIdb\x06proto3\
";
