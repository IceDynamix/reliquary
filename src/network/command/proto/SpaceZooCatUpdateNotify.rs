...
pub struct SpaceZooCatUpdateNotify {
    // message fields
    // @@protoc_insertion_point(field:SpaceZooCatUpdateNotify.OLEOBMLNODL)
    pub OLEOBMLNODL: bool,
    // @@protoc_insertion_point(field:SpaceZooCatUpdateNotify.EALLKDINNBO)
    pub EALLKDINNBO: bool,
    // @@protoc_insertion_point(field:SpaceZooCatUpdateNotify.EAMJKOMLKFJ)
    pub EAMJKOMLKFJ: ::std::vec::Vec<super::FAFGMLPADMI::FAFGMLPADMI>,
    // special fields
...
impl SpaceZooCatUpdateNotify {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "OLEOBMLNODL",
            |m: &SpaceZooCatUpdateNotify| { &m.OLEOBMLNODL },
            |m: &mut SpaceZooCatUpdateNotify| { &mut m.OLEOBMLNODL },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "EALLKDINNBO",
            |m: &SpaceZooCatUpdateNotify| { &m.EALLKDINNBO },
            |m: &mut SpaceZooCatUpdateNotify| { &mut m.EALLKDINNBO },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "EAMJKOMLKFJ",
            |m: &SpaceZooCatUpdateNotify| { &m.EAMJKOMLKFJ },
            |m: &mut SpaceZooCatUpdateNotify| { &mut m.EAMJKOMLKFJ },
        ));
...
impl ::protobuf::Message for SpaceZooCatUpdateNotify {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.OLEOBMLNODL != false {
            os.write_bool(4, self.OLEOBMLNODL)?;
        }
        if self.EALLKDINNBO != false {
            os.write_bool(7, self.EALLKDINNBO)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x17SpaceZooCatUpdateNotify\x12\x20\n\x0bOLEOBMLNODL\x18\x04\x20\x01(\
    \x08R\x0bOLEOBMLNODL\x12\x20\n\x0bEALLKDINNBO\x18\x07\x20\x01(\x08R\x0bE\
    ALLKDINNBO\x12.\n\x0bEAMJKOMLKFJ\x18\x08\x20\x03(\x0b2\x0c.FAFGMLPADMIR\
    \x0bEAMJKOMLKFJb\x06proto3\
";
