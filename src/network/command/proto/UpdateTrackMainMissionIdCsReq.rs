...
pub struct UpdateTrackMainMissionIdCsReq {
    // message fields
    // @@protoc_insertion_point(field:UpdateTrackMainMissionIdCsReq.GGLAEIHGPAJ)
    pub GGLAEIHGPAJ: ::protobuf::EnumOrUnknown<super::TrackMainMissionUpdateReasonId::TrackMainMissionUpdateReasonId>,
    // @@protoc_insertion_point(field:UpdateTrackMainMissionIdCsReq.FNCAOOPDJKN)
    pub FNCAOOPDJKN: u32,
...
impl UpdateTrackMainMissionIdCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "GGLAEIHGPAJ",
            |m: &UpdateTrackMainMissionIdCsReq| { &m.GGLAEIHGPAJ },
            |m: &mut UpdateTrackMainMissionIdCsReq| { &mut m.GGLAEIHGPAJ },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "FNCAOOPDJKN",
            |m: &UpdateTrackMainMissionIdCsReq| { &m.FNCAOOPDJKN },
            |m: &mut UpdateTrackMainMissionIdCsReq| { &mut m.FNCAOOPDJKN },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "track_mission_id",
...
impl ::protobuf::Message for UpdateTrackMainMissionIdCsReq {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                56 => {
                    self.GGLAEIHGPAJ = is.read_enum_or_unknown()?;
                },
                80 => {
                    self.FNCAOOPDJKN = is.read_uint32()?;
                },
                64 => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.GGLAEIHGPAJ != ::protobuf::EnumOrUnknown::new(super::TrackMainMissionUpdateReasonId::TrackMainMissionUpdateReasonId::NCFOCLHAFBL_EHNANCENOLA) {
            my_size += ::protobuf::rt::int32_size(7, self.GGLAEIHGPAJ.value());
        }
        if self.FNCAOOPDJKN != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.FNCAOOPDJKN);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.GGLAEIHGPAJ != ::protobuf::EnumOrUnknown::new(super::TrackMainMissionUpdateReasonId::TrackMainMissionUpdateReasonId::NCFOCLHAFBL_EHNANCENOLA) {
            os.write_enum(7, ::protobuf::EnumOrUnknown::value(&self.GGLAEIHGPAJ))?;
        }
        if self.FNCAOOPDJKN != 0 {
            os.write_uint32(10, self.FNCAOOPDJKN)?;
        }
        if self.track_mission_id != 0 {
    ...
    fn clear(&mut self) {
        self.GGLAEIHGPAJ = ::protobuf::EnumOrUnknown::new(super::TrackMainMissionUpdateReasonId::TrackMainMissionUpdateReasonId::NCFOCLHAFBL_EHNANCENOLA);
        self.FNCAOOPDJKN = 0;
    ...
    fn default_instance() -> &'static UpdateTrackMainMissionIdCsReq {
        static instance: UpdateTrackMainMissionIdCsReq = UpdateTrackMainMissionIdCsReq {
            GGLAEIHGPAJ: ::protobuf::EnumOrUnknown::from_i32(0),
            FNCAOOPDJKN: 0,
            track_mission_id: 0,
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    AJ\x18\x07\x20\x01(\x0e2\x1f.TrackMainMissionUpdateReasonIdR\x0bGGLAEIHG\
    PAJ\x12\x20\n\x0bFNCAOOPDJKN\x18\n\x20\x01(\rR\x0bFNCAOOPDJKN\x12(\n\x10\
    track_mission_id\x18\x08\x20\x01(\rR\x0etrackMissionIdb\x06proto3\
";
