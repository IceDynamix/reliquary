...
pub struct UpdateTrackMainMissionIdCsReq {
    ...
    // @@protoc_insertion_point(field:UpdateTrackMainMissionIdCsReq.EKKNPKGFPGH)
    pub EKKNPKGFPGH: ::protobuf::EnumOrUnknown<super::TrackMainMissionUpdateReasonId::TrackMainMissionUpdateReasonId>,
    // @@protoc_insertion_point(field:UpdateTrackMainMissionIdCsReq.BIAGHAIIJFC)
    pub BIAGHAIIJFC: u32,
    // special fields
...
impl UpdateTrackMainMissionIdCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "EKKNPKGFPGH",
            |m: &UpdateTrackMainMissionIdCsReq| { &m.EKKNPKGFPGH },
            |m: &mut UpdateTrackMainMissionIdCsReq| { &mut m.EKKNPKGFPGH },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "BIAGHAIIJFC",
            |m: &UpdateTrackMainMissionIdCsReq| { &m.BIAGHAIIJFC },
            |m: &mut UpdateTrackMainMissionIdCsReq| { &mut m.BIAGHAIIJFC },
        ));
...
impl ::protobuf::Message for UpdateTrackMainMissionIdCsReq {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                24 => {
                    self.EKKNPKGFPGH = is.read_enum_or_unknown()?;
                },
                72 => {
                    self.BIAGHAIIJFC = is.read_uint32()?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.EKKNPKGFPGH != ::protobuf::EnumOrUnknown::new(super::TrackMainMissionUpdateReasonId::TrackMainMissionUpdateReasonId::TRACK_MAIN_MISSION_UPDATE_NONE) {
            my_size += ::protobuf::rt::int32_size(3, self.EKKNPKGFPGH.value());
        }
        if self.BIAGHAIIJFC != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.BIAGHAIIJFC);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.EKKNPKGFPGH != ::protobuf::EnumOrUnknown::new(super::TrackMainMissionUpdateReasonId::TrackMainMissionUpdateReasonId::TRACK_MAIN_MISSION_UPDATE_NONE) {
            os.write_enum(3, ::protobuf::EnumOrUnknown::value(&self.EKKNPKGFPGH))?;
        }
        if self.BIAGHAIIJFC != 0 {
            os.write_uint32(9, self.BIAGHAIIJFC)?;
        }
    ...
    fn clear(&mut self) {
        ...
        self.EKKNPKGFPGH = ::protobuf::EnumOrUnknown::new(super::TrackMainMissionUpdateReasonId::TrackMainMissionUpdateReasonId::TRACK_MAIN_MISSION_UPDATE_NONE);
        self.BIAGHAIIJFC = 0;
    ...
    fn default_instance() -> &'static UpdateTrackMainMissionIdCsReq {
        static instance: UpdateTrackMainMissionIdCsReq = UpdateTrackMainMissionIdCsReq {
            track_mission_id: 0,
            EKKNPKGFPGH: ::protobuf::EnumOrUnknown::from_i32(0),
            BIAGHAIIJFC: 0,
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    d.proto\"\xae\x01\n\x1dUpdateTrackMainMissionIdCsReq\x12(\n\x10track_mis\
    sion_id\x18\x0f\x20\x01(\rR\x0etrackMissionId\x12A\n\x0bEKKNPKGFPGH\x18\
    \x03\x20\x01(\x0e2\x1f.TrackMainMissionUpdateReasonIdR\x0bEKKNPKGFPGH\
    \x12\x20\n\x0bBIAGHAIIJFC\x18\t\x20\x01(\rR\x0bBIAGHAIIJFCb\x06proto3\
";
