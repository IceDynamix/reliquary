...
impl ::protobuf::Message for SetPlayerInfoScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.cur_avatar_path != ::protobuf::EnumOrUnknown::new(super::MultiPathAvatarType::MultiPathAvatarType::MultiPathAvatarTypeNone) {
            my_size += ::protobuf::rt::int32_size(2, self.cur_avatar_path.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.cur_avatar_path != ::protobuf::EnumOrUnknown::new(super::MultiPathAvatarType::MultiPathAvatarType::MultiPathAvatarTypeNone) {
            os.write_enum(2, ::protobuf::EnumOrUnknown::value(&self.cur_avatar_path))?;
        }
        if self.is_modify != false {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    _avatar_path\x18\x02\x20\x01(\x0e2\x14.MultiPathAvatarTypeR\rcurAvatarPa\
    th\x12\x1b\n\tis_modify\x18\x01\x20\x01(\x08R\x08isModify\x12\x18\n\x07r\
    etcode\x18\x0e\x20\x01(\rR\x07retcode\x12N\n\x19cur_avatar_path_info_lis\
    t\x18\x08\x20\x03(\x0b2\x14.MultiPathAvatarInfoR\x15curAvatarPathInfoLis\
    t\x12\x20\n\x0bJENDKBOOAIP\x18\t\x20\x01(\x03R\x0bJENDKBOOAIPb\x06proto3\
";
