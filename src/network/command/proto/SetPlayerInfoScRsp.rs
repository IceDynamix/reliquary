...
impl ::protobuf::Message for SetPlayerInfoScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.cur_avatar_path != ::protobuf::EnumOrUnknown::new(super::MultiPathAvatarType::MultiPathAvatarType::MultiPathAvatarTypeNone) {
            my_size += ::protobuf::rt::int32_size(14, self.cur_avatar_path.value());
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.cur_avatar_path != ::protobuf::EnumOrUnknown::new(super::MultiPathAvatarType::MultiPathAvatarType::MultiPathAvatarTypeNone) {
            os.write_enum(14, ::protobuf::EnumOrUnknown::value(&self.cur_avatar_path))?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x01\n\x12SetPlayerInfoScRsp\x12<\n\x0fcur_avatar_path\x18\x0e\x20\x01(\
    \x0e2\x14.MultiPathAvatarTypeR\rcurAvatarPath\x12\x18\n\x07retcode\x18\
    \x02\x20\x01(\rR\x07retcode\x12\x1b\n\tis_modify\x18\x0c\x20\x01(\x08R\
    \x08isModify\x12\x19\n\x08set_time\x18\x01\x20\x01(\x03R\x07setTimeb\x06\
    proto3\
";
