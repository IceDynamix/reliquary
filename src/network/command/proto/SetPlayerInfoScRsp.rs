...
pub struct SetPlayerInfoScRsp {
    ...
    pub cur_avatar_path_info_list: ::std::vec::Vec<super::MultiPathAvatarTypeInfo::MultiPathAvatarTypeInfo>,
    // special fields
...
impl ::protobuf::Message for SetPlayerInfoScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.JENDKBOOAIP != 0 {
            my_size += ::protobuf::rt::int64_size(9, self.JENDKBOOAIP);
        }
        if self.retcode != 0 {
        ...
        if self.cur_avatar_path != ::protobuf::EnumOrUnknown::new(super::MultiPathAvatarType::MultiPathAvatarType::MultiPathAvatarTypeNone) {
            my_size += ::protobuf::rt::int32_size(10, self.cur_avatar_path.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.JENDKBOOAIP != 0 {
            os.write_int64(9, self.JENDKBOOAIP)?;
        }
        if self.retcode != 0 {
        ...
        if self.cur_avatar_path != ::protobuf::EnumOrUnknown::new(super::MultiPathAvatarType::MultiPathAvatarType::MultiPathAvatarTypeNone) {
            os.write_enum(10, ::protobuf::EnumOrUnknown::value(&self.cur_avatar_path))?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ultiPathAvatarTypeInfo.proto\"\xff\x01\n\x12SetPlayerInfoScRsp\x12\x20\n\
    \x0bJENDKBOOAIP\x18\t\x20\x01(\x03R\x0bJENDKBOOAIP\x12\x18\n\x07retcode\
    \x18\x08\x20\x01(\rR\x07retcode\x12\x1b\n\tis_modify\x18\x0c\x20\x01(\
    \x08R\x08isModify\x12<\n\x0fcur_avatar_path\x18\n\x20\x01(\x0e2\x14.Mult\
    iPathAvatarTypeR\rcurAvatarPath\x12R\n\x19cur_avatar_path_info_list\x18\
    \x0f\x20\x03(\x0b2\x18.MultiPathAvatarTypeInfoR\x15curAvatarPathInfoList\
    b\x06proto3\
";
