...
pub struct SetPlayerInfoScRsp {
    ...
    // @@protoc_insertion_point(field:SetPlayerInfoScRsp.last_change_time)
...
impl SetPlayerInfoScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "last_change_time",
            |m: &SetPlayerInfoScRsp| { &m.last_change_time },
            |m: &mut SetPlayerInfoScRsp| { &mut m.last_change_time },
        ));
...
impl ::protobuf::Message for SetPlayerInfoScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.cur_avatar_path != ::protobuf::EnumOrUnknown::new(super::MultiPathAvatarType::MultiPathAvatarType::MultiPathAvatarTypeNone) {
            my_size += ::protobuf::rt::int32_size(12, self.cur_avatar_path.value());
        }
        if self.last_change_time != 0 {
            my_size += ::protobuf::rt::int64_size(15, self.last_change_time);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.cur_avatar_path != ::protobuf::EnumOrUnknown::new(super::MultiPathAvatarType::MultiPathAvatarType::MultiPathAvatarTypeNone) {
            os.write_enum(12, ::protobuf::EnumOrUnknown::value(&self.cur_avatar_path))?;
        }
        if self.last_change_time != 0 {
            os.write_int64(15, self.last_change_time)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ultiPathAvatarType.proto\"\x83\x02\n\x12SetPlayerInfoScRsp\x12\x18\n\x07\
    retcode\x18\x03\x20\x01(\rR\x07retcode\x12\x1b\n\tis_modify\x18\x06\x20\
    \x01(\x08R\x08isModify\x12N\n\x19cur_avatar_path_info_list\x18\t\x20\x03\
    (\x0b2\x14.MultiPathAvatarInfoR\x15curAvatarPathInfoList\x12<\n\x0fcur_a\
    vatar_path\x18\x0c\x20\x01(\x0e2\x14.MultiPathAvatarTypeR\rcurAvatarPath\
    \x12(\n\x10last_change_time\x18\x0f\x20\x01(\x03R\x0elastChangeTimeb\x06\
    proto3\
";
