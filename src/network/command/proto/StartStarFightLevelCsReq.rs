...
impl ::protobuf::Message for StartStarFightLevelCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.DBKHHCGGKNN != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.DBKHHCGGKNN);
        }
        if self.group_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.DBKHHCGGKNN != 0 {
            os.write_uint32(2, self.DBKHHCGGKNN)?;
        }
        if self.group_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x18StartStarFightLevelCsReq\x12\x20\n\x0bDBKHHCGGKNN\x18\x02\x20\x01(\
    \rR\x0bDBKHHCGGKNN\x12\x19\n\x08group_id\x18\t\x20\x01(\rR\x07groupId\
    \x12-\n\x0bavatar_list\x18\n\x20\x03(\x0b2\x0c.EBGJAKBKPANR\navatarListb\
    \x06proto3\
";
