...
impl ::protobuf::Message for KLDMJEMIMCN {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.MCOKHHFPBPJ != 0 {
            my_size += ::protobuf::rt::uint64_size(8, self.MCOKHHFPBPJ);
        }
        if self.DANCCAOJLJN != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.DANCCAOJLJN);
        }
        ...
        if self.JGIBHFJMOBE != ::protobuf::EnumOrUnknown::new(super::DGFCBOFAOIA::DGFCBOFAOIA::MATCH3_STATE_IDLE) {
            my_size += ::protobuf::rt::int32_size(7, self.JGIBHFJMOBE.value());
        }
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(1, &self.HBANCCOKOFC);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.MCOKHHFPBPJ != 0 {
            os.write_uint64(8, self.MCOKHHFPBPJ)?;
        }
        if self.DANCCAOJLJN != 0 {
            os.write_uint32(9, self.DANCCAOJLJN)?;
        }
        if let Some(v) = self.MEJDMJIKIMO.as_ref() {
            ::protobuf::rt::write_message_field_with_cached_size(14, v, os)?;
        }
        if self.JGIBHFJMOBE != ::protobuf::EnumOrUnknown::new(super::DGFCBOFAOIA::DGFCBOFAOIA::MATCH3_STATE_IDLE) {
            os.write_enum(7, ::protobuf::EnumOrUnknown::value(&self.JGIBHFJMOBE))?;
        }
        if self.HCBBHCKJNJI != 0 {
        ...
        os.write_repeated_packed_uint32(1, &self.HBANCCOKOFC)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    HFPBPJ\x18\x08\x20\x01(\x04R\x0bMCOKHHFPBPJ\x12\x20\n\x0bDANCCAOJLJN\x18\
    \t\x20\x01(\rR\x0bDANCCAOJLJN\x12.\n\x0bMEJDMJIKIMO\x18\x0e\x20\x01(\x0b\
    2\x0c.MDOHAFBEEPKR\x0bMEJDMJIKIMO\x12.\n\x0bJGIBHFJMOBE\x18\x07\x20\x01(\
    \x0e2\x0c.DGFCBOFAOIAR\x0bJGIBHFJMOBE\x12\x20\n\x0bHCBBHCKJNJI\x18\x0f\
    \x20\x01(\x05R\x0bHCBBHCKJNJI\x12.\n\x0bCPKPINCCEIP\x18\x03\x20\x03(\x0b\
    2\x0c.MEKDNIKFDNAR\x0bCPKPINCCEIP\x12\x20\n\x0bHBANCCOKOFC\x18\x01\x20\
    \x03(\rR\x0bHBANCCOKOFCb\x06proto3\
";
