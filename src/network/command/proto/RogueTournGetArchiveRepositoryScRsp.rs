...
impl ::protobuf::Message for RogueTournGetArchiveRepositoryScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(14, &self.LNEJMJBFLLH);
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_uint32(14, &self.LNEJMJBFLLH)?;
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    LOPKOH\x12\x20\n\x0bLNEJMJBFLLH\x18\x0e\x20\x03(\rR\x0bLNEJMJBFLLH\x12\
