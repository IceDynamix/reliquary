...
impl ::protobuf::Message for RogueTournGetArchiveRepositoryScRsp {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(3, &self.LNEJMJBFLLH);
        my_size += ::protobuf::rt::vec_packed_uint32_size(15, &self.HKDOCLOPKOH);
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(3, &self.LNEJMJBFLLH)?;
        os.write_repeated_packed_uint32(15, &self.HKDOCLOPKOH)?;
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    chiveRepositoryScRsp\x12\x20\n\x0bLNEJMJBFLLH\x18\x03\x20\x03(\rR\x0bLNE\
    JMJBFLLH\x12\x20\n\x0bHKDOCLOPKOH\x18\x0f\x20\x03(\rR\x0bHKDOCLOPKOH\x12\
