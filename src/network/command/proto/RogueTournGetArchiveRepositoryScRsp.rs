...
impl ::protobuf::Message for RogueTournGetArchiveRepositoryScRsp {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(14, &self.HKDOCLOPKOH);
        if self.retcode != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.retcode);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(2, &self.LNEJMJBFLLH);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(14, &self.HKDOCLOPKOH)?;
        if self.retcode != 0 {
            os.write_uint32(5, self.retcode)?;
        }
        os.write_repeated_packed_uint32(2, &self.LNEJMJBFLLH)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    chiveRepositoryScRsp\x12\x20\n\x0bHKDOCLOPKOH\x18\x0e\x20\x03(\rR\x0bHKD\
    OCLOPKOH\x12\x18\n\x07retcode\x18\x05\x20\x01(\rR\x07retcode\x12\x20\n\
    \x0bLNEJMJBFLLH\x18\x02\x20\x03(\rR\x0bLNEJMJBFLLHb\x06proto3\
";
