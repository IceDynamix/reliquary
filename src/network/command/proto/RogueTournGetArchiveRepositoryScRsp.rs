...
pub struct RogueTournGetArchiveRepositoryScRsp {
    ...
    pub retcode: u32,
    // @@protoc_insertion_point(field:RogueTournGetArchiveRepositoryScRsp.IKLPOEDNEDL)
    pub IKLPOEDNEDL: ::std::vec::Vec<u32>,
    // @@protoc_insertion_point(field:RogueTournGetArchiveRepositoryScRsp.JMPPFDJIEKJ)
    pub JMPPFDJIEKJ: ::std::vec::Vec<u32>,
    // special fields
...
impl RogueTournGetArchiveRepositoryScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "IKLPOEDNEDL",
            |m: &RogueTournGetArchiveRepositoryScRsp| { &m.IKLPOEDNEDL },
            |m: &mut RogueTournGetArchiveRepositoryScRsp| { &mut m.IKLPOEDNEDL },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "JMPPFDJIEKJ",
            |m: &RogueTournGetArchiveRepositoryScRsp| { &m.JMPPFDJIEKJ },
            |m: &mut RogueTournGetArchiveRepositoryScRsp| { &mut m.JMPPFDJIEKJ },
        ));
...
impl ::protobuf::Message for RogueTournGetArchiveRepositoryScRsp {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                74 => {
                    is.read_repeated_packed_uint32_into(&mut self.IKLPOEDNEDL)?;
                },
                72 => {
                    self.IKLPOEDNEDL.push(is.read_uint32()?);
                },
                114 => {
                    is.read_repeated_packed_uint32_into(&mut self.JMPPFDJIEKJ)?;
                },
                112 => {
                    self.JMPPFDJIEKJ.push(is.read_uint32()?);
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(9, &self.IKLPOEDNEDL);
        my_size += ::protobuf::rt::vec_packed_uint32_size(14, &self.JMPPFDJIEKJ);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_uint32(9, &self.IKLPOEDNEDL)?;
        os.write_repeated_packed_uint32(14, &self.JMPPFDJIEKJ)?;
    ...
    fn clear(&mut self) {
        self.retcode = 0;
        self.IKLPOEDNEDL.clear();
        self.JMPPFDJIEKJ.clear();
    ...
    fn default_instance() -> &'static RogueTournGetArchiveRepositoryScRsp {
        static instance: RogueTournGetArchiveRepositoryScRsp = RogueTournGetArchiveRepositoryScRsp {
            retcode: 0,
            IKLPOEDNEDL: ::std::vec::Vec::new(),
            JMPPFDJIEKJ: ::std::vec::Vec::new(),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12\x20\n\x0bIKLPOEDNEDL\x18\t\x20\x03(\rR\x0bIKLPOEDNEDL\x12\x20\n\x0b\
    JMPPFDJIEKJ\x18\x0e\x20\x03(\rR\x0bJMPPFDJIEKJb\x06proto3\
";
