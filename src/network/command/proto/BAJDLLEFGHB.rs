...
//! Generated file from `BAJDLLEFGHB.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:BAJDLLEFGHB)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct BAJDLLEFGHB {
    // message fields
...
impl<'a> ::std::default::Default for &'a BAJDLLEFGHB {
    fn default() -> &'a BAJDLLEFGHB {
        <BAJDLLEFGHB as ::protobuf::Message>::default_instance()
    }
}

impl BAJDLLEFGHB {
    pub fn new() -> BAJDLLEFGHB {
...
impl ::protobuf::Message for BAJDLLEFGHB {
    const NAME: &'static str = "BAJDLLEFGHB";
...
impl ::protobuf::MessageFull for BAJDLLEFGHB {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("BAJDLLEFGHB").unwrap()).clone()
    }
}

impl ::std::fmt::Display for BAJDLLEFGHB {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for BAJDLLEFGHB {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(BAJDLLEFGHB::generated_message_descriptor_data());
