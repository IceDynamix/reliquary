...
//! Generated file from `ExpeditionInfo.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:ExpeditionInfo)
...
impl<'a> ::std::default::Default for &'a ExpeditionInfo {
    fn default() -> &'a ExpeditionInfo {
        <ExpeditionInfo as ::protobuf::Message>::default_instance()
    }
}

impl ExpeditionInfo {
    pub fn new() -> ExpeditionInfo {
...
impl ::protobuf::Message for ExpeditionInfo {
    const NAME: &'static str = "ExpeditionInfo";
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.total_duration != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.total_duration);
        }
        if self.id != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.id);
        }
        if self.start_expedition_time != 0 {
            my_size += ::protobuf::rt::int64_size(4, self.start_expedition_time);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.total_duration != 0 {
            os.write_uint32(13, self.total_duration)?;
        }
        if self.id != 0 {
            os.write_uint32(12, self.id)?;
        }
        if self.start_expedition_time != 0 {
            os.write_int64(4, self.start_expedition_time)?;
        }
...
impl ::protobuf::MessageFull for ExpeditionInfo {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("ExpeditionInfo").unwrap()).clone()
    }
}

impl ::std::fmt::Display for ExpeditionInfo {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for ExpeditionInfo {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x14ExpeditionInfo.proto\"\xa1\x01\n\x0eExpeditionInfo\x12%\n\x0etotal\
    _duration\x18\r\x20\x01(\rR\rtotalDuration\x12\x0e\n\x02id\x18\x0c\x20\
    \x01(\rR\x02id\x122\n\x15start_expedition_time\x18\x04\x20\x01(\x03R\x13\
    startExpeditionTime\x12$\n\x0eavatar_id_list\x18\x03\x20\x03(\rR\x0cavat\
    arIdListb\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(ExpeditionInfo::generated_message_descriptor_data());
