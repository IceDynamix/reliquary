...
impl ::protobuf::Message for ExpeditionInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.start_expedition_time != 0 {
            my_size += ::protobuf::rt::int64_size(9, self.start_expedition_time);
        }
        if self.id != 0 {
        ...
        if self.total_duration != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.total_duration);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.start_expedition_time != 0 {
            os.write_int64(9, self.start_expedition_time)?;
        }
        if self.id != 0 {
        ...
        if self.total_duration != 0 {
            os.write_uint32(8, self.total_duration)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    _expedition_time\x18\t\x20\x01(\x03R\x13startExpeditionTime\x12\x0e\n\
    \x02id\x18\n\x20\x01(\rR\x02id\x12$\n\x0eavatar_id_list\x18\x05\x20\x03(\
    \rR\x0cavatarIdList\x12%\n\x0etotal_duration\x18\x08\x20\x01(\rR\rtotalD\
    urationb\x06proto3\
";
