...
impl ::protobuf::Message for SyncRogueSeasonFinishScNotify {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.NIOLDFFFELN != false {
            os.write_bool(8, self.NIOLDFFFELN)?;
        }
        if let Some(v) = self.rogue_score_reward_info.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x08\x20\x01(\x08R\x0bNIOLDFFFELN\x12C\n\x17rogue_score_reward_info\x18\
    \x03\x20\x01(\x0b2\x0c.HGHCOGEPIDMR\x14rogueScoreRewardInfo\x12<\n\x11ro\
    gue_finish_info\x18\x0b\x20\x01(\x0b2\x10.RogueFinishInfoR\x0frogueFinis\
    hInfo\x12\x20\n\x05scene\x18\x04\x20\x01(\x0b2\n.SceneInfoR\x05scene\x12\
    #\n\x06lineup\x18\x0f\x20\x01(\x0b2\x0b.LineupInfoR\x06lineupb\x06proto3\
";
