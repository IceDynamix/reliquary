...
impl ::protobuf::Message for GetMailScRsp {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.total_num != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.total_num);
        }
        ...
        if self.start != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.start);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.total_num != 0 {
            os.write_uint32(3, self.total_num)?;
        }
        ...
        if self.start != 0 {
            os.write_uint32(11, self.start)?;
        }
        for v in &self.notice_mail_list {
            ::protobuf::rt::write_message_field_with_cached_size(12, v, os)?;
        };
        if self.is_end != false {
            os.write_bool(14, self.is_end)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    cRsp\x12\x1b\n\ttotal_num\x18\x03\x20\x01(\rR\x08totalNum\x12(\n\tmail_l\
    ist\x18\x08\x20\x03(\x0b2\x0b.ClientMailR\x08mailList\x12\x18\n\x07retco\
    de\x18\n\x20\x01(\rR\x07retcode\x12\x14\n\x05start\x18\x0b\x20\x01(\rR\
    \x05start\x125\n\x10notice_mail_list\x18\x0c\x20\x03(\x0b2\x0b.ClientMai\
    lR\x0enoticeMailList\x12\x15\n\x06is_end\x18\x0e\x20\x01(\x08R\x05isEndb\
    \x06proto3\
";
