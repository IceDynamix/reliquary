...
impl ::protobuf::Message for GetMailScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.start != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.start);
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    cRsp\x12\x1b\n\ttotal_num\x18\n\x20\x01(\rR\x08totalNum\x12(\n\tmail_lis\
    t\x18\x08\x20\x03(\x0b2\x0b.ClientMailR\x08mailList\x12\x15\n\x06is_end\
    \x18\x01\x20\x01(\x08R\x05isEnd\x12\x18\n\x07retcode\x18\x05\x20\x01(\rR\
    \x07retcode\x12\x14\n\x05start\x18\x07\x20\x01(\rR\x05start\x125\n\x10no\
    tice_mail_list\x18\x02\x20\x03(\x0b2\x0b.ClientMailR\x0enoticeMailListb\
    \x06proto3\
";
