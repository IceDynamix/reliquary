...
impl ::protobuf::Message for GetMailScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.start != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.start);
        }
        ...
        if self.total_num != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.total_num);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.start != 0 {
            os.write_uint32(14, self.start)?;
        }
        for v in &self.notice_mail_list {
            ::protobuf::rt::write_message_field_with_cached_size(5, v, os)?;
        };
        if self.total_num != 0 {
            os.write_uint32(2, self.total_num)?;
        }
        if self.is_end != false {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    cRsp\x12(\n\tmail_list\x18\x01\x20\x03(\x0b2\x0b.ClientMailR\x08mailList\
    \x12\x18\n\x07retcode\x18\x0b\x20\x01(\rR\x07retcode\x12\x14\n\x05start\
    \x18\x0e\x20\x01(\rR\x05start\x125\n\x10notice_mail_list\x18\x05\x20\x03\
    (\x0b2\x0b.ClientMailR\x0enoticeMailList\x12\x1b\n\ttotal_num\x18\x02\
    \x20\x01(\rR\x08totalNum\x12\x15\n\x06is_end\x18\x08\x20\x01(\x08R\x05is\
    Endb\x06proto3\
";
