...
pub struct TrainPartyBuildDiyCsReq {
    // message fields
    // @@protoc_insertion_point(field:TrainPartyBuildDiyCsReq.BIIPDKBLBFO)
...
impl TrainPartyBuildDiyCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "BIIPDKBLBFO",
            |m: &TrainPartyBuildDiyCsReq| { &m.BIIPDKBLBFO },
            |m: &mut TrainPartyBuildDiyCsReq| { &mut m.BIIPDKBLBFO },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "area_id",
...
impl ::protobuf::Message for TrainPartyBuildDiyCsReq {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.BIIPDKBLBFO != false {
            os.write_bool(5, self.BIIPDKBLBFO)?;
        }
        if self.area_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    eq\x12\x20\n\x0bBIIPDKBLBFO\x18\x05\x20\x01(\x08R\x0bBIIPDKBLBFO\x12\x17\
    \n\x07area_id\x18\x02\x20\x01(\rR\x06areaId\x12$\n\x0ediy_dynamic_id\x18\
    \x0c\x20\x01(\rR\x0cdiyDynamicId\x12\x20\n\x0cdice_slot_id\x18\x04\x20\
