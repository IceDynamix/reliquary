...
pub struct TrainPartyBuildDiyCsReq {
    // message fields
    // @@protoc_insertion_point(field:TrainPartyBuildDiyCsReq.KOABEOOEPNP)
...
impl TrainPartyBuildDiyCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "KOABEOOEPNP",
            |m: &TrainPartyBuildDiyCsReq| { &m.KOABEOOEPNP },
            |m: &mut TrainPartyBuildDiyCsReq| { &mut m.KOABEOOEPNP },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "area_id",
...
impl ::protobuf::Message for TrainPartyBuildDiyCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.diy_dynamic_id != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.diy_dynamic_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.KOABEOOEPNP != false {
            os.write_bool(2, self.KOABEOOEPNP)?;
        }
        if self.area_id != 0 {
            os.write_uint32(6, self.area_id)?;
        }
        if self.diy_dynamic_id != 0 {
            os.write_uint32(8, self.diy_dynamic_id)?;
        }
        if self.dice_slot_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    eq\x12\x20\n\x0bKOABEOOEPNP\x18\x02\x20\x01(\x08R\x0bKOABEOOEPNP\x12\x17\
    \n\x07area_id\x18\x06\x20\x01(\rR\x06areaId\x12$\n\x0ediy_dynamic_id\x18\
    \x08\x20\x01(\rR\x0cdiyDynamicId\x12\x20\n\x0cdice_slot_id\x18\x0c\x20\
