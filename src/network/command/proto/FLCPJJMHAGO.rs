...
//! Generated file from `FLCPJJMHAGO.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:FLCPJJMHAGO)
...
impl<'a> ::std::default::Default for &'a FLCPJJMHAGO {
    fn default() -> &'a FLCPJJMHAGO {
        <FLCPJJMHAGO as ::protobuf::Message>::default_instance()
    }
}

impl FLCPJJMHAGO {
    pub fn new() -> FLCPJJMHAGO {
...
impl ::protobuf::Message for FLCPJJMHAGO {
    const NAME: &'static str = "FLCPJJMHAGO";
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.AFEMBLFCCCH != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.AFEMBLFCCCH);
        }
        if self.HCBADDHNIDG != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.HCBADDHNIDG);
        }
        if self.level != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.AFEMBLFCCCH != 0 {
            os.write_uint32(8, self.AFEMBLFCCCH)?;
        }
        if self.HCBADDHNIDG != 0 {
            os.write_uint32(15, self.HCBADDHNIDG)?;
        }
        if self.level != 0 {
...
impl ::protobuf::MessageFull for FLCPJJMHAGO {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("FLCPJJMHAGO").unwrap()).clone()
    }
}

impl ::std::fmt::Display for FLCPJJMHAGO {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for FLCPJJMHAGO {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x11FLCPJJMHAGO.proto\"y\n\x0bFLCPJJMHAGO\x12\x20\n\x0bAFEMBLFCCCH\x18\
    \x08\x20\x01(\rR\x0bAFEMBLFCCCH\x12\x20\n\x0bHCBADDHNIDG\x18\x0f\x20\x01\
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(FLCPJJMHAGO::generated_message_descriptor_data());
