...
impl ::protobuf::Message for GLPEEIJALGF {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.ANLINCFGFAN != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.ANLINCFGFAN);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.ANLINCFGFAN != 0 {
            os.write_uint32(11, self.ANLINCFGFAN)?;
        }
        if let Some(v) = self.cost_data.as_ref() {
        ...
        if self.FOBAOEAFNAM != false {
            os.write_bool(9, self.FOBAOEAFNAM)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ALGF\x12\x20\n\x0bANLINCFGFAN\x18\x0b\x20\x01(\rR\x0bANLINCFGFAN\x12*\n\
    \tcost_data\x18\x0c\x20\x01(\x0b2\r.ItemCostDataR\x08costData\x12\x20\n\
    \x0bDMMAMJGNGNN\x18\x01\x20\x01(\x05R\x0bDMMAMJGNGNN\x12\x20\n\x0bJIFKHC\
    KPNFM\x18\x0f\x20\x01(\rR\x0bJIFKHCKPNFM\x12\x20\n\x0bFOBAOEAFNAM\x18\t\
    \x20\x01(\x08R\x0bFOBAOEAFNAMb\x06proto3\
";
