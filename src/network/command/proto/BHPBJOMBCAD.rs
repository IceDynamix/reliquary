...
//! Generated file from `BHPBJOMBCAD.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:BHPBJOMBCAD)
...
pub struct BHPBJOMBCAD {
    ...
    // special fields
    // @@protoc_insertion_point(special_field:BHPBJOMBCAD.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a BHPBJOMBCAD {
    fn default() -> &'a BHPBJOMBCAD {
        <BHPBJOMBCAD as ::protobuf::Message>::default_instance()
    }
}

impl BHPBJOMBCAD {
    pub fn new() -> BHPBJOMBCAD {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "NOALGKCLDHF",
            |m: &BHPBJOMBCAD| { &m.NOALGKCLDHF },
            |m: &mut BHPBJOMBCAD| { &mut m.NOALGKCLDHF },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<BHPBJOMBCAD>(
            "BHPBJOMBCAD",
            fields,
            oneofs,
        )
...
impl ::protobuf::Message for BHPBJOMBCAD {
    const NAME: &'static str = "BHPBJOMBCAD";
...
impl ::protobuf::MessageFull for BHPBJOMBCAD {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("BHPBJOMBCAD").unwrap()).clone()
    }
}

impl ::std::fmt::Display for BHPBJOMBCAD {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for BHPBJOMBCAD {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::NEJPAGJBMDA::file_descriptor().clone());
            let mut messages = ::std::vec::Vec::with_capacity(1);
            messages.push(BHPBJOMBCAD::generated_message_descriptor_data());
