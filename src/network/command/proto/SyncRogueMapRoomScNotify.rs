...
pub struct SyncRogueMapRoomScNotify {
    // message fields
    // @@protoc_insertion_point(field:SyncRogueMapRoomScNotify.LOJEKBMAFHH)
    pub LOJEKBMAFHH: ::protobuf::MessageField<super::NGEFPLJPHPK::NGEFPLJPHPK>,
...
impl SyncRogueMapRoomScNotify {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::NGEFPLJPHPK::NGEFPLJPHPK>(
            "LOJEKBMAFHH",
            |m: &SyncRogueMapRoomScNotify| { &m.LOJEKBMAFHH },
            |m: &mut SyncRogueMapRoomScNotify| { &mut m.LOJEKBMAFHH },
        ));
...
impl ::protobuf::Message for SyncRogueMapRoomScNotify {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                50 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.LOJEKBMAFHH)?;
                },
                8 => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if let Some(v) = self.LOJEKBMAFHH.as_ref() {
    ...
    fn default_instance() -> &'static SyncRogueMapRoomScNotify {
        static instance: SyncRogueMapRoomScNotify = SyncRogueMapRoomScNotify {
            LOJEKBMAFHH: ::protobuf::MessageField::none(),
            map_id: 0,
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1eSyncRogueMapRoomScNotify.proto\x1a\x11NGEFPLJPHPK.proto\"a\n\x18Sy\
    ncRogueMapRoomScNotify\x12.\n\x0bLOJEKBMAFHH\x18\x06\x20\x01(\x0b2\x0c.N\
    GEFPLJPHPKR\x0bLOJEKBMAFHH\x12\x15\n\x06map_id\x18\x01\x20\x01(\rR\x05ma\
    pIdb\x06proto3\
";
