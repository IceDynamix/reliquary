...
pub struct SyncRogueMapRoomScNotify {
    ...
    pub map_id: u32,
    // @@protoc_insertion_point(field:SyncRogueMapRoomScNotify.HNEANMNJHDB)
    pub HNEANMNJHDB: ::protobuf::MessageField<super::PAIJCBOKIFO::PAIJCBOKIFO>,
    // special fields
...
impl SyncRogueMapRoomScNotify {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::PAIJCBOKIFO::PAIJCBOKIFO>(
            "HNEANMNJHDB",
            |m: &SyncRogueMapRoomScNotify| { &m.HNEANMNJHDB },
            |m: &mut SyncRogueMapRoomScNotify| { &mut m.HNEANMNJHDB },
        ));
...
impl ::protobuf::Message for SyncRogueMapRoomScNotify {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                90 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.HNEANMNJHDB)?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let Some(v) = self.HNEANMNJHDB.as_ref() {
    ...
    fn default_instance() -> &'static SyncRogueMapRoomScNotify {
        static instance: SyncRogueMapRoomScNotify = SyncRogueMapRoomScNotify {
            map_id: 0,
            HNEANMNJHDB: ::protobuf::MessageField::none(),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1eSyncRogueMapRoomScNotify.proto\x1a\x11PAIJCBOKIFO.proto\"a\n\x18Sy\
    ncRogueMapRoomScNotify\x12\x15\n\x06map_id\x18\x06\x20\x01(\rR\x05mapId\
    \x12.\n\x0bHNEANMNJHDB\x18\x0b\x20\x01(\x0b2\x0c.PAIJCBOKIFOR\x0bHNEANMN\
    JHDBb\x06proto3\
";
