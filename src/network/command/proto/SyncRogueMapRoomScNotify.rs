...
pub struct SyncRogueMapRoomScNotify {
    ...
    pub map_id: u32,
    // @@protoc_insertion_point(field:SyncRogueMapRoomScNotify.site_info)
    pub site_info: ::protobuf::MessageField<super::RogueSite::RogueSite>,
    // special fields
...
impl SyncRogueMapRoomScNotify {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::RogueSite::RogueSite>(
            "site_info",
            |m: &SyncRogueMapRoomScNotify| { &m.site_info },
            |m: &mut SyncRogueMapRoomScNotify| { &mut m.site_info },
        ));
...
impl ::protobuf::Message for SyncRogueMapRoomScNotify {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                90 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.site_info)?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let Some(v) = self.site_info.as_ref() {
    ...
    fn default_instance() -> &'static SyncRogueMapRoomScNotify {
        static instance: SyncRogueMapRoomScNotify = SyncRogueMapRoomScNotify {
            map_id: 0,
            site_info: ::protobuf::MessageField::none(),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1eSyncRogueMapRoomScNotify.proto\x1a\x0fRogueSite.proto\"Z\n\x18Sync\
    RogueMapRoomScNotify\x12\x15\n\x06map_id\x18\t\x20\x01(\rR\x05mapId\x12'\
    \n\tsite_info\x18\x0b\x20\x01(\x0b2\n.RogueSiteR\x08siteInfob\x06proto3\
";
