...
impl ::protobuf::Message for GetSceneMapInfoCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(12, &self.floor_id_list);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.IGFIKGHLLNO != false {
            os.write_bool(13, self.IGFIKGHLLNO)?;
        }
        os.write_repeated_packed_uint32(15, &self.entry_id_list)?;
        os.write_repeated_packed_uint32(12, &self.floor_id_list)?;
        if self.entry_story_line_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x20\n\x0bIGFIKGHLLNO\x18\r\x20\x01(\x08R\x0bIGFIKGHLLNO\x12\"\n\rentry_\
    id_list\x18\x0f\x20\x03(\rR\x0bentryIdList\x12\"\n\rfloor_id_list\x18\
    \x0c\x20\x03(\rR\x0bfloorIdList\x12-\n\x13entry_story_line_id\x18\x07\
    \x20\x01(\rR\x10entryStoryLineId\x12\x1d\n\ncontent_id\x18\x04\x20\x01(\
    \rR\tcontentIdb\x06proto3\
";
