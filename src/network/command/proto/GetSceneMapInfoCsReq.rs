...
pub struct GetSceneMapInfoCsReq {
    // message fields
    // @@protoc_insertion_point(field:GetSceneMapInfoCsReq.scene_identifiers)
    pub scene_identifiers: ::std::vec::Vec<super::SceneIdentifier::SceneIdentifier>,
    // special fields
...
impl GetSceneMapInfoCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "scene_identifiers",
            |m: &GetSceneMapInfoCsReq| { &m.scene_identifiers },
            |m: &mut GetSceneMapInfoCsReq| { &mut m.scene_identifiers },
        ));
...
impl ::protobuf::Message for GetSceneMapInfoCsReq {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                98 => {
                    self.scene_identifiers.push(is.read_message()?);
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        for value in &self.scene_identifiers {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        for v in &self.scene_identifiers {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1aGetSceneMapInfoCsReq.proto\x1a\x15SceneIdentifier.proto\"U\n\x14Ge\
    tSceneMapInfoCsReq\x12=\n\x11scene_identifiers\x18\x0c\x20\x03(\x0b2\x10\
    .SceneIdentifierR\x10sceneIdentifiersb\x06proto3\
";
