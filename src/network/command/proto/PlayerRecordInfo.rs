...
impl ::protobuf::Message for PlayerRecordInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.JFPGBKBPBNF != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.JFPGBKBPBNF);
        }
        ...
        if self.GEKKNDONHLJ != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.GEKKNDONHLJ);
        }
        if self.EHBDEIJJOHK != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.EHBDEIJJOHK);
        }
        if self.HKNOAKGCJBK != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.HKNOAKGCJBK);
        }
        if self.BHFEFEODNIM != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.BHFEFEODNIM);
        }
        if self.FHKKMPDDMGO != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.FHKKMPDDMGO);
        }
        if self.CFDFMGLLICO != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.CFDFMGLLICO);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.JFPGBKBPBNF != 0 {
            os.write_uint32(3, self.JFPGBKBPBNF)?;
        }
        if let Some(v) = self.collection_info.as_ref() {
            ::protobuf::rt::write_message_field_with_cached_size(11, v, os)?;
        }
        if self.GEKKNDONHLJ != 0 {
            os.write_uint32(2, self.GEKKNDONHLJ)?;
        }
        if self.EHBDEIJJOHK != 0 {
            os.write_uint32(6, self.EHBDEIJJOHK)?;
        }
        if self.HKNOAKGCJBK != 0 {
            os.write_uint32(8, self.HKNOAKGCJBK)?;
        }
        if self.BHFEFEODNIM != 0 {
            os.write_uint32(15, self.BHFEFEODNIM)?;
        }
        if self.FHKKMPDDMGO != 0 {
            os.write_uint32(13, self.FHKKMPDDMGO)?;
        }
        if self.CFDFMGLLICO != 0 {
            os.write_uint32(7, self.CFDFMGLLICO)?;
        }
        if self.EMJDEBDMHLL != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x10PlayerRecordInfo\x12\x20\n\x0bJFPGBKBPBNF\x18\x03\x20\x01(\rR\x0bJ\
    FPGBKBPBNF\x12>\n\x0fcollection_info\x18\x0b\x20\x01(\x0b2\x15.PlayerCol\
    lectionInfoR\x0ecollectionInfo\x12\x20\n\x0bGEKKNDONHLJ\x18\x02\x20\x01(\
    \rR\x0bGEKKNDONHLJ\x12\x20\n\x0bEHBDEIJJOHK\x18\x06\x20\x01(\rR\x0bEHBDE\
    IJJOHK\x12\x20\n\x0bHKNOAKGCJBK\x18\x08\x20\x01(\rR\x0bHKNOAKGCJBK\x12\
    \x20\n\x0bBHFEFEODNIM\x18\x0f\x20\x01(\rR\x0bBHFEFEODNIM\x12\x20\n\x0bFH\
    KKMPDDMGO\x18\r\x20\x01(\rR\x0bFHKKMPDDMGO\x12\x20\n\x0bCFDFMGLLICO\x18\
    \x07\x20\x01(\rR\x0bCFDFMGLLICO\x12\x20\n\x0bEMJDEBDMHLL\x18\x04\x20\x01\
    (\rR\x0bEMJDEBDMHLLb\x06proto3\
";
