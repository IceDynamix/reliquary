...
impl ::protobuf::Message for PlayerRecordInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.CFDFMGLLICO != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.CFDFMGLLICO);
        }
        if self.GEKKNDONHLJ != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.GEKKNDONHLJ);
        }
        if self.EHBDEIJJOHK != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.EHBDEIJJOHK);
        }
        if self.JFPGBKBPBNF != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.JFPGBKBPBNF);
        }
        if self.EMJDEBDMHLL != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.EMJDEBDMHLL);
        }
        if self.BHFEFEODNIM != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.BHFEFEODNIM);
        }
        if self.FHKKMPDDMGO != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.FHKKMPDDMGO);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.CFDFMGLLICO != 0 {
            os.write_uint32(12, self.CFDFMGLLICO)?;
        }
        if self.GEKKNDONHLJ != 0 {
            os.write_uint32(7, self.GEKKNDONHLJ)?;
        }
        if self.EHBDEIJJOHK != 0 {
            os.write_uint32(6, self.EHBDEIJJOHK)?;
        }
        if self.JFPGBKBPBNF != 0 {
            os.write_uint32(11, self.JFPGBKBPBNF)?;
        }
        if self.EMJDEBDMHLL != 0 {
            os.write_uint32(13, self.EMJDEBDMHLL)?;
        }
        if self.BHFEFEODNIM != 0 {
            os.write_uint32(9, self.BHFEFEODNIM)?;
        }
        if self.FHKKMPDDMGO != 0 {
            os.write_uint32(4, self.FHKKMPDDMGO)?;
        }
        if let Some(v) = self.collection_info.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x10PlayerRecordInfo\x12\x20\n\x0bHKNOAKGCJBK\x18\x01\x20\x01(\rR\x0bH\
    KNOAKGCJBK\x12\x20\n\x0bCFDFMGLLICO\x18\x0c\x20\x01(\rR\x0bCFDFMGLLICO\
    \x12\x20\n\x0bGEKKNDONHLJ\x18\x07\x20\x01(\rR\x0bGEKKNDONHLJ\x12\x20\n\
    \x0bEHBDEIJJOHK\x18\x06\x20\x01(\rR\x0bEHBDEIJJOHK\x12\x20\n\x0bJFPGBKBP\
    BNF\x18\x0b\x20\x01(\rR\x0bJFPGBKBPBNF\x12\x20\n\x0bEMJDEBDMHLL\x18\r\
    \x20\x01(\rR\x0bEMJDEBDMHLL\x12\x20\n\x0bBHFEFEODNIM\x18\t\x20\x01(\rR\
    \x0bBHFEFEODNIM\x12\x20\n\x0bFHKKMPDDMGO\x18\x04\x20\x01(\rR\x0bFHKKMPDD\
    MGO\x12>\n\x0fcollection_info\x18\n\x20\x01(\x0b2\x15.PlayerCollectionIn\
    foR\x0ecollectionInfob\x06proto3\
";
