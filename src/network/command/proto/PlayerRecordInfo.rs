...
impl ::protobuf::Message for PlayerRecordInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.FHKKMPDDMGO != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.FHKKMPDDMGO);
        }
        if self.JFPGBKBPBNF != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.JFPGBKBPBNF);
        }
        if self.GEKKNDONHLJ != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.GEKKNDONHLJ);
        }
        if self.CFDFMGLLICO != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.CFDFMGLLICO);
        }
        if self.EMJDEBDMHLL != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.EMJDEBDMHLL);
        }
        ...
        if self.EHBDEIJJOHK != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.EHBDEIJJOHK);
        }
        if self.BHFEFEODNIM != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.BHFEFEODNIM);
        }
        if self.HKNOAKGCJBK != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.HKNOAKGCJBK);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.FHKKMPDDMGO != 0 {
            os.write_uint32(14, self.FHKKMPDDMGO)?;
        }
        if self.JFPGBKBPBNF != 0 {
            os.write_uint32(15, self.JFPGBKBPBNF)?;
        }
        if self.GEKKNDONHLJ != 0 {
            os.write_uint32(4, self.GEKKNDONHLJ)?;
        }
        if self.CFDFMGLLICO != 0 {
            os.write_uint32(10, self.CFDFMGLLICO)?;
        }
        if self.EMJDEBDMHLL != 0 {
            os.write_uint32(3, self.EMJDEBDMHLL)?;
        }
        if let Some(v) = self.collection_info.as_ref() {
            ::protobuf::rt::write_message_field_with_cached_size(12, v, os)?;
        }
        if self.EHBDEIJJOHK != 0 {
            os.write_uint32(5, self.EHBDEIJJOHK)?;
        }
        if self.BHFEFEODNIM != 0 {
            os.write_uint32(1, self.BHFEFEODNIM)?;
        }
        if self.HKNOAKGCJBK != 0 {
            os.write_uint32(13, self.HKNOAKGCJBK)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x10PlayerRecordInfo\x12\x20\n\x0bFHKKMPDDMGO\x18\x0e\x20\x01(\rR\x0bF\
    HKKMPDDMGO\x12\x20\n\x0bJFPGBKBPBNF\x18\x0f\x20\x01(\rR\x0bJFPGBKBPBNF\
    \x12\x20\n\x0bGEKKNDONHLJ\x18\x04\x20\x01(\rR\x0bGEKKNDONHLJ\x12\x20\n\
    \x0bCFDFMGLLICO\x18\n\x20\x01(\rR\x0bCFDFMGLLICO\x12\x20\n\x0bEMJDEBDMHL\
    L\x18\x03\x20\x01(\rR\x0bEMJDEBDMHLL\x12>\n\x0fcollection_info\x18\x0c\
    \x20\x01(\x0b2\x15.PlayerCollectionInfoR\x0ecollectionInfo\x12\x20\n\x0b\
    EHBDEIJJOHK\x18\x05\x20\x01(\rR\x0bEHBDEIJJOHK\x12\x20\n\x0bBHFEFEODNIM\
    \x18\x01\x20\x01(\rR\x0bBHFEFEODNIM\x12\x20\n\x0bHKNOAKGCJBK\x18\r\x20\
    \x01(\rR\x0bHKNOAKGCJBKb\x06proto3\
";
