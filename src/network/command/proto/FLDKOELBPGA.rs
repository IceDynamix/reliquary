...
//! Generated file from `FLDKOELBPGA.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:FLDKOELBPGA)
...
impl<'a> ::std::default::Default for &'a FLDKOELBPGA {
    fn default() -> &'a FLDKOELBPGA {
        <FLDKOELBPGA as ::protobuf::Message>::default_instance()
    }
}

impl FLDKOELBPGA {
    pub fn new() -> FLDKOELBPGA {
...
impl ::protobuf::Message for FLDKOELBPGA {
    const NAME: &'static str = "FLDKOELBPGA";
...
impl ::protobuf::MessageFull for FLDKOELBPGA {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("FLDKOELBPGA").unwrap()).clone()
    }
}

impl ::std::fmt::Display for FLDKOELBPGA {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for FLDKOELBPGA {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(FLDKOELBPGA::generated_message_descriptor_data());
