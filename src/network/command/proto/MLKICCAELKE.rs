...
impl ::protobuf::Message for MLKICCAELKE {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(3, &self.ANBPNIHMKAH);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(3, &self.ANBPNIHMKAH)?;
        if self.BILBOHBDBPN != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x03\x20\x03(\rR\x0bANBPNIHMKAH\x12\x20\n\x0bBILBOHBDBPN\x18\x06\x20\x01\
