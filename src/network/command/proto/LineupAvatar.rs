...
impl ::protobuf::Message for LineupAvatar {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.satiety != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.satiety);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.satiety != 0 {
            os.write_uint32(1, self.satiety)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12!\n\x06sp_bar\x18\x0f\x20\x01(\x0b2\n.SpBarInfoR\x05spBar\x12\x12\n\
    \x04slot\x18\r\x20\x01(\rR\x04slot\x12\x0e\n\x02hp\x18\x03\x20\x01(\rR\
    \x02hp\x12\x18\n\x07satiety\x18\x01\x20\x01(\rR\x07satietyb\x06proto3\
";
