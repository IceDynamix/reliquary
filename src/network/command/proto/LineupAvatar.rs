...
impl ::protobuf::Message for LineupAvatar {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.satiety != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.satiety);
        }
        if self.slot != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.satiety != 0 {
            os.write_uint32(6, self.satiety)?;
        }
        if self.slot != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \"\xad\x01\n\x0cLineupAvatar\x12\x18\n\x07satiety\x18\x06\x20\x01(\rR\
    \x07satiety\x12\x12\n\x04slot\x18\x0b\x20\x01(\rR\x04slot\x12\x0e\n\x02i\
    d\x18\x0f\x20\x01(\rR\x02id\x12!\n\x06sp_bar\x18\x03\x20\x01(\x0b2\n.SpB\
    arInfoR\x05spBar\x12,\n\x0bavatar_type\x18\x01\x20\x01(\x0e2\x0b.AvatarT\
