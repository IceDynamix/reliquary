...
impl ::protobuf::Message for LineupAvatar {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.satiety != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.satiety);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.satiety != 0 {
            os.write_uint32(5, self.satiety)?;
        }
        if let Some(v) = self.sp_bar.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0b.AvatarTypeR\navatarType\x12\x0e\n\x02hp\x18\x0c\x20\x01(\rR\x02hp\
    \x12\x0e\n\x02id\x18\x0f\x20\x01(\rR\x02id\x12\x12\n\x04slot\x18\x07\x20\
    \x01(\rR\x04slot\x12\x18\n\x07satiety\x18\x05\x20\x01(\rR\x07satiety\x12\
