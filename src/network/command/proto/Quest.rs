...
pub struct Quest {
    ...
    pub progress: u32,
    // @@protoc_insertion_point(field:Quest.ODMDGJOMKFA)
    pub ODMDGJOMKFA: ::std::vec::Vec<u32>,
...
impl Quest {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "ODMDGJOMKFA",
            |m: &Quest| { &m.ODMDGJOMKFA },
            |m: &mut Quest| { &mut m.ODMDGJOMKFA },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "status",
            |m: &Quest| { &m.status },
...
impl ::protobuf::Message for Quest {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                18 => {
                    is.read_repeated_packed_uint32_into(&mut self.ODMDGJOMKFA)?;
                },
                16 => {
                    self.ODMDGJOMKFA.push(is.read_uint32()?);
                },
                72 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(2, &self.ODMDGJOMKFA);
        ...
        if self.finish_time != 0 {
            my_size += ::protobuf::rt::int64_size(8, self.finish_time);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_uint32(2, &self.ODMDGJOMKFA)?;
        if self.status != ::protobuf::EnumOrUnknown::new(super::QuestStatus::QuestStatus::QUEST_NONE) {
        ...
        if self.finish_time != 0 {
            os.write_int64(8, self.finish_time)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x02\x20\x03(\rR\x0bODMDGJOMKFA\x12$\n\x06status\x18\t\x20\x01(\x0e2\
    \x0c.QuestStatusR\x06status\x12\x0e\n\x02id\x18\x07\x20\x01(\rR\x02id\
    \x12\x1f\n\x0bfinish_time\x18\x08\x20\x01(\x03R\nfinishTimeb\x06proto3\
";
