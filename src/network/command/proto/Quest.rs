...
pub struct Quest {
    ...
    pub progress: u32,
    // @@protoc_insertion_point(field:Quest.KAHIFENJKDD)
    pub KAHIFENJKDD: ::std::vec::Vec<u32>,
...
impl Quest {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "KAHIFENJKDD",
            |m: &Quest| { &m.KAHIFENJKDD },
            |m: &mut Quest| { &mut m.KAHIFENJKDD },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "finish_time",
...
impl ::protobuf::Message for Quest {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                106 => {
                    is.read_repeated_packed_uint32_into(&mut self.KAHIFENJKDD)?;
                },
                104 => {
                    self.KAHIFENJKDD.push(is.read_uint32()?);
                },
                56 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(13, &self.KAHIFENJKDD);
        if self.finish_time != 0 {
            my_size += ::protobuf::rt::int64_size(7, self.finish_time);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_uint32(13, &self.KAHIFENJKDD)?;
        if self.finish_time != 0 {
            os.write_int64(7, self.finish_time)?;
        }
        if self.status != ::protobuf::EnumOrUnknown::new(super::QuestStatus::QuestStatus::QUEST_NONE) {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x02id\x18\t\x20\x01(\rR\x02id\x12\x1a\n\x08progress\x18\x0b\x20\x01(\
    \rR\x08progress\x12\x20\n\x0bKAHIFENJKDD\x18\r\x20\x03(\rR\x0bKAHIFENJKD\
    D\x12\x1f\n\x0bfinish_time\x18\x07\x20\x01(\x03R\nfinishTime\x12$\n\x06s\
    tatus\x18\x01\x20\x01(\x0e2\x0c.QuestStatusR\x06statusb\x06proto3\
";
